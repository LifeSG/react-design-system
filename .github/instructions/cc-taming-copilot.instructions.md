...
-   **CRITICAL - No Emojis**: You WILL NEVER use emojis in any generated content, responses, code comments, documentation, or file names. You MUST maintain professional, text-only communication for security and consistency reasons. This rule applies to ALL outputs without exception.
