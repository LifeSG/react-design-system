...
export const accordionExtraArgTypes = {
    ...
    "AccordionProps.showTitleInMobile": {
        "control": false,
        "description": "When `true`, the `title` remains visible on mobile viewports.",
    ...
    "AccordionProps.title": {
        "control": false,
        "description": "Section heading rendered above the item list. Visually hidden on mobile unless `showTitleInMobile` is true.",
        "name": "title",
        "table": {
            "category": "AccordionProps",
            "tabGroup": "Accordion",
