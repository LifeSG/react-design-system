...
export const errorDisplayExtraArgTypes = {
    ...
    "ErrorDisplayProps.imageOnly": {
        "control": false,
        "description": "Renders only the illustration, hiding the title, description, and action button.",
        "name": "imageOnly",
        "table": {
            "category": "ErrorDisplayProps",
            "defaultValue": {
    ...
    "ErrorDisplayProps.img": {
        "control": false,
        "description": "Overrides the default illustration for the selected `type`.",
        "name": "img",
        "table": {
            "category": "ErrorDisplayProps",
            "type": {
    ...
    "ErrorDisplayProps.type": {
        "control": false,
        "description": "Determines the default illustration assets and copy to display.",
        "name": "type",
        "table": {
            "category": "ErrorDisplayProps",
            "type": {
