...
export const fullscreenImageCarouselExtraArgTypes = {
    ...
    "FullscreenImageCarouselCustomItemProps.thumbnailSrc": {
        "control": false,
        "description": "The thumbnail image src. If omitted, a placeholder is shown in the thumbnail strip.",
        "name": "thumbnailSrc",
        "table": {
            "category": "FullscreenImageCarouselCustomItemProps",
            "type": {
    ...
    "FullscreenImageCarouselProps.hideMagnifier": {
        "control": false,
        "description": "Hides the zoom in/out magnifier button. Has no effect on custom items, which\nnever show the magnifier regardless of this prop.",
        "name": "hideMagnifier",
        "table": {
            "category": "FullscreenImageCarouselProps",
            "defaultValue": {
    ...
    "FullscreenImageCarouselProps.initialActiveItemIndex": {
        "control": false,
        "description": "Zero-based index of the item that is active when the carousel first opens.",
    ...
    "FullscreenImageCarouselProps.insets": {
        "control": false,
        "description": "Additional pixel insets applied to keep content within a safe area\nof the viewport and avoid overlap with device UI elements.",
        "name": "insets",
        "table": {
            "category": "FullscreenImageCarouselProps",
            "type": {
    ...
    "FullscreenImageCarouselProps.items": {
        "control": false,
        "description": "The list of items to display. Each item is either an image or a custom content item.",
        "name": "items",
        "table": {
            "category": "FullscreenImageCarouselProps",
            "type": {
    ...
    "FullscreenImageCarouselProps.onClose": {
        "control": false,
        "description": "Called when the close button is activated or the Escape key is pressed.",
        "name": "onClose",
        "table": {
            "category": "FullscreenImageCarouselProps",
            "type": {
    ...
    "FullscreenImageCarouselProps.onDelete": {
        "control": false,
        "description": "Called when the delete button is activated for the current item.",
        "name": "onDelete",
        "table": {
            "category": "FullscreenImageCarouselProps",
            "type": {
