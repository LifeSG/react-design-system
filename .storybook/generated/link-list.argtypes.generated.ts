...
export const linkListExtraArgTypes = {
    ...
    "LinkListItemProps.onClick": {
        "control": false,
        "description": "Called when an item is clicked. This overrides the `onItemClick` event handler.",
        "name": "onClick",
        "table": {
            "category": "LinkListItemProps<T>",
            "type": {
    ...
    "LinkListItemProps.options": {
        "control": false,
        "description": "Arbitrary custom data passed through to the `onItemClick` callback.",
        "name": "options",
        "table": {
            "category": "LinkListItemProps<T>",
            "type": {
    ...
    "LinkListProps": {
        ...
        "table": {
            ...
            "type": {
                "summary": "BaseProps<T> & (LinkListEagerProps | LinkListLazyProps)"
            }
        }
    },
    ...
    "LinkListProps.onItemClick": {
        "control": false,
        "description": "Component-level click handler called for every item click, unless the\nitem defines its own `onClick`.",
        "name": "onItemClick",
        "table": {
            "category": "LinkListProps<T>",
            "type": {
