...
export const typographyExtraArgTypes = {
    ...
    "TypographyProps.inline": {
        "control": false,
        "description": "Renders the element as an inline `span`. When `true`, the `as` prop\nis ignored and `maxLines` clamping is disabled.",
        "name": "inline",
        "table": {
            "category": "TypographyProps<T>",
            "tabGroup": "Heading/Body",
    ...
    "TypographyProps.maxLines": {
        "control": false,
        "description": "Clamps visible text to the given number of lines, truncating the\nremainder.\n\nRemarks:\nHas no effect when `inline` is `true`.",
        "name": "maxLines",
        "table": {
            "category": "TypographyProps<T>",
            "tabGroup": "Heading/Body",
    ...
    "TypographyProps.paragraph": {
        "control": false,
        "description": "Adds a bottom margin to separate the element from following content.",
        "name": "paragraph",
        "table": {
            "category": "TypographyProps<T>",
            "tabGroup": "Heading/Body",
    ...
    "TypographyUnderlineStyle": {
        "control": false,
        "description": "Text-decoration style applied to a link typography element.",
