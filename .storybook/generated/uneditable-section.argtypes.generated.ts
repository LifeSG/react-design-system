...
export const uneditableSectionExtraArgTypes = {
    ...
    "UneditableSectionItemProps.disableMaskUnmask": {
        "control": false,
        "description": "Prevents the user from toggling the mask or unmask control.",
    ...
    "UneditableSectionItemProps.maskChar": {
        "control": false,
        "description": "Character used to replace each masked character in the displayed value.",
        "name": "maskChar",
        "table": {
            "category": "UneditableSectionItemProps",
            "defaultValue": {
    ...
    "UneditableSectionItemProps.maskRegex": {
        "control": false,
        "description": "Regular expression whose matches are replaced with `maskChar`.\n\nRemarks:\nIgnored when `maskTransformer` is provided.",
        "name": "maskRegex",
        "table": {
            "category": "UneditableSectionItemProps",
            "tabGroup": "UneditableSection.Item",
    ...
    "UneditableSectionItemProps.maskState": {
        "control": false,
        "description": "Controls whether the value is masked or unmasked.\nWhen undefined, no mask or unmask controls are rendered.",
        "name": "maskState",
        "table": {
            "category": "UneditableSectionItemProps",
            "tabGroup": "UneditableSection.Item",
    ...
    "UneditableSectionItemProps.maskTransformer": {
        "control": false,
        "description": "Custom function that receives the raw value and returns the fully\nmasked string. Takes precedence over `maskRegex`, `maskRange`, and\n`unmaskRange`.",
    ...
    "UneditableSectionItemProps.unmaskRange": {
        "control": false,
        "description": "Index range `[start, end]` of the characters to keep visible (inclusive, zero-based).\nCharacters outside this range are masked.\n\nRemarks:\nIgnored when `maskTransformer` or `maskRegex` is provided.",
        "name": "unmaskRange",
        "table": {
            "category": "UneditableSectionItemProps",
            "tabGroup": "UneditableSection.Item",
    ...
    "UneditableSectionItemSectionProps.stretch": {
        "control": false,
        "description": "Stretches every child item to fill the full width of the grid.",
        "name": "stretch",
        "table": {
            "category": "UneditableSectionItemSectionProps",
            "tabGroup": "UneditableSection.ItemSection",
    ...
    "UneditableSectionProps.background": {
        "control": false,
        "description": "Applies a grey background to the section container.\nSet to `false` for a transparent background.",
        "name": "background",
        "table": {
    ...
    "UneditableSectionProps.description": {
        "control": false,
        "description": "Optional description rendered below `title` and above the items grid.",
        "name": "description",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
    ...
    "UneditableSectionProps.fullWidth": {
        "control": false,
        "description": "When `true`, allows the section to span the full available width of its parent.",
        "name": "fullWidth",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
    ...
    "UneditableSectionProps.items": {
        "control": false,
        "description": "List of labeled read-only field items to render in a responsive grid.",
        "name": "items",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
    ...
    "UneditableSectionProps.onTryAgain": {
        "control": false,
        "description": "Called when the retry button is clicked on an item in error state.",
        "name": "onTryAgain",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
    ...
    "UneditableSectionProps.stretch": {
        "control": false,
        "description": "Stretches every item to fill the full column width of the grid.",
        "name": "stretch",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
    ...
    "UneditableSectionProps.topSection": {
        "control": false,
        "description": "Custom content rendered above the items grid, below `description`.",
        "name": "topSection",
        "table": {
            "category": "UneditableSectionProps",
            "tabGroup": "UneditableSection",
