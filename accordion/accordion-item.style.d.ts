...
export declare const Title: import("styled-components").StyledComponent<"h3", import("styled-components").DefaultTheme, import("..").V2_TextProps & StyleProps, never>;
export declare const TitleH4: import("styled-components").StyledComponent<"h4", import("styled-components").DefaultTheme, import("..").V2_TextProps & StyleProps, never>;
