...
export declare const CurrentLabel: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("..").TypographyProps, never>;
export declare const PreviousLink: import("styled-components").StyledComponent<{
