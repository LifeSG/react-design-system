...
export declare const PreviousLink: import("styled-components").StyledComponent<(props: import("..").TextLinkProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
export {};
