...
`,or=p(qn.Hyperlink.Small)`
    margin: 0.25rem !important;
`,ar=({links:t,fadeColor:i,fadePosition:o="both",itemStyle:c,id:f,...h})=>{const[d,g]=l(!!o),[p,y]=l("left"===o||"both"===o),[v,S]=l("right"===o||"both"===o),b=a(null),F=a(null);!function(t){void 0===t&&(t={});var e=t.skipOnMount,n=void 0!==e&&e,r=t.refreshMode,i=t.refreshRate,o=void 0===i?1e3:i,c=t.refreshOptions,f=t.handleWidth,h=void 0===f||f,u=t.handleHeight,d=void 0===u||u,s=t.targetRef,g=t.observerOptions,p=t.onResize,y=a(n),v=a(null),S=null!=s?s:v,b=a(),F=l({width:void 0,height:void 0}),w=F[0],H=F[1];ht((function(){if(!lt()){var t=ft(p,H,h,d);b.current=ot((function(e){(h||d)&&e.forEach((function(e){var n=e&&e.contentRect||{},r=n.width,i=n.height;!y.current&&!lt()&&t({width:r,height:i}),y.current=!1}))}),r,o,c);var e=new window.ResizeObserver(b.current);return S.current&&e.observe(S.current,g),function(){e.disconnect();var t=b.current;t&&t.cancel&&t.cancel()}}}),[r,o,c,h,d,p,g,S.current]),m({ref:S},w)}({onResize:s((()=>{const e=F.current,n=b.current;e&&n&&t&&t.length>1&&window.innerWidth<=ut.tablet&&(e.scrollLeft=e.scrollWidth-n.offsetWidth)}),[t.length]),targetRef:b,refreshMode:"debounce",refreshRate:50});const w=()=>{if(d){g(window.innerWidth<ut.tablet);const t=F.current,e=b.current;t&&e&&t.scrollWidth>e.offsetWidth?(g(!0),y(t.scrollLeft>=1),S(t.scrollWidth-t.scrollLeft>e.offsetWidth)):g(!1)}};if(u((()=>{const t=F.current;return w(),window.addEventListener("resize",w),t&&t.addEventListener("scroll",w),()=>{window.removeEventListener("resize",w),t&&t.removeEventListener("scroll",w)}}),[]),!t)return null;return e(Yn,{ref:b,id:f||"breadcrumb",...h,children:[n("nav",{children:n(tr,{ref:F,children:t.map(((r,i)=>{let o;return r.children?(o=i!==t.length-1&&r.href?n(or,{...r,weight:"semibold"}):n(ir,{weight:"semibold",children:r.children}),e(nr,{$styleProps:c,children:[o,i<t.length-1&&n(rr,{})]},i)):null}))})}),d&&(()=>{let t;return t=Array.isArray(i)&&i.length>0?{left:i,right:i}:i||{left:void 0,right:void 0},e(r,{children:[p&&n(er,{$backgroundColor:t.left,$position:"left"}),v&&n(er,{$backgroundColor:t.right,$position:"right"})]})})()]})};export{ar as Breadcrumb};
