...
`,Mt=r=>{var{external:n=!1,children:o}=r,a=l(r,["external","children"]);return e(Gt,Object.assign({},a,{children:[o,n&&t(Xt,{})]}))};var Ut;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ut||(Ut={}));const Zt={collections:{base:{InputBoxShadow:a`
	...
	${e=>"small"===e.$buttonSizeStyle?a`
                ...
                `}
`;n((({color:r,className:n,size:o=18})=>e(Ht,Object.assign({className:n,$size:o,$color:r},{children:[t(At,{id:"inner1",$size:o-2,$borderWidth:2,$color:r}),t(kt,{id:"inner2",$size:o-2,$borderWidth:2,$color:r}),t(Ct,{id:"inner3",$size:o-2,$borderWidth:2,$color:r}),t(_t,{id:"inner4",$size:o-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
...
`;const Kt=n(Jt)`
    ...
    ${e=>"small"===e.$buttonSizeStyle?a`
                ...
                `}
`,Qt={Default:r.forwardRef(((r,n)=>{const{children:o,disabled:a=!1,styleType:i="default",danger:c=!1,icon:d,iconPosition:g="left"}=r,u=l(r,["children","disabled","styleType","danger","icon","iconPosition"]),s={$buttonIconPosition:g,$buttonStyle:a?"disabled":i,$buttonSizeStyle:"default",$buttonIsDanger:c};return e(Kt,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:a},s,u,{children:[d,t("span",{children:o})]}))})),Small:r.forwardRef(((r,n)=>{const{children:o,disabled:a=!1,styleType:i="default",danger:c=!1,icon:d,iconPosition:g="left"}=r,u=l(r,["children","disabled","styleType","danger","icon","iconPosition"]),s={$buttonIconPosition:g,$buttonStyle:a?"disabled":i,$buttonSizeStyle:"small",$buttonIsDanger:c};return e(Kt,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:a},s,u,{children:[d,t("span",{children:o})]}))}))};export{Qt as ButtonWithIcon};
