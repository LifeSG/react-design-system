...
`,Mt=r=>{var{external:n=!1,children:o}=r,a=l(r,["external","children"]);return e(Gt,Object.assign({},a,{children:[o,n&&t(Xt,{})]}))};var Ut;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ut||(Ut={}));const Zt={collections:{base:{InputBoxShadow:a`
	...
	${e=>"small"===e.$buttonSizeStyle?a`
                ...
                `}
`;n((({color:r,className:n,size:o=18})=>e(Ht,Object.assign({className:n,$size:o,$color:r},{children:[t(At,{id:"inner1",$size:o-2,$borderWidth:2,$color:r}),t(Ct,{id:"inner2",$size:o-2,$borderWidth:2,$color:r}),t(kt,{id:"inner3",$size:o-2,$borderWidth:2,$color:r}),t(_t,{id:"inner4",$size:o-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
