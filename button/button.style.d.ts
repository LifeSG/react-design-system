...
export declare const Spinner: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("styled-components").FastOmit<import("../shared/component-loading-spinner").ComponentLoadingSpinnerProps, "$hasChildren"> & {
    $hasChildren: boolean;
}, never> & Partial<Pick<import("styled-components").FastOmit<import("../shared/component-loading-spinner").ComponentLoadingSpinnerProps, "$hasChildren"> & {
    $hasChildren: boolean;
}, never>>> & string & Omit<({ color, className, size, }: import("../shared/component-loading-spinner").ComponentLoadingSpinnerProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;
