...
`,Zt=n=>{var{external:r=!1,children:a}=n,o=l(n,["external","children"]);return e(Mt,Object.assign({},o,{children:[a,r&&t(Ut,{})]}))};var Yt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Yt||(Yt={}));const qt={collections:{base:{InputBoxShadow:o`
	...
	${e=>"small"===e.$buttonSizeStyle?o`
                ...
                `}
`,tn=r((({color:n,className:r,size:a=18})=>e(xt,Object.assign({className:r,$size:a,$color:n},{children:[t(zt,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(At,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(Ct,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(Ot,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
