...
`,Mt=r=>{var{external:n=!1,children:o}=r,a=l(r,["external","children"]);return e(Gt,Object.assign({},a,{children:[o,n&&t(Xt,{})]}))};var Ut;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ut||(Ut={}));const Zt={collections:{base:{InputBoxShadow:a`
	...
	${e=>"small"===e.$buttonSizeStyle?a`
                ...
                `}
`,Kt=n((({color:r,className:n,size:o=18})=>e(xt,Object.assign({className:n,$size:o,$color:r},{children:[t(Ct,{id:"inner1",$size:o-2,$borderWidth:2,$color:r}),t(wt,{id:"inner2",$size:o-2,$borderWidth:2,$color:r}),t(kt,{id:"inner3",$size:o-2,$borderWidth:2,$color:r}),t(zt,{id:"inner4",$size:o-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
