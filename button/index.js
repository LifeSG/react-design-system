...
`,Mt=r=>{var{external:n=!1,children:a}=r,o=l(r,["external","children"]);return e(Gt,Object.assign({},o,{children:[a,n&&t(Xt,{})]}))};var Ut;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ut||(Ut={}));const Zt={collections:{base:{InputBoxShadow:o`
	...
	${e=>"small"===e.$buttonSizeStyle?o`
                ...
                `}
`,Kt=n((({color:r,className:n,size:a=18})=>e(Ht,Object.assign({className:n,$size:a,$color:r},{children:[t(At,{id:"inner1",$size:a-2,$borderWidth:2,$color:r}),t(kt,{id:"inner2",$size:a-2,$borderWidth:2,$color:r}),t(Ct,{id:"inner3",$size:a-2,$borderWidth:2,$color:r}),t(_t,{id:"inner4",$size:a-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
