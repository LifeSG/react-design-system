    ...
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-month":return u`
                ...
                `;case"selected-month":return u`
                    ...
                    color: ${At.Primary(e)};
                `}}}
`,Pr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:l,isNewSelection:s,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const f=i((()=>jt.generateMonths(Ot(e))),[e]),p=e=>{const t="start"===r&&a&&e.isAfter(a,"month")&&s,i="end"===r&&n&&e.isBefore(n,"month")&&s;return t||i},g=e=>{const t=e.format("MMMM"),r=(n=e,!jt.isWithinRange(n,c?Ot(c):void 0,d?Ot(d):void 0,"month"));var n;const i=o.isSame(e,"month")?"selected-month":Ot().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||p(e),interactive:!r||u,month:t,variant:i}};return f.length?t(Wr,{$type:l,children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,month:a}=g(e);return t(_r,{$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n),children:t(Nr,{weight:"regular",$variant:i,$disabledDisplay:r,children:a})},a)}))}):null},Tr=c.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Ir=c(hr.H5)`
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-year":return u`
                ...
                `}}}
`,jr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:l,isNewSelection:s,minDate:c,maxDate:d,allowDisabledSelection:u,onYearSelect:h})=>{const f=i((()=>jt.generateDecadeOfYears(Ot(e))),[e]),p=e=>{const t="start"===r&&a&&e.isAfter(a,"year")&&s,i="end"===r&&n&&e.isBefore(n,"year")&&s;return t||i},g=e=>{const t=[0,11].includes(f.indexOf(e)),r=e.year(),n=(i=e,!jt.isWithinRange(i,c?Ot(c):void 0,d?Ot(d):void 0,"year"));var i;const a=t?"other-decade":o.isSame(e,"year")?"selected-year":Ot().isSame(e,"year")?"current-year":"default";return{disabledDisplay:n||p(e),interactive:!n||u,year:r,variant:a}};return f.length?t(Tr,{$type:l,children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,year:a}=g(e);return t(Rr,{$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n),children:t(Ir,{weight:"regular",$variant:i,$disabledDisplay:r,$interactive:n,children:a})},a)}))}):null},Vr=n.forwardRef((({children:n,initialCalendarDate:i,type:c,minDate:d,maxDate:u,currentFocus:h,selectedStartDate:f,selectedEndDate:p,selectWithinRange:g,dynamicHeight:$=!1,allowDisabledSelection:m,onCalendarDateChange:y,withButton:v,doneButtonDisabled:D,onDismiss:b,showNavigationHeader:S=!0,getLeftArrowDate:w,getRightArrowDate:F,isLeftArrowDisabled:x,isRightArrowDisabled:B,getMonthHeaderLabel:H,getYearHeaderLabel:k,...M},A)=>{const[L,O]=a(Ot(i)),[C,Y]=a(Ot(i)),[z,E]=a("default"),W=o(null),_=o(null),N=o();l(A,(()=>({defaultView(){E("default")},resetView(){const e=Ot(i);O(e),Y(e),E("default")},setCalendarDate(e){const t=e?Ot(e):Ot();O(t),Y(t)}}))),s((()=>{const e=i?Ot(i):Ot();O(e),Y(e)}),[i]),s((()=>{Z(C)}),[C]);const P=()=>{"month-options"!==z?(E("month-options"),N.current.focus()):(E("default"),O(C))},T=()=>{"default"!==z?(E("default"),O(C)):E("year-options")},R=()=>{N.current.focus();const e=w?w(L):L.subtract(1,"month");switch(z){case"default":Y(e),O(e);break;case"month-options":O((e=>e.subtract(1,"year")));break;case"year-options":O((e=>e.subtract(10,"year")))}},I=()=>{N.current.focus();const e=F?F(L):L.add(1,"month");switch(z){case"default":Y(e),O(e);break;case"month-options":O((e=>e.add(1,"year")));break;case"year-options":O((e=>e.add(10,"year")))}},j=e=>{O(e),Y(e)},V=()=>{O(Ot(i)),Y(Ot(i)),"default"===z?U("reset"):E("default")},Z=e=>{y&&y(e)},U=e=>{b&&b(e)},X=()=>{if(!d||m)return!1;const e=Ot(d);return"month-options"===z?!jt.isPreviousYearWithinRange(L,e):"year-options"===z?!jt.isPreviousDecadeWithinRange(L,e):x?x(L):!jt.isPreviousMonthWithinRange(L,e)},G=()=>{if(!u||m)return!1;const e=Ot(u);return"month-options"===z?!jt.isNextYearWithinRange(L,e):"year-options"===z?!jt.isNextDecadeWithinRange(L,e):B?B(L):!jt.isNextMonthWithinRange(L,e)},J=()=>{if("year-options"===z){const{beginDecade:e,endDecade:t}=jt.getStartEndDecade(L);return`${e} to ${t}`}return k?k(L):Ot(L).format("YYYY")},q=()=>{const n=H?H(L):Ot(L).format("MMM");return e(r,{children:[e(Lr,{type:"button",tabIndex:-1,$expanded:"month-options"===z,$visible:"default"===z,id:"month-dropdown",onClick:P,children:[t(Or,{children:n}),t(xr,{})]}),e(Lr,{type:"button",tabIndex:-1,$expanded:"default"!==z,id:"year-dropdown",onClick:T,children:[t(Or,{children:J()}),t(xr,{})]})]})},Q=()=>{switch(z){case"month-options":return t(Pr,{type:c,calendarDate:L,currentFocus:h,minDate:d,maxDate:u,selectedStartDate:f,selectedEndDate:p,viewCalendarDate:C,isNewSelection:g,onMonthSelect:j,allowDisabledSelection:m});case"year-options":return t(jr,{type:c,calendarDate:L,currentFocus:h,minDate:d,maxDate:u,selectedStartDate:f,selectedEndDate:p,viewCalendarDate:C,isNewSelection:g,onYearSelect:j,allowDisabledSelection:m});default:return null}};return e(Br,{ref:N,tabIndex:-1,"data-id":"calendar-container","data-testid":"calendar-container",...M,children:[S&&e(Mr,{"data-id":"calendar-header","data-testid":"calendar-header",children:[t(Ar,{children:q()}),e(Cr,{children:[t(Yr,{"data-testid":"left-arrow-btn",disabled:X(),focusHighlight:!1,tabIndex:-1,onClick:R,children:t(wr,{})}),t(Yr,{"data-testid":"right-arrow-btn",disabled:G(),focusHighlight:!1,tabIndex:-1,onClick:I,children:t(Fr,{})})]})]}),t(Hr,{children:(()=>{const i="function"==typeof n?n({calendarDate:C,currentView:z}):n;return e(r,$?{children:["default"===z&&i,Q()]}:{children:[i,t(kr,{$visible:"default"!==z,children:Q()})]})})()}),(()=>{if(!v)return;const r=!!("default"===z)&&D;return e(zr,{children:[t(Er,{ref:_,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:V,children:"Cancel"}),t(Er,{"data-testid":"done-button",ref:W,type:"button",onClick:()=>(e=>{e||(O(C),"default"===z?U("confirmed"):E("default"))})(r),disabled:r,children:"Done"})]})})()]})})),Zr=c.div`
    width: 100%;
    display: grid;
