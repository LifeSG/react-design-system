...
`,xr=r=>{var{external:n=!1,children:a}=r,i=m(r,["external","children"]);return e(Sr,Object.assign({},i,{children:[a,n&&t(Fr,{})]}))};var wr;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(wr||(wr={}));const Br={collections:{base:{InputBoxShadow:u`
	...
	${e=>"small"===e.$buttonSizeStyle?u`
                ...
                `}
`,kr=c((({color:r,className:n,size:a=18})=>e(ir,Object.assign({className:n,$size:a,$color:r},{children:[t(sr,{id:"inner1",$size:a-2,$borderWidth:2,$color:r}),t(lr,{id:"inner2",$size:a-2,$borderWidth:2,$color:r}),t(cr,{id:"inner3",$size:a-2,$borderWidth:2,$color:r}),t(dr,{id:"inner4",$size:a-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ...
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-month":return u`
                ...
                `;case"selected-month":return u`
                    ...
                    color: ${Mt.Primary(e)};
                `}}}
`,Kr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:i,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const g=a((()=>Zt.generateMonths(Ct(e))),[e]),f=e=>{const t="start"===r&&i&&e.isAfter(i,"month")&&l,a="end"===r&&n&&e.isBefore(n,"month")&&l;return t||a},p=e=>{const t=e.format("MMMM"),r=(n=e,!Zt.isWithinRange(n,c?Ct(c):void 0,d?Ct(d):void 0,"month"));var n;const a=o.isSame(e,"month")?"selected-month":Ct().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||f(e),interactive:!r||u,month:t,variant:a}};return g.length?t(Jr,Object.assign({$type:s},{children:g.map((e=>{const{disabledDisplay:r,interactive:n,variant:a,month:i}=p(e);return t(qr,Object.assign({$variant:a,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Qr,Object.assign({weight:"regular",$variant:a,$disabledDisplay:r},{children:i}))}),i)}))})):null},en=c.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
