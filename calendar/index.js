    ...
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-month":return u`
                ...
                `;case"selected-month":return u`
                    ...
                    color: ${Mt.Primary(e)};
                `}}}
`,ar=({calendarDate:e,currentFocus:n,selectedStartDate:r,selectedEndDate:i,viewCalendarDate:o,type:l,isNewSelection:s,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const f=a((()=>Xt.generateMonths(Wt(e))),[e]),g=e=>{const t="start"===n&&i&&e.isAfter(i,"month")&&s,a="end"===n&&r&&e.isBefore(r,"month")&&s;return t||a},p=e=>{const t=e.format("MMMM"),n=(r=e,!Xt.isWithinRange(r,c?Wt(c):void 0,d?Wt(d):void 0,"month"));var r;const a=o.isSame(e,"month")?"selected-month":Wt().isSame(e,"month")?"current-month":"default";return{disabledDisplay:n||g(e),interactive:!n||u,month:t,variant:a}};return f.length?t(tr,Object.assign({$type:l},{children:f.map((e=>{const{disabledDisplay:n,interactive:r,variant:a,month:i}=p(e);return t(nr,Object.assign({$variant:a,$disabledDisplay:n,$interactive:r,onClick:()=>((e,t)=>{t||h(e)})(e,!r)},{children:t(rr,Object.assign({weight:"regular",$variant:a,$disabledDisplay:n},{children:i}))}),i)}))})):null},ir=c.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
