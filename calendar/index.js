...
`,wr=r=>{var{external:n=!1,children:a}=r,i=m(r,["external","children"]);return e(Fr,Object.assign({},i,{children:[a,n&&t(xr,{})]}))};var Br;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Br||(Br={}));const Hr={collections:{base:{InputBoxShadow:u`
    ...
    `,ElevationBoxShadow:u`
      0px 2px 8px ${Mt.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},kr=e=>t=>{var r;const n=t.theme,a=kt(Hr,n[Et.designTokenScheme]);return(null===(r=n.options)||void 0===r?void 0:r.designToken)?Ht(a,e,n.options.designToken):Ht(a,e)},Er={InputBoxShadow:kr("InputBoxShadow"),InputErrorBoxShadow:kr("InputErrorBoxShadow"),ElevationBoxShadow:kr("ElevationBoxShadow"),Table:{Header:kr("Table.Header"),Cell:{Primary:kr("Table.Cell.Primary"),Secondary:kr("Table.Cell.Secondary"),Selected:kr("Table.Cell.Selected"),Hover:kr("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:kr("Button.Danger.BackgroundColor"),Hover:kr("Button.Danger.Hover"),Primary:kr("Button.Danger.Primary"),Border:kr("Button.Danger.Border")}}},Ar=c.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
