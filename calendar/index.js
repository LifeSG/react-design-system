...
`,ur={Regular:"Open Sans",Semibold:"Open Sans Semibold",Bold:"Open Sans Bold",Light:"Open Sans Light"},hr={collections:{base:{D1:{fontFamily:ur.Bold,fontSize:3,fontWeight:700,lineHeight:4,letterSpacing:-.056},D2:{fontFamily:ur.Bold,fontSize:2.5,fontWeight:700,lineHeight:3.5,letterSpacing:-.032},D3:{fontFamily:ur.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},D4:{fontFamily:ur.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},DBody:{fontFamily:ur.Regular,fontSize:1.375,lineHeight:1.75},H1:{fontFamily:ur.Bold,fontSize:2,fontWeight:700,lineHeight:2.5},H2:{fontFamily:ur.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},H3:{fontFamily:ur.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},H4:{fontFamily:ur.Bold,fontSize:1.125,fontWeight:700,lineHeight:1.625},H5:{fontFamily:ur.Bold,fontSize:1,fontWeight:700,lineHeight:1.5,letterSpacing:.014},H6:{fontFamily:ur.Bold,fontSize:.875,fontWeight:700,lineHeight:1.6,letterSpacing:.012},Body:{fontFamily:ur.Regular,fontSize:1.125,lineHeight:1.625},BodySmall:{fontFamily:ur.Regular,fontSize:1,lineHeight:1.5,letterSpacing:.014},XSmall:{fontFamily:ur.Regular,fontSize:.75,lineHeight:1.2,letterSpacing:.012}}},defaultValue:"base"},fr=e=>t=>{const r=t.theme,n=Et(hr,r[At.textStyleScheme]);return r.options&&r.options.textStyle?Ht(n,e,r.options.textStyle):Ht(n,e)},gr={D1:{fontFamily:fr("D1.fontFamily"),fontSize:fr("D1.fontSize"),fontWeight:fr("D1.fontWeight"),lineHeight:fr("D1.lineHeight"),letterSpacing:fr("D1.letterSpacing")},D2:{fontFamily:fr("D2.fontFamily"),fontSize:fr("D2.fontSize"),fontWeight:fr("D2.fontWeight"),lineHeight:fr("D2.lineHeight"),letterSpacing:fr("D2.letterSpacing")},D3:{fontFamily:fr("D3.fontFamily"),fontSize:fr("D3.fontSize"),fontWeight:fr("D3.fontWeight"),lineHeight:fr("D3.lineHeight"),letterSpacing:fr("D3.letterSpacing")},D4:{fontFamily:fr("D4.fontFamily"),fontSize:fr("D4.fontSize"),fontWeight:fr("D4.fontWeight"),lineHeight:fr("D4.lineHeight"),letterSpacing:fr("D4.letterSpacing")},DBody:{fontFamily:fr("DBody.fontFamily"),fontSize:fr("DBody.fontSize"),fontWeight:fr("DBody.fontWeight"),lineHeight:fr("DBody.lineHeight"),letterSpacing:fr("DBody.letterSpacing")},H1:{fontFamily:fr("H1.fontFamily"),fontSize:fr("H1.fontSize"),fontWeight:fr("H1.fontWeight"),lineHeight:fr("H1.lineHeight"),letterSpacing:fr("H1.letterSpacing")},H2:{fontFamily:fr("H2.fontFamily"),fontSize:fr("H2.fontSize"),fontWeight:fr("H2.fontWeight"),lineHeight:fr("H2.lineHeight"),letterSpacing:fr("H2.letterSpacing")},H3:{fontFamily:fr("H3.fontFamily"),fontSize:fr("H3.fontSize"),fontWeight:fr("H3.fontWeight"),lineHeight:fr("H3.lineHeight"),letterSpacing:fr("H3.letterSpacing")},H4:{fontFamily:fr("H4.fontFamily"),fontSize:fr("H4.fontSize"),fontWeight:fr("H4.fontWeight"),lineHeight:fr("H4.lineHeight"),letterSpacing:fr("H4.letterSpacing")},H5:{fontFamily:fr("H5.fontFamily"),fontSize:fr("H5.fontSize"),fontWeight:fr("H5.fontWeight"),lineHeight:fr("H5.lineHeight"),letterSpacing:fr("H5.letterSpacing")},H6:{fontFamily:fr("H6.fontFamily"),fontSize:fr("H6.fontSize"),fontWeight:fr("H6.fontWeight"),lineHeight:fr("H6.lineHeight"),letterSpacing:fr("H6.letterSpacing")},Body:{fontFamily:fr("Body.fontFamily"),fontSize:fr("Body.fontSize"),fontWeight:fr("Body.fontWeight"),lineHeight:fr("Body.lineHeight"),letterSpacing:fr("Body.letterSpacing")},BodySmall:{fontFamily:fr("BodySmall.fontFamily"),fontSize:fr("BodySmall.fontSize"),fontWeight:fr("BodySmall.fontWeight"),lineHeight:fr("BodySmall.lineHeight"),letterSpacing:fr("BodySmall.letterSpacing")},XSmall:{fontFamily:fr("XSmall.fontFamily"),fontSize:fr("XSmall.fontSize"),fontWeight:fr("XSmall.fontWeight"),lineHeight:fr("XSmall.lineHeight"),letterSpacing:fr("XSmall.letterSpacing")}},pr=e=>{switch(e){case 700:case"bold":return ur.Bold;case 600:case"semibold":return ur.Semibold;case 300:case"light":return ur.Light;case 400:case"regular":return ur.Regular;default:return""}},mr=(e,t)=>r=>{var n;const a=gr[e].fontFamily(r),i=gr[e].fontWeight(r);return Object.values(ur).includes(a)?u`
    ...
    `,e.XSmall=c.span`
        ${e=>u`
                ...
                ${$r(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.Hyperlink={Default:e=>xr(Object.assign(Object.assign({},e),{textStyle:"Body"})),Small:e=>xr(Object.assign(Object.assign({},e),{textStyle:"BodySmall"}))}}(vr||(vr={}));const Sr=c.a`
    ${e=>u`
...
`,xr=r=>{var{external:n=!1,children:a}=r,i=m(r,["external","children"]);return e(Sr,Object.assign({},i,{children:[a,n&&t(Fr,{})]}))};var wr;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(wr||(wr={}));const Br={collections:{base:{InputBoxShadow:u`
    ...
    `,ElevationBoxShadow:u`
      0px 2px 8px ${Mt.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Hr=e=>t=>{var r;const n=t.theme,a=Et(Br,n[At.designTokenScheme]);return(null===(r=n.options)||void 0===r?void 0:r.designToken)?Ht(a,e,n.options.designToken):Ht(a,e)},Er={InputBoxShadow:Hr("InputBoxShadow"),InputErrorBoxShadow:Hr("InputErrorBoxShadow"),ElevationBoxShadow:Hr("ElevationBoxShadow"),Table:{Header:Hr("Table.Header"),Cell:{Primary:Hr("Table.Cell.Primary"),Secondary:Hr("Table.Cell.Secondary"),Selected:Hr("Table.Cell.Selected"),Hover:Hr("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Hr("Button.Danger.BackgroundColor"),Hover:Hr("Button.Danger.Hover"),Primary:Hr("Button.Danger.Primary"),Border:Hr("Button.Danger.Border")}}},Ar=c.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return u`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Er.Button.Danger.Border:Mt.Primary};

                    span {
                        color: ${e.$buttonIsDanger?Er.Button.Danger.Primary:Mt.Primary};
                    }
                `;case"light":return u`
                    background-color: ${Mt.Neutral[8]};
                ...
                `;case"link":return u`
                    ...
                    :focus {
                        span {
                            color: ${e.$buttonIsDanger?Er.Button.Danger.Hover:Mt.Secondary};
                        }
                    }
                `;default:return u`
                    background-color: ${e.$buttonIsDanger?Er.Button.Danger.BackgroundColor:Mt.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?u`
                ...
                `}
`,Or=c((({color:r,className:n,size:a=18})=>e(ir,Object.assign({className:n,$size:a,$color:r},{children:[t(sr,{id:"inner1",$size:a-2,$borderWidth:2,$color:r}),t(lr,{id:"inner2",$size:a-2,$borderWidth:2,$color:r}),t(cr,{id:"inner3",$size:a-2,$borderWidth:2,$color:r}),t(dr,{id:"inner4",$size:a-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Er.Button.Danger.Primary:Mt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Mt.Neutral[3](e);break;default:t=Mt.Neutral[8](e)}return u`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Lr=n.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=m(e,["children","focusHighlight","focusOutline","type"]);return t(Mr,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),Cr=u`
    color: ${Mt.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,Yr=c(f)`
    ...
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-month":return u`
                ...
                `;case"selected-month":return u`
                    ...
                    color: ${Mt.Primary(e)};
                `}}}
`,Kr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:i,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const f=a((()=>Zt.generateMonths(Ct(e))),[e]),g=e=>{const t="start"===r&&i&&e.isAfter(i,"month")&&l,a="end"===r&&n&&e.isBefore(n,"month")&&l;return t||a},p=e=>{const t=e.format("MMMM"),r=(n=e,!Zt.isWithinRange(n,c?Ct(c):void 0,d?Ct(d):void 0,"month"));var n;const a=o.isSame(e,"month")?"selected-month":Ct().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||g(e),interactive:!r||u,month:t,variant:a}};return f.length?t(Jr,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:a,month:i}=p(e);return t(qr,Object.assign({$variant:a,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Qr,Object.assign({weight:"regular",$variant:a,$disabledDisplay:r},{children:i}))}),i)}))})):null},en=c.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,rn=c(vr.H5)`
    ${e=>{if(e.$disabledDisplay)return u`
            ...
            `;switch(e.$variant){case"current-year":return u`
                ...
                `}}}
`,nn=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:i,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onYearSelect:h})=>{const f=a((()=>Zt.generateDecadeOfYears(Ct(e))),[e]),g=e=>{const t="start"===r&&i&&e.isAfter(i,"year")&&l,a="end"===r&&n&&e.isBefore(n,"year")&&l;return t||a},p=e=>{const t=[0,11].includes(f.indexOf(e)),r=e.year(),n=(a=e,!Zt.isWithinRange(a,c?Ct(c):void 0,d?Ct(d):void 0,"year"));var a;const i=t?"other-decade":o.isSame(e,"year")?"selected-year":Ct().isSame(e,"year")?"current-year":"default";return{disabledDisplay:n||g(e),interactive:!n||u,year:r,variant:i}};return f.length?t(en,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:a,year:i}=p(e);return t(tn,Object.assign({$variant:a,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(rn,Object.assign({weight:"regular",$variant:a,$disabledDisplay:r,$interactive:n},{children:i}))}),i)}))})):null},an=n.forwardRef(((n,a)=>{var{children:c,initialCalendarDate:d,type:u,minDate:h,maxDate:f,currentFocus:g,selectedStartDate:p,selectedEndDate:y,selectWithinRange:D,dynamicHeight:b=!1,allowDisabledSelection:$,onCalendarDateChange:v,withButton:S,doneButtonDisabled:F,onDismiss:x,showNavigationHeader:w=!0,getLeftArrowDate:B,getRightArrowDate:H,isLeftArrowDisabled:E,isRightArrowDisabled:A,getMonthHeaderLabel:O,getYearHeaderLabel:k}=n,M=m(n,["children","initialCalendarDate","type","minDate","maxDate","currentFocus","selectedStartDate","selectedEndDate","selectWithinRange","dynamicHeight","allowDisabledSelection","onCalendarDateChange","withButton","doneButtonDisabled","onDismiss","showNavigationHeader","getLeftArrowDate","getRightArrowDate","isLeftArrowDisabled","isRightArrowDisabled","getMonthHeaderLabel","getYearHeaderLabel"]);const[L,C]=i(Qt.toDayjs(d)),[Y,T]=i(Qt.toDayjs(d)),[j,z]=i("default"),N=o(null),_=o(null),W=o();s(a,(()=>({defaultView(){z("default")},resetView(){const e=Qt.toDayjs(d);C(e),T(e),z("default")},setCalendarDate(e){const t=Qt.toDayjs(e);C(t),T(t)}}))),l((()=>{const e=Qt.toDayjs(d);C(e),T(e)}),[d]),l((()=>{X(Y)}),[Y]);const R=()=>{"month-options"!==j?(z("month-options"),W.current.focus()):(z("default"),C(Y))},I=()=>{"default"!==j?(z("default"),C(Y)):z("year-options")},P=()=>{W.current.focus();const e=B?B(L):L.subtract(1,"month");switch(j){case"default":T(e),C(e);break;case"month-options":C((e=>e.subtract(1,"year")));break;case"year-options":C((e=>e.subtract(10,"year")))}},V=()=>{W.current.focus();const e=H?H(L):L.add(1,"month");switch(j){case"default":T(e),C(e);break;case"month-options":C((e=>e.add(1,"year")));break;case"year-options":C((e=>e.add(10,"year")))}},Z=e=>{C(e),T(e),S||z("default")},U=()=>{const e=Qt.toDayjs(d);C(e),T(e),"default"===j?G("reset"):z("default")},X=e=>{v&&v(e)},G=e=>{x&&x(e)},J=()=>{if(!h||$)return!1;const e=Ct(h);return"month-options"===j?!Zt.isPreviousYearWithinRange(L,e):"year-options"===j?!Zt.isPreviousDecadeWithinRange(L,e):E?E(L):!Zt.isPreviousMonthWithinRange(L,e)},q=()=>{if(!f||$)return!1;const e=Ct(f);return"month-options"===j?!Zt.isNextYearWithinRange(L,e):"year-options"===j?!Zt.isNextDecadeWithinRange(L,e):A?A(L):!Zt.isNextMonthWithinRange(L,e)},Q=()=>{if("year-options"===j){const{beginDecade:e,endDecade:t}=Zt.getStartEndDecade(L);return`${e} to ${t}`}return k?k(L):L.format("YYYY")},K=()=>{const n=O?O(L):L.format("MMM");return e(r,{children:[e(Pr,Object.assign({type:"button",tabIndex:-1,$expanded:"month-options"===j,$visible:"default"===j,id:"month-dropdown",onClick:R},{children:[t(Vr,{children:n}),t(jr,{})]})),e(Pr,Object.assign({type:"button",tabIndex:-1,$expanded:"default"!==j,id:"year-dropdown",onClick:I},{children:[t(Vr,{children:Q()}),t(jr,{})]}))]})},ee=()=>{switch(j){case"month-options":return t(Kr,{type:u,calendarDate:L,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:y,viewCalendarDate:Y,isNewSelection:D,onMonthSelect:Z,allowDisabledSelection:$});case"year-options":return t(nn,{type:u,calendarDate:L,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:y,viewCalendarDate:Y,isNewSelection:D,onYearSelect:Z,allowDisabledSelection:$});default:return null}};return e(zr,Object.assign({ref:W,tabIndex:-1,"data-id":"calendar-container","data-testid":"calendar-container"},M,{children:[w&&e(Rr,Object.assign({"data-id":"calendar-header","data-testid":"calendar-header"},{children:[t(Ir,{children:K()}),e(Zr,{children:[t(Ur,Object.assign({"data-testid":"left-arrow-btn",disabled:J(),focusHighlight:!1,tabIndex:-1,onClick:P},{children:t(Yr,{})})),t(Ur,Object.assign({"data-testid":"right-arrow-btn",disabled:q(),focusHighlight:!1,tabIndex:-1,onClick:V},{children:t(Tr,{})}))]})]})),t(Nr,{children:(()=>{const n="function"==typeof c?c({calendarDate:Y,currentView:j}):c;return e(r,b?{children:["default"===j&&n,ee()]}:{children:[t(_r,{children:n}),t(Wr,Object.assign({$visible:"default"!==j},{children:ee()}))]})})()}),(()=>{if(!S)return;const r=!!("default"===j)&&F;return e(Xr,{children:[t(Gr,Object.assign({ref:_,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:U},{children:"Cancel"})),t(Gr,Object.assign({"data-testid":"done-button",ref:N,type:"button",onClick:()=>{r||(C(Y),"default"===j?G("confirmed"):z("default"))},disabled:r},{children:"Done"}))]})})()]}))})),on=c.div`
    width: 100%;
    display: grid;
...
`,c(dn)`
    ...
    ${e=>{const{$disabledDisplay:t,$overlap:r,$variant:n}=e;return r?u`
            ...
            `:"today"===n?u`
                    background: ${Mt.Accent.Light[5]};
                `:void 0}}
`;const un=e=>{let t=Mt.Neutral[8],r="1px solid transparent";switch(e.$type){case"current":t=Mt.Accent.Light[5];break;case"hover-dash":t=Mt.Accent.Light[6],r=`1px dashed ${Mt.Accent.Light[4](e)}`;break;case"hover-current":t=Mt.Neutral[8],r=`1px solid ${Mt.Primary(e)}`;break;case"selected":t=Mt.Accent.Light[5],r=`1px solid ${Mt.Accent.Light[4](e)}`;break;case"selected-outline":t=Mt.Accent.Light[5],r=`1px solid ${Mt.Primary(e)}`;break;case"overlap":t=Mt.Accent.Light[4],r=`1px solid ${Mt.Accent.Light[4](e)}`;break;case"overlap-outline":t=Mt.Accent.Light[4],r=`1px solid ${Mt.Primary(e)}`}return{color:t,border:r}},hn=c.div`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
