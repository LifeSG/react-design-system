import type { CommonCalendarProps, YearMonthDisplay } from "../shared/internal-calendar/types";
...
export type CalendarProps = CalendarBaseProps & (CalendarSingleProps | CalendarMultiProps);
