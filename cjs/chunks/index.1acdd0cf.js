...
`;const Rs=t.forwardRef((function(n,r){var{title:i,children:o,expanded:a,type:s="default",collapsible:l=!0}=n,c=X(n,["title","children","expanded","type","collapsible"]);const d=t.useRef(),u=t.useContext(q),[f,h]=t.useState(!l||(null!=a?a:u)),[p,g]=t.useState(!1),m=c["data-testid"]||"accordion-item",b=qe(),v=b.ref;t.useImperativeHandle(r,(()=>Object.assign(d.current,{expand(){h(!0)},collapse(){h(!1)},isExpanded:()=>f})),[f]),t.useEffect((()=>{p&&h(!l||u)}),[u]),t.useEffect((()=>{p&&h(a)}),[a]),t.useEffect((()=>{g(!0)}),[]);const y={height:f?b.height:0},x=di(y);return e.jsxs(ks,Object.assign({"data-testid":m,className:c.className,$isCollapsed:f,ref:d},{children:[e.jsxs(Cs,Object.assign({$isCollapsed:l,onClick:l?e=>{e.preventDefault(),h((e=>!e))}:void 0},{children:["string"!=typeof i?i:"small"===s?e.jsx(Ds,Object.assign({"data-testid":`${m}-title`,$isCollapsed:f},{children:i})):e.jsx(Ts,Object.assign({"data-testid":`${m}-title`,$isCollapsed:f},{children:i})),l&&e.jsx(Is,Object.assign({"data-testid":`${m}-expand-collapse-button`,$isCollapsed:f,focusHighlight:!1,focusOutline:"browser","aria-label":f?"Collapse":"Expand"},{children:e.jsx(Es,{})}))]})),e.jsx(_s,Object.assign({style:p?x:y,$isCollapsed:f,"data-testid":`${m}-expandable-container`},{children:e.jsx(Ms,Object.assign({ref:v,id:"content-container"},{children:o}))}))]}))})),Ns={collections:{base:{InputBoxShadow:i.css`
    ...
    `,ElevationBoxShadow:i.css`
      0px 2px 8px ${ts.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},As=e=>t=>{var n;const r=t.theme,i=Za(Ns,r[exports.ThemeContextKeys.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?Ga(i,e,r.options.designToken):Ga(i,e)},Bs={InputBoxShadow:As("InputBoxShadow"),InputErrorBoxShadow:As("InputErrorBoxShadow"),ElevationBoxShadow:As("ElevationBoxShadow"),Table:{Header:As("Table.Header"),Cell:{Primary:As("Table.Cell.Primary"),Secondary:As("Table.Cell.Secondary"),Selected:As("Table.Cell.Selected"),Hover:As("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:As("Button.Danger.BackgroundColor"),Hover:As("Button.Danger.Hover"),Primary:As("Button.Danger.Primary"),Border:As("Button.Danger.Border")}}},Fs=K.default.div`
    display: inline-block;
    position: relative;
    width: ${e=>e.$size}px;
    height: ${e=>e.$size}px;
...
`,Rf=K.default.div`
    ...
    ${e=>e.$disabled?i.css`
            ...
            `:e.$hide?i.css`
                display: none;
            `:void 0}
`;Wl.extend(Yl);const Nf=Y.default.forwardRef((({disabled:n,readOnly:r,names:i,value:o,focused:a,hoverValue:s,placeholder:l,label:c,onChange:d,onFocus:u,onBlur:f,hideInputKeyboard:h},p)=>{const g=h?"none":"numeric",[m,b,v]=bc(""),[y,x,w]=bc(""),[$,j,S]=bc(""),[k,C]=t.useState("none"),[O,T]=t.useState(!1),D=t.useRef(null),I=t.useRef(null),E=t.useRef(null),_=t.useRef(null),[M,R,N]=z(s);t.useEffect((()=>{var e;const[t="",n="",r=""]=z(o);b(t),x(n),j(r),t||n||r||!D.current||!D.current.contains(document.activeElement)||null===(e=I.current)||void 0===e||e.focus()}),[o]),t.useEffect((()=>{a||C("none"),a&&(T(!0),I.current&&D.current&&!D.current.contains(document.activeElement)&&I.current.focus())}),[a]),t.useImperativeHandle(p,(()=>({ref:D,resetPlaceholder(){T(!1)},resetInput(){const[e="",t="",n=""]=z(o);b(e),x(t),j(n)}})),[o]);const A=e=>{var t;e.preventDefault(),null===(t=I.current)||void 0===t||t.focus()},B=e=>{e.target.select();const t=e.target.name;C(t)},F=e=>{const[t,n,r]=i,o={[t]:v.current,[n]:w.current,[r]:S.current},a=e.target.name,s=o[a],l=a!==r?dc.padValue(s,!0):s;switch(a){case t:o[t]=l,b(l);break;case n:o[n]=l,x(l)}const c=`${o[r]}-${o[n]}-${o[t]}`,u=Wl(c,"YYYY-MM-DD",!0).isValid(),h=!o[t]&&!o[n]&&!o[r];u&&s!==l&&d(c),D.current&&!D.current.contains(e.relatedTarget)&&(C("none"),null==f||f(h||u))},L=e=>{var t,n;if(s)return;const r=e.target.name,o=e.target.value.replace(/[^0-9]/g,""),a={day:m,month:y,year:$};switch(r){case i[0]:a.day=o,b(o),2===o.length&&(null===(t=E.current)||void 0===t||t.focus());break;case i[1]:a.month=o,x(o),2===o.length&&(null===(n=_.current)||void 0===n||n.focus());break;case i[2]:a.year=o,j(o)}if(!a.day&&!a.month&&!a.year)return void d("");const l=`${a.year}-${a.month}-${a.day}`;Wl(l,"YYYY-MM-DD",!0).isValid()&&d(l)},P=e=>{var t,n;"Backspace"!==e.code&&"Backspace"!==e.key||(k===i[1]&&0===y.length&&(null===(t=I.current)||void 0===t||t.focus()),k===i[2]&&0===$.length&&(null===(n=E.current)||void 0===n||n.focus()))};function z(e){if(e){const t=Wl(new Date(e));return t.isValid()?[dc.padValue(t.date().toString()),dc.padValue((t.month()+1).toString()),t.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e.jsxs(Of,Object.assign({role:"group","aria-label":c,onClick:()=>{n||r||(T(!0),I.current&&D.current&&!D.current.contains(document.activeElement)&&I.current.focus())},onFocus:e=>{n||(T(!0),a||null==u||u(e))}},{children:[e.jsxs(Tf,Object.assign({ref:D,$hover:!!s},{children:[e.jsx(If,{ref:I,name:i[0],maxLength:2,value:null!=M?M:m,onFocus:B,onBlur:F,onChange:L,type:"text",inputMode:g,pattern:"[0-9]{2}","data-testid":`${i[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==i[0]||r?"DD":""}),e.jsx(Mf,Object.assign({$inactive:0===m.length},{children:"/"})),e.jsx(Ef,{ref:E,name:i[1],maxLength:2,value:null!=R?R:y,onFocus:B,onBlur:F,onChange:L,onKeyDown:P,type:"text",inputMode:g,pattern:"[0-9]{2}","data-testid":`${i[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==i[1]||r?"MM":""}),e.jsx(Mf,Object.assign({$inactive:0===y.length},{children:"/"})),e.jsx(_f,{ref:_,name:i[2],maxLength:4,value:null!=N?N:$,onFocus:B,onBlur:F,onChange:L,onKeyDown:P,type:"text",inputMode:g,pattern:"[0-9]{4}","data-testid":`${i[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==i[2]||r?"YYYY":""})]})),(()=>{if(!o&&!r&&l)return e.jsx(Rf,Object.assign({$hide:O,$disabled:n,onMouseDown:A},{children:l}))})()]}))})),Af=K.default(Sf)`
    height: 3rem;
`,Bf=n=>{var{minDate:r,maxDate:i,disabled:o,disabledDates:a,error:s,hideInputKeyboard:l,value:c,onChange:d,onFocus:u,onBlur:f,onYearMonthDisplayChange:h,withButton:p=!0,readOnly:g,id:m,allowDisabledSelection:b,zIndex:v}=n,y=X(n,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection","zIndex"]);const[x,w]=t.useState(lc.sanitizeInput(c)),[$,j]=t.useState(lc.sanitizeInput(c)),[S,k]=t.useState(void 0),[C,O]=t.useState(!1),[T,D]=t.useState(!1),I=t.useRef(null),E=t.useRef();t.useEffect((()=>{const e=lc.sanitizeInput(c);w(e),j(e)}),[c]);const _=e=>{!b&&lc.isDateDisabled(e,{disabledDates:a,minDate:r,maxDate:i})||(j(e),p||(F(e),w(e),e&&O(!1)))},M=e=>{var t;j(e),p||(F(e),w(e),e&&(null===(t=I.current)||void 0===t||t.focus(),O(!1)),S&&k(void 0))},R=()=>{g||o||(O(!0),T||(D(!0),u&&u()))},N=e=>{var t;T&&!C&&I.current&&!I.current.contains(e.relatedTarget)&&(null===(t=E.current)||void 0===t||t.resetInput(),j(x),D(!1),L())},A=e=>{k(e)},B=e=>{var t;switch(e){case"reset":j(x);break;case"confirmed":w($),F($)}null===(t=I.current)||void 0===t||t.focus(),O(!1)},F=e=>{d&&d(e)},L=()=>{f&&f()};return e.jsx(vf,{enabled:!g&&!o,isOpen:C,renderElement:()=>e.jsx(Af,Object.assign({tabIndex:-1,ref:I,onBlur:N,onFocus:R,$disabled:o,$readOnly:g,$focused:T,$error:s,id:m,"data-testid":y["data-testid"]},y,{children:e.jsx(Nf,{ref:E,disabled:o,onChange:_,readOnly:g,focused:C,names:["start-day","start-month","start-year"],value:$,hoverValue:S,hideInputKeyboard:l})})),renderDropdown:({elementWidth:t})=>e.jsx(Td,{type:"input",variant:"single",initialCalendarDate:$,withButton:p,value:$,disabledDates:a,minDate:r,maxDate:i,allowDisabledSelection:b,onHover:A,onSelect:M,onDismiss:B,onYearMonthDisplayChange:h,width:t}),onClose:()=>{var e;null===(e=E.current)||void 0===e||e.resetInput(),j(x),O(!1),D(!1),L()},onDismiss:()=>{var e,t;null===(e=E.current)||void 0===e||e.resetInput(),null===(t=I.current)||void 0===t||t.focus(),j(x),O(!1)},customZIndex:v,offset:16})},Ff=K.default(ss)`
    height: 2.5rem;
    width: 2.5rem;
    padding: 0;
...
`,Gf=K.default.div`
    ...
    ${e=>e.$wrap&&i.css`
            height: fit-content;
        `}
`,Zf={initialStart:"",initialEnd:"",selectedStart:"",selectedEnd:"",currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1,focused:!1},Qf=n=>{var{minDate:r,maxDate:i,disabled:o,disabledDates:a,error:s,hideInputKeyboard:l,value:c,valueEnd:d,onChange:u,onFocus:f,onBlur:h,onYearMonthDisplayChange:p,withButton:g=!0,variant:m="range",numberOfDays:b=7,readOnly:v,id:y,allowDisabledSelection:x,zIndex:w}=n,$=X(n,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","valueEnd","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","variant","numberOfDays","readOnly","id","allowDisabledSelection","zIndex"]);const[j,S]=t.useState(),[k,C]=t.useState(void 0),[O,T]=t.useState(!1),[D,I]=t.useState(!1),E="week"===m,_="fixed-range"===m,[{selectedStart:M,selectedEnd:R,currentFocus:N,calendarOpen:A,isStartDirty:B,isEndDirty:F,focused:L},P]=(({initialState:e,reducers:n,name:r,debug:i})=>{const[o,a]=t.useReducer(((e,t)=>n[t.type]?n[t.type](e,t.payload):e),e);return[o,Object.fromEntries(Object.keys(n).map((e=>[e,t=>{i&&qf(r,e,t),a({type:e,payload:t})}])))]})({name:"date-range-input",initialState:Zf,reducers:{blur:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1,focused:!1}),dismiss:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1}),changeStart:(e,t)=>Object.assign(Object.assign({},e),{selectedStart:t,isStartDirty:!0}),changeEnd:(e,t)=>Object.assign(Object.assign({},e),{selectedEnd:t,isEndDirty:!0}),reselectStart:e=>Object.assign(Object.assign({},e),{selectedStart:"",currentFocus:"start"}),reselectEnd:e=>Object.assign(Object.assign({},e),{selectedEnd:"",currentFocus:"end"}),focus:(e,t)=>Object.assign(Object.assign({},e),{currentFocus:E?"none":_?"start":t,calendarOpen:!v,focused:!0}),cancel:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1}),done:(e,t)=>Object.assign(Object.assign({},e),{selectedStart:t.start,selectedEnd:t.end,initialStart:t.start,initialEnd:t.end,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1}),resetStart:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart}),resetEnd:e=>Object.assign(Object.assign({},e),{selectedEnd:e.initialEnd}),resetRange:(e,t)=>Object.assign(Object.assign({},e),{initialStart:t.start,selectedStart:t.start,initialEnd:t.end,selectedEnd:t.end})}}),z=t.useRef(!1),H=t.useRef(),W=t.useRef(),V=t.useRef(),Y=t.useRef(),U=(({maxWidth:e,targetRef:n})=>{const[r,i]=t.useState(!1);return qe({targetRef:n,refreshMode:"throttle",refreshRate:300,handleHeight:!1,onResize:t.useCallback((t=>{i(t<=e)}),[e])}),r})({maxWidth:320,targetRef:H});t.useEffect((()=>{P.resetRange({start:lc.sanitizeInput(c),end:lc.sanitizeInput(d)})}),[c,d]),t.useEffect((()=>{"start"===N?S(M):"end"===N&&S(R)}),[N]);const K=e=>{var t,n,r;"Enter"!==e.code||g||(M&&R?(P.done({start:M,end:R}),null==u||u(M,R)):(P.dismiss(),null===(t=H.current)||void 0===t||t.focus(),null===(n=V.current)||void 0===n||n.resetPlaceholder(),null===(r=Y.current)||void 0===r||r.resetPlaceholder()))},q=e=>{var t;if(le(e))return void(z.current=!0);if(P.changeStart(e),null===(t=W.current)||void 0===t||t.setCalendarDate(e),z.current=!1,!e)return void(g||R||!F||(P.resetRange({start:"",end:""}),null==u||u("","")));if(!R)return void P.focus("end");if(Wl(e).isAfter(R,"day"))P.reselectEnd();else{if(F)return g?void 0:(P.done({start:e,end:R}),void(null==u||u(e,R)));P.focus("end")}},G=e=>{var t;if(le(e))return void(z.current=!0);if(Wl(e).isBefore(M,"day")&&W.current)return P.changeStart(e),W.current.setCalendarDate(e),void P.reselectEnd();if(P.changeEnd(e),null===(t=W.current)||void 0===t||t.setCalendarDate(e),e){if(M)return g?void 0:(P.done({start:M,end:e}),void(null==u||u(M,e)));P.focus("start")}else g||M||!B||(P.resetRange({start:"",end:""}),null==u||u("",""))},Z=e=>{var t;if(le(e))return void(z.current=!0);if(P.changeStart(e),null===(t=W.current)||void 0===t||t.setCalendarDate(e),z.current=!1,!e)return void(g?P.changeEnd(""):(P.resetRange({start:"",end:""}),null==u||u("","")));const n=Wl(e).format("YYYY-MM-DD"),r=Wl(n).add(b-1,"day").format("YYYY-MM-DD");return P.changeStart(n),P.changeEnd(r),z.current=!1,g?void 0:(P.done({start:n,end:r}),void(null==u||u(n,r)))},Q=()=>{v||o||L||(P.focus("start"),null==f||f())},J=e=>{var t,n,r;L&&!A&&H.current&&!(null===(t=H.current)||void 0===t?void 0:t.contains(e.relatedTarget))&&(P.blur(),T(!1),I(!1),null===(n=V.current)||void 0===n||n.resetPlaceholder(),null===(r=Y.current)||void 0===r||r.resetPlaceholder(),null==h||h())},ee=e=>t=>{t.stopPropagation(),v||(P.focus(e),te(),ne(),L||null==f||f())},te=()=>{if(E){const e=sc.toDayjs(M).startOf("week").format("YYYY-MM-DD");T(!0),I(!0),S(e)}},ne=()=>{_&&(I(!0),S(M))},re=e=>{var t;e&&!z.current||(P.resetStart(),null===(t=V.current)||void 0===t||t.resetInput())},ie=e=>{var t;e&&!z.current||(P.resetEnd(),null===(t=Y.current)||void 0===t||t.resetInput())},oe=e=>{switch(m){case"week":(e=>{const t=Wl(e).startOf("week").format("YYYY-MM-DD"),n=Wl(e).endOf("week").format("YYYY-MM-DD");if(P.changeStart(t),P.changeEnd(n),z.current=!1,!g)P.done({start:t,end:n}),null==u||u(t,n)})(e);break;case"fixed-range":Z(e);break;default:"start"===N?q(e):"end"===N&&G(e)}},ae=e=>{var t;switch(null===(t=H.current)||void 0===t||t.focus(),e){case"reset":P.cancel();break;case"confirmed":P.done({start:M,end:R}),null==u||u(M,R)}},se=e=>{C(e)},le=e=>!x&&e&&lc.isDateDisabled(e,{disabledDates:a,minDate:r,maxDate:i}),ce=e=>{let t={start:void 0,end:void 0};switch(m){case"range":t={start:"start"===N?k:void 0,end:"end"===N?k:void 0};break;case"week":if(!k)return;t={start:Wl(k).startOf("week").format("YYYY-MM-DD"),end:Wl(k).endOf("week").format("YYYY-MM-DD")};break;case"fixed-range":if(!k)return;t={start:Wl(k).format("YYYY-MM-DD"),end:Wl(k).add(b-1,"day").format("YYYY-MM-DD")}}return t[e]};return e.jsx(vf,{enabled:!v&&!o,isOpen:A,onClose:()=>{var e,t;P.blur(),T(!1),I(!1),null===(e=V.current)||void 0===e||e.resetPlaceholder(),null===(t=Y.current)||void 0===t||t.resetPlaceholder(),null==h||h()},onDismiss:()=>{var e,t,n;P.dismiss(),null===(e=H.current)||void 0===e||e.focus(),null===(t=V.current)||void 0===t||t.resetPlaceholder(),null===(n=Y.current)||void 0===n||n.resetPlaceholder()},renderElement:()=>e.jsx(Xf,Object.assign({ref:H,tabIndex:-1,onFocus:Q,onBlur:J,$focused:L,$disabled:o,$readOnly:v,$error:s,$wrap:U,id:y,"data-testid":$["data-testid"],onKeyDown:K},$,{children:e.jsxs(Kf,Object.assign({currentActive:N,wrap:U,error:s},{children:[e.jsx(Gf,Object.assign({$wrap:U},{children:e.jsx(Nf,{ref:V,placeholder:"From",names:["start-day","start-month","start-year"],value:M,disabled:o,readOnly:O||v,focused:"start"===N,hoverValue:ce("start"),onChange:_?Z:q,onFocus:ee("start"),onBlur:re,hideInputKeyboard:l})})),e.jsx(Gf,Object.assign({$wrap:U},{children:e.jsx(Nf,{ref:Y,placeholder:"To",names:["end-day","end-month","end-year"],value:R,disabled:o,readOnly:D||v,focused:"end"===N,hoverValue:ce("end"),onChange:G,onFocus:ee("end"),onBlur:ie,hideInputKeyboard:l})}))]}))})),renderDropdown:({elementWidth:t})=>e.jsx(Td,{ref:W,type:"input",variant:m,initialCalendarDate:j,withButton:g,value:M,endValue:R,selectWithinRange:B||F,currentFocus:N,disabledDates:a,minDate:r,maxDate:i,allowDisabledSelection:x,onSelect:oe,onDismiss:ae,onHover:se,onYearMonthDisplayChange:p,numberOfDays:b,width:t}),customZIndex:w,offset:16})},Jf=K.default.div`
    position: relative;
...
`,hI=n=>{var{selectedOptions:r,placeholders:i={from:"Select",to:"Select"},options:o,disabled:a,className:s,readOnly:l,error:c,"data-testid":d,id:u,enableSearch:f=!1,searchFunction:h,searchPlaceholder:p,valueExtractor:g,valueToStringFunction:m,listExtractor:b,displayValueExtractor:v,onSelectOption:y,listStyleWidth:x,onShowOptions:w,onHideOptions:$,onRetry:j,optionsLoadState:S={from:"success",to:"success"},optionTruncationType:k="middle",renderCustomSelectedOption:C,renderListItem:O,renderCustomCallToAction:T}=n,D=X(n,["selectedOptions","placeholders","options","disabled","className","readOnly","error","data-testid","id","enableSearch","searchFunction","searchPlaceholder","valueExtractor","valueToStringFunction","listExtractor","displayValueExtractor","onSelectOption","listStyleWidth","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType","renderCustomSelectedOption","renderListItem","renderCustomCallToAction"]);const[I,E]=t.useState(),[_,M]=t.useState(),R=t.useRef(),N={from:t.useRef(),to:t.useRef()},[A,B]=t.useState("none");t.useEffect((()=>{E(null==r?void 0:r.from),M(null==r?void 0:r.to)}),[r]);const F=e=>t=>{t.stopPropagation(),t.preventDefault(),a||l||B("from"===e?"from":"to"===e&&I?"to":"from")},L=e=>{const t="from"===e?I:_;return v?v(t):g?g(t):null==t?void 0:t.toString()},P=(e,t)=>{if("middle"===k){let n=0;return N[e]&&N[e].current&&(n=N[e].current.getBoundingClientRect().width),dc.truncateOneLine((e=>"string"==typeof e?e:m(e)||e.toString())(t),n,120,8)}return t},z=e=>{!e&&$&&$(),e&&w&&w()},H=t=>{const n="from"===t?I:_;return n?C?C(n):e.jsx(uf,Object.assign({truncateType:k},{children:P(t,L(t))})):e.jsx(ff,Object.assign({truncateType:k},{children:P(t,i[t])}))},W=t=>e.jsx(df,Object.assign({onClick:F(t),ref:N[t],$disabled:a},{children:H(t)}));return e.jsxs(hf,Object.assign({show:"none"!==A,"data-testid":D["data-testid"],error:c&&!("none"!==A),disabled:a,readOnly:l,testId:d,onBlur:()=>{z(!1),B("none"),I&&_||(M(void 0),E(void 0))},className:s},{children:[e.jsxs(dI,{children:[e.jsx(fI,Object.assign({type:"button","data-testid":u||"selector",disabled:a,ref:R,onClick:F()},D,{children:e.jsxs(Kf,Object.assign({currentActive:(()=>{switch(A){case"from":return"start";case"to":return"end";case"none":return A}})()},{children:[W("from"),W("to")]}))})),"none"===A&&I&&_&&!l&&!a&&e.jsx(uI,Object.assign({onClick:e=>{e.stopPropagation(),E(void 0),M(void 0),y&&y({from:void 0,to:void 0},void 0)},type:"button","aria-label":"Clear"},{children:e.jsx(Hy,{"aria-hidden":!0})}))]}),"none"!==A&&e.jsx(cf,{}),(()=>{if("none"===A)return null;const t=o[A];if(t&&t.length>0){const n="from"===A?I:_;return e.jsx(Rj,{listItems:t,onSelectItem:(e,t)=>{return n=e,r=t,"from"===(i=A)?E(n):M(n),z(!1),R&&R.current&&R.current.focus(),y&&y({[i]:n},r),void("from"===i?(M(void 0),B("to"),z(!0)):B("none"));var n,r,i},onDismiss:()=>(B("none"),z(!1),R&&R.current&&R.current.focus(),void(I&&_||(M(void 0),E(void 0)))),valueExtractor:g,listExtractor:b,listStyleWidth:x,visible:!0,enableSearch:f,searchPlaceholder:p,searchFunction:h,"data-testid":`${A}-dropdown-list`,selectedItems:n?[n]:[],onRetry:j,itemsLoadState:S[A],itemTruncationType:k,renderListItem:O,renderCustomCallToAction:T})}return null})()]}))},pI=({selectedOption:n,placeholder:r="Select",options:i,disabled:o,error:a,className:s,"data-testid":l,id:c,enableSearch:d=!1,searchFunction:u,searchPlaceholder:f,valueExtractor:h,valueToStringFunction:p,listExtractor:g,displayValueExtractor:m,onSelectOption:b,onShowOptions:v,onHideOptions:y,onRetry:x,optionsLoadState:w="success",optionTruncationType:$="end",renderCustomSelectedOption:j,renderListItem:S,hideNoResultsDisplay:k,renderCustomCallToAction:C,onBlur:O,variant:T="default",readOnly:D,alignment:I,dropdownZIndex:E})=>{const[_,M]=t.useState(n),[R,N]=t.useState(!1),[A,B]=t.useState(!1),[F]=t.useState((()=>cc.generate())),L=t.useRef(),P=t.useRef(),z=t.useRef();t.useEffect((()=>{M(n)}),[n]);const H=(e,t)=>{var n;null===(n=P.current)||void 0===n||n.focus(),M(e),N(!1),K(!1),null==b||b(e,t)},W=()=>{R&&(N(!1),K(!1))},V=()=>{A||R||B(!0)},Y=e=>{A&&!R&&L.current&&!L.current.contains(e.relatedTarget)&&(B(!1),null==O||O())},U=e=>{if("middle"===$){let t=0;return z&&z.current&&(t=z.current.getBoundingClientRect().width),dc.truncateOneLine((e=>"string"==typeof e?e:p(e)||e.toString())(e),t,120,8)}return e},K=e=>{e?null==v||v():null==y||y()};return e.jsx(eT,{children:e.jsx(vf,{enabled:!D&&!o,isOpen:R,renderElement:()=>e.jsx(jf,Object.assign({className:s,"data-testid":l,id:c,ref:L,tabIndex:-1,onFocus:V,onBlur:Y,$focused:A,$disabled:o,$readOnly:D,$error:a},{children:e.jsx(OT,Object.assign({ref:P,disabled:o,expanded:R,listboxId:F,popupRole:"listbox",readOnly:D,variant:T},{children:e.jsx(df,Object.assign({ref:z,$disabled:o},{children:_?j?j(_):e.jsx(uf,Object.assign({truncateType:$,$variant:T},{children:U(m?m(_):h?h(_):_.toString())})):e.jsx(ff,Object.assign({truncateType:$,$variant:T},{children:r}))}))}))})),renderDropdown:({elementWidth:t})=>e.jsx(ST,{listboxId:F,listItems:i,onSelectItem:H,onDismiss:W,valueExtractor:h,listExtractor:g,enableSearch:d,searchPlaceholder:f,searchFunction:u,selectedItems:_?[_]:[],onRetry:x,itemsLoadState:w,itemTruncationType:$,renderListItem:S,hideNoResultsDisplay:k,renderCustomCallToAction:C,variant:T,width:t}),onOpen:()=>{N(!0),K(!0),B(!0)},onClose:e=>{N(!1),K(!1),"click"!==e&&(B(!1),null==O||O())},onDismiss:()=>{var e;null===(e=P.current)||void 0===e||e.focus(),N(!1),K(!1)},clickToToggle:!0,offset:8,alignment:I,fitAvailableHeight:!0,customZIndex:E})})},gI=K.default.div`
    overflow: hidden;
    border: 1px solid ${ts.Neutral[5]};
    border-radius: 4px;
    background: ${ts.Neutral[8]};
...
`,AI=({type:t,active:n=!1,disabled:r,className:i})=>{let o;switch(t){case"checkbox":o=n?e.jsx(k.SquareTickFillIcon,{}):e.jsx(S.SquareIcon,{});break;case"radio":o=n?e.jsx(I.CircleDotIcon,{}):e.jsx(D.CircleIcon,{});break;case"tick":o=e.jsx(C.TickIcon,{});break;case"cross":o=e.jsx(m.CrossIcon,{});break;default:o=null}return e.jsx(NI,Object.assign({className:i,$active:n,disabled:r},{children:o}))},BI=e=>`\n\tmargin-bottom: ${e||0}rem;\n`,FI=K.default.ol`
    ${e=>BI(e.bottomMargin)}
    margin-left: ${3}rem;
...
`,tN=Y.default.forwardRef(((t,n)=>{var{children:r,imgSrc:i,selected:o,error:a,type:s="button"}=t,l=X(t,["children","imgSrc","selected","error","type"]);return e.jsxs(eN,Object.assign({ref:n,$selected:o,$error:a,type:s},l,{children:[e.jsx(gp,{src:i}),r]}))})),nN=i.css`
    height: 1.125rem;
    width: 1.125rem;
    color: ${ts.Primary};
`,rN=K.default.div`
    border-top: 1px solid ${ts.Neutral[5]};
    border-bottom: 1px solid ${ts.Neutral[5]};
`,iN=K.default(exports.Text.H3)`
    color: ${ts.Primary};
    margin-bottom: 0.5rem;
`,oN=K.default(exports.Text.Body)`
    color: ${ts.Primary};
`,aN=K.default(h.ChevronRightIcon)`
    ${nN}
`,sN=K.default.a`
    padding: 1rem 0;
    display: flex;
...
`,lN=K.default.div`
    ...
    flex: 1;
    margin-right: 1rem;
`,cN=K.default(exports.Text.BodySmall)`
    margin-top: 0.25rem;
`,dN=K.default(Ti.div)`
    overflow: hidden;
`,uN=K.default.div`
    border-top: 1px solid ${ts.Neutral[5]};
`,fN=K.default(exports.Text.H5)`
    color: ${ts.Primary};
    margin-right: 0.5rem;
`,hN=K.default(N.PlusIcon)`
    ${nN}
`,pN=K.default(R.MinusIcon)`
    ${nN}
`,gN=K.default.button`
    display: flex;
    justify-content: center;
...
`,mN=K.default.div`
    ...
    ${e=>e.color&&i.css`
            color: ${e.color};
        `}
`,bN=t.forwardRef(((t,n)=>{const{baseTextColor:r,baseTextSize:i,inline:o}=t,a=X(t,["baseTextColor","baseTextSize","inline"]);return e.jsx(mN,Object.assign({ref:n,as:o?"span":"div",$textSize:i,$textColor:r},a))})),vN=K.default.div`
    margin-top: 2.5rem;
    display: grid;
    align-items: center;
    width: 100%;
...
`,yN=K.default.div`
    ...
    ${e=>{const{startLg:t,colsLg:n,startMd:r,colsMd:o,startSm:a,colsSm:s}=e;return i.css`
        ...
        `}}
`,xN={Grid:Y.default.forwardRef(((t,n)=>{const{children:r}=t,i=X(t,["children"]);return e.jsx(vN,Object.assign({ref:n},i,{children:r}))})),Tile:Y.default.forwardRef(((t,n)=>{const{children:r}=t,i=X(t,["children"]);return e.jsx(yN,Object.assign({ref:n},i,{children:r}))}))},wN=K.default.div`
...
`,$N=()=>{t.useEffect((()=>{n()||r()}),[]);const n=()=>document.getElementById(jN),r=()=>{if(!document.getElementById(jN)){const e=document.createElement("script");e.id=jN,e.type="module",e.src=SN,document.head.appendChild(e)}};return e.jsx(wN,{dangerouslySetInnerHTML:{__html:"<sgds-masthead></sgds-masthead>"}})},jN="lifesg-ds-masthead-script",SN="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component/Masthead/index.js",kN={notCompress:6,compress:4},CN=K.default.div`
...
`,ON=K.default.nav`
    height: ${e=>e.$compress?kN.compress:kN.notCompress}rem;
    width: 100%;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,RN=({resources:t,onClick:n,"data-id":r,"data-testid":i="navbar-brand",type:o})=>e.jsx(MN,Object.assign({role:"link",onClick:e=>{n&&n(e,o)},tabIndex:0,"data-id":r,"data-testid":i,$type:o},{children:e.jsx(gp,{src:t.logoSrc,alt:t.brandName})})),NN=K.default.div`
    display: none;
...
`,zN=Y.default.forwardRef(((n,r)=>{const{show:i,resources:o,children:a,hideNavBranding:s,onClose:l,onBrandClick:c}=n,[d,u]=t.useState(0),{primary:f,secondary:h}=o;t.useEffect((()=>(p(),window.addEventListener("resize",p),()=>{window.removeEventListener("resize",p)})),[]);const p=()=>{if(window){const e=.01*window.innerHeight;u(e)}};return e.jsx(NN,Object.assign({ref:r,"data-testid":"drawer"},{children:e.jsx(AN,Object.assign({$show:i,$viewHeight:d},{children:e.jsxs(BN,{children:[e.jsxs(FN,{children:[e.jsx(EN,Object.assign({"data-id":"drawer-brand-container"},{children:!s&&e.jsxs(e.Fragment,{children:[e.jsx(RN,{resources:f,compress:!0,onClick:c,"data-id":"drawer-brand-primary","data-testid":"drawer__brand",type:"primary"}),h&&e.jsxs(e.Fragment,{children:[e.jsx(_N,{}),e.jsx(RN,{resources:h,compress:!0,onClick:c,"data-id":"drawer-brand-secondary","data-testid":"drawer__brand-secondary",type:"secondary"})]})]})})),e.jsx(PN,Object.assign({onClick:l,focusHighlight:!1,"aria-label":"Close nav menu"},{children:e.jsx(LN,{})}))]}),a]})}))}))})),HN={primary:{brandName:"LifeSG",logoSrc:"https://assets.life.gov.sg/lifesg/logo-lifesg.svg"}},WN={primary:{brandName:"BookingSG",logoSrc:"https://www.booking.gov.sg/logo.svg"}},VN={primary:{brandName:"MyLegacy",logoSrc:"https://assets.life.gov.sg/ccube/logo-ccube.svg"}},YN={primary:{brandName:"CCube",logoSrc:"https://mylegacy.life.gov.sg/images/site-logo.png"}},UN=K.default.ul`
    display: flex;
    list-style: none;
    margin-left: 4rem;
    flex-shrink: 0;
...
`,QN=K.default(exports.Text.BodySmall)`
    margin-bottom: 0.5rem;
`,JN=K.default.div`
    display: flex;
`,eA=K.default.a`
...
`,tA=({actionButtons:t,mobile:n=!1,onActionButtonClick:r})=>{const i=e=>{e.stopPropagation()},o=e=>t=>{t.stopPropagation(),"download"===e.type&&window.scrollTo({left:0,top:document.body.scrollHeight,behavior:"smooth"}),r(t,e)},a=(t,n)=>{const r=t?(e=>{const t=sj(e,(e=>"download"===e.type));if(t>-1){const n=[...e],r=n.splice(t,1);return[...n,r[0]]}return e})(n):n;return r.map(((n,r)=>{let a;switch(n.type){case"download":a=t?(s=n.args,e.jsxs(ZN,{children:[e.jsx(QN,Object.assign({weight:"semibold"},{children:s&&s.children||"Download the app"})),e.jsxs(JN,{children:[e.jsx(eA,Object.assign({href:"https://apps.apple.com/sg/app/moments-of-life/id1383218758",target:"_blank",rel:"noopener noreferrer","data-testid":"button__app-store",onClick:i},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/apple-app-store.png",alt:"apple-app-store"})})),e.jsx(eA,Object.assign({href:"https://play.google.com/store/apps/details?id=sg.gov.app.mol&hl=en_SG",target:"_blank",rel:"noopener noreferrer","data-testid":"button__play-store",onClick:i},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/google-play-store.png",alt:"google-play-store"})}))]})]})):e.jsx(GN,Object.assign({},n.args,{type:"button",onClick:o(n),"data-testid":"action-button__download"},{children:"Download the app"}));break;case"button":{const i=n.args["data-testid"]?`action-button__${n.args["data-testid"]}`:`action-button__button-${t?"mobile-":""}${r+1}`;a=e.jsx(GN,Object.assign({},n.args,{type:"button",onClick:o(n),"data-testid":i}));break}case"component":{const e=n.args;a=e&&e.render||null;break}default:a=null}var s;if(a)return e.jsx(XN,Object.assign({$mobile:t},{children:a}),`action-button-${r+1}`)}))};if(t){const r=(null==t?void 0:t.mobile)||t.desktop,i=r.filter((e=>!!e.uncollapsible)),o=r.filter((e=>!e.uncollapsible));return n?e.jsx(e.Fragment,{children:o.length>0&&e.jsx(qN,{children:a(n,o)})}):e.jsxs(e.Fragment,{children:[i.length>0&&e.jsx(KN,{children:a(!1,i)}),t.desktop.length>0&&e.jsx(UN,{children:a(n,t.desktop)})]})}return e.jsx(e.Fragment,{})},nA=K.default.ul`
    width: 100%;
    overflow: auto;
    display: flex;
    flex-direction: column;
...
`,iA=K.default(exports.Text.Hyperlink.Small)`
...
`,aA=({items:t,mobile:n=!1,onItemClick:r})=>{const i=e=>t=>{t.stopPropagation(),r(t,e)},o=(n=!1)=>t.map(((t,r)=>{const{children:o,options:a}=t,s=X(t,["children","options"]),l=n?`link__mobile-${r+1}`:`link__${r+1}`;return e.jsx(oA,{children:e.jsx(iA,Object.assign({"data-testid":l,weight:"bold"},s,{onClick:i(t)},a,{children:o}))},r)}));if(t&&t.length>0){const t=n?rA:nA;return e.jsx(t,{children:o(n)})}return e.jsx(e.Fragment,{})},sA=K.default.ul`
    display: flex;
    list-style: none;
    position: relative;
...
`,dA=K.default(exports.Text.Hyperlink.Small)`
    display: flex;
    position: relative;
    align-items: center;
    text-align: center;
...
`,mA=({items:n,selectedId:r,mobile:i=!1,hideNavBranding:o,onItemClick:a})=>{const[s,l]=t.useState(-1),[c,d]=t.useState(!1),u=t.useRef(null);t.useEffect((()=>{const e=e=>{u.current&&!u.current.contains(e.target)&&f()};return document.addEventListener("click",e,!0),()=>{document.removeEventListener("click",e,!0)}}),[]);const f=()=>{d(!1)},h=(e,t)=>n=>{n.stopPropagation(),l(t),d(!0),a(n,e)},p=(e,t)=>{e.stopPropagation(),a(e,t),d(!1)},g=()=>n.map(((t,n)=>{if("component"===t.itemType){const r=t&&t.children||null;return e.jsx("li",{children:r},n)}{const a=(e=>{if(e.id===r)return!0;if((null==e?void 0:e.subMenu)&&e.subMenu.length>=1)return!!e.subMenu.find((e=>e.id===r));return!1})(t),{children:l,options:d}=t,u=X(t,["children","options"]),f=a?i?"bold":"semibold":"regular",g=i?`link__mobile-${n+1}`:`link__${n+1}`,m=s>=0&&s===n&&c;return e.jsxs(cA,Object.assign({$hiddenBranding:o},{children:[e.jsxs(dA,Object.assign({"data-testid":g,weight:f,$selected:a},u,{onClick:h(t,n)},d,{children:[e.jsx(uA,{children:l}),a&&e.jsx(fA,{"data-testid":`${g}-indicator`}),i&&t.subMenu&&e.jsx(hA,{children:e.jsx(pA,Object.assign({"data-testid":`${g}-expand-collapse-button`,$selected:m,focusHighlight:!1,focusOutline:"browser","aria-label":m?"Collapse":"Expand"},{children:e.jsx(gA,{})}))})]})),m&&e.jsx(aA,{items:t.subMenu,mobile:i,onItemClick:p})]}),n)}}));return n&&n.length>0?i?e.jsx(lA,Object.assign({ref:u},{children:g()})):e.jsx(sA,Object.assign({ref:u,$alignLeft:o},{children:g()})):e.jsx(e.Fragment,{})},bA=t.forwardRef(((n,r)=>{var{items:o,className:a,id:s,selectedId:l,compress:c=!1,fixed:d=!0,resources:u,hideNavElements:f=!1,hideNavBranding:h=!1,drawerDismissalExclusions:p=[],actionButtons:g,onItemClick:m,onActionButtonClick:b,onBrandClick:v,masthead:y=!0,layout:x="default"}=n,w=X(n,["items","className","id","selectedId","compress","fixed","resources","hideNavElements","hideNavBranding","drawerDismissalExclusions","actionButtons","onItemClick","onActionButtonClick","onBrandClick","masthead","layout"]);const[$,j]=t.useState(!1),[S,k]=t.useState(!1),C="stretch"===x,O=t.useRef(),T=i.useTheme(),D=(e=>{switch(e){case"bookingsg":return WN;case"mylegacy":return YN;case"ccube":return VN;default:return HN}})(null==T?void 0:T.resourceScheme),I=(null==u?void 0:u.primary)||D.primary,E=null==u?void 0:u.secondary;t.useImperativeHandle(r,(()=>Object.assign(O.current,{dismissDrawer:()=>{_()}})),[$]),t.useEffect((()=>(R(),window.addEventListener("resize",R),()=>{window.removeEventListener("resize",R)})),[]);const _=()=>{j(!1),setTimeout((()=>{k(!1)}),550)},M=e=>$&&-1===p.indexOf(e),R=()=>{window.innerWidth<=ns.tablet&&$&&_()},N=(e,t)=>{v&&(e.preventDefault(),v(t)),M("brand-click")&&_()},A=(e,t)=>{t.onClick?t.onClick(e):m&&(e.preventDefault(),m(t)),!(null==t?void 0:t.subMenu)&&M("item-click")&&_()},B=(e,t)=>{t.args&&t.args.onClick?t.args.onClick(e):b&&(e.preventDefault(),b(t)),M("item-click")&&_()},F=()=>{j(!0),k(!0)},L=()=>{M("close-button-click")&&_()},P=()=>{const t=o.mobile||o.desktop;return t&&t.length>0||g&&(()=>{const e=g.mobile||g.desktop;return!!e&&e.length&&e.some((e=>!e.uncollapsible))})()?e.jsx(DN,Object.assign({"aria-label":"Open nav menu","data-testid":"button__mobile-menu",onClick:F,focusHighlight:!1},{children:e.jsx(IN,{})})):null};return e.jsxs(CN,Object.assign({ref:O,$fixed:d,className:a,id:s||"navbar-wrapper","data-testid":w["data-testid"]||"navbar-wrapper"},{children:[y&&e.jsx($N,{}),e.jsxs(uy.Content,Object.assign({stretch:C},{children:[e.jsxs(ON,Object.assign({$compress:c},{children:[!h&&e.jsxs(EN,Object.assign({$compress:c,"data-id":"brand-container"},{children:[e.jsx(RN,{resources:I,onClick:N,"data-id":"brand-primary","data-testid":"main__brand",type:"primary"}),E&&e.jsxs(e.Fragment,{children:[e.jsx(_N,{$compress:c}),e.jsx(RN,{resources:E,onClick:N,"data-id":"brand-secondary","data-testid":"main__brand-secondary",type:"secondary"})]})]})),!f&&e.jsxs(TN,Object.assign({$hideNavBranding:h},{children:[e.jsx(mA,{items:o.desktop,onItemClick:A,selectedId:l,hideNavBranding:h}),e.jsx(tA,{actionButtons:g,onActionButtonClick:B}),P()]}))]})),!f&&e.jsx(sh,Object.assign({show:S,enableOverlayClick:!0,onOverlayClick:L},{children:e.jsxs(zN,Object.assign({show:$,resources:{primary:I,secondary:E},onClose:L,onBrandClick:N,actionButtons:g,hideNavBranding:h},{children:[e.jsx(mA,{items:o.mobile||o.desktop,onItemClick:A,selectedId:l,mobile:!0}),e.jsx(tA,{actionButtons:g,onActionButtonClick:B,mobile:!0})]}))}))]}))]}))})),vA=kN,yA=i.css`
    color: ${ts.Validation.Orange.Icon};
...
`,jA=K.default.div`
    ...
    ${e=>{const t="linear-gradient(to bottom, black 50%, transparent 100%)";if(e.$maxCollapsedHeight)return i.css`
                ...
                mask-image: ${t};
            `}}
`,SA=K.default(exports.Text.Hyperlink.Default)`
    position: relative;
...
`,UA=K.default.div`
    ...
    display: flex;
    justify-content: center;
`,KA=K.default(exports.Text.Body)`
    white-space: nowrap;
`,qA=K.default(exports.Text.Body)`
    white-space: nowrap;
    margin: 0 1rem;
`,XA=K.default(Vy)`
    ${ys.getTextStyle("Body",400)};
...
`,ZA=K.default.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,QA=Y.default.forwardRef((({id:n,"data-testid":r,className:i,pageSize:o=10,totalItems:a,activePage:s,pageSizeOptions:l=JA,showFirstAndLastNav:c,showPageSizeChanger:d=!1,onPageChange:u,onPageSizeChange:f},g)=>{const m=Tl.useMediaQuery({maxWidth:ns.mobileL}),b=l,[v,y]=t.useState(!1),[x,w]=t.useState(!1),[$,j]=t.useState(""),[S,k]=t.useState(b&&b.length>=1?b[0]:null),[C,O]=t.useState(!m&&d&&S?S.value:o),T=Math.ceil(a/C),D=1===s,I=s===T,E=s>1?()=>V(1):void 0,_=s<T?()=>V(T):void 0,M=s>1?()=>V(s-1):void 0,R=s<T?()=>V(parseInt(s.toString())+1):void 0,N=e=>e?()=>Z():()=>X(),A=e=>e?()=>Q():()=>G();t.useEffect((()=>{s&&H(s)}),[s]),t.useEffect((()=>{var e;O(o),k(null!==(e=b.find((e=>e.value===o)))&&void 0!==e?e:null)}),[o]);const H=e=>{j(e.toString())},W=()=>{y(!1),w(!1)},V=e=>{u&&(u(e),H(e))},Y=()=>{const e=Math.min(T,s+5);V(e),H(e),y(!0),w(!1)},U=()=>{const e=Math.max(1,s-5);V(e),H(e),y(!1),w(!0)},K=e=>{const t=e.target.value;if(void 0===t||0===t.length)j("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));H(Math.max(1,Math.min(T,e)))}else j(t.replace(/[^0-9]/g,""))},q=e=>{e.preventDefault(),$&&u(parseInt($))},X=()=>{y(!0)},G=()=>{y(!1)},Z=()=>{w(!0)},Q=()=>{w(!1)},J=(t,n,r)=>e.jsxs(YA,{children:[e.jsx(HA,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":t?"Previous 5 pages":"Next 5 pages",onMouseOver:N(t),onMouseOut:A(t),onFocus:N(t),onBlur:A(t),onClick:t?U:Y},{children:t&&x?e.jsx(B.Chevron2LeftIcon,{"aria-hidden":!0}):n&&v?e.jsx(F.Chevron2RightIcon,{"aria-hidden":!0}):e.jsx(z.EllipsisHorizontalIcon,{"aria-hidden":!0})})),t&&x&&e.jsx(GA,{children:"Previous 5 pages"}),n&&v&&e.jsx(GA,{children:"Next 5 pages"})]},r);return e.jsxs(LA,Object.assign({className:i,ref:g,id:n||"pagination-wrapper","data-testid":r||"pagination","aria-label":"Pagination"},{children:[e.jsx(PA,{children:e.jsxs(zA,{children:[c&&e.jsx(WA,Object.assign({onClick:E,disabled:D,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:e.jsx(L.ChevronLineLeftIcon,{"aria-hidden":!0})})),e.jsx(WA,Object.assign({onClick:M,disabled:D,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:e.jsx(p.ChevronLeftIcon,{"aria-hidden":!0})})),m?e.jsxs(UA,{children:[e.jsx("form",Object.assign({onSubmit:q},{children:e.jsx(XA,{value:$,onChange:K,autoComplete:"off",type:"numeric",id:(n||"pagination")+"-input","data-testid":(r||"pagination")+"-input"})})),e.jsx(qA,{children:"/"}),e.jsx(KA,{children:T})]}):[...Array(T)].map(((t,n)=>{const r=n+1,i=T-5,o=s===r;if(T<=7)return e.jsx(VA,Object.assign({onClick:()=>V(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:W,onFocus:W},{children:r}),r);const a=s+1>5&&2===r,l=s-1<=i&&r===T-1-1;return a||l?J(a,l,r):r<=5&&s+1<=5||r<=1||r===s||r<=s+1&&r>=s-1-1||r>i&&s-1>i||r>T-1?e.jsx(VA,Object.assign({onClick:()=>V(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:W,onFocus:W},{children:r}),r):null})),e.jsx(WA,Object.assign({onClick:R,disabled:I,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:e.jsx(h.ChevronRightIcon,{"aria-hidden":!0})})),c&&e.jsx(WA,Object.assign({onClick:_,disabled:I,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:e.jsx(P.ChevronLineRightIcon,{"aria-hidden":!0})}))]})}),d&&!m&&e.jsx(ZA,{children:e.jsx(pI,{options:b,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:S,onSelectOption:e=>{k(e);const t=e.value,n=Math.ceil(a/t);O(t);f&&f(s>=n?n:s,t)}})})]}))})),JA=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}],eB=K.default.div`
    border-radius: 1rem;
...
`;var gB=function(e){return function(t){return null==e?void 0:e[t]}}({"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","Ç":"C","ç":"c","Ð":"D","ð":"d","È":"E","É":"E","Ê":"E","Ë":"E","è":"e","é":"e","ê":"e","ë":"e","Ì":"I","Í":"I","Î":"I","Ï":"I","ì":"i","í":"i","î":"i","ï":"i","Ñ":"N","ñ":"n","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","Ø":"O","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","ø":"o","Ù":"U","Ú":"U","Û":"U","Ü":"U","ù":"u","ú":"u","û":"u","ü":"u","Ý":"Y","ý":"y","ÿ":"y","Æ":"Ae","æ":"ae","Þ":"Th","þ":"th","ß":"ss","Ā":"A","Ă":"A","Ą":"A","ā":"a","ă":"a","ą":"a","Ć":"C","Ĉ":"C","Ċ":"C","Č":"C","ć":"c","ĉ":"c","ċ":"c","č":"c","Ď":"D","Đ":"D","ď":"d","đ":"d","Ē":"E","Ĕ":"E","Ė":"E","Ę":"E","Ě":"E","ē":"e","ĕ":"e","ė":"e","ę":"e","ě":"e","Ĝ":"G","Ğ":"G","Ġ":"G","Ģ":"G","ĝ":"g","ğ":"g","ġ":"g","ģ":"g","Ĥ":"H","Ħ":"H","ĥ":"h","ħ":"h","Ĩ":"I","Ī":"I","Ĭ":"I","Į":"I","İ":"I","ĩ":"i","ī":"i","ĭ":"i","į":"i","ı":"i","Ĵ":"J","ĵ":"j","Ķ":"K","ķ":"k","ĸ":"k","Ĺ":"L","Ļ":"L","Ľ":"L","Ŀ":"L","Ł":"L","ĺ":"l","ļ":"l","ľ":"l","ŀ":"l","ł":"l","Ń":"N","Ņ":"N","Ň":"N","Ŋ":"N","ń":"n","ņ":"n","ň":"n","ŋ":"n","Ō":"O","Ŏ":"O","Ő":"O","ō":"o","ŏ":"o","ő":"o","Ŕ":"R","Ŗ":"R","Ř":"R","ŕ":"r","ŗ":"r","ř":"r","Ś":"S","Ŝ":"S","Ş":"S","Š":"S","ś":"s","ŝ":"s","ş":"s","š":"s","Ţ":"T","Ť":"T","Ŧ":"T","ţ":"t","ť":"t","ŧ":"t","Ũ":"U","Ū":"U","Ŭ":"U","Ů":"U","Ű":"U","Ų":"U","ũ":"u","ū":"u","ŭ":"u","ů":"u","ű":"u","ų":"u","Ŵ":"W","ŵ":"w","Ŷ":"Y","ŷ":"y","Ÿ":"Y","Ź":"Z","Ż":"Z","Ž":"Z","ź":"z","ż":"z","ž":"z","Ĳ":"IJ","ĳ":"ij","Œ":"Oe","œ":"oe","ŉ":"'n","ſ":"s"}),mB=Aa,bB=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,vB=RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]","g");var yB=function(e){return(e=mB(e))&&e.replace(bB,gB).replace(vB,"")},xB=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;var wB=function(e){return e.match(xB)||[]},$B=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;var jB=function(e){return $B.test(e)},SB="\\ud800-\\udfff",kB="\\u2700-\\u27bf",CB="a-z\\xdf-\\xf6\\xf8-\\xff",OB="A-Z\\xc0-\\xd6\\xd8-\\xde",TB="\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",DB="["+TB+"]",IB="\\d+",EB="["+kB+"]",_B="["+CB+"]",MB="[^"+SB+TB+IB+kB+CB+OB+"]",RB="(?:\\ud83c[\\udde6-\\uddff]){2}",NB="[\\ud800-\\udbff][\\udc00-\\udfff]",AB="["+OB+"]",BB="(?:"+_B+"|"+MB+")",FB="(?:"+AB+"|"+MB+")",LB="(?:['’](?:d|ll|m|re|s|t|ve))?",PB="(?:['’](?:D|LL|M|RE|S|T|VE))?",zB="(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?",HB="[\\ufe0e\\ufe0f]?",WB=HB+zB+("(?:\\u200d(?:"+["[^"+SB+"]",RB,NB].join("|")+")"+HB+zB+")*"),VB="(?:"+[EB,RB,NB].join("|")+")"+WB,YB=RegExp([AB+"?"+_B+"+"+LB+"(?="+[DB,AB,"$"].join("|")+")",FB+"+"+PB+"(?="+[DB,AB+BB,"$"].join("|")+")",AB+"?"+BB+"+"+LB,AB+"+"+PB,"\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])","\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",IB,VB].join("|"),"g");var UB=wB,KB=jB,qB=Aa,XB=function(e){return e.match(YB)||[]};var GB=UD,ZB=yB,QB=function(e,t,n){return e=qB(e),void 0===(t=n?void 0:t)?KB(e)?XB(e):UB(e):e.match(t)||[]},JB=RegExp("['’]","g");var eF=Ii(function(e){return function(t){return GB(QB(ZB(t).replace(JB,"")),e,"")}}((function(e,t,n){return e+(n?"-":"")+t.toLowerCase()})));const tF=K.default.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 1.5rem;
...
`,bP=K.default(nB)`
    padding: 0.125rem 0.5rem;
`,vP=["#FFE6BB","#D8EFEB","#E6EAFE","#FAE4E5","#D3EEFC"],yP=15,xP=252,wP=["#FFF2DD","#EBF7F5","#F2F4FE","#FCF1F2","#E9F6FD"],$P=i.keyframes`
    100% {
...
`,kP=K.default.div`
    ...
    justify-content: center;
    gap: 0.625rem;
`,CP=K.default(exports.Text.H6)`
    color: ${ts.Neutral[3]};
`,OP=K.default(zf)`
    width: 400px;
`,TP=t=>{var{selectedDate:n,loading:r,tableContainerRef:i,totalRecords:o,onPreviousDayClick:a,onNextDayClick:s,onRefresh:l,onCalendarDateSelect:c}=t,d=X(t,["selectedDate","loading","tableContainerRef","totalRecords","onPreviousDayClick","onNextDayClick","onRefresh","onCalendarDateSelect"]);const f=()=>{i.current&&(i.current.scrollTop=0)},h=()=>{l&&(f(),l())};return e.jsxs(SP,{children:[e.jsx(OP,Object.assign({selectedDate:n,loading:r},d,{onRightArrowClick:e=>{f(),s(e)},onLeftArrowClick:e=>{f(),a(e)},onCalendarDateSelect:c})),void 0===o?e.jsx(e.Fragment,{}):e.jsxs(kP,{children:[e.jsxs(CP,Object.assign({"data-testid":"timetable-records-results",weight:"semibold"},{children:[o," results found"]})),l&&e.jsx(jP,Object.assign({"data-testid":"timetable-records-refresh-btn",styleType:"light",sizeType:"small",disabled:r,onClick:h,$loading:r},{children:e.jsx(u.RefreshIcon,{})}))]})]})},DP=K.default.div`
    display: flex;
    width: 100%;
`,IP=K.default.div`
    border-bottom: 1px solid ${ts.Neutral[5]};
...
`,MP=K.default.div`
    ...
    ${({$status:e,$mainColor:t,$altColor:n,$isClickable:r})=>{switch(e){case"blocked":return i.css`
                ...
                `;default:return i.css`
                    &:hover {
                        background-color: ${r?ts.Accent.Light[5]:""};
                        cursor: ${r?"pointer":"default"};
                    }
                `}}}
`,RP=K.default(exports.Text.H6)`
    text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;
`,NP=K.default(exports.Text.XSmall)`
    color: ${ts.Neutral[3]};
    text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;
`,AP=Y.default.memo((({id:t,startTime:n,endTime:r,title:i,subtitle:o,status:a,intervalWidth:s,rowBarColor:l,containerRef:c,customPopover:d,roundedStartTime:u=n,roundedEndTime:f=r,onClick:h})=>{const p=0===Wl(f,"HH:mm").get("minutes"),g=sc.getTimeDiffInMinutes(u,f)/yP*s-2,m=!!h||d&&"click"===d.trigger;return e.jsx((({wrapper:e,children:t})=>d?e(t):t),Object.assign({wrapper:t=>(t=>{const n={position:"bottom-start",rootNode:c,customOffset:d.offset,children:t,trigger:d.trigger,delay:d.delay,popoverContent:d.content};return e.jsx(qv,Object.assign({},n,{children:t}))})(t)},{children:e.jsx(IP,Object.assign({"data-testid":"block-container",$isOnTheHour:p},{children:e.jsxs(EP,{children:[e.jsxs(MP,Object.assign({$width:g,$status:a,$mainColor:l.mainColor,$altColor:l.alternateColor,$isClickable:m,onClick:e=>{h&&h({id:t,startTime:n,endTime:r,status:a,title:i,subtitle:o,customPopover:d},e)}},{children:[i&&e.jsx(RP,Object.assign({weight:"semibold"},{children:i})),o&&e.jsx(NP,Object.assign({weight:"bold"},{children:o}))]})),e.jsx(_P,{})]})}),"block-container-key")}))})),BP=n=>{var{id:r,timetableMinTime:i,timetableMaxTime:o,rowMinTime:a,rowMaxTime:s,rowCells:l,rowBarColor:c,intervalWidth:d,containerRef:u,outOfRangeCellPopover:f}=n,h=X(n,["id","timetableMinTime","timetableMaxTime","rowMinTime","rowMaxTime","rowCells","rowBarColor","intervalWidth","containerRef","outOfRangeCellPopover"]);const p=h["data-testid"]||"timetable-row",g=a?vu.roundToNearestInterval(a,yP):i,m=s?vu.roundToNearestInterval(s,yP,!0):o,b=t.useMemo((()=>{const e=[];g&&Wl(i,"HH:mm").isBefore(Wl(g,"HH:mm"))&&e.push({id:r,startTime:i,endTime:g,status:"blocked",customPopover:f});const t=[...l].sort(((e,t)=>{const n=Wl(e.startTime,"HH:mm"),r=Wl(t.startTime,"HH:mm");return n.isBefore(r)?-1:n.isAfter(r)?1:0}));let n;return t.forEach(((i,o)=>{var a;const{startTime:s,endTime:l}=i;let c=vu.roundToNearestInterval(s,yP);n&&Wl(c,"HH:mm").isBefore(Wl(n,"HH:mm"))&&(c=vu.roundToNearestInterval(s,yP,!0));const d=vu.roundToNearestInterval(l,yP,!0);e.push(Object.assign(Object.assign({},i),{roundedStartTime:c,roundedEndTime:d}));const u=(null===(a=t[o+1])||void 0===a?void 0:a.startTime)||m,f=Wl(vu.roundToNearestInterval(u,yP),"HH:mm");let h=Wl(d,"HH:mm");for(;h.isBefore(f);)if(p=f,h.get("hour")!=p.get("hour")){const t=h.add(1,"hour").startOf("hour");e.push({id:r,startTime:h.format("HH:mm").toString(),endTime:t.format("HH:mm").toString(),status:"disabled"}),h=t}else e.push({id:r,startTime:h.format("HH:mm").toString(),endTime:f.format("HH:mm").toString(),status:"disabled"}),h=f;var p;n=h.format("HH:mm").toString()})),m&&Wl(o,"HH:mm").isAfter(Wl(m,"HH:mm"))&&e.push({id:r,startTime:m,endTime:o,status:"blocked",customPopover:f}),0!==t.length||a||s||e.push({id:r,startTime:i,endTime:o,status:"blocked",customPopover:f}),e}),[g,i,l,m,o,a,s,r,f]);return e.jsx(DP,Object.assign({"data-testid":p},h,{children:b.map(((t,n)=>e.jsx(AP,Object.assign({},t,{intervalWidth:d,rowBarColor:c,containerRef:u}),`${n}-row-cell-key`)))}))},FP=K.default.div``,LP=K.default.div`
    display: grid;
    overflow: scroll;
    position: relative;
    grid-template-columns: ${xP}px auto;
`,PP=K.default.div`
    display: grid;
    overflow: scroll;
    position: relative;
    grid-template-columns: ${xP}px fit-content(100%);
...
`,KP=K.default.div`
    ...
    border-bottom: 1px solid ${ts.Neutral[5]};
    border-left: 1px solid ${ts.Neutral[5]};
    transition: all 0.5s ease-in-out;
...
`,XP=K.default(exports.Text.XSmall)`
    display: inline-flex;
    gap: 6px;
    align-items: center;
    color: ${ts.Neutral[3]};
...
`,tz=K.default.div`
    ...
    animation: ${ez} 1.5s forwards infinite;
`,nz=K.default(qv)`
    max-width: 24rem !important;
    :hover {
        cursor: default;
    }
`,rz=e=>{switch(e.$type){case"success":return ts.Validation.Green;case"warning":return ts.Validation.Orange;case"error":return ts.Validation.Red;case"info":return ts.Validation.Blue;default:return}},iz=K.default(Ti.div)`
    display: flex;
    flex-direction: row;
    position: ${e=>e.$fixed?"fixed":"relative"};
    ...
    ${e=>i.css`
            background: ${rz(e).Background};
            border: 1px solid ${rz(e).Border};
            color: ${rz(e).Text};
        `};
`,oz=K.default.div`
    display: flex;
...
`,Sz=Y.default.forwardRef(((t,n)=>{var{stretch:r}=t,i=X(t,["stretch"]);return e.jsx(jz,Object.assign({ref:n,$stretch:r},i))})),kz=K.default.li`
    display: flex;
    flex-direction: column;
...
`,Iz=K.default(j.ExclamationTriangleIcon)`
    color: ${ts.Validation.Orange.Icon};
    margin-right: 0.5rem;
    height: 1.125rem;
    width: 1.125rem;
