...
`,VI=q.default.div`
    ...
    ${e=>e.$disabled?i.css`
            ...
            `:i.css`
                color: ${Qo.Neutral[1]};
            `}
`,YI=q.default(exports.Text.BodySmall)`
    color: ${e=>e.$disabled?Qo.Neutral[3]:Qo.Validation.Red.Text};
`,UI=q.default(EI.Ul)`
    li {
        color: ${e=>e.$disabled?Qo.Neutral[3]:Qo.Validation.Red.Text};
    }
`,qI=({type:n="checkbox",indicator:i,checked:a,styleType:o="default",children:s,childrenMaxLines:l,subLabel:c,disabled:d,error:u,name:f,id:h,className:m,compositeSection:g,removable:v,onRemove:b,"data-testid":x,onChange:y,useContentWidth:w})=>{const{collapsible:$=!0,errors:j,children:S,initialExpanded:k}=g||{},[C,O]=t.useState(a),[T,D]=t.useState(k),I=t.useMemo((()=>{const e=Array.isArray(j)&&(null==j?void 0:j.length)>0,t=!Array.isArray(j)&&!!j;return e||t}),[j]),[E]=t.useState(oc.generate()),_=h?`${h}`:`tg-${E}`,M=t.useRef();t.useEffect((()=>{O(a)}),[a]),t.useEffect((()=>{C&&D(null==k||k)}),[C]);const R=e=>{if(!d){if(y)return void y(e);switch(n){case"checkbox":O((e=>!e));break;case"radio":case"yes":case"no":C||O(!0)}}},A=()=>{d||D(!T)},N=()=>{d||!b||b()},B=()=>{var e;null===(e=null==M?void 0:M.current)||void 0===e||e.click()},F=e=>{e.stopPropagation()},L=()=>{let t;switch(n){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=n}return e.jsx(OI,{type:t,active:C,disabled:d})},P=()=>{if(!c)return null;let t;return t="function"==typeof c?c():c,e.jsx(BI,Object.assign({"data-id":"toggle-sublabel",$disabled:d,$selected:C},{children:t}))},z=()=>{const t=!T&&!I;return $&&e.jsxs(zI,Object.assign({$paddingTopRequired:t,disabled:d,onClick:A,"data-testid":T?"collapse-button":"expand-button"},{children:[T?"Show less":"Show more",T?e.jsx(r.ChevronUpIcon,{"aria-hidden":!0}):e.jsx(p.ChevronDownIcon,{"aria-hidden":!0})]}))},H=t=>e.jsxs(e.Fragment,{children:[e.jsx(YI,Object.assign({weight:"semibold",$disabled:d},{children:"Error"})),e.jsx(UI,Object.assign({$disabled:d},{children:null==t?void 0:t.map(((t,n)=>e.jsx("li",Object.assign({id:`${_}-error-list-item-${n}`},{children:e.jsx(YI,Object.assign({weight:"semibold",$disabled:d},{children:t}))}),n)))}))]});return e.jsxs(_I,Object.assign({$selected:C,$disabled:d,className:m,$styleType:o,$error:u,$indicator:i,$useContentWidth:w,id:h,"data-testid":x},{children:[e.jsxs(FI,Object.assign({id:`${_}-header-container`,$disabled:d,$error:u,$selected:C,$indicator:i,$styleType:o},{children:[e.jsx(LI,Object.assign({$addPadding:v},{children:e.jsxs(RI,Object.assign({id:`${_}-input-container`,onClick:B},{children:[e.jsx(MI,{ref:M,name:f,id:`${_}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:d,onChange:R,onClick:F,checked:C}),i&&L(),e.jsxs(AI,{children:[e.jsx(NI,Object.assign({htmlFor:`${_}-input`,$selected:C,$indicator:i,$disabled:d,"data-testid":`${_}-toggle-label`,$maxLines:l},{children:s})),c&&P()]})]}))})),v&&e.jsx(PI,Object.assign({type:"button",$disabled:d,onClick:N,id:`${_}-remove-button`},{children:"Remove"}))]})),S&&e.jsxs("div",{children:[(!$||T)&&e.jsx(VI,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!$,$disabled:d},{children:S})),$&&!T&&I&&e.jsx(HI,Object.assign({$disabled:d,onClick:A,id:`${_}-error-alert`},{children:e.jsx(WI,Object.assign({type:d?"description":"error",className:m,showIcon:!0},{children:Array.isArray(j)?H(j):j}))})),z()]})]}))},KI=q.default(Si.div)`
    position: absolute;
    top: 3.5rem;
    left: 0;
...
`,nE=q.default(exports.Text.Body)`
    width: 1.5rem;
    margin: 0 0.25rem;
    text-align: center;
...
`,xE=q.default(exports.Text.Body)`
    margin: 0 0.25rem;
    ${e=>{if(e.$inactive)return i.css`
                color: ${Qo.Neutral[3]};
            `}}
...
`,DE=q.default(exports.Text.BodySmall)`
    display: flex;
    flex: 1;
    margin-right: 1rem;
...
`,IE=q.default(exports.Text.BodySmall)``,EE=q.default.div`
    display: flex;
    ${ts.MaxWidth.mobileL} {
        flex-direction: column;
    }
...
`,ME=({thumbnailImageDataUrl:t,"data-testid":n,renderReplaceButton:r,onReplaceClick:i})=>e.jsxs(RE,Object.assign({"data-testid":n},{children:[e.jsx(AE,{"data-testid":n?`${n}-image`:void 0,src:t}),r&&e.jsx(NE,Object.assign({type:"button",onClick:e=>{i&&i()}},{children:"Replace"}))]})),RE=q.default.div`
    width: auto;
    margin-right: 2rem;
    display: flex;
    flex-shrink: 0;
...
`,BE=({fileItem:n,fileDescriptionMaxLength:r,wrapperWidth:i,onSave:a,onCancel:o,onBlur:s})=>{const{id:l,name:c,size:d,truncateText:u=!0,thumbnailImageDataUrl:p}=n,[f,h]=t.useState(),[m,g]=t.useState(""),v=t.useRef(),b=t.useRef();t.useEffect((()=>{h(x(c))}),[i]),t.useEffect((()=>{g(n.description||"")}),[n]);const x=e=>{if(!u)return e;const t=b&&b.current?b.current.getBoundingClientRect().width:0;return sc.truncateOneLine(e,t,t/2,t/2/8,16)};return e.jsxs(kE,Object.assign({"data-testid":`${l}-edit-display`},{children:[e.jsxs(CE,{children:[p&&e.jsx(ME,{thumbnailImageDataUrl:p}),e.jsxs(OE,{children:[e.jsxs(TE,Object.assign({ref:b},{children:[e.jsx(DE,Object.assign({weight:"semibold"},{children:f})),e.jsx(IE,{children:uh.formatFileSizeDisplay(d)})]})),e.jsx(SE.Textarea,{ref:v,id:`${l}-description-textarea`,"data-testid":`${l}-textarea`,value:m,maxLength:r,onChange:e=>{g(e.target.value)},onBlur:e=>{s(e.target.value)},rows:3,label:{children:"Photo description",subtitle:"Describe this photo to users who may not be able to see the image."}})]})]}),e.jsxs(EE,Object.assign({$thumbnail:!!p},{children:[e.jsx(_E,Object.assign({"data-testid":`${l}-save-button`,type:"button",disabled:0===m.trim().length,onClick:()=>{v.current&&a(v.current.value.trim())}},{children:"Save"})),e.jsx(_E,Object.assign({type:"button",styleType:"secondary","data-testid":`${l}-cancel-button`,onClick:o},{children:"Cancel"}))]}))]}))},FE=q.default.li`
    display: flex;
    align-items: center;
    width: 100%;
    border: none;
...
`,YE=q.default(exports.Text.BodySmall)``,UE=q.default(YE)`
    margin-top: 0.25rem;
`,qE=q.default(exports.Text.XSmall)`
    font-size: 0.875rem !important;
    color: ${Qo.Validation.Red.Text};
`,KE=q.default(qE)`
    margin-top: 0.25rem;
...
`,JE=t.memo((({fileItem:n,editable:r,sortable:i,wrapperWidth:a,disabled:o,readOnly:s,onDelete:l,onEditClick:c})=>{const{id:d,name:u,size:p,description:f,progress:h=1,errorMessage:m,thumbnailImageDataUrl:v,truncateText:b=!0}=n,[x,y]=t.useState(),{activeId:w}=t.useContext(Ih),{attributes:$,listeners:j,setNodeRef:S,transform:k,transition:C}=Tb({id:d}),O=t.useRef(),T={transform:Og.Translate.toString(k),transition:C},D=Object.assign(Object.assign({style:T},$),j),I=h<1,M=uh.formatFileSizeDisplay(p),R=w?w===d?"self":"others":"none";t.useEffect((()=>{y(F(u))}),[a]);const A=()=>{l()},N=()=>{c&&c()},B=e=>{i&&e.stopPropagation()},F=e=>{if(!b)return e;const t=O&&O.current?O.current.getBoundingClientRect().width:0;return sc.truncateOneLine(e,t,t/2,t/2/8,16)},L=()=>o||!!w,P=()=>i&&!s,z=()=>e.jsxs(e.Fragment,{children:[e.jsx(YE,Object.assign({weight:f?"semibold":"regular"},{children:x})),f&&e.jsx(UE,{children:f})]});return e.jsxs(FE,Object.assign({id:d,ref:S,$sortable:P(),$disabled:L(),$focusType:R},P()?D:{},{children:[P()&&e.jsx(LE,{"data-testid":`${d}-drag-handle`,$disabled:L()}),e.jsxs(PE,Object.assign({$focused:"self"===R,$error:!!m,$loading:I,$disabled:L(),$editable:r},{children:[(()=>{let t;return t=m?e.jsxs(e.Fragment,{children:[e.jsxs(HE,Object.assign({ref:O},{children:[z(),m&&e.jsx(KE,Object.assign({weight:"semibold"},{children:m}))]})),e.jsx(VE,{children:e.jsx(YE,{children:M})}),m&&e.jsx(XE,Object.assign({weight:"semibold"},{children:m}))]}):v?e.jsxs(e.Fragment,{children:[e.jsx(ME,{thumbnailImageDataUrl:v,"data-testid":`${d}-thumbnail`}),e.jsxs(WE,{children:[e.jsx(HE,Object.assign({ref:O},{children:z()})),e.jsx(VE,{children:e.jsx(YE,{children:M})})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(HE,Object.assign({ref:O},{children:z()})),e.jsx(VE,Object.assign({$hideInMobile:I},{children:e.jsx(YE,{children:M})}))]}),e.jsx(zE,Object.assign({$hasThumbnail:!!v},{children:t}))})(),!s&&(()=>{let t;return t=m?e.jsx(QE,Object.assign({onClick:A,"data-testid":`${d}-error-delete-button`,"aria-label":`delete-${u}`},{children:e.jsx(g.CrossIcon,{"aria-hidden":!0})})):I?e.jsx(pf,{progress:h,"data-testid":`${d}-progress-bar`}):e.jsxs(e.Fragment,{children:[r&&e.jsx(ZE,Object.assign({"data-testid":`${d}-edit-button`,"data-no-dnd":"true",type:"button",styleType:"light",sizeType:"small","aria-label":`edit ${u}`,disabled:L(),onClick:N,onKeyDown:B},{children:e.jsx(_.PencilIcon,{"aria-hidden":!0})}),"edit"),e.jsx(ZE,Object.assign({"data-testid":`${d}-delete-button`,"data-no-dnd":"true",type:"button",styleType:"light",sizeType:"small","aria-label":`delete ${u}`,disabled:L(),onClick:A,onKeyDown:B},{children:e.jsx(E.BinIcon,{"aria-hidden":!0})}),"delete")]}),e.jsx(GE,Object.assign({$editable:r,$error:!!m,$loading:I},{children:t}))})()]}))]}))})),e_=q.default.ul`
    list-style-type: none;
...
`,a_=q.default.div`
    color: ${Qo.Neutral[1]};
    ${Zs({textSize:"Body"})}
`,o_=q.default(exports.Text.BodySmall)`
    margin-bottom: 0;
    color: ${Qo.Neutral[3]};
`,s_=q.default.div`
    color: ${Qo.Neutral[3]};
...
`,w_=q.default(jc.Default)`
    width: 100%;
`,$_=q.default.div`
    padding: 1.5rem 1.25rem;
    background-color: ${Qo.Neutral[8]};
    border-top: 1px solid ${Qo.Neutral[5]};
`,j_=q.default(Ys.Default)`
    width: 100%;
`,S_=Y.default.createContext({mode:"default",rootNode:null});var k_=Ci((function(e){return null==e}));const C_=q.default.div`
...
`,D_=q.default(is)`
    margin: 0 0 0 auto;
`,I_=q.default(p.ChevronDownIcon)`
    height: 1.125rem;
    width: 1.125rem;
    color: ${Qo.Neutral[3]};
...
`,A_=q.default(Ys.Small)`
    height: fit-content;
    padding: 0;
    margin: 1rem 0 0 0;
`,N_=n=>{var{collapsible:r=!0,initialExpanded:i=!1,expanded:a,onExpandChange:o,minimisable:s=!1,minimisedHeight:l,showDivider:c=!0,showMobileDivider:d=!0,title:u,addon:p,children:f}=n,h=X(n,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","addon","children"]);const{mode:m,rootNode:g}=t.useContext(S_),v="mobile"===m,[b,x]=t.useState(O()),[y,w]=t.useState(s),$=!v&&r,j=Ye(),S=Ye(),k=oi({height:b?j.height:0}),C=y?null!=l?l:Math.min(.5*S.height,216):S.height;t.useEffect((()=>{x(O())}),[r,a]);function O(){return!!v||(k_(a)?!r||i:a)}return e.jsxs(C_,Object.assign({$collapsible:$},{children:[e.jsx(O_,{$showDivider:c,$showMobileDivider:d}),(u||$)&&e.jsxs(T_,{children:[u&&e.jsxs(E_,Object.assign({weight:"semibold"},{children:[u," ",p&&("popover"===p.type?e.jsx(qb,{addon:p,rootNode:v?g:void 0}):null)]})),$&&e.jsx(D_,Object.assign({focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!b;k_(a)&&x(e),o&&o(e)},"aria-label":b?"Collapse":"Expand"},{children:e.jsx(I_,{$expanded:b})}))]}),e.jsx(__,Object.assign({"data-testid":"expandable-container","data-expanded":b,style:k},{children:e.jsx("div",Object.assign({ref:j.ref},{children:e.jsxs(M_,Object.assign({},h,{children:[e.jsx(R_,Object.assign({"data-testid":"minimisable-container",$height:C,$minimisable:s},{children:e.jsx("div",Object.assign({ref:S.ref},{children:e.jsx("div",Object.assign({"data-id":"content-container"},{children:"function"==typeof f?f(m,{minimised:y}):f}))}))})),s&&e.jsxs(A_,Object.assign({"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{w(!y)}},{children:["View ",y?"more":"less"]}))]}))}))}))]}))},B_=q.default(N_)`
    padding: 0 0 1rem;
...
`,q_=q.default(exports.Text.H5).attrs({as:"p"})`
    margin-bottom: 1rem;
`,K_=q.default.div`
    display: flex;
    align-items: flex-start;
...
`,G_=()=>e.jsxs(U_,Object.assign({"data-testid":"download-app-section"},{children:[e.jsx(q_,Object.assign({weight:"semibold"},{children:"Download the app"})),e.jsxs(K_,{children:[e.jsx(X_,Object.assign({href:"https://apps.apple.com/sg/app/moments-of-life/id1383218758",target:"_blank",rel:"noopener noreferrer",id:"footer-download-app-apple"},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/apple-app-store.png",alt:"apple-app-store"})})),e.jsx(X_,Object.assign({href:"https://play.google.com/store/apps/details?id=sg.gov.app.mol&hl=en_SG",target:"_blank",rel:"noopener noreferrer",id:"footer-download-app-android"},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/google-play-store.png",alt:"google-play-store"})}))]})]})),Z_={privacy:{href:"https://www.life.gov.sg/privacy-statement",target:"_blank",rel:"noopener"},termsOfUse:{href:"https://www.life.gov.sg/terms-of-use",target:"_blank",rel:"noopener"},reportVulnerability:{href:"https://tech.gov.sg/report_vulnerability",target:"_blank",rel:"noopener",external:!0}},Q_={privacy:{href:"https://assets.life.gov.sg/bookingsg/BSG_Privacy_Policy.pdf",target:"_blank",rel:"noopener"},termsOfUse:{href:"https://assets.life.gov.sg/bookingsg/BSG_Terms_of_Use.pdf",target:"_blank",rel:"noopener"},reportVulnerability:{href:"https://tech.gov.sg/report_vulnerability",target:"_blank",rel:"noopener",external:!0}},J_={privacy:{href:"https://mylegacy.life.gov.sg/privacy-statement",target:"_blank",rel:"noopener"},termsOfUse:{href:"https://mylegacy.life.gov.sg/terms-of-use",target:"_blank",rel:"noopener"},reportVulnerability:{href:"https://tech.gov.sg/report_vulnerability",target:"_blank",rel:"noopener",external:!0}};var eM;!function(e){e.getCopyrightInfo=(e=new Date,n)=>{const r=t(n);return`${`${(new Date).getFullYear()} ${r}`} Last Updated ${Pl(e).format("D MMMM YYYY")}`};const t=e=>{switch(e){case"bookingsg":return"BookingSG, Government of Singapore.";case"mylegacy":return"MyLegacy@LifeSG, Government of Singapore.";case"ccube":return"Citizen Collective Common, Government of Singapore.";default:return"LifeSG, Government of Singapore."}};e.getFooterLogoAttribute=e=>{switch(e){case"bookingsg":return{src:"https://home.booking.gov.sg/images/bookingsg/footer.svg",alt:"BookingSG"};case"mylegacy":return{src:"https://mylegacy.life.gov.sg/images/site-logo.png",alt:"MyLegacy",style:{width:"10rem",maxHeight:"2rem"}};case"ccube":return{src:"https://assets.life.gov.sg/ccube/logo-ccube.svg",alt:"Ccube"};default:return{src:"https://assets.life.gov.sg/react-design-system/img/logo/lifesg-primary-logo.svg",alt:"LifeSG"}}},e.getDisclaimerLinks=(e,t)=>{const n=(e=>{switch(e){case"bookingsg":return Q_;case"mylegacy":return J_;default:return Z_}})(e);return{privacy:Object.assign(Object.assign(Object.assign({},n.privacy),t&&t.privacy?t.privacy:{}),{children:"Privacy Statement"}),termsOfUse:Object.assign(Object.assign(Object.assign({},n.termsOfUse),t&&t.termsOfUse?t.termsOfUse:{}),{children:"Terms of Use"}),reportVulnerability:Object.assign(Object.assign(Object.assign({},n.reportVulnerability),t&&t.reportVulnerability?t.reportVulnerability:{}),{children:"Report Vulnerability"})}}}(eM||(eM={}));const tM=q.default.img`
    max-height: 4.5rem;
    max-width: 100%;
`,nM=q.default.div`
    display: flex;
    ...
    gap: 2rem;
    margin-top: 1rem;
`,rM=()=>{const t=i.useTheme();return e.jsx("div",Object.assign({"data-testid":"resource-addon-section"},{children:"mylegacy"===(null==t?void 0:t.resourceScheme)?e.jsxs(e.Fragment,{children:[e.jsx(exports.Text.XSmall,{children:"My Legacy is a LifeSG initiative, brought to you by the following government agencies:"}),e.jsxs(nM,{children:[e.jsx(tM,{"data-testid":"footer-govtech-logo",src:"https://mylegacy.life.gov.sg/images/agencies/govtech-logo.png",alt:"GovTech Singapore"}),e.jsx(tM,{"data-testid":"footer-psd-logo",src:"https://mylegacy.life.gov.sg/images/agencies/psd-logo.png",alt:"Public Service Division",style:{maxHeight:"3.5rem"}})]})]}):null}))},iM=q.default.footer`
    background: ${Qo.Neutral[7]};
`,aM=q.default(exports.Text.Hyperlink.Small)`
    color: ${Qo.Neutral[1]};
`,oM=q.default(ix.Content)`
    padding: 4rem 0;
    border-bottom: 1px solid ${Qo.Neutral[5]};
...
`,hM=q.default(exports.Text.Hyperlink.Small)`
...
`;var mM=function(e,t){return Number(e.toFixed(t))},gM=function(e,t,n){n&&"function"==typeof n&&n(e,t)},vM={easeOut:function(e){return-Math.cos(e*Math.PI)/2+.5},linear:function(e){return e},easeInQuad:function(e){return e*e},easeOutQuad:function(e){return e*(2-e)},easeInOutQuad:function(e){return e<.5?2*e*e:(4-2*e)*e-1},easeInCubic:function(e){return e*e*e},easeOutCubic:function(e){return--e*e*e+1},easeInOutCubic:function(e){return e<.5?4*e*e*e:(e-1)*(2*e-2)*(2*e-2)+1},easeInQuart:function(e){return e*e*e*e},easeOutQuart:function(e){return 1- --e*e*e*e},easeInOutQuart:function(e){return e<.5?8*e*e*e*e:1-8*--e*e*e*e},easeInQuint:function(e){return e*e*e*e*e},easeOutQuint:function(e){return 1+--e*e*e*e*e},easeInOutQuint:function(e){return e<.5?16*e*e*e*e*e:1+16*--e*e*e*e*e}},bM=function(e){"number"==typeof e&&cancelAnimationFrame(e)},xM=function(e){e.mounted&&(bM(e.animation),e.animate=!1,e.animation=null,e.velocity=null)};function yM(e,t,n,r){if(e.mounted){var i=(new Date).getTime();xM(e),e.animation=function(){if(!e.mounted)return bM(e.animation);var a=(new Date).getTime()-i,o=(0,vM[t])(a/n);a>=n?(r(1),e.animation=null):e.animation&&(r(o),requestAnimationFrame(e.animation))},requestAnimationFrame(e.animation)}}function wM(e,t,n,r){var i=function(e){var t=e.scale,n=e.positionX,r=e.positionY;return!(Number.isNaN(t)||Number.isNaN(n)||Number.isNaN(r))}(t);if(e.mounted&&i){var a=e.setTransformState,o=e.transformState,s=o.scale,l=o.positionX,c=o.positionY,d=t.scale-s,u=t.positionX-l,p=t.positionY-c;0===n?a(t.scale,t.positionX,t.positionY):yM(e,r,n,(function(e){a(s+d*e,l+u*e,c+p*e)}))}}var $M=function(e,t){var n=e.wrapperComponent,r=e.contentComponent,i=e.setup.centerZoomedOut;if(!n||!r)throw new Error("Components are not mounted");var a=function(e,t,n){var r=e.offsetWidth,i=e.offsetHeight,a=t.offsetWidth*n,o=t.offsetHeight*n;return{wrapperWidth:r,wrapperHeight:i,newContentWidth:a,newDiffWidth:r-a,newContentHeight:o,newDiffHeight:i-o}}(n,r,t),o=a.wrapperWidth,s=a.wrapperHeight,l=function(e,t,n,r,i,a,o){var s=e>t?n*(o?1:.5):0,l=r>i?a*(o?1:.5):0;return{minPositionX:e-t-s,maxPositionX:s,minPositionY:r-i-l,maxPositionY:l}}(o,a.newContentWidth,a.newDiffWidth,s,a.newContentHeight,a.newDiffHeight,Boolean(i));return l},jM=function(e,t,n,r){return mM(r?e<t?t:e>n?n:e:e,2)},SM=function(e,t){var n=$M(e,t);return e.bounds=n,n};function kM(e,t,n,r,i,a,o){var s=n.minPositionX,l=n.minPositionY,c=n.maxPositionX,d=n.maxPositionY,u=0,p=0;return o&&(u=i,p=a),{x:jM(e,s-u,c+u,r),y:jM(t,l-p,d+p,r)}}function CM(e,t,n,r,i,a){var o=e.transformState,s=o.scale,l=o.positionX,c=o.positionY,d=r-s;return"number"!=typeof t||"number"!=typeof n?(console.error("Mouse X and Y position were not provided!"),{x:l,y:c}):kM(l-t*d,c-n*d,i,a,0,0,null)}function OM(e,t,n,r,i){var a=t-(i?r:0);return!Number.isNaN(n)&&e>=n?n:!Number.isNaN(t)&&e<=a?a:e}var TM=function(e,t){var n=e.setup.panning.excluded,r=e.isInitialized,i=e.wrapperComponent,a=t.target,o="shadowRoot"in a&&"composedPath"in t?t.composedPath().some((function(e){return e instanceof Element&&(null==i?void 0:i.contains(e))})):null==i?void 0:i.contains(a);return!!(r&&a&&o)&&!cR(a,n)},DM=function(e){var t=e.isInitialized,n=e.isPanning,r=e.setup.panning.disabled;return!(!t||!n||r)};function IM(e,t,n,r,i){var a=e.setup.limitToBounds,o=e.wrapperComponent,s=e.bounds,l=e.transformState,c=l.scale,d=l.positionX,u=l.positionY;if(null!==o&&null!==s&&(t!==d||n!==u)){var p=kM(t,n,s,a,r,i,o),f=p.x,h=p.y;e.setTransformState(c,f,h)}}var EM=function(e,t){var n=e.setup,r=e.transformState.scale,i=n.minScale,a=n.disablePadding;return t>0&&r>=i&&!a?t:0};function _M(e,t,n,r,i,a,o,s,l,c){if(i){var d;if(t>o&&n>o)return(d=o+(e-o)*c)>l?l:d<o?o:d;if(t<a&&n<a)return(d=a+(e-a)*c)<s?s:d>a?a:d}return r?t:jM(e,a,o,i)}function MM(e,t){var n=function(e){var t=e.mounted,n=e.setup,r=n.disabled,i=n.velocityAnimation,a=e.transformState.scale;return!(i.disabled&&!(a>1)&&r&&!t)}(e);if(n){var r=e.lastMousePosition,i=e.velocityTime,a=e.setup,o=e.wrapperComponent,s=a.velocityAnimation.equalToMove,l=Date.now();if(r&&i&&o){var c=function(e,t){return t?Math.min(1,e.offsetWidth/window.innerWidth):1}(o,s),d=t.x-r.x,u=t.y-r.y,p=d/c,f=u/c,h=l-i,m=d*d+u*u,g=Math.sqrt(m)/h;e.velocity={velocityX:p,velocityY:f,total:g}}e.lastMousePosition=t,e.velocityTime=l}}function RM(e,t){var n=e.transformState.scale;xM(e),SM(e,n),void 0!==window.TouchEvent&&t instanceof TouchEvent?function(e,t){var n=t.touches,r=e.transformState,i=r.positionX,a=r.positionY;if(e.isPanning=!0,1===n.length){var o=n[0].clientX,s=n[0].clientY;e.startCoords={x:o-i,y:s-a}}}(e,t):function(e,t){var n=e.transformState,r=n.positionX,i=n.positionY;e.isPanning=!0;var a=t.clientX,o=t.clientY;e.startCoords={x:a-r,y:o-i}}(e,t)}function AM(e,t){var n=e.transformState.scale,r=e.setup,i=r.minScale,a=r.alignmentAnimation,o=a.disabled,s=a.sizeX,l=a.sizeY,c=a.animationTime,d=a.animationType;if(!(o||n<i||!s&&!l)){var u=function(e){var t=e.transformState,n=t.positionX,r=t.positionY,i=t.scale,a=e.setup,o=a.disabled,s=a.limitToBounds,l=a.centerZoomedOut,c=e.wrapperComponent;if(!o&&c&&e.bounds){var d=e.bounds,u=d.maxPositionX,p=d.minPositionX,f=d.maxPositionY,h=d.minPositionY,m=n>u||n<p,g=r>f||r<h,v=CM(e,n>u?c.offsetWidth:e.setup.minPositionX||0,r>f?c.offsetHeight:e.setup.minPositionY||0,i,e.bounds,s||l),b=v.x,x=v.y;return{scale:i,positionX:m?b:n,positionY:g?x:r}}}(e);u&&wM(e,u,null!=t?t:c,d)}}function NM(e,t,n){var r=e.startCoords,i=e.setup.alignmentAnimation,a=i.sizeX,o=i.sizeY;if(r){var s=function(e,t,n){var r=e.startCoords,i=e.transformState,a=e.setup.panning,o=a.lockAxisX,s=a.lockAxisY,l=i.positionX,c=i.positionY;if(!r)return{x:l,y:c};var d=t-r.x,u=n-r.y;return{x:o?l:d,y:s?c:u}}(e,t,n),l=s.x,c=s.y,d=EM(e,a),u=EM(e,o);MM(e,{x:l,y:c}),IM(e,l,c,d,u)}}function BM(e){if(e.isPanning){var t=e.setup.panning.velocityDisabled,n=e.velocity,r=e.wrapperComponent,i=e.contentComponent;e.isPanning=!1,e.animate=!1,e.animation=null;var a=null==r?void 0:r.getBoundingClientRect(),o=null==i?void 0:i.getBoundingClientRect(),s=(null==a?void 0:a.width)||0,l=(null==a?void 0:a.height)||0,c=(null==o?void 0:o.width)||0,d=(null==o?void 0:o.height)||0,u=s<c||l<d;!t&&n&&(null==n?void 0:n.total)>.1&&u?function(e){var t=e.velocity,n=e.bounds,r=e.setup,i=e.wrapperComponent,a=function(e){var t=e.mounted,n=e.velocity,r=e.bounds,i=e.setup,a=i.disabled,o=i.velocityAnimation,s=e.transformState.scale;return!(o.disabled&&!(s>1)&&a&&!t||!n||!r)}(e);if(a&&t&&n&&i){var o=t.velocityX,s=t.velocityY,l=t.total,c=n.maxPositionX,d=n.minPositionX,u=n.maxPositionY,p=n.minPositionY,f=r.limitToBounds,h=r.alignmentAnimation,m=r.zoomAnimation,g=r.panning,v=g.lockAxisY,b=g.lockAxisX,x=m.animationType,y=h.sizeX,w=h.sizeY,$=h.velocityAlignmentTime,j=function(e,t){var n=e.setup.velocityAnimation,r=n.equalToMove,i=n.animationTime,a=n.sensitivity;return r?i*t*a:i}(e,l),S=Math.max(j,$),k=EM(e,y),C=EM(e,w),O=k*i.offsetWidth/100,T=C*i.offsetHeight/100,D=c+O,I=d-O,E=u+T,_=p-T,M=e.transformState,R=(new Date).getTime();yM(e,x,S,(function(t){var n=e.transformState,r=n.scale,i=n.positionX,a=n.positionY,l=((new Date).getTime()-R)/$,m=1-(0,vM[h.animationType])(Math.min(1,l)),g=1-t,x=i+o*g,y=a+s*g,w=_M(x,M.positionX,i,b,f,d,c,I,D,m),j=_M(y,M.positionY,a,v,f,p,u,_,E,m);i===x&&a===y||e.setTransformState(r,w,j)}))}}(e):AM(e)}}function FM(e,t,n,r){var i=e.setup,a=i.minScale,o=i.maxScale,s=i.limitToBounds,l=OM(mM(t,2),a,o,0,!1),c=CM(e,n,r,l,SM(e,l),s);return{scale:l,positionX:c.x,positionY:c.y}}function LM(e,t,n){var r=e.transformState.scale,i=e.wrapperComponent,a=e.setup,o=a.minScale,s=a.limitToBounds,l=a.zoomAnimation,c=l.disabled,d=l.animationTime,u=l.animationType,p=c||r>=o;if((r>=1||s)&&AM(e),!p&&i&&e.mounted){var f=FM(e,o,t||i.offsetWidth/2,n||i.offsetHeight/2);f&&wM(e,f,d,u)}}var PM=function(){return PM=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},PM.apply(this,arguments)};function zM(e,t,n){if(n||2===arguments.length)for(var r,i=0,a=t.length;i<a;i++)!r&&i in t||(r||(r=Array.prototype.slice.call(t,0,i)),r[i]=t[i]);return e.concat(r||Array.prototype.slice.call(t))}"function"==typeof SuppressedError&&SuppressedError;var HM=1,WM=0,VM=0,YM={disabled:!1,minPositionX:null,maxPositionX:null,minPositionY:null,maxPositionY:null,minScale:1,maxScale:8,limitToBounds:!0,centerZoomedOut:!1,centerOnInit:!1,disablePadding:!1,smooth:!0,wheel:{step:.2,disabled:!1,smoothStep:.001,wheelDisabled:!1,touchPadDisabled:!1,activationKeys:[],excluded:[]},panning:{disabled:!1,velocityDisabled:!1,lockAxisX:!1,lockAxisY:!1,allowLeftClickPan:!0,allowMiddleClickPan:!0,allowRightClickPan:!0,wheelPanning:!1,activationKeys:[],excluded:[]},pinch:{step:5,disabled:!1,excluded:[]},doubleClick:{disabled:!1,step:.7,mode:"zoomIn",animationType:"easeOut",animationTime:200,excluded:[]},zoomAnimation:{disabled:!1,size:.4,animationTime:200,animationType:"easeOut"},alignmentAnimation:{disabled:!1,sizeX:100,sizeY:100,animationTime:200,velocityAlignmentTime:400,animationType:"easeOut"},velocityAnimation:{disabled:!1,sensitivity:1,animationTime:400,animationType:"easeOut",equalToMove:!0}},UM="react-transform-wrapper",qM="react-transform-component",KM=function(e){var t,n,r,i;return{previousScale:null!==(t=e.initialScale)&&void 0!==t?t:HM,scale:null!==(n=e.initialScale)&&void 0!==n?n:HM,positionX:null!==(r=e.initialPositionX)&&void 0!==r?r:WM,positionY:null!==(i=e.initialPositionY)&&void 0!==i?i:VM}},XM=function(e){var t=PM({},YM);return Object.keys(e).forEach((function(n){var r=void 0!==e[n];if(void 0!==YM[n]&&r){var i=Object.prototype.toString.call(YM[n]),a="[object Object]"===i,o="[object Array]"===i;t[n]=a?PM(PM({},YM[n]),e[n]):o?zM(zM([],YM[n],!0),e[n],!0):e[n]}})),t},GM=function(e,t,n){var r=e.transformState.scale,i=e.wrapperComponent,a=e.setup,o=a.maxScale,s=a.minScale,l=a.zoomAnimation,c=a.smooth,d=l.size;if(!i)throw new Error("Wrapper is not mounted");var u=c?r*Math.exp(t*n):r+t*n;return OM(mM(u,3),s,o,d,!1)};function ZM(e,t,n,r,i){var a=e.wrapperComponent,o=e.transformState,s=o.scale,l=o.positionX,c=o.positionY;if(!a)return console.error("No WrapperComponent found");var d=(a.offsetWidth/2-l)/s,u=(a.offsetHeight/2-c)/s,p=FM(e,GM(e,t,n),d,u);if(!p)return console.error("Error during zoom event. New transformation state was not calculated.");wM(e,p,r,i)}function QM(e,t,n,r){var i=e.setup,a=e.wrapperComponent,o=i.limitToBounds,s=KM(e.props),l=e.transformState,c=l.scale,d=l.positionX,u=l.positionY;if(a){var p=$M(e,s.scale),f=kM(s.positionX,s.positionY,p,o,0,0,a),h={scale:s.scale,positionX:f.x,positionY:f.y};c===s.scale&&d===s.positionX&&u===s.positionY||(null==r||r(),wM(e,h,t,n))}}var JM=function(e){return function(t,n,r){void 0===t&&(t=.5),void 0===n&&(n=300),void 0===r&&(r="easeOut"),ZM(e,1,t,n,r)}},eR=function(e){return function(t,n,r){void 0===t&&(t=.5),void 0===n&&(n=300),void 0===r&&(r="easeOut"),ZM(e,-1,t,n,r)}},tR=function(e){return function(t,n,r,i,a){void 0===i&&(i=300),void 0===a&&(a="easeOut");var o=e.transformState,s=o.positionX,l=o.positionY,c=o.scale,d=e.wrapperComponent,u=e.contentComponent;if(!e.setup.disabled&&d&&u){var p={positionX:Number.isNaN(t)?s:t,positionY:Number.isNaN(n)?l:n,scale:Number.isNaN(r)?c:r};wM(e,p,i,a)}}},nR=function(e){return function(t,n){void 0===t&&(t=200),void 0===n&&(n="easeOut"),QM(e,t,n)}},rR=function(e){return function(t,n,r){void 0===n&&(n=200),void 0===r&&(r="easeOut");var i=e.transformState,a=e.wrapperComponent,o=e.contentComponent;if(a&&o){var s=uR(t||i.scale,a,o);wM(e,s,n,r)}}},iR=function(e){return function(t,n,r,i){void 0===r&&(r=600),void 0===i&&(i="easeOut"),xM(e);var a=e.wrapperComponent,o="string"==typeof t?document.getElementById(t):t;if(a&&o&&a.contains(o)){var s=function(e,t,n){var r=e.wrapperComponent,i=e.contentComponent,a=e.transformState,o=e.setup,s=o.limitToBounds,l=o.minScale,c=o.maxScale;if(!r||!i)return a;var d,u,p,f,h,m,g,v,b=r.getBoundingClientRect(),x=t.getBoundingClientRect(),y=(d=r,u=i,p=a,f=t.getBoundingClientRect(),h=d.getBoundingClientRect(),m=u.getBoundingClientRect(),g=h.x*p.scale,v=h.y*p.scale,{x:(f.x-m.x+g)/p.scale,y:(f.y-m.y+v)/p.scale}),w=y.x,$=y.y,j=x.width/a.scale,S=x.height/a.scale,k=r.offsetWidth/j,C=r.offsetHeight/S,O=OM(n||Math.min(k,C),l,c,0,!1),T=(b.width-j*O)/2,D=(b.height-S*O)/2,I=kM((b.left-w)*O+T,(b.top-$)*O+D,$M(e,O),s,0,0,r);return{positionX:I.x,positionY:I.y,scale:O}}(e,o,n);wM(e,s,r,i)}}},aR=function(e){return{instance:e,zoomIn:JM(e),zoomOut:eR(e),setTransform:tR(e),resetTransform:nR(e),centerView:rR(e),zoomToElement:iR(e)}},oR=function(e){var t={};return Object.assign(t,function(e){return{instance:e,state:e.transformState}}(e)),Object.assign(t,aR(e)),t};function sR(){try{return{get passive(){return!1}}}catch(e){return!1}}var lR=".".concat(UM),cR=function(e,t){return t.some((function(t){return e.matches("".concat(lR," ").concat(t,", ").concat(lR," .").concat(t,", ").concat(lR," ").concat(t," *, ").concat(lR," .").concat(t," *"))}))},dR=function(e){e&&clearTimeout(e)},uR=function(e,t,n){var r=n.offsetWidth*e,i=n.offsetHeight*e;return{scale:e,positionX:(t.offsetWidth-r)/2,positionY:(t.offsetHeight-i)/2}};function pR(e,t,n){var r=t.getBoundingClientRect(),i=0,a=0;if("clientX"in e)i=(e.clientX-r.left)/n,a=(e.clientY-r.top)/n;else{var o=e.touches[0];i=(o.clientX-r.left)/n,a=(o.clientY-r.top)/n}return(Number.isNaN(i)||Number.isNaN(a))&&console.error("No mouse or touch offset found"),{x:i,y:a}}var fR=function(e){return Math.sqrt(Math.pow(e.touches[0].pageX-e.touches[1].pageX,2)+Math.pow(e.touches[0].pageY-e.touches[1].pageY,2))},hR=function(e,t){var n=e.props,r=n.onWheel,i=n.onZoom,a=e.contentComponent,o=e.setup,s=e.transformState.scale,l=o.limitToBounds,c=o.centerZoomedOut,d=o.zoomAnimation,u=o.wheel,p=o.disablePadding,f=o.smooth,h=d.size,m=d.disabled,g=u.step,v=u.smoothStep;if(!a)throw new Error("Component not mounted");t.preventDefault(),t.stopPropagation();var b=function(e,t){var n=function(e){return e?e.deltaY<0?1:-1:0}(e),r=function(e,t){return"number"==typeof e?e:t}(t,n);return r}(t,null),x=function(e,t,n,r,i){var a=e.transformState.scale,o=e.wrapperComponent,s=e.setup,l=s.maxScale,c=s.minScale,d=s.zoomAnimation,u=s.disablePadding,p=d.size,f=d.disabled;if(!o)throw new Error("Wrapper is not mounted");var h=a+t*n;if(i)return h;var m=!r&&!f;return OM(mM(h,3),c,l,p,m&&!u)}(e,b,f?v*Math.abs(t.deltaY):g,!t.ctrlKey);if(s!==x){var y=SM(e,x),w=pR(t,a,s),$=l&&(m||0===h||c||p),j=CM(e,w.x,w.y,x,y,$),S=j.x,k=j.y;e.previousWheelEvent=t,e.setTransformState(x,S,k),gM(oR(e),t,r),gM(oR(e),t,i)}},mR=function(e,t){var n=e.props,r=n.onWheelStop,i=n.onZoomStop;dR(e.wheelAnimationTimer),e.wheelAnimationTimer=setTimeout((function(){e.mounted&&(LM(e,t.x,t.y),e.wheelAnimationTimer=null)}),100);var a=function(e,t){var n=e.previousWheelEvent,r=e.transformState.scale,i=e.setup,a=i.maxScale,o=i.minScale;return!!n&&(r<a||r>o||Math.sign(n.deltaY)!==Math.sign(t.deltaY)||n.deltaY>0&&n.deltaY<t.deltaY||n.deltaY<0&&n.deltaY>t.deltaY||Math.sign(n.deltaY)!==Math.sign(t.deltaY))}(e,t);a&&(dR(e.wheelStopEventTimer),e.wheelStopEventTimer=setTimeout((function(){e.mounted&&(e.wheelStopEventTimer=null,gM(oR(e),t,r),gM(oR(e),t,i))}),160))},gR=function(e){for(var t=0,n=0,r=0;r<2;r+=1)t+=e.touches[r].clientX,n+=e.touches[r].clientY;return{x:t/2,y:n/2}},vR=function(e,t){var n=e.contentComponent,r=e.pinchStartDistance,i=e.wrapperComponent,a=e.transformState.scale,o=e.setup,s=o.limitToBounds,l=o.centerZoomedOut,c=o.zoomAnimation,d=o.alignmentAnimation,u=c.disabled,p=c.size;if(null!==r&&n){var f=function(e,t,n){var r=n.getBoundingClientRect(),i=e.touches,a=mM(i[0].clientX-r.left,5),o=mM(i[0].clientY-r.top,5);return{x:(a+mM(i[1].clientX-r.left,5))/2/t,y:(o+mM(i[1].clientY-r.top,5))/2/t}}(t,a,n);if(Number.isFinite(f.x)&&Number.isFinite(f.y)){var h=fR(t),m=function(e,t){var n=e.pinchStartScale,r=e.pinchStartDistance,i=e.setup,a=i.maxScale,o=i.minScale,s=i.zoomAnimation,l=i.disablePadding,c=s.size,d=s.disabled;if(!n||null===r||!t)throw new Error("Pinch touches distance was not provided");return t<0?e.transformState.scale:OM(mM(t/r*n,2),o,a,c,!d&&!l)}(e,h),g=gR(t),v=g.x-(e.pinchLastCenterX||0),b=g.y-(e.pinchLastCenterY||0);if(m!==a||0!==v||0!==b){e.pinchLastCenterX=g.x,e.pinchLastCenterY=g.y;var x=SM(e,m),y=s&&(u||0===p||l),w=CM(e,f.x,f.y,m,x,y),$=w.x,j=w.y;e.pinchMidpoint=f,e.lastDistance=h;var S=d.sizeX,k=d.sizeY,C=kM($+v,j+b,x,s,EM(e,S),EM(e,k),i),O=C.x,T=C.y;e.setTransformState(m,O,T)}}}},bR=function(e,t){var n=e.props.onZoomStop,r=e.setup.doubleClick.animationTime;dR(e.doubleClickStopEventTimer),e.doubleClickStopEventTimer=setTimeout((function(){e.doubleClickStopEventTimer=null,gM(oR(e),t,n)}),r)};function xR(e,t){var n=e.setup,r=e.doubleClickStopEventTimer,i=e.transformState,a=e.contentComponent,o=i.scale,s=e.props,l=s.onZoomStart,c=s.onZoom,d=n.doubleClick,u=d.disabled,p=d.mode,f=d.step,h=d.animationTime,m=d.animationType;if(!u&&!r){if("reset"===p)return function(e,t){var n=e.props,r=n.onZoomStart,i=n.onZoom,a=e.setup.doubleClick,o=a.animationTime,s=a.animationType;gM(oR(e),t,r),QM(e,o,s,(function(){return gM(oR(e),t,i)})),bR(e,t)}(e,t);if(!a)return console.error("No ContentComponent found");var g=function(e,t){return"toggle"===e?1===t?1:-1:"zoomOut"===e?-1:1}(p,e.transformState.scale),v=GM(e,g,f);if(o!==v){gM(oR(e),t,l);var b=pR(t,a,o),x=FM(e,v,b.x,b.y);if(!x)return console.error("Error during zoom event. New transformation state was not calculated.");gM(oR(e),t,c),wM(e,x,h,m),bR(e,t)}}}var yR=function(e){var t=this;this.mounted=!0,this.pinchLastCenterX=null,this.pinchLastCenterY=null,this.onChangeCallbacks=new Set,this.onInitCallbacks=new Set,this.wrapperComponent=null,this.contentComponent=null,this.isInitialized=!1,this.bounds=null,this.previousWheelEvent=null,this.wheelStopEventTimer=null,this.wheelAnimationTimer=null,this.isPanning=!1,this.isWheelPanning=!1,this.startCoords=null,this.lastTouch=null,this.distance=null,this.lastDistance=null,this.pinchStartDistance=null,this.pinchStartScale=null,this.pinchMidpoint=null,this.doubleClickStopEventTimer=null,this.velocity=null,this.velocityTime=null,this.lastMousePosition=null,this.animate=!1,this.animation=null,this.maxBounds=null,this.pressedKeys={},this.mount=function(){t.initializeWindowEvents()},this.unmount=function(){t.cleanupWindowEvents()},this.update=function(e){t.props=e,SM(t,t.transformState.scale),t.setup=XM(e)},this.initializeWindowEvents=function(){var e,n,r=sR(),i=null===(e=t.wrapperComponent)||void 0===e?void 0:e.ownerDocument,a=null==i?void 0:i.defaultView;null===(n=t.wrapperComponent)||void 0===n||n.addEventListener("wheel",t.onWheelPanning,r),null==a||a.addEventListener("mousedown",t.onPanningStart,r),null==a||a.addEventListener("mousemove",t.onPanning,r),null==a||a.addEventListener("mouseup",t.onPanningStop,r),null==i||i.addEventListener("mouseleave",t.clearPanning,r),null==a||a.addEventListener("keyup",t.setKeyUnPressed,r),null==a||a.addEventListener("keydown",t.setKeyPressed,r)},this.cleanupWindowEvents=function(){var e,n,r=sR(),i=null===(e=t.wrapperComponent)||void 0===e?void 0:e.ownerDocument,a=null==i?void 0:i.defaultView;null==a||a.removeEventListener("mousedown",t.onPanningStart,r),null==a||a.removeEventListener("mousemove",t.onPanning,r),null==a||a.removeEventListener("mouseup",t.onPanningStop,r),null==i||i.removeEventListener("mouseleave",t.clearPanning,r),null==a||a.removeEventListener("keyup",t.setKeyUnPressed,r),null==a||a.removeEventListener("keydown",t.setKeyPressed,r),document.removeEventListener("mouseleave",t.clearPanning,r),xM(t),null===(n=t.observer)||void 0===n||n.disconnect()},this.handleInitializeWrapperEvents=function(e){var n=sR();e.addEventListener("wheel",t.onWheelZoom,n),e.addEventListener("dblclick",t.onDoubleClick,n),e.addEventListener("touchstart",t.onTouchPanningStart,n),e.addEventListener("touchmove",t.onTouchPanning,n),e.addEventListener("touchend",t.onTouchPanningStop,n)},this.handleInitialize=function(e,n){var r=!1,i=t.setup.centerOnInit,a=function(e,t){for(var n=0,r=e;n<r.length;n++)if(r[n].target===t)return!0;return!1};t.applyTransformation(),t.onInitCallbacks.forEach((function(e){e(oR(t))})),t.observer=new ResizeObserver((function(o){if(a(o,e)||a(o,n))if(i&&!r){var s=n.offsetWidth,l=n.offsetHeight;(s>0||l>0)&&(r=!0,t.setCenter())}else xM(t),SM(t,t.transformState.scale),AM(t,0)})),t.observer.observe(e),t.observer.observe(n)},this.onWheelZoom=function(e){if(!t.setup.disabled){var n=function(e,t){var n=e.setup.wheel,r=n.disabled,i=n.wheelDisabled,a=n.touchPadDisabled,o=n.excluded,s=e.isInitialized,l=e.isPanning,c=t.target;return!(!s||l||r||!c||i&&!t.ctrlKey||a&&t.ctrlKey||cR(c,o))}(t,e);n&&t.isPressingKeys(t.setup.wheel.activationKeys)&&(function(e,t){var n=e.props,r=n.onWheelStart,i=n.onZoomStart;e.wheelStopEventTimer||(xM(e),gM(oR(e),t,r),gM(oR(e),t,i))}(t,e),hR(t,e),mR(t,e))}},this.onWheelPanning=function(e){var n=t.setup,r=n.disabled,i=n.wheel,a=n.panning;if(t.wrapperComponent&&t.contentComponent&&!r&&i.wheelDisabled&&!a.disabled&&a.wheelPanning&&!e.ctrlKey){e.preventDefault(),e.stopPropagation();var o=t.transformState,s=o.positionX,l=o.positionY,c=s-e.deltaX,d=l-e.deltaY,u=a.lockAxisX?s:c,p=a.lockAxisY?l:d,f=t.setup.alignmentAnimation,h=f.sizeX,m=f.sizeY,g=EM(t,h),v=EM(t,m);u===s&&p===l||IM(t,u,p,g,v)}},this.onPanningStart=function(e){var n=t.setup.disabled,r=t.props.onPanningStart;n||TM(t,e)&&t.isPressingKeys(t.setup.panning.activationKeys)&&(0!==e.button||t.setup.panning.allowLeftClickPan)&&(1!==e.button||t.setup.panning.allowMiddleClickPan)&&(2!==e.button||t.setup.panning.allowRightClickPan)&&(e.preventDefault(),e.stopPropagation(),xM(t),RM(t,e),gM(oR(t),e,r))},this.onPanning=function(e){var n=t.setup.disabled,r=t.props.onPanning;n||DM(t)&&t.isPressingKeys(t.setup.panning.activationKeys)&&(e.preventDefault(),e.stopPropagation(),NM(t,e.clientX,e.clientY),gM(oR(t),e,r))},this.onPanningStop=function(e){var n=t.props.onPanningStop;t.isPanning&&(BM(t),gM(oR(t),e,n))},this.onPinchStart=function(e){var n=t.setup.disabled,r=t.props,i=r.onPinchingStart,a=r.onZoomStart;if(!n){var o=function(e,t){var n=e.setup.pinch,r=n.disabled,i=n.excluded,a=e.isInitialized,o=t.target;return!(!a||r||!o||cR(o,i))}(t,e);o&&(function(e,t){var n=fR(t);e.pinchStartDistance=n,e.lastDistance=n,e.pinchStartScale=e.transformState.scale,e.isPanning=!1;var r=gR(t);e.pinchLastCenterX=r.x,e.pinchLastCenterY=r.y,xM(e)}(t,e),xM(t),gM(oR(t),e,i),gM(oR(t),e,a))}},this.onPinch=function(e){var n=t.setup.disabled,r=t.props,i=r.onPinching,a=r.onZoom;if(!n){var o=function(e){var t=e.setup.pinch.disabled,n=e.isInitialized,r=e.pinchStartDistance;return!(!n||t||!r)}(t);o&&(e.preventDefault(),e.stopPropagation(),vR(t,e),gM(oR(t),e,i),gM(oR(t),e,a))}},this.onPinchStop=function(e){var n,r,i=t.props,a=i.onPinchingStop,o=i.onZoomStop;t.pinchStartScale&&(r=(n=t).pinchMidpoint,n.velocity=null,n.lastDistance=null,n.pinchMidpoint=null,n.pinchStartScale=null,n.pinchStartDistance=null,LM(n,null==r?void 0:r.x,null==r?void 0:r.y),gM(oR(t),e,a),gM(oR(t),e,o))},this.onTouchPanningStart=function(e){var n=t.setup.disabled,r=t.props.onPanningStart;if(!n&&TM(t,e)&&!(t.lastTouch&&+new Date-t.lastTouch<200&&1===e.touches.length)){t.lastTouch=+new Date,xM(t);var i=e.touches,a=1===i.length,o=2===i.length;a&&(xM(t),RM(t,e),gM(oR(t),e,r)),o&&t.onPinchStart(e)}},this.onTouchPanning=function(e){var n=t.setup.disabled,r=t.props.onPanning;if(t.isPanning&&1===e.touches.length){if(n)return;if(!DM(t))return;e.preventDefault(),e.stopPropagation();var i=e.touches[0];NM(t,i.clientX,i.clientY),gM(oR(t),e,r)}else e.touches.length>1&&t.onPinch(e)},this.onTouchPanningStop=function(e){t.onPanningStop(e),t.onPinchStop(e)},this.onDoubleClick=function(e){if(!t.setup.disabled){var n=function(e,t){var n=e.isInitialized,r=e.setup,i=e.wrapperComponent,a=r.doubleClick,o=a.disabled,s=a.excluded,l=t.target,c=null==i?void 0:i.contains(l);return!(!(n&&l&&c)||o||cR(l,s))}(t,e);n&&xR(t,e)}},this.clearPanning=function(e){t.isPanning&&t.onPanningStop(e)},this.setKeyPressed=function(e){t.pressedKeys[e.key]=!0},this.setKeyUnPressed=function(e){t.pressedKeys[e.key]=!1},this.isPressingKeys=function(e){return!e.length||Boolean(e.find((function(e){return t.pressedKeys[e]})))},this.setTransformState=function(e,n,r){var i=t.props.onTransformed;if(Number.isNaN(e)||Number.isNaN(n)||Number.isNaN(r))console.error("Detected NaN set state values");else{e!==t.transformState.scale&&(t.transformState.previousScale=t.transformState.scale,t.transformState.scale=e),t.transformState.positionX=n,t.transformState.positionY=r,t.applyTransformation();var a=oR(t);t.onChangeCallbacks.forEach((function(e){return e(a)})),gM(a,{scale:e,positionX:n,positionY:r},i)}},this.setCenter=function(){if(t.wrapperComponent&&t.contentComponent){var e=uR(t.transformState.scale,t.wrapperComponent,t.contentComponent);t.setTransformState(e.scale,e.positionX,e.positionY)}},this.handleTransformStyles=function(e,n,r){return t.props.customTransform?t.props.customTransform(e,n,r):function(e,t,n){return"translate(".concat(e,"px, ").concat(t,"px) scale(").concat(n,")")}(e,n,r)},this.applyTransformation=function(){if(t.mounted&&t.contentComponent){var e=t.transformState,n=e.scale,r=e.positionX,i=e.positionY,a=t.handleTransformStyles(r,i,n);t.contentComponent.style.transform=a}},this.getContext=function(){return oR(t)},this.onChange=function(e){return t.onChangeCallbacks.has(e)||t.onChangeCallbacks.add(e),function(){t.onChangeCallbacks.delete(e)}},this.onInit=function(e){return t.onInitCallbacks.has(e)||t.onInitCallbacks.add(e),function(){t.onInitCallbacks.delete(e)}},this.init=function(e,n){t.cleanupWindowEvents(),t.wrapperComponent=e,t.contentComponent=n,SM(t,t.transformState.scale),t.handleInitializeWrapperEvents(e),t.handleInitialize(e,n),t.initializeWindowEvents(),t.isInitialized=!0;var r=oR(t);gM(r,void 0,t.props.onInit)},this.props=e,this.setup=XM(this.props),this.transformState=KM(this.props)},wR=Y.default.createContext(null),$R=Y.default.forwardRef((function(e,n){var r=t.useRef(new yR(e)).current,i=function(e,t){return"function"==typeof e?e(t):e}(e.children,aR(r));return t.useImperativeHandle(n,(function(){return aR(r)}),[r]),t.useEffect((function(){r.update(e)}),[r,e]),Y.default.createElement(wR.Provider,{value:r},i)}));Y.default.forwardRef((function(e,n){var r,i=t.useRef(null),a=t.useContext(wR);return t.useEffect((function(){return a.onChange((function(e){if(i.current){i.current.style.transform=a.handleTransformStyles(0,0,1/e.instance.transformState.scale)}}))}),[a]),Y.default.createElement("div",PM({},e,{ref:(r=[i,n],function(e){r.forEach((function(t){"function"==typeof t?t(e):null!=t&&(t.current=e)}))})}))}));var jR="transform-component-module_wrapper__SPB86",SR="transform-component-module_content__FBWxo";!function(e,t){void 0===t&&(t={});var n=t.insertAt;if(e&&"undefined"!=typeof document){var r=document.head||document.getElementsByTagName("head")[0],i=document.createElement("style");i.type="text/css","top"===n&&r.firstChild?r.insertBefore(i,r.firstChild):r.appendChild(i),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(document.createTextNode(e))}}(".transform-component-module_wrapper__SPB86 {\n  position: relative;\n  width: -moz-fit-content;\n  width: fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  overflow: hidden;\n  -webkit-touch-callout: none; /* iOS Safari */\n  -webkit-user-select: none; /* Safari */\n  -khtml-user-select: none; /* Konqueror HTML */\n  -moz-user-select: none; /* Firefox */\n  -ms-user-select: none; /* Internet Explorer/Edge */\n  user-select: none;\n  margin: 0;\n  padding: 0;\n  transform: translate3d(0, 0, 0);\n}\n.transform-component-module_content__FBWxo {\n  display: flex;\n  flex-wrap: wrap;\n  width: -moz-fit-content;\n  width: fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  margin: 0;\n  padding: 0;\n  transform-origin: 0% 0%;\n}\n.transform-component-module_content__FBWxo img {\n  pointer-events: none;\n}\n");var kR=function(e){var n=e.children,r=e.wrapperClass,i=void 0===r?"":r,a=e.contentClass,o=void 0===a?"":a,s=e.wrapperStyle,l=e.contentStyle,c=e.wrapperProps,d=void 0===c?{}:c,u=e.contentProps,p=void 0===u?{}:u,f=t.useContext(wR),h=f.init,m=f.cleanupWindowEvents,g=t.useRef(null),v=t.useRef(null);return t.useEffect((function(){var e=g.current,t=v.current;return null!==e&&null!==t&&h&&(null==h||h(e,t)),function(){null==m||m()}}),[]),Y.default.createElement("div",PM({},d,{ref:g,className:"".concat(UM," ").concat(jR," ").concat(i),style:s}),Y.default.createElement("div",PM({},p,{ref:v,className:"".concat(qM," ").concat(SR," ").concat(o),style:l}),n))};const CR=q.default.div`
    background-color: ${Qo.Neutral[6]};
    display: flex;
    align-items: center;
    justify-content: center;
...
`,OR=t=>e.jsx(CR,Object.assign({},t,{children:e.jsx(u.PlaceholderImageIcon,{})})),TR=q.default.div`
    display: flex;
    align-items: center;
    justify-content: center;
`,DR=q.default.img`
...
`,IR=q.default(OR)`
    width: 100%;
    height: 100%;
`,ER=({src:n,className:r,alt:i,fit:a,placeholder:o,retrieveImageDimension:s,setDimension:l})=>{const[c,d]=t.useState(!0),[u,p]=t.useState();t.useEffect((()=>{d(!0),p(void 0);const e=new Image;e.src=n,e.onload=()=>{s&&l({src:n,width:e.width,height:e.height}),d(!1)},e.onerror=e=>{d(!1),p(e)}}),[n]);return e.jsx(TR,Object.assign({className:r},{children:u?null!=o?o:e.jsx(IR,{}):c?e.jsx(dl,{}):e.jsx(DR,{src:n,alt:i,$fit:a})}))},_R=q.default(is)`
    padding: 0;
    border-radius: 100%;
    background: ${Qo.Neutral[8]};
    color: ${Qo.Primary};
...
`,WR=q.default.div`
    ...
    margin-right: auto;
    z-index: 3;
`,VR=q.default(exports.Text.XSmall)`
    display: inline-flex;
...
`,QR=Y.default.forwardRef(((t,n)=>{var{children:r,imgSrc:i,selected:a,error:o,type:s="button"}=t,l=X(t,["children","imgSrc","selected","error","type"]);return e.jsxs(ZR,Object.assign({ref:n,$selected:a,$error:o,type:s},l,{children:[e.jsx(ph,{src:i}),r]}))})),JR=i.css`
    height: 1.125rem;
    width: 1.125rem;
    color: ${Qo.Primary};
`,eA=q.default.div`
    border-top: 1px solid ${Qo.Neutral[5]};
    border-bottom: 1px solid ${Qo.Neutral[5]};
`,tA=q.default(exports.Text.H3)`
    color: ${Qo.Primary};
    margin-bottom: 0.5rem;
`,nA=q.default(exports.Text.Body)`
    color: ${Qo.Primary};
`,rA=q.default(f.ChevronRightIcon)`
    ${JR}
`,iA=q.default.a`
    padding: 1rem 0;
    display: flex;
...
`,aA=q.default.div`
    ...
    flex: 1;
    margin-right: 1rem;
`,oA=q.default(exports.Text.BodySmall)`
    margin-top: 0.25rem;
`,sA=q.default(Si.div)`
    overflow: hidden;
`,lA=q.default.div`
    border-top: 1px solid ${Qo.Neutral[5]};
`,cA=q.default(exports.Text.H5)`
    color: ${Qo.Primary};
    margin-right: 0.5rem;
`,dA=q.default(A.PlusIcon)`
    ${JR}
`,uA=q.default(R.MinusIcon)`
    ${JR}
`,pA=q.default.button`
    display: flex;
    justify-content: center;
...
`,fA=q.default.div`
    ...
    ${e=>e.color&&i.css`
            color: ${e.color};
        `}
`,hA=t.forwardRef(((t,n)=>{const{baseTextColor:r,baseTextSize:i,inline:a}=t,o=X(t,["baseTextColor","baseTextSize","inline"]);return e.jsx(fA,Object.assign({ref:n,as:a?"span":"div",$textSize:i,$textColor:r},o))})),mA=q.default.div`
    margin-top: 2.5rem;
    display: grid;
    align-items: center;
    width: 100%;
...
`,gA=q.default.div`
    ...
    ${e=>{const{startLg:t,colsLg:n,startMd:r,colsMd:a,startSm:o,colsSm:s}=e;return i.css`
        ...
        `}}
`,vA={Grid:Y.default.forwardRef(((t,n)=>{const{children:r}=t,i=X(t,["children"]);return e.jsx(mA,Object.assign({ref:n},i,{children:r}))})),Tile:Y.default.forwardRef(((t,n)=>{const{children:r}=t,i=X(t,["children"]);return e.jsx(gA,Object.assign({ref:n},i,{children:r}))}))},bA=q.default.div`
...
`,xA=()=>{t.useEffect((()=>{n()||r()}),[]);const n=()=>document.getElementById(yA),r=()=>{if(!document.getElementById(yA)){const e=document.createElement("script");e.id=yA,e.type="module",e.src=wA,document.head.appendChild(e)}};return e.jsx(bA,{dangerouslySetInnerHTML:{__html:"<sgds-masthead></sgds-masthead>"}})},yA="lifesg-ds-masthead-script",wA="https://cdn.jsdelivr.net/npm/@govtechsg/sgds-web-component/Masthead/index.js",$A={notCompress:6,compress:4},jA=q.default.div`
...
`,SA=q.default.nav`
    height: ${e=>e.$compress?$A.compress:$A.notCompress}rem;
    width: 100%;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,EA=({resources:t,onClick:n,"data-id":r,"data-testid":i="navbar-brand",type:a})=>e.jsx(IA,Object.assign({role:"link",onClick:e=>{n&&n(e,a)},tabIndex:0,"data-id":r,"data-testid":i,$type:a},{children:e.jsx(ph,{src:t.logoSrc,alt:t.brandName})})),_A=q.default.div`
    display: none;
...
`,FA=Y.default.forwardRef(((n,r)=>{const{show:i,resources:a,children:o,hideNavBranding:s,onClose:l,onBrandClick:c}=n,[d,u]=t.useState(0),{primary:p,secondary:f}=a;t.useEffect((()=>(h(),window.addEventListener("resize",h),()=>{window.removeEventListener("resize",h)})),[]);const h=()=>{if(window){const e=.01*window.innerHeight;u(e)}};return e.jsx(_A,Object.assign({ref:r,"data-testid":"drawer"},{children:e.jsx(MA,Object.assign({$show:i,$viewHeight:d},{children:e.jsxs(RA,{children:[e.jsxs(AA,{children:[e.jsx(TA,Object.assign({"data-id":"drawer-brand-container"},{children:!s&&e.jsxs(e.Fragment,{children:[e.jsx(EA,{resources:p,compress:!0,onClick:c,"data-id":"drawer-brand-primary","data-testid":"drawer__brand",type:"primary"}),f&&e.jsxs(e.Fragment,{children:[e.jsx(DA,{}),e.jsx(EA,{resources:f,compress:!0,onClick:c,"data-id":"drawer-brand-secondary","data-testid":"drawer__brand-secondary",type:"secondary"})]})]})})),e.jsx(BA,Object.assign({onClick:l,focusHighlight:!1,"aria-label":"Close nav menu"},{children:e.jsx(NA,{})}))]}),o]})}))}))})),LA={primary:{brandName:"LifeSG",logoSrc:"https://assets.life.gov.sg/lifesg/logo-lifesg.svg"}},PA={primary:{brandName:"BookingSG",logoSrc:"https://www.booking.gov.sg/logo.svg"}},zA={primary:{brandName:"MyLegacy",logoSrc:"https://assets.life.gov.sg/ccube/logo-ccube.svg"}},HA={primary:{brandName:"CCube",logoSrc:"https://mylegacy.life.gov.sg/images/site-logo.png"}},WA=q.default.ul`
    display: flex;
    list-style: none;
    margin-left: 4rem;
    flex-shrink: 0;
...
`,XA=q.default(exports.Text.BodySmall)`
    margin-bottom: 0.5rem;
`,GA=q.default.div`
    display: flex;
`,ZA=q.default.a`
...
`,QA=({actionButtons:t,mobile:n=!1,onActionButtonClick:r})=>{const i=e=>{e.stopPropagation()},a=e=>t=>{t.stopPropagation(),"download"===e.type&&window.scrollTo({left:0,top:document.body.scrollHeight,behavior:"smooth"}),r(t,e)},o=(t,n)=>{const r=t?(e=>{const t=tj(e,(e=>"download"===e.type));if(t>-1){const n=[...e],r=n.splice(t,1);return[...n,r[0]]}return e})(n):n;return r.map(((n,r)=>{let o;switch(n.type){case"download":o=t?(s=n.args,e.jsxs(KA,{children:[e.jsx(XA,Object.assign({weight:"semibold"},{children:s&&s.children||"Download the app"})),e.jsxs(GA,{children:[e.jsx(ZA,Object.assign({href:"https://apps.apple.com/sg/app/moments-of-life/id1383218758",target:"_blank",rel:"noopener noreferrer","data-testid":"button__app-store",onClick:i},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/apple-app-store.png",alt:"apple-app-store"})})),e.jsx(ZA,Object.assign({href:"https://play.google.com/store/apps/details?id=sg.gov.app.mol&hl=en_SG",target:"_blank",rel:"noopener noreferrer","data-testid":"button__play-store",onClick:i},{children:e.jsx("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/google-play-store.png",alt:"google-play-store"})}))]})]})):e.jsx(qA,Object.assign({},n.args,{type:"button",onClick:a(n),"data-testid":"action-button__download"},{children:"Download the app"}));break;case"button":{const i=n.args["data-testid"]?`action-button__${n.args["data-testid"]}`:`action-button__button-${t?"mobile-":""}${r+1}`;o=e.jsx(qA,Object.assign({},n.args,{type:"button",onClick:a(n),"data-testid":i}));break}case"component":{const e=n.args;o=e&&e.render||null;break}default:o=null}var s;if(o)return e.jsx(UA,Object.assign({$mobile:t},{children:o}),`action-button-${r+1}`)}))};if(t){const r=(null==t?void 0:t.mobile)||t.desktop,i=r.filter((e=>!!e.uncollapsible)),a=r.filter((e=>!e.uncollapsible));return n?e.jsx(e.Fragment,{children:a.length>0&&e.jsx(YA,{children:o(n,a)})}):e.jsxs(e.Fragment,{children:[i.length>0&&e.jsx(VA,{children:o(!1,i)}),t.desktop.length>0&&e.jsx(WA,{children:o(n,t.desktop)})]})}return e.jsx(e.Fragment,{})},JA=q.default.ul`
    width: 100%;
    overflow: auto;
    display: flex;
    flex-direction: column;
...
`,tN=q.default(exports.Text.Hyperlink.Small)`
...
`,rN=({items:t,mobile:n=!1,onItemClick:r})=>{const i=e=>t=>{t.stopPropagation(),r(t,e)},a=(n=!1)=>t.map(((t,r)=>{const{children:a,options:o}=t,s=X(t,["children","options"]),l=n?`link__mobile-${r+1}`:`link__${r+1}`;return e.jsx(nN,{children:e.jsx(tN,Object.assign({"data-testid":l,weight:"bold"},s,{onClick:i(t)},o,{children:a}))},r)}));if(t&&t.length>0){const t=n?eN:JA;return e.jsx(t,{children:a(n)})}return e.jsx(e.Fragment,{})},iN=q.default.ul`
    display: flex;
    list-style: none;
    position: relative;
...
`,sN=q.default(exports.Text.Hyperlink.Small)`
    display: flex;
    position: relative;
    align-items: center;
    text-align: center;
...
`,fN=({items:n,selectedId:r,mobile:i=!1,hideNavBranding:a,onItemClick:o})=>{const[s,l]=t.useState(-1),[c,d]=t.useState(!1),u=t.useRef(null);t.useEffect((()=>{const e=e=>{u.current&&!u.current.contains(e.target)&&p()};return document.addEventListener("click",e,!0),()=>{document.removeEventListener("click",e,!0)}}),[]);const p=()=>{d(!1)},f=(e,t)=>n=>{n.stopPropagation(),l(t),d(!0),o(n,e)},h=(e,t)=>{e.stopPropagation(),o(e,t),d(!1)},m=()=>n.map(((t,n)=>{if("component"===t.itemType){const r=t&&t.children||null;return e.jsx("li",{children:r},n)}{const o=(e=>{if(e.id===r)return!0;if((null==e?void 0:e.subMenu)&&e.subMenu.length>=1)return!!e.subMenu.find((e=>e.id===r));return!1})(t),{children:l,options:d}=t,u=X(t,["children","options"]),p=o?i?"bold":"semibold":"regular",m=i?`link__mobile-${n+1}`:`link__${n+1}`,g=s>=0&&s===n&&c;return e.jsxs(oN,Object.assign({$hiddenBranding:a},{children:[e.jsxs(sN,Object.assign({"data-testid":m,weight:p,$selected:o},u,{onClick:f(t,n)},d,{children:[e.jsx(lN,{children:l}),o&&e.jsx(cN,{"data-testid":`${m}-indicator`}),i&&t.subMenu&&e.jsx(dN,{children:e.jsx(uN,Object.assign({"data-testid":`${m}-expand-collapse-button`,$selected:g,focusHighlight:!1,focusOutline:"browser","aria-label":g?"Collapse":"Expand"},{children:e.jsx(pN,{})}))})]})),g&&e.jsx(rN,{items:t.subMenu,mobile:i,onItemClick:h})]}),n)}}));return n&&n.length>0?i?e.jsx(aN,Object.assign({ref:u},{children:m()})):e.jsx(iN,Object.assign({ref:u,$alignLeft:a},{children:m()})):e.jsx(e.Fragment,{})},hN=t.forwardRef(((n,r)=>{var{items:a,className:o,id:s,selectedId:l,compress:c=!1,fixed:d=!0,resources:u,hideNavElements:p=!1,hideNavBranding:f=!1,drawerDismissalExclusions:h=[],actionButtons:m,onItemClick:g,onActionButtonClick:v,onBrandClick:b,masthead:x=!0,layout:y="default"}=n,w=X(n,["items","className","id","selectedId","compress","fixed","resources","hideNavElements","hideNavBranding","drawerDismissalExclusions","actionButtons","onItemClick","onActionButtonClick","onBrandClick","masthead","layout"]);const[$,j]=t.useState(!1),[S,k]=t.useState(!1),C="stretch"===y,O=t.useRef(),T=i.useTheme(),D=(e=>{switch(e){case"bookingsg":return PA;case"mylegacy":return HA;case"ccube":return zA;default:return LA}})(null==T?void 0:T.resourceScheme),I=(null==u?void 0:u.primary)||D.primary,E=null==u?void 0:u.secondary;t.useImperativeHandle(r,(()=>Object.assign(O.current,{dismissDrawer:()=>{_()}})),[$]),t.useEffect((()=>(R(),window.addEventListener("resize",R),()=>{window.removeEventListener("resize",R)})),[]);const _=()=>{j(!1),setTimeout((()=>{k(!1)}),550)},M=e=>$&&-1===h.indexOf(e),R=()=>{window.innerWidth<=Jo.tablet&&$&&_()},A=(e,t)=>{b&&(e.preventDefault(),b(t)),M("brand-click")&&_()},N=(e,t)=>{t.onClick?t.onClick(e):g&&(e.preventDefault(),g(t)),!(null==t?void 0:t.subMenu)&&M("item-click")&&_()},B=(e,t)=>{t.args&&t.args.onClick?t.args.onClick(e):v&&(e.preventDefault(),v(t)),M("item-click")&&_()},F=()=>{j(!0),k(!0)},L=()=>{M("close-button-click")&&_()},P=()=>{const t=a.mobile||a.desktop;return t&&t.length>0||m&&(()=>{const e=m.mobile||m.desktop;return!!e&&e.length&&e.some((e=>!e.uncollapsible))})()?e.jsx(CA,Object.assign({"aria-label":"Open nav menu","data-testid":"button__mobile-menu",onClick:F,focusHighlight:!1},{children:e.jsx(OA,{})})):null};return e.jsxs(jA,Object.assign({ref:O,$fixed:d,className:o,id:s||"navbar-wrapper","data-testid":w["data-testid"]||"navbar-wrapper"},{children:[x&&e.jsx(xA,{}),e.jsxs(ix.Content,Object.assign({stretch:C},{children:[e.jsxs(SA,Object.assign({$compress:c},{children:[!f&&e.jsxs(TA,Object.assign({$compress:c,"data-id":"brand-container"},{children:[e.jsx(EA,{resources:I,onClick:A,"data-id":"brand-primary","data-testid":"main__brand",type:"primary"}),E&&e.jsxs(e.Fragment,{children:[e.jsx(DA,{$compress:c}),e.jsx(EA,{resources:E,onClick:A,"data-id":"brand-secondary","data-testid":"main__brand-secondary",type:"secondary"})]})]})),!p&&e.jsxs(kA,Object.assign({$hideNavBranding:f},{children:[e.jsx(fN,{items:a.desktop,onItemClick:N,selectedId:l,hideNavBranding:f}),e.jsx(QA,{actionButtons:m,onActionButtonClick:B}),P()]}))]})),!p&&e.jsx(rf,Object.assign({show:S,enableOverlayClick:!0,onOverlayClick:L},{children:e.jsxs(FA,Object.assign({show:$,resources:{primary:I,secondary:E},onClose:L,onBrandClick:A,actionButtons:m,hideNavBranding:f},{children:[e.jsx(fN,{items:a.mobile||a.desktop,onItemClick:N,selectedId:l,mobile:!0}),e.jsx(QA,{actionButtons:m,onActionButtonClick:B,mobile:!0})]}))}))]}))]}))})),mN=$A,gN=i.css`
    color: ${Qo.Validation.Orange.Icon};
...
`,yN=q.default.div`
    ...
    ${e=>{const t="linear-gradient(to bottom, black 50%, transparent 100%)";if(e.$maxCollapsedHeight)return i.css`
                ...
                mask-image: ${t};
            `}}
`,wN=q.default(exports.Text.Hyperlink.Default)`
    position: relative;
...
`,kN=q.default.button`
    ...
    white-space: nowrap;
    width: 1px;
`,CN=n=>{var{children:r,visible:i=!0,dismissible:a=!0,sticky:o=!0,onDismiss:s,id:l,forwardedRef:c,maxCollapsedHeight:d,onClick:u,actionButton:p}=n,f=X(n,["children","visible","dismissible","sticky","onDismiss","id","forwardedRef","maxCollapsedHeight","onClick","actionButton"]);const h=f["data-testid"],[m,g]=t.useState(i),{height:v,ref:b}=Ye();t.useEffect((()=>{g(i)}),[i]);const x=e=>{e.stopPropagation(),g(!1),a&&s&&s()},y=e=>{p.onClick&&(e.stopPropagation(),p.onClick(e))};if(!m)return null;return e.jsxs(vN,Object.assign({ref:c,$sticky:o,$clickable:!!u,onClick:u},f,{children:[e.jsxs(bN,Object.assign({id:ON("container",l)},{children:[e.jsxs(xN,{children:[e.jsx(yN,Object.assign({"data-testid":ON("text-content",h),$maxCollapsedHeight:d&&v>d?d:void 0},{children:e.jsx("div",Object.assign({ref:b},{children:r}))})),p&&e.jsx(SN,Object.assign({id:ON("action-button",l),"data-testid":ON("action-button",h),type:"button"},p,{onClick:y},{children:p.children}))]}),a&&e.jsx($N,Object.assign({onClick:x,id:ON("dismiss-button",l),"data-testid":ON("dismiss-button",h),focusHighlight:!1,type:"button","aria-label":"Dismiss notification"},{children:e.jsx(jN,{"aria-hidden":!0})}))]})),u&&e.jsx(kN,{"aria-label":"Clickable banner",type:"button"})]}))},ON=(e,t="wrapper")=>`${t}-${e}`,TN=Y.default.forwardRef(((t,n)=>e.jsx(CN,Object.assign({},t,{forwardedRef:n})))),DN=Object.assign(TN,{Link:wN}),{entries:IN,setPrototypeOf:EN,isFrozen:_N,getPrototypeOf:MN,getOwnPropertyDescriptor:RN}=Object;let{freeze:AN,seal:NN,create:BN}=Object,{apply:FN,construct:LN}="undefined"!=typeof Reflect&&Reflect;AN||(AN=function(e){return e}),NN||(NN=function(e){return e}),FN||(FN=function(e,t,n){return e.apply(t,n)}),LN||(LN=function(e,t){return new e(...t)});const PN=tB(Array.prototype.forEach),zN=tB(Array.prototype.lastIndexOf),HN=tB(Array.prototype.pop),WN=tB(Array.prototype.push),VN=tB(Array.prototype.splice),YN=tB(String.prototype.toLowerCase),UN=tB(String.prototype.toString),qN=tB(String.prototype.match),KN=tB(String.prototype.replace),XN=tB(String.prototype.indexOf),GN=tB(String.prototype.trim),ZN=tB(Object.prototype.hasOwnProperty),QN=tB(RegExp.prototype.test),JN=(eB=TypeError,function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return LN(eB,t)});var eB;function tB(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];return FN(e,t,r)}}function nB(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:YN;EN&&EN(e,null);let r=t.length;for(;r--;){let i=t[r];if("string"==typeof i){const e=n(i);e!==i&&(_N(t)||(t[r]=e),i=e)}e[i]=!0}return e}function rB(e){for(let t=0;t<e.length;t++){ZN(e,t)||(e[t]=null)}return e}function iB(e){const t=BN(null);for(const[n,r]of IN(e)){ZN(e,n)&&(Array.isArray(r)?t[n]=rB(r):r&&"object"==typeof r&&r.constructor===Object?t[n]=iB(r):t[n]=r)}return t}function aB(e,t){for(;null!==e;){const n=RN(e,t);if(n){if(n.get)return tB(n.get);if("function"==typeof n.value)return tB(n.value)}e=MN(e)}return function(){return null}}const oB=AN(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),sB=AN(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),lB=AN(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),cB=AN(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),dB=AN(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),uB=AN(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),pB=AN(["#text"]),fB=AN(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),hB=AN(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),mB=AN(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),gB=AN(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),vB=NN(/\{\{[\w\W]*|[\w\W]*\}\}/gm),bB=NN(/<%[\w\W]*|[\w\W]*%>/gm),xB=NN(/\$\{[\w\W]*/gm),yB=NN(/^data-[\-\w.\u00B7-\uFFFF]+$/),wB=NN(/^aria-[\-\w]+$/),$B=NN(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),jB=NN(/^(?:\w+script|data):/i),SB=NN(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),kB=NN(/^html$/i),CB=NN(/^[a-z][.\w]*(-[.\w]+)+$/i);var OB=Object.freeze({__proto__:null,ARIA_ATTR:wB,ATTR_WHITESPACE:SB,CUSTOM_ELEMENT:CB,DATA_ATTR:yB,DOCTYPE_NAME:kB,ERB_EXPR:bB,IS_ALLOWED_URI:$B,IS_SCRIPT_OR_DATA:jB,MUSTACHE_EXPR:vB,TMPLIT_EXPR:xB});const TB=1,DB=3,IB=7,EB=8,_B=9,MB=function(){return"undefined"==typeof window?null:window};var RB=function e(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:MB();const n=t=>e(t);if(n.version="3.2.6",n.removed=[],!t||!t.document||t.document.nodeType!==_B||!t.Element)return n.isSupported=!1,n;let{document:r}=t;const i=r,a=i.currentScript,{DocumentFragment:o,HTMLTemplateElement:s,Node:l,Element:c,NodeFilter:d,NamedNodeMap:u=t.NamedNodeMap||t.MozNamedAttrMap,HTMLFormElement:p,DOMParser:f,trustedTypes:h}=t,m=c.prototype,g=aB(m,"cloneNode"),v=aB(m,"remove"),b=aB(m,"nextSibling"),x=aB(m,"childNodes"),y=aB(m,"parentNode");if("function"==typeof s){const e=r.createElement("template");e.content&&e.content.ownerDocument&&(r=e.content.ownerDocument)}let w,$="";const{implementation:j,createNodeIterator:S,createDocumentFragment:k,getElementsByTagName:C}=r,{importNode:O}=i;let T={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]};n.isSupported="function"==typeof IN&&"function"==typeof y&&j&&void 0!==j.createHTMLDocument;const{MUSTACHE_EXPR:D,ERB_EXPR:I,TMPLIT_EXPR:E,DATA_ATTR:_,ARIA_ATTR:M,IS_SCRIPT_OR_DATA:R,ATTR_WHITESPACE:A,CUSTOM_ELEMENT:N}=OB;let{IS_ALLOWED_URI:B}=OB,F=null;const L=nB({},[...oB,...sB,...lB,...dB,...pB]);let P=null;const z=nB({},[...fB,...hB,...mB,...gB]);let H=Object.seal(BN(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),W=null,V=null,Y=!0,U=!0,q=!1,K=!0,X=!1,G=!0,Z=!1,Q=!1,J=!1,ee=!1,te=!1,ne=!1,re=!0,ie=!1,ae=!0,oe=!1,se={},le=null;const ce=nB({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let de=null;const ue=nB({},["audio","video","img","source","image","track"]);let pe=null;const fe=nB({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),he="http://www.w3.org/1998/Math/MathML",me="http://www.w3.org/2000/svg",ge="http://www.w3.org/1999/xhtml";let ve=ge,be=!1,xe=null;const ye=nB({},[he,me,ge],UN);let we=nB({},["mi","mo","mn","ms","mtext"]),$e=nB({},["annotation-xml"]);const je=nB({},["title","style","font","a","script"]);let Se=null;const ke=["application/xhtml+xml","text/html"];let Ce=null,Oe=null;const Te=r.createElement("form"),De=function(e){return e instanceof RegExp||e instanceof Function},Ie=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(!Oe||Oe!==e){if(e&&"object"==typeof e||(e={}),e=iB(e),Se=-1===ke.indexOf(e.PARSER_MEDIA_TYPE)?"text/html":e.PARSER_MEDIA_TYPE,Ce="application/xhtml+xml"===Se?UN:YN,F=ZN(e,"ALLOWED_TAGS")?nB({},e.ALLOWED_TAGS,Ce):L,P=ZN(e,"ALLOWED_ATTR")?nB({},e.ALLOWED_ATTR,Ce):z,xe=ZN(e,"ALLOWED_NAMESPACES")?nB({},e.ALLOWED_NAMESPACES,UN):ye,pe=ZN(e,"ADD_URI_SAFE_ATTR")?nB(iB(fe),e.ADD_URI_SAFE_ATTR,Ce):fe,de=ZN(e,"ADD_DATA_URI_TAGS")?nB(iB(ue),e.ADD_DATA_URI_TAGS,Ce):ue,le=ZN(e,"FORBID_CONTENTS")?nB({},e.FORBID_CONTENTS,Ce):ce,W=ZN(e,"FORBID_TAGS")?nB({},e.FORBID_TAGS,Ce):iB({}),V=ZN(e,"FORBID_ATTR")?nB({},e.FORBID_ATTR,Ce):iB({}),se=!!ZN(e,"USE_PROFILES")&&e.USE_PROFILES,Y=!1!==e.ALLOW_ARIA_ATTR,U=!1!==e.ALLOW_DATA_ATTR,q=e.ALLOW_UNKNOWN_PROTOCOLS||!1,K=!1!==e.ALLOW_SELF_CLOSE_IN_ATTR,X=e.SAFE_FOR_TEMPLATES||!1,G=!1!==e.SAFE_FOR_XML,Z=e.WHOLE_DOCUMENT||!1,ee=e.RETURN_DOM||!1,te=e.RETURN_DOM_FRAGMENT||!1,ne=e.RETURN_TRUSTED_TYPE||!1,J=e.FORCE_BODY||!1,re=!1!==e.SANITIZE_DOM,ie=e.SANITIZE_NAMED_PROPS||!1,ae=!1!==e.KEEP_CONTENT,oe=e.IN_PLACE||!1,B=e.ALLOWED_URI_REGEXP||$B,ve=e.NAMESPACE||ge,we=e.MATHML_TEXT_INTEGRATION_POINTS||we,$e=e.HTML_INTEGRATION_POINTS||$e,H=e.CUSTOM_ELEMENT_HANDLING||{},e.CUSTOM_ELEMENT_HANDLING&&De(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(H.tagNameCheck=e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),e.CUSTOM_ELEMENT_HANDLING&&De(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(H.attributeNameCheck=e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),e.CUSTOM_ELEMENT_HANDLING&&"boolean"==typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements&&(H.allowCustomizedBuiltInElements=e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),X&&(U=!1),te&&(ee=!0),se&&(F=nB({},pB),P=[],!0===se.html&&(nB(F,oB),nB(P,fB)),!0===se.svg&&(nB(F,sB),nB(P,hB),nB(P,gB)),!0===se.svgFilters&&(nB(F,lB),nB(P,hB),nB(P,gB)),!0===se.mathMl&&(nB(F,dB),nB(P,mB),nB(P,gB))),e.ADD_TAGS&&(F===L&&(F=iB(F)),nB(F,e.ADD_TAGS,Ce)),e.ADD_ATTR&&(P===z&&(P=iB(P)),nB(P,e.ADD_ATTR,Ce)),e.ADD_URI_SAFE_ATTR&&nB(pe,e.ADD_URI_SAFE_ATTR,Ce),e.FORBID_CONTENTS&&(le===ce&&(le=iB(le)),nB(le,e.FORBID_CONTENTS,Ce)),ae&&(F["#text"]=!0),Z&&nB(F,["html","head","body"]),F.table&&(nB(F,["tbody"]),delete W.tbody),e.TRUSTED_TYPES_POLICY){if("function"!=typeof e.TRUSTED_TYPES_POLICY.createHTML)throw JN('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if("function"!=typeof e.TRUSTED_TYPES_POLICY.createScriptURL)throw JN('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');w=e.TRUSTED_TYPES_POLICY,$=w.createHTML("")}else void 0===w&&(w=function(e,t){if("object"!=typeof e||"function"!=typeof e.createPolicy)return null;let n=null;const r="data-tt-policy-suffix";t&&t.hasAttribute(r)&&(n=t.getAttribute(r));const i="dompurify"+(n?"#"+n:"");try{return e.createPolicy(i,{createHTML:e=>e,createScriptURL:e=>e})}catch(e){return console.warn("TrustedTypes policy "+i+" could not be created."),null}}(h,a)),null!==w&&"string"==typeof $&&($=w.createHTML(""));AN&&AN(e),Oe=e}},Ee=nB({},[...sB,...lB,...cB]),_e=nB({},[...dB,...uB]),Me=function(e){WN(n.removed,{element:e});try{y(e).removeChild(e)}catch(t){v(e)}},Re=function(e,t){try{WN(n.removed,{attribute:t.getAttributeNode(e),from:t})}catch(e){WN(n.removed,{attribute:null,from:t})}if(t.removeAttribute(e),"is"===e)if(ee||te)try{Me(t)}catch(e){}else try{t.setAttribute(e,"")}catch(e){}},Ae=function(e){let t=null,n=null;if(J)e="<remove></remove>"+e;else{const t=qN(e,/^[\r\n\t ]+/);n=t&&t[0]}"application/xhtml+xml"===Se&&ve===ge&&(e='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+e+"</body></html>");const i=w?w.createHTML(e):e;if(ve===ge)try{t=(new f).parseFromString(i,Se)}catch(e){}if(!t||!t.documentElement){t=j.createDocument(ve,"template",null);try{t.documentElement.innerHTML=be?$:i}catch(e){}}const a=t.body||t.documentElement;return e&&n&&a.insertBefore(r.createTextNode(n),a.childNodes[0]||null),ve===ge?C.call(t,Z?"html":"body")[0]:Z?t.documentElement:a},Ne=function(e){return S.call(e.ownerDocument||e,e,d.SHOW_ELEMENT|d.SHOW_COMMENT|d.SHOW_TEXT|d.SHOW_PROCESSING_INSTRUCTION|d.SHOW_CDATA_SECTION,null)},Be=function(e){return e instanceof p&&("string"!=typeof e.nodeName||"string"!=typeof e.textContent||"function"!=typeof e.removeChild||!(e.attributes instanceof u)||"function"!=typeof e.removeAttribute||"function"!=typeof e.setAttribute||"string"!=typeof e.namespaceURI||"function"!=typeof e.insertBefore||"function"!=typeof e.hasChildNodes)},Fe=function(e){return"function"==typeof l&&e instanceof l};function Le(e,t,r){PN(e,(e=>{e.call(n,t,r,Oe)}))}const Pe=function(e){let t=null;if(Le(T.beforeSanitizeElements,e,null),Be(e))return Me(e),!0;const r=Ce(e.nodeName);if(Le(T.uponSanitizeElement,e,{tagName:r,allowedTags:F}),G&&e.hasChildNodes()&&!Fe(e.firstElementChild)&&QN(/<[/\w!]/g,e.innerHTML)&&QN(/<[/\w!]/g,e.textContent))return Me(e),!0;if(e.nodeType===IB)return Me(e),!0;if(G&&e.nodeType===EB&&QN(/<[/\w]/g,e.data))return Me(e),!0;if(!F[r]||W[r]){if(!W[r]&&He(r)){if(H.tagNameCheck instanceof RegExp&&QN(H.tagNameCheck,r))return!1;if(H.tagNameCheck instanceof Function&&H.tagNameCheck(r))return!1}if(ae&&!le[r]){const t=y(e)||e.parentNode,n=x(e)||e.childNodes;if(n&&t){for(let r=n.length-1;r>=0;--r){const i=g(n[r],!0);i.__removalCount=(e.__removalCount||0)+1,t.insertBefore(i,b(e))}}}return Me(e),!0}return e instanceof c&&!function(e){let t=y(e);t&&t.tagName||(t={namespaceURI:ve,tagName:"template"});const n=YN(e.tagName),r=YN(t.tagName);return!!xe[e.namespaceURI]&&(e.namespaceURI===me?t.namespaceURI===ge?"svg"===n:t.namespaceURI===he?"svg"===n&&("annotation-xml"===r||we[r]):Boolean(Ee[n]):e.namespaceURI===he?t.namespaceURI===ge?"math"===n:t.namespaceURI===me?"math"===n&&$e[r]:Boolean(_e[n]):e.namespaceURI===ge?!(t.namespaceURI===me&&!$e[r])&&!(t.namespaceURI===he&&!we[r])&&!_e[n]&&(je[n]||!Ee[n]):!("application/xhtml+xml"!==Se||!xe[e.namespaceURI]))}(e)?(Me(e),!0):"noscript"!==r&&"noembed"!==r&&"noframes"!==r||!QN(/<\/no(script|embed|frames)/i,e.innerHTML)?(X&&e.nodeType===DB&&(t=e.textContent,PN([D,I,E],(e=>{t=KN(t,e," ")})),e.textContent!==t&&(WN(n.removed,{element:e.cloneNode()}),e.textContent=t)),Le(T.afterSanitizeElements,e,null),!1):(Me(e),!0)},ze=function(e,t,n){if(re&&("id"===t||"name"===t)&&(n in r||n in Te))return!1;if(U&&!V[t]&&QN(_,t));else if(Y&&QN(M,t));else if(!P[t]||V[t]){if(!(He(e)&&(H.tagNameCheck instanceof RegExp&&QN(H.tagNameCheck,e)||H.tagNameCheck instanceof Function&&H.tagNameCheck(e))&&(H.attributeNameCheck instanceof RegExp&&QN(H.attributeNameCheck,t)||H.attributeNameCheck instanceof Function&&H.attributeNameCheck(t))||"is"===t&&H.allowCustomizedBuiltInElements&&(H.tagNameCheck instanceof RegExp&&QN(H.tagNameCheck,n)||H.tagNameCheck instanceof Function&&H.tagNameCheck(n))))return!1}else if(pe[t]);else if(QN(B,KN(n,A,"")));else if("src"!==t&&"xlink:href"!==t&&"href"!==t||"script"===e||0!==XN(n,"data:")||!de[e]){if(q&&!QN(R,KN(n,A,"")));else if(n)return!1}else;return!0},He=function(e){return"annotation-xml"!==e&&qN(e,N)},We=function(e){Le(T.beforeSanitizeAttributes,e,null);const{attributes:t}=e;if(!t||Be(e))return;const r={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:P,forceKeepAttr:void 0};let i=t.length;for(;i--;){const a=t[i],{name:o,namespaceURI:s,value:l}=a,c=Ce(o),d=l;let u="value"===o?d:GN(d);if(r.attrName=c,r.attrValue=u,r.keepAttr=!0,r.forceKeepAttr=void 0,Le(T.uponSanitizeAttribute,e,r),u=r.attrValue,!ie||"id"!==c&&"name"!==c||(Re(o,e),u="user-content-"+u),G&&QN(/((--!?|])>)|<\/(style|title)/i,u)){Re(o,e);continue}if(r.forceKeepAttr)continue;if(!r.keepAttr){Re(o,e);continue}if(!K&&QN(/\/>/i,u)){Re(o,e);continue}X&&PN([D,I,E],(e=>{u=KN(u,e," ")}));const p=Ce(e.nodeName);if(ze(p,c,u)){if(w&&"object"==typeof h&&"function"==typeof h.getAttributeType)if(s);else switch(h.getAttributeType(p,c)){case"TrustedHTML":u=w.createHTML(u);break;case"TrustedScriptURL":u=w.createScriptURL(u)}if(u!==d)try{s?e.setAttributeNS(s,o,u):e.setAttribute(o,u),Be(e)?Me(e):HN(n.removed)}catch(t){Re(o,e)}}else Re(o,e)}Le(T.afterSanitizeAttributes,e,null)},Ve=function e(t){let n=null;const r=Ne(t);for(Le(T.beforeSanitizeShadowDOM,t,null);n=r.nextNode();)Le(T.uponSanitizeShadowNode,n,null),Pe(n),We(n),n.content instanceof o&&e(n.content);Le(T.afterSanitizeShadowDOM,t,null)};return n.sanitize=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=null,a=null,s=null,c=null;if(be=!e,be&&(e="\x3c!--\x3e"),"string"!=typeof e&&!Fe(e)){if("function"!=typeof e.toString)throw JN("toString is not a function");if("string"!=typeof(e=e.toString()))throw JN("dirty is not a string, aborting")}if(!n.isSupported)return e;if(Q||Ie(t),n.removed=[],"string"==typeof e&&(oe=!1),oe){if(e.nodeName){const t=Ce(e.nodeName);if(!F[t]||W[t])throw JN("root node is forbidden and cannot be sanitized in-place")}}else if(e instanceof l)r=Ae("\x3c!----\x3e"),a=r.ownerDocument.importNode(e,!0),a.nodeType===TB&&"BODY"===a.nodeName||"HTML"===a.nodeName?r=a:r.appendChild(a);else{if(!ee&&!X&&!Z&&-1===e.indexOf("<"))return w&&ne?w.createHTML(e):e;if(r=Ae(e),!r)return ee?null:ne?$:""}r&&J&&Me(r.firstChild);const d=Ne(oe?e:r);for(;s=d.nextNode();)Pe(s),We(s),s.content instanceof o&&Ve(s.content);if(oe)return e;if(ee){if(te)for(c=k.call(r.ownerDocument);r.firstChild;)c.appendChild(r.firstChild);else c=r;return(P.shadowroot||P.shadowrootmode)&&(c=O.call(i,c,!0)),c}let u=Z?r.outerHTML:r.innerHTML;return Z&&F["!doctype"]&&r.ownerDocument&&r.ownerDocument.doctype&&r.ownerDocument.doctype.name&&QN(kB,r.ownerDocument.doctype.name)&&(u="<!DOCTYPE "+r.ownerDocument.doctype.name+">\n"+u),X&&PN([D,I,E],(e=>{u=KN(u,e," ")})),w&&ne?w.createHTML(u):u},n.setConfig=function(){Ie(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}),Q=!0},n.clearConfig=function(){Oe=null,Q=!1},n.isValidAttribute=function(e,t,n){Oe||Ie({});const r=Ce(e),i=Ce(t);return ze(r,i,n)},n.addHook=function(e,t){"function"==typeof t&&WN(T[e],t)},n.removeHook=function(e,t){if(void 0!==t){const n=zN(T[e],t);return-1===n?void 0:VN(T[e],n,1)[0]}return HN(T[e])},n.removeHooks=function(e){T[e]=[]},n.removeAllHooks=function(){T={afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}},n}();const AB=q.default.div`
    display: flex;
    flex-direction: column;
`,NB=q.default.div`
    display: flex;
...
`,qB=q.default(exports.Text.Body)`
    white-space: nowrap;
`,KB=q.default(exports.Text.Body)`
    white-space: nowrap;
    margin: 0 1rem;
`,XB=q.default(Bx)`
    ${gs.getTextStyle("Body",400)};
...
`,ZB=q.default.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,QB=Y.default.forwardRef((({id:n,"data-testid":r,className:i,pageSize:a=10,totalItems:o,activePage:s,pageSizeOptions:l=JB,showFirstAndLastNav:c,showPageSizeChanger:d=!1,onPageChange:u,onPageSizeChange:p},m)=>{const g=kl.useMediaQuery({maxWidth:Jo.mobileL}),v=l,[b,x]=t.useState(!1),[y,w]=t.useState(!1),[$,j]=t.useState(""),[S,k]=t.useState(v&&v.length>=1?v[0]:null),[C,O]=t.useState(!g&&d&&S?S.value:a),T=Math.ceil(o/C),D=1===s,I=s===T,E=s>1?()=>V(1):void 0,_=s<T?()=>V(T):void 0,M=s>1?()=>V(s-1):void 0,R=s<T?()=>V(parseInt(s.toString())+1):void 0,A=e=>e?()=>Z():()=>X(),N=e=>e?()=>Q():()=>G();t.useEffect((()=>{s&&H(s)}),[s]),t.useEffect((()=>{var e;O(a),k(null!==(e=v.find((e=>e.value===a)))&&void 0!==e?e:null)}),[a]);const H=e=>{j(e.toString())},W=()=>{x(!1),w(!1)},V=e=>{u&&(u(e),H(e))},Y=()=>{const e=Math.min(T,s+5);V(e),H(e),x(!0),w(!1)},U=()=>{const e=Math.max(1,s-5);V(e),H(e),x(!1),w(!0)},q=e=>{const t=e.target.value;if(void 0===t||0===t.length)j("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));H(Math.max(1,Math.min(T,e)))}else j(t.replace(/[^0-9]/g,""))},K=e=>{e.preventDefault(),$&&u(parseInt($))},X=()=>{x(!0)},G=()=>{x(!1)},Z=()=>{w(!0)},Q=()=>{w(!1)},J=(t,n,r)=>e.jsxs(YB,{children:[e.jsx(HB,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":t?"Previous 5 pages":"Next 5 pages",onMouseOver:A(t),onMouseOut:N(t),onFocus:A(t),onBlur:N(t),onClick:t?U:Y},{children:t&&y?e.jsx(B.Chevron2LeftIcon,{"aria-hidden":!0}):n&&b?e.jsx(F.Chevron2RightIcon,{"aria-hidden":!0}):e.jsx(z.EllipsisHorizontalIcon,{"aria-hidden":!0})})),t&&y&&e.jsx(GB,{children:"Previous 5 pages"}),n&&b&&e.jsx(GB,{children:"Next 5 pages"})]},r);return e.jsxs(LB,Object.assign({className:i,ref:m,id:n||"pagination-wrapper","data-testid":r||"pagination","aria-label":"Pagination"},{children:[e.jsx(PB,{children:e.jsxs(zB,{children:[c&&e.jsx(WB,Object.assign({onClick:E,disabled:D,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:e.jsx(L.ChevronLineLeftIcon,{"aria-hidden":!0})})),e.jsx(WB,Object.assign({onClick:M,disabled:D,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:e.jsx(h.ChevronLeftIcon,{"aria-hidden":!0})})),g?e.jsxs(UB,{children:[e.jsx("form",Object.assign({onSubmit:K},{children:e.jsx(XB,{value:$,onChange:q,autoComplete:"off",type:"numeric",id:(n||"pagination")+"-input","data-testid":(r||"pagination")+"-input"})})),e.jsx(KB,{children:"/"}),e.jsx(qB,{children:T})]}):[...Array(T)].map(((t,n)=>{const r=n+1,i=T-5,a=s===r;if(T<=7)return e.jsx(VB,Object.assign({onClick:()=>V(r),$selected:a,"aria-label":"Page "+r,"aria-current":!!a&&"page",onMouseOver:W,onFocus:W},{children:r}),r);const o=s+1>5&&2===r,l=s-1<=i&&r===T-1-1;return o||l?J(o,l,r):r<=5&&s+1<=5||r<=1||r===s||r<=s+1&&r>=s-1-1||r>i&&s-1>i||r>T-1?e.jsx(VB,Object.assign({onClick:()=>V(r),$selected:a,"aria-label":"Page "+r,"aria-current":!!a&&"page",onMouseOver:W,onFocus:W},{children:r}),r):null})),e.jsx(WB,Object.assign({onClick:R,disabled:I,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:e.jsx(f.ChevronRightIcon,{"aria-hidden":!0})})),c&&e.jsx(WB,Object.assign({onClick:_,disabled:I,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:e.jsx(P.ChevronLineRightIcon,{"aria-hidden":!0})}))]})}),d&&!g&&e.jsx(ZB,{children:e.jsx(aI,{options:v,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:S,onSelectOption:e=>{k(e);const t=e.value,n=Math.ceil(o/t);O(t);p&&p(s>=n?n:s,t)}})})]}))})),JB=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}],eF=q.default.div`
    border-radius: 1rem;
...
`,tF=q.default.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,nF=t=>{var{type:n,colorType:r="black",children:i,icon:a}=t,o=X(t,["type","colorType","children","icon"]);return e.jsxs(eF,Object.assign({$type:n,$color:r},o,{children:[a,e.jsx(tF,{children:i})]}))},rF=q.default.div`
    max-width: 30rem;
    pointer-events: auto;
    position: absolute;
...
`,fF=q.default(exports.Text.BodySmall)`
    overflow-wrap: anywhere;
    color: ${Qo.Neutral[1]};
`,hF=q.default.div`
    display: flex;
...
`;var mF=function(e){return function(t){return null==e?void 0:e[t]}}({"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","Ç":"C","ç":"c","Ð":"D","ð":"d","È":"E","É":"E","Ê":"E","Ë":"E","è":"e","é":"e","ê":"e","ë":"e","Ì":"I","Í":"I","Î":"I","Ï":"I","ì":"i","í":"i","î":"i","ï":"i","Ñ":"N","ñ":"n","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","Ø":"O","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","ø":"o","Ù":"U","Ú":"U","Û":"U","Ü":"U","ù":"u","ú":"u","û":"u","ü":"u","Ý":"Y","ý":"y","ÿ":"y","Æ":"Ae","æ":"ae","Þ":"Th","þ":"th","ß":"ss","Ā":"A","Ă":"A","Ą":"A","ā":"a","ă":"a","ą":"a","Ć":"C","Ĉ":"C","Ċ":"C","Č":"C","ć":"c","ĉ":"c","ċ":"c","č":"c","Ď":"D","Đ":"D","ď":"d","đ":"d","Ē":"E","Ĕ":"E","Ė":"E","Ę":"E","Ě":"E","ē":"e","ĕ":"e","ė":"e","ę":"e","ě":"e","Ĝ":"G","Ğ":"G","Ġ":"G","Ģ":"G","ĝ":"g","ğ":"g","ġ":"g","ģ":"g","Ĥ":"H","Ħ":"H","ĥ":"h","ħ":"h","Ĩ":"I","Ī":"I","Ĭ":"I","Į":"I","İ":"I","ĩ":"i","ī":"i","ĭ":"i","į":"i","ı":"i","Ĵ":"J","ĵ":"j","Ķ":"K","ķ":"k","ĸ":"k","Ĺ":"L","Ļ":"L","Ľ":"L","Ŀ":"L","Ł":"L","ĺ":"l","ļ":"l","ľ":"l","ŀ":"l","ł":"l","Ń":"N","Ņ":"N","Ň":"N","Ŋ":"N","ń":"n","ņ":"n","ň":"n","ŋ":"n","Ō":"O","Ŏ":"O","Ő":"O","ō":"o","ŏ":"o","ő":"o","Ŕ":"R","Ŗ":"R","Ř":"R","ŕ":"r","ŗ":"r","ř":"r","Ś":"S","Ŝ":"S","Ş":"S","Š":"S","ś":"s","ŝ":"s","ş":"s","š":"s","Ţ":"T","Ť":"T","Ŧ":"T","ţ":"t","ť":"t","ŧ":"t","Ũ":"U","Ū":"U","Ŭ":"U","Ů":"U","Ű":"U","Ų":"U","ũ":"u","ū":"u","ŭ":"u","ů":"u","ű":"u","ų":"u","Ŵ":"W","ŵ":"w","Ŷ":"Y","ŷ":"y","Ÿ":"Y","Ź":"Z","Ż":"Z","Ž":"Z","ź":"z","ż":"z","ž":"z","Ĳ":"IJ","ĳ":"ij","Œ":"Oe","œ":"oe","ŉ":"'n","ſ":"s"}),gF=Mo,vF=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,bF=RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]","g");var xF=function(e){return(e=gF(e))&&e.replace(vF,mF).replace(bF,"")},yF=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;var wF=function(e){return e.match(yF)||[]},$F=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;var jF=function(e){return $F.test(e)},SF="\\ud800-\\udfff",kF="\\u2700-\\u27bf",CF="a-z\\xdf-\\xf6\\xf8-\\xff",OF="A-Z\\xc0-\\xd6\\xd8-\\xde",TF="\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",DF="["+TF+"]",IF="\\d+",EF="["+kF+"]",_F="["+CF+"]",MF="[^"+SF+TF+IF+kF+CF+OF+"]",RF="(?:\\ud83c[\\udde6-\\uddff]){2}",AF="[\\ud800-\\udbff][\\udc00-\\udfff]",NF="["+OF+"]",BF="(?:"+_F+"|"+MF+")",FF="(?:"+NF+"|"+MF+")",LF="(?:['’](?:d|ll|m|re|s|t|ve))?",PF="(?:['’](?:D|LL|M|RE|S|T|VE))?",zF="(?:[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]|\\ud83c[\\udffb-\\udfff])?",HF="[\\ufe0e\\ufe0f]?",WF=HF+zF+("(?:\\u200d(?:"+["[^"+SF+"]",RF,AF].join("|")+")"+HF+zF+")*"),VF="(?:"+[EF,RF,AF].join("|")+")"+WF,YF=RegExp([NF+"?"+_F+"+"+LF+"(?="+[DF,NF,"$"].join("|")+")",FF+"+"+PF+"(?="+[DF,NF+BF,"$"].join("|")+")",NF+"?"+BF+"+"+LF,NF+"+"+PF,"\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])","\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",IF,VF].join("|"),"g");var UF=wF,qF=jF,KF=Mo,XF=function(e){return e.match(YF)||[]};var GF=ND,ZF=xF,QF=function(e,t,n){return e=KF(e),void 0===(t=n?void 0:t)?qF(e)?XF(e):UF(e):e.match(t)||[]},JF=RegExp("['’]","g");var eL=Ci(function(e){return function(t){return GF(QF(ZF(t).replace(JF,"")),e,"")}}((function(e,t,n){return e+(n?"-":"")+t.toLowerCase()})));const tL=q.default.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 1.5rem;
...
`,pL=q.default(exports.Text.XSmall)``,fL=t.createContext({selectedItem:void 0,currentItem:void 0,previouslySelectedItemId:void 0,setCurrentItem:()=>{},setPreviouslySelectedItemId:()=>{},setSelectedItem:()=>{}}),hL=q.default.ul`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`,mL=q.default.li`
    ...
    height: 1px;
    background-color: ${Qo.Neutral[5]};
`,gL=q.default(Si.li)``,vL=q.default(Ys.Default)`
    justify-content: flex-start;
    width: 100%;
    height: unset;
    padding: 0.75rem 1rem;
...
`,wL=q.default.div`
    ...
    -webkit-box-orient: vertical;
    text-align: initial;
`,$L=q.default(Si.ul)``,jL=q.default.li``,SL=q.default(Ys.Default)`
    width: 100%;
    height: unset;
    justify-content: flex-start;
    border-radius: 0.5rem;
...
`,kL=Object.assign((n=>{var{fixed:r=!0,children:i}=n,a=X(n,["fixed","children"]);const o=t.useRef(null),[s,l]=t.useState(void 0),[c,d]=t.useState(void 0),[u,p]=t.useState(void 0),[f,h]=t.useState(!1),m=t.useMemo((()=>({currentItem:s,selectedItem:c,previouslySelectedItemId:u,setCurrentItem:l,setSelectedItem:d,setPreviouslySelectedItemId:p})),[s,c,u,l,d,p]),g=oi({width:f?240:0,borderRightWidth:f?1:0,borderTopWidth:f?1:0,borderBottomWidth:f?1:0,borderLeftWidth:0});return cc("click",(e=>{o.current&&!o.current.contains(e.target)&&(d({itemId:u||(c?c.itemId:void 0),content:void 0}),p(void 0),l(void 0))}),"window",!0),t.useEffect((()=>{h(c&&!!c.content||s&&!!s.content)}),[s,c]),e.jsx(fL.Provider,Object.assign({value:m},{children:e.jsxs(iL,Object.assign({$fixed:r},a,{ref:o,onMouseLeave:()=>{l(void 0)}},{children:[e.jsx(oL,{children:i}),e.jsx(lL,Object.assign({style:g,$showDrawer:f,"data-testid":"sidenav-drawer"},{children:s&&s.content||c&&c.content})),e.jsx(sL,{})]}))}))}),{Group:t=>{var{separator:n,children:r}=t,i=X(t,["separator","children"]);return e.jsxs(hL,Object.assign({},i,{children:[r,n&&e.jsx(mL,{"data-testid":"divider"})]}))},Item:n=>{var{children:r,icon:i,title:a,onClick:o}=n,s=X(n,["children","icon","title","onClick"]);const l=s.id||a.toLowerCase().replaceAll(" ","-"),{currentItem:c,previouslySelectedItemId:d,selectedItem:u,setCurrentItem:p,setPreviouslySelectedItemId:f,setSelectedItem:h}=t.useContext(fL);t.useEffect((()=>{s.selected&&h({itemId:l,content:void 0})}),[s.selected]);return e.jsx(cL,{children:e.jsxs(dL,Object.assign({styleType:"link",type:"button",onClick:()=>{f((()=>{if(r&&u)return d||u.itemId})()),p({itemId:l,content:r}),h({itemId:l,content:r}),o&&!r&&o(l)},onMouseEnter:()=>{p({itemId:l,content:r})}},s,{$highlight:u&&u.itemId===l||c&&c.itemId===l},{children:[e.jsx(uL,{children:i}),e.jsx(pL,{children:a})]}))})},DrawerItem:n=>{var{id:r,title:i,onClick:a,children:o}=n,s=X(n,["id","title","onClick","children"]);const[l,c]=t.useState(!0),[d,u]=t.useState(!1),{currentItem:p,setSelectedItem:f,setPreviouslySelectedItemId:h,setCurrentItem:m}=t.useContext(fL),g=oi({from:{opacity:0},to:{opacity:1}}),v=Ye(),b=v.ref,x=oi({height:o&&l?v.height:0});return e.jsxs(gL,Object.assign({onMouseEnter:()=>{u(!0)},onMouseLeave:()=>{u(!1)}},s,{style:g},{children:[e.jsxs(vL,Object.assign({styleType:"link",type:"button",onClick:()=>{o?c(!l):(f({itemId:p.itemId,content:void 0}),m(void 0),h(void 0),a&&a(r))},$highlight:d&&l,$noChildren:!o},{children:[e.jsx(wL,{children:i}),o&&e.jsx(xL,{children:e.jsx(yL,{"aria-hidden":!0,$expanded:l})})]})),e.jsx(bL,Object.assign({style:x},{children:e.jsx($L,Object.assign({ref:b},{children:o}))}))]}))},DrawerSubitem:n=>{var{id:r,title:i,onClick:a}=n,o=X(n,["id","title","onClick"]);const{currentItem:s,setSelectedItem:l,setCurrentItem:c,setPreviouslySelectedItemId:d}=t.useContext(fL);return e.jsx(jL,Object.assign({},o,{children:e.jsx(SL,Object.assign({styleType:"link",type:"button",onClick:()=>{a&&a(r),l({itemId:s.itemId,content:void 0}),c(void 0),d(void 0)}},{children:i}))}))}}),CL=i.keyframes`
	from {
		opacity: 0;
...
`,NL=q.default(exports.Text.H6)`
    overflow-wrap: anywhere;
    ${ts.MaxWidth.mobileM} {
        ${gs.getTextStyle("XSmall","semibold")}
    }
`,BL=q.default(exports.Text.XSmall)`
    overflow-wrap: anywhere;
`,FL=q.default.div`
    margin-top: 0.25rem;
    display: flex;
...
`,LL=i.css`
    ...
    color: #ffc107;
`,PL=q.default(b.StarFillIcon)`
    ${LL}
`,zL=q.default(H.StarHalfIcon)`
    ${LL}
`,HL=q.default(v.StarIcon)`
    ${LL}
`,WL="https://assets.life.gov.sg/react-design-system/img/app-icon/app-icon.png",VL="smart-app-banner";const YL=Y.default.forwardRef((function(t,n){const{className:r,show:i,href:a,content:o,offset:s=0,icon:l=WL,animated:c=!1,onDismiss:d,onClick:u}=t,{title:p,message:f,buttonLabel:h,buttonAriaLabel:m,numberOfStars:g}=o,v=e=>{e.stopPropagation(),window.open(a,"_blank","noreferrer"),null==u||u()};return e.jsx(e.Fragment,{children:i&&e.jsxs(OL,Object.assign({ref:n,$isAnimated:c,$offset:s,className:r},{children:[e.jsx(TL,Object.assign({onClick:d,id:`${VL}-dismiss`,"data-testid":`${VL}-dismiss-container`},{children:e.jsx(DL,Object.assign({"aria-label":"Dismiss"},{children:e.jsx(IL,{})}))})),e.jsxs(EL,Object.assign({onClick:v,id:`${VL}-proceed`,"data-testid":`${VL}-proceed-container`},{children:[e.jsx(ML,{src:l,alt:"lifesg-app-icon"}),e.jsxs(_L,{children:[e.jsx(NL,{children:p}),e.jsx(BL,{children:f}),(()=>{if(isNaN(g)||g<0)return;const t=[],n=g-Math.floor(g)>=.4;for(let n=0;n<Math.floor(g);n++)t.push(e.jsx(PL,{},`star${n}`));if(n&&t.push(e.jsx(zL,{},"halfstar")),t.length<5){const n=5-t.length;for(let r=0;r<n;r++)t.push(e.jsx(HL,{},`emptystar${r}`))}return e.jsx(FL,{children:t.slice(0,5)})})()]}),e.jsx(RL,{children:e.jsx(AL,Object.assign({type:"button",onClick:v,"aria-label":m},{children:h}))})]}))]}))})})),UL=Y.default.createContext({currentActiveIndex:0,tabLinks:[],setCurrentActiveIndex:()=>{}}),qL=q.default.div`
    position: relative;
    width: 100%;
`,KL=q.default.div`
    width: 4rem;
...
`,ZL=t.forwardRef(((n,r)=>{var{children:i,fadeColor:a,fadePosition:o="both",showIndicator:s=!1,onResize:l}=n,c=X(n,["children","fadeColor","fadePosition","showIndicator","onResize"]);const[d,u]=t.useState("left"===o||"both"===o),[p,m]=t.useState("right"===o||"both"===o),g=t.useRef(null),v=t.useRef(null),b=tu(x,50);function x(){const e=g.current,t=v.current;e&&t&&t.scrollWidth>e.offsetWidth?(m(Math.round(t.scrollLeft)<t.scrollWidth-t.offsetWidth),u(t.scrollLeft>=1)):(m(!1),u(!1))}function y(){x(),l&&l({content:v.current,wrapper:g.current})}Ye({onResize:y,targetRef:g,refreshMode:"debounce",refreshRate:50}),t.useImperativeHandle(r,(()=>({resize(){y()}}))),t.useEffect((()=>{const e=v.current;return x(),e&&e.addEventListener("scroll",b),()=>{e&&e.removeEventListener("scroll",b)}}),[]);return e.jsxs(qL,Object.assign({ref:g},c,{children:[e.jsx(XL,Object.assign({ref:v},{children:i})),(()=>{let t;return t=Array.isArray(a)&&a.length>0?{left:a,right:a}:a||{left:void 0,right:void 0},e.jsxs(e.Fragment,{children:[d&&e.jsx(KL,Object.assign({$backgroundColor:t.left,$position:"left",$showIndicator:s,"data-id":"left-fade"},{children:s&&e.jsx(GL,Object.assign({$position:"left","data-id":"left-fade-indicator-button"},{children:e.jsx(h.ChevronLeftIcon,{})}))})),p&&e.jsx(KL,Object.assign({$backgroundColor:t.right,$position:"right",$showIndicator:s,"data-id":"right-fade"},{children:s&&e.jsx(GL,Object.assign({$position:"right","data-id":"right-fade-indicator-button"},{children:e.jsx(f.ChevronRightIcon,{})}))}))]})})()]}))})),QL=q.default.ul`
    display: inline-flex;
    width: 100%;
    list-style-type: none;
...
`,tP=q.default(exports.Text.Body)`
    ...
    ${e=>{if(e.$active)return i.css`
                opacity: 0;
            `}}
`,nP=q.default(exports.Text.Body)`
    color: ${Qo.Primary};
    opacity: 0;
    ${e=>{if(e.$active)return i.css`
                opacity: 1;
...
`,lP=q.default.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`;var cP;Pl.extend(Hl),function(e){e.formatHourlyDisplay=e=>Pl(e,"HH:mm").format("ha"),e.calculateWidth=(e,t,n)=>ic.getTimeDiffInMinutes(e,t)/15*(n/2)}(cP||(cP={}));const dP=1.25,uP=e=>"minified"===e?12:40,pP=e=>"minified"===e?12:40,fP=q.default.div`
    position: relative;
    display: flex;
    align-items: center;
`,hP=q.default(is)`
...
`,mP=q.default(f.ChevronRightIcon)`
    width: 1rem;
    height: 1rem;
    color: ${Qo.Primary};
`,gP=q.default(h.ChevronLeftIcon)`
    font-size: 1rem;
    color: ${Qo.Primary};
`,vP=q.default.div`
    overflow: hidden;
...
`,yP=q.default.div`
    display: inline-block;
    width: ${({$variant:e})=>`${uP(e)}px`};
    position: relative;
    border-left: 1px solid ${Qo.Neutral[2]};
    ${e=>{let t=0;switch(e.$variant){case"default":t=e.$isLongMarker?dP:.625;break;case"minified":t=e.$isLongMarker?dP:0;break;default:t=0}return i.css`
            height: ${t}rem;
        `}}
`,wP=q.default(exports.Text.XSmall)`
    color: ${Qo.Neutral[2]};
    position: absolute;
    bottom: 10%;
    left: 10%;
...
`,jP=q.default.div`
    position: absolute;
    top: ${dP}rem;
    height: ${({$variant:e})=>`${pP(e)}px`};
    z-index: 1;
    border-right: 1px solid ${Qo.Neutral[2]};
`,SP=q.default(exports.Text.XSmall)`
...
`,FP=q.default($P)`
    ...
    ${e=>e.$halfFill?i.css`
            ...
            `}
`;var LP=qi;var PP=function(e,t,n){for(var r=-1,i=e.length;++r<i;){var a=e[r],o=t(a);if(null!=o&&(void 0===s?o==o&&!LP(o):n(o,s)))var s=o,l=a}return l};var zP=PP,HP=H$,WP=function(e,t){return e<t};var VP=Ci((function(e,t){return e&&e.length?zP(e,HP(t),WP):void 0}));var YP=PP,UP=function(e,t){return e>t},qP=H$;var KP=Ci((function(e,t){return e&&e.length?YP(e,qP(t),UP):void 0}));const XP=({calendarDate:n,disabledDates:r,selectedDate:i,onSelect:a,minDate:o,maxDate:s,startTime:l,endTime:c,maxVisibleCellHeight:d,slots:u,interval:p=30,variant:f="flexible",enableSelection:h=!0,onSlotClick:m})=>{var g,v,b,x;const y="YYYY-MM-DD",[w,$]=t.useState(!1),[j,S]=t.useState(),k=t.useMemo((()=>Ql.generateDaysForCurrentWeek(n)),[n]),C=Object.values(null!=u?u:{}).flat(),O=null!==(v=null!=l?l:null===(g=VP(C,"startTime"))||void 0===g?void 0:g.startTime)&&void 0!==v?v:"00:00",T=null!==(x=null!=c?c:null===(b=KP(C,"endTime"))||void 0===b?void 0:b.endTime)&&void 0!==x?x:"24:00",D=Math.ceil(ic.getTimeDiffInMinutes(O,T)/p),{height:I,ref:E}=Ye(),_=d?I<d||w?I:d:I,M=oi({height:_}),R=t.useMemo((()=>{if(u){const e={};return Object.entries(u).forEach((([t,n])=>{const r=function(e){const t=Array(D).fill({});return e.forEach((e=>{const n=Math.max(0,ic.getTimeDiffInMinutes(O,e.startTime)/p),r=Math.min(D,ic.getTimeDiffInMinutes(O,e.endTime)/p),i=Math.ceil(r)-Math.floor(n);switch(f){case"fixed":t[Math.floor(n)]=Object.assign(Object.assign({},e),{cellLength:r-n});break;case"flexible":for(let a=0;a<i;a++){const o=ic.addMinutesToTime(O,Math.floor(n+a)*p),s=ic.addMinutesToTime(o,p);let l;vD(t[Math.floor(n+a)])?0===a&&n%1!=0?l="top":a===i-1&&r%1!=0&&(l="bottom"):l=void 0,t[Math.floor(n+a)]=Object.assign(Object.assign({},e),{id:`${e.id}-${a}`,startTime:o,endTime:s,cellLength:1,halfFill:l})}}})),t}(n);e[t]=function(e){var t,n,r,i;let a=0;switch(f){case"fixed":for(e=e.reduce(((e,t)=>{const n=e.length>0?e[e.length-1]:e[0];return vD(t)&&vD(n)?e:[...e,t]}),[{}]);a<e.length;){if(vD(e[a])){const o=null!==(n=null===(t=e[a-1])||void 0===t?void 0:t.endTime)&&void 0!==n?n:O,s=null!==(i=null===(r=e[a+1])||void 0===r?void 0:r.startTime)&&void 0!==i?i:T;if(o!==s){const t=ic.getTimeDiffInMinutes(o,s)/p;e[a]=Object.assign(Object.assign({},L(a)),{startTime:o,endTime:s,cellLength:t})}}a++}break;case"flexible":for(;a<e.length;)vD(e[a])?(e[a]=L(a),a++):a+=e[a].cellLength}return e.filter((e=>!vD(e)&&e.cellLength>0))}(r)})),e}return{}}),[u]),A=e=>{S(e)},N=()=>{S(void 0)},B=e=>{e.preventDefault(),$((e=>!e))},F=e=>{var t;const n=Ql.isWithinRange(e,o?Pl(o):void 0,s?Pl(s):void 0),i=null!==(t=r&&r.includes(e.format(y)))&&void 0!==t&&t;return!n||i};function L(e,t=1){return{id:`${e.toString()}-${(new Date).getTime()}`,startTime:"",endTime:"",clickable:!1,styleAttributes:{backgroundColor:"#E0E4E5"},cellLength:t}}return e.jsxs(TP,{children:[e.jsx(OP,{children:k.map(((t,n)=>{const r=(e=>{const t=e.format(y),n=F(e),r={},a=h&&!n;return n&&(r.disabled=!0),r.interactive=h?a:null,a&&j&&e.isSame(j,"day")&&(r.circleLeft="hover-current",r.circleRight="hover-current",r.circleShadow=!0),[i].includes(t)&&(r.labelType="selected",r.circleLeft="selected-outline",r.circleRight="selected-outline"),r})(t);return e.jsx(gd,Object.assign({date:t,calendarDate:Pl(i),onSelect:()=>{((e,t)=>{!t&&h&&a(e)})(t,!r.interactive)},onHover:A,onHoverEnd:N},r),`day-${n}`)}))}),e.jsx(OP,{children:k.map(((t,n)=>e.jsx(kP,{children:e.jsx(CP,Object.assign({weight:"semibold",$disabled:F(t)},{children:Pl(t).format("ddd")}))},`week-day-${n}`)))}),(()=>{let t=!1;const n=e=>{const n=Pl(O,"HH:mm").add(4*e*p,"minutes"),r=n.format("h"),i=n.format("mm"),a=n.format("a");let o=`${r}${"00"!==i?` ${i}`:""}`;return t||"pm"!==a||"00"!==i||(o+=` ${a}`,t=!0),o};return e.jsx(EP,Object.assign({$height:_},{children:Array(Math.ceil(D/4)).fill(void 0).map(((t,r)=>e.jsx(_P,{children:e.jsx(MP,{children:n(r)})},`time-${r}`)))}))})(),e.jsx(DP,Object.assign({style:M},{children:e.jsx(IP,Object.assign({ref:E},{children:k.map(((t,n)=>{var r;const i=t.format(y),a=null!==(r=R[i])&&void 0!==r?r:Array("flexible"===f?D:1).fill(void 0).map(((e,t)=>L(t,"fixed"===f?D:void 0)));return e.jsx(RP,{children:a.map((t=>{const{id:n,clickable:r=!0,styleAttributes:a,cellLength:o,halfFill:s}=t,{styleType:l="default",backgroundColor:c,backgroundColor2:d}=a;return e.jsx(FP,{$type:"vertical",$variant:"default",$styleType:l,$bgColor:c,$bgColor2:d,$halfFill:s,$clickable:r,$height:"fixed"===f?12*o+4*(o-1):12,onClick:()=>r&&((e,t)=>{m&&m(e,t)})(i,t)},n)}))},`wrapper-${n}`)}))}),`week-cell-${n.format(y)}`)})),(()=>{if(d&&E.current&&!(I&&I<d))return e.jsx(AP,{children:e.jsxs(NP,Object.assign({"data-testid":"time-bar-expand-collapse-button",styleType:"light",onClick:B},{children:[e.jsx(BP,{$isExpanded:w}),(w?"Hide":"Show")+" later times"]}))})})()]})},GP=q.default.div`
    min-width: 18.5rem;
...
`,rz=q.default.div`
    ...
    flex: 1;
    margin: 1px;
`;Pl.extend(Vl);const iz={id:"1",startTime:"",endTime:"",clickable:!1,styleAttributes:{styleType:"stripes",backgroundColor:"#ECEFEF",backgroundColor2:"#E0E4E5"}},az=({calendarDate:n,disabledDates:r,selectedDate:i,onSelect:a,minDate:o,maxDate:s,slots:l,enableSelection:c=!0,onSlotClick:d})=>{const u=t.useMemo((()=>Ql.generateDaysForCurrentWeek(n)),[n]),p="YYYY-MM-DD",f=e=>{const t=e.format(p),n=(e=>{const t=Ql.isWithinRange(e,o?Pl(o):void 0,s?Pl(s):void 0),n=r&&r.includes(e.format(p));return!t||n})(e),a={},l={};return n&&(a.$disabledDisplay=!0,l.$disabledDisplay=!0),a.$interactive=c&&!n,[i].includes(t)&&(a.$selected=!0,l.$selected=!0),{styleCircleProps:a,styleLabelProps:l}};return e.jsxs(ez,{children:[e.jsx(Qc,{children:u.map(((t,n)=>{const r="default",{styleCircleProps:i,styleLabelProps:o}=f(t);return e.jsx(Jc,{children:e.jsx(rd,Object.assign({$variant:r,onClick:()=>((e,t)=>{!t&&c&&a(e)})(t,!i.$interactive)},i,{children:e.jsx(QP,Object.assign({weight:o.$selected?"semibold":"regular",$variant:r},o,{children:t.format("D")}))}))},`day-${n}`)}))}),u.map(((t,n)=>e.jsx(JP,{children:e.jsx(exports.Text.XSmall,Object.assign({weight:"semibold"},{children:Pl(t).format("ddd")}))},`week-day-${n}`))),e.jsx(tz,{children:u.map(((t,n)=>{const r=t.format(p),i=l&&(l[r]?l[r]:[iz]);return e.jsx(rz,{children:i&&i.map((t=>{const{id:n,startTime:i,endTime:a,clickable:o=!0,styleAttributes:s}=t,{color:l,styleType:c="default",backgroundColor:u,backgroundColor2:p}=s;return e.jsx($P,Object.assign({$type:"vertical",$variant:"default",$styleType:c,$bgColor:u,$bgColor2:p,$clickable:o,onClick:()=>o&&((e,t)=>{d(e,t)})(r,t)},{children:e.jsxs(nz,Object.assign({style:{color:l}},{children:[e.jsx("span",{children:Ql.convertTo12HourFormat(i)}),a&&i&&e.jsx("span",{children:"-"}),e.jsx("span",{children:Ql.convertTo12HourFormat(a)})]}))}),n)}))},`wrapper-${n}`)}))},`week-cell-${n.format(p)}`)]})},oz=q.default.div`
    min-width: 18.5rem;
...
`,sz="YYYY-MM-DD",lz=q.default.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 1.5rem;
...
`,pz=q.default(exports.Text.H3)`
    margin-bottom: 1rem;

    ${ts.MaxWidth.tablet} {
        margin-bottom: 1.5rem;
    }
`,fz=q.default(exports.Text.H4)`
    margin-top: -0.125rem;
    margin-bottom: 0.5rem;
`,hz=q.default.div`
    display: flex;
...
`,vz=q.default(nF)`
    padding: 0.125rem 0.5rem;
`,bz=["#FFE6BB","#D8EFEB","#E6EAFE","#FAE4E5","#D3EEFC"],xz=15,yz=252,wz=["#FFF2DD","#EBF7F5","#F2F4FE","#FCF1F2","#E9F6FD"],$z=i.keyframes`
    100% {
...
`,kz=q.default.div`
    ...
    justify-content: center;
    gap: 0.625rem;
`,Cz=q.default(exports.Text.H6)`
    color: ${Qo.Neutral[3]};
`,Oz=q.default(Bp)`
    width: 400px;
`,Tz=t=>{var{selectedDate:n,loading:r,tableContainerRef:i,totalRecords:a,onPreviousDayClick:o,onNextDayClick:s,onRefresh:l,onCalendarDateSelect:c}=t,d=X(t,["selectedDate","loading","tableContainerRef","totalRecords","onPreviousDayClick","onNextDayClick","onRefresh","onCalendarDateSelect"]);const p=()=>{i.current&&(i.current.scrollTop=0)},f=()=>{l&&(p(),l())};return e.jsxs(Sz,{children:[e.jsx(Oz,Object.assign({selectedDate:n,loading:r},d,{onRightArrowClick:e=>{p(),s(e)},onLeftArrowClick:e=>{p(),o(e)},onCalendarDateSelect:c})),void 0===a?e.jsx(e.Fragment,{}):e.jsxs(kz,{children:[e.jsxs(Cz,Object.assign({"data-testid":"timetable-records-results",weight:"semibold"},{children:[a," results found"]})),l&&e.jsx(jz,Object.assign({"data-testid":"timetable-records-refresh-btn",styleType:"light",sizeType:"small",disabled:r,onClick:f,$loading:r},{children:e.jsx(u.RefreshIcon,{})}))]})]})},Dz=q.default.div`
    display: flex;
    width: 100%;
`,Iz=q.default.div`
    border-bottom: 1px solid ${Qo.Neutral[5]};
...
`,Mz=q.default.div`
    ...
    ${({$status:e,$mainColor:t,$altColor:n,$isClickable:r})=>{switch(e){case"blocked":return i.css`
                ...
                `}}}
`,Rz=q.default(exports.Text.H6)`
    text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;
`,Az=q.default(exports.Text.XSmall)`
    color: ${Qo.Neutral[3]};
    text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;
`,Nz=Y.default.memo((({id:t,startTime:n,endTime:r,title:i,subtitle:a,status:o,intervalWidth:s,rowBarColor:l,containerRef:c,customPopover:d,roundedStartTime:u=n,roundedEndTime:p=r,onClick:f})=>{const h=0===Pl(p,"HH:mm").get("minutes"),m=ic.getTimeDiffInMinutes(u,p)/xz*s-2,g=!!f||d&&"click"===d.trigger;return e.jsx((({wrapper:e,children:t})=>d?e(t):t),Object.assign({wrapper:t=>(t=>{const n={position:"bottom-start",rootNode:c,customOffset:d.offset,children:t,trigger:d.trigger,delay:d.delay,popoverContent:d.content};return e.jsx(zb,Object.assign({},n,{children:t}))})(t)},{children:e.jsx(Iz,Object.assign({"data-testid":"block-container",$isOnTheHour:h},{children:e.jsxs(Ez,{children:[e.jsxs(Mz,Object.assign({$width:m,$status:o,$mainColor:l.mainColor,$altColor:l.alternateColor,$isClickable:g,onClick:e=>{f&&f({id:t,startTime:n,endTime:r,status:o,title:i,subtitle:a,customPopover:d},e)}},{children:[i&&e.jsx(Rz,Object.assign({weight:"semibold"},{children:i})),a&&e.jsx(Az,Object.assign({weight:"bold"},{children:a}))]})),e.jsx(_z,{})]})}),"block-container-key")}))})),Bz=n=>{var{id:r,timetableMinTime:i,timetableMaxTime:a,rowMinTime:o,rowMaxTime:s,rowCells:l,rowBarColor:c,intervalWidth:d,containerRef:u,outOfRangeCellPopover:p}=n,f=X(n,["id","timetableMinTime","timetableMaxTime","rowMinTime","rowMaxTime","rowCells","rowBarColor","intervalWidth","containerRef","outOfRangeCellPopover"]);const h=f["data-testid"]||"timetable-row",m=o?mu.roundToNearestInterval(o,xz):i,g=s?mu.roundToNearestInterval(s,xz,!0):a,v=t.useMemo((()=>{const e=[];m&&Pl(i,"HH:mm").isBefore(Pl(m,"HH:mm"))&&e.push({id:r,startTime:i,endTime:m,status:"blocked",customPopover:p});const t=[...l].sort(((e,t)=>{const n=Pl(e.startTime,"HH:mm"),r=Pl(t.startTime,"HH:mm");return n.isBefore(r)?-1:n.isAfter(r)?1:0}));let n;return t.forEach(((i,a)=>{var o;const{startTime:s,endTime:l}=i;let c=mu.roundToNearestInterval(s,xz);n&&Pl(c,"HH:mm").isBefore(Pl(n,"HH:mm"))&&(c=mu.roundToNearestInterval(s,xz,!0));const d=mu.roundToNearestInterval(l,xz,!0);e.push(Object.assign(Object.assign({},i),{roundedStartTime:c,roundedEndTime:d}));const u=(null===(o=t[a+1])||void 0===o?void 0:o.startTime)||g,p=Pl(mu.roundToNearestInterval(u,xz),"HH:mm");let f=Pl(d,"HH:mm");for(;f.isBefore(p);)if(h=p,f.get("hour")!=h.get("hour")){const t=f.add(1,"hour").startOf("hour");e.push({id:r,startTime:f.format("HH:mm").toString(),endTime:t.format("HH:mm").toString(),status:"disabled"}),f=t}else e.push({id:r,startTime:f.format("HH:mm").toString(),endTime:p.format("HH:mm").toString(),status:"disabled"}),f=p;var h;n=f.format("HH:mm").toString()})),g&&Pl(a,"HH:mm").isAfter(Pl(g,"HH:mm"))&&e.push({id:r,startTime:g,endTime:a,status:"blocked",customPopover:p}),0!==t.length||o||s||e.push({id:r,startTime:i,endTime:a,status:"blocked",customPopover:p}),e}),[m,i,l,g,a,o,s,r,p]);return e.jsx(Dz,Object.assign({"data-testid":h},f,{children:v.map(((t,n)=>e.jsx(Nz,Object.assign({},t,{intervalWidth:d,rowBarColor:c,containerRef:u}),`${n}-row-cell-key`)))}))},Fz=q.default.div``,Lz=q.default.div`
    display: grid;
    overflow: scroll;
    position: relative;
    grid-template-columns: ${yz}px auto;
`,Pz=q.default.div`
    display: grid;
    overflow: scroll;
    position: relative;
    grid-template-columns: ${yz}px fit-content(100%);
...
`,Xz=q.default(exports.Text.XSmall)`
    display: inline-flex;
    gap: 6px;
    align-items: center;
    color: ${Qo.Neutral[3]};
...
`,tH=q.default.div`
    ...
    animation: ${eH} 1.5s forwards infinite;
`,nH=q.default(zb)`
    max-width: 24rem !important;
    :hover {
        cursor: default;
    }
`,rH=e=>{switch(e.$type){case"success":return Qo.Validation.Green;case"warning":return Qo.Validation.Orange;case"error":return Qo.Validation.Red;case"info":return Qo.Validation.Blue;default:return}},iH=q.default(Si.div)`
    display: flex;
    flex-direction: row;
    position: ${e=>e.$fixed?"fixed":"relative"};
...
`,SH=Y.default.forwardRef(((t,n)=>{var{stretch:r}=t,i=X(t,["stretch"]);return e.jsx(jH,Object.assign({ref:n,$stretch:r},i))})),kH=q.default.li`
    display: flex;
    flex-direction: column;
...
`,IH=q.default(j.ExclamationTriangleIcon)`
    color: ${Qo.Validation.Orange.Icon};
    margin-right: 0.5rem;
    height: 1.125rem;
    width: 1.125rem;
