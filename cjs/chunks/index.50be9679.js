...
`,BH=e=>{const t={success:{Background:"bg-success",Border:"border-success",Text:"text-success",Icon:"icon-success"},warning:{Background:"bg-warning",Border:"border-warning",Text:"text-warning",Icon:"icon-warning"},error:{Background:"bg-error",Border:"border-error",Text:"text-error",Icon:"icon-error"},info:{Background:"bg-info",Border:"border-info",Text:"text-info",Icon:"icon-info"}}[e.$type];return{Background:qs[t.Background],Border:qs[t.Border],Text:qs[t.Text],Icon:qs[t.Icon]}},AH=K.default(Ti.div)`
    display: flex;
    flex-direction: row;
    position: ${e=>e.$fixed?"fixed":"relative"};
    ...
    ${e=>i.css`
            background: ${BH(e).Background};
            border: 1px solid ${BH(e).Border};
            color: ${BH(e).Text};
        `};
`,RH=K.default.div`
    display: flex;
...
`,PH=K.default.div`
    display: flex;
    flex-direction: column;
`,LH=K.default(exports.Typography.HeadingXS)`
    display: flex;
...
`,ZH=K.default(p_.Content)`
    ...
    padding-top: 2rem;
    padding-bottom: 2rem;
`,QH=K.default(exports.Typography.HeadingSM)`
    margin-bottom: 1rem;
    ${GH}
