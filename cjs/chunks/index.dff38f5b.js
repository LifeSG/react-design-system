...
`,zs=({color:t,className:n,size:r=18})=>e.jsxs(As,Object.assign({className:n,$size:r,$color:t},{children:[e.jsx(Bs,{id:"inner1",$size:r-2,$borderWidth:2,$color:t}),e.jsx(Fs,{id:"inner2",$size:r-2,$borderWidth:2,$color:t}),e.jsx(Ls,{id:"inner3",$size:r-2,$borderWidth:2,$color:t}),e.jsx(Ps,{id:"inner4",$size:r-2,$borderWidth:2,$color:t})]}));var Hs;exports.RedirectScope=void 0,(Hs=exports.RedirectScope||(exports.RedirectScope={}))[Hs.Subpage=0]="Subpage",Hs[Hs.Domain=1]="Domain";const Ws={collections:{base:{InputBoxShadow:i.css`
    ...
    `,ElevationBoxShadow:i.css`
      0px 2px 8px ${ts.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Vs=e=>t=>{var n;const r=t.theme,i=Za(Ws,r[exports.ThemeContextKeys.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?Ga(i,e,r.options.designToken):Ga(i,e)},Ys={InputBoxShadow:Vs("InputBoxShadow"),InputErrorBoxShadow:Vs("InputErrorBoxShadow"),ElevationBoxShadow:Vs("ElevationBoxShadow"),Table:{Header:Vs("Table.Header"),Cell:{Primary:Vs("Table.Cell.Primary"),Secondary:Vs("Table.Cell.Secondary"),Selected:Vs("Table.Cell.Selected"),Hover:Vs("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Vs("Button.Danger.BackgroundColor"),Hover:Vs("Button.Danger.Hover"),Primary:Vs("Button.Danger.Primary"),Border:Vs("Button.Danger.Border")}}},Us=K.default.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
...
`,kc=K.default(Us)`
    ...
    ${e=>"small"===e.$buttonSizeStyle?i.css`
                ...
                `}
`,Cc={Default:Y.default.forwardRef(((t,n)=>{const{children:r,disabled:i=!1,styleType:o="default",danger:a=!1,icon:s,iconPosition:l="left"}=t,c=X(t,["children","disabled","styleType","danger","icon","iconPosition"]),d={$buttonIconPosition:l,$buttonStyle:i?"disabled":o,$buttonSizeStyle:"default",$buttonIsDanger:a};return e.jsxs(kc,Object.assign({ref:n,"data-testid":c["data-testid"]||"button-with-icon",disabled:i},d,c,{children:[s,e.jsx("span",{children:r})]}))})),Small:Y.default.forwardRef(((t,n)=>{const{children:r,disabled:i=!1,styleType:o="default",danger:a=!1,icon:s,iconPosition:l="left"}=t,c=X(t,["children","disabled","styleType","danger","icon","iconPosition"]),d={$buttonIconPosition:l,$buttonStyle:i?"disabled":o,$buttonSizeStyle:"small",$buttonIsDanger:a};return e.jsxs(kc,Object.assign({ref:n,"data-testid":c["data-testid"]||"button-with-icon",disabled:i},d,c,{children:[s,e.jsx("span",{children:r})]}))}))},Oc=K.default.div`
    width: ${e=>e.$width}px;
    max-width: 41rem;
    min-width: 21rem;
