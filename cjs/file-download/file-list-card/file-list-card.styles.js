...
`;d.default(t.ComponentLoadingSpinner)`
    color: ${n.V3_Colour["icon-primary"]};
`;const V=d.default.div`
    display: flex;
    justify-content: flex-end;
    align-items: center;
...
`,M=d.default(a.ImageWithFallback)`
    border-radius: ${n.V3_Radius.sm};
    border: ${n.V3_Border["width-010"]} ${n.V3_Border.solid}
        ${n.V3_Colour.border};
...
`;exports.ActionContainer=V,exports.Box=c,exports.ContentSection=g,exports.DesktopErrorMessage=$,exports.ErrorIcon=m,exports.ExtendedNameSection=u,exports.FileSizeSection=x,exports.IconButton=b,exports.Item=s,exports.ItemNameText=f,exports.MobileErrorMessage=_,exports.NameSection=p,exports.Thumbnail=M,exports.ThumbnailContainer=y;
