"use strict";var e=require("react/jsx-runtime"),t=require("styled-components"),r=require("../../shared/image-with-fallback/image-with-fallback.js"),i=require("../../v3_theme/index.js"),a=require("../helper.js");function o(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var d=o(t);const n=d.default.div`
    width: auto;
...
`,l=d.default(r.ImageWithFallback)`
    ...
    border: ${e=>e.$isPdf?"none":`${i.V3_Border["width-010"]} ${i.V3_Border.solid} ${i.V3_Colour.border}`};
    object-fit: cover;
