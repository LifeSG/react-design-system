"use strict";var i=require("styled-components"),t=require("../theme/index.js");function e(i){return i&&"object"==typeof i&&"default"in i?i:{default:i}}var o=e(i);const s=o.default.div`
    position: fixed;
    left: 0;
    top: 0;
    height: 0;
...
`,n=o.default.div`
    ...
    left: 0;
    top: 0;
    background-color: ${i=>i.$stacked?t.Colour["overlay-subtle"]:t.Colour["overlay-strong"]};
