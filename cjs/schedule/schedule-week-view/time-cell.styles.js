"use strict";var e=require("styled-components"),t=require("../../theme/index.js"),o=require("../const.js");function r(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var i=r(e);const n=i.default.div`
    min-height: ${o.CELL_HEIGHT}px;
    position: relative;
    border-bottom: ${t.Border["width-010"]} solid ${t.Colour.border};
    ${t=>t.$dashed&&e.css`
