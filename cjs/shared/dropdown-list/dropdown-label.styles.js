"use strict";var e=require("styled-components"),t=require("../../theme/index.js"),l=require("../styles/index.js");function i(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var r=i(e);const o=r.default.div`
    font-weight: ${e=>e.$bold?t.Font.Spec["weight-semibold"]:t.Font.Spec["weight-regular"]};
