"use strict";var e=require("@lifesg/react-icons/chevron-left"),o=require("@lifesg/react-icons/chevron-right"),r=require("styled-components"),t=require("../shared/clickable-icon/clickable-icon.js"),i=require("../typography/index.js"),l=require("../v3_theme/index.js");function a(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var s=a(r);const n=1.25,d=e=>"minified"===e?12:40,g=e=>"minified"===e?12:40,p=s.default.div`
    position: relative;
    display: flex;
    align-items: center;
    ...
    ${e=>"stripes"===e.$styleType&&r.css`
            ...
            ${(e.$hoverBgColor||e.$hoverBgColor2)&&e.$clickable&&r.css`
                &:hover {
                    background: repeating-linear-gradient(
                        135deg,
                        ${e.$hoverBgColor2||e.$bgColor2||l.V3_Colour["bg-strongest"]}
                            0px,
                        ${e.$hoverBgColor2||e.$bgColor2||l.V3_Colour["bg-strongest"]}
                            10px,
                        ${e.$hoverBgColor||e.$bgColor||l.V3_Colour["bg-stronger"]}
                            10px,
                        ${e.$hoverBgColor||e.$bgColor||l.V3_Colour["bg-stronger"]}
                            20px
                    );
...
`,m=s.default.div`
    ...
    border-right: ${l.V3_Border["width-010"]} ${l.V3_Border.solid}
        ${l.V3_Colour["border-stronger"]};
`,w=s.default(i.Typography.BodyXS)`
