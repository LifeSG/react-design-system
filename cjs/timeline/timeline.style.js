"use strict";var r=require("styled-components"),e=require("../pill/pill.js"),o=require("../theme/index.js"),i=require("../typography/typography.js");function t(r){return r&&"object"==typeof r&&"default"in r?r:{default:r}}var n=t(r);const l=n.default.div`
    display: flex;
    ...
    ${e=>{switch(e.$variant){case"current":return r.css`
                    background-color: ${o.Colour["icon-primary-subtle"]};
                `;case"upcoming-active":return r.css`
                    border: 4px solid ${o.Colour["icon-primary-subtle"]};
                `;case"upcoming-inactive":return r.css`
                    border: 4px solid ${o.Colour["icon-subtle"]};
                `;case"disabled":return r.css`
                    background-color: ${o.Colour["icon-disabled-subtle"]};
                `;case"completed":return r.css`
                    background-color: ${o.Colour["icon-success"]};
                    svg {
                        color: ${o.Colour["icon-inverse"]};
                    }
                `;case"numeric":return r.css`
                    background-color: ${o.Colour["icon-info"]};
                    color: ${o.Colour["text-inverse"]};
                    font-size: ${o.Font["body-sm-bold"]};
...
`,c=n.default.div`
    ...
    ${e=>{switch(e.$variant){case"current":case"upcoming-active":return r.css`
                    background-color: ${o.Colour["icon-primary-subtle"]};
                `;case"upcoming-inactive":return r.css`
                    background-color: ${o.Colour["icon-subtle"]};
                `;case"disabled":return r.css`
                    background-color: ${o.Colour["icon-disabled-subtle"]};
                `;case"completed":return r.css`
                    background-color: ${o.Colour["icon-success"]};
                ...
                `;case"error":return r.css`
                    margin-left: -0.15rem;
                    background-color: ${o.Colour["icon-error"]};
                `}}}
`,s=n.default.div`
    display: flex;
...
`,u=n.default(i.Typography.HeadingSM)`
    margin-bottom: 1rem;

    ${o.MediaQuery.MaxWidth.lg} {
        margin-bottom: 1.5rem;
    }
`,d=n.default(i.Typography.HeadingXS)`
    margin-top: -0.125rem;
    margin-bottom: 0.5rem;
`,m=n.default.div`
    display: flex;
