"use strict";var e=require("@lifesg/react-icons/exclamation-triangle"),r=require("styled-components"),o=require("../alert/alert.js"),t=require("../shared/component-loading-spinner/component-loading-spinner.js"),n=require("../theme/index.js");function l(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var i=l(r);const a=i.default.li`
    display: flex;
...
`,p=i.default(e.ExclamationTriangleIcon)`
    ...
    width: ${n.Font.Spec["body-size-baseline"]};
`,g=i.default.span`
    color: ${n.Colour["text-warning"]};
`,f=i.default.span`
    ${n.Font["body-baseline-semibold"]}
    color: ${n.Colour.hyperlink};
