...
export declare class CodemodUtils {
    ...
    static replaceImport(source: Collection, api: API, oldImportPath: string | string[], oldImportSpecifier: string, newImportPath: string, newImportSpecifier: string): void;
