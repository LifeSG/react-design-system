...
`;var zi;!function(t){const s=(e,r,t)=>{const s=E(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
        ...
        `;return t.displayName=`Typography.${r}`,t};t.BodyBL=i("body-baseline","BodyBL"),t.BodyMD=i("body-md","BodyMD"),t.BodySM=i("body-sm","BodySM"),t.BodyXS=i("body-xs","BodyXS");const n=(t,s)=>{const i=E.a`
            ...
            `}
        `,n=t=>{var{external:s=!1,children:n}=t,o=A(t,["external","children"]);return r(i,Object.assign({},o,{children:[n,s&&e(Si,{})]}))};return n.displayName=`Typography.${s}`,n};t.LinkBL=n("body-baseline","LinkBL"),t.LinkMD=n("body-md","LinkMD"),t.LinkSM=n("body-sm","LinkSM"),t.LinkXS=n("body-xs","LinkXS")}(zi||(zi={}));const Si=E(D)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
