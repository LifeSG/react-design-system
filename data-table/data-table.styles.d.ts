...
export declare const BodyCellContent: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const ErrorDisplayElement: import("styled-components").StyledComponent<({ type, img, title, description, actionButton, additionalProps, imageOnly, illustrationScheme, ...otherProps }: import("../error-display").ErrorDisplayProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
