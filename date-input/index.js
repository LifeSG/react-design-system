...
`,Sn=n=>{var{external:r=!1,children:a}=n,i=Y(n,["external","children"]);return e($n,Object.assign({},i,{children:[a,r&&t(Dn,{})]}))};var wn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(wn||(wn={}));const Fn="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",xn=e=>"small"===e?2.5:3;y.div`
    position: relative;
    width: 100%;
...
`,da=y((({color:n,className:r,size:a=18})=>e(ra,Object.assign({className:r,$size:a,$color:n,"data-testid":"component-loading-spinner"},{children:[t(ia,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(oa,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(la,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(sa,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
    ${e=>{let t=e.$buttonIsDanger?an.Button.Danger.Primary:tn.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=tn.Neutral[3](e);break;default:t=tn.Neutral[8](e)}return b`
        ...
        `}}
`,ua={Default:a.forwardRef(((n,r)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:l="default",danger:s=!1}=n,c=Y(n,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(ca,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[o&&t(da,Object.assign({},d)),t("span",{children:a})]}))})),Small:a.forwardRef(((n,r)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:l="default",danger:s=!1}=n,c=Y(n,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(ca,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[o&&t(da,Object.assign({},d,{size:16})),t("span",{children:a})]}))}))},ha=y.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,fa=a.forwardRef(((e,n)=>{var{children:r,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,l=Y(e,["children","focusHighlight","focusOutline","type"]);return t(ha,Object.assign({ref:n,$outline:i,$highlight:a,type:o},l,{children:r}))})),ga=b`
    color: ${tn.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,pa=y(j)`
...
`,Bi=y.div`
    ...
    ${e=>e.$disabled?b`
            ...
            `:e.$hide?b`
                display: none;
            `:void 0}
`;zr.extend(jr);const Oi=a.forwardRef((({disabled:n,readOnly:r,names:a,value:l,focused:s,hoverValue:c,placeholder:d,label:h,onChange:f,onFocus:g,onBlur:m,hideInputKeyboard:y},b)=>{const v=y?"none":"numeric",[$,D,S]=na(""),[w,F,x]=na(""),[B,O,H]=na(""),[k,E]=o("none"),[A,M]=o(!1),C=i(null),z=i(null),L=i(null),j=i(null),[T,Y,R]=V(c);u((()=>{var e;const[t="",n="",r=""]=V(l);D(t),F(n),O(r),t||n||r||!C.current||!C.current.contains(document.activeElement)||null===(e=z.current)||void 0===e||e.focus()}),[l]),u((()=>{s||E("none"),s&&(M(!0),z.current&&C.current&&!C.current.contains(document.activeElement)&&z.current.focus())}),[s]),p(b,(()=>({ref:C,resetPlaceholder(){M(!1)},resetInput(){const[e="",t="",n=""]=V(l);D(e),F(t),O(n)}})),[l]);const W=e=>{var t;e.preventDefault(),null===(t=z.current)||void 0===t||t.focus()},N=e=>{e.target.select();const t=e.target.name;E(t)},I=e=>{const[t,n,r]=a,i={[t]:S.current,[n]:x.current,[r]:H.current},o=e.target.name,l=i[o],s=o!==r?ta.padValue(l,!0):l;switch(o){case t:i[t]=s,D(s);break;case n:i[n]=s,F(s)}const c=`${i[r]}-${i[n]}-${i[t]}`,d=zr(c,"YYYY-MM-DD",!0).isValid(),u=!i[t]&&!i[n]&&!i[r];d&&l!==s&&f(c),C.current&&!C.current.contains(e.relatedTarget)&&(E("none"),null==m||m(u||d))},_=e=>{var t,n;if(c)return;const r=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),o={day:$,month:w,year:B};switch(r){case a[0]:o.day=i,D(i),2===i.length&&(null===(t=L.current)||void 0===t||t.focus());break;case a[1]:o.month=i,F(i),2===i.length&&(null===(n=j.current)||void 0===n||n.focus());break;case a[2]:o.year=i,O(i)}if(!o.day&&!o.month&&!o.year)return void f("");const l=`${o.year}-${o.month}-${o.day}`;zr(l,"YYYY-MM-DD",!0).isValid()&&f(l)},P=e=>{var t,n;"Backspace"!==e.code&&"Backspace"!==e.key||(k===a[1]&&0===w.length&&(null===(t=z.current)||void 0===t||t.focus()),k===a[2]&&0===B.length&&(null===(n=L.current)||void 0===n||n.focus()))};function V(e){if(e){const t=Qr.sanitizeInput(e);if(!t)return[void 0,void 0,void 0];const n=zr(t,"YYYY-MM-DD",!0);return[ta.padValue(n.date().toString()),ta.padValue((n.month()+1).toString()),n.year().toString()]}return[void 0,void 0,void 0]}return e(vi,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(M(!0),z.current&&C.current&&!C.current.contains(document.activeElement)&&z.current.focus())},onFocus:e=>{n||(M(!0),s||null==g||g(e))}},{children:[e($i,Object.assign({ref:C,$hover:!!c},{children:[t(Si,{ref:z,name:a[0],maxLength:2,value:null!=T?T:$,onFocus:N,onBlur:I,onChange:_,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[0]||r?"DD":""}),t(xi,Object.assign({$inactive:0===$.length},{children:"/"})),t(wi,{ref:L,name:a[1],maxLength:2,value:null!=Y?Y:w,onFocus:N,onBlur:I,onChange:_,onKeyDown:P,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[1]||r?"MM":""}),t(xi,Object.assign({$inactive:0===w.length},{children:"/"})),t(Fi,{ref:j,name:a[2],maxLength:4,value:null!=R?R:B,onFocus:N,onBlur:I,onChange:_,onKeyDown:P,type:"text",inputMode:v,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[2]||r?"YYYY":""})]})),(()=>{if(!l&&!r&&d)return t(Bi,Object.assign({$hide:A,$disabled:n,onMouseDown:W},{children:d}))})()]}))})),Hi=y(yi)`
    height: 3rem;
`,ki=e=>{var{minDate:n,maxDate:r,disabled:a,disabledDates:l,error:s,hideInputKeyboard:c,value:d,onChange:h,onFocus:f,onBlur:g,onYearMonthDisplayChange:p,withButton:m=!0,readOnly:y,id:b,allowDisabledSelection:v,zIndex:$}=e,D=Y(e,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection","zIndex"]);const[S,w]=o(Qr.sanitizeInput(d)),[F,x]=o(Qr.sanitizeInput(d)),[B,O]=o(void 0),[H,k]=o(!1),[E,A]=o(!1),M=i(null),C=i();u((()=>{const e=Qr.sanitizeInput(d);w(e),x(e)}),[d]);const z=e=>{!v&&Qr.isDateDisabled(e,{disabledDates:l,minDate:n,maxDate:r})||(x(e),m||(N(e),w(e),e&&k(!1)))},L=e=>{var t;x(e),m||(N(e),w(e),e&&(null===(t=M.current)||void 0===t||t.focus(),k(!1)),O(void 0))},j=()=>{y||a||(k(!0),E||(A(!0),f&&f()))},T=e=>{var t;E&&!H&&M.current&&!M.current.contains(e.relatedTarget)&&(null===(t=C.current)||void 0===t||t.resetInput(),x(S),A(!1),I())},R=e=>{O(e)},W=e=>{var t;switch(e){case"reset":x(S);break;case"confirmed":w(F),N(F)}null===(t=M.current)||void 0===t||t.focus(),k(!1)},N=e=>{h&&h(e)},I=()=>{g&&g()};return t(Ar,{enabled:!y&&!a,isOpen:H,renderElement:()=>t(Hi,Object.assign({tabIndex:-1,ref:M,onBlur:T,onFocus:j,$disabled:a,$readOnly:y,$focused:E,$error:s,id:b,"data-testid":D["data-testid"]},D,{children:t(Oi,{ref:C,disabled:a,onChange:z,readOnly:y,focused:H,names:["start-day","start-month","start-year"],value:F,hoverValue:B,hideInputKeyboard:c})})),renderDropdown:({elementWidth:e})=>t(ui,{type:"input",variant:"single",initialCalendarDate:F,withButton:m,value:F,disabledDates:l,minDate:n,maxDate:r,allowDisabledSelection:v,onHover:R,onSelect:L,onDismiss:W,onYearMonthDisplayChange:p,width:e}),onClose:()=>{var e;null===(e=C.current)||void 0===e||e.resetInput(),x(S),k(!1),A(!1),I(),O(void 0)},onDismiss:()=>{var e,t;null===(e=C.current)||void 0===e||e.resetInput(),null===(t=M.current)||void 0===t||t.focus(),x(S),k(!1)},customZIndex:$,offset:16})};export{ki as DateInput};
