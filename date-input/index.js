    ...
    ${e=>{if(e.$disabledDisplay)return S`
            ...
            `;switch(e.$variant){case"current-month":return S`
                ...
                `;case"selected-month":return S`
                    ...
                    color: ${xa.Primary(e)};
                `}}}
`,Qs=({calendarDate:e,currentFocus:t,selectedStartDate:r,selectedEndDate:i,viewCalendarDate:o,type:a,isNewSelection:s,minDate:l,maxDate:c,allowDisabledSelection:u,onMonthSelect:d})=>{const h=y((()=>Pa.generateMonths(_a(e))),[e]),f=e=>{const n="start"===t&&i&&e.isAfter(i,"month")&&s,o="end"===t&&r&&e.isBefore(r,"month")&&s;return n||o},p=e=>{const t=e.format("MMMM"),n=(r=e,!Pa.isWithinRange(r,l?_a(l):void 0,c?_a(c):void 0,"month"));var r;const i=o.isSame(e,"month")?"selected-month":_a().isSame(e,"month")?"current-month":"default";return{disabledDisplay:n||f(e),interactive:!n||u,month:t,variant:i}};return h.length?n(Ws,{$type:a,children:h.map((e=>{const{disabledDisplay:t,interactive:r,variant:i,month:o}=p(e);return n(Vs,{$variant:i,$disabledDisplay:t,$interactive:r,onClick:()=>((e,t)=>{t||d(e)})(e,!r),children:n(qs,{weight:"regular",$variant:i,$disabledDisplay:t,children:o})},o)}))}):null},Us=$.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Gs=$(bs.H5)`
    ${e=>{if(e.$disabledDisplay)return S`
            ...
            `;switch(e.$variant){case"current-year":return S`
                ...
                `}}}
`,Xs=({calendarDate:e,currentFocus:t,selectedStartDate:r,selectedEndDate:i,viewCalendarDate:o,type:a,isNewSelection:s,minDate:l,maxDate:c,allowDisabledSelection:u,onYearSelect:d})=>{const h=y((()=>Pa.generateDecadeOfYears(_a(e))),[e]),f=e=>{const n="start"===t&&i&&e.isAfter(i,"year")&&s,o="end"===t&&r&&e.isBefore(r,"year")&&s;return n||o},p=e=>{const t=[0,11].includes(h.indexOf(e)),n=e.year(),r=(i=e,!Pa.isWithinRange(i,l?_a(l):void 0,c?_a(c):void 0,"year"));var i;const a=t?"other-decade":o.isSame(e,"year")?"selected-year":_a().isSame(e,"year")?"current-year":"default";return{disabledDisplay:r||f(e),interactive:!r||u,year:n,variant:a}};return h.length?n(Us,{$type:a,children:h.map((e=>{const{disabledDisplay:t,interactive:r,variant:i,year:o}=p(e);return n(Zs,{$variant:i,$disabledDisplay:t,$interactive:r,onClick:()=>((e,t)=>{t||d(e)})(e,!r),children:n(Gs,{weight:"regular",$variant:i,$disabledDisplay:t,$interactive:r,children:o})},o)}))}):null},Js=o.forwardRef((({children:e,initialCalendarDate:i,type:o,minDate:a,maxDate:c,currentFocus:u,selectedStartDate:d,selectedEndDate:f,selectWithinRange:p,dynamicHeight:m=!1,allowDisabledSelection:g,onCalendarDateChange:y,withButton:b,doneButtonDisabled:w,onDismiss:$,showNavigationHeader:x=!0,getLeftArrowDate:S,getRightArrowDate:D,isLeftArrowDisabled:_,isRightArrowDisabled:O,getMonthHeaderLabel:F,getYearHeaderLabel:C,...M},k)=>{const[j,B]=l(_a(i)),[A,E]=l(_a(i)),[P,H]=l("default"),I=s(null),T=s(null),R=s();v(k,(()=>({defaultView(){H("default")},resetView(){const e=_a(i);B(e),E(e),H("default")},setCalendarDate(e){const t=e?_a(e):_a();B(t),E(t)}}))),h((()=>{const e=i?_a(i):_a();B(e),E(e)}),[i]),h((()=>{q(A)}),[A]);const z=()=>{"month-options"!==P?(H("month-options"),R.current.focus()):(H("default"),B(A))},L=()=>{"default"!==P?(H("default"),B(A)):H("year-options")},N=()=>{R.current.focus();const e=S?S(j):j.subtract(1,"month");switch(P){case"default":E(e),B(e);break;case"month-options":B((e=>e.subtract(1,"year")));break;case"year-options":B((e=>e.subtract(10,"year")))}},Y=()=>{R.current.focus();const e=D?D(j):j.add(1,"month");switch(P){case"default":E(e),B(e);break;case"month-options":B((e=>e.add(1,"year")));break;case"year-options":B((e=>e.add(10,"year")))}},W=e=>{B(e),E(e)},V=()=>{B(_a(i)),E(_a(i)),"default"===P?Q("reset"):H("default")},q=e=>{y&&y(e)},Q=e=>{$&&$(e)},U=()=>{if(!a||g)return!1;const e=_a(a);return"month-options"===P?!Pa.isPreviousYearWithinRange(j,e):"year-options"===P?!Pa.isPreviousDecadeWithinRange(j,e):_?_(j):!Pa.isPreviousMonthWithinRange(j,e)},Z=()=>{if(!c||g)return!1;const e=_a(c);return"month-options"===P?!Pa.isNextYearWithinRange(j,e):"year-options"===P?!Pa.isNextDecadeWithinRange(j,e):O?O(j):!Pa.isNextMonthWithinRange(j,e)},G=()=>{if("year-options"===P){const{beginDecade:e,endDecade:t}=Pa.getStartEndDecade(j);return`${e} to ${t}`}return C?C(j):_a(j).format("YYYY")},X=()=>{const e=F?F(j):_a(j).format("MMM");return t(r,{children:[t(Ts,{type:"button",tabIndex:-1,$expanded:"month-options"===P,$visible:"default"===P,id:"month-dropdown",onClick:z,children:[n(Rs,{children:e}),n(Bs,{})]}),t(Ts,{type:"button",tabIndex:-1,$expanded:"default"!==P,id:"year-dropdown",onClick:L,children:[n(Rs,{children:G()}),n(Bs,{})]})]})},J=()=>{switch(P){case"month-options":return n(Qs,{type:o,calendarDate:j,currentFocus:u,minDate:a,maxDate:c,selectedStartDate:d,selectedEndDate:f,viewCalendarDate:A,isNewSelection:p,onMonthSelect:W,allowDisabledSelection:g});case"year-options":return n(Xs,{type:o,calendarDate:j,currentFocus:u,minDate:a,maxDate:c,selectedStartDate:d,selectedEndDate:f,viewCalendarDate:A,isNewSelection:p,onYearSelect:W,allowDisabledSelection:g});default:return null}};return t(As,{ref:R,tabIndex:-1,"data-id":"calendar-container",...M,children:[x&&t(Hs,{"data-id":"calendar-header",children:[n(Is,{children:X()}),t(zs,{children:[n(Ls,{"data-testid":"left-arrow-btn",disabled:U(),focusHighlight:!1,tabIndex:-1,onClick:N,children:n(ks,{})}),n(Ls,{"data-testid":"right-arrow-btn",disabled:Z(),focusHighlight:!1,tabIndex:-1,onClick:Y,children:n(js,{})})]})]}),n(Es,{children:(()=>{const i="function"==typeof e?e({calendarDate:A}):e;return t(r,m?{children:["default"===P&&i,J()]}:{children:[i,n(Ps,{$visible:"default"!==P,children:J()})]})})()}),(()=>{if(!b)return;const e=!!("default"===P)&&w;return t(Ns,{children:[n(Ys,{ref:T,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:V,children:"Cancel"}),n(Ys,{"data-testid":"done-button",ref:I,type:"button",onClick:()=>{e||(B(A),"default"===P?Q("confirmed"):H("default"))},disabled:e,children:"Done"})]})})()]})})),Ks=$.div`
    width: 100%;
    display: grid;
...
`,Ml=$.div`
    ...
    ${e=>e.$disabled?S`
            ...
            `:e.$hide?S`
                display: none;
            `:void 0}
`;_a.extend(Fa);const kl=o.forwardRef((({disabled:e,readOnly:r,names:i,value:o,focused:a,hoverValue:c,placeholder:u,label:d,onChange:f,onFocus:p,onBlur:m},g)=>{const[y,b,w]=ml(""),[$,x,S]=ml(""),[D,_,O]=ml(""),[F,C]=l("none"),[M,k]=l(!1),j=s(null),B=s(null),A=s(null),E=s(null),[P,H,I]=N(c);h((()=>{const[e="",t="",n=""]=N(o);b(e),x(t),_(n)}),[o]),h((()=>{a||C("none"),a&&(k(!0),j.current.contains(document.activeElement)||B.current.focus())}),[a]),v(g,(()=>({ref:j,resetPlaceholder(){k(!1)},resetInput(){const[e="",t="",n=""]=N(o);b(e),x(t),_(n)}})),[o]);const T=e=>{e.target.select();const t=e.target.name;C(t)},R=e=>{const[t,n,r]=i,o={[t]:w.current,[n]:S.current,[r]:O.current},a=e.target.name,s=o[a],l=a!==r?pl.padValue(s,!0):s;switch(a){case t:o[t]=l,b(l);break;case n:o[n]=l,x(l)}const c=`${o[r]}-${o[n]}-${o[t]}`,u=_a(c,"YYYY-MM-DD",!0).isValid(),d=!o[t]&&!o[n]&&!o[r];u&&s!==l&&f(c),j.current.contains(e.relatedTarget)||(C("none"),m?.(d||u))},z=e=>{if(c)return;const t=e.target.name,n=e.target.value.replace(/[^0-9]/g,""),r={day:y,month:$,year:D};switch(t){case i[0]:r.day=n,b(n),2===n.length&&A.current.focus();break;case i[1]:r.month=n,x(n),2===n.length&&E.current.focus();break;case i[2]:r.year=n,_(n)}if(!r.day&&!r.month&&!r.year)return void f("");const o=`${r.year}-${r.month}-${r.day}`;_a(o,"YYYY-MM-DD",!0).isValid()&&f(o)},L=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(F===i[1]&&0===$.length&&B.current.focus(),F===i[2]&&0===D.length&&A.current.focus())};function N(e){if(e){const t=_a(e,"YYYY-MM-DD");return[pl.padValue(t.date().toString()),pl.padValue((t.month()+1).toString()),t.year().toString()]}return[void 0,void 0,void 0]}return t(xl,{role:"group","aria-label":d,onClick:()=>{e||r||(k(!0),j.current.contains(document.activeElement)||B.current.focus())},onFocus:()=>{e||r||(k(!0),a||p())},children:[t(Sl,{ref:j,$hover:!!c,children:[n(_l,{ref:B,name:i[0],maxLength:2,value:P??y,onFocus:T,onBlur:R,onChange:z,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${i[0]}-input`,"aria-label":"day",disabled:e,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[0]||r?"DD":""}),n(Cl,{$inactive:0===y.length,children:"/"}),n(Ol,{ref:A,name:i[1],maxLength:2,value:H??$,onFocus:T,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${i[1]}-input`,"aria-label":"month",disabled:e,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[1]||r?"MM":""}),n(Cl,{$inactive:0===$.length,children:"/"}),n(Fl,{ref:E,name:i[2],maxLength:4,value:I??D,onFocus:T,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{4}","data-testid":`${i[2]}-input`,"aria-label":"year",disabled:e,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[2]||r?"YYYY":""})]}),(()=>{if(!o&&!r&&u)return n(Ml,{$hide:M,$disabled:e,children:u})})()]})}));var jl;_a.extend(ja),function(e){e.isDateDisabled=(e,t)=>{const{disabledDates:n,minDate:r,maxDate:i}=t;return!!(n&&n.length&&n.includes(e))||(!(!r||!_a(e).isBefore(r,"day"))||!(!i||!_a(e).isAfter(i,"day")))}}(jl||(jl={}));const Bl=$(wl)`
    height: 3rem;
`,Al=({minDate:e,maxDate:r,disabled:i,disabledDates:o,error:a,value:c,onChange:u,onBlur:d,onYearMonthDisplayChange:f,withButton:p=!0,readOnly:m,id:g,allowDisabledSelection:y,...v})=>{const[b,w]=l(c),[$,x]=l(c),[S,D]=l(void 0),[_,F]=l(!1),C=s(null),M=s(),k=s(),j=O.exports.useMediaQuery({maxWidth:Xa.mobileL}),B=p||j;h((()=>{w(c),x(c)}),[c]);const A=t=>{!y&&jl.isDateDisabled(t,{disabledDates:o,minDate:e,maxDate:r})||(x(t),B||(E(t),w(t),t&&F(!1)))},E=e=>{u&&u(e)},P=()=>{d&&d()};return t(Bl,{ref:C,$disabled:i,$readOnly:m,$error:a,id:g,"data-testid":v["data-testid"],tabIndex:-1,onBlur:e=>{C&&!C.current.contains(e.relatedTarget)&&(k.current.resetInput(),x(b),F(!1),P())},onKeyDown:function(e){"Escape"===e.code&&(k.current.resetInput(),x(b),F(!1))},...v,children:[n(kl,{ref:k,disabled:i,onChange:A,onFocus:()=>{F(!0)},readOnly:m,focused:_,names:["start-day","start-month","start-year"],value:$,hoverValue:S}),n(cl,{ref:M,type:"input",variant:"single",initialCalendarDate:$,isOpen:_,withButton:B,value:$,disabledDates:o,minDate:e,maxDate:r,allowDisabledSelection:y,onHover:e=>{D(e)},onSelect:A,onDismiss:e=>{switch(e){case"reset":x(b);break;case"confirmed":w($),E($)}F(!1)},onYearMonthDisplayChange:f})]})};export{Al as DateInput};
