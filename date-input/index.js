...
`,ln=n=>{var{external:r=!1,children:o}=n,i=w(n,["external","children"]);return e(on,Object.assign({},i,{children:[o,r&&t(an,{})]}))};var sn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(sn||(sn={}));const cn="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",un=e=>"small"===e?2.5:3;h.div`
    position: relative;
    width: 100%;
...
`,Xi=h((({color:n,className:r,size:o=18})=>e(zi,Object.assign({className:r,$size:o,$color:n},{children:[t(_i,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(Vi,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(Ui,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(Zi,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    ...
    ${e=>{let t=e.$buttonIsDanger?Ut.Button.Danger.Primary:Wt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Wt.Neutral[3](e);break;default:t=Wt.Neutral[8](e)}return p`
        ...
        `}}
`,qi={Default:o.forwardRef(((n,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:l="default",danger:s=!1}=n,c=w(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(Ki,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},u,c,{children:[a&&t(Xi,Object.assign({},u)),t("span",{children:o})]}))})),Small:o.forwardRef(((n,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:l="default",danger:s=!1}=n,c=w(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(Ki,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},u,c,{children:[a&&t(Xi,Object.assign({},u,{size:16})),t("span",{children:o})]}))}))},Gi=h.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,Ji=o.forwardRef(((e,n)=>{var{children:r,focusHighlight:o=!0,focusOutline:i="none",type:a="button"}=e,l=w(e,["children","focusHighlight","focusOutline","type"]);return t(Gi,Object.assign({ref:n,$outline:i,$highlight:o,type:a},l,{children:r}))})),Qi=p`
    color: ${Wt.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,ea=h(b)`
...
`,ul=h.div`
    ...
    ${e=>e.$disabled?p`
            ...
            `:e.$hide?p`
                display: none;
            `:void 0}
`;bi.extend(xi);const dl=o.forwardRef((({disabled:n,readOnly:r,names:o,value:i,focused:c,hoverValue:u,placeholder:f,label:h,onChange:p,onFocus:g,onBlur:m,hideInputKeyboard:y},v)=>{const b=y?"none":"numeric",[D,w,$]=Pi(""),[x,S,F]=Pi(""),[B,E,k]=Pi(""),[O,A]=s("none"),[R,C]=s(!1),M=l(null),L=l(null),H=l(null),T=l(null),[N,I,j]=V(u);a((()=>{const[e="",t="",n=""]=V(i);w(e),S(t),E(n)}),[i]),a((()=>{c||A("none"),c&&(C(!0),M.current.contains(document.activeElement)||L.current.focus())}),[c]),d(v,(()=>({ref:M,resetPlaceholder(){C(!1)},resetInput(){const[e="",t="",n=""]=V(i);w(e),S(t),E(n)}})),[i]);const Y=e=>{var t;e.preventDefault(),null===(t=L.current)||void 0===t||t.focus()},P=e=>{e.target.select();const t=e.target.name;A(t)},z=e=>{const[t,n,r]=o,i={[t]:$.current,[n]:F.current,[r]:k.current},a=e.target.name,l=i[a],s=a!==r?Yi.padValue(l,!0):l;switch(a){case t:i[t]=s,w(s);break;case n:i[n]=s,S(s)}const c=`${i[r]}-${i[n]}-${i[t]}`,u=bi(c,"YYYY-MM-DD",!0).isValid(),d=!i[t]&&!i[n]&&!i[r];u&&l!==s&&p(c),M.current.contains(e.relatedTarget)||(A("none"),null==m||m(d||u))},W=e=>{if(u)return;const t=e.target.name,n=e.target.value.replace(/[^0-9]/g,""),r={day:D,month:x,year:B};switch(t){case o[0]:r.day=n,w(n),2===n.length&&H.current.focus();break;case o[1]:r.month=n,S(n),2===n.length&&T.current.focus();break;case o[2]:r.year=n,E(n)}if(!r.day&&!r.month&&!r.year)return void p("");const i=`${r.year}-${r.month}-${r.day}`;bi(i,"YYYY-MM-DD",!0).isValid()&&p(i)},_=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(O===o[1]&&0===x.length&&L.current.focus(),O===o[2]&&0===B.length&&H.current.focus())};function V(e){if(e){const t=bi(new Date(e));return[Yi.padValue(t.date().toString()),Yi.padValue((t.month()+1).toString()),t.year().toString()]}return[void 0,void 0,void 0]}return e(rl,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(C(!0),M.current.contains(document.activeElement)||L.current.focus())},onFocus:e=>{n||(C(!0),c||null==g||g(e))}},{children:[e(ol,Object.assign({ref:M,$hover:!!u},{children:[t(al,{ref:L,name:o[0],maxLength:2,value:null!=N?N:D,onFocus:P,onBlur:z,onChange:W,type:"text",inputMode:b,pattern:"[0-9]{2}","data-testid":`${o[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==o[0]||r?"DD":""}),t(cl,Object.assign({$inactive:0===D.length},{children:"/"})),t(ll,{ref:H,name:o[1],maxLength:2,value:null!=I?I:x,onFocus:P,onBlur:z,onChange:W,onKeyDown:_,type:"text",inputMode:b,pattern:"[0-9]{2}","data-testid":`${o[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==o[1]||r?"MM":""}),t(cl,Object.assign({$inactive:0===x.length},{children:"/"})),t(sl,{ref:T,name:o[2],maxLength:4,value:null!=j?j:B,onFocus:P,onBlur:z,onChange:W,onKeyDown:_,type:"text",inputMode:b,pattern:"[0-9]{4}","data-testid":`${o[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==o[2]||r?"YYYY":""})]})),(()=>{if(!i&&!r&&f)return t(ul,Object.assign({$hide:R,$disabled:n,onMouseDown:Y},{children:f}))})()]}))})),fl=h(tl)`
    height: 3rem;
`,hl=e=>{var{minDate:n,maxDate:r,disabled:o,disabledDates:i,error:c,hideInputKeyboard:u,value:d,onChange:f,onFocus:h,onBlur:p,onYearMonthDisplayChange:g,withButton:m=!0,readOnly:y,id:v,allowDisabledSelection:b,zIndex:D=50}=e,$=w(e,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection","zIndex"]);const[x,S]=s(Ii.sanitizeInput(d)),[F,B]=s(Ii.sanitizeInput(d)),[E,k]=s(void 0),[O,A]=s(!1),[R,C]=s(!1),M=l(null),L=l();a((()=>{const e=Ii.sanitizeInput(d);S(e),B(e)}),[d]);const H=e=>{!b&&Ii.isDateDisabled(e,{disabledDates:i,minDate:n,maxDate:r})||(B(e),m||(P(e),S(e),e&&A(!1)))},T=e=>{B(e),m||(P(e),S(e),e&&(M.current.focus(),A(!1)))},N=()=>{y||(A(!0),R||(C(!0),h&&h()))},I=e=>{!R||O||M.current.contains(e.relatedTarget)||(L.current.resetInput(),B(x),C(!1),z())},j=e=>{k(e)},Y=e=>{switch(e){case"reset":B(x);break;case"confirmed":S(F),P(F)}M.current.focus(),A(!1)},P=e=>{f&&f(e)},z=()=>{p&&p()};return t(hi,{enabled:!y&&!o,isOpen:O,renderElement:()=>t(fl,Object.assign({tabIndex:-1,ref:M,onBlur:I,onFocus:N,$disabled:o,$readOnly:y,$focused:R,$error:c,id:v,"data-testid":$["data-testid"]},$,{children:t(dl,{ref:L,disabled:o,onChange:H,readOnly:y,focused:O,names:["start-day","start-month","start-year"],value:F,hoverValue:E,hideInputKeyboard:u})})),renderDropdown:()=>t(qa,{type:"input",variant:"single",initialCalendarDate:F,withButton:m,value:F,disabledDates:i,minDate:n,maxDate:r,allowDisabledSelection:b,onHover:j,onSelect:T,onDismiss:Y,onYearMonthDisplayChange:g}),onClose:()=>{L.current.resetInput(),B(x),A(!1),C(!1),z()},onDismiss:()=>{L.current.resetInput(),M.current.focus(),B(x),A(!1)},zIndex:D})};export{hl as DateInput};
