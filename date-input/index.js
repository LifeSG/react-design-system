...
`,za=y.button`
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return p`
                ...
                `}}}
`,ka=y((({color:r,className:n,size:a})=>e(Ca,Object.assign({className:n,$size:a,$color:r},{children:[t(Ba,{id:"inner1"}),t(Oa,{id:"inner2"}),t(Aa,{id:"inner3"}),t(Ma,{id:"inner4"})]}))))`
    margin-right: 0.5rem;
...
`,Ui=y.div`
    ...
    ${e=>e.$disabled?p`
            ...
            `:e.$hide?p`
                display: none;
            `:void 0}
`;na.extend(ia);const Ki=a.forwardRef((({disabled:r,readOnly:n,names:a,value:s,focused:l,hoverValue:d,placeholder:c,label:h,onChange:b,onFocus:g,onBlur:f,hideInputKeyboard:y},p)=>{const v=y?"none":"numeric",[x,D,w]=Ea(""),[$,F,E]=Ea(""),[C,S,B]=Ea(""),[O,A]=o("none"),[M,z]=o(!1),k=i(null),Y=i(null),j=i(null),T=i(null),[_,R,H]=V(d);u((()=>{const[e="",r="",t=""]=V(s);D(e),F(r),S(t),e||r||t||!k.current.contains(document.activeElement)||Y.current.focus()}),[s]),u((()=>{l||A("none"),l&&(z(!0),k.current.contains(document.activeElement)||Y.current.focus())}),[l]),m(p,(()=>({ref:k,resetPlaceholder(){z(!1)},resetInput(){const[e="",r="",t=""]=V(s);D(e),F(r),S(t)}})),[s]);const L=e=>{var r;e.preventDefault(),null===(r=Y.current)||void 0===r||r.focus()},I=e=>{e.target.select();const r=e.target.name;A(r)},W=e=>{const[r,t,n]=a,i={[r]:w.current,[t]:E.current,[n]:B.current},o=e.target.name,s=i[o],l=o!==n?Fa.padValue(s,!0):s;switch(o){case r:i[r]=l,D(l);break;case t:i[t]=l,F(l)}const d=`${i[n]}-${i[t]}-${i[r]}`,c=na(d,"YYYY-MM-DD",!0).isValid(),u=!i[r]&&!i[t]&&!i[n];c&&s!==l&&b(d),k.current.contains(e.relatedTarget)||(A("none"),null==f||f(u||c))},N=e=>{if(d)return;const r=e.target.name,t=e.target.value.replace(/[^0-9]/g,""),n={day:x,month:$,year:C};switch(r){case a[0]:n.day=t,D(t),2===t.length&&j.current.focus();break;case a[1]:n.month=t,F(t),2===t.length&&T.current.focus();break;case a[2]:n.year=t,S(t)}if(!n.day&&!n.month&&!n.year)return void b("");const i=`${n.year}-${n.month}-${n.day}`;na(i,"YYYY-MM-DD",!0).isValid()&&b(i)},P=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(O===a[1]&&0===$.length&&Y.current.focus(),O===a[2]&&0===C.length&&j.current.focus())};function V(e){if(e){const r=na(new Date(e));return r.isValid()?[Fa.padValue(r.date().toString()),Fa.padValue((r.month()+1).toString()),r.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Li,Object.assign({role:"group","aria-label":h,onClick:()=>{r||n||(z(!0),k.current.contains(document.activeElement)||Y.current.focus())},onFocus:e=>{r||(z(!0),l||null==g||g(e))}},{children:[e(Ii,Object.assign({ref:k,$hover:!!d},{children:[t(Ni,{ref:Y,name:a[0],maxLength:2,value:null!=_?_:x,onFocus:I,onBlur:W,onChange:N,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[0]||n?"DD":""}),t(Zi,Object.assign({$inactive:0===x.length},{children:"/"})),t(Pi,{ref:j,name:a[1],maxLength:2,value:null!=R?R:$,onFocus:I,onBlur:W,onChange:N,onKeyDown:P,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[1]||n?"MM":""}),t(Zi,Object.assign({$inactive:0===$.length},{children:"/"})),t(Vi,{ref:T,name:a[2],maxLength:4,value:null!=H?H:C,onFocus:I,onBlur:W,onChange:N,onKeyDown:P,type:"text",inputMode:v,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[2]||n?"YYYY":""})]})),(()=>{if(!s&&!n&&c)return t(Ui,Object.assign({$hide:M,$disabled:r,onMouseDown:L},{children:c}))})()]}))})),Ji=y(Ri)`
    height: 3rem;
`,qi=e=>{var{minDate:r,maxDate:n,disabled:a,disabledDates:s,error:l,hideInputKeyboard:d,value:c,onChange:h,onFocus:b,onBlur:g,onYearMonthDisplayChange:m,withButton:f=!0,readOnly:y,id:p,allowDisabledSelection:v,zIndex:x}=e,D=R(e,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection","zIndex"]);const[w,$]=o(wa.sanitizeInput(c)),[F,E]=o(wa.sanitizeInput(c)),[C,S]=o(void 0),[B,O]=o(!1),[A,M]=o(!1),z=i(null),k=i();u((()=>{const e=wa.sanitizeInput(c);$(e),E(e)}),[c]);const Y=e=>{!v&&wa.isDateDisabled(e,{disabledDates:s,minDate:r,maxDate:n})||(E(e),f||(I(e),$(e),e&&O(!1)))},j=e=>{E(e),f||(I(e),$(e),e&&(z.current.focus(),O(!1)),C&&S(void 0))},T=()=>{y||a||(O(!0),A||(M(!0),b&&b()))},_=e=>{!A||B||z.current.contains(e.relatedTarget)||(k.current.resetInput(),E(w),M(!1),W())},H=e=>{S(e)},L=e=>{switch(e){case"reset":E(w);break;case"confirmed":$(F),I(F)}z.current.focus(),O(!1)},I=e=>{h&&h(e)},W=()=>{g&&g()};return t(ea,{enabled:!y&&!a,isOpen:B,renderElement:()=>t(Ji,Object.assign({tabIndex:-1,ref:z,onBlur:_,onFocus:T,$disabled:a,$readOnly:y,$focused:A,$error:l,id:p,"data-testid":D["data-testid"]},D,{children:t(Ki,{ref:k,disabled:a,onChange:Y,readOnly:y,focused:B,names:["start-day","start-month","start-year"],value:F,hoverValue:C,hideInputKeyboard:d})})),renderDropdown:({elementWidth:e})=>t(ki,{variant:"single",initialCalendarDate:F,withButton:f,value:F,disabledDates:s,minDate:r,maxDate:n,allowDisabledSelection:v,onHover:H,onSelect:j,onDismiss:L,onYearMonthDisplayChange:m,width:e}),onClose:()=>{k.current.resetInput(),E(w),O(!1),M(!1),W()},onDismiss:()=>{k.current.resetInput(),z.current.focus(),E(w),O(!1)},customZIndex:x,offset:16})};export{qi as DateInput};
