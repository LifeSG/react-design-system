...
`,hs=n=>{var{external:r=!1,children:a}=n,i=O(n,["external","children"]);return e(ds,Object.assign({},i,{children:[a,r&&t(us,{})]}))};var fs;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(fs||(fs={}));const ps={collections:{base:{InputBoxShadow:$`
	...
	${e=>"small"===e.$buttonSizeStyle?$`
                ...
                `}
`,vs=D((({color:n,className:r,size:a=18})=>e(Uo,Object.assign({className:r,$size:a,$color:n},{children:[t(Zo,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(Go,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(Xo,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(Jo,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
...
`,el=D.div`
    ...
    ${e=>{if(!e.$type)return;const{color:t,border:n}=Js(e);return $`
            background-color: ${t};
...
`,ol=D.div`
    ...
    ${e=>{if(e.$type){const{color:t,border:n}=Js(e);return $`
                background-color: ${t};
                background-clip: content-box;
                border: ${n};
            `}}}
...
`,kl=D.div`
    ...
    ${e=>e.$disabled?$`
            ...
            `:e.$hide?$`
                display: none;
            `:void 0}
`;ca.extend(fa);const Ml=a.forwardRef((({disabled:n,readOnly:r,names:a,value:s,focused:l,hoverValue:c,placeholder:d,label:h,onChange:f,onFocus:p,onBlur:g},m)=>{const[v,b,D]=Aa(""),[w,$,S]=Aa(""),[x,F,B]=Aa(""),[O,_]=o("none"),[k,M]=o(!1),A=i(null),E=i(null),C=i(null),H=i(null),[j,I,P]=Y(c);u((()=>{const[e="",t="",n=""]=Y(s);b(e),$(t),F(n)}),[s]),u((()=>{l||_("none"),l&&(M(!0),A.current.contains(document.activeElement)||E.current.focus())}),[l]),y(m,(()=>({ref:A,resetPlaceholder(){M(!1)},resetInput(){const[e="",t="",n=""]=Y(s);b(e),$(t),F(n)}})),[s]);const T=e=>{e.target.select();const t=e.target.name;_(t)},R=e=>{const[t,n,r]=a,i={[t]:D.current,[n]:S.current,[r]:B.current},o=e.target.name,s=i[o],l=o!==r?Ma.padValue(s,!0):s;switch(o){case t:i[t]=l,b(l);break;case n:i[n]=l,$(l)}const c=`${i[r]}-${i[n]}-${i[t]}`,d=ca(c,"YYYY-MM-DD",!0).isValid(),u=!i[t]&&!i[n]&&!i[r];d&&s!==l&&f(c),A.current.contains(e.relatedTarget)||(_("none"),null==g||g(u||d))},L=e=>{if(c)return;const t=e.target.name,n=e.target.value.replace(/[^0-9]/g,""),r={day:v,month:w,year:x};switch(t){case a[0]:r.day=n,b(n),2===n.length&&C.current.focus();break;case a[1]:r.month=n,$(n),2===n.length&&H.current.focus();break;case a[2]:r.year=n,F(n)}if(!r.day&&!r.month&&!r.year)return void f("");const i=`${r.year}-${r.month}-${r.day}`;ca(i,"YYYY-MM-DD",!0).isValid()&&f(i)},z=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(O===a[1]&&0===w.length&&E.current.focus(),O===a[2]&&0===x.length&&C.current.focus())};function Y(e){if(e){const t=ca(new Date(e));return[Ma.padValue(t.date().toString()),Ma.padValue((t.month()+1).toString()),t.year().toString()]}return[void 0,void 0,void 0]}return e($l,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(M(!0),A.current.contains(document.activeElement)||E.current.focus())},onFocus:()=>{n||(M(!0),l||p())}},{children:[e(Sl,Object.assign({ref:A,$hover:!!c},{children:[t(Fl,{ref:E,name:a[0],maxLength:2,value:null!=j?j:v,onFocus:T,onBlur:R,onChange:L,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==a[0]||r?"DD":""}),t(_l,Object.assign({$inactive:0===v.length},{children:"/"})),t(Bl,{ref:C,name:a[1],maxLength:2,value:null!=I?I:w,onFocus:T,onBlur:R,onChange:L,onKeyDown:z,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==a[1]||r?"MM":""}),t(_l,Object.assign({$inactive:0===w.length},{children:"/"})),t(Ol,{ref:H,name:a[2],maxLength:4,value:null!=P?P:x,onFocus:T,onBlur:R,onChange:L,onKeyDown:z,type:"text",inputMode:"numeric",pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:O!==a[2]||r?"YYYY":""})]})),(()=>{if(!s&&!r&&d)return t(kl,Object.assign({$hide:k,$disabled:n},{children:d}))})()]}))})),Al=D(Dl)`
    height: 3rem;
`,El=n=>{var{minDate:r,maxDate:a,disabled:s,disabledDates:l,error:c,value:d,onChange:h,onFocus:f,onBlur:p,onYearMonthDisplayChange:g,withButton:m=!0,readOnly:y,id:v,allowDisabledSelection:b}=n,D=O(n,["minDate","maxDate","disabled","disabledDates","error","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection"]);const[w,$]=o(_a.sanitizeInput(d)),[S,x]=o(_a.sanitizeInput(d)),[F,B]=o(void 0),[_,k]=o(!1),M=i(null),A=i(),E=i();u((()=>{const e=_a.sanitizeInput(d);$(e),x(e)}),[d]);const C=e=>{!b&&_a.isDateDisabled(e,{disabledDates:l,minDate:r,maxDate:a})||(x(e),m||(H(e),$(e),e&&k(!1)))},H=e=>{h&&h(e)},j=()=>{p&&p()};return e(Al,Object.assign({ref:M,$disabled:s,$readOnly:y,$error:c,id:v,"data-testid":D["data-testid"],tabIndex:-1,onBlur:e=>{M&&!M.current.contains(e.relatedTarget)&&(E.current.resetInput(),x(w),k(!1),j())},onKeyDown:function(e){"Escape"===e.code&&(E.current.resetInput(),x(w),k(!1))}},D,{children:[t(Ml,{ref:E,disabled:s,onChange:C,onFocus:()=>{y||(k(!0),f&&f())},readOnly:y,focused:_,names:["start-day","start-month","start-year"],value:S,hoverValue:F}),t(bl,{ref:A,type:"input",variant:"single",initialCalendarDate:S,isOpen:_,withButton:m,value:S,disabledDates:l,minDate:r,maxDate:a,allowDisabledSelection:b,onHover:e=>{B(e)},onSelect:C,onDismiss:e=>{switch(e){case"reset":x(w);break;case"confirmed":$(S),H(S)}k(!1)},onYearMonthDisplayChange:g})]}))};export{El as DateInput};
