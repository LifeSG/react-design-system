...
`,Ga=S.div`
    ...
    ${e=>{const{$selected:t}=e;if(t)return x`
                border-top: 1px solid ${Pa.Accent.Light[4]};
                border-bottom: 1px solid ${Pa.Accent.Light[4]};
                background-color: ${Pa.Accent.Light[5]};
            `}}
    
    ${e=>{const{$hovered:t,$overlap:n}=e;return t?x`
                border-top: 1px dashed ${Pa.Accent.Light[4]};
                border-bottom: 1px dashed ${Pa.Accent.Light[4]};
                background-color: ${Pa.Accent.Light[6]};
            `:n?x`
                background-color: ${Pa.Accent.Light[4]};
            `:void 0}}
`,Ja=S.div`
    display: flex;
    align-items: center;
    ...
    :hover {
        box-shadow: 0px 0px 4px 1px ${Pa.Shadow.Accent};
        border: 1px solid ${Pa.Accent.Light[1]};
        background-color: ${Pa.Neutral[8]};
    }

    ${e=>{const{$hovered:t,$selected:n}=e;return n?x`
                background: ${Pa.Accent.Light[5]};
...
`,os=S.div`
    ...
    ${e=>{if(e.$disabled)return x`
            ...
            `;switch(e.$variant){case"current-month":return x`
                    background-color: ${Pa.Accent.Light[6](e)};
                `;case"selected-month":return x`
                    background-color: ${Pa.Accent.Light[5](e)};
...
`,ls=S.div`
    ...
    ${e=>{if(e.$disabled)return x`
            ...
            `;switch(e.$variant){case"current-year":return x`
                    background: ${Pa.Accent.Light[6](e)};
...
`,Ps=S.button`
	...
	${e=>"small"===e.$buttonSizeStyle?x`
                ...
                `}
`,Bs=S((({color:e,className:r,size:o=18})=>t(ks,{className:r,$size:o,$color:e,children:[n(Ds,{id:"inner1",$size:o-2,$borderWidth:2}),n(Ms,{id:"inner2",$size:o-2,$borderWidth:2}),n(js,{id:"inner3",$size:o-2,$borderWidth:2}),n(Fs,{id:"inner4",$size:o-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Pa.Primary(e);break;case"disabled":t=Pa.Neutral[3](e);break;default:t=Pa.Neutral[8](e)}return x`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
        ...
        `}}
`,As={Default:i.forwardRef(((e,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",...l}=e,c={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default"};return t(Ps,{ref:r,"data-testid":l["data-testid"]||"button",disabled:i,...c,...l,children:[a&&n(Bs,{...c}),n("span",{children:o})]})})),Small:i.forwardRef(((e,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",...l}=e,c={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small"};return t(Ps,{ref:r,"data-testid":l["data-testid"]||"button",disabled:i,...c,...l,children:[a&&n(Bs,{...c,size:16}),n("span",{children:o})]})}))},Es=S.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,Ts=i.forwardRef((({children:e,focusHighlight:t=!0,focusOutline:r="none",...o},i)=>n(Es,{ref:i,$outline:r,$highlight:t,...o,children:e}))),Is=x`
    color: ${Pa.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,Hs=S(ms)`
...
`,tl=S(Ts)`
    ...
    ${e=>"left"===e.$direction?x`
                ...
                `}
`,nl=i.forwardRef((({disabledDates:e,onYearMonthDisplayChange:o,onCalendarView:i,onSelect:a,onHover:c,onDismiss:u,actionComponent:d,isOpen:f,value:p,endValue:m,currentFocus:g,withButton:y,variant:b,between:w,type:$="standalone",...S},x)=>{const[_,O]=l(M()),[k,C]=l("default"),[D,j]=l(),[P,B]=l(),[A,E]=l(),[T,I]=l(!0),H=s(null),L=s(null),R=function(e){void 0===e&&(e={});var t=e.skipOnMount,n=void 0!==t&&t,r=e.refreshMode,o=e.refreshRate,i=void 0===o?1e3:o,a=e.refreshOptions,c=e.handleWidth,u=void 0===c||c,d=e.handleHeight,h=void 0===d||d,f=e.targetRef,p=e.observerOptions,m=e.onResize,g=s(n),y=s(null),v=null!=f?f:y,b=s(),w=l({width:void 0,height:void 0}),$=w[0],S=w[1];return xe((function(){if(!we()){var e=Se(m,S,u,h);b.current=ve((function(t){(u||h)&&t.forEach((function(t){var n=t&&t.contentRect||{},r=n.width,o=n.height;!g.current&&!we()&&e({width:r,height:o}),g.current=!1}))}),r,i,a);var t=new window.ResizeObserver(b.current);return v.current&&t.observe(v.current,p),function(){t.disconnect();var e=b.current;e&&e.cancel&&e.cancel()}}}),[r,i,a,u,h,m,p,v.current]),F({ref:v},$)}();v(x,(()=>({defaultView(){C("default"),i("default")}})),[]),h((()=>{f&&(O(M()),C("default"),"range"===b&&p?.length&&m?.length&&I(!1))}),[f]),h((()=>{const e="end"===g?m:p;E(M(e)),e&&O(M(e))}),[g]),h((()=>{I(!0),p?("input"===d&&O(M(p)),j(p),O(M(p))):j(void 0)}),[p]),h((()=>{I(!0),m?("input"===d&&O(M(m)),B(m)):B(void 0)}),[m]);const z=()=>{switch(k){case"default":E((e=>e.subtract(1,"month"))),O((e=>{const t=e.subtract(1,"month");return Z(t),t}));break;case"month-options":O((e=>e.subtract(1,"year")));break;case"year-options":O((e=>e.subtract(10,"year")))}},N=()=>{switch(k){case"default":E((e=>e.add(1,"month"))),O((e=>{const t=e.add(1,"month");return Z(t),t}));break;case"month-options":O((e=>e.add(1,"year")));break;case"year-options":O((e=>e.add(10,"year")))}},V=e=>{const t=e.format("YYYY-MM-DD");O(e),E(e),G(t),Q(t)},Y=e=>{O(e),E(e),Z(e)},W=()=>{O(M("end"===g?m:p)),X("reset")},q=e=>{U(e)},Q=e=>{a&&a(e)},U=e=>{c&&c(e)},Z=e=>{if(o){const t={month:e.month()+1,year:e.year()};o(t)}},X=e=>{u&&u(e)},G=e=>{if(g)switch(g){case"start":default:j(e);break;case"end":B(e)}else j(e)},J=()=>{"month-options"!==k?(C("month-options"),te("month-options"),R.ref.current.focus()):(C("default"),O(A),te("default"))},K=()=>{"default"!==k?(C("default"),O(A),te("default")):(C("year-options"),te("year-options"))},ee=()=>{if("year-options"===k){const{beginDecade:e,endDecade:t}=ho.getStartEndDecade(_);return`${e} to ${t}`}return M(_).format("YYYY")},te=e=>{i&&i(e)},ne=()=>t(r,{children:[t(Zs,{type:"button",tabIndex:-1,$type:$,$expandedDisplay:"month-options"===k,$visible:"default"===k,id:"month-dropdown",onClick:J,children:[n(Xs,{$type:$,children:M(_).format("MMM")}),n(Rs,{})]}),t(Zs,{type:"button",tabIndex:-1,$type:$,$expandedDisplay:"default"!==k,id:"year-dropdown",onClick:K,children:[n(Xs,{$type:$,children:ee()}),n(Rs,{})]})]}),re=()=>{switch(k){case"month-options":return n(as,{type:$,calendarDate:_,currentFocus:g,selectedStartDate:D,selectedEndDate:P,viewCalendarDate:A,between:w,isNewSelection:T,onMonthSelect:Y});case"year-options":return n(us,{type:$,calendarDate:_,currentFocus:g,selectedStartDate:D,selectedEndDate:P,viewCalendarDate:A,between:w,isNewSelection:T,onYearSelect:Y});default:return null}},oe=()=>{switch($){case"standalone":default:return n(Us,{children:ne()});case"input":return t(qs,{children:[n(Qs,{children:ne()}),t(Gs,{children:[n(Js,{tabIndex:-1,onClick:z,children:n(Hs,{})}),n(Js,{tabIndex:-1,onClick:N,children:n(Ls,{})})]})]})}},ie=()=>{if("standalone"===$||!y)return;let e=!0;const r=["default"].includes(k);switch(b){case"single":e=!D;break;case"range":e=!D||!P}const o=!!r&&e;return t(Ks,{children:[n(el,{ref:L,"data-testid":"cancel-button",styleType:"light",onClick:W,children:"Cancel"}),n(el,{"data-testid":"done-button",ref:H,onClick:()=>(e=>{e||(O(A),X("confirmed"))})(o),disabled:o,children:"Done"})]})},ae=()=>t(Ns,{ref:R.ref,tabIndex:-1,"data-id":"calendar-container",$type:$,...S,children:["standalone"===$&&n(tl,{$direction:"left",onClick:z,children:n(Hs,{})}),t(Vs,{children:[oe(),t(Ys,{children:[n(ns,{type:$,calendarDate:_,currentFocus:g,disabledDates:e,selectedStartDate:D,selectedEndDate:P,variant:b,between:w,isNewSelection:T,onSelect:V,onHover:q}),n(Ws,{$visible:"default"!==k,children:re()})]}),ie()]}),"standalone"===$&&n(tl,{$direction:"right",onClick:N,children:n(Ls,{})})]}),se=zr({height:f?R.height+64:0});return"input"===$?n(zs,{style:se,children:ae()}):n(r,{children:ae()})}));var rl;M.extend(ts),function(e){const t=/^\d{4}-\d{2}-\d{2}$/;e.validate=(e,n,r,o)=>{if(!e||!n)return!1;if(M(e).isAfter(n))return!1;if(r&&r.length&&r.some((t=>[e,n].includes(t))))return!1;if(o&&o.length){if(![e,n].every((e=>M(e).isBetween(o[0],o[1],"day","[]"))))return!1;if(!o.every((e=>t.test(e))))return!1}return!0},e.validateSingle=(e,n,r)=>{if(0===e.length)return!1;if(n&&n.length&&n.some((t=>e===t)))return!1;if(r&&r.length&&!M(e).isBetween(r[0],r[1],"day","[]")){if(!M(e).isBetween(r[0],r[1],"day","[]"))return!1;if(!r.every((e=>t.test(e))))return!1}return!0},e.getFormattedRawValue=(e,t)=>{const[n,r,o]=e.split("-"),i=[o,r,n];let a;if(t){const[e,n,r]=t.split("-");a=[r,n,e]}return{start:i,end:a}},e.sleep=(e,t)=>new Promise((n=>{const r=setTimeout(n,e);t.signal.addEventListener("abort",(()=>{clearTimeout(r)}))}))}(rl||(rl={}));const ol=[1,3,5,7,8,10,12],il=[4,6,9,11];var al,sl,ll;!function(e){e.clampDay=(t,n,r)=>{const o=parseInt(t),i=parseInt(n),a=parseInt(r);return 0==o?"1":ol.includes(i)?Math.min(o,31).toString():il.includes(i)?Math.min(o,30).toString():2===i?e.isLeapYear(a)?Math.min(o,29).toString():Math.min(o,28).toString():t},e.clampMonth=e=>{const t=parseInt(e);return 0==t?"1":t>12?"12":e},e.isLeapYear=e=>e%4==0&&e%100!=0||e%400==0,e.getTimeDiffInMinutes=(e,t,n="HH:mm")=>{const r=M(e,n);return M(t,n).diff(r,"minute")}}(al||(al={})),function(e){e.generate=()=>Math.random().toString(36).substring(2,9)}(sl||(sl={})),function(e){e.transformWithSpaces=(e,t)=>{const n="(.{"+t+"})";return e.replace(/[^\dA-Z]/gi,"").replace(new RegExp(n,"g"),"$1 ").trim()},e.padValue=(e,t)=>{if("0"===e)return t?e:e.padStart(2,"0");if(""===e)return e;return parseInt(e).toString().padStart(2,"0")},e.shouldTruncateToTwoLines=(e,t)=>{const n=Math.floor(t/9);return e.length>=2*n||1===e.split(" ").length&&e.length>n},e.truncateOneLine=(e,t,n,r)=>{let o=0;t>n&&(o=Math.floor((t-n)/8));const i=r+o;if(i<e.length){const t=Math.floor(i/2);return e.substring(0,t)+" ... "+e.substring(e.length-t,e.length)}return e}}(ll||(ll={}));const cl=S.div`
    position: relative;
    display: flex;
    align-items: center;
    flex: 1;
...
`,Tl=S.div`
    ...
    ${e=>{if(!e.$disableMobile)return x`
            ...
            `}}
`,Il=({between:e,disabled:o,disabledDates:i,error:a,value:c,valueEnd:u,onChange:d,onBlur:f,onChangeRaw:p,onBlurRaw:m,withButton:g=!0,readOnly:y,id:v,variant:w="single",...$})=>{const[S,x]=l(!1),[_,O]=l("calendar"),[k,D]=l("default"),[M,j]=l({field:"none",type:"none",count:0}),[F,P]=l(!1),B=s(null),A=s(),E=C.exports.useMediaQuery({maxWidth:xs.mobileL}),T=g||E,[I,H]=b(xl,_l),[L,R]=b(xl,_l);((e,t,n=window)=>{const r=s();h((()=>{r.current=t}),[t]),h((()=>{if(!n||!n.addEventListener)return;const t=e=>r.current(e);return n.addEventListener(e,t),()=>{n.removeEventListener(e,t)}}),[e,n])})("keydown",(function(e){"Escape"===e.code&&V("reset");if("Enter"===e.code&&"range"===w&&!T){const e=[I.selected,L.selected].every(Boolean);V(e?"confirmed":"reset")}}),B.current),h((()=>{H({type:"confirmed",value:c}),"range"===w&&R({type:"confirmed",value:u})}),[]),h((()=>{H({type:"selected",value:c}),"range"===w&&R({type:"selected",value:u})}),[c,u]),h((()=>{const e=new AbortController;if([I.currentType,L.currentType].includes("unhover")){(async()=>{await rl.sleep(250,e),Q("default")})()}return()=>{e.abort()}}),[I.currentType,L.currentType]),h((()=>{"single"!==w&&"none"!==M.type&&j((e=>({...M,count:e.count+1})))}),[M.type]);const z=(e,t)=>{if(e===$l||""===e)return void(""===e&&Q("selected",e));const n=q(e);Q("selected",e),P(!n),O(t),U(n,t,e)},N=e=>{const t=e.split("-")[0];x(!0),j({...M,field:e,type:t})},V=e=>{if(["month-options","year-options"].includes(k))Y();else{switch(e){case"reset":Q("reset");break;case"confirmed":if(F){Q("reset");break}Q("confirmed"),W()}j({field:"none",type:"none",count:0}),x(!1)}},Y=()=>{A.current.defaultView()},W=e=>{const t=M.type;let n=I.selected,r=L.selected;if(e)switch(t){case"end":r=e;break;case"start":n=e}if(d&&d(n,r),p){const{start:e,end:t}=rl.getFormattedRawValue(n,r);p(e,t)}},q=t=>{let n=!0;const r={start:I.selected,end:L.selected};if(r[M.type]=t,"range"===w)switch(M.type){case"start":n=rl.validate(t,r.end,i,e);break;case"end":n=rl.validate(r.start,t,i,e)}else"single"===w&&(n=rl.validateSingle(t,i,e));return n},Q=(t,n)=>{let r=M.type,o=!0;switch(["confirmed","reset"].includes(t)&&(r="none",T&&"range"===w&&(o=rl.validate(I.selected,L.selected,i,e))),o||(H({type:"reset"}),R({type:"reset"})),r){case"start":if("invalid"===t)return void R({type:t});H({type:t,value:n});break;case"end":if("invalid"===t)return void H({type:t});R({type:t,value:n});break;default:H({type:t,value:n}),"range"===w&&R({type:t,value:n})}},U=(e,t,n)=>{if("range"===w&&!e){const{field:e,type:t}=Z();j({field:e,type:t,count:1}),Q("invalid")}if(!["month-options","year-options"].includes(k)){if(!T&&"single"===w&&e||!T&&"range"===w&&M.count>=2&&e)return x(!1),Q("confirmed"),W(n),void j({field:"none",type:"none",count:0});if(!(M.count>=2)&&"calendar"===t&&"range"===w){const{field:e,type:t}=Z();j((n=>({field:e,type:t,count:n.count+1})))}}},Z=()=>{const e="start"===M.type?"end":"start";return{field:`${e}-day`,type:e}};return t(Bl,{ref:B,$disabled:o,$error:a,id:v,"data-testid":$["data-testid"],$readOnly:y,$variant:w,onBlur:e=>{B&&!B.current.contains(e.relatedTarget)&&(Q("reset"),j({field:"none",type:"none",count:0}),((e,t)=>{if(f&&f(e.confirmed,t.confirmed),m){const{start:n,end:r}=rl.getFormattedRawValue(e.confirmed,t.confirmed);m(n,r)}})(I,L),x(!1),P(!1))},tabIndex:-1,...$,children:[n(wl,{disabled:o,onChange:e=>z(e,"input"),onFocus:N,readOnly:y,focused:"start"===M.type,names:["start-day","start-month","start-year"],value:I.input,confirmedValue:I.confirmed,variant:"range"===w?"start":"single",action:I.currentType,focusType:M.type,isOpen:S}),(()=>{if("range"===w)return t(r,{children:[n(Al,{tabIndex:-1,children:n(El,{})}),n(wl,{disabled:o,onChange:e=>z(e,"input"),onFocus:N,readOnly:y,focused:"end"===M.type,names:["end-day","end-month","end-year"],value:L.input,confirmedValue:L.confirmed,variant:w,action:L.currentType,focusType:M.type,isOpen:S})]})})(),(()=>{if("single"!==w&&!o&&!y)return n(Tl,{$position:M.type||"none"})})(),n(nl,{ref:A,type:"input",disabledDates:i,isOpen:S,withButton:T,actionComponent:_,currentFocus:M.type,value:I.calendar,endValue:L.calendar,between:e,variant:w,onCalendarView:e=>{D(e)},onHover:e=>{e?Q("hover",e):Q("unhover")},onSelect:e=>z(e,"calendar"),onDismiss:V})]})};export{Il as DateInput};
