...
`,bs=n=>{var{external:r=!1,children:i}=n,o=F(n,["external","children"]);return e(ys,Object.assign({},o,{children:[i,r&&t(vs,{})]}))};var $s;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}($s||($s={}));const ws=$.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
...
`,Ss=$((({color:n,className:r,size:i=18})=>e(ts,Object.assign({className:r,$size:i,$color:n},{children:[t(rs,{id:"inner1",$size:i-2,$borderWidth:2}),t(is,{id:"inner2",$size:i-2,$borderWidth:2}),t(os,{id:"inner3",$size:i-2,$borderWidth:2}),t(as,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=es.Primary(e);break;case"disabled":t=es.Neutral[3](e);break;default:t=es.Neutral[8](e)}return S`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
        ...
        `}}
`,xs={Default:i.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default"}=n,l=F(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default"};return e(ws,Object.assign({ref:r,"data-testid":l["data-testid"]||"button",disabled:o},c,l,{children:[a&&t(Ss,Object.assign({},c)),t("span",{children:i})]}))})),Small:i.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default"}=n,l=F(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small"};return e(ws,Object.assign({ref:r,"data-testid":l["data-testid"]||"button",disabled:o},c,l,{children:[a&&t(Ss,Object.assign({},c,{size:16})),t("span",{children:i})]}))}))},Ds=$.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,Os=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=F(e,["children","focusHighlight","focusOutline","type"]);return t(Ds,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),_s=S`
    color: ${es.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,Fs=$(D)`
    ...
    ${e=>{if(e.$disabledDisplay)return S`
            ...
            `;switch(e.$variant){case"current-month":return S`
                ...
                `;case"selected-month":return S`
                    ...
                    color: ${es.Primary(e)};
                `}}}
`,Ws=({calendarDate:e,currentFocus:n,selectedStartDate:r,selectedEndDate:i,viewCalendarDate:o,type:a,isNewSelection:s,minDate:l,maxDate:c,allowDisabledSelection:u,onMonthSelect:d})=>{const h=g((()=>ji.generateMonths(yi(e))),[e]),f=e=>{const t="start"===n&&i&&e.isAfter(i,"month")&&s,o="end"===n&&r&&e.isBefore(r,"month")&&s;return t||o},p=e=>{const t=e.format("MMMM"),n=(r=e,!ji.isWithinRange(r,l?yi(l):void 0,c?yi(c):void 0,"month"));var r;const i=o.isSame(e,"month")?"selected-month":yi().isSame(e,"month")?"current-month":"default";return{disabledDisplay:n||f(e),interactive:!n||u,month:t,variant:i}};return h.length?t(Ls,Object.assign({$type:a},{children:h.map((e=>{const{disabledDisplay:n,interactive:r,variant:i,month:o}=p(e);return t(Ns,Object.assign({$variant:i,$disabledDisplay:n,$interactive:r,onClick:()=>((e,t)=>{t||d(e)})(e,!r)},{children:t(Ys,Object.assign({weight:"regular",$variant:i,$disabledDisplay:n},{children:o}))}),o)}))})):null},Vs=$.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Qs=$(gs.H5)`
    ${e=>{if(e.$disabledDisplay)return S`
            ...
            `;switch(e.$variant){case"current-year":return S`
                ...
                `}}}
`,Us=({calendarDate:e,currentFocus:n,selectedStartDate:r,selectedEndDate:i,viewCalendarDate:o,type:a,isNewSelection:s,minDate:l,maxDate:c,allowDisabledSelection:u,onYearSelect:d})=>{const h=g((()=>ji.generateDecadeOfYears(yi(e))),[e]),f=e=>{const t="start"===n&&i&&e.isAfter(i,"year")&&s,o="end"===n&&r&&e.isBefore(r,"year")&&s;return t||o},p=e=>{const t=[0,11].includes(h.indexOf(e)),n=e.year(),r=(i=e,!ji.isWithinRange(i,l?yi(l):void 0,c?yi(c):void 0,"year"));var i;const a=t?"other-decade":o.isSame(e,"year")?"selected-year":yi().isSame(e,"year")?"current-year":"default";return{disabledDisplay:r||f(e),interactive:!r||u,year:n,variant:a}};return h.length?t(Vs,Object.assign({$type:a},{children:h.map((e=>{const{disabledDisplay:n,interactive:r,variant:i,year:o}=p(e);return t(qs,Object.assign({$variant:i,$disabledDisplay:n,$interactive:r,onClick:()=>((e,t)=>{t||d(e)})(e,!r)},{children:t(Qs,Object.assign({weight:"regular",$variant:i,$disabledDisplay:n,$interactive:r},{children:o}))}),o)}))})):null},Zs=i.forwardRef(((r,i)=>{var{children:o,initialCalendarDate:l,type:c,minDate:u,maxDate:h,currentFocus:f,selectedStartDate:p,selectedEndDate:m,selectWithinRange:g,dynamicHeight:v=!1,allowDisabledSelection:b,onCalendarDateChange:$,withButton:w,doneButtonDisabled:S,onDismiss:x,showNavigationHeader:D=!0,getLeftArrowDate:O,getRightArrowDate:_,isLeftArrowDisabled:k,isRightArrowDisabled:j,getMonthHeaderLabel:M,getYearHeaderLabel:P}=r,B=F(r,["children","initialCalendarDate","type","minDate","maxDate","currentFocus","selectedStartDate","selectedEndDate","selectWithinRange","dynamicHeight","allowDisabledSelection","onCalendarDateChange","withButton","doneButtonDisabled","onDismiss","showNavigationHeader","getLeftArrowDate","getRightArrowDate","isLeftArrowDisabled","isRightArrowDisabled","getMonthHeaderLabel","getYearHeaderLabel"]);const[A,C]=s(Ei.toDayjs(l)),[E,H]=s(Ei.toDayjs(l)),[T,I]=s("default"),R=a(null),z=a(null),L=a();y(i,(()=>({defaultView(){I("default")},resetView(){const e=Ei.toDayjs(l);C(e),H(e),I("default")},setCalendarDate(e){const t=Ei.toDayjs(e);C(t),H(t)}}))),d((()=>{const e=Ei.toDayjs(l);C(e),H(e)}),[l]),d((()=>{U(E)}),[E]);const N=()=>{"month-options"!==T?(I("month-options"),L.current.focus()):(I("default"),C(E))},Y=()=>{"default"!==T?(I("default"),C(E)):I("year-options")},W=()=>{L.current.focus();const e=O?O(A):A.subtract(1,"month");switch(T){case"default":H(e),C(e);break;case"month-options":C((e=>e.subtract(1,"year")));break;case"year-options":C((e=>e.subtract(10,"year")))}},V=()=>{L.current.focus();const e=_?_(A):A.add(1,"month");switch(T){case"default":H(e),C(e);break;case"month-options":C((e=>e.add(1,"year")));break;case"year-options":C((e=>e.add(10,"year")))}},q=e=>{C(e),H(e)},Q=()=>{const e=Ei.toDayjs(l);C(e),H(e),"default"===T?Z("reset"):I("default")},U=e=>{$&&$(e)},Z=e=>{x&&x(e)},G=()=>{if(!u||b)return!1;const e=yi(u);return"month-options"===T?!ji.isPreviousYearWithinRange(A,e):"year-options"===T?!ji.isPreviousDecadeWithinRange(A,e):k?k(A):!ji.isPreviousMonthWithinRange(A,e)},X=()=>{if(!h||b)return!1;const e=yi(h);return"month-options"===T?!ji.isNextYearWithinRange(A,e):"year-options"===T?!ji.isNextDecadeWithinRange(A,e):j?j(A):!ji.isNextMonthWithinRange(A,e)},J=()=>{if("year-options"===T){const{beginDecade:e,endDecade:t}=ji.getStartEndDecade(A);return`${e} to ${t}`}return P?P(A):A.format("YYYY")},K=()=>{const r=M?M(A):A.format("MMM");return e(n,{children:[e(Es,Object.assign({type:"button",tabIndex:-1,$expanded:"month-options"===T,$visible:"default"===T,id:"month-dropdown",onClick:N},{children:[t(Hs,{children:r}),t(js,{})]})),e(Es,Object.assign({type:"button",tabIndex:-1,$expanded:"default"!==T,id:"year-dropdown",onClick:Y},{children:[t(Hs,{children:J()}),t(js,{})]}))]})},ee=()=>{switch(T){case"month-options":return t(Ws,{type:c,calendarDate:A,currentFocus:f,minDate:u,maxDate:h,selectedStartDate:p,selectedEndDate:m,viewCalendarDate:E,isNewSelection:g,onMonthSelect:q,allowDisabledSelection:b});case"year-options":return t(Us,{type:c,calendarDate:A,currentFocus:f,minDate:u,maxDate:h,selectedStartDate:p,selectedEndDate:m,viewCalendarDate:E,isNewSelection:g,onYearSelect:q,allowDisabledSelection:b});default:return null}};return e(Ms,Object.assign({ref:L,tabIndex:-1,"data-id":"calendar-container","data-testid":"calendar-container"},B,{children:[D&&e(As,Object.assign({"data-id":"calendar-header","data-testid":"calendar-header"},{children:[t(Cs,{children:K()}),e(Ts,{children:[t(Is,Object.assign({"data-testid":"left-arrow-btn",disabled:G(),focusHighlight:!1,tabIndex:-1,onClick:W},{children:t(Fs,{})})),t(Is,Object.assign({"data-testid":"right-arrow-btn",disabled:X(),focusHighlight:!1,tabIndex:-1,onClick:V},{children:t(ks,{})}))]})]})),t(Ps,{children:(()=>{const r="function"==typeof o?o({calendarDate:E,currentView:T}):o;return e(n,v?{children:["default"===T&&r,ee()]}:{children:[r,t(Bs,Object.assign({$visible:"default"!==T},{children:ee()}))]})})()}),(()=>{if(!w)return;const n=!!("default"===T)&&S;return e(Rs,{children:[t(zs,Object.assign({ref:z,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:Q},{children:"Cancel"})),t(zs,Object.assign({"data-testid":"done-button",ref:R,type:"button",onClick:()=>(e=>{e||(C(E),"default"===T?Z("confirmed"):I("default"))})(n),disabled:n},{children:"Done"}))]})})()]}))})),Gs=$.div`
    width: 100%;
    display: grid;
...
`,ll=$(nl)`
    ${e=>{if("default"===e.$view)return S`
                z-index: 1;
            `}}
`,cl=({type:r,dayDate:i,currentView:o,variant:a,styleLeftProps:s,styleRightProps:l,styleCircleProps:c,styleLabelProps:u,styleOverflowCirleProps:d,onDayClick:h,onHoverCell:f})=>t(n,{children:(()=>{const n=i.format("YYYY-MM-DD");switch(r){case"regular":return e(Ks,{children:[t(rl,Object.assign({$position:"left"},s)),t(rl,Object.assign({$position:"right"},l)),t(il,Object.assign({$variant:a,onClick:()=>h(i,!c.$interactive),onMouseEnter:()=>f(n,!c.$interactive)},c,{children:t(nl,Object.assign({weight:u.$selected?"semibold":"regular",$variant:a},u,{children:i.format("D")}))}))]});case"week":return e(Ks,{children:[t(ol,Object.assign({$position:"left"},s)),t(ol,Object.assign({$position:"right"},l)),t(sl,Object.assign({$variant:a,onClick:()=>h(i,!c.$interactive),onMouseEnter:()=>f(n,!c.$interactive)},c,d,{children:t(ll,Object.assign({weight:u.$selected?"semibold":"regular",$variant:a,$view:o},u,{children:i.format("D")}))})),t(al,Object.assign({},c,d))]})}})()});var ul;yi.extend(Oi),function(e){e.generateStyleProps=(e,t,n,r,i,o,a,s,l,c,u)=>{const d=e.format("YYYY-MM-DD"),h={},f={},p={},m={},g=dl(e,l,a,s),y=t&&n&&t===n;return!u&&["reset-start","reset-end"].includes(i)&&[t,n].includes(d)&&(p.$overlap=!0),(g||hl(e,o,t,n,u))&&(p.$disabledDisplay=!0,m.$disabledDisplay=!0),p.$interactive=!g||c,[t,n].includes(d)&&(p.$selected=!0,m.$selected=!0),t&&n&&!y&&e.isBetween(t,n,"day","[]")&&(m.$selected=!0,e.isSame(t)?f.$selected=!0:e.isSame(n)?h.$selected=!0:(h.$selected=!0,f.$selected=!0)),"hover-start"===i&&e.isBetween(n,r,"day","[]")&&(m.$selected=!0,n===d?h.$hovered=!0:r===d?(f.$hovered=!0,p.$hovered=!0):(h.$hovered=!0,f.$hovered=!0)),"hover-end"===i&&e.isBetween(t,r,"day","[]")&&(m.$selected=!0,t===d?f.$hovered=!0:r===d?(h.$hovered=!0,p.$hovered=!0):(h.$hovered=!0,f.$hovered=!0)),"overlap-start"===i&&e.isBetween(n,r,"day","[]")&&(r===d?(f.$overlap=!0,p.$overlap=!0):n===d?(h.$overlap=!0,p.$overlap=!0,p.$hovered=!0):(h.$overlap=!0,f.$overlap=!0)),"overlap-end"===i&&e.isBetween(t,r,"day","[]")&&(r===d?(h.$overlap=!0,p.$overlap=!0):t===d?(f.$overlap=!0,p.$overlap=!0,p.$hovered=!0):(h.$overlap=!0,f.$overlap=!0)),"full-overlap-start"===i&&e.isBetween(n,r,"day","[]")&&(t===d&&y?(h.$hovered=!0,p.$overlap=!0):t===d?(h.$hovered=!0,f.$overlap=!0,p.$overlap=!0):n===d?(h.$overlap=!0,p.$overlap=!0):e.isSame(r)?(f.$hovered=!0,m.$selected=!0,p.$hovered=!0):e.isBetween(t,r,"day","()")&&(h.$hovered=!0,f.$hovered=!0,m.$selected=!0)),"full-overlap-end"===i&&e.isBetween(t,r,"day","[]")&&(n===d&&y?(f.$hovered=!0,p.$overlap=!0):n===d?(h.$overlap=!0,f.$hovered=!0,p.$overlap=!0):t===d?(f.$overlap=!0,p.$overlap=!0):e.isSame(r)?(h.$hovered=!0,m.$selected=!0,p.$hovered=!0):e.isBetween(n,r,"day","()")&&(h.$hovered=!0,f.$hovered=!0,m.$selected=!0)),["full-overlap-end","full-overlap-start"].includes(i)&&e.isBetween(t,n,"day","()")&&(h.$overlap=!0,f.$overlap=!0),{styleLeftProps:h,styleRightProps:f,styleCircleProps:p,styleLabelProps:m}},e.getStylePropsForWeekSelection=(e,t,n,r,i,o,a,s)=>{const l={},c={},u={},d={},h={},f=dl(e,a,i,o);if(f&&(u.$disabledDisplay=!0,d.$disabledDisplay=!0),u.$interactive=!f||s,t){const{firstDayOfWeek:n,lastDayOfWeek:r}=fl(t);e.isBetween(n,r,"day","[]")&&(d.$selected=!0,e.isSame(n)?(c.$selected=!0,u.$selected=!0,h.$position="left"):e.isSame(r)?(l.$selected=!0,u.$selected=!0,h.$position="right"):(l.$selected=!0,u.$selected=!0,c.$selected=!0))}if(r){const{firstDayOfWeek:t,lastDayOfWeek:n}=fl(r);e.isBetween(t,n,"day","[]")&&(d.$selected=!0,e.isSame(t)?(c.$hovered=!0,u.$hovered=!0,h.$position="left"):e.isSame(n)?(l.$hovered=!0,u.$hovered=!0,h.$position="right"):(l.$hovered=!0,c.$hovered=!0))}if(t&&n&&r&&e.isBetween(t,n,"day","[]")&&yi(r).isBetween(t,n,"day","[]")){const{firstDayOfWeek:n,lastDayOfWeek:r}=fl(t);e.isBetween(n,r,"day","[]")&&(d.$selected=!0,e.isSame(n)?(c.$overlap=!0,u.$overlap=!0,h.$position="left"):e.isSame(r)?(l.$overlap=!0,u.$overlap=!0,h.$position="right"):(l.$overlap=!0,u.$overlap=!0,c.$overlap=!0))}return{styleLeftProps:l,styleRightProps:c,styleCircleProps:u,styleLabelProps:d,styleOverflowCirleProps:h}}}(ul||(ul={}));const dl=(e,t,n,r)=>{const i=ji.isWithinRange(e,n?yi(n):void 0,r?yi(r):void 0),o=t&&t.includes(e.format("YYYY-MM-DD"));return!i||o},hl=(e,t,n,r,i)=>{const o="start"===t&&r&&e.isAfter(r)&&i,a="end"===t&&n&&e.isBefore(n)&&i;return o||a},fl=e=>({firstDayOfWeek:Ei.toDayjs(e).startOf("week").format("YYYY-MM-DD"),lastDayOfWeek:Ei.toDayjs(e).endOf("week").format("YYYY-MM-DD")});yi.extend(Oi);const pl=({calendarDate:n,currentFocus:r,disabledDates:i,selectedStartDate:o,selectedEndDate:a,onSelect:l,onHover:c,isNewSelection:u,minDate:d,maxDate:h,variant:f,allowDisabledSelection:p})=>{const m=g((()=>ji.generateDays(n)),[n]),[y,v]=s(""),b=(e,t)=>{t&&!p||l(e)},$=(e,t)=>{t&&!p||(v(e),c(e))},w=()=>{v(""),c("")},S=(()=>{if(!y||"single"===f)return null;const e=yi(y);if(o&&a)if(e.isBefore(o)){if("start"===r)return"full-overlap-start";if("end"===r)return"reset-end"}else if(e.isAfter(a)){if("end"===r)return"full-overlap-end";if("start"===r)return"reset-start"}else if(e.isBetween(o,a,"day","[]")&&![o,a].includes(y)){if("start"===r)return"overlap-start";if("end"===r)return"overlap-end"}if(o&&!a){if(e.isAfter(o)&&"end"===r)return"hover-end"}else if(!o&&a&&e.isBefore(a)&&"start"===r)return"hover-start";return null})();return e(Gs,Object.assign({"data-testid":"calendar-content"},{children:[m[0].map(((e,n)=>t(Xs,{children:t(gs.H6,Object.assign({weight:"semibold"},{children:yi(e).format("ddd")}))},`week-day-${n}`))),m.map(((e,s)=>t(Js,Object.assign({onMouseLeave:w},{children:e.map(((e,s)=>{const{variant:l}=(e=>({variant:n.month()!==e.month()?"other-month":yi().isSame(e,"day")?"today":"default"}))(e),{styleLeftProps:c,styleRightProps:f,styleCircleProps:m,styleLabelProps:g}=ul.generateStyleProps(e,o,a,y,S,r,d,h,i,p,u);return t(cl,{type:"regular",dayDate:e,variant:l,styleLeftProps:c,styleRightProps:f,styleCircleProps:m,styleLabelProps:g,onDayClick:b,onHoverCell:$},`day-${s}`)}))}),s)))]}))},ml=({calendarDate:n,disabledDates:r,selectedStartDate:i,selectedEndDate:o,onSelect:a,onHover:l,minDate:c,maxDate:u,currentView:d,allowDisabledSelection:h})=>{const f=g((()=>ji.generateDays(n)),[n]),[p,m]=s(""),y=(e,t)=>{if(t&&!h)return;const n=e.startOf("week");a(n),e&&!yi(e).isSame(n,"month")&&m("")},v=(e,t)=>{t&&!h||(m(e),l(e))},b=()=>{m(""),l("")};return e(Gs,Object.assign({"data-testid":"calendar-content"},{children:[f[0].map(((e,n)=>t(Xs,{children:t(gs.H6,Object.assign({weight:"semibold"},{children:yi(e).format("ddd")}))},`week-day-${n}`))),f.map(((e,a)=>t(Js,Object.assign({onMouseLeave:b},{children:e.map(((e,a)=>{const{variant:s}=(e=>({variant:n.month()!==e.month()?"other-month":yi().isSame(e,"day")?"today":"default"}))(e),{styleLeftProps:l,styleRightProps:f,styleCircleProps:m,styleLabelProps:g,styleOverflowCirleProps:b}=ul.getStylePropsForWeekSelection(e,i,o,p,c,u,r,h);return t(cl,{type:"week",dayDate:e,variant:s,currentView:d,styleLeftProps:l,styleRightProps:f,styleCircleProps:m,styleLabelProps:g,styleOverflowCirleProps:b,onDayClick:y,onHoverCell:v},`day-${a}`)}))}),a)))]}))},gl=$.div`
    width: 100%;
    padding: 1.5rem 2rem;
    background: ${es.Neutral[8]};
...
`,yl=i.forwardRef((({disabledDates:e,onYearMonthDisplayChange:n,onSelect:r,onHover:i,onDismiss:o,value:s,endValue:l,currentFocus:c,withButton:u,variant:d,minDate:h,maxDate:f,allowDisabledSelection:p,type:m="standalone",selectWithinRange:g=!0,initialCalendarDate:v},b)=>{const $=a(),w=a(void 0);y(b,(()=>({reset(){$.current.resetView()},setCalendarDate(e){$.current.setCalendarDate(e)}})));const S=e=>{const t=e.format("YYYY-MM-DD");$.current.setCalendarDate(t),D(t)},x=e=>{O(e)},D=e=>{r&&r(e)},O=e=>{i&&i(e)},_=e=>{if(n){const t={month:e.month()+1,year:e.year()};n(t)}};return t(gl,Object.assign({$type:m},{children:t(Zs,Object.assign({type:m,ref:$,withButton:u,doneButtonDisabled:(()=>{if(!u)return;let e=!0;switch(d){case"single":e=!1;break;case"range":e=!!s!=!!l;break;case"week":e=!s&&!l}return e})(),onDismiss:o,minDate:h,maxDate:f,selectWithinRange:g,currentFocus:c,selectedStartDate:s,selectedEndDate:l,allowDisabledSelection:p,onCalendarDateChange:e=>{w.current&&w.current.isSame(e,"month")||_(e),w.current=e},initialCalendarDate:v},{children:({calendarDate:n,currentView:r})=>((n,r)=>{switch(d){case"single":case"range":default:return t(pl,{calendarDate:n,currentFocus:c,disabledDates:e,selectedStartDate:s,selectedEndDate:l,variant:d,minDate:h,maxDate:f,isNewSelection:g,allowDisabledSelection:p,onSelect:S,onHover:x});case"week":return t(ml,{calendarDate:n,disabledDates:e,selectedStartDate:s,selectedEndDate:l,minDate:h,maxDate:f,currentView:r,allowDisabledSelection:p,onSelect:S,onHover:x})}})(n,r)}))}))})),vl=i.forwardRef(((e,n)=>{const{isOpen:r}=e,i=F(e,["isOpen"]),o=a(),l=function(e){void 0===e&&(e={});var t=e.skipOnMount,n=void 0!==t&&t,r=e.refreshMode,i=e.refreshRate,o=void 0===i?1e3:i,l=e.refreshOptions,c=e.handleWidth,u=void 0===c||c,d=e.handleHeight,h=void 0===d||d,f=e.targetRef,p=e.observerOptions,m=e.onResize,g=a(n),y=a(null),v=null!=f?f:y,b=a(),$=s({width:void 0,height:void 0}),w=$[0],S=$[1];return De((function(){if(!we()){var e=xe(m,S,u,h);b.current=be((function(t){(u||h)&&t.forEach((function(t){var n=t&&t.contentRect||{},r=n.width,i=n.height;!g.current&&!we()&&e({width:r,height:i}),g.current=!1}))}),r,o,l);var t=new window.ResizeObserver(b.current);return v.current&&t.observe(v.current,p),function(){t.disconnect();var e=b.current;e&&e.cancel&&e.cancel()}}}),[r,o,l,u,h,m,p,v.current]),B({ref:v},w)}(),c=Nr({height:r?l.height:0});return d((()=>{r&&o.current.reset()}),[r]),y(n,(()=>o.current)),t(mi,Object.assign({style:c},{children:t("div",Object.assign({ref:l.ref,inert:r?void 0:""},{children:t(yl,Object.assign({ref:o},i))}))}))})),bl={collections:{base:{InputBoxShadow:S`
    ...
    `,ElevationBoxShadow:S`
      0px 2px 8px ${es.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},$l=e=>t=>{var n;const r=t.theme,i=Ga(bl,r[Xa.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?Za(i,e,r.options.designToken):Za(i,e)},wl=$l("InputBoxShadow"),Sl=$l("InputErrorBoxShadow"),xl=($l("ElevationBoxShadow"),$l("Table.Header"),$l("Table.Cell.Primary"),$l("Table.Cell.Secondary"),$l("Table.Cell.Selected"),$l("Table.Cell.Hover"),$.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${es.Neutral[5]};
...
`,Bl=$.div`
    ...
    ${e=>e.$disabled?S`
            ...
            `:e.$hide?S`
                display: none;
            `:void 0}
`;yi.extend(wi);const Al=i.forwardRef((({disabled:n,readOnly:r,names:i,value:o,focused:l,hoverValue:c,placeholder:u,label:h,onChange:f,onFocus:p,onBlur:m},g)=>{const[v,b,$]=Ri(""),[w,S,x]=Ri(""),[D,O,_]=Ri(""),[F,k]=s("none"),[j,M]=s(!1),P=a(null),B=a(null),A=a(null),C=a(null),[E,H,T]=N(c);d((()=>{const[e="",t="",n=""]=N(o);b(e),S(t),O(n)}),[o]),d((()=>{l||k("none"),l&&(M(!0),P.current.contains(document.activeElement)||B.current.focus())}),[l]),y(g,(()=>({ref:P,resetPlaceholder(){M(!1)},resetInput(){const[e="",t="",n=""]=N(o);b(e),S(t),O(n)}})),[o]);const I=e=>{e.target.select();const t=e.target.name;k(t)},R=e=>{const[t,n,r]=i,o={[t]:$.current,[n]:x.current,[r]:_.current},a=e.target.name,s=o[a],l=a!==r?Ii.padValue(s,!0):s;switch(a){case t:o[t]=l,b(l);break;case n:o[n]=l,S(l)}const c=`${o[r]}-${o[n]}-${o[t]}`,u=yi(c,"YYYY-MM-DD",!0).isValid(),d=!o[t]&&!o[n]&&!o[r];u&&s!==l&&f(c),P.current.contains(e.relatedTarget)||(k("none"),null==m||m(d||u))},z=e=>{if(c)return;const t=e.target.name,n=e.target.value.replace(/[^0-9]/g,""),r={day:v,month:w,year:D};switch(t){case i[0]:r.day=n,b(n),2===n.length&&A.current.focus();break;case i[1]:r.month=n,S(n),2===n.length&&C.current.focus();break;case i[2]:r.year=n,O(n)}if(!r.day&&!r.month&&!r.year)return void f("");const o=`${r.year}-${r.month}-${r.day}`;yi(o,"YYYY-MM-DD",!0).isValid()&&f(o)},L=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(F===i[1]&&0===w.length&&B.current.focus(),F===i[2]&&0===D.length&&A.current.focus())};function N(e){if(e){const t=yi(e,"YYYY-MM-DD");return[Ii.padValue(t.date().toString()),Ii.padValue((t.month()+1).toString()),t.year().toString()]}return[void 0,void 0,void 0]}return e(Ol,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(M(!0),P.current.contains(document.activeElement)||B.current.focus())},onFocus:()=>{n||(M(!0),l||p())}},{children:[e(_l,Object.assign({ref:P,$hover:!!c},{children:[t(kl,{ref:B,name:i[0],maxLength:2,value:null!=E?E:v,onFocus:I,onBlur:R,onChange:z,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${i[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[0]||r?"DD":""}),t(Pl,Object.assign({$inactive:0===v.length},{children:"/"})),t(jl,{ref:A,name:i[1],maxLength:2,value:null!=H?H:w,onFocus:I,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${i[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[1]||r?"MM":""}),t(Pl,Object.assign({$inactive:0===w.length},{children:"/"})),t(Ml,{ref:C,name:i[2],maxLength:4,value:null!=T?T:D,onFocus:I,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{4}","data-testid":`${i[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:F!==i[2]||r?"YYYY":""})]})),(()=>{if(!o&&!r&&u)return t(Bl,Object.assign({$hide:j,$disabled:n},{children:u}))})()]}))})),Cl=$(xl)`
    height: 3rem;
`,El=n=>{var{minDate:r,maxDate:i,disabled:o,disabledDates:l,error:c,value:u,onChange:h,onFocus:f,onBlur:p,onYearMonthDisplayChange:m,withButton:g=!0,readOnly:y,id:v,allowDisabledSelection:b}=n,$=F(n,["minDate","maxDate","disabled","disabledDates","error","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection"]);const[w,S]=s(Hi.sanitizeInput(u)),[x,D]=s(Hi.sanitizeInput(u)),[O,_]=s(void 0),[k,j]=s(!1),P=a(null),B=a(),A=a(),C=M.exports.useMediaQuery({maxWidth:hi.mobileL}),E=g||C;d((()=>{const e=Hi.sanitizeInput(u);S(e),D(e)}),[u]);const H=e=>{!b&&Hi.isDateDisabled(e,{disabledDates:l,minDate:r,maxDate:i})||(D(e),E||(T(e),S(e),e&&j(!1)))},T=e=>{h&&h(e)},I=()=>{p&&p()};return e(Cl,Object.assign({ref:P,$disabled:o,$readOnly:y,$error:c,id:v,"data-testid":$["data-testid"],tabIndex:-1,onBlur:e=>{P&&!P.current.contains(e.relatedTarget)&&(A.current.resetInput(),D(w),j(!1),I())},onKeyDown:function(e){"Escape"===e.code&&(A.current.resetInput(),D(w),j(!1))}},$,{children:[t(Al,{ref:A,disabled:o,onChange:H,onFocus:()=>{y||(j(!0),f&&f())},readOnly:y,focused:k,names:["start-day","start-month","start-year"],value:x,hoverValue:O}),t(vl,{ref:B,type:"input",variant:"single",initialCalendarDate:x,isOpen:k,withButton:E,value:x,disabledDates:l,minDate:r,maxDate:i,allowDisabledSelection:b,onHover:e=>{_(e)},onSelect:H,onDismiss:e=>{switch(e){case"reset":D(w);break;case"confirmed":S(x),T(x)}j(!1)},onYearMonthDisplayChange:m})]}))};export{El as DateInput};
