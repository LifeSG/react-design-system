...
`,jl=w.div`
    ...
    ${e=>e.$disabled?D`
            ...
            `:e.$hide?D`
                display: none;
            `:void 0}
`;ga.extend(ba);const Pl=a.forwardRef((({disabled:n,readOnly:r,names:a,value:i,focused:l,hoverValue:c,placeholder:d,label:h,onChange:f,onFocus:p,onBlur:g},m)=>{const[v,b,w]=Ia(""),[$,D,S]=Ia(""),[x,F,O]=Ia(""),[B,_]=s("none"),[k,M]=s(!1),A=o(null),E=o(null),H=o(null),C=o(null),[j,P,I]=Y(c);u((()=>{const[e="",t="",n=""]=Y(i);b(e),D(t),F(n)}),[i]),u((()=>{l||_("none"),l&&(M(!0),A.current.contains(document.activeElement)||E.current.focus())}),[l]),y(m,(()=>({ref:A,resetPlaceholder(){M(!1)},resetInput(){const[e="",t="",n=""]=Y(i);b(e),D(t),F(n)}})),[i]);const T=e=>{e.target.select();const t=e.target.name;_(t)},R=e=>{const[t,n,r]=a,i={[t]:w.current,[n]:S.current,[r]:O.current},o=e.target.name,s=i[o],l=o!==r?Pa.padValue(s,!0):s;switch(o){case t:i[t]=l,b(l);break;case n:i[n]=l,D(l)}const c=`${i[r]}-${i[n]}-${i[t]}`,d=ga(c,"YYYY-MM-DD",!0).isValid(),u=!i[t]&&!i[n]&&!i[r];d&&s!==l&&f(c),A.current.contains(e.relatedTarget)||(_("none"),null==g||g(u||d))},z=e=>{if(c)return;const t=e.target.name,n=e.target.value.replace(/[^0-9]/g,""),r={day:v,month:$,year:x};switch(t){case a[0]:r.day=n,b(n),2===n.length&&H.current.focus();break;case a[1]:r.month=n,D(n),2===n.length&&C.current.focus();break;case a[2]:r.year=n,F(n)}if(!r.day&&!r.month&&!r.year)return void f("");const i=`${r.year}-${r.month}-${r.day}`;ga(i,"YYYY-MM-DD",!0).isValid()&&f(i)},L=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(B===a[1]&&0===$.length&&E.current.focus(),B===a[2]&&0===x.length&&H.current.focus())};function Y(e){if(e){const t=ga(new Date(e));return[Pa.padValue(t.date().toString()),Pa.padValue((t.month()+1).toString()),t.year().toString()]}return[void 0,void 0,void 0]}return e(_l,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(M(!0),A.current.contains(document.activeElement)||E.current.focus())},onFocus:()=>{n||(M(!0),l||p())}},{children:[e(kl,Object.assign({ref:A,$hover:!!c},{children:[t(Al,{ref:E,name:a[0],maxLength:2,value:null!=j?j:v,onFocus:T,onBlur:R,onChange:z,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:B!==a[0]||r?"DD":""}),t(Cl,Object.assign({$inactive:0===v.length},{children:"/"})),t(El,{ref:H,name:a[1],maxLength:2,value:null!=P?P:$,onFocus:T,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:B!==a[1]||r?"MM":""}),t(Cl,Object.assign({$inactive:0===$.length},{children:"/"})),t(Hl,{ref:C,name:a[2],maxLength:4,value:null!=I?I:x,onFocus:T,onBlur:R,onChange:z,onKeyDown:L,type:"text",inputMode:"numeric",pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:B!==a[2]||r?"YYYY":""})]})),(()=>{if(!i&&!r&&d)return t(jl,Object.assign({$hide:k,$disabled:n},{children:d}))})()]}))})),Il=w(Ol)`
    height: 3rem;
