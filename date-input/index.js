    ...
    ${e=>{if(e.$disabledDisplay)return b`
            ...
            `;switch(e.$variant){case"current-month":return b`
                ...
                `;case"selected-month":return b`
                    ...
                    color: ${tn.Primary(e)};
                `}}}
`,Ma=({calendarDate:e,currentFocus:n,selectedStartDate:r,selectedEndDate:a,viewCalendarDate:i,type:o,isNewSelection:l,minDate:s,maxDate:c,allowDisabledSelection:d,onMonthSelect:u})=>{const h=g((()=>_r.generateMonths(Cr(e))),[e]),f=e=>{const t="start"===n&&a&&e.isAfter(a,"month")&&l,i="end"===n&&r&&e.isBefore(r,"month")&&l;return t||i},p=e=>{const t=e.format("MMMM"),n=(r=e,!_r.isWithinRange(r,s?Cr(s):void 0,c?Cr(c):void 0,"month"));var r;const a=i.isSame(e,"month")?"selected-month":Cr().isSame(e,"month")?"current-month":"default";return{disabledDisplay:n||f(e),interactive:!n||d,month:t,variant:a}};return h.length?t(ka,Object.assign({$type:o},{children:h.map((e=>{const{disabledDisplay:n,interactive:r,variant:a,month:i}=p(e);return t(Ea,Object.assign({$variant:a,$disabledDisplay:n,$interactive:r,onClick:()=>((e,t)=>{t||u(e)})(e,!r)},{children:t(Aa,Object.assign({weight:"regular",$variant:a,$disabledDisplay:n},{children:i}))}),i)}))})):null},Ca=y.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
