...
`,aa=e=>"right"===e?"bottom-end":"bottom-start",ia=({enabled:n,isOpen:a,onOpen:s,onClose:l,onDismiss:d,renderElement:c,renderDropdown:g,customZIndex:h,clickToToggle:b=!1,offset:m=0,alignment:f="left",fitAvailableHeight:y})=>{var p;const v=x(),T=rn["sm-max"]({theme:v}),j=i(null),R=i(null),{width:_=0}=function(e){void 0===e&&(e={});var r=e.skipOnMount,t=void 0!==r&&r,n=e.refreshMode,a=e.refreshRate,s=void 0===a?1e3:a,l=e.refreshOptions,d=e.handleWidth,c=void 0===d||d,u=e.handleHeight,g=void 0===u||u,h=e.targetRef,b=e.observerOptions,m=e.onResize,f=i(t),y=i(null),p=null!=h?h:y,v=i(),x=o({width:void 0,height:void 0}),D=x[0],w=x[1];return ta((function(){if(!Gn()){var e=ea(m,w,c,g);v.current=Xn((function(r){(c||g)&&r.forEach((function(r){var t=r&&r.contentRect||{},n=t.width,a=t.height;!f.current&&!Gn()&&e({width:n,height:a}),f.current=!1}))}),n,s,l);var r=new window.ResizeObserver(v.current);return p.current&&r.observe(p.current,b),function(){r.disconnect();var e=v.current;e&&e.cancel&&e.cancel()}}}),[n,s,l,c,g,m,b,p.current]),dn({ref:p},D)}({targetRef:j,handleHeight:!1}),L={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<T;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:H,floatingStyles:I,context:W}=w({open:a,onOpenChange:(e,r,t)=>{"escape-key"===t?null==d||d():e&&!a?null==s||s():!e&&a&&(null==l||l(t))},whileElementsMounted:F,placement:aa(f),middleware:[$(m),E(),C({limiter:B()}),A({apply({availableHeight:e}){R.current&&Object.assign(R.current.style,{maxHeight:y?`${e}px`:void 0,overflowY:y?"hidden":void 0})}}),L]}),N=(()=>{const[e,r]=o(void 0),t=D();return u((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(ra.Change,e),t.events.emit(ra.Ready),()=>t.events.off(ra.Change,e)}),[t]),e})(),{isMounted:P,styles:U}=S(W,{initial:{opacity:0},open:{opacity:1},duration:300}),V=k(W,{enabled:n,toggle:b}),Z=M(W,{enabled:n}),{getReferenceProps:K,getFloatingProps:J}=z([V,Z]);return e(r,{children:[t("div",Object.assign({ref:e=>{j.current=e,H.setReference(e)}},K(),{children:c()})),P&&t(O,{children:t(Y,{context:W,modal:!1,initialFocus:R,returnFocus:!1,children:t("div",Object.assign({ref:H.setFloating,style:Object.assign(Object.assign({},I),{zIndex:null!==(p=null!=h?h:N)&&void 0!==p?p:50})},J(),{children:t(na,{ref:R,style:Object.assign({},U),inert:U.opacity<1?"":void 0,children:g({elementWidth:_})})}))})})]})},oa=y.div`
...
`,qi=y(Xa.Default)`
    ...
    ${e=>{if(e.$enableDateClick)return p`
            ...
            `}}
`,Gi=r=>{var{selectedDate:n,minDate:a,maxDate:i,loading:s,showDateAsShortForm:l,showCurrentDateAsToday:d,onLeftArrowClick:c,onRightArrowClick:u,onCalendarDateSelect:g}=r,h=_(r,["selectedDate","minDate","maxDate","loading","showDateAsShortForm","showCurrentDateAsToday","onLeftArrowClick","onRightArrowClick","onCalendarDateSelect"]);const b=$a.toDayjs(n),m=$a.toDayjs(n).format(l?"D MMM YYYY":"D MMMM YYYY").toString(),f=$a.isSame(n,W())&&d?"Today":b.format(l?"ddd":"dddd"),[y,p]=o(!1),v=e=>{g&&g(e),p(!y)},x=()=>{p(!1),c(n)},D=()=>{p(!1),u(n)};return t(ia,{enabled:!s,isOpen:y,renderElement:()=>e(Xi,Object.assign({},h,{children:[t(Ji,{"data-testid":"date-navigator-left-arrow-btn",disabled:s||!!a&&(fa.isDisabledDay(b,void 0,a)||$a.isSame(b,a)),"aria-label":"Previous day",onClick:x,styleType:"light",sizeType:"small",children:t(ei,{})}),t(qi,{onClick:()=>!!g&&!s&&p(!y),$enableDateClick:!!g&&!s,"data-testid":"date-navigator-date-text",styleType:"link",disabled:!g||s,children:`${m}, ${f}`}),t(Ji,{"data-testid":"date-navigator-right-arrow-btn",disabled:s||!!i&&(fa.isDisabledDay(b,void 0,void 0,i)||$a.isSame(b,i)),"aria-label":"Next day",onClick:D,styleType:"light",sizeType:"small",children:t(ri,{})})]})),renderDropdown:({elementWidth:e})=>t(Zi,{variant:"single",initialCalendarDate:n,value:n,minDate:a,maxDate:i,onSelect:v,width:e}),onDismiss:()=>p(!1),onClose:()=>p(!1),offset:8})};export{Gi as DateNavigator};
