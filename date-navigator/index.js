...
`,ki=f.button`
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return y`
                ...
                `}}}
`,Yi=f((({color:r,className:n,size:i})=>e(Si,{className:n,$size:i,$color:r,"data-testid":"component-loading-spinner",children:[t(Ai,{id:"inner1"}),t(zi,{id:"inner2"}),t(Mi,{id:"inner3"}),t(Oi,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,Ti=(r,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:s="default",danger:l=!1}=r,d=_(r,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:a?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(ki,Object.assign({ref:n,"data-testid":d["data-testid"]||"button",disabled:a},c,d,{children:[o&&t(Yi,{}),t("span",{children:i})]}))};Ti.displayName="Button.Default";const ji=(r,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:s="default",danger:l=!1}=r,d=_(r,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:a?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(ki,Object.assign({ref:n,"data-testid":d["data-testid"]||"button",disabled:a},c,d,{children:[o&&t(Yi,{}),t("span",{children:i})]}))};ji.displayName="Button.Small";const _i=(r,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:s="default",danger:l=!1}=r,d=_(r,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:a?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(ki,Object.assign({ref:n,"data-testid":d["data-testid"]||"button",disabled:a},c,d,{children:[o&&t(Yi,{}),t("span",{children:i})]}))};_i.displayName="Button.Large";const Ri={Default:i.forwardRef(Ti),Small:i.forwardRef(ji),Large:i.forwardRef(_i)},Li=f.button`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,Hi=i.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=_(e,["children","focusHighlight","focusOutline","type"]);return t(Li,Object.assign({ref:r,$outline:a,$highlight:i,type:o},s,{children:n}))})),Wi=y`
    color: ${Jt.icon};
    height: 1rem;
    width: 1rem;
`,Ii=f(T)`
...
`,ga=f.div`
    grid-column: 1 / -1;
    display: flex;
`,ha=e=>{let r=Jt.bg,t="transparent";switch(e.$type){case"hover-subtle":r=Jt["bg-hover"],t=Jt["bg-hover"];break;case"hover":r=Jt["bg-hover-strong"],t=Jt["bg-hover-strong"];break;case"hover-outline":r=Jt["bg-hover-subtle"],t=Jt["border-hover"];break;case"selected-outline":r=Jt["bg-selected"],t=Jt["border-selected"];break;case"selected-outline-subtle":r=Jt["bg-selected"],t=Jt["border-selected-subtle"];break;case"selected-hover":r=Jt["bg-selected-hover"];break;case"selected-hover-outline":r=Jt["bg-selected-hover"],t=Jt["border-selected-hover"]}return{color:r,borderColor:t}},ba=f.div`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
...
`,ma=f.div`
    ...
    ${e=>{if(!e.$type)return;const{color:r,borderColor:t}=ha(e);return y`
            background-color: ${r};
            background-clip: border-box;
            border-top-color: ${t};
...
`,pa=f.div`
    ...
    ${e=>{if(e.$type){const{color:r,borderColor:t}=ha(e);return y`
                background-color: ${r};
...
`,ja=f(i.forwardRef(((e,r)=>{var{"data-testid":n,styleType:i="primary",children:a,sizeType:o="default",type:s="button"}=e,l=_(e,["data-testid","styleType","children","sizeType","type"]);return t(Ta,Object.assign({"data-testid":n||"iconButton",ref:r,type:s,$sizeType:o,$styleType:i},l,{children:a}))})))`
    margin: ${Qt["spacing-8"]};
`,_a=f.div`
    display: flex;
    position: relative;
...
`,Ra=f(Ri.Default)`
    ...
    ${e=>{if(e.$enableDateClick)return y`
            ...
            `}}
`,La=r=>{var{selectedDate:n,minDate:i,maxDate:a,loading:s,showDateAsShortForm:l,showCurrentDateAsToday:d,onLeftArrowClick:c,onRightArrowClick:u,onCalendarDateSelect:g}=r,h=_(r,["selectedDate","minDate","maxDate","loading","showDateAsShortForm","showCurrentDateAsToday","onLeftArrowClick","onRightArrowClick","onCalendarDateSelect"]);const b=Fi.toDayjs(n),m=Fi.toDayjs(n).format(l?"D MMM YYYY":"D MMMM YYYY").toString(),f=Fi.isSame(n,W())&&d?"Today":b.format(l?"ddd":"dddd"),[y,p]=o(!1),v=e=>{g&&g(e),p(!y)},x=()=>{p(!1),c(n)},D=()=>{p(!1),u(n)};return t(ii,{enabled:!s,isOpen:y,renderElement:()=>e(_a,Object.assign({},h,{children:[t(ja,{"data-testid":"date-navigator-left-arrow-btn",disabled:s||!!i&&(mi.isDisabledDay(b,void 0,i)||Fi.isSame(b,i)),"aria-label":"Previous day",onClick:x,styleType:"light",sizeType:"small",children:t(Ii,{})}),t(Ra,{onClick:()=>!!g&&!s&&p(!y),$enableDateClick:!!g&&!s,"data-testid":"date-navigator-date-text",styleType:"link",disabled:!g||s,children:`${m}, ${f}`}),t(ja,{"data-testid":"date-navigator-right-arrow-btn",disabled:s||!!a&&(mi.isDisabledDay(b,void 0,void 0,a)||Fi.isSame(b,a)),"aria-label":"Next day",onClick:D,styleType:"light",sizeType:"small",children:t(Ni,{})})]})),renderDropdown:({elementWidth:e})=>t(Ya,{variant:"single",initialCalendarDate:n,value:n,minDate:i,maxDate:a,onSelect:v,width:e}),onDismiss:()=>p(!1),onClose:()=>p(!1),offset:8})};export{La as DateNavigator};
