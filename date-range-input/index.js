...
`,ja=p.button`
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return v`
                ...
                `}}}
`,Ta=p((({color:r,className:n,size:a})=>e(Ba,Object.assign({className:n,$size:a,$color:r},{children:[t(Aa,{id:"inner1"}),t(za,{id:"inner2"}),t(ka,{id:"inner3"}),t(Ya,{id:"inner4"})]}))))`
    margin-right: 0.5rem;
...
`,to=p.div`
    ...
    ${e=>e.$disabled?v`
            ...
            `:e.$hide?v`
                display: none;
            `:void 0}
`;N.extend(la);const no=a.forwardRef((({disabled:r,readOnly:n,names:a,value:s,focused:l,hoverValue:d,placeholder:c,label:h,onChange:b,onFocus:g,onBlur:f,hideInputKeyboard:y},p)=>{const v=y?"none":"numeric",[x,D,w]=Oa(""),[$,F,E]=Oa(""),[C,S,O]=Oa(""),[B,M]=o("none"),[A,z]=o(!1),k=i(null),Y=i(null),j=i(null),T=i(null),[R,_,H]=Z(d);u((()=>{const[e="",r="",t=""]=Z(s);D(e),F(r),S(t),e||r||t||!k.current.contains(document.activeElement)||Y.current.focus()}),[s]),u((()=>{l||M("none"),l&&(z(!0),k.current.contains(document.activeElement)||Y.current.focus())}),[l]),m(p,(()=>({ref:k,resetPlaceholder(){z(!1)},resetInput(){const[e="",r="",t=""]=Z(s);D(e),F(r),S(t)}})),[s]);const L=e=>{var r;e.preventDefault(),null===(r=Y.current)||void 0===r||r.focus()},I=e=>{e.target.select();const r=e.target.name;M(r)},W=e=>{const[r,t,n]=a,i={[r]:w.current,[t]:E.current,[n]:O.current},o=e.target.name,s=i[o],l=o!==n?Sa.padValue(s,!0):s;switch(o){case r:i[r]=l,D(l);break;case t:i[t]=l,F(l)}const d=`${i[n]}-${i[t]}-${i[r]}`,c=N(d,"YYYY-MM-DD",!0).isValid(),u=!i[r]&&!i[t]&&!i[n];c&&s!==l&&b(d),k.current.contains(e.relatedTarget)||(M("none"),null==f||f(u||c))},P=e=>{if(d)return;const r=e.target.name,t=e.target.value.replace(/[^0-9]/g,""),n={day:x,month:$,year:C};switch(r){case a[0]:n.day=t,D(t),2===t.length&&j.current.focus();break;case a[1]:n.month=t,F(t),2===t.length&&T.current.focus();break;case a[2]:n.year=t,S(t)}if(!n.day&&!n.month&&!n.year)return void b("");const i=`${n.year}-${n.month}-${n.day}`;N(i,"YYYY-MM-DD",!0).isValid()&&b(i)},V=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||(B===a[1]&&0===$.length&&Y.current.focus(),B===a[2]&&0===C.length&&j.current.focus())};function Z(e){if(e){const r=N(new Date(e));return r.isValid()?[Sa.padValue(r.date().toString()),Sa.padValue((r.month()+1).toString()),r.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Ji,Object.assign({role:"group","aria-label":h,onClick:()=>{r||n||(z(!0),k.current.contains(document.activeElement)||Y.current.focus())},onFocus:e=>{r||(z(!0),l||null==g||g(e))}},{children:[e(qi,Object.assign({ref:k,$hover:!!d},{children:[t(Gi,{ref:Y,name:a[0],maxLength:2,value:null!=R?R:x,onFocus:I,onBlur:W,onChange:P,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:B!==a[0]||n?"DD":""}),t(ro,Object.assign({$inactive:0===x.length},{children:"/"})),t(Qi,{ref:j,name:a[1],maxLength:2,value:null!=_?_:$,onFocus:I,onBlur:W,onChange:P,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:B!==a[1]||n?"MM":""}),t(ro,Object.assign({$inactive:0===$.length},{children:"/"})),t(eo,{ref:T,name:a[2],maxLength:4,value:null!=H?H:C,onFocus:I,onBlur:W,onChange:P,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:B!==a[2]||n?"YYYY":""})]})),(()=>{if(!s&&!n&&c)return t(to,Object.assign({$hide:A,$disabled:r,onMouseDown:L},{children:c}))})()]}))})),ao=(e,r,t)=>{const n=[];e&&n.push(`[${e}]`),n.push(r,t),console.log(...n)},io=p(Ui)`
    ${e=>e.$wrap&&v`
