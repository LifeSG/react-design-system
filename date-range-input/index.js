...
`,wo=p.div`
    ...
    ${e=>e.$wrap&&v`
            height: fit-content;
        `}
`,Fo={initialStart:"",initialEnd:"",selectedStart:"",selectedEnd:"",currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1,focused:!1},$o=r=>{var{minDate:n,maxDate:a,disabled:s,disabledDates:l,error:d,hideInputKeyboard:c,value:g,valueEnd:b,onChange:m,onFocus:y,onBlur:p,onYearMonthDisplayChange:v,withButton:x=!0,variant:D="range",numberOfDays:w=7,readOnly:F,id:$,allowDisabledSelection:E,zIndex:C,dropdownRootNode:S}=r,B=H(r,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","valueEnd","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","variant","numberOfDays","readOnly","id","allowDisabledSelection","zIndex","dropdownRootNode"]);const[A,O]=o(),[M,k]=o(void 0),[z,Y]=o(!1),[j,R]=o(!1),T="week"===D,_="fixed-range"===D,[{selectedStart:I,selectedEnd:L,currentFocus:W,calendarOpen:P,isStartDirty:V,isEndDirty:U,focused:Z},K]=(({initialState:e,reducers:r,name:t,debug:n})=>{const[a,i]=f(((e,t)=>r[t.type]?r[t.type](e,t.payload):e),e);return[a,Object.fromEntries(Object.keys(r).map((e=>[e,r=>{n&&xo(t,e,r),i({type:e,payload:r})}])))]})({name:"date-range-input",initialState:Fo,reducers:{blur:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1,focused:!1}),dismiss:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1}),changeStart:(e,r)=>Object.assign(Object.assign({},e),{selectedStart:r,isStartDirty:!0}),changeEnd:(e,r)=>Object.assign(Object.assign({},e),{selectedEnd:r,isEndDirty:!0}),reselectStart:e=>Object.assign(Object.assign({},e),{selectedStart:"",currentFocus:"start"}),reselectEnd:e=>Object.assign(Object.assign({},e),{selectedEnd:"",currentFocus:"end"}),focus:(e,r)=>Object.assign(Object.assign({},e),{currentFocus:T?"none":_?"start":r,calendarOpen:!F,focused:!0}),cancel:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart,selectedEnd:e.initialEnd,currentFocus:"none",calendarOpen:!1}),done:(e,r)=>Object.assign(Object.assign({},e),{selectedStart:r.start,selectedEnd:r.end,initialStart:r.start,initialEnd:r.end,currentFocus:"none",calendarOpen:!1,isStartDirty:!1,isEndDirty:!1}),resetStart:e=>Object.assign(Object.assign({},e),{selectedStart:e.initialStart}),resetEnd:e=>Object.assign(Object.assign({},e),{selectedEnd:e.initialEnd}),resetRange:(e,r)=>Object.assign(Object.assign({},e),{initialStart:r.start,selectedStart:r.start,initialEnd:r.end,selectedEnd:r.end})}}),J=i(!1),q=i(null),X=i(null),G=i(null),Q=i(null),ee=(({maxWidth:e,targetRef:r})=>{const[t,n]=o(!1);return ia({targetRef:r,refreshMode:"throttle",refreshRate:300,handleHeight:!1,onResize:h((r=>{n(r<=e)}),[e])}),t})({maxWidth:320,targetRef:q});u((()=>{K.resetRange({start:Ba.sanitizeInput(g),end:Ba.sanitizeInput(b)})}),[g,b]),u((()=>{"start"===W?O(I):"end"===W&&O(L)}),[W]);const re=e=>{var r,t,n;"Enter"!==e.code||x||(I&&L?(K.done({start:I,end:L}),null==m||m(I,L)):(K.dismiss(),null===(r=q.current)||void 0===r||r.focus(),null===(t=G.current)||void 0===t||t.resetPlaceholder(),null===(n=Q.current)||void 0===n||n.resetPlaceholder()))},te=e=>{var r;if(me(e))return void(J.current=!0);if(K.changeStart(e),null===(r=X.current)||void 0===r||r.setCalendarDate(e),J.current=!1,!e)return void(x||L||!U||(K.resetRange({start:"",end:""}),null==m||m("","")));if(!L)return void K.focus("end");if(N(e).isAfter(L,"day"))K.reselectEnd();else{if(U)return x?void 0:(K.done({start:e,end:L}),void(null==m||m(e,L)));K.focus("end")}},ne=e=>{var r,t;if(me(e))return void(J.current=!0);if(N(e).isBefore(I,"day"))return K.changeStart(e),null===(r=X.current)||void 0===r||r.setCalendarDate(e),void K.reselectEnd();if(K.changeEnd(e),null===(t=X.current)||void 0===t||t.setCalendarDate(e),e){if(I)return x?void 0:(K.done({start:I,end:e}),void(null==m||m(I,e)));K.focus("start")}else x||I||!V||(K.resetRange({start:"",end:""}),null==m||m("",""))},ae=e=>{var r;if(me(e))return void(J.current=!0);if(K.changeStart(e),null===(r=X.current)||void 0===r||r.setCalendarDate(e),J.current=!1,!e)return void(x?K.changeEnd(""):(K.resetRange({start:"",end:""}),null==m||m("","")));const t=N(e).format("YYYY-MM-DD"),n=N(t).add(w-1,"day").format("YYYY-MM-DD");return K.changeStart(t),K.changeEnd(n),J.current=!1,x?void 0:(K.done({start:t,end:n}),void(null==m||m(t,n)))},ie=()=>{F||s||Z||(K.focus("start"),null==y||y())},oe=e=>{var r,t;Z&&!P&&q.current&&q.current.contains(e.relatedTarget)&&(K.blur(),Y(!1),R(!1),null===(r=G.current)||void 0===r||r.resetPlaceholder(),null===(t=Q.current)||void 0===t||t.resetPlaceholder(),null==p||p())},se=e=>r=>{r.stopPropagation(),F||(K.focus(e),le(),de(),Z||null==y||y())},le=()=>{if(T){const e=Sa.toDayjs(I).startOf("week").format("YYYY-MM-DD");Y(!0),R(!0),O(e)}},de=()=>{_&&(R(!0),O(I))},ce=e=>{var r;e&&!J.current||(K.resetStart(),null===(r=G.current)||void 0===r||r.resetInput())},ue=e=>{var r;e&&!J.current||(K.resetEnd(),null===(r=Q.current)||void 0===r||r.resetInput())},ge=e=>{switch(D){case"week":(e=>{const r=N(e).startOf("week").format("YYYY-MM-DD"),t=N(e).endOf("week").format("YYYY-MM-DD");if(K.changeStart(r),K.changeEnd(t),J.current=!1,!x)K.done({start:r,end:t}),null==m||m(r,t)})(e);break;case"fixed-range":ae(e);break;default:"start"===W?te(e):"end"===W&&ne(e)}},he=e=>{var r;switch(null===(r=q.current)||void 0===r||r.focus(),e){case"reset":K.cancel();break;case"confirmed":K.done({start:I,end:L}),null==m||m(I,L)}},be=e=>{k(e)},me=e=>!E&&e&&Ba.isDateDisabled(e,{disabledDates:l,minDate:n,maxDate:a}),fe=e=>{let r={start:void 0,end:void 0};switch(D){case"range":r={start:"start"===W?M:void 0,end:"end"===W?M:void 0};break;case"week":if(!M)return;r={start:N(M).startOf("week").format("YYYY-MM-DD"),end:N(M).endOf("week").format("YYYY-MM-DD")};break;case"fixed-range":if(!M)return;r={start:N(M).format("YYYY-MM-DD"),end:N(M).add(w-1,"day").format("YYYY-MM-DD")}}return r[e]};return t(la,{enabled:!F&&!s,isOpen:P,onClose:()=>{var e,r;K.blur(),Y(!1),R(!1),null===(e=G.current)||void 0===e||e.resetPlaceholder(),null===(r=Q.current)||void 0===r||r.resetPlaceholder(),null==p||p()},onDismiss:()=>{var e,r,t;K.dismiss(),null===(e=q.current)||void 0===e||e.focus(),null===(r=G.current)||void 0===r||r.resetPlaceholder(),null===(t=Q.current)||void 0===t||t.resetPlaceholder()},renderElement:()=>t(Do,Object.assign({ref:q,tabIndex:-1,onFocus:ie,onBlur:oe,$focused:Z,$disabled:s,$readOnly:F,$error:d,$wrap:ee,id:$,"data-testid":B["data-testid"],onKeyDown:re},B,{children:e(no,{currentActive:W,wrap:ee,error:d,children:[t(wo,{$wrap:ee,children:t(vo,{ref:G,placeholder:"From",names:["start-day","start-month","start-year"],value:I,disabled:s,readOnly:z||F,focused:"start"===W,hoverValue:fe("start"),onChange:_?ae:te,onFocus:se("start"),onBlur:ce,hideInputKeyboard:c})}),t(wo,{$wrap:ee,children:t(vo,{ref:Q,placeholder:"To",names:["end-day","end-month","end-year"],value:L,disabled:s,readOnly:j||F,focused:"end"===W,hoverValue:fe("end"),onChange:ne,onFocus:se("end"),onBlur:ue,hideInputKeyboard:c})})]})})),renderDropdown:({elementWidth:e})=>t(Xi,{ref:X,variant:D,initialCalendarDate:A,withButton:x,value:I,endValue:L,selectWithinRange:V||U,currentFocus:W,disabledDates:l,minDate:n,maxDate:a,allowDisabledSelection:E,onSelect:ge,onDismiss:he,onHover:be,onYearMonthDisplayChange:v,numberOfDays:w,width:e}),customZIndex:C,offset:16,rootNode:S})};export{$o as DateRangeInput};
