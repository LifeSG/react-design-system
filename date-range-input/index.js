...
`,Hc=$.div`
    ...
    ${e=>{if(e.$wrap)return S`
                display: none;
            `}}
`,Rc=({children:n,currentActive:r,error:a,className:i,wrap:o})=>{const[s,c]=n;return e(Ec,Object.assign({className:i,$wrap:o},{children:[t(Cc,Object.assign({"data-id":"range-container-elem1-container"},{children:s})),t(Pc,{}),o&&t(Ac,{}),t(Cc,Object.assign({"data-id":"range-container-elem2-container"},{children:c})),t(Hc,{"data-id":"range-container-indicator",$position:r,$error:a,$wrap:o})]}))},Tc=$.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${as.Neutral[5]};
