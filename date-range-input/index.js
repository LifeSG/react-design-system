...
`,$i=v((({color:r,className:n,size:a})=>e(ii,{className:n,$size:a,$color:r,"data-testid":"component-loading-spinner",children:[t(si,{id:"inner1"}),t(li,{id:"inner2"}),t(di,{id:"inner3"}),t(ci,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,Ei=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=H(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Fi,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t($i,{}),t("span",{children:a})]}))};Ei.displayName="Button.Default";const Ci=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=H(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Fi,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t($i,{}),t("span",{children:a})]}))};Ci.displayName="Button.Small";const Si=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=H(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(Fi,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t($i,{}),t("span",{children:a})]}))};Si.displayName="Button.Large";const Bi={Default:a.forwardRef(Ei),Small:a.forwardRef(Ci),Large:a.forwardRef(Si)},ki=v.button`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,Ai=a.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=H(e,["children","focusHighlight","focusOutline","type"]);return t(ki,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),Oi=x`
    color: ${mn.icon};
    height: 1rem;
    width: 1rem;
`,Mi=v(_)`
...
`,Oo=v.div`
    ...
    ${e=>{if(e.$wrap)return x`
                display: none;
            `}}
`,Mo=({children:r,currentActive:n,error:a,className:i,wrap:o})=>{const[s,l]=r;return e(So,{className:i,$wrap:o,children:[t(ko,{"data-id":"range-container-elem1-container",children:s}),t(Ao,{}),o&&t(Bo,{}),t(ko,{"data-id":"range-container-elem2-container",children:l}),t(Oo,{"data-id":"range-container-indicator",$position:n,$error:a,$wrap:o})]})},Yo=x`
    outline-offset: -1px;
...
`,Uo=v.div`
    ...
    ${e=>e.$disabled?x`
            ...
            `:e.$hide?x`
                display: none;
            `:void 0}
`;V.extend(_a);const Ko=a.forwardRef((({disabled:r,readOnly:n,names:a,value:s,focused:l,hoverValue:d,placeholder:c,label:g,onChange:b,onFocus:h,onBlur:m,hideInputKeyboard:y,inputLabels:p=["Date","Month","Year"]},v)=>{const x=y?"none":"numeric",[D,w,F]=ai(""),[$,E,C]=ai(""),[S,B,k]=ai(""),[A,O]=o("none"),[M,Y]=o(!1),z=i(null),j=i(null),R=i(null),T=i(null),[_,I,L]=K(d);u((()=>{var e;const[r="",t="",n=""]=K(s);w(r),E(t),B(n),r||t||n||!z.current||!z.current.contains(document.activeElement)||null===(e=j.current)||void 0===e||e.focus()}),[s]),u((()=>{var e;l||O("none"),l&&(Y(!0),z.current&&!z.current.contains(document.activeElement)&&(null===(e=j.current)||void 0===e||e.focus()))}),[l]),f(v,(()=>({ref:z,resetPlaceholder(){Y(!1)},resetInput(){const[e="",r="",t=""]=K(s);w(e),E(r),B(t)},focusYearRef(){var e;null===(e=T.current)||void 0===e||e.focus()}})),[w,E,B,s]);const H=e=>{var r;e.preventDefault(),null===(r=j.current)||void 0===r||r.focus()},W=e=>{e.target.select();const r=e.target.name;O(r)},P=e=>{const[r,t,n]=a,i={[r]:F.current,[t]:C.current,[n]:k.current},o=e.target.name,s=i[o],l=o!==n?ni.padValue(s,!0):s;switch(o){case r:i[r]=l,w(l);break;case t:i[t]=l,E(l)}const d=`${i[n]}-${i[t]}-${i[r]}`,c=V(d,"YYYY-MM-DD",!0).isValid(),u=!i[r]&&!i[t]&&!i[n];c&&s!==l&&b(d),z.current&&!z.current.contains(e.relatedTarget)&&(O("none"),null==m||m(u||c))},N=e=>{var r,t;if(d)return;const n=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),o={day:D,month:$,year:S};switch(n){case a[0]:o.day=i,w(i),2===i.length&&(null===(r=R.current)||void 0===r||r.focus());break;case a[1]:o.month=i,E(i),2===i.length&&(null===(t=T.current)||void 0===t||t.focus());break;case a[2]:o.year=i,B(i)}if(!o.day&&!o.month&&!o.year)return void b("");const s=`${o.year}-${o.month}-${o.day}`;V(s,"YYYY-MM-DD",!0).isValid()&&b(s)},U=e=>{var r,t;"Backspace"!==e.code&&"Backspace"!==e.key||(A===a[1]&&0===$.length&&(null===(r=j.current)||void 0===r||r.focus()),A===a[2]&&0===S.length&&(null===(t=R.current)||void 0===t||t.focus()))};function K(e){if(e){const r=V(new Date(e));return r.isValid()?[ni.padValue(r.date().toString()),ni.padValue((r.month()+1).toString()),r.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Io,{role:"group","aria-label":g,onClick:()=>{var e;r||n||(Y(!0),z.current&&!z.current.contains(document.activeElement)&&(null===(e=j.current)||void 0===e||e.focus()))},onFocus:e=>{r||(Y(!0),l||null==h||h(e))},children:[e(Lo,{ref:z,$hover:!!d,children:[t(Wo,{ref:j,name:a[0],maxLength:2,value:null!=_?_:D,onFocus:W,onBlur:P,onChange:N,type:"text",inputMode:x,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":p[0],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:A!==a[0]||n?"DD":""}),t(Vo,{$inactive:0===D.length,children:"/"}),t(Po,{ref:R,name:a[1],maxLength:2,value:null!=I?I:$,onFocus:W,onBlur:P,onChange:N,onKeyDown:U,type:"text",inputMode:x,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":p[1],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:A!==a[1]||n?"MM":""}),t(Vo,{$inactive:0===$.length,children:"/"}),t(No,{ref:T,name:a[2],maxLength:4,value:null!=L?L:S,onFocus:W,onBlur:P,onChange:N,onKeyDown:U,type:"text",inputMode:x,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":p[2],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:A!==a[2]||n?"YYYY":""})]}),(()=>{if(!s&&!n&&c)return t(Uo,{$hide:M,$disabled:r,onMouseDown:H,children:c})})()]})})),Zo=(e,r,t)=>{const n=[];e&&n.push(`[${e}]`),n.push(r,t),console.log(...n)},Jo=v(To)`
    ${e=>e.$wrap&&x`
