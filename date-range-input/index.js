...
`,mi={Button:{"button-radius":bn.md,"button-default-colour-bg":Wt["bg-primary"],"button-default-colour-bg-hover":Wt["bg-primary-hover"],"button-default-colour-text":Wt["text-inverse"],"button-secondary-colour-border":Wt["border-primary"],"button-secondary-colour-text":Wt["text-primary"],"button-light-colour-text":Wt["text-primary"],"button-link-colour-text":Wt["text-primary"]}},fi={collections:{default:{Button:{"button-radius":bn.sm,"button-default-colour-bg":Wt["bg-primary"],"button-default-colour-bg-hover":Wt["bg-primary-hover"],"button-default-colour-text":Wt["text-inverse"],"button-secondary-colour-border":Wt["border-primary"],"button-secondary-colour-text":Wt["text-primary"],"button-light-colour-text":Wt["text-primary"],"button-link-colour-text":Wt["text-primary"]}},pa:{Button:{"button-radius":bn.full,"button-default-colour-bg":Wt["bg-primary"],"button-default-colour-bg-hover":Wt["bg-primary-hover"],"button-default-colour-text":Wt["text-inverse"],"button-secondary-colour-border":Wt["border-primary"],"button-secondary-colour-text":Wt["text-primary"],"button-light-colour-text":Wt["text-primary"],"button-link-colour-text":Wt["text-primary"]}},a11yplayground:mi},defaultValue:"default"},yi=(e,r)=>t=>{var n,a;const i=t.theme,o=mt(fi,null==i?void 0:i.componentScheme);return pi((null===(a=null===(n=null==i?void 0:i.componentOverrides)||void 0===n?void 0:n[e])||void 0===a?void 0:a[r])||o[e][r],t)},pi=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},vi=yi("Button","button-radius"),xi=yi("Button","button-default-colour-bg"),Di=yi("Button","button-default-colour-bg-hover"),Fi=yi("Button","button-default-colour-text"),wi=yi("Button","button-secondary-colour-border"),$i=yi("Button","button-secondary-colour-text"),Ei=yi("Button","button-light-colour-text"),Ci=yi("Button","button-link-colour-text"),Si=D.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return F`
                    ...
                    border-color: ${e.$buttonIsDanger?pn["border-error-strong"]:wi};

                    color: ${e.$buttonIsDanger?pn["text-error"]:$i};
                ...
                `;case"light":return F`
                    ...
                    color: ${e.$buttonIsDanger?pn["text-error"]:Ei};
                ...
                `;case"disabled":return F`
                    ...
                    color: ${pn["text-disabled"]};
                `;default:return F`
                    background-color: ${e.$buttonIsDanger?pn["bg-error-strong"]:xi};
                    ...
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${e.$buttonIsDanger?pn["bg-error-strong-hover"]:Di};
                        }
                    }
                `}}}
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return F`
                ...
                `}}}
`,Bi=D((({color:r,className:n,size:a})=>e(di,{className:n,$size:a,$color:r,"data-testid":"component-loading-spinner",children:[t(ui,{id:"inner1"}),t(gi,{id:"inner2"}),t(bi,{id:"inner3"}),t(hi,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,Ai=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=P(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Si,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t(Bi,{}),t("span",{children:a})]}))};Ai.displayName="Button.Default";const ki=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=P(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Si,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t(Bi,{}),t("span",{children:a})]}))};ki.displayName="Button.Small";const Oi=(r,n)=>{const{children:a,disabled:i=!1,loading:o=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=r,u=P(r,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(Si,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":o,onClick:i?void 0:c},g,u,{children:[o&&t(Bi,{}),t("span",{children:a})]}))};Oi.displayName="Button.Large";const Mi={Default:a.forwardRef(Ai),Small:a.forwardRef(ki),Large:a.forwardRef(Oi)},zi=D.button`
    display: flex;
    justify-content: center;
    align-items: center;
...
`,Yi=a.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=P(e,["children","focusHighlight","focusOutline","type"]);return t(zi,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),ji=F`
    color: ${pn.icon};
    height: 1rem;
    width: 1rem;
`,Ri=D(L)`
...
`,oo=D.div`
    grid-column: 1 / -1;
    display: flex;
`,so=e=>{let r=pn.bg,t="transparent";switch(e.$type){case"hover-subtle":r=pn["bg-hover"],t=pn["bg-hover"];break;case"hover":r=pn["bg-hover-strong"],t=pn["bg-hover-strong"];break;case"hover-outline":r=pn["bg-hover-subtle"],t=pn["border-hover"];break;case"selected-outline":r=pn["bg-selected"],t=pn["border-selected"];break;case"selected-outline-subtle":r=pn["bg-selected"],t=pn["border-selected-subtle"];break;case"selected-hover":r=pn["bg-selected-hover"];break;case"selected-hover-outline":r=pn["bg-selected-hover"],t=pn["border-selected-hover"]}return{color:r,borderColor:t}},lo=D.div`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
...
`,co=D.div`
    ...
    ${e=>{if(!e.$type)return;const{color:r,borderColor:t}=so(e);return F`
            background-color: ${r};
            background-clip: border-box;
            border-top-color: ${t};
...
`,bo=D.div`
    ...
    ${e=>{if(e.$type){const{color:r,borderColor:t}=so(e);return F`
                background-color: ${r};
...
`,jo=D.div`
    ...
    ${e=>{if(e.$wrap)return F`
                display: none;
            `}}
`,Ro=({children:r,currentActive:n,error:a,className:i,wrap:o})=>{const[s,l]=r;return e(Oo,{className:i,$wrap:o,children:[t(zo,{"data-id":"range-container-elem1-container",children:s}),t(Yo,{}),o&&t(Mo,{}),t(zo,{"data-id":"range-container-elem2-container",children:l}),t(jo,{"data-id":"range-container-indicator",$position:n,$error:a,$wrap:o})]})},To=F`
    outline-offset: -1px;
...
`,qo=D.div`
    ...
    ${e=>e.$disabled?F`
            ...
            `:e.$hide?F`
                display: none;
            `:void 0}
`;K.extend(Ha);const Xo=a.forwardRef((({disabled:r,readOnly:n,names:a,value:s,focused:l,hoverValue:d,placeholder:c,label:g,onChange:b,onFocus:h,onBlur:m,hideInputKeyboard:f,inputLabels:y=["Date","Month","Year"]},v)=>{const x=f?"none":"numeric",[D,F,w]=si(""),[$,E,C]=si(""),[S,B,A]=si(""),[k,O]=o("none"),[M,z]=o(!1),Y=i(null),j=i(null),R=i(null),T=i(null),[_,I,L]=U(d);u((()=>{var e;const[r="",t="",n=""]=U(s);F(r),E(t),B(n),r||t||n||!Y.current||!Y.current.contains(document.activeElement)||null===(e=j.current)||void 0===e||e.focus()}),[s]),u((()=>{var e;l||O("none"),l&&(z(!0),Y.current&&!Y.current.contains(document.activeElement)&&(null===(e=j.current)||void 0===e||e.focus()))}),[l]),p(v,(()=>({ref:Y,resetPlaceholder(){z(!1)},resetInput(){const[e="",r="",t=""]=U(s);F(e),E(r),B(t)},focusYearRef(){var e;null===(e=T.current)||void 0===e||e.focus()}})),[F,E,B,s]);const H=e=>{var r;e.preventDefault(),null===(r=j.current)||void 0===r||r.focus()},W=e=>{e.target.select();const r=e.target.name;O(r)},P=e=>{const[r,t,n]=a,i={[r]:w.current,[t]:C.current,[n]:A.current},o=e.target.name,s=i[o],l=o!==n?oi.padValue(s,!0):s;switch(o){case r:i[r]=l,F(l);break;case t:i[t]=l,E(l)}const d=`${i[n]}-${i[t]}-${i[r]}`,c=K(d,"YYYY-MM-DD",!0).isValid(),u=!i[r]&&!i[t]&&!i[n];c&&s!==l&&b(d),Y.current&&!Y.current.contains(e.relatedTarget)&&(O("none"),null==m||m(u||c))},N=e=>{var r,t;if(d)return;const n=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),o={day:D,month:$,year:S};switch(n){case a[0]:o.day=i,F(i),2===i.length&&(null===(r=R.current)||void 0===r||r.focus());break;case a[1]:o.month=i,E(i),2===i.length&&(null===(t=T.current)||void 0===t||t.focus());break;case a[2]:o.year=i,B(i)}if(!o.day&&!o.month&&!o.year)return void b("");const s=`${o.year}-${o.month}-${o.day}`;K(s,"YYYY-MM-DD",!0).isValid()&&b(s)},V=e=>{var r,t;"Backspace"!==e.code&&"Backspace"!==e.key||(k===a[1]&&0===$.length&&(null===(r=j.current)||void 0===r||r.focus()),k===a[2]&&0===S.length&&(null===(t=R.current)||void 0===t||t.focus()))};function U(e){if(e){const r=K(new Date(e));return r.isValid()?[oi.padValue(r.date().toString()),oi.padValue((r.month()+1).toString()),r.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Po,{role:"group","aria-label":g,onClick:()=>{var e;r||n||(z(!0),Y.current&&!Y.current.contains(document.activeElement)&&(null===(e=j.current)||void 0===e||e.focus()))},onFocus:e=>{r||(z(!0),l||null==h||h(e))},children:[e(No,{ref:Y,$hover:!!d,children:[t(Uo,{ref:j,name:a[0],maxLength:2,value:null!=_?_:D,onFocus:W,onBlur:P,onChange:N,type:"text",inputMode:x,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":y[0],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:k!==a[0]||n?"DD":""}),t(Jo,{$inactive:0===D.length,children:"/"}),t(Ko,{ref:R,name:a[1],maxLength:2,value:null!=I?I:$,onFocus:W,onBlur:P,onChange:N,onKeyDown:V,type:"text",inputMode:x,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":y[1],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:k!==a[1]||n?"MM":""}),t(Jo,{$inactive:0===$.length,children:"/"}),t(Zo,{ref:T,name:a[2],maxLength:4,value:null!=L?L:S,onFocus:W,onBlur:P,onChange:N,onKeyDown:V,type:"text",inputMode:x,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":y[2],disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:k!==a[2]||n?"YYYY":""})]}),(()=>{if(!s&&!n&&c)return t(qo,{$hide:M,$disabled:r,onMouseDown:H,children:c})})()]})})),Go=(e,r,t)=>{const n=[];e&&n.push(`[${e}]`),n.push(r,t),console.log(...n)},Qo=D(Ho)`
