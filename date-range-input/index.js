...
`,Ci=b.div`
    ...
    ${e=>e.$disabled?v`
            ...
            `:e.$hide?v`
                display: none;
            `:void 0}
`;_.extend(Tr);const zi=a.forwardRef((({disabled:n,readOnly:r,names:a,value:l,focused:s,hoverValue:c,placeholder:d,label:h,onChange:f,onFocus:g,onBlur:m,hideInputKeyboard:y},b)=>{const v=y?"none":"numeric",[D,$,S]=ia(""),[w,F,x]=ia(""),[B,O,H]=ia(""),[k,E]=o("none"),[M,A]=o(!1),j=i(null),Y=i(null),C=i(null),z=i(null),[L,R,T]=J(c);u((()=>{var e;const[t="",n="",r=""]=J(l);$(t),F(n),O(r),t||n||r||!j.current||!j.current.contains(document.activeElement)||null===(e=Y.current)||void 0===e||e.focus()}),[l]),u((()=>{s||E("none"),s&&(A(!0),Y.current&&j.current&&!j.current.contains(document.activeElement)&&Y.current.focus())}),[s]),p(b,(()=>({ref:j,resetPlaceholder(){A(!1)},resetInput(){const[e="",t="",n=""]=J(l);$(e),F(t),O(n)}})),[l]);const W=e=>{var t;e.preventDefault(),null===(t=Y.current)||void 0===t||t.focus()},N=e=>{e.target.select();const t=e.target.name;E(t)},P=e=>{const[t,n,r]=a,i={[t]:S.current,[n]:x.current,[r]:H.current},o=e.target.name,l=i[o],s=o!==r?aa.padValue(l,!0):l;switch(o){case t:i[t]=s,$(s);break;case n:i[n]=s,F(s)}const c=`${i[r]}-${i[n]}-${i[t]}`,d=_(c,"YYYY-MM-DD",!0).isValid(),u=!i[t]&&!i[n]&&!i[r];d&&l!==s&&f(c),j.current&&!j.current.contains(e.relatedTarget)&&(E("none"),null==m||m(u||d))},I=e=>{var t,n;if(c)return;const r=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),o={day:D,month:w,year:B};switch(r){case a[0]:o.day=i,$(i),2===i.length&&(null===(t=C.current)||void 0===t||t.focus());break;case a[1]:o.month=i,F(i),2===i.length&&(null===(n=z.current)||void 0===n||n.focus());break;case a[2]:o.year=i,O(i)}if(!o.day&&!o.month&&!o.year)return void f("");const l=`${o.year}-${o.month}-${o.day}`;_(l,"YYYY-MM-DD",!0).isValid()&&f(l)},V=e=>{var t,n;"Backspace"!==e.code&&"Backspace"!==e.key||(k===a[1]&&0===w.length&&(null===(t=Y.current)||void 0===t||t.focus()),k===a[2]&&0===B.length&&(null===(n=C.current)||void 0===n||n.focus()))};function J(e){if(e){const t=na.sanitizeInput(e);if(!t)return[void 0,void 0,void 0];const n=_(t,"YYYY-MM-DD",!0);return[aa.padValue(n.date().toString()),aa.padValue((n.month()+1).toString()),n.year().toString()]}return[void 0,void 0,void 0]}return e(Hi,Object.assign({role:"group","aria-label":h,onClick:()=>{n||r||(A(!0),Y.current&&j.current&&!j.current.contains(document.activeElement)&&Y.current.focus())},onFocus:e=>{n||(A(!0),s||null==g||g(e))}},{children:[e(ki,Object.assign({ref:j,$hover:!!c},{children:[t(Mi,{ref:Y,name:a[0],maxLength:2,value:null!=L?L:D,onFocus:N,onBlur:P,onChange:I,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[0]||r?"DD":""}),t(Yi,Object.assign({$inactive:0===D.length},{children:"/"})),t(Ai,{ref:C,name:a[1],maxLength:2,value:null!=R?R:w,onFocus:N,onBlur:P,onChange:I,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[1]||r?"MM":""}),t(Yi,Object.assign({$inactive:0===w.length},{children:"/"})),t(ji,{ref:z,name:a[2],maxLength:4,value:null!=T?T:B,onFocus:N,onBlur:P,onChange:I,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:n,readOnly:r,tabIndex:r?-1:0,autoComplete:"off",placeholder:k!==a[2]||r?"YYYY":""})]})),(()=>{if(!l&&!r&&d)return t(Ci,Object.assign({$hide:M,$disabled:n,onMouseDown:W},{children:d}))})()]}))})),Li=(e,t,n)=>{const r=[];e&&r.push(`[${e}]`),r.push(t,n),console.log(...r)},Ri=b(Bi)`
    ${e=>e.$wrap&&v`
