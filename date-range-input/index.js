...
`,_a=p.button`
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return v`
                ...
                `}}}
`,Ha=p((({color:r,className:n,size:a})=>e(za,{className:n,$size:a,$color:r,"data-testid":"component-loading-spinner",children:[t(Ya,{id:"inner1"}),t(ja,{id:"inner2"}),t(Ta,{id:"inner3"}),t(Ra,{id:"inner4"})]})))`
    margin-right: 0.5rem;
...
`,io=p.div`
    ...
    ${e=>e.$disabled?v`
            ...
            `:e.$hide?v`
                display: none;
            `:void 0}
`;N.extend(ua);const oo=a.forwardRef((({disabled:r,readOnly:n,names:a,value:s,focused:l,hoverValue:d,placeholder:c,label:g,onChange:h,onFocus:b,onBlur:f,hideInputKeyboard:y},p)=>{const v=y?"none":"numeric",[x,D,w]=Ma(""),[F,$,E]=Ma(""),[C,S,B]=Ma(""),[O,A]=o("none"),[M,z]=o(!1),k=i(null),Y=i(null),j=i(null),T=i(null),[R,_,H]=Z(d);u((()=>{var e;const[r="",t="",n=""]=Z(s);D(r),$(t),S(n),r||t||n||!k.current||!k.current.contains(document.activeElement)||null===(e=Y.current)||void 0===e||e.focus()}),[s]),u((()=>{var e;l||A("none"),l&&(z(!0),k.current&&!k.current.contains(document.activeElement)&&(null===(e=Y.current)||void 0===e||e.focus()))}),[l]),m(p,(()=>({ref:k,resetPlaceholder(){z(!1)},resetInput(){const[e="",r="",t=""]=Z(s);D(e),$(r),S(t)}})),[s]);const L=e=>{var r;e.preventDefault(),null===(r=Y.current)||void 0===r||r.focus()},I=e=>{e.target.select();const r=e.target.name;A(r)},W=e=>{const[r,t,n]=a,i={[r]:w.current,[t]:E.current,[n]:B.current},o=e.target.name,s=i[o],l=o!==n?Aa.padValue(s,!0):s;switch(o){case r:i[r]=l,D(l);break;case t:i[t]=l,$(l)}const d=`${i[n]}-${i[t]}-${i[r]}`,c=N(d,"YYYY-MM-DD",!0).isValid(),u=!i[r]&&!i[t]&&!i[n];c&&s!==l&&h(d),k.current&&!k.current.contains(e.relatedTarget)&&(A("none"),null==f||f(u||c))},P=e=>{var r,t;if(d)return;const n=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),o={day:x,month:F,year:C};switch(n){case a[0]:o.day=i,D(i),2===i.length&&(null===(r=j.current)||void 0===r||r.focus());break;case a[1]:o.month=i,$(i),2===i.length&&(null===(t=T.current)||void 0===t||t.focus());break;case a[2]:o.year=i,S(i)}if(!o.day&&!o.month&&!o.year)return void h("");const s=`${o.year}-${o.month}-${o.day}`;N(s,"YYYY-MM-DD",!0).isValid()&&h(s)},V=e=>{var r,t;"Backspace"!==e.code&&"Backspace"!==e.key||(O===a[1]&&0===F.length&&(null===(r=Y.current)||void 0===r||r.focus()),O===a[2]&&0===C.length&&(null===(t=j.current)||void 0===t||t.focus()))};function Z(e){if(e){const r=N(new Date(e));return r.isValid()?[Aa.padValue(r.date().toString()),Aa.padValue((r.month()+1).toString()),r.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Gi,{role:"group","aria-label":g,onClick:()=>{var e;r||n||(z(!0),k.current&&!k.current.contains(document.activeElement)&&(null===(e=Y.current)||void 0===e||e.focus()))},onFocus:e=>{r||(z(!0),l||null==b||b(e))},children:[e(Qi,{ref:k,$hover:!!d,children:[t(ro,{ref:Y,name:a[0],maxLength:2,value:null!=R?R:x,onFocus:I,onBlur:W,onChange:P,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[0]}-input`,"aria-label":"day",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[0]||n?"DD":""}),t(ao,{$inactive:0===x.length,children:"/"}),t(to,{ref:j,name:a[1],maxLength:2,value:null!=_?_:F,onFocus:I,onBlur:W,onChange:P,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{2}","data-testid":`${a[1]}-input`,"aria-label":"month",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[1]||n?"MM":""}),t(ao,{$inactive:0===F.length,children:"/"}),t(no,{ref:T,name:a[2],maxLength:4,value:null!=H?H:C,onFocus:I,onBlur:W,onChange:P,onKeyDown:V,type:"text",inputMode:v,pattern:"[0-9]{4}","data-testid":`${a[2]}-input`,"aria-label":"year",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:O!==a[2]||n?"YYYY":""})]}),(()=>{if(!s&&!n&&c)return t(io,{$hide:M,$disabled:r,onMouseDown:L,children:c})})()]})})),so=(e,r,t)=>{const n=[];e&&n.push(`[${e}]`),n.push(r,t),console.log(...n)},lo=p(qi)`
    ${e=>e.$wrap&&v`
