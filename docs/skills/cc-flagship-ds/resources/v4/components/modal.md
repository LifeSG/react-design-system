...
| ----------------------- | ---------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------ |
| `show`                  | `boolean`                                | —          | Controls visibility — **required**                                                                                       |
| `children`              | `JSX.Element`                            | —          | Modal content; parent element must be a valid HTML element or component that forwards a ref. Fragments are not supported |
| `animationFrom`         | `"top" \| "bottom" \| "left" \| "right"` | `"bottom"` | Slide-in direction                                                                                                       |
| `enableOverlayClick`    | `boolean`                                | —          | Allow clicking the overlay to dismiss                                                                                    |
| `onOverlayClick`        | `() => void`                             | —          | Called when the overlay is clicked; requires `enableOverlayClick: true`                                                  |
| `zIndex`                | `number`                                 | —          | Custom z-index (useful for stacked modals)                                                                               |
| `rootComponentId`       | `string`                                 | —          | ID of the element to portal the modal into; defaults to `<body>`                                                         |
| `dismissKeyboardOnShow` | `boolean`                                | `true`     | Dismiss mobile keyboard when modal opens                                                                                 |
