...
| `variant`              | `"flexible" \| "fixed"`                      | `"flexible"` | The variant of the rendered timeslot bars                                                          |
| `interval`             | `number`                                     | `30`         | Duration each cell represents in minutes                                                           |
| `startTime`            | `string`                                     | —            | Minimum time displayed (`HH:mm`; full hours only, e.g. `"08:00"`)                                  |
| `endTime`              | `string`                                     | —            | Maximum time displayed (`HH:mm`; full hours only)                                                  |
...
| `maxVisibleCellHeight` | `number`                                     | —            | Maximum combined cell height before truncation                                                     |
