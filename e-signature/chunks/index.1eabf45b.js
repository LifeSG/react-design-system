...
`,Sn=d.canvas`
    cursor: crosshair;
`,wn=c((()=>v(void 0,void 0,void 0,(function*(){return{default:(yield import("./e-signature-canvas.9b523a12.js")).ESignatureCanvas}})))),Fn=i=>{const{description:c,id:d,loadingProgress:f,loadingLabel:h="Uploading...",onChange:p,value:g}=i,m=y(i,["description","id","loadingProgress","loadingLabel","onChange","value"]),[v,b]=a(!1),$=s(null),[x,S]=a(g),w=F.useMediaQuery({maxWidth:Rt.mobileL}),D=()=>{$.current.clear()},B=()=>{const e=$.current.export();S(e),b(!1),null==p||p(e)};l((()=>{S(g)}),[g]);return e("div",Object.assign({},m,{children:[t(an,{children:isNaN(f)?x?e(r,{children:[t(cn,{src:x,alt:"Signature preview"}),t(ln,Object.assign({styleType:"light",onClick:()=>b(!0),id:d,"aria-label":"Edit signature"},{children:t(n,{})}))]}):t(sn,Object.assign({type:"button",styleType:"secondary","aria-label":"Add signature",id:d,onClick:()=>b(!0)},{children:"Add signature"})):e(un,{children:[h&&t(ir.BodySmall,{children:h}),t(yr,{progress:f,"data-testid":`${d||"e-signature"}-progress-bar`})]})}),t(fn,Object.assign({"data-testid":"signature-modal",show:v},{children:t(hn,{children:e(pn,Object.assign({onClose:()=>b(!1)},{children:[t(gn,{children:"Signature"}),t(mn,{children:e(yn,{children:[t(vn,{}),t(u,Object.assign({fallback:null},{children:v&&t(wn,{ref:$,baseImageDataURL:x})}))]})}),e(bn,{children:[t($n,Object.assign({as:mr.Default,type:"button",styleType:w?"light":"link",icon:t(o,{}),onClick:D},{children:"Clear"})),t($n,Object.assign({type:"button",onClick:B},{children:"Save"}))]})]}))})})),c?t(dn,Object.assign({weight:"regular",as:"p"},{children:c})):null]}))};export{Pt as C,Fn as E,xn as S,Mt as T,v as _,Sn as a,x as g};
//# sourceMappingURL=index.1eabf45b.js.map
