...
/*!**************************************************************************************!*\
    ...
    `,ElevationBoxShadow:f`
      0px 2px 8px ${Wt.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Yt=e=>t=>{var n;const r=t.theme,o=At(Rt,r[Pt.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?zt(o,e,r.options.designToken):zt(o,e)},Vt={InputBoxShadow:Yt("InputBoxShadow"),InputErrorBoxShadow:Yt("InputErrorBoxShadow"),ElevationBoxShadow:Yt("ElevationBoxShadow"),Table:{Header:Yt("Table.Header"),Cell:{Primary:Yt("Table.Cell.Primary"),Secondary:Yt("Table.Cell.Secondary"),Selected:Yt("Table.Cell.Selected"),Hover:Yt("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Yt("Button.Danger.BackgroundColor"),Hover:Yt("Button.Danger.Hover"),Primary:Yt("Button.Danger.Primary"),Border:Yt("Button.Danger.Border")}}},Nt={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},Jt=e=>Object.keys(Nt).reduce(((t,n)=>{const r=Nt[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),Zt=Jt("max-width"),Ut=(Jt("min-width"),Nt),qt=d.div`
...
`,vn=n=>{var{external:r=!1,children:o}=n,i=$(n,["external","children"]);return e(mn,Object.assign({},i,{children:[o,r&&t(yn,{})]}))};var bn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(bn||(bn={}));const Sn=d.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return f`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Vt.Button.Danger.Border:Wt.Primary};

                    color: ${e.$buttonIsDanger?Vt.Button.Danger.Primary:Wt.Primary};
                `;case"light":return f`
                    background-color: ${Wt.Neutral[8]};
                ...
                `;case"link":return f`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Vt.Button.Danger.Hover:Wt.Secondary};
                    }
                `;default:return f`
                    background-color: ${e.$buttonIsDanger?Vt.Button.Danger.BackgroundColor:Wt.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?f`
                ...
                `}
`,$n=d((({color:n,className:r,size:o=18})=>e(qt,Object.assign({className:r,$size:o,$color:n,"data-testid":"component-loading-spinner"},{children:[t(Qt,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(Gt,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(Kt,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(en,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    ${e=>{let t=e.$buttonIsDanger?Vt.Button.Danger.Primary:Wt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Wt.Neutral[3](e);break;default:t=Wt.Neutral[8](e)}return f`
...
`,Kn=d.div`
    ...
    ${e=>{let t="";return e.$show?t+=f`
            ...
            `,e.$disableTransition&&(t+=f`
                transition: none;
            `),t}}
`;var er;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(er||(er={}));const tr=({show:e=!1,rootId:n,onOverlayClick:r,children:o,backgroundOpacity:c,backgroundBlur:u=!0,disableTransition:d=!1,enableOverlayClick:f=!1,zIndex:h,id:p})=>{const[m,S]=s(null),[$,F]=s(),[x]=s((()=>Xn.generate())),w=y(),D=l(),B=l(null),O=o&&i.cloneElement(o,{ref:B}),k=p?`lifesg-ds-overlay-root-${p}`:"lifesg-ds-overlay-root",E=null!=h?h:$?99999:99998;(e=>{const t=g();a((()=>{if(!t)return;const n={zIndex:e};t.events.emit(er.Change,n)}),[t,e]),a((()=>{if(!t)return;const n=()=>{const n={zIndex:e};t.events.emit(er.Change,n)};return null==t||t.events.on(er.Ready,n),()=>null==t?void 0:t.events.off(er.Ready,n)}),[t,e])})(E),a((()=>(T(),S(C()),()=>{P(),z().length<1&&(I("remove"),W(),M("remove"))})),[]),a((()=>{if(e){const e=_();H(e),A(),j()&&1===z().length&&(L(),I("add"));const t=setTimeout((()=>{M("add")}),200);return()=>clearTimeout(t)}{P(),j()&&z().length<1&&(I("remove"),W());const e=setTimeout((()=>{z().length<1&&M("remove")}),200);return()=>clearTimeout(e)}}),[e]);const H=e=>{D.current=e,F(e)},j=()=>/(iPad|iPhone|iPod)/g.test(navigator.userAgent),C=()=>document&&n?document.getElementById(n):document?document.body:null,_=()=>z().length>0,T=()=>{if(!document.getElementById(rr)){const e=document.createElement("style");e.id=rr;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${or} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${or}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\n\t\t\t\t.${ir} {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: var(${ar}, 0);\n\t\t\t\t\tbottom: 0;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},M=e=>{const t=document.body.classList.contains(or);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(or):document.body.classList.add(or)},z=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},A=()=>{const e=z();document.body.dataset.lifesgDsOverlayOrder=[...e,x].join(",")},P=()=>{const e=z();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==x)).join(",")},I=e=>{if(!j())return;const t=document.body.classList.contains(ir);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(ir):document.body.classList.add(ir)},L=()=>{const e=document.body.style,t=e.top?e.top:window.scrollY+"px";document.body.style.setProperty(ar,t)},W=()=>{const e=document.body.style.getPropertyValue(ar);requestAnimationFrame((()=>{window.scrollTo({top:parseFloat(e)})}))},R=e=>{var t;const n=null===(t=B.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||r&&f&&(e.preventDefault(),r())};return m?b.createPortal(t(Gn,Object.assign({id:k,"data-testid":k,$show:e,$zIndex:E},{children:o&&t(v,Object.assign({id:w},{children:t(Kn,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:c||($?.5:.8),$backgroundBlur:u,$disableTransition:d,onClick:R},{children:O}))}))})),m):null},nr=e=>t(m,{children:t(tr,Object.assign({},e))}),rr="lifesg-ds-overlay-stylesheet",or="lifesg-ds-overlay-open",ir="lifesg-ds-overlay-scroll-lock",ar="--lifesg-ds-overlay-scroll-y",sr=d.div`
    position: relative;
    display: flex;
    justify-content: center;
    align-items: center;
...
`,cr=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:o=!0,focusOutline:i="none",type:a="button"}=e,s=$(e,["children","focusHighlight","focusOutline","type"]);return t(lr,Object.assign({ref:n,$outline:i,$highlight:o,type:a},s,{children:r}))})),ur=d.div`
    position: relative;
    display: flex;
...
`,jr=d.canvas`
    cursor: crosshair;
`,Cr=c((()=>F(void 0,void 0,void 0,(function*(){return{default:(yield import("./e-signature-canvas.096853db.js")).ESignatureCanvas}})))),_r=i=>{const{description:c,id:d,loadingProgress:f,loadingLabel:h="Uploading...",onChange:p,value:g}=i,m=$(i,["description","id","loadingProgress","loadingLabel","onChange","value"]),[y,v]=s(!1),b=l(null),[S,F]=s(g),x=O.useMediaQuery({maxWidth:Ut.mobileL}),w=()=>{var e;null===(e=b.current)||void 0===e||e.clear()},D=()=>{var e;if(b.current){const t=null===(e=b.current)||void 0===e?void 0:e.export();F(t),v(!1),null==p||p(t)}};a((()=>{F(g)}),[g]);return e("div",Object.assign({},m,{children:[t(gr,{children:isNaN(f)?S?e(n,{children:[t(vr,{src:S,alt:"Signature preview"}),t(yr,Object.assign({styleType:"light",onClick:()=>v(!0),id:d,"aria-label":"Edit signature"},{children:t(r,{})}))]}):t(mr,Object.assign({type:"button",styleType:"secondary","aria-label":"Add signature",id:d,onClick:()=>v(!0)},{children:"Add signature"})):e(br,{children:[h&&t(gn.BodySmall,{children:h}),t(wn,{progress:f,"data-testid":`${d||"e-signature"}-progress-bar`})]})}),t($r,Object.assign({"data-testid":"signature-modal",show:y},{children:t(Fr,{children:e(xr,Object.assign({onClose:()=>v(!1)},{children:[t(wr,{children:"Signature"}),t(Dr,{children:e(Br,{children:[t(Or,{}),t(u,Object.assign({fallback:null},{children:y&&t(Cr,{ref:b,baseImageDataURL:S})}))]})}),e(kr,{children:[t(Er,Object.assign({as:xn.Default,type:"button",styleType:x?"light":"link",icon:t(o,{}),onClick:w},{children:"Clear"})),t(Er,Object.assign({type:"button",onClick:D},{children:"Save"}))]})]}))})})),c?t(Sr,Object.assign({weight:"regular",as:"p"},{children:c})):null]}))};export{Wt as C,_r as E,Hr as S,Pt as T,F as _,jr as a};
//# sourceMappingURL=index.60731ca5.js.map
