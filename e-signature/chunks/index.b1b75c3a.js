...
`,_=c.div`
    ...
    animation: ${k} 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
`,M=c(_)`
...
`,fn=(t,n)=>{const{children:i,disabled:o=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:d="left",loading:u=!1}=t,c=F(t,["children","disabled","styleType","danger","icon","iconPosition","loading"]),g={$buttonIconPosition:d,$buttonStyle:o?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(mn,Object.assign({ref:n,"data-testid":c["data-testid"]||"button-with-icon",disabled:o},g,c,{children:[u?r(T,{}):l,r("span",{children:i})]}))};fn.displayName="ButtonWithIcon.Default";const yn=(t,n)=>{const{children:i,disabled:o=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:d="left",loading:u=!1}=t,c=F(t,["children","disabled","styleType","danger","icon","iconPosition","loading"]),g={$buttonIconPosition:d,$buttonStyle:o?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(mn,Object.assign({ref:n,"data-testid":c["data-testid"]||"button-with-icon",disabled:o},g,c,{children:[u?r(T,{}):l,r("span",{children:i})]}))};yn.displayName="ButtonWithIcon.Small";const pn={Default:o.forwardRef(fn),Small:o.forwardRef(yn)},vn=({className:e,progress:t,color:n,"data-testid":i})=>r(xn,{className:e,$innerWidth:t,$color:n,"data-testid":i,children:r("progress",{value:100*t,max:100})}),xn=c.div`
    position: relative;
    width: 100%;
    height: 8px;
...
`}
    ...
    color: ${Ht.text};
`;var En;!function(t){const n=(e,r,t)=>{const n=c(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${e=>$n(r,e)}
        ...
        `;return t.displayName=`Typography.${r}`,t};t.BodyBL=i("body-baseline","BodyBL"),t.BodyMD=i("body-md","BodyMD"),t.BodySM=i("body-sm","BodySM"),t.BodyXS=i("body-xs","BodyXS");const o=(t,n)=>{const i=c.a`
            ...
            `}
        `,o=t=>{var{external:n=!1,children:o}=t,a=F(t,["external","children"]);return e(i,Object.assign({},a,{children:[o,n&&r(Cn,{})]}))};return o.displayName=`Typography.${n}`,o};t.LinkBL=o("body-baseline","LinkBL"),t.LinkMD=o("body-md","LinkMD"),t.LinkSM=o("body-sm","LinkSM"),t.LinkXS=o("body-xs","LinkXS")}(En||(En={}));const Cn=c(m)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
...
`,Gn=c.div`
    ...
    ${e=>{let r="";return e.$show?r+=h`
            ...
            `,e.$disableTransition&&(r+=h`
                transition: none;
            `),r}}
`;var Kn;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Kn||(Kn={}));const ei=({show:e=!1,rootId:t,onOverlayClick:n,children:i,backgroundOpacity:d,backgroundBlur:u=!0,disableTransition:c=!1,enableOverlayClick:g=!1,zIndex:h,id:b})=>{const[m,y]=s(null),[w,F]=s(),[$]=s((()=>Xn.generate())),E=p(),C=l(),D=l(null),B=i&&o.cloneElement(i,{ref:D}),O=b?`lifesg-ds-overlay-root-${b}`:"lifesg-ds-overlay-root",A=null!=h?h:w?99999:99998;(e=>{const r=f();a((()=>{if(!r)return;const t={zIndex:e};r.events.emit(Kn.Change,t)}),[r,e]),a((()=>{if(!r)return;const t=()=>{const t={zIndex:e};r.events.emit(Kn.Change,t)};return null==r||r.events.on(Kn.Ready,t),()=>null==r?void 0:r.events.off(Kn.Ready,t)}),[r,e])})(A),a((()=>(M(),y(k()),()=>{L(),j().length<1&&z("remove")})),[]),a((()=>{if(e){const e=_();S(e),T();const r=setTimeout((()=>{z("add")}),200);return()=>clearTimeout(r)}{L();const e=setTimeout((()=>{j().length<1&&z("remove")}),200);return()=>clearTimeout(e)}}),[e]);const S=e=>{C.current=e,F(e)},k=()=>document&&t?document.getElementById(t):document?document.body:null,_=()=>j().length>0,M=()=>{if(!document.getElementById(ti)){const e=document.createElement("style");e.id=ti;const r=document.documentElement.clientWidth,t=window.innerWidth-r;e.innerHTML=`\n\t\t\t\t.${ni} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${t}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${ni}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},z=e=>{const r=document.body.classList.contains(ni);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(ni):document.body.classList.add(ni)},j=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},T=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=[...e,$].join(",")},L=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==$)).join(",")},I=e=>{var r;const t=null===(r=D.current)||void 0===r?void 0:r.firstChild;t&&t.contains(e.target)||n&&g&&(e.preventDefault(),n())};return m?x.createPortal(r(Jn,{id:O,"data-testid":O,$show:e,$zIndex:A,children:i&&r(v,{id:E,children:r(Gn,{"data-testid":"overlay-wrapper",$show:e,$stacked:w,$backgroundBlur:u,$disableTransition:c,onClick:I,children:B})})}),m):null},ri=e=>r(y,{children:r(ei,Object.assign({},e))}),ti="lifesg-ds-overlay-stylesheet",ni="lifesg-ds-overlay-open",ii=c.div`
    position: relative;
    display: flex;
    justify-content: center;
    align-items: center;
...
`,ai=o.forwardRef(((e,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=F(e,["children","focusHighlight","focusOutline","type"]);return r(oi,Object.assign({ref:t,$outline:o,$highlight:i,type:a},s,{children:n}))})),si=c.div`
    position: relative;
    display: flex;
...
`,Oi=c.canvas`
    cursor: crosshair;
`,Ai=d((()=>$(void 0,void 0,void 0,(function*(){return{default:(yield import("./e-signature-canvas.31c31ef3.js")).ESignatureCanvas}})))),Si=o=>{const{description:d,id:c,loadingProgress:g,loadingLabel:h="Uploading...",onChange:m,value:f,disabled:y}=o,p=F(o,["description","id","loadingProgress","loadingLabel","onChange","value","disabled"]),[v,x]=s(!1),w=l(null),[$,E]=s(f),C=b(),D=Xt["sm-max"]({theme:C}),B=A.useMediaQuery({maxWidth:D}),O=A.useMediaQuery({maxHeight:D,orientation:"landscape"}),S=()=>{var e;null===(e=w.current)||void 0===e||e.clear()},k=()=>{if(w.current){const e=w.current.export();E(e),x(!1),null==m||m(e)}};a((()=>{E(f)}),[f]);return e("div",Object.assign({},p,{children:[r(gi,{$disabled:y,children:"number"==typeof g?e(fi,{children:[h&&r(En.BodyMD,{children:h}),r(vn,{progress:null!=g?g:0,"data-testid":`${c||"e-signature"}-progress-bar`})]}):$?e(t,{children:[r(mi,{src:$,alt:"Signature preview"}),r(bi,{styleType:"light",onClick:()=>x(!0),id:c,"aria-label":"Edit signature",disabled:y,children:r(n,{})})]}):r(hi,{type:"button",styleType:"secondary","aria-label":"Add signature",id:c,onClick:()=>x(!0),disabled:y,children:"Add signature"})}),r(pi,{"data-testid":"signature-modal",show:v,children:r(vi,{children:e(xi,{onClose:()=>x(!1),children:[r(wi,{children:"Signature"}),r(Fi,{children:e($i,{children:[r(Ei,{}),r(u,{fallback:null,children:v&&r(Ai,{ref:w,baseImageDataURL:$})})]})}),e(Ci,{children:[r(Di,{as:O?pn.Small:pn.Default,type:"button",styleType:B&&!O?"light":"link",icon:r(i,{}),onClick:S,children:"Clear"}),r(Di,{as:O?bn.Small:bn.Default,type:"button",onClick:k,children:"Save"})]})]})})}),d?r(yi,{children:d}):null]}))};export{Ht as C,Si as E,Bi as S,$ as _,Oi as a,D as g};
//# sourceMappingURL=index.b1b75c3a.js.map
