import i,{css as t}from"styled-components";import{Button as e}from"../button/button.js";import{IconButton as o}from"../icon-button/icon-button.js";import{Modal as a}from"../modal/index.js";import{MediaQuery as n,Breakpoint as r,Colour as d,Border as s,Radius as g,Spacing as c,Font as p}from"../theme/index.js";import{Typography as h}from"../typography/typography.js";const l=t`
    ${i=>`\n        ${n.MaxWidth.sm(i)},\n        (orientation: landscape) and (max-height: ${r["sm-max"](i)}px)\n    `}
`,m=t`
    ${i=>`\n        @media (orientation: landscape) and (max-height: ${r["sm-max"](i)}px)\n    `}
`,$=i.div`
    position: relative;
    display: flex;
    align-items: center;
...
`,X=i.canvas`
    cursor: crosshair;
`;export{b as AddSignatureButton,M as ESignatureContainer,W as ESignatureDrawable,u as EditSignatureButton,v as GrowContainer,w as Instructions,S as ModalActionButton,j as ModalBox,D as ModalButtons,k as ModalTitle,f as ProgressBox,y as ScrollableModal,$ as SignatureArea,X as SignatureCanvas,U as SignatureCanvasContainer,B as SignatureLine,x as SignaturePreviewImage};
