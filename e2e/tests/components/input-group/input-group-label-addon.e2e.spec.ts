...
test.describe("Input Group Label", () => {
    test.describe(() => {
        ...
        test("Accessibility", async ({ story }) => {
            await expect(story.locators.formLabelDefault).toMatchAriaSnapshot(`
            ...
            await expect(story.locators.formLabelDefaultRight)
                ...
                - textbox "Default (Right Label) kg":
                    - /placeholder: Enter an amount          
                `);
            await expect(
            ...
            await expect(story.locators.formLabelDisabled).toMatchAriaSnapshot(`
            ...
            await expect(story.locators.formLabelReadonly).toMatchAriaSnapshot(`
            ...
            await expect(story.locators.formLabelError).toMatchAriaSnapshot(`
    ...
    test.describe(() => {
        ...
        test("Standalone visual", async ({ story }) => {
            await compareScreenshot(story, "mount");
        });
    });
});
