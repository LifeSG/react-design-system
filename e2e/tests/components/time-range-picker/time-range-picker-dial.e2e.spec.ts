    ...
    test.describe(() => {
        ...
        test("Dropdown", async ({ story }) => {
            ...
            await test.step('Hover on "PM" button', async () => {
                await story.locators.dropdownPMButton
                    .getByTestId("toggle-input")
                    .hover();
            ...
            await test.step('Hover on "Cancel" button', async () => {
                await story.locators.dropdownCancelButton.hover();
                await compareScreenshot(story, "cancel-button-hover");
            });

            await test.step('Hover on "Done" button', async () => {
                await story.locators.incrementHourButton.click();
                await story.locators.incrementMinuteButton.click();
                await story.locators.dropdownDoneButton.hover();
