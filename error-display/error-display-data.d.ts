...
export declare const generateErrorDisplayData: (ImgPathsObject: Record<string, ErrorDisplayImagePathAttributes>, mobile: string, tablet: string) => Map<ErrorDisplayType, ErrorDisplayDataAttrs>;
export declare const getErrorDisplayData: (type: ErrorDisplayType, resourceScheme: ThemeType, mobile: string, tablet: string) => ErrorDisplayDataAttrs | undefined;
export {};
