...
`,lr=n((({color:e,className:r,size:n=18})=>t(Nt,{className:r,$size:n,$color:e,children:[i(Ot,{id:"inner1",$size:n-2,$borderWidth:2}),i(Pt,{id:"inner2",$size:n-2,$borderWidth:2}),i(jt,{id:"inner3",$size:n-2,$borderWidth:2}),i(It,{id:"inner4",$size:n-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Ct.Primary(e);break;case"disabled":t=Ct.Neutral[3](e);break;default:t=Ct.Neutral[8](e)}return a`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,pr=n.div`
    ...
    color: ${Ct.Neutral[1]}; // Follow styling of Text.Body
    text-align: center;
...
`,ur=({type:e,img:r,title:n,description:o,actionButton:a,additionalProps:l,...s})=>{const c=y.get(e),g=s["data-testid"]||"error-display",d=()=>{switch(e){case"maintenance":{const e=l;return l&&e.dateString?c.renderDescription(e):o||void 0}case"500":{const e=l;return l&&e.referenceId?c.renderDescription(e):o||void 0}default:return o||void 0}};if(!c)return null;const h={...c,...r&&{img:r},...n&&{title:n},...d()&&{description:d()}};return t(cr,{...s,"data-testid":g,children:[i(gr,{...h.img,alt:""}),t(dr,{children:[i(hr,{"data-testid":`${g}--title`,children:h.title}),i(pr,{"data-testid":`${g}--description`,children:"string"==typeof h.description?i("p",{children:h.description}):h.description})]}),a&&(()=>{const e={children:"Proceed",...a};return i(fr,{...e})})()]})};export{ur as ErrorDisplay};
