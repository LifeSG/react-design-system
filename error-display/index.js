...
`,sr=t=>{var{external:s=!1,children:i}=t,n=l(t,["external","children"]);return e(tr,Object.assign({},n,{children:[i,s&&r(rr,{})]}))};var ir;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(ir||(ir={}));const nr={collections:{base:{InputBoxShadow:n`
	...
	${e=>"small"===e.$buttonSizeStyle?n`
                ...
                `}
`,lr=s((({color:t,className:s,size:i=18})=>e(It,Object.assign({className:s,$size:i,$color:t},{children:[r(Wt,{id:"inner1",$size:i-2,$borderWidth:2,$color:t}),r(Lt,{id:"inner2",$size:i-2,$borderWidth:2,$color:t}),r(Nt,{id:"inner3",$size:i-2,$borderWidth:2,$color:t}),r(Rt,{id:"inner4",$size:i-2,$borderWidth:2,$color:t})]}))))`
    margin-right: 0.5rem;
