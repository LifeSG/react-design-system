...
export declare type ErrorDisplayType = "400" | "403" | "404" | "408" | "500" | "503" | "maintenance" | "unsupported-browser" | "partially-supported-browser";
...
export interface ErrorDisplayAttributes {
    ...
    additionalProps?: MaintenanceAdditionalAttributes | Error500AdditionalAttributes | undefined;
}
