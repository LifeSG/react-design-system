...
export declare const SubmitButton: import("styled-components").StyledComponent<(props: import("src/button").ButtonProps & import("react").RefAttributes<HTMLButtonElement>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>, any, {}, never>;
