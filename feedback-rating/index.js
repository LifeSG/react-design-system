...
`,fr=n.button`
	...
	${e=>"small"===e.$buttonSizeStyle?i`
                ...
                `}
`,mr=n((({color:e,className:n,size:i=18})=>t(dr,{className:n,$size:i,$color:e,children:[r(gr,{id:"inner1",$size:i-2,$borderWidth:2}),r(sr,{id:"inner2",$size:i-2,$borderWidth:2}),r(ur,{id:"inner3",$size:i-2,$borderWidth:2}),r(pr,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Nt.Primary(e);break;case"disabled":t=Nt.Neutral[3](e);break;default:t=Nt.Neutral[8](e)}return i`
        ...
        `}}
`,yr={Default:o.forwardRef(((e,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:l="default",...c}=e,d={$buttonStyle:a?"disabled":l,$buttonSizeStyle:"default"};return t(fr,{ref:n,"data-testid":c["data-testid"]||"button",disabled:a,...d,...c,children:[o&&r(mr,{...d}),r("span",{children:i})]})})),Small:o.forwardRef(((e,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:l="default",...c}=e,d={$buttonStyle:a?"disabled":l,$buttonSizeStyle:"small"};return t(fr,{ref:n,"data-testid":c["data-testid"]||"button",disabled:a,...d,...c,children:[o&&r(mr,{...d,size:16}),r("span",{children:i})]})}))},Fr=n.img`
    width: 9.5rem;
    height: 9.5rem;
    margin: 0 1rem;
    @media screen and (max-width: 38rem) {
