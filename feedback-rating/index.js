...
`,hn={collections:{base:{InputBoxShadow:r`
	...
	${e=>"small"===e.$buttonSizeStyle?r`
                ...
                `}
`,pn=n((({color:n,className:r,size:a=18})=>e(on,Object.assign({className:r,$size:a,$color:n},{children:[t(cn,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(dn,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(gn,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(sn,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Fn.Button.Danger.Primary:jt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=jt.Neutral[3](e);break;default:t=jt.Neutral[8](e)}return r`
        ...
        `}}
`,mn={Default:c.forwardRef(((n,r)=>{const{children:a,disabled:o=!1,loading:i=!1,styleType:l="default",danger:c=!1}=n,g=d(n,["children","disabled","loading","styleType","danger"]),s={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"default",$buttonIsDanger:c};return e(fn,Object.assign({ref:r,"data-testid":g["data-testid"]||"button",disabled:o},s,g,{children:[i&&t(pn,Object.assign({},s)),t("span",{children:a})]}))})),Small:c.forwardRef(((n,r)=>{const{children:a,disabled:o=!1,loading:i=!1,styleType:l="default",danger:c=!1}=n,g=d(n,["children","disabled","loading","styleType","danger"]),s={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"small",$buttonIsDanger:c};return e(fn,Object.assign({ref:r,"data-testid":g["data-testid"]||"button",disabled:o},s,g,{children:[i&&t(pn,Object.assign({},s,{size:16})),t("span",{children:a})]}))}))},Sn=n.img`
    width: 9.5rem;
    height: 9.5rem;
    margin: 0 1rem;
    @media screen and (max-width: 38rem) {
...
`,bn=n(mn.Default)`
    margin-top: 1rem;
    width: 100%;
`,Dn=n=>{const{imgSrc:r,buttonLabel:a,description:o,rating:i,onRatingChange:l,onSubmit:c}=n,g=d(n,["imgSrc","buttonLabel","description","rating","onRatingChange","onSubmit"]),s=null!=r?r:Xt,h=null!=o?o:Mt;return e(Bn,Object.assign({},g,{children:[s&&t(Sn,{src:s,alt:"","aria-label":"banner image",onError:e=>e.currentTarget.style.display="none"}),e(yn,{children:[t(Rt.H3,Object.assign({weight:"semibold"},{children:h})),t(tn,{description:h,rating:i,onRatingChange:l}),t(bn,Object.assign({disabled:!i,onClick:c,type:"button"},{children:null!=a?a:Gt}))]})]}))};export{Dn as FeedbackRating};
