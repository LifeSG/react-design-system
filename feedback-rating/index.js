...
`,fr=n.button`
	...
	${e=>"small"===e.$buttonSizeStyle?i`
                ...
                `}
`,mr=n((({color:e,className:n,size:i=18})=>t(dr,{className:n,$size:i,$color:e,children:[r(sr,{id:"inner1",$size:i-2,$borderWidth:2}),r(gr,{id:"inner2",$size:i-2,$borderWidth:2}),r(ur,{id:"inner3",$size:i-2,$borderWidth:2}),r(pr,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
