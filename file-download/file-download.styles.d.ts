...
export declare const Title: import("styled-components").StyledComponent<"h4", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const ListWrapper: import("styled-components").StyledComponent<"ul", import("styled-components").DefaultTheme, {}, never>;
export {};
