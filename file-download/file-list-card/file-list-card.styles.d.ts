...
export declare const ItemText: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../../v2_text").V2_TextProps, never>;
export declare const ItemDescriptionText: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../../v2_text").V2_TextProps, never>;
export declare const BaseErrorMessage: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../../v2_text").V2_TextProps, never>;
export declare const DesktopErrorMessage: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../../v2_text").V2_TextProps, never>;
export declare const MobileErrorMessage: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../../v2_text").V2_TextProps, never>;
