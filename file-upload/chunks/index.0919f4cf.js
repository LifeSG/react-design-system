...
`,Iu=_.span`
    ...
    display: block;
`,Fu=r=>{var{children:n,addon:o,subtitle:i,"data-testid":a}=r,s=lt(r,["children","addon","subtitle","data-testid"]);return e(Eu,Object.assign({},s,{children:[n,o&&o.type&&("popover"===(null==o?void 0:o.type)?t(Ou,{addon:o}):null),"string"==typeof i?t(Iu,Object.assign({"data-testid":a?`${a}-subtitle`:"subtitle"},s,{children:i})):i]}))},Mu=_.div`
    position: relative;
...
`,pd=({color:r,className:n,size:o})=>e(ld,{className:n,$size:o,$color:r,"data-testid":"component-loading-spinner",children:[t(ud,{id:"inner1"}),t(dd,{id:"inner2"}),t(fd,{id:"inner3"}),t(hd,{id:"inner4"})]}),gd=_.button`
...
`,Nd=_.div`
    ...
    ${({$variant:e,$interactive:t})=>{if(t)return"selected-year"===e?O`
        ...
        `}}
`,Hd=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:o,viewCalendarDate:i,isNewSelection:s,minDate:l,maxDate:c,allowDisabledSelection:u,onYearSelect:d})=>{const f=a((()=>Rc.generateDecadeOfYears(Dc(e))),[e]),h=e=>{const t="start"===r&&o&&e.isAfter(o,"year")&&s,i="end"===r&&n&&e.isBefore(n,"year")&&s;return!(!t&&!i)},p=e=>{const t=[0,11].includes(f.indexOf(e)),r=e.year(),n=(o=e,!Rc.isWithinRange(o,l?Dc(l):void 0,c?Dc(c):void 0,"year"));var o;const a=t?"other-decade":i.isSame(e,"year")?"selected-year":Dc().isSame(e,"year")?"current-year":"default";return{disabledDisplay:n||h(e),interactive:!n||u,year:r,variant:a}};return f.length?t(Ld,{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:o,year:i}=p(e);return t(Nd,{$variant:o,$disabledDisplay:r,$interactive:!!n,onClick:()=>((e,t)=>{t||d(e)})(e,!n),children:i},i)}))}):null},Wd=o.forwardRef(((n,o)=>{var{children:i,initialCalendarDate:a,minDate:l,maxDate:u,currentFocus:d,selectedStartDate:h,selectedEndDate:p,selectWithinRange:m,dynamicHeight:b=!1,allowDisabledSelection:v,onCalendarDateChange:y,withButton:x,doneButtonDisabled:w,onDismiss:$,showNavigationHeader:C=!0,getLeftArrowDate:S,getRightArrowDate:D,isLeftArrowDisabled:k,isRightArrowDisabled:_,getMonthHeaderLabel:O,getYearHeaderLabel:E}=n,T=lt(n,["children","initialCalendarDate","minDate","maxDate","currentFocus","selectedStartDate","selectedEndDate","selectWithinRange","dynamicHeight","allowDisabledSelection","onCalendarDateChange","withButton","doneButtonDisabled","onDismiss","showNavigationHeader","getLeftArrowDate","getRightArrowDate","isLeftArrowDisabled","isRightArrowDisabled","getMonthHeaderLabel","getYearHeaderLabel"]);const[I,F]=g(Wc.toDayjs(a)),[M,A]=g(Wc.toDayjs(a)),[j,z]=g("default"),R=s(null),B=s(null),P=s(null);f(o,(()=>({defaultView(){z("default")},resetView(){const e=Wc.toDayjs(a);F(e),A(e),z("default")},setCalendarDate(e){const t=Wc.toDayjs(e);F(t),A(t)}}))),c((()=>{const e=Wc.toDayjs(a);F(e),A(e)}),[a]),c((()=>{U(M)}),[M]);const L=()=>{var e;"month-options"!==j?(z("month-options"),null===(e=P.current)||void 0===e||e.focus()):(z("default"),F(M))},N=()=>{"default"!==j?(z("default"),F(M)):z("year-options")},H=()=>{var e;null===(e=P.current)||void 0===e||e.focus();const t=S?S(I):I.subtract(1,"month");switch(j){case"default":A(t),F(t);break;case"month-options":F((e=>e.subtract(1,"year")));break;case"year-options":F((e=>e.subtract(10,"year")))}},W=()=>{var e;null===(e=P.current)||void 0===e||e.focus();const t=D?D(I):I.add(1,"month");switch(j){case"default":A(t),F(t);break;case"month-options":F((e=>e.add(1,"year")));break;case"year-options":F((e=>e.add(10,"year")))}},V=e=>{F(e),A(e),x||z("default")},Y=()=>{const e=Wc.toDayjs(a);F(e),A(e),"default"===j?K("reset"):z("default")},U=e=>{y&&y(e)},K=e=>{$&&$(e)},q=()=>{if(!l||v)return!1;const e=Dc(l);return"month-options"===j?!Rc.isPreviousYearWithinRange(I,e):"year-options"===j?!Rc.isPreviousDecadeWithinRange(I,e):k?k(I):!Rc.isPreviousMonthWithinRange(I,e)},G=()=>{if(!u||v)return!1;const e=Dc(u);return"month-options"===j?!Rc.isNextYearWithinRange(I,e):"year-options"===j?!Rc.isNextDecadeWithinRange(I,e):_?_(I):!Rc.isNextMonthWithinRange(I,e)},Q=()=>{if("year-options"===j){const{beginDecade:e,endDecade:t}=Rc.getStartEndDecade(I);return`${e} to ${t}`}return E?E(I):I.format("YYYY")},Z=()=>{const n=O?O(I):I.format("MMM");return e(r,{children:[e(Id,{type:"button",tabIndex:-1,$expanded:"month-options"===j,$visible:"default"===j,id:"month-dropdown",onClick:L,children:[t(Fd,{children:n}),t(Sd,{})]}),e(Id,{type:"button",tabIndex:-1,$expanded:"default"!==j,id:"year-dropdown",onClick:N,children:[t(Fd,{children:Q()}),t(Sd,{})]})]})},X=()=>{switch(j){case"month-options":return t(Pd,{calendarDate:I,currentFocus:d,minDate:l,maxDate:u,selectedStartDate:h,selectedEndDate:p,viewCalendarDate:M,isNewSelection:!!m,onMonthSelect:V,allowDisabledSelection:v});case"year-options":return t(Hd,{calendarDate:I,currentFocus:d,minDate:l,maxDate:u,selectedStartDate:h,selectedEndDate:p,viewCalendarDate:M,isNewSelection:!!m,onYearSelect:V,allowDisabledSelection:v});default:return null}};return e(Dd,Object.assign({ref:P,"data-id":"calendar-container","data-testid":"calendar-container"},T,{children:[C&&e(Ed,{"data-id":"calendar-header","data-testid":"calendar-header",children:[t(Td,{children:Z()}),e(Md,{children:[t(Ad,{"aria-label":"Previous month","data-testid":"left-arrow-btn",disabled:q(),focusHighlight:!1,tabIndex:-1,onClick:H,children:t($d,{})}),t(Ad,{"aria-label":"Next month","data-testid":"right-arrow-btn",disabled:G(),focusHighlight:!1,tabIndex:-1,onClick:W,children:t(Cd,{})})]})]}),t(kd,{children:(()=>{const n="function"==typeof i?i({calendarDate:M,currentView:j}):i;return e(r,b?{children:["default"===j&&n,X()]}:{children:[t(_d,{children:n}),t(Od,{$visible:"default"!==j,children:X()})]})})()}),(()=>{if(!x)return;const r=!!("default"===j)&&w;return e(jd,{children:[t(zd,{ref:B,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:Y,children:"Cancel"}),t(zd,{"data-testid":"done-button",ref:R,type:"button",onClick:()=>{r||(F(M),"default"===j?K("confirmed"):z("default"))},disabled:r,children:"Done"})]})})()]}))})),Vd=_.div`
    width: 100%;
    display: grid;
...
`,If=_.div`
    ...
    ${e=>e.$disabled?O`
            ...
            `:e.$hide?O`
                display: none;
            `:void 0}
`;Dc.extend(_c);const Ff=o.forwardRef((({disabled:r,readOnly:n,names:o,value:i,focused:a,hoverValue:l,placeholder:u,label:d,onChange:h,onFocus:p,onBlur:m,hideInputKeyboard:b},v)=>{const y=b?"none":"numeric",[x,w,$]=Xc(""),[C,S,D]=Xc(""),[k,_,O]=Xc(""),[E,T]=g("none"),[I,F]=g(!1),M=s(null),A=s(null),j=s(null),z=s(null),[R,B,P]=Y(l);c((()=>{var e;const[t="",r="",n=""]=Y(i);w(t),S(r),_(n),t||r||n||!M.current||!M.current.contains(document.activeElement)||null===(e=A.current)||void 0===e||e.focus()}),[i]),c((()=>{var e;a||T("none"),a&&(F(!0),M.current&&!M.current.contains(document.activeElement)&&(null===(e=A.current)||void 0===e||e.focus()))}),[a]),f(v,(()=>({ref:M,resetPlaceholder(){F(!1)},resetInput(){const[e="",t="",r=""]=Y(i);w(e),S(t),_(r)}})),[i]);const L=e=>{var t;e.preventDefault(),null===(t=A.current)||void 0===t||t.focus()},N=e=>{e.target.select();const t=e.target.name;T(t)},H=e=>{const[t,r,n]=o,i={[t]:$.current,[r]:D.current,[n]:O.current},a=e.target.name,s=i[a],l=a!==n?Uc.padValue(s,!0):s;switch(a){case t:i[t]=l,w(l);break;case r:i[r]=l,S(l)}const c=`${i[n]}-${i[r]}-${i[t]}`,u=Dc(c,"YYYY-MM-DD",!0).isValid(),d=!i[t]&&!i[r]&&!i[n];u&&s!==l&&h(c),M.current&&!M.current.contains(e.relatedTarget)&&(T("none"),null==m||m(d||u))},W=e=>{var t,r;if(l)return;const n=e.target.name,i=e.target.value.replace(/[^0-9]/g,""),a={day:x,month:C,year:k};switch(n){case o[0]:a.day=i,w(i),2===i.length&&(null===(t=j.current)||void 0===t||t.focus());break;case o[1]:a.month=i,S(i),2===i.length&&(null===(r=z.current)||void 0===r||r.focus());break;case o[2]:a.year=i,_(i)}if(!a.day&&!a.month&&!a.year)return void h("");const s=`${a.year}-${a.month}-${a.day}`;Dc(s,"YYYY-MM-DD",!0).isValid()&&h(s)},V=e=>{var t,r;"Backspace"!==e.code&&"Backspace"!==e.key||(E===o[1]&&0===C.length&&(null===(t=A.current)||void 0===t||t.focus()),E===o[2]&&0===k.length&&(null===(r=j.current)||void 0===r||r.focus()))};function Y(e){if(e){const t=Dc(new Date(e));return t.isValid()?[Uc.padValue(t.date().toString()),Uc.padValue((t.month()+1).toString()),t.year().toString()]:[void 0,void 0,void 0]}return[void 0,void 0,void 0]}return e(Sf,{role:"group","aria-label":d,onClick:()=>{var e;r||n||(F(!0),M.current&&!M.current.contains(document.activeElement)&&(null===(e=A.current)||void 0===e||e.focus()))},onFocus:e=>{r||(F(!0),a||null==p||p(e))},children:[e(Df,{ref:M,$hover:!!l,children:[t(_f,{ref:A,name:o[0],maxLength:2,value:null!=R?R:x,onFocus:N,onBlur:H,onChange:W,type:"text",inputMode:y,pattern:"[0-9]{2}","data-testid":`${o[0]}-input`,"aria-label":"day",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:E!==o[0]||n?"DD":""}),t(Tf,{$inactive:0===x.length,children:"/"}),t(Of,{ref:j,name:o[1],maxLength:2,value:null!=B?B:C,onFocus:N,onBlur:H,onChange:W,onKeyDown:V,type:"text",inputMode:y,pattern:"[0-9]{2}","data-testid":`${o[1]}-input`,"aria-label":"month",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:E!==o[1]||n?"MM":""}),t(Tf,{$inactive:0===C.length,children:"/"}),t(Ef,{ref:z,name:o[2],maxLength:4,value:null!=P?P:k,onFocus:N,onBlur:H,onChange:W,onKeyDown:V,type:"text",inputMode:y,pattern:"[0-9]{4}","data-testid":`${o[2]}-input`,"aria-label":"year",disabled:r,readOnly:n,tabIndex:n?-1:0,autoComplete:"off",placeholder:E!==o[2]||n?"YYYY":""})]}),(()=>{if(!i&&!n&&u)return t(If,{$hide:I,$disabled:r,onMouseDown:L,children:u})})()]})})),Mf=_(wf)`
    height: 3rem;
`,Af=e=>{var{minDate:r,maxDate:n,disabled:o,disabledDates:i,error:a,hideInputKeyboard:l,value:u,onChange:d,onFocus:f,onBlur:h,onYearMonthDisplayChange:p,withButton:m=!0,readOnly:b,id:v,allowDisabledSelection:y,zIndex:x}=e,w=lt(e,["minDate","maxDate","disabled","disabledDates","error","hideInputKeyboard","value","onChange","onFocus","onBlur","onYearMonthDisplayChange","withButton","readOnly","id","allowDisabledSelection","zIndex"]);const[$,C]=g(Vc.sanitizeInput(u)),[S,D]=g(Vc.sanitizeInput(u)),[k,_]=g(void 0),[O,E]=g(!1),[T,I]=g(!1),F=s(null),M=s(null);c((()=>{const e=Vc.sanitizeInput(u);C(e),D(e)}),[u]);const A=e=>{!y&&Vc.isDateDisabled(e,{disabledDates:i,minDate:r,maxDate:n})||(D(e),m||(L(e),C(e),e&&E(!1)))},j=e=>{var t;D(e),m||(L(e),C(e),e&&(null===(t=F.current)||void 0===t||t.focus(),E(!1)),k&&_(void 0))},z=()=>{b||o||(E(!0),T||(I(!0),f&&f()))},R=e=>{var t;T&&!O&&F.current&&!F.current.contains(e.relatedTarget)&&(null===(t=M.current)||void 0===t||t.resetInput(),D($),I(!1),N())},B=e=>{_(e)},P=e=>{var t;switch(e){case"reset":D($);break;case"confirmed":C(S),L(S)}null===(t=F.current)||void 0===t||t.focus(),E(!1)},L=e=>{d&&d(e)},N=()=>{h&&h()};return t(ad,{enabled:!b&&!o,isOpen:O,renderElement:()=>t(Mf,Object.assign({tabIndex:-1,ref:F,onBlur:R,onFocus:z,$disabled:o,$readOnly:b,$focused:T,$error:a,id:v,"data-testid":w["data-testid"]},w,{children:t(Ff,{ref:M,disabled:o,onChange:A,readOnly:b,focused:O,names:["start-day","start-month","start-year"],value:S,hoverValue:k,hideInputKeyboard:l})})),renderDropdown:({elementWidth:e})=>t(gf,{variant:"single",initialCalendarDate:S,withButton:m,value:S,disabledDates:i,minDate:r,maxDate:n,allowDisabledSelection:y,onHover:B,onSelect:j,onDismiss:P,onYearMonthDisplayChange:p,width:e}),onClose:()=>{var e;null===(e=M.current)||void 0===e||e.resetInput(),D($),E(!1),I(!1),N()},onDismiss:()=>{var e,t;null===(e=M.current)||void 0===e||e.resetInput(),null===(t=F.current)||void 0===t||t.focus(),D($),E(!1)},customZIndex:x,offset:16})},jf=_.div`
    position: relative;
    height: 100%;
    display: flex;
    flex: 1;
...
`,Kf=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:u=!1}=r,d=lt(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),f={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(Uf,Object.assign({ref:n,"data-testid":d["data-testid"]||"button-with-icon",disabled:i},f,d,{children:[u?t(pd,{}):l,t("span",{children:o})]}))};Kf.displayName="ButtonWithIcon.Default";const qf=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:u=!1}=r,d=lt(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),f={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(Uf,Object.assign({ref:n,"data-testid":d["data-testid"]||"button-with-icon",disabled:i},f,d,{children:[u?t(pd,{}):l,t("span",{children:o})]}))};qf.displayName="ButtonWithIcon.Small";const Gf={Default:o.forwardRef(Kf),Small:o.forwardRef(qf)},Qf=({className:e,progress:r,color:n,"data-testid":o})=>t(Zf,{className:e,$innerWidth:r,$color:n,"data-testid":o,children:t("progress",{value:100*r,max:100})}),Zf=_.div`
    position: relative;
    width: 100%;
    height: 8px;
    background: transparent;
...
`,vw=_.div`
    ...
    `}
`,yw=O`
    animation: ${Fi["duration-150"]} ${Fi["ease-default"]} ${bw};
    width: 100%;
    height: 100%;
...
`,aT=r=>{var{id:n,disabled:o=!1,error:i,value:l,format:d="12hr",readOnly:f,onChange:h,onFocus:p,onBlur:m,alignment:b="left",dropdownZIndex:v,startLimit:y,endLimit:x,interval:w=15}=r,$=lt(r,["id","disabled","error","value","format","readOnly","onChange","onFocus","onBlur","alignment","dropdownZIndex","startLimit","endLimit","interval"]);const[C]=g((()=>Yc.generate())),[S,D]=g(null),[k,_]=g(!1),[O,E]=g(""),[T,I]=g(""),[F,M]=g(""),[A,j]=g(""),[z,R]=g(""),B=s(null),P=s(null),L=s(null),N=a((()=>aE.generateTimings(w,d,y,x)),[w,d,y,x]),H=a((()=>{if(""===A)return N;const e=aE.findClosestFlooredTime(A,N);return e?N.slice(N.indexOf(e)):[]}),[N,A]),W=u((e=>aE.parseInput(e,d)),[d]);c((()=>{var e,t;if(l){const r=null!==(e=W(l.start))&&void 0!==e?e:"",n=null!==(t=W(l.end))&&void 0!==t?t:"";I(r),M(n),j(r),R(n)}}),[l,W]),c((()=>{if(i)return void _(!1);const e=W(T),t=W(F);if(void 0===e)E("Invalid start time");else if(void 0===t)E("Invalid end time");else{if(!(""!==e&&""!==t&&aE.to24Hour(t)<aE.to24Hour(e)))return E(""),void(document.activeElement!==P.current&&document.activeElement!==L.current||_(!0));E("End time must be after start time")}_(!1)}),[T,F,W,i]);const V=e=>{o||f||(S||k||null==p||p(),D(e),_(!0))},Y=e=>{var t;o||f||(D(e),_(!0),null===(t=("start"===e?P:L).current)||void 0===t||t.select())};function U(e){var t;switch(e.code){case"Enter":"start"===S?K(T):"end"===S&&(k&&q(F),null===(t=L.current)||void 0===t||t.blur());break;case"Tab":G(T,F,{})}}const K=e=>{G(e,F,{goToNextInput:!0})},q=e=>{G(T,e,{triggerOnBlur:!0})},G=(e,t,{goToNextInput:r,triggerOnBlur:n})=>{var o,i,a;const s=null!==(o=W(e))&&void 0!==o?o:A,l=null!==(i=W(t))&&void 0!==i?i:z;I(s),M(l);s===A&&l===z||null==h||h({start:s,end:l}),r&&void 0!==W(e)&&(D("end"),null===(a=L.current)||void 0===a||a.select()),n&&(D(null),_(!1),null==m||m()),j(s),R(l)},Q=e=>{e.stopPropagation(),I(""),M(""),j(""),R("");null==h||h({start:"",end:""}),D(null),_(!1)},Z=e=>{B.current&&!B.current.contains(e.relatedTarget)&&S&&!k&&G(T,F,{triggerOnBlur:!0})},X=()=>{if(!f&&!o&&((null==T?void 0:T.length)>0||(null==F?void 0:F.length)>0))return t(zO,{onClick:Q,type:"button","aria-label":"Clear",children:t(qh,{"aria-hidden":!0})})};return e(rE,Object.assign({id:n},$,{children:[t(yk,{children:t(ad,{enabled:!f&&!o,isOpen:k,renderElement:()=>e(iT,{ref:B,$disabled:o,$error:i||!!O,$readOnly:f,onBlur:Z,children:[e(Lf,{error:i||!!O,currentActive:null===S?"none":S,children:[t(oE,{ref:P,onFocus:()=>V("start"),placeholder:"start"===S?"hh:mm":"From",onChange:e=>I(e.target.value),value:T,disabled:o,readOnly:f,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("start"),onKeyDown:U,autoComplete:"off","aria-label":"Start time input",type:"text",role:"combobox","aria-expanded":k,"aria-controls":C,"aria-autocomplete":"list"}),t(oE,{ref:L,onFocus:()=>V("end"),placeholder:"end"===S?"hh:mm":"To",onChange:e=>M(e.target.value),value:F,disabled:o,readOnly:f,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("end"),onKeyDown:U,autoComplete:"off","aria-label":"End time input",type:"text",role:"combobox","aria-expanded":k,"aria-controls":C,"aria-autocomplete":"list"})]}),X()]}),renderDropdown:()=>{if(k)return t(Nk,"start"===S?{listItems:N,onSelectItem:K,selectedItems:[T],disableItemFocus:!0,topScrollItem:aE.findClosestFlooredTime(W(T),N),listboxId:C}:{listItems:H,onSelectItem:q,selectedItems:[F],disableItemFocus:!0,topScrollItem:aE.findClosestFlooredTime(W(F),H),listboxId:C})},onClose:e=>{"outside-press"===e?(D(null),_(!1),null==m||m()):G(T,F,{triggerOnBlur:!0})},onDismiss:()=>{var e;null===(e=("start"===S?P:L).current)||void 0===e||e.focus(),_(!1)},offset:8,alignment:b,fitAvailableHeight:!0,customZIndex:v})}),!i&&O&&t(Tu,{id:n?`${n}-error-message`:"error-message",tabIndex:0,"data-testid":n?`${n}-error-message`:"error-message",children:O})]}))},sT=e=>{var{variant:r="dial"}=e,n=lt(e,["variant"]);return t("combobox"===r?aT:oT,Object.assign({},n))};_.div`
    position: relative;
`;const lT=_($f)`
    height: calc(3rem - 2px); // exclude top and bottom borders
...
`;var IT;!function(e){e.formatFileSizeDisplay=e=>{if(!e||0===e)return"0 KB";const t=Math.floor(Math.log(e)/Math.log(1024));return`${Number(e/Math.pow(1024,t)).toFixed(0)} ${["B","KB","MB","GB","TB","PB","EB","ZB","YB"][t]}`},e.isSupportedImageType=e=>["image/avif","image/gif","image/jpeg","image/png","image/svg+xml","image/webp"].includes(e)}(IT||(IT={}));const FT=({fileItem:r,fileDescriptionMaxLength:n,wrapperWidth:o,onSave:i,onCancel:a,onBlur:l})=>{const{id:u,name:d,size:f,truncateText:h=!0,thumbnailImageDataUrl:p}=r,[m,b]=g(),[v,y]=g(""),x=s(null),w=s(null);c((()=>{b($(d))}),[o]),c((()=>{y(r.description||"")}),[r]);const $=e=>{if(!h)return e;const t=w&&w.current?w.current.getBoundingClientRect().width:0;return Uc.truncateOneLine(e,t,t/2,t/2/8,16)};return e(yT,{"data-testid":`${u}-edit-display`,children:[e(xT,{children:[p&&t(_T,{thumbnailImageDataUrl:p}),e(wT,{children:[e($T,{ref:w,children:[t(CT,{weight:"semibold",children:m}),t(ST,{children:IT.formatFileSizeDisplay(f)})]}),t(vT.Textarea,{ref:x,id:`${u}-description-textarea`,"data-testid":`${u}-textarea`,value:v,maxLength:n,onChange:e=>{y(e.target.value)},onBlur:e=>{l(e.target.value)},rows:3,label:{children:"Photo description",subtitle:"Describe this photo to users who may not be able to see the image."}})]})]}),e(DT,{$thumbnail:!!p,children:[t(kT,{"data-testid":`${u}-save-button`,type:"button",disabled:0===v.trim().length,onClick:()=>{x.current&&i(x.current.value.trim())},children:"Save"}),t(kT,{type:"button",styleType:"secondary","data-testid":`${u}-cancel-button`,onClick:a,children:"Cancel"})]})]})},MT=_.li`
    display: flex;
    align-items: center;
    width: 100%;
    border: none;
