...
`;const yT=E(Nf)`
    height: calc(3rem - 2px); // exclude top and bottom borders
`,xT=r=>{var{id:n,disabled:o=!1,readOnly:i=!1,error:a,value:l,placeholder:c,format:u="24hr",onChange:h,onFocus:f,onBlur:p}=r,m=ut(r,["id","disabled","readOnly","error","value","placeholder","format","onChange","onFocus","onBlur"]);const[b,v]=g(!1),y=s(null);Nd("mousedown",(function(e){o||i||$(e)}),"document"),Nd("keyup",(function(e){if("Tab"===e.code)$(e)}),"document");const x=()=>{o||i||b||(v(!0),null==f||f())};const w=()=>{v(!1),null==p||p()},$=e=>{y.current&&!y.current.contains(e.target)&&b&&w()},C=d((()=>"12hr"===u?"HH:MMam":"HH:MM"),[u,c]);return t(Lf,Object.assign({ref:y,id:n,$readOnly:i,$disabled:o,$error:a},m,{children:[e(yT,{onFocus:x,readOnly:!0,placeholder:c||C(),value:g_.formatDisplayValue(l,u),disabled:o,"data-testid":n?`${n}-timepicker-selector`:"timepicker-selector"}),e(pT,{id:n,show:b,value:l,format:u,onCancel:()=>{w()},onChange:e=>{null==h||h(e),w()}})]}))},wT=E(WS)`
    margin-right: 0.5rem;
`,$T=E(bg)`
    width: 2.5rem;
...
//# sourceMappingURL=index.0ce276b5.js.map
