...
`,N_=C((({type:r="checkbox",indicator:i,checked:a,styleType:s="default",children:d,childrenMaxLines:u,subLabel:p,disabled:f,error:h,name:g,id:v,className:b,compositeSection:y,removable:x,onRemove:w,"data-testid":$,onChange:S,useContentWidth:k})=>{const{collapsible:O=!0,errors:C,children:D,initialExpanded:_}=y||{},[j,T]=m(a),[I,E]=m(_),B=o((()=>{const e=Array.isArray(C)&&(null==C?void 0:C.length)>0,t=!Array.isArray(C)&&!!C;return e||t}),[C]),[F]=m(tc.generate()),A=v?`${v}`:`tg-${F}`,M=l();c((()=>{T(a)}),[a]),c((()=>{j&&E(null==_||_)}),[j]);const R=e=>{if(!f){if(S)return void S(e);switch(r){case"checkbox":T((e=>!e));break;case"radio":case"yes":case"no":j||T(!0)}}},z=()=>{f||E(!I)},P=()=>{f||!w||w()},L=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(a_,{type:e,active:j,disabled:f})},N=()=>{if(!p)return null;let e;return e="function"==typeof p?p():p,t(w_,Object.assign({"data-id":"toggle-sublabel",$disabled:f,$selected:j},{children:e}))},H=()=>{const n=!I&&!B;return O&&e(O_,Object.assign({$paddingTopRequired:n,disabled:f,onClick:z,"data-testid":I?"collapse-button":"expand-button"},{children:[I?"Show less":"Show more",t(I?ke:ne,{"aria-hidden":!0})]}))},V=r=>e(n,{children:[t(j_,Object.assign({weight:"semibold",$disabled:f},{children:"Error"})),t(T_,Object.assign({$disabled:f},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${A}-error-list-item-${n}`},{children:t(j_,Object.assign({weight:"semibold",$disabled:f},{children:e}))}),n)))}))]});return e(v_,Object.assign({$selected:j,$disabled:f,className:b,$styleType:s,$error:h,$indicator:i,$useContentWidth:k,id:v,"data-testid":$},{children:[e($_,Object.assign({id:`${A}-header-container`,$disabled:f,$error:h,$selected:j,$indicator:i,$styleType:s},{children:[e(S_,Object.assign({$addPadding:x},{children:[t(b_,{ref:M,name:g,id:`${A}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:f,onChange:R,checked:j}),i&&L(),e(y_,{children:[t(x_,Object.assign({htmlFor:`${A}-input`,$selected:j,$indicator:i,$disabled:f,"data-testid":`${A}-toggle-label`,$maxLines:u},{children:d})),p&&N()]})]})),x&&t(k_,Object.assign({type:"button",$disabled:f,onClick:P,id:`${A}-remove-button`},{children:"Remove"}))]})),D&&e("div",{children:[(!O||I)&&t(__,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:f},{children:D})),O&&!I&&B&&t(C_,Object.assign({$disabled:f,onClick:z,id:`${A}-error-alert`},{children:t(D_,Object.assign({type:f?"description":"error",className:b,showIcon:!0},{children:Array.isArray(C)?V(C):C}))})),H()]})]}))}))`
    min-width: 5rem;
    flex: 1;
`,H_=C(Id.Small)`
    width: 7rem;
...
`;var gj;!function(e){e.formatFileSizeDisplay=e=>{if(!e||0===e)return"0 KB";const t=Math.floor(Math.log(e)/Math.log(1024));return`${Number(e/Math.pow(1024,t)).toFixed(0)} ${["B","KB","MB","GB","TB","PB","EB","ZB","YB"][t]}`},e.isSupportedImageType=e=>["image/avif","image/gif","image/jpeg","image/png","image/svg+xml","image/webp"].includes(e)}(gj||(gj={}));const vj=({thumbnailImageDataUrl:n,"data-testid":r,renderReplaceButton:i,onReplaceClick:a})=>e(bj,Object.assign({"data-testid":r},{children:[t(yj,{"data-testid":r?`${r}-image`:void 0,src:n}),i&&t(xj,Object.assign({type:"button",onClick:e=>{a&&a()}},{children:"Replace"}))]})),bj=C.div`
    width: auto;
    margin-right: 2rem;
    display: flex;
    flex-shrink: 0;
    flex-direction: column;
    justify-content: center;
`,yj=C((({src:e,alt:n,className:r,"data-testid":i})=>t("img",{src:e,alt:n||"",className:r,"data-testid":i,onError:e=>{e.target.onerror=null,e.target.src="data:image/png;base64,"}})))`
    width: 6rem;
    height: 6rem;
    aspect-ratio: 1;
    border-radius: 4px;
...
`,wj=({fileItem:n,fileDescriptionMaxLength:r,wrapperWidth:i,onSave:a,onCancel:o,onBlur:s})=>{const{id:d,name:u,size:p,truncateText:f=!0,thumbnailImageDataUrl:h}=n,[g,v]=m(),[b,y]=m(""),x=l(),w=l();c((()=>{v($(u))}),[i]),c((()=>{y(n.description||"")}),[n]);const $=e=>{if(!f)return e;const t=w&&w.current?w.current.getBoundingClientRect().width:0;return nc.truncateOneLine(e,t,t/2,t/2/8,16)};return e(sj,Object.assign({"data-testid":`${d}-edit-display`},{children:[e(cj,{children:[h&&t(vj,{thumbnailImageDataUrl:h}),e(dj,{children:[e(uj,Object.assign({ref:w},{children:[t(pj,Object.assign({weight:"semibold"},{children:g})),t(fj,{children:gj.formatFileSizeDisplay(p)})]})),t(lj.Textarea,{ref:x,id:`${d}-description-textarea`,"data-testid":`${d}-textarea`,value:b,maxLength:r,onChange:e=>{y(e.target.value)},onBlur:e=>{s(e.target.value)},rows:3,label:{children:"Photo description",subtitle:"Describe this photo to users who may not be able to see the image."}})]})]}),e(hj,Object.assign({$thumbnail:!!h},{children:[t(mj,Object.assign({"data-testid":`${d}-save-button`,type:"button",disabled:0===b.trim().length,onClick:()=>{x.current&&a(x.current.value.trim())}},{children:"Save"})),t(mj,Object.assign({type:"button",styleType:"secondary","data-testid":`${d}-cancel-button`,onClick:o},{children:"Cancel"}))]}))]}))},$j=C.li`
    display: flex;
    align-items: center;
    width: 100%;
    border: none;
...
`,Rj=g((({fileItem:r,editable:i,sortable:a,wrapperWidth:o,disabled:s,readOnly:d,onDelete:u,onEditClick:p})=>{const{id:f,name:h,size:g,description:b,progress:y=1,errorMessage:x,thumbnailImageDataUrl:w,truncateText:$=!0}=r,[S,k]=m(),{activeId:O}=v(Be),{attributes:C,listeners:D,setNodeRef:_,transform:j,transition:T}=jl({id:f}),I=l(),E={transform:_a.Translate.toString(j),transition:T},B=Object.assign(Object.assign({style:E},C),D),F=y<1,A=gj.formatFileSizeDisplay(g),M=O?O===f?"self":"others":"none";c((()=>{k(L(h))}),[o]);const R=()=>{u()},z=()=>{p&&p()},P=e=>{a&&e.stopPropagation()},L=e=>{if(!$)return e;const t=I&&I.current?I.current.getBoundingClientRect().width:0;return nc.truncateOneLine(e,t,t/2,t/2/8,16)},N=()=>s||!!O,H=()=>a&&!d,V=()=>e(n,{children:[t(jj,Object.assign({weight:b?"semibold":"regular"},{children:S})),b&&t(Tj,{children:b})]});return e($j,Object.assign({id:f,ref:_,$sortable:H(),$disabled:N(),$focusType:M},H()?B:{},{children:[H()&&t(Sj,{"data-testid":`${f}-drag-handle`,$disabled:N()}),e(kj,Object.assign({$focused:"self"===M,$error:!!x,$loading:F,$disabled:N(),$editable:i},{children:[(()=>{let r;return r=e(n,x?{children:[e(Cj,Object.assign({ref:I},{children:[V(),x&&t(Ej,Object.assign({weight:"semibold"},{children:x}))]})),t(_j,{children:t(jj,{children:A})}),x&&t(Bj,Object.assign({weight:"semibold"},{children:x}))]}:w?{children:[t(vj,{thumbnailImageDataUrl:w,"data-testid":`${f}-thumbnail`}),e(Dj,{children:[t(Cj,Object.assign({ref:I},{children:V()})),t(_j,{children:t(jj,{children:A})})]})]}:{children:[t(Cj,Object.assign({ref:I},{children:V()})),t(_j,Object.assign({$hideInMobile:F},{children:t(jj,{children:A})}))]}),t(Oj,Object.assign({$hasThumbnail:!!w},{children:r}))})(),!d&&(()=>{let r;return r=x?t(Mj,Object.assign({onClick:R,"data-testid":`${f}-error-delete-button`,"aria-label":`delete-${h}`},{children:t(te,{"aria-hidden":!0})})):F?t(sp,{progress:y,"data-testid":`${f}-progress-bar`}):e(n,{children:[i&&t(Aj,Object.assign({"data-testid":`${f}-edit-button`,"data-no-dnd":"true",type:"button",styleType:"light",sizeType:"small","aria-label":`edit ${h}`,disabled:N(),onClick:z,onKeyDown:P},{children:t(Ie,{"aria-hidden":!0})}),"edit"),t(Aj,Object.assign({"data-testid":`${f}-delete-button`,"data-no-dnd":"true",type:"button",styleType:"light",sizeType:"small","aria-label":`delete ${h}`,disabled:N(),onClick:R,onKeyDown:P},{children:t(Te,{"aria-hidden":!0})}),"delete")]}),t(Fj,Object.assign({$editable:i,$error:!!x,$loading:F},{children:r}))})()]}))]}))})),zj=C.ul`
    list-style-type: none;
...
`,Qj=C(f_)`
    margin-bottom: 2rem;
`,Jj=({styleType:n="bordered",fileItems:r,title:i,description:a,maxFiles:o,warning:s,className:c,name:d,id:u,"data-testid":p,accept:f,capture:h,multiple:g,disabled:v,sortable:b=!1,fileDescriptionMaxLength:y,editableFileItems:x=!1,errorMessage:w,readOnly:$,onChange:S,onDelete:k,onEdit:O,onSort:C})=>{const D=l(),[_,j]=m(),T=()=>!!o&&r.length>=o;return t(Be.Provider,Object.assign({value:{activeId:_,setActiveId:j}},{children:e(oa,Object.assign({ref:D,onChange:e=>{!v&&S&&S(e)},id:u?`${u}-dropzone`:"dropzone",accept:f,capture:h,border:"bordered"===n,className:c,"data-testid":p,name:d,multiple:g,disabled:v||T()||$},{children:[(i||a)&&e(Nj,{children:[i?"string"==typeof i?t(Hj,Object.assign({weight:"regular"},{children:i})):t(Vj,{children:i}):null,a?"string"==typeof a?t(Wj,Object.assign({weight:"regular"},{children:a})):t(Yj,{children:a}):null]}),s&&t(Uj,Object.assign({type:"warning"},{children:s})),t(Lj,{fileItems:r,editableFileItems:x,fileDescriptionMaxLength:y,sortable:b,disabled:v,readOnly:$,onItemDelete:e=>{k&&k(e)},onItemUpdate:e=>{O&&O(e)},onSort:e=>{C&&C(e)}}),w&&t(Qj,Object.assign({type:"error"},{children:w})),!$&&e(qj,{children:[t(Kj,Object.assign({type:"button",styleType:"secondary",disabled:!!_||v||T(),onClick:e=>{v||(e.preventDefault(),D.current&&D.current.openFileDialog())}},{children:"Upload files"})),t(Gj,{children:"or drop them here"})]})]}))}))};export{ww as B,Ii as C,Jj as F,Tp as S,st as _,Ip as a};
//# sourceMappingURL=index.1b17e165.js.map
