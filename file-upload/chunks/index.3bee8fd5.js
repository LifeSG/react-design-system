    ...
    ${e=>{if(e.$disabledDisplay)return _`
            ...
            `;switch(e.$variant){case"current-month":return _`
                ...
                `;case"selected-month":return _`
                    ...
                    color: ${Mi.Primary(e)};
                `}}}
`,td=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:i,viewCalendarDate:a,type:s,isNewSelection:l,minDate:c,maxDate:u,allowDisabledSelection:d,onMonthSelect:f})=>{const h=o((()=>tc.generateMonths(Vl(e))),[e]),p=e=>{const t="start"===r&&i&&e.isAfter(i,"month")&&l,a="end"===r&&n&&e.isBefore(n,"month")&&l;return t||a},g=e=>{const t=e.format("MMMM"),r=(n=e,!tc.isWithinRange(n,c?Vl(c):void 0,u?Vl(u):void 0,"month"));var n;const i=a.isSame(e,"month")?"selected-month":Vl().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||p(e),interactive:!r||d,month:t,variant:i}};return h.length?t(Zu,Object.assign({$type:s},{children:h.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,month:a}=g(e);return t(Xu,Object.assign({$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||f(e)})(e,!n)},{children:t(ed,Object.assign({weight:"regular",$variant:i,$disabledDisplay:r},{children:a}))}),a)}))})):null},rd=k.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
//# sourceMappingURL=index.3bee8fd5.js.map
