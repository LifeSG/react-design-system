...
`,cC=k((({type:r="checkbox",indicator:i,checked:o,styleType:l="default",children:u,childrenMaxLines:d,subLabel:f,disabled:p,error:h,name:m,id:b,className:v,compositeSection:y,removable:w,onRemove:x,"data-testid":$,onChange:S})=>{const{collapsible:O=!0,errors:k,children:_,initialExpanded:D}=y||{},[C,j]=g(o),[E,T]=g(D),A=a((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[M]=g(Vd.generate()),I=b?`${b}`:`tg-${M}`,F=s();c((()=>{j(o)}),[o]),c((()=>{C&&T(null==D||D)}),[C]);const R=e=>{if(!p){if(S)return void S(e);switch(r){case"checkbox":j((e=>!e));break;case"radio":case"yes":case"no":C||j(!0)}}},B=()=>{p||T(!E)},L=()=>{p||!x||x()},N=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(DD,{type:e,active:C,disabled:p})},z=()=>{if(!f)return null;let e;return e="function"==typeof f?f():f,t(VD,Object.assign({"data-id":"toggle-sublabel",$disabled:p,$selected:C},{children:e}))},H=()=>{const n=!E&&!A;return O&&e(KD,Object.assign({$paddingTopRequired:n,disabled:p,onClick:B,"data-testid":E?"collapse-button":"expand-button"},{children:[E?"Show less":"Show more",t(E?oe:P,{"aria-hidden":!0})]}))},V=r=>e(n,{children:[t(XD,Object.assign({weight:"semibold",$disabled:p},{children:"Error"})),t(JD,Object.assign({$disabled:p},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${I}-error-list-item-${n}`},{children:t(XD,Object.assign({weight:"semibold",$disabled:p},{children:e}))}),n)))}))]});return e(LD,Object.assign({$selected:C,$disabled:p,className:v,$styleType:l,$error:h,$indicator:i,id:b,"data-testid":$},{children:[e(WD,Object.assign({id:`${I}-header-container`,$disabled:p,$error:h,$selected:C,$indicator:i,$styleType:l},{children:[e(YD,Object.assign({$addPadding:w},{children:[t(ND,{ref:F,name:m,id:`${I}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:p,onChange:R,checked:C}),i&&N(),e(zD,{children:[t(HD,Object.assign({htmlFor:`${I}-input`,$selected:C,$indicator:i,$disabled:p,"data-testid":`${I}-toggle-label`,$maxLines:d},{children:u})),f&&z()]})]})),w&&t(UD,Object.assign({type:"button",$disabled:p,onClick:L,id:`${I}-remove-button`},{children:"Remove"}))]})),_&&e("div",{children:[(!O||E)&&t(QD,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:p},{children:_})),O&&!E&&A&&t(qD,Object.assign({$disabled:p,onClick:B,id:`${I}-error-alert`},{children:t(GD,Object.assign({type:p?"description":"error",className:v,showIcon:!0},{children:Array.isArray(k)?V(k):k}))})),H()]})]}))}))`
    min-width: 5rem;
    flex: 1;
`,uC=k(gp.Small)`
    width: 7rem;
...
//# sourceMappingURL=index.3e25ef25.js.map
