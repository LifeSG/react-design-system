...
`,IO=k(Yc)`
    margin-top: 0;
`,FO=i.forwardRef(((n,i)=>{const{label:a,value:o,errorMessage:s,id:l="form-textarea","data-error-testid":u,"data-testid":d,onChange:f,layoutType:h,mobileCols:p,tabletCols:m,desktopCols:b}=n,v=ot(n,["label","value","errorMessage","id","data-error-testid","data-testid","onChange","layoutType","mobileCols","tabletCols","desktopCols"]),[y,w]=g(o);c((()=>{w(o)}),[o]);return e(ou,Object.assign({id:l,label:a,disabled:v.disabled,layoutType:h,mobileCols:p,tabletCols:m,desktopCols:b},{children:[t(EO,Object.assign({id:`${l}-base`,"data-testid":d||l,value:y,error:!!s,onChange:e=>{const t=e.target.value;v.maxLength&&t.length>v.maxLength||(w(t),e.target.value=t,f&&f(e))},ref:i},v)),s||v.maxLength?e(TO,{children:[s&&t(AO,{children:t(IO,Object.assign({weight:"semibold","data-testid":u||(l?`${l}-error-message`:"error-message")},{children:s}))}),v.maxLength&&t(DO,{disabled:v.disabled,value:y,maxLength:v.maxLength,renderCustomCounter:v.renderCustomCounter})]}):t(r,{})]}))})),MO=k.div`
    position: relative;
`,BO=k(Hd)`
    height: 3rem;
    gap: 0.5rem;
...
//# sourceMappingURL=index.3f174075.js.map
