...
`,Xu=_(zu)`
    margin-right: 0.5rem;
`,Ju=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=ct(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Zu,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&t(Xu,{}),t("span",{children:o})]}))};Ju.displayName="Button.Default";const ef=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=ct(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Zu,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&t(Xu,{}),t("span",{children:o})]}))};ef.displayName="Button.Small";const tf=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=ct(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(Zu,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&t(Xu,{}),t("span",{children:o})]}))};tf.displayName="Button.Large";const rf={Default:o.forwardRef(Ju),Small:o.forwardRef(ef),Large:o.forwardRef(tf)},nf=O`
    color: ${Ui.icon};
    height: 1rem;
    width: 1rem;
`,of=_(oe)`
...
`,Fh=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:d=!1}=r,u=ct(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),f={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(Oh,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:i},f,u,{children:[d?t(zu,{}):l,t("span",{children:o})]}))};Fh.displayName="ButtonWithIcon.Default";const Th=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:d=!1}=r,u=ct(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),f={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(Oh,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:i},f,u,{children:[d?t(zu,{}):l,t("span",{children:o})]}))};Th.displayName="ButtonWithIcon.Small";const Ih={Default:o.forwardRef(Fh),Small:o.forwardRef(Th)},Mh=({className:e,progress:r,color:n,"data-testid":o})=>t(Ah,{className:e,$innerWidth:r,$color:n,"data-testid":o,children:t("progress",{value:100*r,max:100})}),Ah=_.div`
    position: relative;
    width: 100%;
    height: 8px;
    background: transparent;
...
`,m$=_.div`
    ...
    direction: rtl;
    text-align: right;
`,b$=_((r=>{var{className:n,checked:o,disabled:i,indeterminate:a,onChange:l,onKeyPress:d,displaySize:u="default"}=r,f=ct(r,["className","checked","disabled","indeterminate","onChange","onKeyPress","displaySize"]);const h=s(null);c((()=>{h.current&&(h.current.indeterminate=null!=a&&a)}),[a]);const p=e=>{if(!i){const t=e;if(!(" "===t.key||"change"===e.type))return;l&&l(e),d&&d(t)}};return e(e$,{className:n,"data-testid":"checkbox",role:"checkbox","aria-checked":a?"mixed":o,"aria-labelledby":"checkbox-input",tabIndex:i?-1:0,onKeyDown:p,$displaySize:u,$disabled:i,$unchecked:!(a||o||i),children:[t(a$,Object.assign({id:"checkbox-input","data-testid":"checkbox-input","aria-hidden":"true",type:"checkbox",checked:o,ref:h,tabIndex:-1,onChange:p,disabled:i},f)),a?t(i$,{$disabled:i,"data-testid":"indeterminate"}):o?t(o$,{$disabled:i,"data-testid":"checkmark"}):i?t(n$,{"data-testid":"empty-disabled-checkbox"}):t(r$,{$disabled:i,"data-testid":"empty-checkbox"})]})}))`
    flex-shrink: 0;
...
//# sourceMappingURL=index.5300fc28.js.map
