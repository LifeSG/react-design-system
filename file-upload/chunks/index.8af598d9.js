...
`,_E=u(((r,n)=>{var{value:o,variant:i,onClear:a}=r,s=ct(r,["value","variant","onClear"]);return t(CE,{$variant:i,children:[t(SE,{$variant:i,children:[e(kE,{"aria-hidden":!0}),e(DE,Object.assign({ref:n,value:o,$variant:i},s))]}),o&&e(EE,{"aria-label":"Clear search",focusOutline:"browser",onClick:a,children:e(re,{"aria-hidden":!0})})]})})),OE=({listItems:n,multiSelect:o,maxSelectable:i,selectedItems:a,disableItemFocus:l,itemsLoadState:u="success",itemTruncationType:f="end",itemMaxLines:h=2,labelDisplayType:p="inline",variant:m="default",listboxId:v,matchElementWidth:y=!1,width:x,topScrollItem:w,onSelectItem:$,onSelectAll:C,onDismiss:S,onRetry:D,valueExtractor:k,listExtractor:E,renderListItem:_,renderCustomCallToAction:O,enableSearch:F,hideNoResultsDisplay:T,noResultsDescription:I,customLabels:M,searchPlaceholder:A,searchFunction:j,onSearch:B})=>{const{noResultsLabel:R="No results found.",selectAllButtonLabel:z="Select all",clearAllButtonLabel:P="Clear all"}=M||{},L=(null==M?void 0:M.searchPlaceholder)||A||"Search",N=(null==M?void 0:M.noResultsDescription)||I,{focusedIndex:H,setFocusedIndex:W}=b(oE),{elementWidth:Y,setFloatingRef:V,getFloatingProps:U,styles:K}=zu(),[q,G]=g(""),[Q,Z]=g(null!=n?n:[]),X=_d(u),J=kd(),ee=s(null),te=s(null),re=s([]),ne=s(null),oe=s(null),ie=!!i&&!!a&&(null==a?void 0:a.length)===i,ae=e=>{const t=E?E(e):null==e?void 0:e.toString();return"object"==typeof t?{title:t.title,secondaryLabel:t.secondaryLabel}:{title:null!=t?t:""}},se=d((e=>!!Ov(a,(t=>Tv(t,e)))),[a]),le=Sd((()=>null==j?void 0:j(q))),ce=Sd((()=>null==n?void 0:n.filter((e=>{const{title:t,secondaryLabel:r}=ae(e),n=q.trim().toLowerCase();return t.toLowerCase().includes(n)||r&&r.toLowerCase().includes(n)})))),de=(e,t)=>{ie&&!se(e)||(W(t),null==$||$(e,(e=>k?k(e):e)(e)))},ue=e=>{const t=e.target.value;G(t),null==B||B()},fe=()=>{var e;G(""),null===(e=ne.current)||void 0===e||e.focus(),null==B||B()},he=()=>{null==D||D()};Dd("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),H<Q.length-1){const e=H+1;null===(t=re.current[e])||void 0===t||t.focus(),W(e)}break;case"ArrowUp":if(e.preventDefault(),H>0){const e=H-1;null===(r=re.current[e])||void 0===r||r.focus(),W(e)}else 0===H&&ne.current&&(ne.current.focus(),W(-1));break;case"Space":case"Enter":document.activeElement===re.current[H]&&(e.preventDefault(),Q[H]&&de(Q[H],H))}})),c((()=>{var e;if(!w)return void(null===(e=oe.current)||void 0===e||e.scrollTo({top:0}));const t=setTimeout((()=>{if(!n)return;const e=n.indexOf(w);oe.current&&-1!==e&&(oe.current.scrollToIndex({index:e}),W(e))}),0);return()=>clearTimeout(t)}),[re,n,W,w]),c((()=>{var e,t,r;if(J)return;if(l||!n)return;const o=n.findIndex((e=>se(e)));ne.current?(W(-1),setTimeout((()=>{var e;return null===(e=ne.current)||void 0===e?void 0:e.focus()}),200)):H>0?(null===(e=oe.current)||void 0===e||e.scrollToIndex({index:H,align:"center"}),setTimeout((()=>{var e;return null===(e=re.current[H])||void 0===e?void 0:e.focus()}),200)):-1!==o?(null===(t=oe.current)||void 0===t||t.scrollToIndex({index:o,align:"center"}),W(o),setTimeout((()=>{var e;return null===(e=re.current[o])||void 0===e?void 0:e.focus()}),200)):(null===(r=oe.current)||void 0===r||r.scrollToIndex({index:0}),W(0),setTimeout((()=>{var e;return null===(e=re.current[0])||void 0===e?void 0:e.focus()}),200))}),[se,l,H,n,J,W]),c((()=>{J&&X&&(l||"success"===u&&ne.current&&(W(-1),ne.current.focus()))}),[J,X,u,W,l]),c((()=>{var e;Z(null!==(e=""===q?n:j?le():ce())&&void 0!==e?e:[])}),[le,ce,n,j,q]);const pe=t=>o?e(ie&&!t?pE:t?fE:hE,{"aria-hidden":!0}):t?e(dE,{"aria-hidden":!0}):e(uE,{}),ge=(t,r)=>{const{title:n,secondaryLabel:o}=ae(t);return e(CC,{displayType:p,label:n,maxLines:h,selected:r,disabled:!r&&ie,sublabel:o,truncationType:f,variant:m})},me=(n,i)=>{if(!D||"success"===u){const a=se(n),s=i===H;return e(cE,{"aria-selected":a,"aria-multiselectable":o,"aria-disabled":!a&&ie,"data-testid":"list-item",onClick:()=>de(n,i),onMouseEnter:()=>(e=>{W(e)})(i),ref:e=>{re.current[i]=e},role:"option",tabIndex:s?0:-1,$active:s,$selected:a,$disabled:!a&&ie,children:_?_(n,{selected:a}):t(r,{children:[pe(a),ge(n,a)]})},((e,t)=>`item_${t}__${k?k(e):e}`)(n,i))}},be=()=>{if((F||j)&&"success"===u)return e(_E,{ref:ne,onChange:ue,value:q,placeholder:L,"data-testid":"search-input","aria-label":"Enter text to search",onClear:fe,variant:m})},ve=()=>{if(a&&o&&Q.length>0&&!q&&"success"===u)return e(gE,{children:e(vE,{onClick:C,type:"button",$variant:m,children:i||0!==a.length?P:z})})},ye=()=>{if(!T&&(q||!F)&&0===Q.length&&"success"===u)return t(r,{children:[t(yE,{"data-testid":"list-no-results",children:[e(xE,{"data-testid":"no-result-icon"}),R]}),N&&e($E,{"data-testid":"no-result-desc",children:N})]})},xe=()=>{if(D&&"loading"===u)return t(yE,{"data-testid":"list-loading",children:[e(wE,{}),"Loading..."]})},we=()=>{if(D&&"fail"===u)return t(yE,{"data-testid":"list-fail",children:[e(xE,{"data-testid":"load-error-icon"}),"Failed to load. ",e(bE,{onClick:he,type:"button",$variant:m,children:"Try again."})]})},$e=()=>{var t;const r="test"===process.env.NODE_ENV;return e(lE,{role:"listbox",id:v,children:e(_k,Object.assign({ref:oe,style:{height:"100%"},data:Q,customScrollParent:null!==(t=ee.current)&&void 0!==t?t:void 0,itemContent:(e,t)=>me(t,e)},r?{initialItemCount:Q.length}:{}),r?Q.length:void 0)})};return t(aE,Object.assign({"data-testid":"dropdown-container",ref:wd(ee,V),style:K},U(),{$width:y?Y:void 0,$customWidth:x,$variant:m,children:[t(sE,{ref:te,"data-testid":"dropdown-list",children:[be(),ve(),ye(),xe(),we(),$e()]}),(()=>{if(O)return e("div",{"data-testid":"custom-cta",children:O(S,Q)})})()]}))},FE=_(bh)`
    display: flex;
    align-items: center;
    gap: ${ea["spacing-8"]};
    width: 100%;
...
//# sourceMappingURL=index.8af598d9.js.map
