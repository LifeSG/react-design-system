...
export declare const FileList: ({ fileItems, editableFileItems, fileDescriptionMaxLength, sortable, disabled, readOnly, onItemUpdate, onItemDelete, onSort, }: Props) => import("react/jsx-runtime").JSX.Element;
export {};
