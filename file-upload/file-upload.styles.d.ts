...
export declare const Title: import("styled-components").StyledComponent<"h4", import("styled-components").DefaultTheme, import("../text").TextProps, never>;
...
export declare const WarningAlert: import("styled-components").StyledComponent<({ type, className, children, actionLink, ...otherProps }: import("../alert").AlertProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
...
export declare const ErrorAlert: import("styled-components").StyledComponent<({ type, className, children, actionLink, ...otherProps }: import("../alert").AlertProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
