...
`,gy=_(py)`
    color: ${Di.Neutral[3]};
`,my=({children:e,show:r,error:n,disabled:i,testId:o,onBlur:a,readOnly:l,className:c})=>{const u=s();return ny("mousedown",(function(e){if(!i){if(u&&u.current.contains(e.target))return;r&&a()}}),"document"),t(iy,Object.assign({className:c},{children:t(cy,Object.assign({ref:u,error:n&&!r,disabled:i,$readOnly:l,expanded:r,"data-testid":o},{children:e}))}))},vy=_.div`
    position: relative;
    display: flex;
    align-items: center;
    margin: 0 1rem;
...
`,D_=_(y_)`
    margin-bottom: 2rem;
`,j_=({styleType:r="bordered",fileItems:n,title:i,description:o,maxFiles:a,warning:l,className:c,name:u,id:d,"data-testid":f,accept:h,capture:p,multiple:m,disabled:v,sortable:b=!1,fileDescriptionMaxLength:y,editableFileItems:w=!1,errorMessage:x,readOnly:$,onChange:_,onDelete:O,onEdit:S,onSort:k})=>{const D=s(),[j,C]=g(),E=()=>!!a&&n.length>=a;return t(ne.Provider,Object.assign({value:{activeId:j,setActiveId:C}},{children:e(Xi,Object.assign({ref:D,onChange:e=>{!v&&_&&_(e)},id:d?`${d}-dropzone`:"dropzone",accept:h,capture:p,border:"bordered"===r,className:c,"data-testid":f,name:u,multiple:m,disabled:v||E()||$},{children:[(i||o)&&e(w_,{children:[i&&t(x_,Object.assign({weight:"regular"},{children:i})),o&&t($_,Object.assign({weight:"semibold"},{children:o}))]}),l&&t(__,Object.assign({type:"warning"},{children:l})),t(g_,{fileItems:n,editableFileItems:w,fileDescriptionMaxLength:y,sortable:b,disabled:v,readOnly:$,onItemDelete:e=>{O&&O(e)},onItemUpdate:e=>{S&&S(e)},onSort:e=>{k&&k(e)}}),x&&t(D_,Object.assign({type:"error"},{children:x})),!$&&e(O_,{children:[t(S_,Object.assign({type:"button",styleType:"secondary",disabled:!!j||v||E(),onClick:e=>{v||(e.preventDefault(),D.current&&D.current.openFileDialog())}},{children:"Upload files"})),t(k_,{children:"or drop them here"})]})]}))}))};export{j_ as FileUpload};
