...
export declare const StyledFilterItem: import("styled-components").StyledComponent<({ collapsible: desktopCollapsible, initialExpanded, expanded: controlledExpanded, onExpandChange, minimisable, minimisedHeight, showDivider, showMobileDivider, title, children, ...otherProps }: import("..").FilterItemProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
