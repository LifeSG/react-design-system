...
export declare const StyledToggle: import("styled-components").StyledComponent<({ type, indicator, checked, styleType, children, disabled, error, name, id, className, "data-testid": testId, onChange, }: import("../../toggle").ToggleProps) => JSX.Element, import("styled-components").DefaultTheme, {
    $visible: boolean;
}, never>;
