...
export declare const StyledToggleIcon: import("styled-components").StyledComponent<({ type, active, disabled, className, }: import("../../shared/toggle-icon/toggle-icon").ToggleIconProps) => import("react/jsx-runtime").JSX.Element, import("styled-components").DefaultTheme, {}, never>;
export declare const StyledToggle: import("styled-components").StyledComponent<({ type, indicator, checked, styleType, children, subLabel, disabled, error, name, id, className, "data-testid": testId, onChange, }: import("../../toggle").ToggleProps) => import("react/jsx-runtime").JSX.Element, import("styled-components").DefaultTheme, {
    $visible: boolean;
}, never>;
