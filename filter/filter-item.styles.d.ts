...
export declare const FilterItemTitle: import("styled-components").StyledComponent<"h4", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
