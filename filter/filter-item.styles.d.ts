...
export declare const FilterItemExpandButton: import("styled-components").StyledComponent<(props: import("..").IconButtonProps & import("react").RefAttributes<HTMLButtonElement>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>, import("styled-components").DefaultTheme, {}, never>;
...
export declare const MinimisableContent: import("styled-components").StyledComponent<import("react-spring").AnimatedComponent<"div">, import("styled-components").DefaultTheme, {
    $height?: number;
    $minimisable: boolean;
}, never>;
