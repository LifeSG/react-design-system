...
export declare const Filter: {
    ...
    Sidebar: {
        ({ customLabels, onClear, clearButtonDisabled, children, headerTitle: _headerTitle, className, ...otherProps }: import("./types").FilterSidebarProps): import("react/jsx-runtime").JSX.Element;
        displayName: string;
    };
    Modal: {
