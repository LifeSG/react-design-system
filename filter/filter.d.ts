...
export declare const Filter: {
    ({ customLabels, toggleFilterButtonLabel: _toggleFilterButtonLabel, headerTitle: _headerTitle, doneButtonLabel: _doneButtonLabel, toggleFilterButtonStyle, clearButtonDisabled, onClear, onDismiss, onDone, onModalOpen, children, _dangerouslyForceMobile, ...otherProps }: FilterProps): import("react/jsx-runtime").JSX.Element;
    displayName: string;
} & {
    Item: {
