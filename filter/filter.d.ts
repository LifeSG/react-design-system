...
export declare const Filter: (({ toggleFilterButtonLabel, headerTitle, clearButtonDisabled, onClear, onDismiss, onDone, children, ...otherProps }: FilterProps) => JSX.Element) & {
    Item: ({ collapsible: desktopCollapsible, initialExpanded, expanded: controlledExpanded, onExpandChange, minimisable, minimisedHeight, showDivider, showMobileDivider, title, addon, children, ...otherProps }: import("./types").FilterItemProps) => JSX.Element;
