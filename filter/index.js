...
`,Ro=({color:t,className:n,size:i})=>e(Mo,{className:n,$size:i,$color:t,"data-testid":"component-loading-spinner",children:[r(Io,{id:"inner1"}),r(To,{id:"inner2"}),r(Po,{id:"inner3"}),r(Lo,{id:"inner4"})]}),Wo=v.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return x`
                ...
                `;default:return x`
                    background-color: ${e.$buttonIsDanger?gi["bg-error-strong"]:In};
                    ...
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${e.$buttonIsDanger?gi["bg-error-strong-hover"]:Tn};
                        }
                    }
                `}}}
...
`,Ho=e=>i.Children.toArray(e).some((e=>"string"==typeof e?""!==e.trim():null!=e)),Vo=(t,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=me(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),h={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Wo,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},h,u,{children:[a&&r(No,{$hasChildren:Ho(i)}),r("span",{children:i})]}))};Vo.displayName="Button.Default";const Yo=(t,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=me(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),h={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Wo,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},h,u,{children:[a&&r(No,{$hasChildren:Ho(i)}),r("span",{children:i})]}))};Yo.displayName="Button.Small";const qo=(t,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=me(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),h={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(Wo,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},h,u,{children:[a&&r(No,{$hasChildren:Ho(i)}),r("span",{children:i})]}))};qo.displayName="Button.Large";const Qo={Default:i.forwardRef(Vo),Small:i.forwardRef(Yo),Large:i.forwardRef(qo)},Uo=w`
  0% {
    opacity: 0;
  }
  100% {
...
`,ra=v.input`
    ...
    &:hover
        ...
        + ${Ko} {
        @media (pointer: fine) {
            color: ${e=>!e.$disabledVisual&&gi["icon-hover"](e)};
        }
    }
...
`,cs=v(Za)`
    color: ${e=>e.$disabled?gi["text-disabled"]:gi["text-error"]};
`,us=v((({type:e,active:t=!1,disabled:n,className:i})=>{let o;switch(e){case"checkbox":o=r(t?q:Y,{});break;case"radio":o=r(t?H:N,{});break;case"tick":o=r(Q,{});break;case"cross":o=r(V,{});break;default:o=null}return r(Ha,{className:i,$active:t,$disabled:n,"aria-hidden":!0,children:o})}))`
    ${e=>e.$disabled?e.$selected?x`
                    color: ${gi["icon-selected-disabled"]};
                `:x`
                    color: ${gi["icon-disabled-subtle"]};
...
`,Vc=i.forwardRef(((e,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=me(e,["children","focusHighlight","focusOutline","type"]);return r(Hc,Object.assign({ref:t,$outline:o,$highlight:i,type:a},s,{children:n}))})),Yc=v.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`;const Qc=i.forwardRef((function(t,n){var{id:i="modal-box",children:o,onClose:a,showCloseButton:s=!0}=t,l=me(t,["id","children","onClose","showCloseButton"]);return e(Yc,Object.assign({ref:n,"data-testid":i},l,{onClick:e=>{e.stopPropagation()},children:[s&&r(qc,{onClick:a,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:r(V,{})}),o]}))}));Qc.displayName="Modal.Box";const Uc=v.div`
    max-width: 30rem;
    padding: 0 1rem;
    pointer-events: auto;
    outline: none;
`,Zc=v((e=>{var{children:t}=e,n=me(e,["children"]);const i=n["data-testid"]||"card";return r(Nc,Object.assign({},n,{"data-testid":i,children:"string"==typeof t?r(Ma.BodyBL,{children:t}):t}))}))`
    color: ${gi.text};
    ${ka({textSize:"body-md"})}
...
`,Gc=v.div`
    ...
    ${e=>{let r="";return e.$show?r+=x`
            ...
            `,e.$disableTransition&&(r+=x`
                transition: none;
            `),r}};
`;var Jc;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Jc||(Jc={}));const Kc=({show:e=!1,rootId:t,onOverlayClick:n,children:i,backgroundOpacity:s,backgroundBlur:l=!0,disableTransition:d=!1,enableOverlayClick:c=!1,zIndex:h,id:g,containerRef:m})=>{const[b,p]=a(null),[f,y]=a(),[v]=a((()=>Fa.generate())),x=X(),w=o(),$=o(!1),F=o(null),E=g?`lifesg-ds-overlay-root-${g}`:"lifesg-ds-overlay-root",D=null!=h?h:f?99999:99998;(e=>{const r=U();u((()=>{if(!r)return;const t={zIndex:e};r.events.emit(Jc.Change,t)}),[r,e]),u((()=>{if(!r)return;const t=()=>{const t={zIndex:e};r.events.emit(Jc.Change,t)};return null==r||r.events.on(Jc.Ready,t),()=>null==r?void 0:r.events.off(Jc.Ready,t)}),[r,e])})(D),u((()=>(O(),p(A()),()=>{j(),z().length<1&&(S()&&(I("remove"),P()),_("remove"))})),[]),u((()=>{if(e){const e=B();k(e),M(),S()&&1===z().length&&(T(),I("add"));const r=setTimeout((()=>{_("add")}),200);return()=>clearTimeout(r)}{j(),S()&&z().length<1&&(I("remove"),P());const e=setTimeout((()=>{z().length<1&&_("remove")}),200);return()=>clearTimeout(e)}}),[e]),u((()=>{if(e)return document.addEventListener("mousedown",L,!0),()=>{document.removeEventListener("mousedown",L,!0)}}),[e]);const k=e=>{w.current=e,y(e)},S=()=>/(iPad|iPhone|iPod)/g.test(navigator.userAgent),A=()=>document&&t?document.getElementById(t):document?document.body:null,B=()=>z().length>0,O=()=>{if(!document.getElementById(ru)){const e=document.createElement("style");e.id=ru;const r=document.documentElement.clientWidth,t=window.innerWidth-r;e.innerHTML=`\n\t\t\t\t.${tu} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${t}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${tu}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\n\t\t\t\t.${nu} {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: var(${iu}, 0);\n\t\t\t\t\tbottom: 0;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},_=e=>{const r=document.body.classList.contains(tu);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(tu):document.body.classList.add(tu)},z=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},M=()=>{const e=z();document.body.dataset.lifesgDsOverlayOrder=[...e,v].join(",")},j=()=>{const e=z();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==v)).join(",")},I=e=>{if(!S())return;const r=document.body.classList.contains(nu);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(nu):document.body.classList.add(nu)},T=()=>{const e=document.body.style,r=e.top?e.top:window.scrollY+"px";document.body.style.setProperty(iu,r)},P=()=>{if(!S())return;const e=document.body.style.getPropertyValue(iu);requestAnimationFrame((()=>{window.scrollTo({top:parseFloat(e)})}))},L=e=>{var r;const t=null!==(r=null==m?void 0:m.current)&&void 0!==r?r:F.current,n=F.current;if(!t)return void($.current=!1);const i=e.target,o=n===i,a=t===i,s=t.contains(i);$.current=!o&&(a||s)},R=e=>{var r;const t=null!==(r=null==m?void 0:m.current)&&void 0!==r?r:F.current,i=F.current;if(!t)return void($.current=!1);const o=e.target,a=i===o,s=t===o,l=t.contains(o);!a&&(s||l)||$.current||!n||!c||(e.preventDefault(),n()),$.current=!1};return b?C.createPortal(r(Xc,{id:E,"data-testid":E,$show:e,$zIndex:D,children:i&&r(G,{id:x,children:r(Gc,{ref:F,"data-testid":"overlay-wrapper",$show:e,$stacked:f,$backgroundBlur:l,$disableTransition:d,onClick:R,children:i})})}),b):null},eu=e=>r(Z,{children:r(Kc,Object.assign({},e))}),ru="lifesg-ds-overlay-stylesheet",tu="lifesg-ds-overlay-open",nu="lifesg-ds-overlay-scroll-lock",iu="--lifesg-ds-overlay-scroll-y",ou=y({onClose:()=>{}}),au=v.div`
    position: relative;
    width: 100%;
    height: 100%;
...
`,mu=v.div`
    ...
    ${e=>e.$hasCloseButton?x`
              ...
              `}
`,bu=e=>{var{"data-testid":t="modal-close-button"}=e,n=me(e,["data-testid"]);const{onClose:i}=f(ou);return r(cu,Object.assign({"data-testid":t},n,{children:r(uu,{onClick:i,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser","aria-label":"Close button",children:r(V,{"aria-hidden":!0})})}))};bu.displayName="ModalV2.CloseButton";const pu=e=>{var{"data-testid":t="modal-content",children:n}=e,i=me(e,["data-testid","children"]);return r(hu,Object.assign({"data-testid":t},i,{children:n}))};pu.displayName="ModalV2.Content";const fu=r=>{var{"data-testid":t="modal-footer",primaryButton:n,secondaryButton:i}=r,o=me(r,["data-testid","primaryButton","secondaryButton"]);return e(gu,Object.assign({"data-testid":t},o,{children:[n,i]}))};fu.displayName="ModalV2.Footer";const yu=i.forwardRef((function(r,t){var{id:n,"data-testid":o="modal-card",children:a}=r,s=me(r,["id","data-testid","children"]);const l=e=>i.Children.toArray(a).find((r=>((e,r)=>$(e.type)?e.type.target===r:e.type===r)(r,e))),d=l(bu),c=l(pu),u=l(fu),h=!!d;return e(du,Object.assign({ref:t,id:n,"data-testid":o},s,{onClick:e=>{e.stopPropagation()},children:[e(mu,{$hasCloseButton:h,children:[c,u]}),h&&d]}))}));yu.displayName="ModalV2.Card";const vu=Object.assign((e=>{var{id:t,show:n,onClose:s,animationFrom:l="bottom",children:d,enableOverlayClick:c=!0,rootComponentId:g,zIndex:b,onOverlayClick:p,dismissKeyboardOnShow:f=!0,"data-testid":y="modal","aria-label":v,"aria-labelledby":x,"aria-describedby":w,disableInitialFocus:$=!1}=e,F=me(e,["id","show","onClose","animationFrom","children","enableOverlayClick","rootComponentId","zIndex","onOverlayClick","dismissKeyboardOnShow","data-testid","aria-label","aria-labelledby","aria-describedby","disableInitialFocus"]);const{verticalHeight:C,offsetTop:E}=(()=>{const[e,r]=a(),[t,n]=a(),i=m((()=>{const e=.01*window.innerHeight;r(e)}),[]),o=m((()=>{if(window.visualViewport){const e=.01*window.visualViewport.height;r(e),n(window.visualViewport.offsetTop)}}),[]);return u((()=>window.visualViewport?(o(),window.visualViewport.addEventListener("resize",o),()=>{var e;null===(e=window.visualViewport)||void 0===e||e.removeEventListener("resize",o)}):(i(),window.addEventListener("resize",i),()=>{window.removeEventListener("resize",i)})),[]),{verticalHeight:e,offsetTop:t}})(),D=o(null),k=d&&i.cloneElement(d,{ref:D}),{refs:S,context:A}=J({open:n,onOpenChange:e=>{e||null==s||s()}}),{isMounted:B,status:O}=K(A,{duration:300}),_=ee(A,{outsidePress:!1,enabled:!!s}),{getFloatingProps:z}=re([_]),M=function(e){const r=o(null);return h((()=>{r.current=e}),[e]),m(((...e)=>{var t;return null===(t=r.current)||void 0===t?void 0:t.call(r,...e)}),[])}((()=>{var e,r;f&&(null===(r=null===(e=document.activeElement)||void 0===e?void 0:e.blur)||void 0===r||r.call(e))}));return u((()=>{n&&M()}),[n,M]),r(eu,{"data-testid":`${y}-overlay`,show:B,enableOverlayClick:c,onOverlayClick:p,id:t,rootId:g,containerRef:D,zIndex:b,children:r(au,Object.assign({$show:B,$animationFrom:l,"data-testid":y,$verticalHeight:C,$offsetTop:E,"data-status":O},F,{children:r(ou.Provider,{value:{onClose:s},children:B&&r(te,{context:A,initialFocus:$?-1:S.floating,children:r(su,{children:r(lu,Object.assign({ref:S.setFloating},z(),{role:"dialog","aria-label":v,"aria-labelledby":x,"aria-describedby":w,children:k}))})})})}))})}),{Card:yu,CloseButton:bu,Content:pu,Footer:fu}),xu=n=>{var{children:i,visible:o,onMobileClose:a,maxHeight:s,overflow:l,ariaLabel:d,id:c}=n,u=me(n,["children","visible","onMobileClose","maxHeight","overflow","ariaLabel","id"]);const h=u["data-testid"]||"popover",g=f(F),m=xi["sm-max"]({theme:g}),b=ve.useMediaQuery({maxWidth:m}),p=()=>{a&&a()},y=()=>"string"==typeof i?r(Ma.BodyMD,{children:i}):i;return e(t,{children:[o&&r(Uc,Object.assign({tabIndex:0,"data-testid":h},u,{id:c,role:"dialog","aria-label":null!=d?d:"More information",children:r(Zc,{$maxHeight:s,$overflow:l,children:y()})})),b&&r(vu,{show:null!=o&&o,onOverlayClick:p,onClose:p,id:c,role:"dialog","aria-label":null!=d?d:"More information",children:e(vu.Card,{children:[r(vu.Content,{children:y()}),r(vu.CloseButton,{})]})})]})},wu=v.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,$u=n=>{var i,s,{children:l,popoverContent:d,trigger:c="click",position:h="top",zIndex:g,rootNode:m,customOffset:b,delay:p,onPopoverAppear:y,onPopoverDismiss:v,popoverAriaLabel:x,enableFlip:w=!0,enableResize:$=!1,overflow:C="auto",triggerOnFocus:E=!1,isModal:D=!0}=n,k=me(n,["children","popoverContent","trigger","position","zIndex","rootNode","customOffset","delay","onPopoverAppear","onPopoverDismiss","popoverAriaLabel","enableFlip","enableResize","overflow","triggerOnFocus","isModal"]);const[S,A]=a(!1),B=o(null),O=o(null),_=f(F),z=xi["sm-max"]({theme:_}),M=ve.useMediaQuery({maxWidth:z}),[j,I]=a(0),T=`${o(Fa.generate()).current}-popover`,{refs:P,floatingStyles:L,context:R}=J({open:S,placement:h,whileElementsMounted:ne,middleware:[ie(null!=b?b:16),w&&oe(),ae({limiter:se()}),$&&le({apply({availableHeight:e}){I(e)}})],onOpenChange:e=>{A(e),S!==e&&G(e)}}),W=(()=>{const[e,r]=a(void 0),t=U();return u((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(Jc.Change,e),t.events.emit(Jc.Ready),()=>t.events.off(Jc.Change,e)}),[t]),e})(),N="hover"===(M?"click":c),H=de(R,{ignoreMouse:N}),V=ee(R),Y=ce(R,{enabled:N,delay:{open:null!==(i=null==p?void 0:p.open)&&void 0!==i?i:0,close:null!==(s=null==p?void 0:p.close)&&void 0!==s?s:500}}),q=ue(R,{enabled:E}),{getReferenceProps:Q,getFloatingProps:Z}=re([H,V,Y,q]),X=()=>{A(!1),G(!1)},G=e=>{e&&y&&y(),!e&&v&&v()};return e(t,{children:[r(wu,Object.assign({ref:e=>{B.current=e,P.setReference(e)}},Q({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),k,{children:l})),S&&r(he,{root:m,children:r(te,Object.assign({context:R},!D&&{initialFocus:-1,returnFocus:!1,modal:!1},{children:r("div",Object.assign({ref:e=>{O.current=e,P.setFloating(e)},onBlur:e=>{var r;const t=null!==(r=e.relatedTarget)&&void 0!==r?r:document.activeElement;t&&(e=>{var r;if(!e)return!1;if(e instanceof HTMLElement&&e.hasAttribute("data-floating-ui-focus-guard"))return!0;const t=B.current,n=null===(r=O.current)||void 0===r?void 0:r.parentElement;return!!t&&t.contains(e)||!!n&&n.contains(e)})(t)||(A(!1),G(!1))},style:Object.assign(Object.assign({},L),{outline:"none",zIndex:null!=g?g:W})},Z(),{children:"function"==typeof d?d($?{maxHeight:j,overflow:C}:{}):r(xu,{visible:!0,onMobileClose:X,maxHeight:$?j:void 0,overflow:$?C:void 0,ariaLabel:x,id:T,children:d})}))}))})]})},Fu=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}},Cu=v.span`
    color: ${gi["text-primary"]};
    font-weight: 600;
...
`,Du=t=>{var{ariaLabel:n,content:i,icon:o,underlineStyle:a="default",underlineHoverStyle:s="default"}=t,l=me(t,["ariaLabel","content","icon","underlineStyle","underlineHoverStyle"]);const d=!!i;return r($u,Object.assign({},l,{children:e(Cu,{"aria-label":null!=n?n:d?void 0:"More info",role:"button","aria-haspopup":"dialog",tabIndex:0,$defaultStyle:a,$hoverStyle:s,children:[i,o&&r(Eu,{$standalone:!d,children:o})]})}))},ku=v.div`
    padding-left: ${fi["spacing-4"]};
    display: inline;
`,Su=({addon:e,rootNode:t})=>{const{content:n,type:i,icon:o,id:a,zIndex:s,"data-testid":l}=e;return r(ku,{children:r(Du,{trigger:"click",id:a,"data-testid":l,popoverContent:n,rootNode:t,zIndex:s,icon:null!=o?o:r(L,{"data-testid":`${i}-icon`}),ariaLabel:"More info"})})},Au=v.div`
...
`,Lu=t=>{var n,{collapsible:i=!0,initialExpanded:s=!1,expanded:l,onExpandChange:d,minimisable:c=!1,minimisedHeight:h,showDivider:g=!0,showMobileDivider:m=!0,title:b,addon:p,children:y}=t,v=me(t,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","addon","children"]);const{mode:x,rootNode:w}=f(Bo),$="mobile"===x,[F,C]=a(j()),[E,D]=a(c),k=!$&&i,S=Ao(),A=Ao(),B=$c({height:F?S.height:0}),O=E?null!=h?h:Math.min(.5*(null!==(n=A.height)&&void 0!==n?n:0),216):A.height,_=o(Fa.generate()),z=`${_.current}-content`,M=`${_.current}-title`;u((()=>{C(j())}),[i,l]),u((()=>{D(c)}),[c]);function j(){return!!$||(Wc(l)?!i||s:l)}return e(Au,{$isMobile:$,$collapsible:k,"aria-labelledby":M,children:[r(Bu,{$isMobile:$,$showDivider:g,$showMobileDivider:m}),(b||k)&&e(Ou,{$isMobile:$,children:[b&&e(Mu,{id:M,"data-testid":"filter-item-title",$isMobile:$,children:[b," ",p&&("popover"===(null==p?void 0:p.type)?r(Su,{addon:p,rootNode:$?w:void 0}):null)]}),k&&e(_u,{"data-testid":"expand-collapse-button",focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!F;Wc(l)&&C(e),d&&d(e)},"aria-expanded":F,"aria-disabled":!k,"aria-controls":z,children:[b&&r(Ea,{children:b}),r(zu,{$expanded:F,"aria-hidden":!0})]})]}),r(ju,{id:z,"data-testid":"expandable-container","data-expanded":F,style:B,inert:Da(!F),children:r("div",{ref:S.ref,children:e(Iu,Object.assign({},v,{children:[r(Tu,{"data-testid":"minimisable-container",$height:O,$minimisable:c,children:r("div",{ref:A.ref,children:r("div",{"data-id":"content-container",children:"function"==typeof y?y(x,{minimised:E}):y})})}),c&&e(Pu,{"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{D(!E)},children:[r(Ea,{children:`view ${E?"more":"less"} in ${b}`}),e("span",{"aria-hidden":!0,children:["View ",E?"more":"less"]})]})]}))})})]})};Lu.displayName="Filter.Item";const Ru=v(Lu)`
...
`,Hu=v((t=>{var{className:n,checked:i,disabled:a,focusableWhenDisabled:s,indeterminate:l,displaySize:d="default",id:c,tabIndex:h,onChange:g}=t,m=me(t,["className","checked","disabled","focusableWhenDisabled","indeterminate","displaySize","id","tabIndex","onChange"]);const b=o(null),p=!!a&&!!s,f=!!a&&!s;u((()=>{b.current&&(b.current.indeterminate=null!=l&&l)}),[l]);return e(ea,{className:n,"data-testid":"checkbox",$displaySize:d,children:[r(ra,Object.assign({id:c,"data-testid":"checkbox-input",type:"checkbox",onChange:e=>{a?e.preventDefault():null==g||g(e)},checked:i,"aria-checked":l?"mixed":i,ref:b,disabled:f,"aria-disabled":p,tabIndex:p?0:h,$disabledVisual:a},m)),l?r(Ko,{$disabled:a,"data-testid":"indeterminate","aria-hidden":!0}):i?r(Jo,{$disabled:a,"data-testid":"checkmark","aria-hidden":!0}):a?r(Go,{"data-testid":"empty-disabled-checkbox","aria-hidden":!0}):r(Xo,{$disabled:a,"data-testid":"empty-checkbox","aria-hidden":!0})]})}))`
    flex-shrink: 0;
    margin-right: ${fi["spacing-8"]};
`,Vu=v((n=>{var{type:i="checkbox",indicator:s,checked:l,styleType:d="default",children:c,childrenMaxLines:h,subLabel:g,disabled:m,error:p,name:f,id:y,className:v,compositeSection:x,removable:w,focusableWhenDisabled:$,useContentWidth:F,onRemove:C,onChange:E,"data-testid":D,"aria-describedby":k}=n,S=me(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","focusableWhenDisabled","useContentWidth","onRemove","onChange","data-testid","aria-describedby"]);const{collapsible:A=!0,errors:B,children:O,initialExpanded:_}=x||{},[z,I]=a(l),[T,P]=a(!!_),L=b((()=>{const e=Array.isArray(B)&&(null==B?void 0:B.length)>0,r=!Array.isArray(B)&&!!B;return e||r}),[B]),[R]=a(Fa.generate()),W=y?`${y}`:`tg-${R}`,N=o(null),H=!!m&&!!$,V=!!m&&!$,Y=!!m;u((()=>{I(l)}),[l]),u((()=>{z&&P(null==_||_)}),[z]);const q=e=>{if(Y)e.preventDefault();else if(E)E(e);else switch(i){case"checkbox":I((e=>!e));break;case"radio":case"yes":case"no":z||I(!0)}},Q=()=>{m||P(!T)},U=()=>{m||!C||C()},Z=()=>{var e;null===(e=null==N?void 0:N.current)||void 0===e||e.click()},X=e=>{e.stopPropagation()},G=()=>{let e;switch(i){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=i}return r(us,{type:e,active:z,disabled:m,$selected:z,$disabled:m})},J=()=>{if(!g)return null;let e;return e="function"==typeof g?g():g,r(rs,{"data-id":"toggle-sublabel",id:`${W}-sublabel`,"aria-hidden":!0,children:e})},K=n=>e(t,{children:[r(ds,{weight:"semibold",$disabled:m,children:"Error"}),r(cs,{$disabled:m,children:null==n?void 0:n.map(((e,t)=>r("li",{id:`${W}-error-list-item-${t}`,children:r(ds,{weight:"semibold",$disabled:m,children:e})},t)))})]});return e(Xa,{$selected:z,$disabled:m,className:v,$styleType:d,$error:p,$indicator:s,$useContentWidth:F,id:y,"data-testid":D,children:[(()=>{const t=["string"==typeof g?`${W}-sublabel`:null,k].filter(Boolean).join(" ")||void 0;return e(ts,{id:`${W}-header-container`,$disabled:m,$error:p,$selected:z,$indicator:s,$styleType:d,children:[r(ns,{$addPadding:w,children:e(Ja,{id:`${W}-input-container`,onClick:Z,children:[r(Ga,Object.assign({ref:N,name:f,id:`${W}-input`,type:"checkbox"===i?"checkbox":"radio","data-testid":"toggle-input",disabled:V,"aria-disabled":H,$disabledVisual:m,onChange:q,onClick:X,checked:z,tabIndex:H?0:void 0,"aria-describedby":t},S)),s&&G(),e(Ka,{$selected:z,$disabled:m,children:[r(es,{htmlFor:`${W}-input`,"data-testid":"toggle-label",id:`${W}-label`,$maxLines:h,$selected:z,children:c}),g&&J()]})]})}),w&&r(is,{type:"button",$disabled:m,onClick:U,id:`${W}-remove-button`,children:"Remove"})]})})(),O&&e("div",{children:[(!A||T)&&r(ls,{"data-id":"toggle-composite-children",$isFinalItem:!A,$disabled:m,children:O}),A&&!T&&L&&r(as,{$disabled:m,onClick:Q,id:`${W}-error-alert`,children:r(ss,{type:m?"description":"error",className:v,showIcon:!0,children:Array.isArray(B)?K(B):B})}),A&&e(os,{$paddingTopRequired:!T&&!L,disabled:m,onClick:Q,"data-testid":T?"collapse-button":"expand-button",children:[T?"Show less":"Show more",r(T?j:M,{"aria-hidden":!0})]})]})]})}))`
...
`,Gu=v(Qo.Default)`
    width: 100%;
`,Ju=({onDismiss:t,onDone:n,children:i})=>e(Qu,{children:[r(Zu,{onClick:t,focusOutline:"browser",focusHighlight:!1,"aria-label":"Dismiss",children:r(ge,{})}),r(Uu,{children:i}),r(Xu,{children:r(Gu,{onClick:n,type:"button",children:"Done"})})]});Ju.displayName="Filter.Page";const Ku=v(Wo)`
...
`,eh=(t,n)=>{const{children:o,disabled:a=!1,styleType:s="default",danger:l=!1,icon:d,iconPosition:c="left",loading:u=!1,focusableWhenDisabled:h=!1,onClick:g}=t,m=me(t,["children","disabled","styleType","danger","icon","iconPosition","loading","focusableWhenDisabled","onClick"]),b={$buttonIconPosition:c,$buttonStyle:a?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Ku,Object.assign({ref:n,"data-testid":m["data-testid"]||"button-with-icon",disabled:a&&!h,"aria-disabled":a,"aria-busy":u,onClick:a?void 0:g},b,m,{children:[u?r(Ro,{}):d?i.cloneElement(d,{"aria-hidden":!0}):null,r("span",{children:o})]}))};eh.displayName="ButtonWithIcon.Default";const rh=(t,n)=>{const{children:o,disabled:a=!1,styleType:s="default",danger:l=!1,icon:d,iconPosition:c="left",loading:u=!1,focusableWhenDisabled:h=!1,onClick:g}=t,m=me(t,["children","disabled","styleType","danger","icon","iconPosition","loading","focusableWhenDisabled","onClick"]),b={$buttonIconPosition:c,$buttonStyle:a?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Ku,Object.assign({ref:n,"data-testid":m["data-testid"]||"button-with-icon",disabled:a&&!h,"aria-disabled":a,"aria-busy":u,onClick:a?void 0:g},b,m,{children:[u?r(Ro,{}):d?i.cloneElement(d,{"aria-hidden":!0}):null,r("span",{children:o})]}))};rh.displayName="ButtonWithIcon.Small";const th={Default:i.forwardRef(eh),Small:i.forwardRef(rh)},nh=v.div`
    background-color: ${gi["bg-strong"]};
    height: 100%;
    width: 100%;
    display: flex;
...
`,dh=v(th.Default)`
    width: 100%;
`,ch=t=>{var{customLabels:n,onClear:i,onDone:s,onDismiss:l,onModalOpen:d,toggleFilterButtonStyle:c="light",clearButtonDisabled:h=!1,insets:g,children:m,toggleFilterButtonLabel:b,headerTitle:p,doneButtonLabel:f}=t,y=me(t,["customLabels","onClear","onDone","onDismiss","onModalOpen","toggleFilterButtonStyle","clearButtonDisabled","insets","children","toggleFilterButtonLabel","headerTitle","doneButtonLabel"]);const{context:v,refs:x}=J(),w=o(null),[$,F]=a(!1),C={toggle:(null==n?void 0:n.toggleFilterButtonLabel)||b||"Filters",title:(null==n?void 0:n.headerTitle)||p||"Filters",done:(null==n?void 0:n.doneButtonLabel)||f||"Done",clear:(null==n?void 0:n.clearButtonLabel)||"Clear"};return u((()=>{var e;$&&(null===(e=w.current)||void 0===e||e.focus())}),[$]),e(Bo.Provider,{value:{mode:"mobile",rootNode:w},children:[r("div",Object.assign({},y,{children:r(dh,{"data-testid":"filter-show-button",styleType:c,onClick:()=>{F(!0),null==d||d()},type:"button",icon:r(_,{}),children:C.toggle})})),r(eu,{show:$,disableTransition:!0,children:r(oh,{inert:Da(!$),children:r(te,{context:v,disabled:!$,children:r(ih,{"data-id":"filter-mobile","data-testid":"filter-mobile",ref:x.setFloating,children:e(nh,{ref:w,tabIndex:0,children:[e(ah,{$insetTop:null==g?void 0:g.top,children:[r(Zu,{onClick:()=>{F(!1),null==l||l()},focusOutline:"browser",focusHighlight:!1,"aria-label":`close ${C.title}`,children:r(z,{})}),r(sh,{children:C.title}),r(lh,{styleType:"link",type:"button",onClick:()=>null==i?void 0:i(),disabled:h,"aria-label":`clear ${C.title}`,children:C.clear})]}),r(Uu,{children:m}),r(Xu,{$insetBottom:null==g?void 0:g.bottom,children:r(Gu,{onClick:()=>{F(!1),null==s||s()},children:C.done})})]})})})})})]})};ch.displayName="Filter.Modal";const uh=v.div`
    background-color: ${gi.bg};
...
`,mh=v(Qo.Small)`
    ...
    height: 100%;
`,bh=t=>{var{customLabels:n,onClear:i,clearButtonDisabled:a=!1,children:s,headerTitle:l}=t,d=me(t,["customLabels","onClear","clearButtonDisabled","children","headerTitle"]);const c=o(null),u={title:(null==n?void 0:n.headerTitle)||l||"Filters",clear:(null==n?void 0:n.clearButtonLabel)||"Clear"};return r(Bo.Provider,{value:{mode:"default",rootNode:c},children:e(uh,Object.assign({"data-id":"filter-desktop","data-testid":"filter-desktop",ref:c},d,{children:[e(hh,{children:[r(gh,{children:u.title}),r(mh,{styleType:"link",type:"button",onClick:()=>null==i?void 0:i(),disabled:a,"aria-label":`clear ${u.title}`,children:u.clear})]}),r(Uu,{children:s})]}))})};bh.displayName="Filter.Sidebar";const ph=e=>{var{children:t,className:n,style:i,onDismiss:o,onDone:a,onModalOpen:s,toggleFilterButtonStyle:l,insets:d,id:c,"data-testid":h}=e,g=me(e,["children","className","style","onDismiss","onDone","onModalOpen","toggleFilterButtonStyle","insets","id","data-testid"]);const m=f(F),b=xi["lg-max"]({theme:m}),p=ve.useMediaQuery({maxWidth:b});return u((()=>{p||null==o||o()}),[p]),r("div",{className:n,style:i,id:c,"data-testid":h,children:p?r(ch,Object.assign({onDismiss:o,onDone:a,onModalOpen:s,toggleFilterButtonStyle:l,insets:d},g,{children:"function"==typeof t?t("mobile"):t})):r(bh,Object.assign({},g,{children:"function"==typeof t?t("default"):t}))})};ph.Sidebar=bh,ph.Modal=ch,ph.Item=Lu,ph.Page=Ju,ph.Checkbox=qu;export{ph as Filter};
