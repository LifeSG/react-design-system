...
`,oi=$.div`
    ...
    ${e=>e.$disabled?x`
            ...
            `:x`
                color: ${xr.Neutral[1]};
            `}
`;var ai=function(e){return null==e},si=Object.defineProperty,li={};((e,t)=>{for(var n in t)si(e,n,{get:t[n],enumerable:!0})})(li,{assign:()=>Ni,colors:()=>Hi,createStringInterpolator:()=>Pi,skipAnimation:()=>zi,to:()=>Ai,willAdvance:()=>Ri});var ci=_i(),ui=e=>$i(e,ci),di=_i();ui.write=e=>$i(e,di);var hi=_i();ui.onStart=e=>$i(e,hi);var fi=_i();ui.onFrame=e=>$i(e,fi);var pi=_i();ui.onFinish=e=>$i(e,pi);var mi=[];ui.setTimeout=(e,t)=>{const n=ui.now()+t,r=()=>{const e=mi.findIndex((e=>e.cancel==r));~e&&mi.splice(e,1),bi-=~e?1:0},i={time:n,handler:e,cancel:r};return mi.splice(gi(n),0,i),bi+=1,xi(),i};var gi=e=>~(~mi.findIndex((t=>t.time>e))||~mi.length);ui.cancel=e=>{hi.delete(e),fi.delete(e),pi.delete(e),ci.delete(e),di.delete(e)},ui.sync=e=>{wi=!0,ui.batchedUpdates(e),wi=!1},ui.throttle=e=>{let t;function n(){try{e(...t)}finally{t=null}}function r(...e){t=e,ui.onStart(n)}return r.handler=e,r.cancel=()=>{hi.delete(n),t=null},r};var yi="undefined"!=typeof window?window.requestAnimationFrame:()=>{};ui.use=e=>yi=e,ui.now="undefined"!=typeof performance?()=>performance.now():Date.now,ui.batchedUpdates=e=>e(),ui.catch=console.error,ui.frameLoop="always",ui.advance=()=>{"demand"!==ui.frameLoop?console.warn("Cannot call the manual advancement of rafz whilst frameLoop is not set as demand"):Oi()};var vi=-1,bi=0,wi=!1;function $i(e,t){wi?(t.delete(e),e(0)):(t.add(e),xi())}function xi(){vi<0&&(vi=0,"demand"!==ui.frameLoop&&yi(Si))}function Si(){~vi&&(yi(Si),ui.batchedUpdates(Oi))}function Oi(){const e=vi;vi=ui.now();const t=gi(vi);t&&(Fi(mi.splice(0,t),(e=>e.handler())),bi-=t),bi?(hi.flush(),ci.flush(e?Math.min(64,vi-e):16.667),fi.flush(),di.flush(),pi.flush()):vi=-1}function _i(){let e=new Set,t=e;return{add(n){bi+=t!=e||e.has(n)?0:1,e.add(n)},delete:n=>(bi-=t==e&&e.has(n)?1:0,e.delete(n)),flush(n){t.size&&(e=new Set,bi-=t.size,Fi(t,(t=>t(n)&&e.add(t))),bi+=e.size,t=e)}}}function Fi(e,t){e.forEach((e=>{try{t(e)}catch(e){ui.catch(e)}}))}function Di(){}var ki={arr:Array.isArray,obj:e=>!!e&&"Object"===e.constructor.name,fun:e=>"function"==typeof e,str:e=>"string"==typeof e,num:e=>"number"==typeof e,und:e=>void 0===e};function Bi(e,t){if(ki.arr(e)){if(!ki.arr(t)||e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}return e===t}var ji=(e,t)=>e.forEach(t);function Mi(e,t,n){if(ki.arr(e))for(let r=0;r<e.length;r++)t.call(n,e[r],`${r}`);else for(const r in e)e.hasOwnProperty(r)&&t.call(n,e[r],r)}var Ei=e=>ki.und(e)?[]:ki.arr(e)?e:[e];function Ci(e,t){if(e.size){const n=Array.from(e);e.clear(),ji(n,t)}}var Pi,Ai,Ti=(e,...t)=>Ci(e,(e=>e(...t))),Ii=()=>"undefined"==typeof window||!window.navigator||/ServerSideRendering|^Deno\//.test(window.navigator.userAgent),Hi=null,zi=!1,Ri=Di,Ni=e=>{e.to&&(Ai=e.to),e.now&&(ui.now=e.now),void 0!==e.colors&&(Hi=e.colors),null!=e.skipAnimation&&(zi=e.skipAnimation),e.createStringInterpolator&&(Pi=e.createStringInterpolator),e.requestAnimationFrame&&ui.use(e.requestAnimationFrame),e.batchedUpdates&&(ui.batchedUpdates=e.batchedUpdates),e.willAdvance&&(Ri=e.willAdvance),e.frameLoop&&(ui.frameLoop=e.frameLoop)},Li=new Set,Wi=[],Vi=[],Yi=0,qi={get idle(){return!Li.size&&!Wi.length},start(e){Yi>e.priority?(Li.add(e),ui.onStart(Qi)):(Ui(e),ui(Gi))},advance:Gi,sort(e){if(Yi)ui.onFrame((()=>qi.sort(e)));else{const t=Wi.indexOf(e);~t&&(Wi.splice(t,1),Zi(e))}},clear(){Wi=[],Li.clear()}};function Qi(){Li.forEach(Ui),Li.clear(),ui(Gi)}function Ui(e){Wi.includes(e)||Zi(e)}function Zi(e){Wi.splice(function(e,t){const n=e.findIndex(t);return n<0?e.length:n}(Wi,(t=>t.priority>e.priority)),0,e)}function Gi(e){const t=Vi;for(let n=0;n<Wi.length;n++){const r=Wi[n];Yi=r.priority,r.idle||(Ri(r),r.advance(e),r.idle||t.push(r))}return Yi=0,(Vi=Wi).length=0,(Wi=t).length>0}var Xi="[-+]?\\d*\\.?\\d+",Ji=Xi+"%";function Ki(...e){return"\\(\\s*("+e.join(")\\s*,\\s*(")+")\\s*\\)"}var eo=new RegExp("rgb"+Ki(Xi,Xi,Xi)),to=new RegExp("rgba"+Ki(Xi,Xi,Xi,Xi)),no=new RegExp("hsl"+Ki(Xi,Ji,Ji)),ro=new RegExp("hsla"+Ki(Xi,Ji,Ji,Xi)),io=/^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,oo=/^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,ao=/^#([0-9a-fA-F]{6})$/,so=/^#([0-9a-fA-F]{8})$/;function lo(e,t,n){return n<0&&(n+=1),n>1&&(n-=1),n<1/6?e+6*(t-e)*n:n<.5?t:n<2/3?e+(t-e)*(2/3-n)*6:e}function co(e,t,n){const r=n<.5?n*(1+t):n+t-n*t,i=2*n-r,o=lo(i,r,e+1/3),a=lo(i,r,e),s=lo(i,r,e-1/3);return Math.round(255*o)<<24|Math.round(255*a)<<16|Math.round(255*s)<<8}function uo(e){const t=parseInt(e,10);return t<0?0:t>255?255:t}function ho(e){return(parseFloat(e)%360+360)%360/360}function fo(e){const t=parseFloat(e);return t<0?0:t>1?255:Math.round(255*t)}function po(e){const t=parseFloat(e);return t<0?0:t>100?1:t/100}function mo(e){let t=function(e){let t;return"number"==typeof e?e>>>0===e&&e>=0&&e<=4294967295?e:null:(t=ao.exec(e))?parseInt(t[1]+"ff",16)>>>0:Hi&&void 0!==Hi[e]?Hi[e]:(t=eo.exec(e))?(uo(t[1])<<24|uo(t[2])<<16|uo(t[3])<<8|255)>>>0:(t=to.exec(e))?(uo(t[1])<<24|uo(t[2])<<16|uo(t[3])<<8|fo(t[4]))>>>0:(t=io.exec(e))?parseInt(t[1]+t[1]+t[2]+t[2]+t[3]+t[3]+"ff",16)>>>0:(t=so.exec(e))?parseInt(t[1],16)>>>0:(t=oo.exec(e))?parseInt(t[1]+t[1]+t[2]+t[2]+t[3]+t[3]+t[4]+t[4],16)>>>0:(t=no.exec(e))?(255|co(ho(t[1]),po(t[2]),po(t[3])))>>>0:(t=ro.exec(e))?(co(ho(t[1]),po(t[2]),po(t[3]))|fo(t[4]))>>>0:null}(e);if(null===t)return e;t=t||0;return`rgba(${(4278190080&t)>>>24}, ${(16711680&t)>>>16}, ${(65280&t)>>>8}, ${(255&t)/255})`}var go=(e,t,n)=>{if(ki.fun(e))return e;if(ki.arr(e))return go({range:e,output:t,extrapolate:n});if(ki.str(e.output[0]))return Pi(e);const r=e,i=r.output,o=r.range||[0,1],a=r.extrapolateLeft||r.extrapolate||"extend",s=r.extrapolateRight||r.extrapolate||"extend",l=r.easing||(e=>e);return e=>{const t=function(e,t){for(var n=1;n<t.length-1&&!(t[n]>=e);++n);return n-1}(e,o);return function(e,t,n,r,i,o,a,s,l){let c=l?l(e):e;if(c<t){if("identity"===a)return c;"clamp"===a&&(c=t)}if(c>n){if("identity"===s)return c;"clamp"===s&&(c=n)}if(r===i)return r;if(t===n)return e<=t?r:i;t===-1/0?c=-c:n===1/0?c-=t:c=(c-t)/(n-t);c=o(c),r===-1/0?c=-c:i===1/0?c+=r:c=c*(i-r)+r;return c}(e,o[t],o[t+1],i[t],i[t+1],l,a,s,r.map)}};var yo=1.70158,vo=1.525*yo,bo=yo+1,wo=2*Math.PI/3,$o=2*Math.PI/4.5,xo=e=>{const t=7.5625,n=2.75;return e<1/n?t*e*e:e<2/n?t*(e-=1.5/n)*e+.75:e<2.5/n?t*(e-=2.25/n)*e+.9375:t*(e-=2.625/n)*e+.984375},So={linear:e=>e,easeInQuad:e=>e*e,easeOutQuad:e=>1-(1-e)*(1-e),easeInOutQuad:e=>e<.5?2*e*e:1-Math.pow(-2*e+2,2)/2,easeInCubic:e=>e*e*e,easeOutCubic:e=>1-Math.pow(1-e,3),easeInOutCubic:e=>e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2,easeInQuart:e=>e*e*e*e,easeOutQuart:e=>1-Math.pow(1-e,4),easeInOutQuart:e=>e<.5?8*e*e*e*e:1-Math.pow(-2*e+2,4)/2,easeInQuint:e=>e*e*e*e*e,easeOutQuint:e=>1-Math.pow(1-e,5),easeInOutQuint:e=>e<.5?16*e*e*e*e*e:1-Math.pow(-2*e+2,5)/2,easeInSine:e=>1-Math.cos(e*Math.PI/2),easeOutSine:e=>Math.sin(e*Math.PI/2),easeInOutSine:e=>-(Math.cos(Math.PI*e)-1)/2,easeInExpo:e=>0===e?0:Math.pow(2,10*e-10),easeOutExpo:e=>1===e?1:1-Math.pow(2,-10*e),easeInOutExpo:e=>0===e?0:1===e?1:e<.5?Math.pow(2,20*e-10)/2:(2-Math.pow(2,-20*e+10))/2,easeInCirc:e=>1-Math.sqrt(1-Math.pow(e,2)),easeOutCirc:e=>Math.sqrt(1-Math.pow(e-1,2)),easeInOutCirc:e=>e<.5?(1-Math.sqrt(1-Math.pow(2*e,2)))/2:(Math.sqrt(1-Math.pow(-2*e+2,2))+1)/2,easeInBack:e=>bo*e*e*e-yo*e*e,easeOutBack:e=>1+bo*Math.pow(e-1,3)+yo*Math.pow(e-1,2),easeInOutBack:e=>e<.5?Math.pow(2*e,2)*(7.189819*e-vo)/2:(Math.pow(2*e-2,2)*((vo+1)*(2*e-2)+vo)+2)/2,easeInElastic:e=>0===e?0:1===e?1:-Math.pow(2,10*e-10)*Math.sin((10*e-10.75)*wo),easeOutElastic:e=>0===e?0:1===e?1:Math.pow(2,-10*e)*Math.sin((10*e-.75)*wo)+1,easeInOutElastic:e=>0===e?0:1===e?1:e<.5?-Math.pow(2,20*e-10)*Math.sin((20*e-11.125)*$o)/2:Math.pow(2,-20*e+10)*Math.sin((20*e-11.125)*$o)/2+1,easeInBounce:e=>1-xo(1-e),easeOutBounce:xo,easeInOutBounce:e=>e<.5?(1-xo(1-2*e))/2:(1+xo(2*e-1))/2,steps:(e,t="end")=>n=>{const r=(n="end"===t?Math.min(n,.999):Math.max(n,.001))*e,i="end"===t?Math.floor(r):Math.ceil(r);return o=0,a=1,s=i/e,Math.min(Math.max(s,o),a);var o,a,s}},Oo=Symbol.for("FluidValue.get"),_o=Symbol.for("FluidValue.observers"),Fo=e=>Boolean(e&&e[Oo]),Do=e=>e&&e[Oo]?e[Oo]():e,ko=e=>e[_o]||null;function Bo(e,t){const n=e[_o];n&&n.forEach((e=>{!function(e,t){e.eventObserved?e.eventObserved(t):e(t)}(e,t)}))}var jo=class{constructor(e){if(!e&&!(e=this.get))throw Error("Unknown getter");Mo(this,e)}},Mo=(e,t)=>Ao(e,Oo,t);function Eo(e,t){if(e[Oo]){let n=e[_o];n||Ao(e,_o,n=new Set),n.has(t)||(n.add(t),e.observerAdded&&e.observerAdded(n.size,t))}return t}function Co(e,t){const n=e[_o];if(n&&n.has(t)){const r=n.size-1;r?n.delete(t):e[_o]=null,e.observerRemoved&&e.observerRemoved(r,t)}}var Po,Ao=(e,t,n)=>Object.defineProperty(e,t,{value:n,writable:!0,configurable:!0}),To=/[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,Io=/(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi,Ho=new RegExp(`(${To.source})(%|[a-z]+)`,"i"),zo=/rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,Ro=/var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/,No=e=>{const[t,n]=Lo(e);if(!t||Ii())return e;const r=window.getComputedStyle(document.documentElement).getPropertyValue(t);if(r)return r.trim();if(n&&n.startsWith("--")){const t=window.getComputedStyle(document.documentElement).getPropertyValue(n);return t||e}return n&&Ro.test(n)?No(n):n||e},Lo=e=>{const t=Ro.exec(e);if(!t)return[,];const[,n,r]=t;return[n,r]},Wo=(e,t,n,r,i)=>`rgba(${Math.round(t)}, ${Math.round(n)}, ${Math.round(r)}, ${i})`,Vo=e=>{Po||(Po=Hi?new RegExp(`(${Object.keys(Hi).join("|")})(?!\\w)`,"g"):/^\b$/);const t=e.output.map((e=>Do(e).replace(Ro,No).replace(Io,mo).replace(Po,mo))),n=t.map((e=>e.match(To).map(Number))),r=n[0].map(((e,t)=>n.map((e=>{if(!(t in e))throw Error('The arity of each "output" value must be equal');return e[t]})))).map((t=>go({...e,output:t})));return e=>{const n=!Ho.test(t[0])&&t.find((e=>Ho.test(e)))?.replace(To,"");let i=0;return t[0].replace(To,(()=>`${r[i++](e)}${n||""}`)).replace(zo,Wo)}},Yo="react-spring: ",qo=e=>{const t=e;let n=!1;if("function"!=typeof t)throw new TypeError(`${Yo}once requires a function parameter`);return(...e)=>{n||(t(...e),n=!0)}},Qo=qo(console.warn);var Uo=qo(console.warn);function Zo(e){return ki.str(e)&&("#"==e[0]||/\d/.test(e)||!Ii()&&Ro.test(e)||e in(Hi||{}))}var Go=Ii()?h:f,Xo=()=>{const e=s(!1);return Go((()=>(e.current=!0,()=>{e.current=!1})),[]),e};function Jo(){const e=l()[1],t=Xo();return()=>{t.current&&e(Math.random())}}var Ko=e=>h(e,ea),ea=[];function ta(e){const t=s();return h((()=>{t.current=e})),t.current}var na=Symbol.for("Animated:node"),ra=e=>e&&e[na],ia=(e,t)=>{return n=e,r=na,i=t,Object.defineProperty(n,r,{value:i,writable:!0,configurable:!0});var n,r,i},oa=e=>e&&e[na]&&e[na].getPayload(),aa=class{constructor(){ia(this,this)}getPayload(){return this.payload||[]}},sa=class extends aa{constructor(e){super(),this._value=e,this.done=!0,this.durationProgress=0,ki.num(this._value)&&(this.lastPosition=this._value)}static create(e){return new sa(e)}getPayload(){return[this]}getValue(){return this._value}setValue(e,t){return ki.num(e)&&(this.lastPosition=e,t&&(e=Math.round(e/t)*t,this.done&&(this.lastPosition=e))),this._value!==e&&(this._value=e,!0)}reset(){const{done:e}=this;this.done=!1,ki.num(this._value)&&(this.elapsedTime=0,this.durationProgress=0,this.lastPosition=this._value,e&&(this.lastVelocity=null),this.v0=null)}},la=class extends sa{constructor(e){super(0),this._string=null,this._toString=go({output:[e,e]})}static create(e){return new la(e)}getValue(){const e=this._string;return null==e?this._string=this._toString(this._value):e}setValue(e){if(ki.str(e)){if(e==this._string)return!1;this._string=e,this._value=1}else{if(!super.setValue(e))return!1;this._string=null}return!0}reset(e){e&&(this._toString=go({output:[this.getValue(),e]})),this._value=0,super.reset()}},ca={dependencies:null},ua=class extends aa{constructor(e){super(),this.source=e,this.setValue(e)}getValue(e){const t={};return Mi(this.source,((n,r)=>{var i;(i=n)&&i[na]===i?t[r]=n.getValue(e):Fo(n)?t[r]=Do(n):e||(t[r]=n)})),t}setValue(e){this.source=e,this.payload=this._makePayload(e)}reset(){this.payload&&ji(this.payload,(e=>e.reset()))}_makePayload(e){if(e){const t=new Set;return Mi(e,this._addToPayload,t),Array.from(t)}}_addToPayload(e){ca.dependencies&&Fo(e)&&ca.dependencies.add(e);const t=oa(e);t&&ji(t,(e=>this.add(e)))}},da=class extends ua{constructor(e){super(e)}static create(e){return new da(e)}getValue(){return this.source.map((e=>e.getValue()))}setValue(e){const t=this.getPayload();return e.length==t.length?t.map(((t,n)=>t.setValue(e[n]))).some(Boolean):(super.setValue(e.map(ha)),!0)}};function ha(e){return(Zo(e)?la:sa).create(e)}function fa(e){const t=ra(e);return t?t.constructor:ki.arr(e)?da:Zo(e)?la:sa}var pa=(e,t)=>{const n=!ki.fun(e)||e.prototype&&e.prototype.isReactComponent;return p(((r,o)=>{const a=s(null),l=n&&m((e=>{a.current=function(e,t){e&&(ki.fun(e)?e(t):e.current=t);return t}(o,e)}),[o]),[c,u]=function(e,t){const n=new Set;ca.dependencies=n,e.style&&(e={...e,style:t.createAnimatedStyle(e.style)});return e=new ua(e),ca.dependencies=null,[e,n]}(r,t),d=Jo(),f=()=>{const e=a.current;if(n&&!e)return;!1===(!!e&&t.applyAnimatedValues(e,c.getValue(!0)))&&d()},p=new ma(f,u),g=s();Go((()=>(g.current=p,ji(u,(e=>Eo(e,p))),()=>{g.current&&(ji(g.current.deps,(e=>Co(e,g.current))),ui.cancel(g.current.update))}))),h(f,[]),Ko((()=>()=>{const e=g.current;ji(e.deps,(t=>Co(t,e)))}));const y=t.getComponentProps(c.getValue());return i.createElement(e,{...y,ref:l})}))},ma=class{constructor(e,t){this.update=e,this.deps=t}eventObserved(e){"change"==e.type&&ui.write(this.update)}};var ga=Symbol.for("AnimatedComponent"),ya=e=>ki.str(e)?e:e&&ki.str(e.displayName)?e.displayName:ki.fun(e)&&e.name||null;function va(e,...t){return ki.fun(e)?e(...t):e}var ba=(e,t)=>!0===e||!!(t&&e&&(ki.fun(e)?e(t):Ei(e).includes(t))),wa=(e,t)=>ki.obj(e)?t&&e[t]:e,$a=(e,t)=>!0===e.default?e[t]:e.default?e.default[t]:void 0,xa=e=>e,Sa=(e,t=xa)=>{let n=Oa;e.default&&!0!==e.default&&(e=e.default,n=Object.keys(e));const r={};for(const i of n){const n=t(e[i],i);ki.und(n)||(r[i]=n)}return r},Oa=["config","onProps","onStart","onChange","onPause","onResume","onRest"],_a={config:1,from:1,to:1,ref:1,loop:1,reset:1,pause:1,cancel:1,reverse:1,immediate:1,default:1,delay:1,onProps:1,onStart:1,onChange:1,onPause:1,onResume:1,onRest:1,onResolve:1,items:1,trail:1,sort:1,expires:1,initial:1,enter:1,update:1,leave:1,children:1,onDestroyed:1,keys:1,callId:1,parentId:1};function Fa(e){const t=function(e){const t={};let n=0;if(Mi(e,((e,r)=>{_a[r]||(t[r]=e,n++)})),n)return t}(e);if(t){const n={to:t};return Mi(e,((e,r)=>r in t||(n[r]=e))),n}return{...e}}function Da(e){return e=Do(e),ki.arr(e)?e.map(Da):Zo(e)?li.createStringInterpolator({range:[0,1],output:[e,e]})(1):e}function ka(e){return ki.fun(e)||ki.arr(e)&&ki.obj(e[0])}var Ba={tension:170,friction:26,mass:1,damping:1,easing:So.linear,clamp:!1},ja=class{constructor(){this.velocity=0,Object.assign(this,Ba)}};function Ma(e,t){if(ki.und(t.decay)){const n=!ki.und(t.tension)||!ki.und(t.friction);!n&&ki.und(t.frequency)&&ki.und(t.damping)&&ki.und(t.mass)||(e.duration=void 0,e.decay=void 0),n&&(e.frequency=void 0)}else e.duration=void 0}var Ea=[],Ca=class{constructor(){this.changed=!1,this.values=Ea,this.toValues=null,this.fromValues=Ea,this.config=new ja,this.immediate=!1}};function Pa(e,{key:t,props:n,defaultProps:r,state:i,actions:o}){return new Promise(((a,s)=>{let l,c,u=ba(n.cancel??r?.cancel,t);if(u)f();else{ki.und(n.pause)||(i.paused=ba(n.pause,t));let e=r?.pause;!0!==e&&(e=i.paused||ba(e,t)),l=va(n.delay||0,t),e?(i.resumeQueue.add(h),o.pause()):(o.resume(),h())}function d(){i.resumeQueue.add(h),i.timeouts.delete(c),c.cancel(),l=c.time-ui.now()}function h(){l>0&&!li.skipAnimation?(i.delayed=!0,c=ui.setTimeout(f,l),i.pauseQueue.add(d),i.timeouts.add(c)):f()}function f(){i.delayed&&(i.delayed=!1),i.pauseQueue.delete(d),i.timeouts.delete(c),e<=(i.cancelId||0)&&(u=!0);try{o.start({...n,callId:e,cancel:u},a)}catch(e){s(e)}}}))}var Aa=(e,t)=>1==t.length?t[0]:t.some((e=>e.cancelled))?Ha(e.get()):t.every((e=>e.noop))?Ta(e.get()):Ia(e.get(),t.every((e=>e.finished))),Ta=e=>({value:e,noop:!0,finished:!0,cancelled:!1}),Ia=(e,t,n=!1)=>({value:e,finished:t,cancelled:n}),Ha=e=>({value:e,cancelled:!0,finished:!1});function za(e,t,n,r){const{callId:i,parentId:o,onRest:a}=t,{asyncTo:s,promise:l}=n;return o||e!==s||t.reset?n.promise=(async()=>{n.asyncId=i,n.asyncTo=e;const c=Sa(t,((e,t)=>"onRest"===t?void 0:e));let u,d;const h=new Promise(((e,t)=>(u=e,d=t))),f=e=>{const t=i<=(n.cancelId||0)&&Ha(r)||i!==n.asyncId&&Ia(r,!1);if(t)throw e.result=t,d(e),e},p=(e,t)=>{const o=new Na,a=new La;return(async()=>{if(li.skipAnimation)throw Ra(n),a.result=Ia(r,!1),d(a),a;f(o);const s=ki.obj(e)?{...e}:{...t,to:e};s.parentId=i,Mi(c,((e,t)=>{ki.und(s[t])&&(s[t]=e)}));const l=await r.start(s);return f(o),n.paused&&await new Promise((e=>{n.resumeQueue.add(e)})),l})()};let m;if(li.skipAnimation)return Ra(n),Ia(r,!1);try{let t;t=ki.arr(e)?(async e=>{for(const t of e)await p(t)})(e):Promise.resolve(e(p,r.stop.bind(r))),await Promise.all([t.then(u),h]),m=Ia(r.get(),!0,!1)}catch(e){if(e instanceof Na)m=e.result;else{if(!(e instanceof La))throw e;m=e.result}}finally{i==n.asyncId&&(n.asyncId=o,n.asyncTo=o?s:void 0,n.promise=o?l:void 0)}return ki.fun(a)&&ui.batchedUpdates((()=>{a(m,r,r.item)})),m})():l}function Ra(e,t){Ci(e.timeouts,(e=>e.cancel())),e.pauseQueue.clear(),e.resumeQueue.clear(),e.asyncId=e.asyncTo=e.promise=void 0,t&&(e.cancelId=t)}var Na=class extends Error{constructor(){super("An async animation has been interrupted. You see this error because you forgot to use `await` or `.catch(...)` on its returned promise.")}},La=class extends Error{constructor(){super("SkipAnimationSignal")}},Wa=e=>e instanceof Ya,Va=1,Ya=class extends jo{constructor(){super(...arguments),this.id=Va++,this._priority=0}get priority(){return this._priority}set priority(e){this._priority!=e&&(this._priority=e,this._onPriorityChange(e))}get(){const e=ra(this);return e&&e.getValue()}to(...e){return li.to(this,e)}interpolate(...e){return Qo(`${Yo}The "interpolate" function is deprecated in v9 (use "to" instead)`),li.to(this,e)}toJSON(){return this.get()}observerAdded(e){1==e&&this._attach()}observerRemoved(e){0==e&&this._detach()}_attach(){}_detach(){}_onChange(e,t=!1){Bo(this,{type:"change",parent:this,value:e,idle:t})}_onPriorityChange(e){this.idle||qi.sort(this),Bo(this,{type:"priority",parent:this,priority:e})}},qa=Symbol.for("SpringPhase"),Qa=e=>(1&e[qa])>0,Ua=e=>(2&e[qa])>0,Za=e=>(4&e[qa])>0,Ga=(e,t)=>t?e[qa]|=3:e[qa]&=-3,Xa=(e,t)=>t?e[qa]|=4:e[qa]&=-5,Ja=class extends Ya{constructor(e,t){if(super(),this.animation=new Ca,this.defaultProps={},this._state={paused:!1,delayed:!1,pauseQueue:new Set,resumeQueue:new Set,timeouts:new Set},this._pendingCalls=new Set,this._lastCallId=0,this._lastToId=0,this._memoizedDuration=0,!ki.und(e)||!ki.und(t)){const n=ki.obj(e)?{...e}:{...t,from:e};ki.und(n.default)&&(n.default=!0),this.start(n)}}get idle(){return!(Ua(this)||this._state.asyncTo)||Za(this)}get goal(){return Do(this.animation.to)}get velocity(){const e=ra(this);return e instanceof sa?e.lastVelocity||0:e.getPayload().map((e=>e.lastVelocity||0))}get hasAnimated(){return Qa(this)}get isAnimating(){return Ua(this)}get isPaused(){return Za(this)}get isDelayed(){return this._state.delayed}advance(e){let t=!0,n=!1;const r=this.animation;let{toValues:i}=r;const{config:o}=r,a=oa(r.to);!a&&Fo(r.to)&&(i=Ei(Do(r.to))),r.values.forEach(((s,l)=>{if(s.done)return;const c=s.constructor==la?1:a?a[l].lastPosition:i[l];let u=r.immediate,d=c;if(!u){if(d=s.lastPosition,o.tension<=0)return void(s.done=!0);let t=s.elapsedTime+=e;const n=r.fromValues[l],i=null!=s.v0?s.v0:s.v0=ki.arr(o.velocity)?o.velocity[l]:o.velocity;let a;const h=o.precision||(n==c?.005:Math.min(1,.001*Math.abs(c-n)));if(ki.und(o.duration))if(o.decay){const e=!0===o.decay?.998:o.decay,r=Math.exp(-(1-e)*t);d=n+i/(1-e)*(1-r),u=Math.abs(s.lastPosition-d)<=h,a=i*r}else{a=null==s.lastVelocity?i:s.lastVelocity;const t=o.restVelocity||h/10,r=o.clamp?0:o.bounce,l=!ki.und(r),f=n==c?s.v0>0:n<c;let p,m=!1;const g=1,y=Math.ceil(e/g);for(let e=0;e<y&&(p=Math.abs(a)>t,p||(u=Math.abs(c-d)<=h,!u));++e){l&&(m=d==c||d>c==f,m&&(a=-a*r,d=c));a+=(1e-6*-o.tension*(d-c)+.001*-o.friction*a)/o.mass*g,d+=a*g}}else{let r=1;o.duration>0&&(this._memoizedDuration!==o.duration&&(this._memoizedDuration=o.duration,s.durationProgress>0&&(s.elapsedTime=o.duration*s.durationProgress,t=s.elapsedTime+=e)),r=(o.progress||0)+t/this._memoizedDuration,r=r>1?1:r<0?0:r,s.durationProgress=r),d=n+o.easing(r)*(c-n),a=(d-s.lastPosition)/e,u=1==r}s.lastVelocity=a,Number.isNaN(d)&&(console.warn("Got NaN while animating:",this),u=!0)}a&&!a[l].done&&(u=!1),u?s.done=!0:t=!1,s.setValue(d,o.round)&&(n=!0)}));const s=ra(this),l=s.getValue();if(t){const e=Do(r.to);l===e&&!n||o.decay?n&&o.decay&&this._onChange(l):(s.setValue(e),this._onChange(e)),this._stop()}else n&&this._onChange(l)}set(e){return ui.batchedUpdates((()=>{this._stop(),this._focus(e),this._set(e)})),this}pause(){this._update({pause:!0})}resume(){this._update({pause:!1})}finish(){if(Ua(this)){const{to:e,config:t}=this.animation;ui.batchedUpdates((()=>{this._onStart(),t.decay||this._set(e,!1),this._stop()}))}return this}update(e){return(this.queue||(this.queue=[])).push(e),this}start(e,t){let n;return ki.und(e)?(n=this.queue||[],this.queue=[]):n=[ki.obj(e)?e:{...t,to:e}],Promise.all(n.map((e=>this._update(e)))).then((e=>Aa(this,e)))}stop(e){const{to:t}=this.animation;return this._focus(this.get()),Ra(this._state,e&&this._lastCallId),ui.batchedUpdates((()=>this._stop(t,e))),this}reset(){this._update({reset:!0})}eventObserved(e){"change"==e.type?this._start():"priority"==e.type&&(this.priority=e.priority+1)}_prepareNode(e){const t=this.key||"";let{to:n,from:r}=e;n=ki.obj(n)?n[t]:n,(null==n||ka(n))&&(n=void 0),r=ki.obj(r)?r[t]:r,null==r&&(r=void 0);const i={to:n,from:r};return Qa(this)||(e.reverse&&([n,r]=[r,n]),r=Do(r),ki.und(r)?ra(this)||this._set(n):this._set(r)),i}_update({...e},t){const{key:n,defaultProps:r}=this;e.default&&Object.assign(r,Sa(e,((e,t)=>/^on/.test(t)?wa(e,n):e))),os(this,e,"onProps"),as(this,"onProps",e,this);const i=this._prepareNode(e);if(Object.isFrozen(this))throw Error("Cannot animate a `SpringValue` object that is frozen. Did you forget to pass your component to `animated(...)` before animating its props?");const o=this._state;return Pa(++this._lastCallId,{key:n,props:e,defaultProps:r,state:o,actions:{pause:()=>{Za(this)||(Xa(this,!0),Ti(o.pauseQueue),as(this,"onPause",Ia(this,Ka(this,this.animation.to)),this))},resume:()=>{Za(this)&&(Xa(this,!1),Ua(this)&&this._resume(),Ti(o.resumeQueue),as(this,"onResume",Ia(this,Ka(this,this.animation.to)),this))},start:this._merge.bind(this,i)}}).then((n=>{if(e.loop&&n.finished&&(!t||!n.noop)){const t=es(e);if(t)return this._update(t,!0)}return n}))}_merge(e,t,n){if(t.cancel)return this.stop(!0),n(Ha(this));const r=!ki.und(e.to),i=!ki.und(e.from);if(r||i){if(!(t.callId>this._lastToId))return n(Ha(this));this._lastToId=t.callId}const{key:o,defaultProps:a,animation:s}=this,{to:l,from:c}=s;let{to:u=l,from:d=c}=e;!i||r||t.default&&!ki.und(u)||(u=d),t.reverse&&([u,d]=[d,u]);const h=!Bi(d,c);h&&(s.from=d),d=Do(d);const f=!Bi(u,l);f&&this._focus(u);const p=ka(t.to),{config:m}=s,{decay:g,velocity:y}=m;(r||i)&&(m.velocity=0),t.config&&!p&&function(e,t,n){n&&(Ma(n={...n},t),t={...n,...t}),Ma(e,t),Object.assign(e,t);for(const t in Ba)null==e[t]&&(e[t]=Ba[t]);let{frequency:r,damping:i}=e;const{mass:o}=e;ki.und(r)||(r<.01&&(r=.01),i<0&&(i=0),e.tension=Math.pow(2*Math.PI/r,2)*o,e.friction=4*Math.PI*i*o/r)}(m,va(t.config,o),t.config!==a.config?va(a.config,o):void 0);let v=ra(this);if(!v||ki.und(u))return n(Ia(this,!0));const b=ki.und(t.reset)?i&&!t.default:!ki.und(d)&&ba(t.reset,o),w=b?d:this.get(),$=Da(u),x=ki.num($)||ki.arr($)||Zo($),S=!p&&(!x||ba(a.immediate||t.immediate,o));if(f){const e=fa(u);if(e!==v.constructor){if(!S)throw Error(`Cannot animate between ${v.constructor.name} and ${e.name}, as the "to" prop suggests`);v=this._set($)}}const O=v.constructor;let _=Fo(u),F=!1;if(!_){const e=b||!Qa(this)&&h;(f||e)&&(F=Bi(Da(w),$),_=!F),(Bi(s.immediate,S)||S)&&Bi(m.decay,g)&&Bi(m.velocity,y)||(_=!0)}if(F&&Ua(this)&&(s.changed&&!b?_=!0:_||this._stop(l)),!p&&((_||Fo(l))&&(s.values=v.getPayload(),s.toValues=Fo(u)?null:O==la?[1]:Ei($)),s.immediate!=S&&(s.immediate=S,S||b||this._set(l)),_)){const{onRest:e}=s;ji(is,(e=>os(this,t,e)));const r=Ia(this,Ka(this,l));Ti(this._pendingCalls,r),this._pendingCalls.add(n),s.changed&&ui.batchedUpdates((()=>{s.changed=!b,e?.(r,this),b?va(a.onRest,r):s.onStart?.(r,this)}))}b&&this._set(w),p?n(za(t.to,t,this._state,this)):_?this._start():Ua(this)&&!f?this._pendingCalls.add(n):n(Ta(w))}_focus(e){const t=this.animation;e!==t.to&&(ko(this)&&this._detach(),t.to=e,ko(this)&&this._attach())}_attach(){let e=0;const{to:t}=this.animation;Fo(t)&&(Eo(t,this),Wa(t)&&(e=t.priority+1)),this.priority=e}_detach(){const{to:e}=this.animation;Fo(e)&&Co(e,this)}_set(e,t=!0){const n=Do(e);if(!ki.und(n)){const e=ra(this);if(!e||!Bi(n,e.getValue())){const r=fa(n);e&&e.constructor==r?e.setValue(n):ia(this,r.create(n)),e&&ui.batchedUpdates((()=>{this._onChange(n,t)}))}}return ra(this)}_onStart(){const e=this.animation;e.changed||(e.changed=!0,as(this,"onStart",Ia(this,Ka(this,e.to)),this))}_onChange(e,t){t||(this._onStart(),va(this.animation.onChange,e,this)),va(this.defaultProps.onChange,e,this),super._onChange(e,t)}_start(){const e=this.animation;ra(this).reset(Do(e.to)),e.immediate||(e.fromValues=e.values.map((e=>e.lastPosition))),Ua(this)||(Ga(this,!0),Za(this)||this._resume())}_resume(){li.skipAnimation?this.finish():qi.start(this)}_stop(e,t){if(Ua(this)){Ga(this,!1);const n=this.animation;ji(n.values,(e=>{e.done=!0})),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),Bo(this,{type:"idle",parent:this});const r=t?Ha(this.get()):Ia(this.get(),Ka(this,e??n.to));Ti(this._pendingCalls,r),n.changed&&(n.changed=!1,as(this,"onRest",r,this))}}};function Ka(e,t){const n=Da(t);return Bi(Da(e.get()),n)}function es(e,t=e.loop,n=e.to){const r=va(t);if(r){const i=!0!==r&&Fa(r),o=(i||e).reverse,a=!i||i.reset;return ts({...e,loop:t,default:!1,pause:void 0,to:!o||ka(n)?n:void 0,from:a?e.from:void 0,reset:a,...i})}}function ts(e){const{to:t,from:n}=e=Fa(e),r=new Set;return ki.obj(t)&&rs(t,r),ki.obj(n)&&rs(n,r),e.keys=r.size?Array.from(r):null,e}function ns(e){const t=ts(e);return ki.und(t.default)&&(t.default=Sa(t)),t}function rs(e,t){Mi(e,((e,n)=>null!=e&&t.add(n)))}var is=["onStart","onRest","onChange","onPause","onResume"];function os(e,t,n){e.animation[n]=t[n]!==$a(t,n)?wa(t[n],e.key):void 0}function as(e,t,...n){e.animation[t]?.(...n),e.defaultProps[t]?.(...n)}var ss=["onStart","onChange","onRest"],ls=1,cs=class{constructor(e,t){this.id=ls++,this.springs={},this.queue=[],this._lastAsyncId=0,this._active=new Set,this._changed=new Set,this._started=!1,this._state={paused:!1,pauseQueue:new Set,resumeQueue:new Set,timeouts:new Set},this._events={onStart:new Map,onChange:new Map,onRest:new Map},this._onFrame=this._onFrame.bind(this),t&&(this._flush=t),e&&this.start({default:!0,...e})}get idle(){return!this._state.asyncTo&&Object.values(this.springs).every((e=>e.idle&&!e.isDelayed&&!e.isPaused))}get item(){return this._item}set item(e){this._item=e}get(){const e={};return this.each(((t,n)=>e[n]=t.get())),e}set(e){for(const t in e){const n=e[t];ki.und(n)||this.springs[t].set(n)}}update(e){return e&&this.queue.push(ts(e)),this}start(e){let{queue:t}=this;return e?t=Ei(e).map(ts):this.queue=[],this._flush?this._flush(this,t):(gs(this,t),us(this,t))}stop(e,t){if(e!==!!e&&(t=e),t){const n=this.springs;ji(Ei(t),(t=>n[t].stop(!!e)))}else Ra(this._state,this._lastAsyncId),this.each((t=>t.stop(!!e)));return this}pause(e){if(ki.und(e))this.start({pause:!0});else{const t=this.springs;ji(Ei(e),(e=>t[e].pause()))}return this}resume(e){if(ki.und(e))this.start({pause:!1});else{const t=this.springs;ji(Ei(e),(e=>t[e].resume()))}return this}each(e){Mi(this.springs,e)}_onFrame(){const{onStart:e,onChange:t,onRest:n}=this._events,r=this._active.size>0,i=this._changed.size>0;(r&&!this._started||i&&!this._started)&&(this._started=!0,Ci(e,(([e,t])=>{t.value=this.get(),e(t,this,this._item)})));const o=!r&&this._started,a=i||o&&n.size?this.get():null;i&&t.size&&Ci(t,(([e,t])=>{t.value=a,e(t,this,this._item)})),o&&(this._started=!1,Ci(n,(([e,t])=>{t.value=a,e(t,this,this._item)})))}eventObserved(e){if("change"==e.type)this._changed.add(e.parent),e.idle||this._active.add(e.parent);else{if("idle"!=e.type)return;this._active.delete(e.parent)}ui.onFrame(this._onFrame)}};function us(e,t){return Promise.all(t.map((t=>ds(e,t)))).then((t=>Aa(e,t)))}async function ds(e,t,n){const{keys:r,to:i,from:o,loop:a,onRest:s,onResolve:l}=t,c=ki.obj(t.default)&&t.default;a&&(t.loop=!1),!1===i&&(t.to=null),!1===o&&(t.from=null);const u=ki.arr(i)||ki.fun(i)?i:void 0;u?(t.to=void 0,t.onRest=void 0,c&&(c.onRest=void 0)):ji(ss,(n=>{const r=t[n];if(ki.fun(r)){const i=e._events[n];t[n]=({finished:e,cancelled:t})=>{const n=i.get(r);n?(e||(n.finished=!1),t&&(n.cancelled=!0)):i.set(r,{value:null,finished:e||!1,cancelled:t||!1})},c&&(c[n]=t[n])}}));const d=e._state;t.pause===!d.paused?(d.paused=t.pause,Ti(t.pause?d.pauseQueue:d.resumeQueue)):d.paused&&(t.pause=!0);const h=(r||Object.keys(e.springs)).map((n=>e.springs[n].start(t))),f=!0===t.cancel||!0===$a(t,"cancel");(u||f&&d.asyncId)&&h.push(Pa(++e._lastAsyncId,{props:t,state:d,actions:{pause:Di,resume:Di,start(t,n){f?(Ra(d,e._lastAsyncId),n(Ha(e))):(t.onRest=s,n(za(u,t,d,e)))}}})),d.paused&&await new Promise((e=>{d.resumeQueue.add(e)}));const p=Aa(e,await Promise.all(h));if(a&&p.finished&&(!n||!p.noop)){const n=es(t,a,i);if(n)return gs(e,[n]),ds(e,n,!0)}return l&&ui.batchedUpdates((()=>l(p,e,e.item))),p}function hs(e,t){const n={...e.springs};return t&&ji(Ei(t),(e=>{ki.und(e.keys)&&(e=ts(e)),ki.obj(e.to)||(e={...e,to:void 0}),ms(n,e,(e=>ps(e)))})),fs(e,n),n}function fs(e,t){Mi(t,((t,n)=>{e.springs[n]||(e.springs[n]=t,Eo(t,e))}))}function ps(e,t){const n=new Ja;return n.key=e,t&&Eo(n,t),n}function ms(e,t,n){t.keys&&ji(t.keys,(r=>{(e[r]||(e[r]=n(r)))._prepareNode(t)}))}function gs(e,t){ji(t,(t=>{ms(e.springs,t,(t=>ps(t,e)))}))}var ys,vs,bs=({children:e,...t})=>{const n=g(ws),r=t.pause||!!n.pause,o=t.immediate||!!n.immediate;t=function(e,t){const[n]=l((()=>({inputs:t,result:e()}))),r=s(),i=r.current;let o=i;o?Boolean(t&&o.inputs&&function(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}(t,o.inputs))||(o={inputs:t,result:e()}):o=n;return h((()=>{r.current=o,i==n&&(n.inputs=n.result=void 0)}),[o]),o.result}((()=>({pause:r,immediate:o})),[r,o]);const{Provider:a}=ws;return i.createElement(a,{value:t},e)},ws=(ys=bs,vs={},Object.assign(ys,i.createContext(vs)),ys.Provider._context=ys,ys.Consumer._context=ys,ys);bs.Provider=ws.Provider,bs.Consumer=ws.Consumer;var $s=()=>{const e=[],t=function(t){Uo(`${Yo}Directly calling start instead of using the api object is deprecated in v9 (use ".start" instead), this will be removed in later 0.X.0 versions`);const r=[];return ji(e,((e,i)=>{if(ki.und(t))r.push(e.start());else{const o=n(t,e,i);o&&r.push(e.start(o))}})),r};t.current=e,t.add=function(t){e.includes(t)||e.push(t)},t.delete=function(t){const n=e.indexOf(t);~n&&e.splice(n,1)},t.pause=function(){return ji(e,(e=>e.pause(...arguments))),this},t.resume=function(){return ji(e,(e=>e.resume(...arguments))),this},t.set=function(t){ji(e,((e,n)=>{const r=ki.fun(t)?t(n,e):t;r&&e.set(r)}))},t.start=function(t){const n=[];return ji(e,((e,r)=>{if(ki.und(t))n.push(e.start());else{const i=this._getProps(t,e,r);i&&n.push(e.start(i))}})),n},t.stop=function(){return ji(e,(e=>e.stop(...arguments))),this},t.update=function(t){return ji(e,((e,n)=>e.update(this._getProps(t,e,n)))),this};const n=function(e,t,n){return ki.fun(e)?e(n,t):e};return t._getProps=n,t};function xs(e,t){const n=ki.fun(e),[[r],i]=function(e,t,n){const r=ki.fun(t)&&t;r&&!n&&(n=[]);const i=y((()=>r||3==arguments.length?$s():void 0),[]),o=s(0),a=Jo(),l=y((()=>({ctrls:[],queue:[],flush(e,t){const n=hs(e,t);return o.current>0&&!l.queue.length&&!Object.keys(n).some((t=>!e.springs[t]))?us(e,t):new Promise((r=>{fs(e,n),l.queue.push((()=>{r(us(e,t))})),a()}))}})),[]),c=s([...l.ctrls]),u=[],d=ta(e)||0;function h(e,n){for(let i=e;i<n;i++){const e=c.current[i]||(c.current[i]=new cs(null,l.flush)),n=r?r(i,e):t[i];n&&(u[i]=ns(n))}}y((()=>{ji(c.current.slice(e,d),(e=>{!function(e,t){e.ref?.delete(e),t?.delete(e)}(e,i),e.stop(!0)})),c.current.length=e,h(d,e)}),[e]),y((()=>{h(0,Math.min(d,e))}),n);const f=c.current.map(((e,t)=>hs(e,u[t]))),p=g(bs),m=ta(p),v=p!==m&&function(e){for(const t in e)return!0;return!1}(p);Go((()=>{o.current++,l.ctrls=c.current;const{queue:e}=l;e.length&&(l.queue=[],ji(e,(e=>e()))),ji(c.current,((e,t)=>{i?.add(e),v&&e.start({default:p});const n=u[t];n&&(function(e,t){t&&e.ref!==t&&(e.ref?.delete(e),t.add(e),e.ref=t)}(e,n.ref),e.ref?e.queue.push(n):e.start(n))}))})),Ko((()=>()=>{ji(l.ctrls,(e=>e.stop(!0)))}));const b=f.map((e=>({...e})));return i?[b,i]:b}(1,n?e:[e],n?t||[]:t);return n||2==arguments.length?[r,i]:r}var Ss=class extends Ya{constructor(e,t){super(),this.source=e,this.idle=!0,this._active=new Set,this.calc=go(...t);const n=this._get(),r=fa(n);ia(this,r.create(n))}advance(e){const t=this._get();Bi(t,this.get())||(ra(this).setValue(t),this._onChange(t,this.idle)),!this.idle&&_s(this._active)&&Fs(this)}_get(){const e=ki.arr(this.source)?this.source.map(Do):Ei(Do(this.source));return this.calc(...e)}_start(){this.idle&&!_s(this._active)&&(this.idle=!1,ji(oa(this),(e=>{e.done=!1})),li.skipAnimation?(ui.batchedUpdates((()=>this.advance())),Fs(this)):qi.start(this))}_attach(){let e=1;ji(Ei(this.source),(t=>{Fo(t)&&Eo(t,this),Wa(t)&&(t.idle||this._active.add(t),e=Math.max(e,t.priority+1))})),this.priority=e,this._start()}_detach(){ji(Ei(this.source),(e=>{Fo(e)&&Co(e,this)})),this._active.clear(),Fs(this)}eventObserved(e){"change"==e.type?e.idle?this.advance():(this._active.add(e.parent),this._start()):"idle"==e.type?this._active.delete(e.parent):"priority"==e.type&&(this.priority=Ei(this.source).reduce(((e,t)=>Math.max(e,(Wa(t)?t.priority:0)+1)),0))}};function Os(e){return!1!==e.idle}function _s(e){return!e.size||Array.from(e).every(Os)}function Fs(e){e.idle||(e.idle=!0,ji(oa(e),(e=>{e.done=!0})),Bo(e,{type:"idle",parent:e}))}li.assign({createStringInterpolator:Vo,to:(e,t)=>new Ss(e,t)});var Ds=/^--/;function ks(e,t){return null==t||"boolean"==typeof t||""===t?"":"number"!=typeof t||0===t||Ds.test(e)||js.hasOwnProperty(e)&&js[e]?(""+t).trim():t+"px"}var Bs={};var js={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Ms=["Webkit","Ms","Moz","O"];js=Object.keys(js).reduce(((e,t)=>(Ms.forEach((n=>e[((e,t)=>e+t.charAt(0).toUpperCase()+t.substring(1))(n,t)]=e[t])),e)),js);var Es=/^(matrix|translate|scale|rotate|skew)/,Cs=/^(translate)/,Ps=/^(rotate|skew)/,As=(e,t)=>ki.num(e)&&0!==e?e+t:e,Ts=(e,t)=>ki.arr(e)?e.every((e=>Ts(e,t))):ki.num(e)?e===t:parseFloat(e)===t,Is=class extends ua{constructor({x:e,y:t,z:n,...r}){const i=[],o=[];(e||t||n)&&(i.push([e||0,t||0,n||0]),o.push((e=>[`translate3d(${e.map((e=>As(e,"px"))).join(",")})`,Ts(e,0)]))),Mi(r,((e,t)=>{if("transform"===t)i.push([e||""]),o.push((e=>[e,""===e]));else if(Es.test(t)){if(delete r[t],ki.und(e))return;const n=Cs.test(t)?"px":Ps.test(t)?"deg":"";i.push(Ei(e)),o.push("rotate3d"===t?([e,t,r,i])=>[`rotate3d(${e},${t},${r},${As(i,n)})`,Ts(i,0)]:e=>[`${t}(${e.map((e=>As(e,n))).join(",")})`,Ts(e,t.startsWith("scale")?1:0)])}})),i.length&&(r.transform=new Hs(i,o)),super(r)}},Hs=class extends jo{constructor(e,t){super(),this.inputs=e,this.transforms=t,this._value=null}get(){return this._value||(this._value=this._get())}_get(){let e="",t=!0;return ji(this.inputs,((n,r)=>{const i=Do(n[0]),[o,a]=this.transforms[r](ki.arr(i)?i:n.map(Do));e+=" "+o,t=t&&a})),t?"none":e}observerAdded(e){1==e&&ji(this.inputs,(e=>ji(e,(e=>Fo(e)&&Eo(e,this)))))}observerRemoved(e){0==e&&ji(this.inputs,(e=>ji(e,(e=>Fo(e)&&Co(e,this)))))}eventObserved(e){"change"==e.type&&(this._value=null),Bo(this,e)}};li.assign({batchedUpdates:w,createStringInterpolator:Vo,colors:{transparent:0,aliceblue:4042850303,antiquewhite:4209760255,aqua:16777215,aquamarine:2147472639,azure:4043309055,beige:4126530815,bisque:4293182719,black:255,blanchedalmond:4293643775,blue:65535,blueviolet:2318131967,brown:2771004159,burlywood:3736635391,burntsienna:3934150143,cadetblue:1604231423,chartreuse:2147418367,chocolate:3530104575,coral:4286533887,cornflowerblue:1687547391,cornsilk:4294499583,crimson:3692313855,cyan:16777215,darkblue:35839,darkcyan:9145343,darkgoldenrod:3095792639,darkgray:2846468607,darkgreen:6553855,darkgrey:2846468607,darkkhaki:3182914559,darkmagenta:2332068863,darkolivegreen:1433087999,darkorange:4287365375,darkorchid:2570243327,darkred:2332033279,darksalmon:3918953215,darkseagreen:2411499519,darkslateblue:1211993087,darkslategray:793726975,darkslategrey:793726975,darkturquoise:13554175,darkviolet:2483082239,deeppink:4279538687,deepskyblue:12582911,dimgray:1768516095,dimgrey:1768516095,dodgerblue:512819199,firebrick:2988581631,floralwhite:4294635775,forestgreen:579543807,fuchsia:4278255615,gainsboro:3705462015,ghostwhite:4177068031,gold:4292280575,goldenrod:3668254975,gray:2155905279,green:8388863,greenyellow:2919182335,grey:2155905279,honeydew:4043305215,hotpink:4285117695,indianred:3445382399,indigo:1258324735,ivory:4294963455,khaki:4041641215,lavender:3873897215,lavenderblush:4293981695,lawngreen:2096890111,lemonchiffon:4294626815,lightblue:2916673279,lightcoral:4034953471,lightcyan:3774873599,lightgoldenrodyellow:4210742015,lightgray:3553874943,lightgreen:2431553791,lightgrey:3553874943,lightpink:4290167295,lightsalmon:4288707327,lightseagreen:548580095,lightskyblue:2278488831,lightslategray:2005441023,lightslategrey:2005441023,lightsteelblue:2965692159,lightyellow:4294959359,lime:16711935,limegreen:852308735,linen:4210091775,magenta:4278255615,maroon:2147483903,mediumaquamarine:1724754687,mediumblue:52735,mediumorchid:3126187007,mediumpurple:2473647103,mediumseagreen:1018393087,mediumslateblue:2070474495,mediumspringgreen:16423679,mediumturquoise:1221709055,mediumvioletred:3340076543,midnightblue:421097727,mintcream:4127193855,mistyrose:4293190143,moccasin:4293178879,navajowhite:4292783615,navy:33023,oldlace:4260751103,olive:2155872511,olivedrab:1804477439,orange:4289003775,orangered:4282712319,orchid:3664828159,palegoldenrod:4008225535,palegreen:2566625535,paleturquoise:2951671551,palevioletred:3681588223,papayawhip:4293907967,peachpuff:4292524543,peru:3448061951,pink:4290825215,plum:3718307327,powderblue:2967529215,purple:2147516671,rebeccapurple:1714657791,red:4278190335,rosybrown:3163525119,royalblue:1097458175,saddlebrown:2336560127,salmon:4202722047,sandybrown:4104413439,seagreen:780883967,seashell:4294307583,sienna:2689740287,silver:3233857791,skyblue:2278484991,slateblue:1784335871,slategray:1887473919,slategrey:1887473919,snow:4294638335,springgreen:16744447,steelblue:1182971135,tan:3535047935,teal:8421631,thistle:3636451583,tomato:4284696575,turquoise:1088475391,violet:4001558271,wheat:4125012991,white:4294967295,whitesmoke:4126537215,yellow:4294902015,yellowgreen:2597139199}});var zs=((e,{applyAnimatedValues:t=(()=>!1),createAnimatedStyle:n=(e=>new ua(e)),getComponentProps:r=(e=>e)}={})=>{const i={applyAnimatedValues:t,createAnimatedStyle:n,getComponentProps:r},o=e=>{const t=ya(e)||"Anonymous";return(e=ki.str(e)?o[e]||(o[e]=pa(e,i)):e[ga]||(e[ga]=pa(e,i))).displayName=`Animated(${t})`,e};return Mi(e,((t,n)=>{ki.arr(e)&&(n=ya(t)),o[n]=o(t)})),{animated:o}})(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"],{applyAnimatedValues:function(e,t){if(!e.nodeType||!e.setAttribute)return!1;const n="filter"===e.nodeName||e.parentNode&&"filter"===e.parentNode.nodeName,{style:r,children:i,scrollTop:o,scrollLeft:a,viewBox:s,...l}=t,c=Object.values(l),u=Object.keys(l).map((t=>n||e.hasAttribute(t)?t:Bs[t]||(Bs[t]=t.replace(/([A-Z])/g,(e=>"-"+e.toLowerCase())))));void 0!==i&&(e.textContent=i);for(const t in r)if(r.hasOwnProperty(t)){const n=ks(t,r[t]);Ds.test(t)?e.style.setProperty(t,n):e.style[t]=n}u.forEach(((t,n)=>{e.setAttribute(t,c[n])})),void 0!==o&&(e.scrollTop=o),void 0!==a&&(e.scrollLeft=a),void 0!==s&&e.setAttribute("viewBox",s)},createAnimatedStyle:e=>new Is(e),getComponentProps:({scrollTop:e,scrollLeft:t,...n})=>n}),Rs=zs.animated;const Ns=$.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,Ls=o.forwardRef(((t,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=t,s=C(t,["children","focusHighlight","focusOutline","type"]);return e(Ns,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Ws=$.div`
...
`,Js=$(Jr.Small)`
    ...
    padding: 0;
    margin: 1rem 0 0 0;
`,Ks=n=>{var{collapsible:r=!0,initialExpanded:i=!1,expanded:o,onExpandChange:a,minimisable:s=!1,minimisedHeight:c,showDivider:u=!0,showMobileDivider:d=!0,title:f,children:p}=n,m=C(n,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","children"]);const{mode:y}=g(st),v="mobile"===y,[b,w]=l(k()),[$,x]=l(s),S=!v&&r,O=et(),_=et(),F=xs({height:b?O.height:0}),D=$?null!=c?c:Math.min(.5*_.height,216):_.height;h((()=>{w(k())}),[r,o]);function k(){return!!v||(ai(o)?!r||i:o)}return t(Ws,Object.assign({$collapsible:S},{children:[e(Vs,{$showDivider:u,$showMobileDivider:d}),(f||S)&&t(Ys,{children:[f&&e(Us,Object.assign({weight:"semibold"},{children:f})),S&&e(qs,Object.assign({focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!b;ai(o)&&w(e),a&&a(e)},"aria-label":b?"Collapse":"Expand"},{children:e(Qs,{$expanded:b})}))]}),e(Zs,Object.assign({"data-testid":"expandable-container","data-expanded":b,style:F},{children:e("div",Object.assign({ref:O.ref},{children:t(Gs,Object.assign({},m,{children:[e(Xs,Object.assign({"data-testid":"minimisable-container",$height:D,$minimisable:s},{children:e("div",Object.assign({ref:_.ref},{children:e("div",Object.assign({"data-id":"content-container"},{children:"function"==typeof p?p(y,{minimised:$}):p}))}))})),s&&t(Js,Object.assign({"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{x(!$)}},{children:["View ",$?"more":"less"]}))]}))}))}))]}))},el=$(Ks)`
    padding: 0 0 1rem;
