...
`,rh=v(Uu.Default)`
    width: 100%;
`,th=t=>{var{customLabels:n,onClear:i,onDone:s,onDismiss:l,onModalOpen:d,toggleFilterButtonStyle:c="light",clearButtonDisabled:h=!1,insets:g,children:m,toggleFilterButtonLabel:b,headerTitle:p,doneButtonLabel:f}=t,y=ge(t,["customLabels","onClear","onDone","onDismiss","onModalOpen","toggleFilterButtonStyle","clearButtonDisabled","insets","children","toggleFilterButtonLabel","headerTitle","doneButtonLabel"]);const{context:v,refs:x}=J(),w=o(null),[$,F]=a(!1),C={toggle:(null==n?void 0:n.toggleFilterButtonLabel)||b||"Filters",title:(null==n?void 0:n.headerTitle)||p||"Filters",done:(null==n?void 0:n.doneButtonLabel)||f||"Done",clear:(null==n?void 0:n.clearButtonLabel)||"Clear"};return u((()=>{var e;$&&(null===(e=w.current)||void 0===e||e.focus())}),[$]),e(co.Provider,{value:{mode:"mobile",rootNode:w},children:[r("div",Object.assign({},y,{children:r(rh,{"data-testid":"filter-show-button",styleType:c,onClick:()=>{F(!0),null==d||d()},type:"button",icon:r(_,{}),children:C.toggle})})),r(qc,{show:$,disableTransition:!0,children:r(Gu,{inert:va(!$),children:r(te,{context:v,disabled:!$,children:r(Xu,{"data-id":"filter-mobile","data-testid":"filter-mobile",ref:x.setFloating,children:e(Zu,{ref:w,tabIndex:0,children:[e(Ju,{$insetTop:null==g?void 0:g.top,children:[r(Wu,{onClick:()=>{F(!1),null==l||l()},focusOutline:"browser",focusHighlight:!1,"aria-label":`close ${C.title}`,children:r(M,{})}),r(Ku,{children:C.title}),r(eh,{styleType:"link",type:"button",onClick:()=>null==i?void 0:i(),disabled:h,"aria-label":`clear ${C.title}`,children:C.clear})]}),r(Ru,{children:m}),r(Nu,{$insetBottom:null==g?void 0:g.bottom,children:r(Hu,{onClick:()=>{F(!1),null==s||s()},children:C.done})})]})})})})})]})};th.displayName="Filter.Modal";const nh=v.div`
    background-color: ${Un.bg};
...
`,ah=v(Ro.Small)`
    ...
    height: 100%;
`,sh=t=>{var{customLabels:n,onClear:i,clearButtonDisabled:a=!1,children:s,headerTitle:l}=t,d=ge(t,["customLabels","onClear","clearButtonDisabled","children","headerTitle"]);const c=o(null),u={title:(null==n?void 0:n.headerTitle)||l||"Filters",clear:(null==n?void 0:n.clearButtonLabel)||"Clear"};return r(co.Provider,{value:{mode:"default",rootNode:c},children:e(nh,Object.assign({"data-id":"filter-desktop","data-testid":"filter-desktop",ref:c},d,{children:[e(ih,{children:[r(oh,{children:u.title}),r(ah,{styleType:"link",type:"button",onClick:()=>null==i?void 0:i(),disabled:a,"aria-label":`clear ${u.title}`,children:u.clear})]}),r(Ru,{children:s})]}))})};sh.displayName="Filter.Sidebar";const lh=e=>{var{children:t,className:n,style:i,onDismiss:o,onDone:a,onModalOpen:s,toggleFilterButtonStyle:l,insets:d,id:c,"data-testid":h}=e,g=ge(e,["children","className","style","onDismiss","onDone","onModalOpen","toggleFilterButtonStyle","insets","id","data-testid"]);const m=f(F),b=ri["lg-max"]({theme:m}),p=ye.useMediaQuery({maxWidth:b});return u((()=>{p||null==o||o()}),[p]),r("div",{className:n,style:i,id:c,"data-testid":h,children:p?r(th,Object.assign({onDismiss:o,onDone:a,onModalOpen:s,toggleFilterButtonStyle:l,insets:d},g,{children:"function"==typeof t?t("mobile"):t})):r(sh,Object.assign({},g,{children:"function"==typeof t?t("default"):t}))})};lh.Sidebar=sh,lh.Modal=th,lh.Item=Ou,lh.Page=Yu,lh.Checkbox=Pu;export{lh as Filter};
