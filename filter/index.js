...
`,ga=e=>{const{textSize:r}=e||{};return D`
        // Text styling
        ${r&&lo[`${r}-regular`]}
...
`,$a=E.div`
    ...
    ${e=>{let r;const t="small"===e.$sizeType?"1.25rem":"1.5rem";switch(e.$type){case"error":r=so["icon-error"](e);break;case"success":r=so["icon-success"](e);break;case"warning":default:r=so["icon-warning"](e);break;case"info":r=so["icon-info"](e);break;case"description":r=so["icon-subtle"](e)}return D`
            svg {
                color: ${r};
                width: ${t};
                height: ${t};
...
`,qa=E((t=>{var{type:n,className:i,children:o,actionLink:a,actionLinkIcon:s,sizeType:l="default",showIcon:d=!1,customIcon:c,maxCollapsedHeight:u}=t,h=ce(t,["type","className","children","actionLink","actionLinkIcon","sizeType","showIcon","customIcon","maxCollapsedHeight"]);const[b,m]=g(!1),[p,f]=g(!1),{height:v,ref:x}=Mr();y((()=>{w()}),[u,v]);const w=()=>{m(!u),f($())},$=()=>!(!v||!u)&&v>u;return r(wa,{className:i,$type:n,$sizeType:l,"data-testid":h["data-testid"],children:[d&&e($a,{$sizeType:l,$type:n,children:(()=>{if(n&&c)return c;switch(n){case"success":return e(re,{});case"warning":return e(K,{});case"error":return e(J,{});case"info":case"description":return e(ee,{});default:return null}})()}),r(Ca,{children:[r(Ea,{$maxCollapsedHeight:$()?u:void 0,$showMore:b,$hasActionLink:!!a,children:[e("div",{ref:x,children:o}),a?r(Fa,Object.assign({"data-testid":"action-link",$type:n,$sizeType:l},a,{children:[a.children,s||e(G,{})]})):null]}),p&&r(Da,{$sizeType:l,$type:n,type:"button",onClick:()=>m(!b),children:["Show ",b?"less":"more",e(ka,{$expanded:b})]})]})]})}))`
    width: 100%;
    user-select: none;
`,Qa=E.div`
    padding: 0 1rem;
...
`,Za=E(za)`
    color: ${e=>e.$disabled?so["text-disabled"]:so["text-error"]};
`,Xa=E((({type:r,active:t=!1,disabled:n,className:i})=>{let o;switch(r){case"checkbox":o=e(t?se:ae,{});break;case"radio":o=e(t?ie:ne,{});break;case"tick":o=e(le,{});break;case"cross":o=e(oe,{});break;default:o=null}return e(Sa,{className:i,$active:t,$disabled:n,"aria-hidden":!0,children:o})}))`
    ${e=>e.$disabled?e.$selected?D`
                    color: ${so["icon-selected-disabled"]};
                `:D`
                    color: ${so["icon-disabled-subtle"]};
...
`,Ac=u.forwardRef(((r,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=r,s=ce(r,["children","focusHighlight","focusOutline","type"]);return e(_c,Object.assign({ref:t,$outline:o,$highlight:i,type:a},s,{children:n}))})),Bc=E.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,zc=E.div`
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,jc=E((r=>{var{children:t}=r,n=ce(r,["children"]);const i=n["data-testid"]||"card";return e(Oc,Object.assign({},n,{"data-testid":i,children:"string"==typeof t?e(xa.BodyBL,{children:t}):t}))}))`
    color: ${so.text};
    ${ga({textSize:"body-md"})}
...
`,Tc=E((t=>{var{id:n="modal-box",children:i,onClose:o,showCloseButton:a=!0}=t,s=ce(t,["id","children","onClose","showCloseButton"]);return r(Bc,Object.assign({"data-testid":n},s,{onClick:e=>{e.stopPropagation()},children:[a&&e(Mc,{onClick:o,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:e(oe,{})}),i]}))}))`
...
`,Ic=E.div`
    ...
    color: ${so.text};
    ${ga({textSize:"body-md"})}
`,Pc=n=>{var{children:i,visible:o,onMobileClose:a,maxHeight:s,overflow:l}=n,d=ce(n,["children","visible","onMobileClose","maxHeight","overflow"]);const c=d["data-testid"]||"popover",u=F(S),h=mo["sm-max"]({theme:u}),g=me.useMediaQuery({maxWidth:h}),b=()=>{a&&a()},m=()=>"string"==typeof i?e(xa.BodyMD,{children:i}):i;return r(t,{children:[o&&e(zc,Object.assign({"data-testid":c},d,{children:e(jc,{$maxHeight:s,$overflow:l,children:m()})})),g&&e(Sc,{show:null!=o&&o,onOverlayClick:b,children:e(Tc,{onClose:b,children:e(Ic,{children:m()})})})]})},Lc=E.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,Rc=n=>{var i,o,{children:a,popoverContent:s,trigger:l="click",position:d="top",zIndex:c,rootNode:u,customOffset:b,delay:m,onPopoverAppear:p,onPopoverDismiss:f,enableFlip:v=!0,enableResize:x=!1,overflow:w="auto"}=n,$=ce(n,["children","popoverContent","trigger","position","zIndex","rootNode","customOffset","delay","onPopoverAppear","onPopoverDismiss","enableFlip","enableResize","overflow"]);const[C,E]=g(!1),D=h(null),k=h(null),_=F(S),A=mo["sm-max"]({theme:_}),B=me.useMediaQuery({maxWidth:A}),[q,Q]=g(0),{refs:U,floatingStyles:Z,context:X}=M({open:C,placement:d,whileElementsMounted:z,middleware:[j(null!=b?b:16),v&&T(),I({limiter:P()}),x&&L({apply({availableHeight:e}){Q(e)}})],onOpenChange:e=>{E(e),C!==e&&oe(e)}}),G=(()=>{const[e,r]=g(void 0),t=O();return y((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(So.Change,e),t.events.emit(So.Ready),()=>t.events.off(So.Change,e)}),[t]),e})(),J=B?"click":l,K=R(X,{ignoreMouse:"hover"===J}),ee=W(X),re=H(X,{enabled:"hover"===J,delay:{open:null!==(i=null==m?void 0:m.open)&&void 0!==i?i:0,close:null!==(o=null==m?void 0:m.close)&&void 0!==o?o:500}}),{getReferenceProps:te,getFloatingProps:ne}=Y([K,ee,re]),ie=()=>{E(!1),oe(!1)},oe=e=>{e&&p&&p(),!e&&f&&f()};return r(t,{children:[e(Lc,Object.assign({ref:e=>{D.current=e,U.setReference(e)}},te({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),$,{children:a})),C&&e(N,{root:u,children:e(V,{context:X,children:e("div",Object.assign({ref:e=>{k.current=e,U.setFloating(e)},style:Object.assign(Object.assign({},Z),{outline:"none",zIndex:null!=c?c:G})},ne(),{children:"function"==typeof s?s(x?{maxHeight:q,overflow:w}:{}):e(Pc,{visible:!0,onMobileClose:ie,maxHeight:x?q:void 0,overflow:x?w:void 0,children:s})}))})})]})},Wc=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}},Hc=E.span`
    color: ${so["text-primary"]};
    font-weight: 600;
...
`,Nc=t=>{var{ariaLabel:n,content:i,icon:o,underlineStyle:a="default",underlineHoverStyle:s="default"}=t,l=ce(t,["ariaLabel","content","icon","underlineStyle","underlineHoverStyle"]);const d=!!i;return e(Rc,Object.assign({},l,{children:r(Hc,{role:"button","aria-haspopup":"dialog",tabIndex:0,$defaultStyle:a,$hoverStyle:s,"aria-label":null!=n?n:d?void 0:"More info",children:[i,o&&e(Yc,{$standalone:!d,children:o})]})}))},Vc=E.div`
    padding-left: ${ho["spacing-4"]};
    display: inline;
`,qc=({addon:r,rootNode:t})=>{const{content:n,type:i,icon:o,id:a,zIndex:s,"data-testid":l}=r;return e(Vc,{children:e(Nc,{trigger:"click",id:a,"data-testid":l,popoverContent:n,rootNode:t,zIndex:s,icon:null!=o?o:e(ee,{"data-testid":`${i}-icon`}),ariaLabel:"More info"})})},Qc=E.div`
...
`,nu=E.div`
    ...
    position: absolute;
    white-space: nowrap;
`,iu=e=>{const r=C.split(".");return parseInt(r[0],10)>=19?e:e?"true":void 0},ou=t=>{var n,{collapsible:i=!0,initialExpanded:o=!1,expanded:a,onExpandChange:s,minimisable:l=!1,minimisedHeight:d,showDivider:c=!0,showMobileDivider:u=!0,title:b,addon:m,children:p}=t,f=ce(t,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","addon","children"]);const{mode:v,rootNode:x}=F(Mo),w="mobile"===v,[$,C]=g(j()),[E,D]=g(l),k=!w&&i,S=Mr(),O=Mr(),_=sc({height:$?S.height:0}),A=E?null!=d?d:Math.min(.5*(null!==(n=O.height)&&void 0!==n?n:0),216):O.height,B=h(Ie.generate()),M=`${B.current}-content`,z=`${B.current}-title`;y((()=>{C(j())}),[i,a]),y((()=>{D(l)}),[l]);function j(){return!!w||(Dc(a)?!i||o:a)}return r(Qc,{$collapsible:k,"aria-labelledby":z,children:[e(Uc,{$showDivider:c,$showMobileDivider:u}),(b||k)&&r(Zc,{children:[b&&r(Jc,{id:z,"data-testid":"filter-item-title",children:[b," ",m&&("popover"===(null==m?void 0:m.type)?e(qc,{addon:m,rootNode:w?x:void 0}):null)]}),k&&r(Xc,{"data-testid":"expand-collapse-button",focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!$;Dc(a)&&C(e),s&&s(e)},"aria-expanded":$,"aria-disabled":!k,"aria-controls":M,children:[b&&e(nu,{as:"span",children:b}),e(Gc,{$expanded:$,"aria-hidden":!0})]})]}),e(Kc,{id:M,"data-testid":"expandable-container","data-expanded":$,style:_,inert:iu(!$),children:e("div",{ref:S.ref,children:r(eu,Object.assign({},f,{children:[e(ru,{"data-testid":"minimisable-container",$height:A,$minimisable:l,children:e("div",{ref:O.ref,children:e("div",{"data-id":"content-container",children:"function"==typeof p?p(v,{minimised:E}):p})})}),l&&r(tu,{"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{D(!E)},children:[e(nu,{as:"span",children:`view ${E?"more":"less"} in ${b}`}),r("span",{"aria-hidden":!0,children:["View ",E?"more":"less"]})]})]}))})})]})};ou.displayName="Filter.Item";const au=E(ou)`
...
`,du=E((t=>{var{className:n,checked:i,disabled:o,indeterminate:a,displaySize:s="default",id:l}=t,d=ce(t,["className","checked","disabled","indeterminate","displaySize","id"]);const c=h(null);y((()=>{c.current&&(c.current.indeterminate=null!=a&&a)}),[a]);return r(ua,{className:n,"data-testid":"checkbox",$displaySize:s,children:[e(ha,Object.assign({id:l,"data-testid":"checkbox-input",type:"checkbox",checked:i,ref:c,tabIndex:o?-1:0,disabled:o,"aria-checked":a?"mixed":i},d)),a?e(ca,{$disabled:o,"data-testid":"indeterminate","aria-hidden":!0}):i?e(da,{$disabled:o,"data-testid":"checkmark","aria-hidden":!0}):o?e(la,{"data-testid":"empty-disabled-checkbox","aria-hidden":!0}):e(sa,{$disabled:o,"data-testid":"empty-checkbox","aria-hidden":!0})]})}))`
    flex-shrink: 0;
    margin-right: ${ho["spacing-8"]};
`,cu=E((n=>{var{type:i="checkbox",indicator:o,checked:a,styleType:s="default",children:l,childrenMaxLines:d,subLabel:c,disabled:u,error:b,name:m,id:p,className:f,compositeSection:v,removable:w,onRemove:$,"data-testid":F,onChange:C,useContentWidth:E,"aria-describedby":D}=n,k=ce(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","onRemove","data-testid","onChange","useContentWidth","aria-describedby"]);const{collapsible:S=!0,errors:O,children:_,initialExpanded:A}=v||{},[B,M]=g(a),[z,j]=g(!!A),T=x((()=>{const e=Array.isArray(O)&&(null==O?void 0:O.length)>0,r=!Array.isArray(O)&&!!O;return e||r}),[O]),[I]=g(Ie.generate()),P=p?`${p}`:`tg-${I}`,L=h(null);y((()=>{M(a)}),[a]),y((()=>{B&&j(null==A||A)}),[B]);const R=e=>{if(!u){if(C)return void C(e);switch(i){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":B||M(!0)}}},W=()=>{u||j(!z)},H=()=>{u||!$||$()},Y=()=>{var e;null===(e=null==L?void 0:L.current)||void 0===e||e.click()},N=e=>{e.stopPropagation()},V=()=>{let r;switch(i){case"yes":r="tick";break;case"no":r="cross";break;case"checkbox":case"radio":r=i}return e(Xa,{type:r,active:B,disabled:u,$selected:B,$disabled:u})},q=()=>{if(!c)return null;let r;return r="function"==typeof c?c():c,e(Ra,{"data-id":"toggle-sublabel",id:`${P}-sublabel`,"aria-hidden":!0,children:r})},Q=n=>r(t,{children:[e(Ua,{weight:"semibold",$disabled:u,children:"Error"}),e(Za,{$disabled:u,children:null==n?void 0:n.map(((r,t)=>e("li",{id:`${P}-error-list-item-${t}`,children:e(Ua,{weight:"semibold",$disabled:u,children:r})},t)))})]});return r(ja,{$selected:B,$disabled:u,className:f,$styleType:s,$error:b,$indicator:o,$useContentWidth:E,id:p,"data-testid":F,children:[(()=>{const t=["string"==typeof c?`${P}-sublabel`:null,D].filter(Boolean).join(" ")||void 0;return r(Wa,{id:`${P}-header-container`,$disabled:u,$error:b,$selected:B,$indicator:o,$styleType:s,children:[e(Ha,{$addPadding:w,children:r(Ia,{id:`${P}-input-container`,onClick:Y,children:[e(Ta,Object.assign({ref:L,name:m,id:`${P}-input`,type:"checkbox"===i?"checkbox":"radio","data-testid":"toggle-input",disabled:u,onChange:R,onClick:N,checked:B,"aria-describedby":t},k)),o&&V(),r(Pa,{$selected:B,$disabled:u,children:[e(La,{htmlFor:`${P}-input`,"data-testid":"toggle-label",id:`${P}-label`,$maxLines:d,children:l}),c&&q()]})]})}),w&&e(Ya,{type:"button",$disabled:u,onClick:H,id:`${P}-remove-button`,children:"Remove"})]})})(),_&&r("div",{children:[(!S||z)&&e(Qa,{"data-id":"toggle-composite-children",$isFinalItem:!S,$disabled:u,children:_}),S&&!z&&T&&e(Va,{$disabled:u,onClick:W,id:`${P}-error-alert`,children:e(qa,{type:u?"description":"error",className:f,showIcon:!0,children:Array.isArray(O)?Q(O):O})}),S&&r(Na,{$paddingTopRequired:!z&&!T,disabled:u,onClick:W,"data-testid":z?"collapse-button":"expand-button",children:[z?"Show less":"Show more",e(z?X:Z,{"aria-hidden":!0})]})]})]})}))`
...
`,hu=n=>{var{selectedOptions:i,options:o,onSelect:a,labelExtractor:s,valueExtractor:l,useToggleContentWidth:d}=n,c=ce(n,["selectedOptions","options","onSelect","labelExtractor","valueExtractor","useToggleContentWidth"]);const{mode:u}=F(Mo),[b,m]=g(i||[]),[p,f]=g(),[v,x]=g(o.length),w=h(null),C=h(null),E=e=>()=>{const r=[...b],t=b.findIndex((r=>S(r)===S(e)));t>=0?r.splice(t,1):r.push(e),m(r),null==a||a(r)},D=()=>{const e=b.length?[]:o;m(e),null==a||a(e)},k=e=>{var r;return s?s(e):null!==(r=e.label)&&void 0!==r?r:null==e?void 0:e.toString()},S=e=>{var r;return l?l(e):null!==(r=e.value)&&void 0!==r?r:null==e?void 0:e.toString()},O=$((()=>{if(!w.current)return void f(void 0);const e=Array.from(w.current.children);let r=0,t=0,n=-1;for(let i=0;i<e.length;i++){const o=e[i].offsetTop;if(o>n&&(t++,n=o,t>2))break;r=i}x(r),f(t>2?n-8:void 0)}),[]);y((()=>{i!==b&&m(i||[])}),[i]),y((()=>{"default"===u?(()=>{const e=C.current?C.current.offsetTop+C.current.clientHeight:void 0;f(e)})():O()}),[o]),Mr({handleWidth:"mobile"===u,handleHeight:!1,skipOnMount:!0,refreshMode:"throttle",targetRef:w,onResize:O});const _=()=>{var r;return o.length<3?null:e(uu,{styleType:"link",type:"button",onClick:D,"aria-label":b.length?"Clear all selections":`Select all in ${(null===(r=w.current)||void 0===r?void 0:r.ariaLabel)||"this group"}`,children:b.length?"Clear all":"Select all"})};return e(au,Object.assign({minimisable:"default"===u?o.length>5:!!p,minimisedHeight:p},c,{children:(n,{minimised:i})=>r(t,{children:[_(),e(su,{role:"group","aria-label":c.title,ref:w,children:o.map(((t,o)=>"default"===n?((t,n,i)=>{const o=k(t),a=S(t),s=!!b.find((e=>S(e)===a));return r(lu,{$visible:!i||n<5,$selected:s,ref:4===n?C:void 0,children:[e(du,{displaySize:"small",checked:s,onChange:E(t)}),o]},a)})(t,o,i):((r,t,n)=>{const i=k(r),o=S(r),a=!!b.find((e=>S(e)===o));return e(cu,{type:"checkbox",checked:a,$visible:!n||!!p&&t<=v,onChange:E(r),useContentWidth:d,children:i},o)})(t,o,i)))})]})}))};hu.displayName="Filter.Checkbox";const gu=E.div`
    background-color: ${so.bg};
    height: 100%;
    width: 100%;
    display: flex;
...
`,mu=(t,n)=>{const{children:i,disabled:o=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:d="left",loading:c=!1,focusableWhenDisabled:h=!1,onClick:g}=t,b=ce(t,["children","disabled","styleType","danger","icon","iconPosition","loading","focusableWhenDisabled","onClick"]),m={$buttonIconPosition:d,$buttonStyle:o?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:s};return r(bu,Object.assign({ref:n,"data-testid":b["data-testid"]||"button-with-icon",disabled:o&&!h,"aria-disabled":o,"aria-busy":c,onClick:o?void 0:g},m,b,{children:[c?e(Ro,{}):l?u.cloneElement(l,{"aria-hidden":!0}):null,e("span",{children:i})]}))};mu.displayName="ButtonWithIcon.Default";const pu=(t,n)=>{const{children:i,disabled:o=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:d="left",loading:c=!1,focusableWhenDisabled:h=!1,onClick:g}=t,b=ce(t,["children","disabled","styleType","danger","icon","iconPosition","loading","focusableWhenDisabled","onClick"]),m={$buttonIconPosition:d,$buttonStyle:o?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:s};return r(bu,Object.assign({ref:n,"data-testid":b["data-testid"]||"button-with-icon",disabled:o&&!h,"aria-disabled":o,"aria-busy":c,onClick:o?void 0:g},m,b,{children:[c?e(Ro,{}):l?u.cloneElement(l,{"aria-hidden":!0}):null,e("span",{children:i})]}))};pu.displayName="ButtonWithIcon.Small";const fu={Default:u.forwardRef(mu),Small:u.forwardRef(pu)},yu=E.div`
    background-color: ${so.bg};
...
`,Ou=E(ia.Default)`
    width: 100%;
`,_u=({onDismiss:t,onDone:n,children:i})=>r(gu,{children:[e(Eu,{onClick:t,focusOutline:"browser",focusHighlight:!1,"aria-label":"Dismiss",children:e(de,{})}),e(wu,{children:i}),e(Su,{children:e(Ou,{onClick:n,type:"button",children:"Done"})})]});_u.displayName="Filter.Page";const Au=n=>{var{customLabels:i,toggleFilterButtonLabel:o,headerTitle:a,doneButtonLabel:s,toggleFilterButtonStyle:c="light",clearButtonDisabled:u=!1,onClear:b,onDismiss:m,onDone:p,children:f}=n,v=ce(n,["customLabels","toggleFilterButtonLabel","headerTitle","doneButtonLabel","toggleFilterButtonStyle","clearButtonDisabled","onClear","onDismiss","onDone","children"]);const x=(null==i?void 0:i.toggleFilterButtonLabel)||o||"Filters",w=(null==i?void 0:i.headerTitle)||a||"Filters",$=(null==i?void 0:i.doneButtonLabel)||s||"Done",[C,E]=g(!1),D=h(null),k=h(null),O=F(S),_=mo["lg-max"]({theme:O}),A=me.useMediaQuery({maxWidth:_}),{context:B,refs:z}=M();y((()=>{A||T()}),[A]),y((()=>{var e;C&&A&&(null===(e=D.current)||void 0===e||e.focus())}),[C,A]);const j=()=>{E(!0)},T=()=>{E(!1),m&&m()},I=()=>{E(!1),p&&p()},P=()=>{b&&b()},L=e=>"function"==typeof f?f(e):f,R=t=>r(Fu,{children:["mobile"===t&&e(Eu,{onClick:T,focusOutline:"browser",focusHighlight:!1,"aria-label":`close ${w}`,children:e(d,{})}),e(Cu,{children:w}),e(Du,{styleType:"link",type:"button",onClick:P,disabled:u,"aria-label":`clear ${w}`,children:"Clear"})]});return e("div",Object.assign({},v,{children:e(Mo.Provider,A?{value:{mode:"mobile",rootNode:D},children:r(t,{children:[e(ku,{"data-testid":"filter-show-button",styleType:c,onClick:j,type:"button",icon:e(l,{}),children:x}),e(_o,{show:C,disableTransition:!0,children:C?e($u,{children:e(V,{context:B,initialFocus:-1,children:e(xu,{"data-id":"filter-mobile","data-testid":"filter-mobile",ref:z.setFloating,children:r(vu,{ref:D,tabIndex:0,children:[R("mobile"),e(wu,{children:L("mobile")}),e(Su,{children:e(Ou,{onClick:I,type:"button",children:$})})]})})})}):void 0})]})}:{value:{mode:"default",rootNode:k},children:r(yu,{"data-id":"filter-desktop","data-testid":"filter-desktop",ref:k,children:[R("default"),L("default")]})})}))};Au.displayName="Filter";const Bu=Object.assign(Au,{Item:ou,Page:_u,Checkbox:hu});export{Bu as Filter};
