...
`,Tl=a.div`
    ...
    color: ${$n.Neutral[1]};
    ${El({textSize:"BodySmall"})}
`,Il=r=>{var{children:i,visible:o,onMobileClose:a}=r,s=re(r,["children","visible","onMobileClose"]);const l=s["data-testid"]||"popover",c=Gs.useMediaQuery({maxWidth:wn.mobileL}),d=()=>{a&&a()},u=()=>"string"==typeof i?t(Yn.BodySmall,{children:i}):i;return e(n,{children:[o&&t(Ml,Object.assign({"data-testid":l},s,{children:t(Pl,{children:u()})})),c&&t(Bl,Object.assign({show:o,onOverlayClick:d},{children:t(Hl,Object.assign({onClose:d},{children:t(Tl,{children:u()})}))}))]})},Al=a.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,zl=r=>{var{children:i,popoverContent:o,trigger:a="click",position:s="top",zIndex:l,rootNode:c,onPopoverAppear:d,onPopoverDismiss:f}=r,p=re(r,["children","popoverContent","trigger","position","zIndex","rootNode","onPopoverAppear","onPopoverDismiss"]);const[m,g]=h(!1),b=u(),v=u(),$=Gs.useMediaQuery({maxWidth:Fn.mobileL}),{refs:w,floatingStyles:S,context:x}=E({open:m,placement:s,whileElementsMounted:M,middleware:[P(16),H(),T({limiter:I()})],onOpenChange:e=>{g(e),m!==e&&Y(e)}}),F=(()=>{const[e,t]=h(void 0),n=B();return y((()=>{if(!n)return void t(void 0);const e=e=>{t(e.zIndex)};return n.events.on(Zs.Change,e),n.events.emit(Zs.Ready),()=>n.events.off(Zs.Change,e)}),[n]),e})(),O=$?"click":a,k=A(x,{ignoreMouse:"hover"===O}),D=z(x),_=R(x,{enabled:"hover"===O,delay:{close:500}}),{getReferenceProps:j,getFloatingProps:C}=N([k,D,_]),V=()=>{g(!1),Y(!1)},Y=e=>{e&&d&&d(),!e&&f&&f()};return e(n,{children:[t(Al,Object.assign({ref:e=>{b.current=e,w.setReference(e)}},j({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),p,{children:i})),m&&t(L,Object.assign({root:c},{children:t(W,Object.assign({context:x},{children:t("div",Object.assign({ref:e=>{v.current=e,w.setFloating(e)},style:Object.assign(Object.assign({},S),{zIndex:null!=l?l:F})},C(),{children:"function"==typeof o?o():t(Il,Object.assign({visible:!0,onMobileClose:V},{children:o}))}))}))}))]})},Rl=a.button`
...
`,Nl=a.div`
    ...
    position: relative;
    width: fit-content;
`,Ll=({addon:e,rootNode:n})=>{const{content:r,type:i,icon:o,id:a,zIndex:s,"data-testid":l}=e;return t(zl,Object.assign({trigger:"click",id:a,"data-testid":l,popoverContent:r,rootNode:n,zIndex:s},{children:t(Nl,{children:t(Rl,{children:o||t(D,{id:`${i}-icon`})})})}))},Wl=a.div`
...
`,Xl=a(tr.Small)`
    ...
    padding: 0;
    margin: 1rem 0 0 0;
`,Kl=n=>{var{collapsible:r=!0,initialExpanded:i=!1,expanded:o,onExpandChange:a,minimisable:s=!1,minimisedHeight:l,showDivider:c=!0,showMobileDivider:d=!0,title:u,addon:f,children:p}=n,m=re(n,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","addon","children"]);const{mode:g,rootNode:b}=w(yr),v="mobile"===g,[$,S]=h(j()),[x,F]=h(s),O=!v&&r,k=fi(),D=fi(),B=_s({height:$?k.height:0}),_=x?null!=l?l:Math.min(.5*D.height,216):D.height;y((()=>{S(j())}),[r,o]);function j(){return!!v||(br(o)?!r||i:o)}return e(Wl,Object.assign({$collapsible:O},{children:[t(Vl,{$showDivider:c,$showMobileDivider:d}),(u||O)&&e(Yl,{children:[u&&e(Ul,Object.assign({weight:"semibold"},{children:[u," ",f&&("popover"===f.type?t(Ll,{addon:f,rootNode:v?b:void 0}):null)]})),O&&t(ql,Object.assign({focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!$;br(o)&&S(e),a&&a(e)},"aria-label":$?"Collapse":"Expand"},{children:t(Ql,{$expanded:$})}))]}),t(Jl,Object.assign({"data-testid":"expandable-container","data-expanded":$,style:B},{children:t("div",Object.assign({ref:k.ref},{children:e(Zl,Object.assign({},m,{children:[t(Gl,Object.assign({"data-testid":"minimisable-container",$height:_,$minimisable:s},{children:t("div",Object.assign({ref:D.ref},{children:t("div",Object.assign({"data-id":"content-container"},{children:"function"==typeof p?p(g,{minimised:x}):p}))}))})),s&&e(Xl,Object.assign({"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{F(!x)}},{children:["View ",x?"more":"less"]}))]}))}))}))]}))},ec=a.div`
    height: 1.625rem;
    width: 1.625rem;
    margin-right: 0.5rem;
    flex-shrink: 0;
...
`,tc=({type:e,active:n=!1,disabled:r,className:i})=>{let o;switch(e){case"checkbox":o=t(n?J:U,{});break;case"radio":o=t(n?Q:q,{});break;case"tick":o=t(Z,{});break;case"cross":o=t(V,{});break;default:o=null}return t(ec,Object.assign({className:i,$active:n,disabled:r},{children:o}))},nc=a.div`
...
`),uc=e=>{var{size:n="Body",children:r}=e,i=re(e,["size","children"]);return t(dc,Object.assign({size:n},i,{children:r}))},hc=a.div`
    position: relative;
    display: inline-flex;
    min-width: 10.375rem;
    border-radius: 4px;
...
`,Cc=a((({type:r="checkbox",indicator:i,checked:o,styleType:a="default",children:s,childrenMaxLines:l,subLabel:c,disabled:d,error:f,name:p,id:m,className:g,compositeSection:b,removable:v,onRemove:$,"data-testid":w,onChange:x,useContentWidth:F})=>{const{collapsible:O=!0,errors:k,children:D,initialExpanded:B}=b||{},[_,j]=h(o),[C,E]=h(B),M=S((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[P]=h(vl.generate()),H=m?`${m}`:`tg-${P}`,T=u();y((()=>{j(o)}),[o]),y((()=>{_&&E(null==B||B)}),[_]);const I=e=>{if(!d){if(x)return void x(e);switch(r){case"checkbox":j((e=>!e));break;case"radio":case"yes":case"no":_||j(!0)}}},A=()=>{d||E(!C)},z=()=>{d||!$||$()},R=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(tc,{type:e,active:_,disabled:d})},N=()=>{if(!c)return null;let e;return e="function"==typeof c?c():c,t(gc,Object.assign({"data-id":"toggle-sublabel",$disabled:d,$selected:_},{children:e}))},L=()=>{const n=!C&&!M;return O&&e($c,Object.assign({$paddingTopRequired:n,disabled:d,onClick:A,"data-testid":C?"collapse-button":"expand-button"},{children:[C?"Show less":"Show more",t(C?G:Y,{"aria-hidden":!0})]}))},W=r=>e(n,{children:[t(Fc,Object.assign({weight:"semibold",$disabled:d},{children:"Error"})),t(Oc,Object.assign({$disabled:d},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${H}-error-list-item-${n}`},{children:t(Fc,Object.assign({weight:"semibold",$disabled:d},{children:e}))}),n)))}))]});return e(hc,Object.assign({$selected:_,$disabled:d,className:g,$styleType:a,$error:f,$indicator:i,$useContentWidth:F,id:m,"data-testid":w},{children:[e(yc,Object.assign({id:`${H}-header-container`,$disabled:d,$error:f,$selected:_,$indicator:i,$styleType:a},{children:[e(bc,Object.assign({$addPadding:v},{children:[t(fc,{ref:T,name:p,id:`${H}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:d,onChange:I,checked:_}),i&&R(),e(pc,{children:[t(mc,Object.assign({htmlFor:`${H}-input`,$selected:_,$indicator:i,$disabled:d,"data-testid":`${H}-toggle-label`,$maxLines:l},{children:s})),c&&N()]})]})),v&&t(vc,Object.assign({type:"button",$disabled:d,onClick:z,id:`${H}-remove-button`},{children:"Remove"}))]})),D&&e("div",{children:[(!O||C)&&t(xc,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:d},{children:D})),O&&!C&&M&&t(wc,Object.assign({$disabled:d,onClick:A,id:`${H}-error-alert`},{children:t(Sc,Object.assign({type:d?"description":"error",className:g,showIcon:!0},{children:Array.isArray(k)?W(k):k}))})),L()]})]}))}))`
