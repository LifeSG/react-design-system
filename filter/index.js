...
`,Mc=a((({type:r="checkbox",indicator:i,checked:o,styleType:a="default",children:s,childrenMaxLines:l,subLabel:c,disabled:d,error:f,name:p,id:m,className:g,compositeSection:b,removable:v,onRemove:$,"data-testid":w,onChange:x,useContentWidth:F})=>{const{collapsible:O=!0,errors:k,children:D,initialExpanded:B}=b||{},[_,j]=h(o),[C,E]=h(B),M=S((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[P]=h(yl.generate()),H=m?`${m}`:`tg-${P}`,I=u();y((()=>{j(o)}),[o]),y((()=>{_&&E(null==B||B)}),[_]);const T=e=>{if(!d){if(x)return void x(e);switch(r){case"checkbox":j((e=>!e));break;case"radio":case"yes":case"no":_||j(!0)}}},A=()=>{d||E(!C)},z=()=>{d||!$||$()},R=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(rc,{type:e,active:_,disabled:d})},N=()=>{if(!c)return null;let e;return e="function"==typeof c?c():c,t(bc,Object.assign({"data-id":"toggle-sublabel",$disabled:d,$selected:_},{children:e}))},V=()=>{const n=!C&&!M;return O&&e(Sc,Object.assign({$paddingTopRequired:n,disabled:d,onClick:A,"data-testid":C?"collapse-button":"expand-button"},{children:[C?"Show less":"Show more",t(C?G:Y,{"aria-hidden":!0})]}))},L=r=>e(n,{children:[t(kc,Object.assign({weight:"semibold",$disabled:d},{children:"Error"})),t(Dc,Object.assign({$disabled:d},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${H}-error-list-item-${n}`},{children:t(kc,Object.assign({weight:"semibold",$disabled:d},{children:e}))}),n)))}))]});return e(pc,Object.assign({$selected:_,$disabled:d,className:g,$styleType:a,$error:f,$indicator:i,$useContentWidth:F,id:m,"data-testid":w},{children:[e(vc,Object.assign({id:`${H}-header-container`,$disabled:d,$error:f,$selected:_,$indicator:i,$styleType:a},{children:[e($c,Object.assign({$addPadding:v},{children:[t(mc,{ref:I,name:p,id:`${H}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:d,onChange:T,checked:_}),i&&R(),e(gc,{children:[t(yc,Object.assign({htmlFor:`${H}-input`,$selected:_,$indicator:i,$disabled:d,"data-testid":`${H}-toggle-label`,$maxLines:l},{children:s})),c&&N()]})]})),v&&t(wc,Object.assign({type:"button",$disabled:d,onClick:z,id:`${H}-remove-button`},{children:"Remove"}))]})),D&&e("div",{children:[(!O||C)&&t(Oc,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:d},{children:D})),O&&!C&&M&&t(xc,Object.assign({$disabled:d,onClick:A,id:`${H}-error-alert`},{children:t(Fc,Object.assign({type:d?"description":"error",className:g,showIcon:!0},{children:Array.isArray(k)?L(k):k}))})),V()]})]}))}))`
