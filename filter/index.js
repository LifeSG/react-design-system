...
`,Qc=C(Eo.Default)`
    width: 100%;
`,Uc=({onDismiss:r,onDone:n,children:i})=>t(Mc,{children:[e(Hc,{onClick:r,focusOutline:"browser",focusHighlight:!1,"aria-label":"Dismiss",children:e(ae,{})}),e(Lc,{children:i}),e(qc,{children:e(Qc,{onClick:n,type:"button",children:"Done"})})]});Uc.displayName="Filter.Page";const Zc=n=>{var{toggleFilterButtonLabel:i="Filters",toggleFilterButtonStyle:o="light",headerTitle:s="Filters",clearButtonDisabled:a=!1,onClear:c,onDismiss:u,onDone:m,children:f}=n,p=le(n,["toggleFilterButtonLabel","toggleFilterButtonStyle","headerTitle","clearButtonDisabled","onClear","onDismiss","onDone","children"]);const[b,v]=g(!1),x=h(null),w=h(null),$=k(),F=Vi["lg-max"]({theme:$}),C=ge.useMediaQuery({maxWidth:F});y((()=>{C||D()}),[C]);const E=()=>{v(!0)},D=()=>{v(!1),u&&u()},_=()=>{v(!1),m&&m()},O=()=>{c&&c()},S=e=>"function"==typeof f?f(e):f,A=r=>t(Wc,{children:["mobile"===r&&e(Hc,{onClick:D,focusOutline:"browser",focusHighlight:!1,"aria-label":"Dismiss",children:e(d,{})}),e(Yc,{weight:"semibold",children:s}),e(Nc,{styleType:"link",type:"button",onClick:O,disabled:a,children:"Clear"})]});return e("div",Object.assign({},p,{children:e(eo.Provider,C?{value:{mode:"mobile",rootNode:x},children:t(r,{children:[e(Vc,{"data-testid":"filter-show-button",styleType:o,onClick:E,type:"button",icon:e(l,{}),children:i}),e(Gi,{show:b,disableTransition:!0,children:e(Rc,{"data-id":"filter-mobile","data-testid":"filter-mobile",children:t(Pc,{ref:x,children:[A("mobile"),e(Lc,{children:S("mobile")}),e(qc,{children:e(Qc,{onClick:_,type:"button",children:"Done"})})]})})})]})}:{value:{mode:"default",rootNode:w},children:t(Ic,{"data-id":"filter-desktop","data-testid":"filter-desktop",ref:w,children:[A("default"),S("default")]})})}))};Zc.displayName="Filter";const Xc=Object.assign(Zc,{Item:Cc,Page:Uc,Checkbox:Ac});export{Xc as Filter};
