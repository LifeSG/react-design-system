...
`,Cl=e=>{const{textSize:t}=e||{};return s`
        // Text styling
        ${t&&qn(t,"regular")}
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,Ml=a((e=>{var{children:n}=e,r=re(e,["children"]);const i=r["data-testid"]||"card";return t(Bl,Object.assign({},r,{"data-testid":i},{children:"string"==typeof n?t(Un.Body,{children:n}):n}))}))`
    color: ${$n.Neutral[1]};
...
`,Pl=a((n=>{var{id:r="modal-box",children:i,onClose:o,showCloseButton:a=!0}=n,s=re(n,["id","children","onClose","showCloseButton"]);return e(_l,Object.assign({"data-testid":r},s,{onClick:e=>{e.stopPropagation()}},{children:[a&&t(jl,Object.assign({onClick:o,"data-testid":"close-button",focusHighlight:!1},{children:t(W,{})})),i]}))}))`
...
`,Hl=a.div`
    ...
    color: ${$n.Neutral[1]};
    ${Cl({textSize:"BodySmall"})}
`,Il=r=>{var{children:i,visible:o,onMobileClose:a}=r,s=re(r,["children","visible","onMobileClose"]);const l=s["data-testid"]||"popover",c=Js.useMediaQuery({maxWidth:On.mobileL}),d=()=>{a&&a()},u=()=>"string"==typeof i?t(Un.BodySmall,{children:i}):i;return e(n,{children:[o&&t(El,Object.assign({"data-testid":l},s,{children:t(Ml,{children:u()})})),c&&t(Dl,Object.assign({show:o,onOverlayClick:d},{children:t(Pl,Object.assign({onClose:d},{children:t(Hl,{children:u()})}))}))]})},Tl=a.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,Al=r=>{var i,o,{children:a,popoverContent:s,trigger:l="click",position:c="top",zIndex:d,rootNode:f,customOffset:p,delay:m,onPopoverAppear:g,onPopoverDismiss:b}=r,v=re(r,["children","popoverContent","trigger","position","zIndex","rootNode","customOffset","delay","onPopoverAppear","onPopoverDismiss"]);const[$,w]=h(!1),S=u(),x=u(),O=Js.useMediaQuery({maxWidth:Dn.mobileL}),{refs:F,floatingStyles:k,context:D}=E({open:$,placement:c,whileElementsMounted:M,middleware:[P(null!=p?p:16),H(),I({limiter:T()})],onOpenChange:e=>{w(e),$!==e&&J(e)}}),_=(()=>{const[e,t]=h(void 0),n=B();return y((()=>{if(!n)return void t(void 0);const e=e=>{t(e.zIndex)};return n.events.on(wl.Change,e),n.events.emit(wl.Ready),()=>n.events.off(wl.Change,e)}),[n]),e})(),j=O?"click":l,C=A(D,{ignoreMouse:"hover"===j}),W=z(D),Y=R(D,{enabled:"hover"===j,delay:{open:null!==(i=null==m?void 0:m.open)&&void 0!==i?i:0,close:null!==(o=null==m?void 0:m.close)&&void 0!==o?o:500}}),{getReferenceProps:q,getFloatingProps:Q}=N([C,W,Y]),U=()=>{w(!1),J(!1)},J=e=>{e&&g&&g(),!e&&b&&b()};return e(n,{children:[t(Tl,Object.assign({ref:e=>{S.current=e,F.setReference(e)}},q({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),v,{children:a})),$&&t(V,Object.assign({root:f},{children:t(L,Object.assign({context:D},{children:t("div",Object.assign({ref:e=>{x.current=e,F.setFloating(e)},style:Object.assign(Object.assign({},k),{outline:"none",zIndex:null!=d?d:_})},Q(),{children:"function"==typeof s?s():t(Il,Object.assign({visible:!0,onMobileClose:U},{children:s}))}))}))}))]})},zl=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}},Rl=a.span`
    color: ${$n.Primary};
    font-weight: 600;
...
`,Vl=n=>{var{ariaLabel:r,content:i,icon:o,underlineStyle:a="default",underlineHoverStyle:s="default"}=n,l=re(n,["ariaLabel","content","icon","underlineStyle","underlineHoverStyle"]);const c=!!i;return t(Al,Object.assign({},l,{children:e(Rl,Object.assign({role:"button","aria-haspopup":"dialog",tabIndex:0,$defaultStyle:a,$hoverStyle:s,"aria-label":null!=r?r:c?void 0:"More info"},{children:[i,o&&t(Nl,Object.assign({$standalone:!c},{children:o}))]}))}))};a.button`
...
`;const Ll=a.div`
    ...
    display: inline;
`,Wl=({addon:e,rootNode:n})=>{const{content:r,type:i,icon:o,id:a,zIndex:s,"data-testid":l}=e;return t(Ll,{children:t(Vl,{trigger:"click",id:a,"data-testid":l,popoverContent:r,rootNode:n,zIndex:s,icon:null!=o?o:t(D,{"data-testid":`${i}-icon`}),ariaLabel:"More info"})})},Yl=a.div`
...
`,ec=a(tr.Small)`
    ...
    padding: 0;
    margin: 1rem 0 0 0;
`,tc=n=>{var{collapsible:r=!0,initialExpanded:i=!1,expanded:o,onExpandChange:a,minimisable:s=!1,minimisedHeight:l,showDivider:c=!0,showMobileDivider:d=!0,title:u,addon:f,children:p}=n,m=re(n,["collapsible","initialExpanded","expanded","onExpandChange","minimisable","minimisedHeight","showDivider","showMobileDivider","title","addon","children"]);const{mode:g,rootNode:b}=w(yr),v="mobile"===g,[$,S]=h(j()),[x,O]=h(s),F=!v&&r,k=fi(),D=fi(),B=Bs({height:$?k.height:0}),_=x?null!=l?l:Math.min(.5*D.height,216):D.height;y((()=>{S(j())}),[r,o]);function j(){return!!v||(br(o)?!r||i:o)}return e(Yl,Object.assign({$collapsible:F},{children:[t(ql,{$showDivider:c,$showMobileDivider:d}),(u||F)&&e(Ql,{children:[u&&e(Zl,Object.assign({weight:"semibold"},{children:[u," ",f&&("popover"===f.type?t(Wl,{addon:f,rootNode:v?b:void 0}):null)]})),F&&t(Ul,Object.assign({focusHighlight:!1,focusOutline:"browser",onClick:()=>{const e=!$;br(o)&&S(e),a&&a(e)},"aria-label":$?"Collapse":"Expand"},{children:t(Jl,{$expanded:$})}))]}),t(Gl,Object.assign({"data-testid":"expandable-container","data-expanded":$,style:B},{children:t("div",Object.assign({ref:k.ref},{children:e(Xl,Object.assign({},m,{children:[t(Kl,Object.assign({"data-testid":"minimisable-container",$height:_,$minimisable:s},{children:t("div",Object.assign({ref:D.ref},{children:t("div",Object.assign({"data-id":"content-container"},{children:"function"==typeof p?p(g,{minimised:x}):p}))}))})),s&&e(ec,Object.assign({"data-id":"minimise-button",styleType:"link",type:"button",onClick:()=>{O(!x)}},{children:["View ",x?"more":"less"]}))]}))}))}))]}))},nc=a.div`
    height: 1.625rem;
    width: 1.625rem;
    margin-right: 0.5rem;
    flex-shrink: 0;
...
`,rc=({type:e,active:n=!1,disabled:r,className:i})=>{let o;switch(e){case"checkbox":o=t(n?J:U,{});break;case"radio":o=t(n?Q:q,{});break;case"tick":o=t(Z,{});break;case"cross":o=t(W,{});break;default:o=null}return t(nc,Object.assign({className:i,$active:n,disabled:r},{children:o}))},ic=a.div`
...
`),fc=e=>{var{size:n="Body",children:r}=e,i=re(e,["size","children"]);return t(hc,Object.assign({size:n},i,{children:r}))},pc=a.div`
    position: relative;
    display: inline-flex;
    min-width: 10.375rem;
    border-radius: 4px;
...
`,Pc=a((({type:r="checkbox",indicator:i,checked:o,styleType:a="default",children:s,childrenMaxLines:l,subLabel:c,disabled:d,error:f,name:p,id:m,className:g,compositeSection:b,removable:v,onRemove:$,"data-testid":w,onChange:x,useContentWidth:O})=>{const{collapsible:F=!0,errors:k,children:D,initialExpanded:B}=b||{},[_,j]=h(o),[C,E]=h(B),M=S((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[P]=h(yl.generate()),H=m?`${m}`:`tg-${P}`,I=u();y((()=>{j(o)}),[o]),y((()=>{_&&E(null==B||B)}),[_]);const T=e=>{if(!d){if(x)return void x(e);switch(r){case"checkbox":j((e=>!e));break;case"radio":case"yes":case"no":_||j(!0)}}},A=()=>{d||E(!C)},z=()=>{d||!$||$()},R=()=>{var e;null===(e=null==I?void 0:I.current)||void 0===e||e.click()},N=e=>{e.stopPropagation()},V=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(rc,{type:e,active:_,disabled:d})},L=()=>{if(!c)return null;let e;return e="function"==typeof c?c():c,t(vc,Object.assign({"data-id":"toggle-sublabel",$disabled:d,$selected:_},{children:e}))},W=()=>{const n=!C&&!M;return F&&e(xc,Object.assign({$paddingTopRequired:n,disabled:d,onClick:A,"data-testid":C?"collapse-button":"expand-button"},{children:[C?"Show less":"Show more",t(C?G:Y,{"aria-hidden":!0})]}))},q=r=>e(n,{children:[t(Dc,Object.assign({weight:"semibold",$disabled:d},{children:"Error"})),t(Bc,Object.assign({$disabled:d},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${H}-error-list-item-${n}`},{children:t(Dc,Object.assign({weight:"semibold",$disabled:d},{children:e}))}),n)))}))]});return e(pc,Object.assign({$selected:_,$disabled:d,className:g,$styleType:a,$error:f,$indicator:i,$useContentWidth:O,id:m,"data-testid":w},{children:[e($c,Object.assign({id:`${H}-header-container`,$disabled:d,$error:f,$selected:_,$indicator:i,$styleType:a},{children:[t(wc,Object.assign({$addPadding:v},{children:e(gc,Object.assign({id:`${H}-input-container`,onClick:R},{children:[t(mc,{ref:I,name:p,id:`${H}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:d,onChange:T,onClick:N,checked:_}),i&&V(),e(yc,{children:[t(bc,Object.assign({htmlFor:`${H}-input`,$selected:_,$indicator:i,$disabled:d,"data-testid":`${H}-toggle-label`,$maxLines:l},{children:s})),c&&L()]})]}))})),v&&t(Sc,Object.assign({type:"button",$disabled:d,onClick:z,id:`${H}-remove-button`},{children:"Remove"}))]})),D&&e("div",{children:[(!F||C)&&t(kc,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!F,$disabled:d},{children:D})),F&&!C&&M&&t(Oc,Object.assign({$disabled:d,onClick:A,id:`${H}-error-alert`},{children:t(Fc,Object.assign({type:d?"description":"error",className:g,showIcon:!0},{children:Array.isArray(k)?q(k):k}))})),W()]})]}))}))`
