...
`,Ie=({external:t=!1,children:i,...r})=>e(Ve,{...r,children:[i,t&&n(Te,{})]});var Ne;!function(t){t[t.Subpage=0]="Subpage",t[t.Domain=1]="Domain"}(Ne||(Ne={}));const Re={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},Ye=t=>Object.keys(Re).reduce(((e,n)=>{const i=Re[n];return e[n]=`@media screen and (${t}: ${i}px)`,e}),{}),Pe=Ye("max-width"),Ue=(Ye("min-width"),r.div`
    display: flex;
...
`,Je=()=>e(Ue,{"data-testid":"download-app-section",children:[n(Ge,{weight:"semibold",children:"Download the app"}),e(Xe,{children:[n(Ze,{href:"https://apps.apple.com/sg/app/moments-of-life/id1383218758",target:"_blank",rel:"noopener noreferrer",id:"footer-download-app-apple",children:n("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/apple-app-store.png",alt:"apple-app-store"})}),n(Ze,{href:"https://play.google.com/store/apps/details?id=sg.gov.app.mol&hl=en_SG",target:"_blank",rel:"noopener noreferrer",id:"footer-download-app-android",children:n("img",{src:"https://assets.life.gov.sg/react-design-system/img/download/google-play-store.png",alt:"google-play-store"})})]})]});var qe,Qe={exports:{}},Ke=Qe.exports=function(){var t=1e3,e=6e4,n=36e5,i="millisecond",r="second",o="minute",a="hour",l="day",s="week",c="month",h="quarter",d="year",u="date",f="Invalid Date",g=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,p=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,m={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(t){var e=["th","st","nd","rd"],n=t%100;return"["+t+(e[(n-20)%10]||e[n]||e[0])+"]"}},y=function(t,e,n){var i=String(t);return!i||i.length>=e?t:""+Array(e+1-i.length).join(n)+t},$={s:y,z:function(t){var e=-t.utcOffset(),n=Math.abs(e),i=Math.floor(n/60),r=n%60;return(e<=0?"+":"-")+y(i,2,"0")+":"+y(r,2,"0")},m:function t(e,n){if(e.date()<n.date())return-t(n,e);var i=12*(n.year()-e.year())+(n.month()-e.month()),r=e.clone().add(i,c),o=n-r<0,a=e.clone().add(i+(o?-1:1),c);return+(-(i+(n-r)/(o?r-a:a-r))||0)},a:function(t){return t<0?Math.ceil(t)||0:Math.floor(t)},p:function(t){return{M:c,y:d,w:s,d:l,D:u,h:a,m:o,s:r,ms:i,Q:h}[t]||String(t||"").toLowerCase().replace(/s$/,"")},u:function(t){return void 0===t}},v="en",S={};S[v]=m;var F=function(t){return t instanceof w},D=function t(e,n,i){var r;if(!e)return v;if("string"==typeof e){var o=e.toLowerCase();S[o]&&(r=o),n&&(S[o]=n,r=o);var a=e.split("-");if(!r&&a.length>1)return t(a[0])}else{var l=e.name;S[l]=e,r=l}return!i&&r&&(v=r),r||!i&&v},b=function(t,e){if(F(t))return t.clone();var n="object"==typeof e?e:{};return n.date=t,n.args=arguments,new w(n)},H=$;H.l=D,H.i=F,H.w=function(t,e){return b(t,{locale:e.$L,utc:e.$u,x:e.$x,$offset:e.$offset})};var w=function(){function m(t){this.$L=D(t.locale,null,!0),this.parse(t)}var y=m.prototype;return y.parse=function(t){this.$d=function(t){var e=t.date,n=t.utc;if(null===e)return new Date(NaN);if(H.u(e))return new Date;if(e instanceof Date)return new Date(e);if("string"==typeof e&&!/Z$/i.test(e)){var i=e.match(g);if(i){var r=i[2]-1||0,o=(i[7]||"0").substring(0,3);return n?new Date(Date.UTC(i[1],r,i[3]||1,i[4]||0,i[5]||0,i[6]||0,o)):new Date(i[1],r,i[3]||1,i[4]||0,i[5]||0,i[6]||0,o)}}return new Date(e)}(t),this.$x=t.x||{},this.init()},y.init=function(){var t=this.$d;this.$y=t.getFullYear(),this.$M=t.getMonth(),this.$D=t.getDate(),this.$W=t.getDay(),this.$H=t.getHours(),this.$m=t.getMinutes(),this.$s=t.getSeconds(),this.$ms=t.getMilliseconds()},y.$utils=function(){return H},y.isValid=function(){return!(this.$d.toString()===f)},y.isSame=function(t,e){var n=b(t);return this.startOf(e)<=n&&n<=this.endOf(e)},y.isAfter=function(t,e){return b(t)<this.startOf(e)},y.isBefore=function(t,e){return this.endOf(e)<b(t)},y.$g=function(t,e,n){return H.u(t)?this[e]:this.set(n,t)},y.unix=function(){return Math.floor(this.valueOf()/1e3)},y.valueOf=function(){return this.$d.getTime()},y.startOf=function(t,e){var n=this,i=!!H.u(e)||e,h=H.p(t),f=function(t,e){var r=H.w(n.$u?Date.UTC(n.$y,e,t):new Date(n.$y,e,t),n);return i?r:r.endOf(l)},g=function(t,e){return H.w(n.toDate()[t].apply(n.toDate("s"),(i?[0,0,0,0]:[23,59,59,999]).slice(e)),n)},p=this.$W,m=this.$M,y=this.$D,$="set"+(this.$u?"UTC":"");switch(h){case d:return i?f(1,0):f(31,11);case c:return i?f(1,m):f(0,m+1);case s:var v=this.$locale().weekStart||0,S=(p<v?p+7:p)-v;return f(i?y-S:y+(6-S),m);case l:case u:return g($+"Hours",0);case a:return g($+"Minutes",1);case o:return g($+"Seconds",2);case r:return g($+"Milliseconds",3);default:return this.clone()}},y.endOf=function(t){return this.startOf(t,!1)},y.$set=function(t,e){var n,s=H.p(t),h="set"+(this.$u?"UTC":""),f=(n={},n[l]=h+"Date",n[u]=h+"Date",n[c]=h+"Month",n[d]=h+"FullYear",n[a]=h+"Hours",n[o]=h+"Minutes",n[r]=h+"Seconds",n[i]=h+"Milliseconds",n)[s],g=s===l?this.$D+(e-this.$W):e;if(s===c||s===d){var p=this.clone().set(u,1);p.$d[f](g),p.init(),this.$d=p.set(u,Math.min(this.$D,p.daysInMonth())).$d}else f&&this.$d[f](g);return this.init(),this},y.set=function(t,e){return this.clone().$set(t,e)},y.get=function(t){return this[H.p(t)]()},y.add=function(i,h){var u,f=this;i=Number(i);var g=H.p(h),p=function(t){var e=b(f);return H.w(e.date(e.date()+Math.round(t*i)),f)};if(g===c)return this.set(c,this.$M+i);if(g===d)return this.set(d,this.$y+i);if(g===l)return p(1);if(g===s)return p(7);var m=(u={},u[o]=e,u[a]=n,u[r]=t,u)[g]||1,y=this.$d.getTime()+i*m;return H.w(y,this)},y.subtract=function(t,e){return this.add(-1*t,e)},y.format=function(t){var e=this,n=this.$locale();if(!this.isValid())return n.invalidDate||f;var i=t||"YYYY-MM-DDTHH:mm:ssZ",r=H.z(this),o=this.$H,a=this.$m,l=this.$M,s=n.weekdays,c=n.months,h=function(t,n,r,o){return t&&(t[n]||t(e,i))||r[n].slice(0,o)},d=function(t){return H.s(o%12||12,t,"0")},u=n.meridiem||function(t,e,n){var i=t<12?"AM":"PM";return n?i.toLowerCase():i},g={YY:String(this.$y).slice(-2),YYYY:this.$y,M:l+1,MM:H.s(l+1,2,"0"),MMM:h(n.monthsShort,l,c,3),MMMM:h(c,l),D:this.$D,DD:H.s(this.$D,2,"0"),d:String(this.$W),dd:h(n.weekdaysMin,this.$W,s,2),ddd:h(n.weekdaysShort,this.$W,s,3),dddd:s[this.$W],H:String(o),HH:H.s(o,2,"0"),h:d(1),hh:d(2),a:u(o,a,!0),A:u(o,a,!1),m:String(a),mm:H.s(a,2,"0"),s:String(this.$s),ss:H.s(this.$s,2,"0"),SSS:H.s(this.$ms,3,"0"),Z:r};return i.replace(p,(function(t,e){return e||g[t]||r.replace(":","")}))},y.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},y.diff=function(i,u,f){var g,p=H.p(u),m=b(i),y=(m.utcOffset()-this.utcOffset())*e,$=this-m,v=H.m(this,m);return v=(g={},g[d]=v/12,g[c]=v,g[h]=v/3,g[s]=($-y)/6048e5,g[l]=($-y)/864e5,g[a]=$/n,g[o]=$/e,g[r]=$/t,g)[p]||$,f?v:H.a(v)},y.daysInMonth=function(){return this.endOf(c).$D},y.$locale=function(){return S[this.$L]},y.locale=function(t,e){if(!t)return this.$L;var n=this.clone(),i=D(t,e,!0);return i&&(n.$L=i),n},y.clone=function(){return H.w(this.$d,this)},y.toDate=function(){return new Date(this.valueOf())},y.toJSON=function(){return this.isValid()?this.toISOString():null},y.toISOString=function(){return this.$d.toISOString()},y.toString=function(){return this.$d.toUTCString()},m}(),_=w.prototype;return b.prototype=_,[["$ms",i],["$s",r],["$m",o],["$H",a],["$W",l],["$M",c],["$y",d],["$D",u]].forEach((function(t){_[t[1]]=function(e){return this.$g(e,t[0],t[1])}})),b.extend=function(t,e){return t.$i||(t(e,w,b),t.$i=!0),b},b.locale=D,b.isDayjs=F,b.unix=function(t){return b(1e3*t)},b.en=S[v],b.Ls=S,b.p={},b}();!function(t){t.getCopyrightInfo=(t=new Date)=>`${`${(new Date).getFullYear()} LifeSG, Government of Singapore.`} Last Updated ${Ke(t).format("D MMMM YYYY")}`,t.getDisclaimerLinks=t=>({privacy:{href:"https://www.life.gov.sg/privacy-statement",target:"_blank",rel:"noopener",...t&&t.privacy?t.privacy:{},children:"Privacy Statement"},termsOfUse:{href:"https://www.life.gov.sg/terms-of-use",target:"_blank",rel:"noopener",...t&&t.termsOfUse?t.termsOfUse:{},children:"Terms of Use"},reportVulnerability:{href:"https://tech.gov.sg/report_vulnerability",target:"_blank",rel:"noopener",external:!0,...t&&t.reportVulnerability?t.reportVulnerability:{},children:"Report Vulnerability"}})}(qe||(qe={}));const tn=a.forwardRef(((t,e)=>{const{children:i,"data-testid":r="container",type:o="flex",...a}=t;return n(en,{ref:e,"data-testid":r,type:o,...a,children:i})})),en=r.div`
    flex-grow: 1;
    margin: 0 auto;
    position: relative;
    width: auto;
...
`,$n=({children:t,links:r,lastUpdated:o,disclaimerLinks:a,showDownloadAddon:l,logoSrc:s,copyrightInfo:c,onFooterLinkClick:h})=>{const d=t=>t.map(((t,e)=>{const{"data-options":i,...r}=t;return n("li",{children:n(sn,{...r,onClick:e=>((t,e)=>{e.onClick?(t.preventDefault(),e.onClick(t)):h&&(t.preventDefault(),h(e))})(e,t)})},e)}));return e(ln,{children:[(()=>{let o=null;return t||((r||l)&&(o=e(i,{children:[n(hn,{"data-testid":"logo-section",children:n("img",{src:s||"https://assets.life.gov.sg/react-design-system/img/logo/lifesg-primary-logo.svg",alt:"LifeSG","data-testid":"logo"})}),r?.[0]&&n(dn,{"data-testid":"link-col-1",children:d(r[0])},"link-col-1"),r?.[1]&&n(dn,{"data-testid":"link-col-2",children:d(r[1])},"link-col-2"),l&&n(un,{children:n(Je,{})})]})),o?n(cn,{type:"grid",children:o}):null)})(),n(fn,{}),e(gn,{type:"grid",children:[n(pn,{children:(()=>{const t=qe.getDisclaimerLinks(a);return Object.keys(t).map((e=>n(yn,{...t[e]},e)))})()},"disclaimer"),n(mn,{children:n(Le.XSmall,{"data-testid":"copyright-text",children:c||e(i,{children:["©"," ",qe.getCopyrightInfo(o)]})})},"copyright")]})]})};export{$n as Footer};
