...
`,Le=n=>{var{external:r=!1,children:i}=n,a=l(n,["external","children"]);return t(Me,Object.assign({},a,{children:[i,r&&e(We,{})]}))};var Te;!function(t){t[t.Subpage=0]="Subpage",t[t.Domain=1]="Domain"}(Te||(Te={}));const Ve={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},Ie=t=>Object.keys(Ve).reduce(((e,n)=>{const r=Ve[n];return e[n]=`@media screen and (${t}: ${r}px)`,e}),{}),Re=Ie("max-width"),Ne=(Ie("min-width"),r.div`
    display: flex;
...
`,pn=({children:r,links:i,lastUpdated:a,disclaimerLinks:o,showDownloadAddon:c,logoSrc:s,copyrightInfo:d,onFooterLinkClick:h,layout:u="default"})=>{const g="stretch"===u,f=t=>t.map(((t,n)=>{const r=l(t,["data-options"]);return e("li",{children:e(an,Object.assign({},r,{onClick:e=>((t,e)=>{e.onClick?(t.preventDefault(),e.onClick(t)):h&&(t.preventDefault(),h(e))})(e,t)}))},n)}));return t(rn,{children:[(()=>{let a=null;return r||((i||c)&&(a=t(n,{children:[e(ln,Object.assign({"data-testid":"logo-section"},{children:e("img",{src:s||"https://assets.life.gov.sg/react-design-system/img/logo/lifesg-primary-logo.svg",alt:"LifeSG","data-testid":"logo"})})),(null==i?void 0:i[0])&&e(cn,Object.assign({"data-testid":"link-col-1"},{children:f(i[0])}),"link-col-1"),(null==i?void 0:i[1])&&e(cn,Object.assign({"data-testid":"link-col-2"},{children:f(i[1])}),"link-col-2"),c&&e(sn,{children:e(Ue,{})})]})),a?e(on,Object.assign({type:"grid",stretch:g},{children:a})):null)})(),e(dn,{}),t(hn,Object.assign({type:"grid",stretch:g},{children:[e(un,{children:(()=>{const t=Xe.getDisclaimerLinks(o);return Object.keys(t).map((n=>e(fn,Object.assign({},t[n]),n)))})()},"disclaimer"),e(gn,{children:e(Ce.XSmall,Object.assign({"data-testid":"copyright-text"},{children:d||t(n,{children:["©"," ",Xe.getCopyrightInfo(a)]})}))},"copyright")]}))]})};export{pn as Footer};
