...
`,Gc=r=>{var{id:n,value:o,min:i=0,max:a=100,step:l=1,minRange:d=0,numOfThumbs:c=2,colors:u,disabled:f,readOnly:g,showSliderLabels:m,sliderLabelPrefix:p,sliderLabelSuffix:b,showIndicatorLabel:v,indicatorLabelPrefix:y,indicatorLabelSuffix:x,ariaLabels:w,ariaDescriptions:$,"aria-invalid":C,"aria-labelledby":D,"aria-describedby":S,renderSliderLabel:k,onChange:F,onChangeEnd:E}=r,_=ke(r,["id","value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","showIndicatorLabel","indicatorLabelPrefix","indicatorLabelSuffix","ariaLabels","ariaDescriptions","aria-invalid","aria-labelledby","aria-describedby","renderSliderLabel","onChange","onChangeEnd"]);const[O,T]=s(L()),[M]=s((()=>Je.generate())),I=function(){const e=function(){const e=f||g?la["border-disabled"]:la["border-strong"],t=f||g?la["border-selected-disabled"]:la["border-selected"];if(1===c)return[t,e];const r=[e];for(let e=0;e<c-1;e++)r.push(t);return r.push(e),r}();return new Array(c+1).fill(0).map(((t,r)=>(null==u?void 0:u[r])||e[r]))}(),B=`${M}-indicator`,A=`${M}-instruction`,z=Array.from({length:c},((e,t)=>(null==w?void 0:w[t])||function(e){return 1===c?"":0===e?"Minimum value slider":e===c-1?"Maximum value slider":"Indeterminate value slider"}(t)));h((()=>{o!==O&&T(L())}),[o]);const j=(e,t)=>{if(f||g)return;const r=function(e,t){if(c<2)return"";const r=O[t],n=t>0?O[t-1]:void 0,o=t<O.length-1?O[t+1]:void 0,i=z[t],a=t>0?z[t-1]:void 0,s=t<z.length-1?z[t+1]:void 0;if(function(e){return["ArrowRight","ArrowUp","PageUp","End"].includes(e)}(e)&&void 0!==o&&r>=o-d)return`The ${P(i)} has reached its limit. Increase the ${H(s)} to set a higher ${H(i)}.`;if(function(e){return["ArrowLeft","ArrowDown","PageDown","Home"].includes(e)}(e)&&void 0!==n&&r<=n+d)return`The ${P(i)} has reached its limit. Decrease the ${H(a)} to set a lower ${H(i)}.`;return""}(e.key,t);r&&(Tc("assertive"),Oc(r,"assertive"))};function L(){if(o&&o.length===c)return o;const e=[];for(let t=0;t<c;t++)e.push(i+l*t);return e}function R(e){return z[e]}function P(e){return e?e.toLowerCase():"slider"}function H(e){return e?e.replace(/ slider$/i,"").toLowerCase():"slider"}const N=e=>k?k(e):t(Vc,{children:[p,e,b]});return t(Nc,Object.assign({},_,{id:n,role:"group","aria-disabled":f||void 0,children:[!f&&!g&&e(sl,{id:A,children:"Use left and right arrow keys to adjust the slider."}),v&&e(Yc,{id:B,children:(()=>{let e="";if(1===O.length)e=`${O[0]}`;else if(2===O.length)e=`${O[0]} - ${O[1]}`;else if(O.length>2){e=`${Math.min(...O)} - ${Math.max(...O)}`}return t(Vc,{children:[y,e,x]})})()}),e(Uc,{step:l,min:i,max:a,value:O,disabled:f||g,onChange:(e,t)=>{if(g||f)return;if("number"==typeof e){const t=[e];return T(t),void(null==F||F(t))}if(t>-1&&O[t]===e[t])return;const r=[...e];T(r),null==F||F(r)},onAfterChange:e=>{if(!g&&!f)if("number"==typeof e){const t=[e];T(t),null==E||E(t)}else{const t=[...e];T(t),null==E||E(t)}},minDistance:d,renderThumb:(r,n)=>{const o=`${M}-thumb-label-${n.index}`,s=(l=n.index,null==$?void 0:$[l]);var l;const d=s?`${M}-thumb-description-${n.index}`:void 0,c=O[n.index];return t(Zc,Object.assign({"data-testid":`slider-thumb-${n.index}`},r,{tabIndex:r.tabIndex,"aria-labelledby":dl(D,o),"aria-describedby":(h=d,dl(S,v?B:void 0,f||g?void 0:A,h)),"aria-valuetext":(u=c,`${p||""}${u}${b||""}`),"aria-valuemin":i,"aria-valuemax":a,"aria-valuenow":c,"aria-readonly":g||void 0,"aria-invalid":C||void 0,onKeyDown:e=>{var t;j(e,n.index),null===(t=r.onKeyDown)||void 0===t||t.call(r,e)},children:[d&&e(sl,{id:d,children:s}),e(sl,{id:o,children:R(n.index)}),e(Kc,{$disabled:f,$readOnly:g})]}));var u,h},renderTrack:(t,r)=>e(qc,Object.assign({"data-testid":`slider-track-${r.index}`},t,{$color:I[r.index]}))}),m&&t(Wc,{children:[e("div",{children:N(i)}),e("div",{children:N(a)})]})]}))},Xc=k.div`
    display: flex;
    margin-bottom: ${ha["spacing-16"]};
...
`,vC=k((n=>{var{type:o="checkbox",indicator:i,checked:l,styleType:d="default",children:c,childrenMaxLines:u,subLabel:f,disabled:g,error:m,name:p,id:b,className:y,compositeSection:x,removable:w,onRemove:$,"data-testid":C,onChange:D,useContentWidth:S,"aria-describedby":k}=n,F=ke(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","onRemove","data-testid","onChange","useContentWidth","aria-describedby"]);const{collapsible:E=!0,errors:_,children:O,initialExpanded:T}=x||{},[M,I]=s(l),[B,A]=s(!!T),z=v((()=>{const e=Array.isArray(_)&&(null==_?void 0:_.length)>0,t=!Array.isArray(_)&&!!_;return e||t}),[_]),[j]=s(Je.generate()),L=b?`${b}`:`tg-${j}`,R=a(null);h((()=>{I(l)}),[l]),h((()=>{M&&A(null==T||T)}),[M]);const P=e=>{if(!g){if(D)return void D(e);switch(o){case"checkbox":I((e=>!e));break;case"radio":case"yes":case"no":M||I(!0)}}},H=()=>{g||A(!B)},N=()=>{g||!$||$()},W=()=>{var e;null===(e=null==R?void 0:R.current)||void 0===e||e.click()},Y=e=>{e.stopPropagation()},V=()=>{let t;switch(o){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=o}return e(aC,{type:t,active:M,disabled:g,$selected:M,$disabled:g})},U=()=>{if(!f)return null;let t;return t="function"==typeof f?f():f,e(G$,{"data-id":"toggle-sublabel",id:`${L}-sublabel`,"aria-hidden":!0,children:t})},K=n=>t(r,{children:[e(oC,{weight:"semibold",$disabled:g,children:"Error"}),e(iC,{$disabled:g,children:null==n?void 0:n.map(((t,r)=>e("li",{id:`${L}-error-list-item-${r}`,children:e(oC,{weight:"semibold",$disabled:g,children:t})},r)))})]});return t(V$,{$selected:M,$disabled:g,className:y,$styleType:d,$error:m,$indicator:i,$useContentWidth:S,id:b,"data-testid":C,children:[(()=>{const r=["string"==typeof f?`${L}-sublabel`:null,k].filter(Boolean).join(" ")||void 0;return t(X$,{id:`${L}-header-container`,$disabled:g,$error:m,$selected:M,$indicator:i,$styleType:d,children:[e(Q$,{$addPadding:w,children:t(K$,{id:`${L}-input-container`,onClick:W,children:[e(U$,Object.assign({ref:R,name:p,id:`${L}-input`,type:"checkbox"===o?"checkbox":"radio","data-testid":"toggle-input",disabled:g,onChange:P,onClick:Y,checked:M,"aria-describedby":r},F)),i&&V(),t(Z$,{$selected:M,$disabled:g,children:[e(q$,{htmlFor:`${L}-input`,"data-testid":"toggle-label",id:`${L}-label`,$maxLines:u,$selected:M,children:c}),f&&U()]})]})}),w&&e(J$,{type:"button",$disabled:g,onClick:N,id:`${L}-remove-button`,children:"Remove"})]})})(),O&&t("div",{children:[(!E||B)&&e(nC,{"data-id":"toggle-composite-children",$isFinalItem:!E,$disabled:g,children:O}),E&&!B&&z&&e(tC,{$disabled:g,onClick:H,id:`${L}-error-alert`,children:e(rC,{type:g?"description":"error",className:y,showIcon:!0,children:Array.isArray(_)?K(_):_})}),E&&t(eC,{$paddingTopRequired:!B&&!z,disabled:g,onClick:H,"data-testid":B?"collapse-button":"expand-button",children:[B?"Show less":"Show more",e(B?xe:re,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,yC=k(Cl.Small)`
    width: 7rem;
...
//# sourceMappingURL=index.3fc16ea8.js.map
