...
`,Hb=W(ii)`
    ...
    ${e=>Y`
        ...
        `}
`,Vb=w(((r,n)=>{var{value:a,variant:i,onClear:o}=r,s=Se(r,["value","variant","onClear"]);return t(Lb,{children:[t(Nb,{children:[e(zb,{$variant:i,"aria-hidden":!0}),e(Rb,Object.assign({ref:n,value:a,$variant:i},s))]}),a&&e(Hb,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:i},{children:e(Z,{"aria-hidden":!0})}))]})})),Wb=({listItems:n,multiSelect:a,selectedItems:s,disableItemFocus:l,itemsLoadState:c="success",itemTruncationType:u="end",itemMaxLines:h=2,labelDisplayType:f="inline",variant:p="default",listboxId:m,width:g,topScrollItem:b,onSelectItem:y,onSelectAll:v,onDismiss:w,onRetry:x,valueExtractor:S,listExtractor:_,renderListItem:O,renderCustomCallToAction:k,enableSearch:C,hideNoResultsDisplay:D,searchPlaceholder:j="Search",searchFunction:T,onSearch:F})=>{const{focusedIndex:B,setFocusedIndex:M}=$(vb),[I,E]=o(""),[P,A]=o(n),L=Qt(c),N=(()=>{const[e,t]=o(!1);return d((()=>{t(!0)}),[]),e})(),R=i(),z=i(),H=i([]),V=i(),W=e=>_?_(e):e.toString(),Y=Zt((()=>T(I))),U=Zt((()=>n.filter((e=>{var t;const r=W(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),a="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),i=I.trim().toLowerCase();return n.includes(i)||a&&a.includes(i)})))),K=(e,t)=>{M(t),null==y||y(e,(e=>S?S(e):e)(e))},q=e=>{const t=e.target.value;E(t),null==F||F()},Z=()=>{var e;E(""),null===(e=V.current)||void 0===e||e.focus(),null==F||F()},G=()=>{null==x||x()};Gt("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),B<P.length-1){const e=B+1;null===(t=H.current[e])||void 0===t||t.focus(),M(e)}break;case"ArrowUp":if(e.preventDefault(),B>0){const e=B-1;null===(r=H.current[e])||void 0===r||r.focus(),M(e)}else 0===B&&V.current&&(V.current.focus(),M(-1));break;case"Space":case"Enter":document.activeElement===H.current[B]&&(e.preventDefault(),P[B]&&K(P[B],B))}})),d((()=>{if(void 0===b)return;const e=setTimeout((()=>{var e;const t=n.indexOf(b),r=H.current[t];if(R.current){const t=null!==(e=null==r?void 0:r.offsetTop)&&void 0!==e?e:0;R.current.scrollTop=t-8}M(t)}),0);return()=>clearTimeout(e)}),[H,n,M,b]),d((()=>{N||l||(V.current?(M(-1),setTimeout((()=>{var e;return null===(e=V.current)||void 0===e?void 0:e.focus()}),200)):H.current[B]?setTimeout((()=>{var e;return null===(e=H.current[B])||void 0===e?void 0:e.focus()}),200):(M(0),setTimeout((()=>{var e;return null===(e=H.current[0])||void 0===e?void 0:e.focus()}),200)))}),[l,B,N,M]),d((()=>{N&&L&&(l||"success"===c&&V.current&&(M(-1),V.current.focus()))}),[N,L,c,M,l]),d((()=>{A(""===I?n:T?Y():U())}),[Y,U,n,T,I]);const J=t=>a?e(t?Cb:Db,{"aria-hidden":!0}):t?e(Ob,{"aria-hidden":!0}):e(kb,{}),Q=(t,r)=>{const n=W(t),a="string"==typeof n?n:n.title,i="string"==typeof n?void 0:n.secondaryLabel;return e(yb,{displayType:f,label:a,maxLines:h,selected:r,sublabel:i,truncationType:u,variant:p})},X=()=>{if(!x||x&&"success"===c)return P.map(((n,i)=>{const o=(e=>!!kh(s,(t=>Dh(t,e))))(n),l=i===B;return e(_b,Object.assign({"aria-selected":o,"aria-multiselectable":a,"data-testid":"list-item",onClick:()=>K(n,i),onMouseEnter:()=>(e=>{M(e)})(i),ref:e=>H.current[i]=e,role:"option",tabIndex:l?0:-1,$active:l},{children:O?O(n,{selected:o}):t(r,{children:[J(o),Q(n,o)]})}),((e,t)=>`item_${t}__${S?S(e):e}`)(n,i))}))},ee=()=>{if((C||T)&&"success"===c)return e(Vb,{ref:V,onChange:q,value:I,placeholder:j,"data-testid":"search-input","aria-label":"Enter text to search",onClear:Z,variant:p})},te=()=>{if(a&&P.length>0&&!I&&"success"===c)return e(jb,{children:e(Bb,Object.assign({onClick:v,type:"button",$variant:p},{children:0===s.length?"Select all":"Clear all"}))})},re=()=>{if(!D&&(I||!C)&&0===P.length&&"success"===c)return t(Mb,Object.assign({"data-testid":"list-no-results"},{children:[e(Eb,{"data-testid":"no-result-icon",$variant:p}),e(Ib,Object.assign({$variant:p},{children:"No results found."}))]}))},ne=()=>{if(x&&"loading"===c){const r="small"===p?16:18;return t(Mb,Object.assign({"data-testid":"list-loading"},{children:[e(yo,{$buttonStyle:"secondary",size:r}),e(Ib,Object.assign({$variant:p},{children:"Loading..."}))]}))}},ae=()=>{if(x&&"fail"===c)return t(Mb,Object.assign({"data-testid":"list-fail"},{children:[e(Eb,{"data-testid":"load-error-icon",$variant:p}),e(Ib,Object.assign({$variant:p},{children:"Failed to load."}))," ",e(Fb,Object.assign({onClick:G,type:"button",$variant:p},{children:"Try again."}))]}))};return t($b,Object.assign({"data-testid":"dropdown-container",ref:R,$width:g},{children:[t(xb,Object.assign({ref:z,"data-testid":"dropdown-list"},{children:[ee(),te(),re(),ne(),ae(),e(Sb,Object.assign({role:"listbox",id:m},{children:X()}))]})),(()=>{if(k)return e("div",Object.assign({"data-testid":"custom-cta"},{children:k(w,P)}))})()]}))},Yb=W(Os)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,uw=W.textarea`
    ...
    ${e=>e.readOnly?Y`
            ...
            `:void 0}
`,dw=a.forwardRef(((t,r)=>{var{value:n,disabled:a,error:i,rows:o=5}=t,s=Se(t,["value","disabled","error","rows"]);return e(uw,Object.assign({ref:r,disabled:a,value:n,error:i,rows:o},s))}));a.forwardRef(((r,n)=>{var{value:a,disabled:i,rows:s=5,onChange:l}=r,c=Se(r,["value","disabled","rows","onChange"]);const[u,h]=o(a);d((()=>{h(a)}),[a]);return t(cw,{children:[e(uw,Object.assign({ref:n,disabled:i,value:u,rows:s||5,onChange:e=>{const t=e.target.value;c.maxLength&&t.length>c.maxLength||(h(t),e.target.value=t,l&&l(e))}},c)),c.maxLength&&e(lw,{disabled:i,value:u,maxLength:c.maxLength,renderCustomCounter:c.renderCustomCounter})]})}));const hw=W.div`
    display: flex;
    justify-content: flex-end;
    margin-top: 0.25rem;
`,fw=W.div`
...
`,pw=W(Oi)`
    margin-top: 0;
`,mw=a.forwardRef(((n,a)=>{const{label:i,value:s,errorMessage:l,id:c="form-textarea","data-error-testid":u,"data-testid":h,onChange:f,layoutType:p,mobileCols:m,tabletCols:g,desktopCols:b}=n,y=Se(n,["label","value","errorMessage","id","data-error-testid","data-testid","onChange","layoutType","mobileCols","tabletCols","desktopCols"]),[v,w]=o(s);d((()=>{w(s)}),[s]);return t(Ri,Object.assign({id:c,label:i,disabled:y.disabled,layoutType:p,mobileCols:m,tabletCols:g,desktopCols:b},{children:[e(dw,Object.assign({id:`${c}-base`,"data-testid":h||c,value:v,error:!!l,onChange:e=>{const t=e.target.value;y.maxLength&&t.length>y.maxLength||(w(t),e.target.value=t,f&&f(e))},ref:a},y)),l||y.maxLength?t(hw,{children:[l&&e(fw,{children:e(pw,Object.assign({weight:"semibold","data-testid":u||(c?`${c}-error-message`:"error-message")},{children:l}))}),y.maxLength&&e(lw,{disabled:y.disabled,value:v,maxLength:y.maxLength,renderCustomCounter:y.renderCustomCounter})]}):e(r,{})]}))})),gw=W.div`
    position: relative;
`,bw=W(Ss)`
    height: 3rem;
    gap: 0.5rem;
