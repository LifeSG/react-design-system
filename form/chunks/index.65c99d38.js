...
`),yS=t=>{var{size:n="Body",children:r}=t,i=se(t,["size","children"]);return e(vS,Object.assign({size:n},i,{children:r}))},wS=D.div`
    position: relative;
    display: inline-flex;
    min-width: 10.375rem;
    border-radius: 4px;
