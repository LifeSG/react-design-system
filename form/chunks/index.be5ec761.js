...
`,zs=k($s)`
    margin-right: 0.5rem;
`,js=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=_e(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return t(Bs,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&e(zs,{}),e("span",{children:o})]}))};js.displayName="Button.Default";const Rs=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=_e(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return t(Bs,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&e(zs,{}),e("span",{children:o})]}))};Rs.displayName="Button.Small";const Ls=(r,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=_e(r,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return t(Bs,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:i},d,c,{children:[a&&e(zs,{}),e("span",{children:o})]}))};Ls.displayName="Button.Large";const Ps={Default:o.forwardRef(js),Small:o.forwardRef(Rs),Large:o.forwardRef(Ls)},Hs=D`
    color: ${ji.icon};
    height: 1rem;
    width: 1rem;
`,Ns=k(J)`
...
`,fc=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:d=!1}=r,u=_e(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),h={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:s};return t(hc,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:i},h,u,{children:[d?e($s,{}):l,e("span",{children:o})]}))};fc.displayName="ButtonWithIcon.Default";const pc=(r,n)=>{const{children:o,disabled:i=!1,styleType:a="default",danger:s=!1,icon:l,iconPosition:c="left",loading:d=!1}=r,u=_e(r,["children","disabled","styleType","danger","icon","iconPosition","loading"]),h={$buttonIconPosition:c,$buttonStyle:i?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:s};return t(hc,Object.assign({ref:n,"data-testid":u["data-testid"]||"button-with-icon",disabled:i},h,u,{children:[d?e($s,{}):l,e("span",{children:o})]}))};pc.displayName="ButtonWithIcon.Small";const gc={Default:o.forwardRef(fc),Small:o.forwardRef(pc)},mc=({className:t,progress:r,color:n,"data-testid":o})=>e(bc,{className:t,$innerWidth:r,$color:n,"data-testid":o,children:e("progress",{value:100*r,max:100})}),bc=k.div`
    position: relative;
    width: 100%;
    height: 8px;
    background: transparent;
...
`,ev=k.div`
    ...
    direction: rtl;
    text-align: right;
`,tv=k((r=>{var{className:n,checked:o,disabled:a,indeterminate:s,onChange:l,onKeyPress:c,displaySize:d="default"}=r,h=_e(r,["className","checked","disabled","indeterminate","onChange","onKeyPress","displaySize"]);const f=i(null);u((()=>{f.current&&(f.current.indeterminate=null!=s&&s)}),[s]);const p=e=>{if(!a){const t=e;if(!(" "===t.key||"change"===e.type))return;l&&l(e),c&&c(t)}};return t(Rb,{className:n,"data-testid":"checkbox",role:"checkbox","aria-checked":s?"mixed":o,"aria-labelledby":"checkbox-input",tabIndex:a?-1:0,onKeyDown:p,$displaySize:d,$disabled:a,$unchecked:!(s||o||a),children:[e(Yb,Object.assign({id:"checkbox-input","data-testid":"checkbox-input","aria-hidden":"true",type:"checkbox",checked:o,ref:f,tabIndex:-1,onChange:p,disabled:a},h)),s?e(Wb,{$disabled:a,"data-testid":"indeterminate"}):o?e(Nb,{$disabled:a,"data-testid":"checkmark"}):a?e(Hb,{"data-testid":"empty-disabled-checkbox"}):e(Pb,{$disabled:a,"data-testid":"empty-checkbox"})]})}))`
    flex-shrink: 0;
...
//# sourceMappingURL=index.be5ec761.js.map
