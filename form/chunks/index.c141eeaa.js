...
`,ys=S.div`
    ...
    ${({$variant:e,$interactive:t})=>{if(t)return"selected-month"===e?_`
        ...
        `}}
`,xs=({calendarDate:t,currentFocus:r,selectedStartDate:n,selectedEndDate:o,viewCalendarDate:i,isNewSelection:a,minDate:s,maxDate:l,allowDisabledSelection:c,onMonthSelect:d})=>{const u=g((()=>Ue.generateMonths(Ae(t))),[t]),h=e=>{const t="start"===r&&o&&e.isAfter(o,"month")&&a,i="end"===r&&n&&e.isBefore(n,"month")&&a;return!(!t&&!i)},f=e=>{const t=e.format("MMMM"),r=(n=e,!Ue.isWithinRange(n,s?Ae(s):void 0,l?Ae(l):void 0,"month"));var n;const o=i.isSame(e,"month")?"selected-month":Ae().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||h(e),interactive:!r||c,month:t,variant:o}};return u.length?e(vs,{children:u.map((t=>{const{disabledDisplay:r,interactive:n,variant:o,month:i}=f(t);return e(ys,{$variant:o,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||d(e)})(t,!n),children:i},i)}))}):null},ws=S.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Ml=o.forwardRef(((t,r)=>{var{"data-testid":n,styleType:o="primary",children:i,sizeType:a="default",type:s="button"}=t,l=_e(t,["data-testid","styleType","children","sizeType","type"]);return e(Fl,Object.assign({"data-testid":n||"iconButton",ref:r,type:s,$sizeType:a,$styleType:o},l,{children:i}))})),Al=Object.assign(Bi,{Box:Zi}),jl=_`
...
`,w$=x(((r,n)=>{var{value:o,variant:i,onClear:a}=r,s=_e(r,["value","variant","onClear"]);return t(m$,{$variant:i,children:[t(b$,{$variant:i,children:[e(y$,{"aria-hidden":!0}),e(v$,Object.assign({ref:n,value:o,$variant:i},s))]}),o&&e(x$,{"aria-label":"Clear search",focusOutline:"browser",onClick:a,children:e(G,{"aria-hidden":!0})})]})})),$$=({listItems:n,multiSelect:o,selectedItems:s,disableItemFocus:l,itemsLoadState:c="success",itemTruncationType:d="end",itemMaxLines:h=2,labelDisplayType:p="inline",variant:g="default",listboxId:m,width:b,topScrollItem:v,onSelectItem:y,onSelectAll:x,onDismiss:$,onRetry:C,valueExtractor:S,listExtractor:_,renderListItem:k,renderCustomCallToAction:D,enableSearch:O,hideNoResultsDisplay:T,searchPlaceholder:E="Search",searchFunction:I,onSearch:F})=>{const{focusedIndex:M,setFocusedIndex:A}=w(Jw),[j,z]=a(""),[B,R]=a(null!=n?n:[]),L=tr(c),P=Jt(),H=i(null),N=i(null),W=i([]),V=i(null),Y=i(null),U=e=>{const t=_?_(e):null==e?void 0:e.toString();return"object"==typeof t?{title:t.title,secondaryLabel:t.secondaryLabel}:{title:null!=t?t:""}},q=f((e=>!!mf(s,(t=>vf(t,e)))),[s]),K=Qt((()=>null==I?void 0:I(j))),Z=Qt((()=>null==n?void 0:n.filter((e=>{const{title:t,secondaryLabel:r}=U(e),n=j.trim().toLowerCase();return t.includes(n)||r&&r.includes(n)})))),G=(e,t)=>{A(t),null==y||y(e,(e=>S?S(e):e)(e))},Q=e=>{const t=e.target.value;z(t),null==F||F()},X=()=>{var e;z(""),null===(e=V.current)||void 0===e||e.focus(),null==F||F()},J=()=>{null==C||C()};Xt("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),M<B.length-1){const e=M+1;null===(t=W.current[e])||void 0===t||t.focus(),A(e)}break;case"ArrowUp":if(e.preventDefault(),M>0){const e=M-1;null===(r=W.current[e])||void 0===r||r.focus(),A(e)}else 0===M&&V.current&&(V.current.focus(),A(-1));break;case"Space":case"Enter":document.activeElement===W.current[M]&&(e.preventDefault(),B[M]&&G(B[M],M))}})),u((()=>{var e;if(!v)return void(null===(e=Y.current)||void 0===e||e.scrollTo({top:0}));const t=setTimeout((()=>{if(!n)return;const e=n.indexOf(v);Y.current&&-1!==e&&(Y.current.scrollToIndex({index:e}),A(e))}),0);return()=>clearTimeout(t)}),[W,n,A,v]),u((()=>{var e,t,r;if(P)return;if(l||!n)return;const o=n.findIndex((e=>q(e)));V.current?(A(-1),setTimeout((()=>{var e;return null===(e=V.current)||void 0===e?void 0:e.focus()}),200)):M>0?(null===(e=Y.current)||void 0===e||e.scrollToIndex({index:M,align:"center"}),setTimeout((()=>{var e;return null===(e=W.current[M])||void 0===e?void 0:e.focus()}),200)):-1!==o?(null===(t=Y.current)||void 0===t||t.scrollToIndex({index:o,align:"center"}),A(o),setTimeout((()=>{var e;return null===(e=W.current[o])||void 0===e?void 0:e.focus()}),200)):(null===(r=Y.current)||void 0===r||r.scrollToIndex({index:0}),A(0),setTimeout((()=>{var e;return null===(e=W.current[0])||void 0===e?void 0:e.focus()}),200))}),[q,l,M,n,P,A]),u((()=>{P&&L&&(l||"success"===c&&V.current&&(A(-1),V.current.focus()))}),[P,L,c,A,l]),u((()=>{var e;R(null!==(e=""===j?n:I?K():Z())&&void 0!==e?e:[])}),[K,Z,n,I,j]);const ee=t=>o?e(t?s$:l$,{"aria-hidden":!0}):t?e(i$,{"aria-hidden":!0}):e(a$,{}),te=(t,r)=>{const{title:n,secondaryLabel:o}=U(t);return e(pv,{displayType:p,label:n,maxLines:h,selected:r,sublabel:o,truncationType:d,variant:g})},re=(n,i)=>{if(!C||"success"===c){const a=q(n),s=i===M;return e(o$,{"aria-selected":a,"aria-multiselectable":o,"data-testid":"list-item",onClick:()=>G(n,i),onMouseEnter:()=>(e=>{A(e)})(i),ref:e=>{W.current[i]=e},role:"option",tabIndex:s?0:-1,$active:s,$selected:a,children:k?k(n,{selected:a}):t(r,{children:[ee(a),te(n,a)]})},((e,t)=>`item_${t}__${S?S(e):e}`)(n,i))}},ne=()=>{if(s&&o&&B.length>0&&!j&&"success"===c)return e(c$,{children:e(h$,{onClick:x,type:"button",$variant:g,children:0===s.length?"Select all":"Clear all"})})},oe=()=>{if(!T&&(j||!O)&&0===B.length&&"success"===c)return t(f$,{"data-testid":"list-no-results",children:[e(p$,{"data-testid":"no-result-icon"}),"No results found."]})},ie=()=>{if(C&&"loading"===c)return t(f$,{"data-testid":"list-loading",children:[e(g$,{}),"Loading..."]})},ae=()=>{if(C&&"fail"===c)return t(f$,{"data-testid":"list-fail",children:[e(p$,{"data-testid":"load-error-icon"}),"Failed to load. ",e(u$,{onClick:J,type:"button",$variant:g,children:"Try again."})]})},se=()=>{var t;const r="test"===process.env.NODE_ENV;return e(n$,{role:"listbox",id:m,children:e(Cw,Object.assign({ref:Y,style:{height:"100%"},data:B,customScrollParent:null!==(t=H.current)&&void 0!==t?t:void 0,itemContent:(e,t)=>re(t,e)},r?{initialItemCount:B.length}:{}),r?B.length:void 0)})};return t(t$,{"data-testid":"dropdown-container",ref:H,$width:b,$variant:g,children:[t(r$,{ref:N,"data-testid":"dropdown-list",children:[(()=>{if((O||I)&&"success"===c)return e(w$,{ref:V,onChange:Q,value:j,placeholder:E,"data-testid":"search-input","aria-label":"Enter text to search",onClear:X,variant:g})})(),ne(),oe(),ie(),ae(),se()]}),(()=>{if(D)return e("div",{"data-testid":"custom-cta",children:D($,B)})})()]})},C$=S(nl)`
    display: flex;
    align-items: center;
    gap: ${Si["spacing-8"]};
    width: 100%;
...
`,F_=S((({type:n="checkbox",indicator:o,checked:s,styleType:l="default",children:c,childrenMaxLines:d,subLabel:h,disabled:f,error:p,name:m,id:b,className:v,compositeSection:y,removable:x,onRemove:w,"data-testid":$,onChange:C,useContentWidth:S})=>{const{collapsible:_=!0,errors:k,children:D,initialExpanded:O}=y||{},[T,E]=a(s),[I,F]=a(!!O),M=g((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[A]=a(et.generate()),j=b?`${b}`:`tg-${A}`,z=i(null);u((()=>{E(s)}),[s]),u((()=>{T&&F(null==O||O)}),[T]);const B=()=>{f||F(!I)},R=()=>{f||!w||w()},L=()=>{let t;switch(n){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=n}return e(x_,{type:t,active:T,disabled:f,$selected:T,$disabled:f})},P=()=>{if(!h)return null;let t;return t="function"==typeof h?h():h,e(d_,{"data-id":"toggle-sublabel",children:t})},H=n=>t(r,{children:[e(v_,{weight:"semibold",$disabled:f,children:"Error"}),e(y_,{$disabled:f,children:null==n?void 0:n.map(((t,r)=>e("li",{id:`${j}-error-list-item-${r}`,children:e(v_,{weight:"semibold",$disabled:f,children:t})},r)))})]});return t(a_,{$selected:T,$disabled:f,className:v,$styleType:l,$error:p,$indicator:o,$useContentWidth:S,id:b,"data-testid":$,children:[t(u_,{id:`${j}-header-container`,$disabled:f,$error:p,$selected:T,$indicator:o,$styleType:l,children:[t(h_,{$addPadding:x,children:[e(s_,{ref:z,name:m,id:`${j}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:f,onChange:e=>{if(!f){if(C)return void C(e);switch(n){case"checkbox":E((e=>!e));break;case"radio":case"yes":case"no":T||E(!0)}}},checked:T}),o&&L(),t(l_,{$selected:T,$disabled:f,children:[e(c_,{htmlFor:`${j}-input`,"data-testid":`${j}-toggle-label`,$maxLines:d,children:c}),h&&P()]})]}),x&&e(f_,{type:"button",$disabled:f,onClick:R,id:`${j}-remove-button`,children:"Remove"})]}),D&&t("div",{children:[(!_||I)&&e(b_,{"data-id":"toggle-composite-children",$isFinalItem:!_,$disabled:f,children:D}),_&&!I&&M&&e(g_,{$disabled:f,onClick:B,id:`${j}-error-alert`,children:e(m_,{type:f?"description":"error",className:v,showIcon:!0,children:Array.isArray(k)?H(k):k})}),_&&t(p_,{$paddingTopRequired:!I&&!M,disabled:f,onClick:B,"data-testid":I?"collapse-button":"expand-button",children:[I?"Show less":"Show more",e(I?ye:Q,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,M_=S(ts.Small)`
    width: 7rem;
