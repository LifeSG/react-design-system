...
`;const nF=k(Dd)`
    height: calc(3rem - 2px); // exclude top and bottom borders
`,oF=r=>{var{id:n,disabled:o=!1,readOnly:i=!1,error:l,value:d,placeholder:c,format:u="24hr",onChange:h,onFocus:f,onBlur:g}=r,m=Oe(r,["id","disabled","readOnly","error","value","placeholder","format","onChange","onFocus","onBlur"]);const[b,v]=s(!1),y=a(null);ka("mousedown",(function(e){o||i||$(e)}),"document"),ka("keyup",(function(e){if("Tab"===e.code)$(e)}),"document");const x=()=>{o||i||b||(v(!0),f&&f())};const w=()=>{v(!1),g&&g()},$=e=>{y.current&&!y.current.contains(e.target)&&b&&w()},C=p((()=>"12hr"===u?"HH:MMam":"HH:MM"),[u,c]);return t(Sd,Object.assign({ref:y,id:n,$readOnly:i,$disabled:o,$error:l},m,{children:[e(nF,{onFocus:x,readOnly:!0,placeholder:c||C(),value:ek.formatDisplayValue(d,u),disabled:o,"data-testid":n?`${n}-timepicker-selector`:"timepicker-selector"}),e(Xk,{id:n,show:b,value:d,format:u,onCancel:()=>{w()},onChange:e=>{h&&h(e),w()}})]}))},iF=k(Fx)`
    margin-right: 0.5rem;
`,aF=k(tu)`
    width: 2.5rem;
...
//# sourceMappingURL=index.e41aa7e1.js.map
