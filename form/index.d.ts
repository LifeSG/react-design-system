...
export declare const Form: {
    ...
    MultiSelect: <T_1, V_1>({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, enableSearch, layoutType, mobileCols, tabletCols, desktopCols, variant, ...otherProps }: import("./types").FormMultiSelectProps<T_1, V_1>) => JSX.Element;
    ...
    Select: <T_2, V_2>({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, enableSearch, layoutType, mobileCols, tabletCols, desktopCols, variant, ...otherProps }: import("./types").FormInputSelectProps<T_2, V_2>) => JSX.Element;
    SelectHistogram: ({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, layoutType, mobileCols, tabletCols, desktopCols, histogramSlider, ...otherProps }: import("./types").FormSelectHistogramProps) => JSX.Element;
