...
export declare const Form: {
    ...
    NestedSelect: <V1, V2, V3>({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, ...otherProps }: import("./types").FormNestedSelectProps<V1, V2, V3>) => JSX.Element;
    NestedMultiSelect: <V1_1, V2_1, V3_1>({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, ...otherProps }: import("./types").FormNestedMultiSelectProps<V1_1, V2_1, V3_1>) => JSX.Element;
    ...
    PredictiveTextInput: <T_4, V_4>({ label, errorMessage, id, "data-error-testid": errorTestId, "data-testid": testId, ...otherProps }: import("./types").FormPredictiveTextInputProps<T_4, V_4>) => JSX.Element;
};
