...
export declare const SlideImage: import("styled-components").StyledComponent<({ src, className, alt, fit, placeholder, retrieveImageDimension, setDimension, }: import("./stateful-image").StatefulImageProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
export declare const SlidePlaceholderImage: import("styled-components").StyledComponent<(props: import("../shared/image-placeholder").ImagePlaceholderProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
...
export declare const ThumbnailImage: import("styled-components").StyledComponent<({ src, className, alt, fit, placeholder, retrieveImageDimension, setDimension, }: import("./stateful-image").StatefulImageProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
export {};
