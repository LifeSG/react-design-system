...
export declare const SlideImage: import("styled-components").StyledComponent<({ src, className, alt, fit, placeholder, }: import("./stateful-image").StatefulImageProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
...
export declare const ThumbnailImage: import("styled-components").StyledComponent<({ src, className, alt, fit, placeholder, }: import("./stateful-image").StatefulImageProps) => JSX.Element, import("styled-components").DefaultTheme, {}, never>;
export {};
