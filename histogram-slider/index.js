...
`,sn=s.div`
    ...
    ${e=>{let t=Mt.Neutral[6];return e.$disabled&&e.$selected?t=Mt.Neutral[4]:e.$disabled?t=Mt.Neutral[5]:e.$selected&&(t=Mt.Accent.Light[1]),l`
            background-color: ${t};
        `}}
`,ln=s((n=>{var{value:r,min:a=0,max:s=100,step:l=1,minRange:c,numOfThumbs:h=2,colors:p,disabled:d,readOnly:f,ariaLabels:g,showSliderLabels:m,sliderLabelPrefix:y,sliderLabelSuffix:v,renderSliderLabel:F,onChange:b}=n,S=u(n,["value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","ariaLabels","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","renderSliderLabel","onChange"]);const[B,D]=i(E()),x=function(){const e=function(){const e=d||f?Mt.Neutral[5]:Mt.Neutral[4],t=d||f?Mt.Neutral[4]:Mt.Primary;if(1===h)return[t,e];const n=[];n.push(e);for(let e=0;e<h-1;e++)n.push(t);return n.push(e),n}();return new Array(h+1).fill(0).map(((t,n)=>(null==p?void 0:p[n])||e[n]))}();o((()=>{r!==B&&D(E())}),[r]);function E(){if(r&&r.length===h)return r;const e=[];for(let t=0;t<h;t++)e.push(a+l*t);return e}const $=t=>F?F(t):e(Qt,{children:[y,t,v]});return e("div",Object.assign({},S,{children:[t(Zt,{step:l,min:a,max:s,value:B,disabled:d||f,onChange:(e,t)=>{if("number"==typeof e){const t=[e];D(t),null==b||b(t)}else{if(t>-1&&B[t]===e[t])return;D(e),null==b||b(e)}},minDistance:c,ariaLabel:g,renderThumb:(e,n)=>t(tn,Object.assign({"data-testid":`slider-thumb-${n.index}`},e,{tabIndex:d?void 0:e.tabIndex},{children:t(en,{$disabled:d,$readOnly:f})})),renderTrack:(e,n)=>t(nn,Object.assign({"data-testid":`slider-track-${n.index}`},e,{$color:x[n.index]}))}),m&&e(Jt,{children:[t("div",{children:$(a)}),t("div",{children:$(s)})]})]}))}))`
    margin-top: -0.3125rem;
`,cn=r=>{var{bins:s=[],interval:l,disabled:c,readOnly:h,value:p,showRangeLabels:d,rangeLabelPrefix:f,rangeLabelSuffix:g,onChange:m,renderEmptyView:y,renderRangeLabel:v}=r,F=u(r,["bins","interval","disabled","readOnly","value","showRangeLabels","rangeLabelPrefix","rangeLabelSuffix","onChange","renderEmptyView","renderRangeLabel"]);const b=s.map((e=>e.count)),S=Math.max(...b),B=s.map((e=>e.minValue)),D=Math.max(...B),x=Math.min(...B),[E,$]=i(H()),w=a((()=>{const e=[...s].sort(((e,t)=>e.minValue-t.minValue)),t=(D-x)/l+1,n=[];for(let r=0;r<t;r++){const t=e.find((e=>e.minValue===x+l*r));t?n.push(t):n.push({count:0,minValue:x+l*r})}return n}),[s,l]);o((()=>{p!==E&&$(H())}),[p]);const k=e=>{$(e),null==m||m(e)};function H(){return null!=p?p:[x,x+l]}const A=t=>v?v(t):e(Pt.Body,{children:[f,t,g]});return e("div",Object.assign({},F,{children:[d&&e(rn,{children:[A(E[0]),t(on,{children:"-"}),A(E[1])]}),w.every((e=>0===e.count))&&y?y():e(n,{children:[t(an,{children:w.map(((e,n)=>{const r=e.count/S;return t(sn,{style:{height:r?`calc(calc(100% - 0.25rem) * ${r} + 0.25rem)`:0},$selected:e.minValue>=E[0]&&e.minValue<E[1],$disabled:c||h},n)}))}),t(ln,{min:x,max:D+l,step:l,minRange:l,numOfThumbs:2,value:E,disabled:c,readOnly:h,onChange:k})]})]}))};export{cn as HistogramSlider};
