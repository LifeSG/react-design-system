...
`,cn=s.div`
    ...
    ${e=>{let t=Pt.Neutral[6];return e.$disabled&&e.$selected?t=Pt.Neutral[4]:e.$disabled?t=Pt.Neutral[5]:e.$selected&&(t=Pt.Accent.Light[1]),l`
            background-color: ${t};
        `}}
`,un=s((n=>{var{value:r,min:a=0,max:s=100,step:l=1,minRange:c,numOfThumbs:h=2,colors:p,disabled:d,readOnly:f,ariaLabels:g,showSliderLabels:m,sliderLabelPrefix:y,sliderLabelSuffix:v,renderSliderLabel:F,onChange:b,onChangeEnd:S}=n,B=u(n,["value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","ariaLabels","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","renderSliderLabel","onChange","onChangeEnd"]);const[D,x]=i($()),E=function(){const e=function(){const e=d||f?Pt.Neutral[5]:Pt.Neutral[4],t=d||f?Pt.Neutral[4]:Pt.Primary;if(1===h)return[t,e];const n=[];n.push(e);for(let e=0;e<h-1;e++)n.push(t);return n.push(e),n}();return new Array(h+1).fill(0).map(((t,n)=>(null==p?void 0:p[n])||e[n]))}();o((()=>{r!==D&&x($())}),[r]);function $(){if(r&&r.length===h)return r;const e=[];for(let t=0;t<h;t++)e.push(a+l*t);return e}const w=t=>F?F(t):e(en,{children:[y,t,v]});return e(Qt,Object.assign({},B,{children:[t(tn,{step:l,min:a,max:s,value:D,disabled:d||f,onChange:(e,t)=>{if("number"==typeof e){const t=[e];x(t),null==b||b(t)}else{if(t>-1&&D[t]===e[t])return;x(e),null==b||b(e)}},onAfterChange:e=>{if("number"==typeof e){const t=[e];x(t),null==S||S(t)}else x(e),null==S||S(e)},minDistance:c,ariaLabel:g,renderThumb:(e,n)=>t(rn,Object.assign({"data-testid":`slider-thumb-${n.index}`},e,{tabIndex:d?void 0:e.tabIndex},{children:t(nn,{$disabled:d,$readOnly:f})})),renderTrack:(e,n)=>t(on,Object.assign({"data-testid":`slider-track-${n.index}`},e,{$color:E[n.index]}))}),m&&e(Zt,{children:[t("div",{children:w(a)}),t("div",{children:w(s)})]})]}))}))`
    margin-top: -0.3125rem;
`,hn=r=>{var{bins:s=[],interval:l,disabled:c,readOnly:h,value:p,showRangeLabels:d,rangeLabelPrefix:f,rangeLabelSuffix:g,onChange:m,onChangeEnd:y,renderEmptyView:v,renderRangeLabel:F}=r,b=u(r,["bins","interval","disabled","readOnly","value","showRangeLabels","rangeLabelPrefix","rangeLabelSuffix","onChange","onChangeEnd","renderEmptyView","renderRangeLabel"]);const S=s.map((e=>e.count)),B=Math.max(...S),D=s.map((e=>e.minValue)),x=Math.max(...D),E=Math.min(...D),[$,w]=i(A()),k=a((()=>{const e=[...s].sort(((e,t)=>e.minValue-t.minValue)),t=(x-E)/l+1,n=[];for(let r=0;r<t;r++){const t=e.find((e=>e.minValue===E+l*r));t?n.push(t):n.push({count:0,minValue:E+l*r})}return n}),[s,l]);o((()=>{p!==$&&w(A())}),[p]);const H=e=>{w(e),null==m||m(e)},C=e=>{w(e),null==y||y(e)};function A(){return null!=p?p:[E,E+l]}const O=t=>F?F(t):e(Lt.Body,{children:[f,t,g]});return e("div",Object.assign({},b,{children:[d&&e(an,{children:[O($[0]),t(sn,{children:"-"}),O($[1])]}),k.every((e=>0===e.count))&&v?v():e(n,{children:[t(ln,{children:k.map(((e,n)=>{const r=e.count/B;return t(cn,{style:{height:r?`calc(calc(100% - 0.25rem) * ${r} + 0.25rem)`:0},$selected:e.minValue>=$[0]&&e.minValue<$[1],$disabled:c||h},n)}))}),t(un,{min:E,max:x+l,step:l,minRange:l,numOfThumbs:2,value:$,disabled:c,readOnly:h,onChange:H,onChangeEnd:C})]})]}))};export{hn as HistogramSlider};
