import r,{css as e}from"styled-components";import{Radius as o,Colour as t,Border as i}from"../theme/index.js";const d=r.button`
    align-items: center;
    border-radius: ${o.sm};
    cursor: pointer;
    display: flex;
    ...
    ${r=>{switch(r.$styleType){case"secondary":return e`
