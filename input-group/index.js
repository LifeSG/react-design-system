...
`;p(Uu)`
    color: ${Gt.Neutral[3]};
`;const Qu=({children:e,show:n,error:r,disabled:i,testId:s,onBlur:l,readOnly:c,className:u})=>{const d=a();return((e,t,n="window",r)=>{const i=a();o((()=>{i.current=t}),[t]),o((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const a=e=>i.current(e);return t.addEventListener(e,a,r),()=>{t.removeEventListener(e,a,r)}}),[e,n])})("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&l()}}),"document"),t(Ru,Object.assign({className:u},{children:t(qu,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":s},{children:e}))}))},Zu=p.div`
    position: relative;
    display: flex;
    align-items: center;
    margin: 0 1rem;
