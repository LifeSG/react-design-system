...
`,Ec=n=>{var{external:r=!1,children:i}=n,o=k(n,["external","children"]);return e(jc,Object.assign({},o,{children:[i,r&&t(Ac,{})]}))};var Dc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Dc||(Dc={})),f.button`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const Pc=f((({color:n,className:r,size:i=18})=>e(pc,Object.assign({className:r,$size:i,$color:n},{children:[t(gc,{id:"inner1",$size:i-2,$borderWidth:2}),t(mc,{id:"inner2",$size:i-2,$borderWidth:2}),t(yc,{id:"inner3",$size:i-2,$borderWidth:2}),t(bc,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,zc=f.div`
    ...
    svg {
        animation: 200ms ease-in-out ${Cc};
        width: 100%;
        height: 100%;
...
`,Fu=f($u)`
    color: ${cc.Neutral[3]};
`,ku=({children:e,show:n,error:r,disabled:i,testId:a,onBlur:s,readOnly:c,className:u})=>{const d=l();return((e,t,n="window",r)=>{const i=l();o((()=>{i.current=t}),[t]),o((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const o=e=>i.current(e);return t.addEventListener(e,o,r),()=>{t.removeEventListener(e,o,r)}}),[e,n])})("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&s()}}),"document"),t(gu,Object.assign({className:u},{children:t(vu,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":a},{children:e}))}))},Ou=r=>{var{selectedOptions:i,placeholder:a="Select",options:c,className:u,disabled:d,error:h,"data-testid":p,enableSearch:f=!1,searchFunction:g,searchPlaceholder:m,valueExtractor:y,listExtractor:b,onSelectOptions:v,listStyleWidth:w,onShowOptions:S,onHideOptions:_,onRetry:x,optionsLoadState:$="success",optionTruncationType:F="end"}=r,O=k(r,["selectedOptions","placeholder","options","className","disabled","error","data-testid","enableSearch","searchFunction","searchPlaceholder","valueExtractor","listExtractor","onSelectOptions","listStyleWidth","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[B,j]=s(i||[]),[A,E]=s(!1),D=l();o((()=>{j(i||[])}),[i]);const P=(e,t)=>{const n=[...B],r=uo(B,(e=>(y?y(e):e)===t));r>-1?n.splice(r,1):n.push(e),j(n),z(!1),D&&D.current.focus(),T(n)},I=()=>{A&&(E(!1),z(!1)),D&&D.current.focus()},C=()=>{B&&B.length>0?(j([]),T([])):(j(c),T(c))},z=e=>{!e&&_&&_(),e&&S&&S()},T=e=>{v&&v(e)};return e(ku,Object.assign({show:A,error:h&&!A,disabled:d,testId:p,className:u,onBlur:()=>{E(!1),z(!1)}},{children:[t(yu,Object.assign({ref:D,type:"button","data-testid":"selector",onClick:e=>{e.preventDefault(),d||(E(!A),z(!A))}},O,{children:e(n,{children:[t(xu,{children:B&&0!==B.length?t($u,{children:B&&0!=B.length?c&&B.length===c.length?"All selected":`${B.length} selected`:a}):t(Fu,Object.assign({truncateType:F},{children:a}))}),t(wu,Object.assign({expanded:A},{children:t(Su,{})}))]})})),A&&t(_u,{}),c&&c.length>0||x?t(pu,{listItems:c,onSelectItem:P,onDismiss:I,valueExtractor:y,listExtractor:b,listStyleWidth:w,visible:A,enableSearch:f,searchFunction:g,searchPlaceholder:m,"data-testid":"dropdown-list",multiSelect:!0,selectedItems:B,onSelectAll:C,onRetry:x,itemsLoadState:$,itemTruncationType:F}):null]}))};export{Ou as InputMultiSelect};
