...
`,wl={collections:{base:{InputBoxShadow:y`
    ...
    `,ElevationBoxShadow:y`
      0px 2px 8px ${Xo.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Dl=e=>t=>{var r;const n=t.theme,i=zo(wl,n[To.designTokenScheme]);return(null===(r=n.options)||void 0===r?void 0:r.designToken)?_o(i,e,n.options.designToken):_o(i,e)},Ol={InputBoxShadow:Dl("InputBoxShadow"),InputErrorBoxShadow:Dl("InputErrorBoxShadow"),ElevationBoxShadow:Dl("ElevationBoxShadow"),Table:{Header:Dl("Table.Header"),Cell:{Primary:Dl("Table.Cell.Primary"),Secondary:Dl("Table.Cell.Secondary"),Selected:Dl("Table.Cell.Selected"),Hover:Dl("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Dl("Button.Danger.BackgroundColor"),Hover:Dl("Button.Danger.Hover"),Primary:Dl("Button.Danger.Primary"),Border:Dl("Button.Danger.Border")}}};v.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return y`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Ol.Button.Danger.Border:Xo.Primary};

                    color: ${e.$buttonIsDanger?Ol.Button.Danger.Primary:Xo.Primary};
                `;case"light":return y`
                    background-color: ${Xo.Neutral[8]};
                ...
                `;case"link":return y`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Ol.Button.Danger.Hover:Xo.Secondary};
                    }
                `;default:return y`
                    background-color: ${e.$buttonIsDanger?Ol.Button.Danger.BackgroundColor:Xo.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?y`
                ...
                `}
`;const kl=v((({color:r,className:n,size:i=18})=>e(bl,Object.assign({className:n,$size:i,$color:r},{children:[t(Sl,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),t(Fl,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),t(xl,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),t(Bl,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Ol.Button.Danger.Primary:Xo.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Xo.Neutral[3](e);break;default:t=Xo.Neutral[8](e)}return y`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Bs=i.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,l=Jo(e,["children","focusHighlight","focusOutline","type"]);return t(xs,Object.assign({ref:r,$outline:a,$highlight:i,type:o},l,{children:n}))})),ws=e=>"small"===e?1:1.125,Ds=e=>y`
        height: ${ws(e)}rem;
        width: ${ws(e)}rem;
    `,Os=v.div`
...
`,js=v(Bs)`
    ...
    ${e=>y`
        ...
        `}
`,As=p(((r,n)=>{var{value:i,variant:a,onClear:o}=r,l=Jo(r,["value","variant","onClear"]);return e(Os,{children:[e(ks,{children:[t(Hs,{$variant:a,"aria-hidden":!0}),t(Es,Object.assign({ref:n,value:i,$variant:a},l))]}),i&&t(js,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:a},{children:t(O,{"aria-hidden":!0})}))]})})),_s=({listItems:r,multiSelect:n,selectedItems:i,disableItemFocus:l,itemsLoadState:s="success",itemTruncationType:c="end",itemMaxLines:u=2,labelDisplayType:f="inline",variant:h="default",listboxId:g,width:p,onSelectItem:v,onSelectAll:y,onDismiss:b,onRetry:$,valueExtractor:S,listExtractor:F,renderListItem:x,renderCustomCallToAction:B,enableSearch:w,hideNoResultsDisplay:D,searchPlaceholder:O="Search",searchFunction:k,onSearch:E})=>{const{focusedIndex:H,setFocusedIndex:j}=m(Kl),[A,_]=o(""),[z,T]=o(r),M=Ql(s),C=(()=>{const[e,t]=o(!1);return d((()=>{t(!0)}),[]),e})(),I=a(),L=a(),W=a([]),P=a(),R=e=>F?F(e):e.toString(),N=ql((()=>k(A))),Y=ql((()=>r.filter((e=>{var t;const r=R(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),a=A.trim().toLowerCase();return n.includes(a)||i&&i.includes(a)})))),V=(e,t)=>{j(t),null==v||v(e,(e=>S?S(e):e)(e))},J=e=>{const t=e.target.value;_(t),null==E||E()},Z=()=>{var e;_(""),null===(e=P.current)||void 0===e||e.focus(),null==E||E()},U=()=>{null==$||$()};((e,t,r="window",n)=>{const i=a();d((()=>{i.current=t}),[t]),d((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const a=e=>i.current(e);return t.addEventListener(e,a,n),()=>{t.removeEventListener(e,a,n)}}),[e,r])})("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),H<z.length-1){const e=H+1;null===(t=W.current[e])||void 0===t||t.focus(),j(e)}break;case"ArrowUp":if(e.preventDefault(),H>0){const e=H-1;null===(r=W.current[e])||void 0===r||r.focus(),j(e)}else 0===H&&P.current&&(P.current.focus(),j(-1));break;case"Space":document.activeElement===W.current[H]&&(e.preventDefault(),z[H]&&V(z[H],H))}})),d((()=>{C||l||(P.current?(j(-1),setTimeout((()=>{var e;return null===(e=P.current)||void 0===e?void 0:e.focus()}),200)):W.current[H]?setTimeout((()=>{var e;return null===(e=W.current[H])||void 0===e?void 0:e.focus()}),200):(j(0),setTimeout((()=>{var e;return null===(e=W.current[0])||void 0===e?void 0:e.focus()}),200)))}),[l,H,C,j]),d((()=>{C&&M&&(l||"success"===s&&P.current&&(j(-1),P.current.focus()))}),[C,M,s,j,l]),d((()=>{T(""===A?r:k?N():Y())}),[N,Y,r,k,A]);const X=e=>n?t(e?gs:ps,{"aria-hidden":!0}):e?t(fs,{"aria-hidden":!0}):t(hs,{}),G=(e,r)=>{const n=R(e),i="string"==typeof n?n:n.title,a="string"==typeof n?void 0:n.secondaryLabel;return t(cl,{displayType:f,label:i,maxLines:u,selected:r,sublabel:a,truncationType:c,variant:h})},q=()=>{if(!$||$&&"success"===s)return z.map(((t,r)=>{const a=(e=>!!hl(i,(t=>pl(t,e))))(t),o=r===H;return e(ds,Object.assign({"aria-selected":a,"aria-multiselectable":n,"data-testid":"list-item",onClick:()=>V(t,r),onMouseEnter:()=>(e=>{j(e)})(r),ref:e=>W.current[r]=e,role:"option",tabIndex:o?0:-1,$active:o},{children:[X(a),x?x(t,{selected:a}):G(t,a)]}),((e,t)=>`item_${t}__${S?S(e):e}`)(t,r))}))},Q=()=>{if((w||k)&&"success"===s)return t(As,{ref:P,onChange:J,value:A,placeholder:O,"data-testid":"search-input","aria-label":"Enter text to search",onClear:Z,variant:h})},K=()=>{if(n&&z.length>0&&!A&&"success"===s)return t(ms,{children:t(bs,Object.assign({onClick:y,type:"button",$variant:h},{children:0===i.length?"Select all":"Clear all"}))})},ee=()=>{if(!D&&(A||!w)&&0===z.length&&"success"===s)return e($s,Object.assign({"data-testid":"list-no-results"},{children:[t(Fs,{"data-testid":"no-result-icon",$variant:h}),t(Ss,Object.assign({$variant:h},{children:"No results found."}))]}))},te=()=>{if($&&"loading"===s){const r="small"===h?16:18;return e($s,Object.assign({"data-testid":"list-loading"},{children:[t(kl,{$buttonStyle:"secondary",size:r}),t(Ss,Object.assign({$variant:h},{children:"Loading..."}))]}))}},re=()=>{if($&&"fail"===s)return e($s,Object.assign({"data-testid":"list-fail"},{children:[t(Fs,{"data-testid":"load-error-icon",$variant:h}),t(Ss,Object.assign({$variant:h},{children:"Failed to load."}))," ",t(ys,Object.assign({onClick:U,type:"button",$variant:h},{children:"Try again."}))]}))};return e(ss,Object.assign({"data-testid":"dropdown-container",ref:I,$width:p},{children:[e(cs,Object.assign({ref:L,"data-testid":"dropdown-list"},{children:[Q(),K(),ee(),te(),re(),t(us,Object.assign({role:"listbox",id:g},{children:q()}))]})),(()=>{if(B)return t("div",Object.assign({"data-testid":"custom-cta"},{children:B(b,z)}))})()]}))},zs="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Ts=v(ls)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,Cs=p((({children:r,disabled:n,expanded:i,listboxId:a,readOnly:o,variant:l},s)=>e(Ts,Object.assign({ref:s,type:"button","aria-expanded":i,"aria-haspopup":"listbox","data-testid":"selector",disabled:n,"aria-controls":a,$variant:l},{children:[r,!o&&t(Ms,Object.assign({$expanded:i,$variant:l},{children:t(E,{"aria-hidden":!0})}))]})))),Is=e=>"small"===e?2.5:3;v.div`
    position: relative;
    width: 100%;
    ${e=>{const t=Is(e.$variant);return y`
            min-height: ${t}rem;
...
`,Ys=v(Ns)`
    color: ${Xo.Neutral[3]};
`;var Vs;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Vs||(Vs={}));const Js=v.div`
    display: flex;
    flex-direction: column;
`,Zs=e=>"right"===e?"bottom-end":"bottom-start",Us=({enabled:n,isOpen:i,onOpen:l,onClose:s,onDismiss:c,renderElement:u,renderDropdown:f,customZIndex:h,clickToToggle:g=!1,offset:p=0,alignment:m="left",fitAvailableHeight:v})=>{var y;const b=a(null),$=a(null),{width:S}=ko({targetRef:b,handleHeight:!1}),{refs:F,floatingStyles:x,context:B}=j({open:i,onOpenChange:(e,t,r)=>{"escape-key"===r?null==c||c():e&&!i?null==l||l():!e&&i&&(null==s||s(r))},whileElementsMounted:A,placement:Zs(m),middleware:[_(p),z(),T({limiter:M()}),C({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:v?`${e}px`:void 0,overflowY:v?"hidden":void 0})}})]}),w=(()=>{const[e,t]=o(void 0),r=H();return d((()=>{if(!r)return void t(void 0);const e=e=>{t(e.zIndex)};return r.events.on(Vs.Change,e),r.events.emit(Vs.Ready),()=>r.events.off(Vs.Change,e)}),[r]),e})(),{isMounted:D,styles:O}=I(B,{initial:{opacity:0},open:{opacity:1},duration:300}),k=L(B,{enabled:n,toggle:g}),E=W(B,{enabled:n}),{getReferenceProps:Y,getFloatingProps:V}=P([k,E]);return e(r,{children:[t("div",Object.assign({ref:e=>{b.current=e,F.setReference(e)}},Y(),{children:u()})),D&&t(R,{children:t(N,Object.assign({context:B,modal:!1,initialFocus:$,returnFocus:!1},{children:t("div",Object.assign({ref:F.setFloating,style:Object.assign(Object.assign({},x),{zIndex:null!==(y=null!=h?h:w)&&void 0!==y?y:50})},V(),{children:t(Js,Object.assign({ref:$,style:Object.assign({},O),inert:O.opacity<1?"":void 0},{children:f({elementWidth:S})}))}))}))})]})},Xs=({selectedOptions:e,placeholder:r="Select",options:n,disabled:i,error:l,className:s,"data-testid":c,id:u,enableSearch:f=!1,searchFunction:h,searchPlaceholder:g,valueExtractor:p,listExtractor:m,onSelectOptions:v,onShowOptions:y,onHideOptions:b,onRetry:$,optionsLoadState:S="success",optionTruncationType:F="end",renderListItem:x,hideNoResultsDisplay:B,renderCustomCallToAction:w,onBlur:D,variant:O="default",readOnly:k,alignment:E,dropdownZIndex:H})=>{const[j,A]=o(e||[]),[_,z]=o(!1),[T,M]=o(!1),[C]=o((()=>Gl.generate())),I=a(),L=a();d((()=>{A(e||[])}),[e]);const W=()=>{j&&j.length>0?(A([]),J([])):(A(n),J(n))},P=(e,t)=>{const r=[...j],n=Aa(j,(e=>(p?p(e):e)===t));n>-1?r.splice(n,1):r.push(e),A(r),J(r)},R=()=>{_&&(z(!1),V(!1))},N=()=>{T||_||M(!0)},Y=e=>{!T||_||I.current.contains(e.relatedTarget)||(M(!1),null==D||D())},V=e=>{!e&&b&&b(),e&&y&&y()},J=e=>{v&&v(e)};return t(es,{children:t(Us,{enabled:!k&&!i,isOpen:_,renderElement:()=>t(as,Object.assign({className:s,"data-testid":c,id:u,ref:I,tabIndex:-1,onFocus:N,onBlur:Y,$focused:T,$disabled:i,$readOnly:k,$error:l},{children:t(Cs,Object.assign({ref:L,disabled:i,expanded:_,listboxId:C,readOnly:k,variant:O},{children:t(Rs,{children:j&&0!==j.length?t(Ns,Object.assign({$variant:O},{children:n&&j.length===n.length?"All selected":`${j.length} selected`})):t(Ys,Object.assign({truncateType:F,$variant:O},{children:r}))})}))})),renderDropdown:({elementWidth:e})=>t(_s,{listboxId:C,listItems:n,onSelectItem:P,onDismiss:R,valueExtractor:p,listExtractor:m,enableSearch:f,searchFunction:h,searchPlaceholder:g,multiSelect:!0,selectedItems:j,onSelectAll:W,onRetry:$,itemsLoadState:S,itemTruncationType:F,renderListItem:x,hideNoResultsDisplay:B,renderCustomCallToAction:w,variant:O,width:e}),onOpen:()=>{z(!0),V(!0),M(!0)},onClose:e=>{z(!1),V(!1),"click"!==e&&(M(!1),null==D||D())},onDismiss:()=>{L.current.focus(),z(!1),V(!1)},clickToToggle:!0,offset:8,alignment:E,fitAvailableHeight:!0,customZIndex:H})})};export{Xs as InputMultiSelect};
