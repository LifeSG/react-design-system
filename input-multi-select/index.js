...
`,As=v(Bs)`
    ...
    ${e=>y`
        ...
        `}
`,Ts=p(((r,n)=>{var{value:i,variant:a,onClear:o}=r,l=Jo(r,["value","variant","onClear"]);return e(ks,{children:[e(Es,{children:[t(js,{$variant:a,"aria-hidden":!0}),t(Hs,Object.assign({ref:n,value:i,$variant:a},l))]}),i&&t(As,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:a},{children:t(O,{"aria-hidden":!0})}))]})})),_s=({listItems:n,multiSelect:i,selectedItems:l,disableItemFocus:s,itemsLoadState:c="success",itemTruncationType:u="end",itemMaxLines:f=2,labelDisplayType:h="inline",variant:g="default",listboxId:p,width:v,topScrollItem:y,onSelectItem:b,onSelectAll:$,onDismiss:S,onRetry:F,valueExtractor:x,listExtractor:w,renderListItem:B,renderCustomCallToAction:D,enableSearch:O,hideNoResultsDisplay:k,searchPlaceholder:E="Search",searchFunction:H,onSearch:j})=>{const{focusedIndex:A,setFocusedIndex:T}=m(es),[_,z]=o(""),[M,C]=o(n),I=Kl(c),L=(()=>{const[e,t]=o(!1);return d((()=>{t(!0)}),[]),e})(),W=a(),P=a(),R=a([]),N=a(),Y=e=>w?w(e):e.toString(),V=Ql((()=>H(_))),J=Ql((()=>n.filter((e=>{var t;const r=Y(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),a=_.trim().toLowerCase();return n.includes(a)||i&&i.includes(a)})))),Z=(e,t)=>{T(t),null==b||b(e,(e=>x?x(e):e)(e))},U=e=>{const t=e.target.value;z(t),null==j||j()},X=()=>{var e;z(""),null===(e=N.current)||void 0===e||e.focus(),null==j||j()},G=()=>{null==F||F()};((e,t,r="window",n)=>{const i=a();d((()=>{i.current=t}),[t]),d((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const a=e=>i.current(e);return t.addEventListener(e,a,n),()=>{t.removeEventListener(e,a,n)}}),[e,r])})("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),A<M.length-1){const e=A+1;null===(t=R.current[e])||void 0===t||t.focus(),T(e)}break;case"ArrowUp":if(e.preventDefault(),A>0){const e=A-1;null===(r=R.current[e])||void 0===r||r.focus(),T(e)}else 0===A&&N.current&&(N.current.focus(),T(-1));break;case"Space":case"Enter":document.activeElement===R.current[A]&&(e.preventDefault(),M[A]&&Z(M[A],A))}})),d((()=>{if(void 0===y)return;const e=setTimeout((()=>{var e;const t=n.indexOf(y),r=R.current[t];if(W.current){const t=null!==(e=null==r?void 0:r.offsetTop)&&void 0!==e?e:0;W.current.scrollTop=t-8}T(t)}),0);return()=>clearTimeout(e)}),[R,n,T,y]),d((()=>{L||s||(N.current?(T(-1),setTimeout((()=>{var e;return null===(e=N.current)||void 0===e?void 0:e.focus()}),200)):R.current[A]?setTimeout((()=>{var e;return null===(e=R.current[A])||void 0===e?void 0:e.focus()}),200):(T(0),setTimeout((()=>{var e;return null===(e=R.current[0])||void 0===e?void 0:e.focus()}),200)))}),[s,A,L,T]),d((()=>{L&&I&&(s||"success"===c&&N.current&&(T(-1),N.current.focus()))}),[L,I,c,T,s]),d((()=>{C(""===_?n:H?V():J())}),[V,J,n,H,_]);const q=e=>i?t(e?ps:ms,{"aria-hidden":!0}):e?t(hs,{"aria-hidden":!0}):t(gs,{}),Q=(e,r)=>{const n=Y(e),i="string"==typeof n?n:n.title,a="string"==typeof n?void 0:n.secondaryLabel;return t(cl,{displayType:h,label:i,maxLines:f,selected:r,sublabel:a,truncationType:u,variant:g})},K=()=>{if(!F||F&&"success"===c)return M.map(((n,a)=>{const o=(e=>!!hl(l,(t=>pl(t,e))))(n),s=a===A;return t(fs,Object.assign({"aria-selected":o,"aria-multiselectable":i,"data-testid":"list-item",onClick:()=>Z(n,a),onMouseEnter:()=>(e=>{T(e)})(a),ref:e=>R.current[a]=e,role:"option",tabIndex:s?0:-1,$active:s},{children:B?B(n,{selected:o}):e(r,{children:[q(o),Q(n,o)]})}),((e,t)=>`item_${t}__${x?x(e):e}`)(n,a))}))},ee=()=>{if((O||H)&&"success"===c)return t(Ts,{ref:N,onChange:U,value:_,placeholder:E,"data-testid":"search-input","aria-label":"Enter text to search",onClear:X,variant:g})},te=()=>{if(i&&M.length>0&&!_&&"success"===c)return t(vs,{children:t($s,Object.assign({onClick:$,type:"button",$variant:g},{children:0===l.length?"Select all":"Clear all"}))})},re=()=>{if(!k&&(_||!O)&&0===M.length&&"success"===c)return e(Ss,Object.assign({"data-testid":"list-no-results"},{children:[t(xs,{"data-testid":"no-result-icon",$variant:g}),t(Fs,Object.assign({$variant:g},{children:"No results found."}))]}))},ne=()=>{if(F&&"loading"===c){const r="small"===g?16:18;return e(Ss,Object.assign({"data-testid":"list-loading"},{children:[t(El,{$buttonStyle:"secondary",size:r}),t(Fs,Object.assign({$variant:g},{children:"Loading..."}))]}))}},ie=()=>{if(F&&"fail"===c)return e(Ss,Object.assign({"data-testid":"list-fail"},{children:[t(xs,{"data-testid":"load-error-icon",$variant:g}),t(Fs,Object.assign({$variant:g},{children:"Failed to load."}))," ",t(bs,Object.assign({onClick:G,type:"button",$variant:g},{children:"Try again."}))]}))};return e(cs,Object.assign({"data-testid":"dropdown-container",ref:W,$width:v},{children:[e(us,Object.assign({ref:P,"data-testid":"dropdown-list"},{children:[ee(),te(),re(),ne(),ie(),t(ds,Object.assign({role:"listbox",id:p},{children:K()}))]})),(()=>{if(D)return t("div",Object.assign({"data-testid":"custom-cta"},{children:D(S,M)}))})()]}))},zs="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Ms=v(ss)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
