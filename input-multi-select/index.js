...
`,ku=f($u)`
    color: ${cc.Neutral[3]};
`,Bu=({children:e,show:n,error:r,disabled:i,testId:a,onBlur:s,readOnly:c,className:u})=>{const d=l();return((e,t,n="window",r)=>{const i=l();o((()=>{i.current=t}),[t]),o((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const o=e=>i.current(e);return t.addEventListener(e,o,r),()=>{t.removeEventListener(e,o,r)}}),[e,n])})("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&s()}}),"document"),t(mu,Object.assign({className:u},{children:t(wu,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":a},{children:e}))}))},Ou=r=>{var{selectedOptions:i,placeholder:a="Select",options:c,className:u,disabled:d,error:h,"data-testid":p,enableSearch:f=!1,searchFunction:g,searchPlaceholder:m,valueExtractor:y,listExtractor:b,onSelectOptions:v,listStyleWidth:w,onShowOptions:x,onHideOptions:S,onRetry:F,optionsLoadState:_="success",optionTruncationType:$="end"}=r,B=k(r,["selectedOptions","placeholder","options","className","disabled","error","data-testid","enableSearch","searchFunction","searchPlaceholder","valueExtractor","listExtractor","onSelectOptions","listStyleWidth","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[O,j]=s(i||[]),[A,E]=s(!1),D=l();o((()=>{j(i||[])}),[i]);const C=(e,t)=>{const n=[...O],r=uo(O,(e=>(y?y(e):e)===t));r>-1?n.splice(r,1):n.push(e),j(n),z(!1),D&&D.current.focus(),T(n)},P=()=>{A&&(E(!1),z(!1)),D&&D.current.focus()},I=()=>{O&&O.length>0?(j([]),T([])):(j(c),T(c))},z=e=>{!e&&S&&S(),e&&x&&x()},T=e=>{v&&v(e)};return e(Bu,Object.assign({show:A,error:h&&!A,disabled:d,testId:p,className:u,onBlur:()=>{E(!1),z(!1)}},{children:[t(bu,Object.assign({ref:D,type:"button","data-testid":"selector",onClick:e=>{e.preventDefault(),d||(E(!A),z(!A))}},B,{children:e(n,{children:[t(_u,{children:O&&0!==O.length?t($u,{children:O&&0!=O.length?c&&O.length===c.length?"All selected":`${O.length} selected`:a}):t(ku,Object.assign({truncateType:$},{children:a}))}),t(xu,Object.assign({expanded:A},{children:t(Su,{})}))]})})),A&&t(Fu,{}),c&&c.length>0||F?t(fu,{listItems:c,onSelectItem:C,onDismiss:P,valueExtractor:y,listExtractor:b,listStyleWidth:w,visible:A,enableSearch:f,searchFunction:g,searchPlaceholder:m,"data-testid":"dropdown-list",multiSelect:!0,selectedItems:O,onSelectAll:I,onRetry:F,itemsLoadState:_,itemTruncationType:$}):null]}))};export{Ou as InputMultiSelect};
