...
`,ru=a.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=B(e,["children","focusHighlight","focusOutline","type"]);return t(tu,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),nu=m`
...
`,Du=f(ku)`
    color: ${oc.Neutral[3]};
`,Ou=({children:e,show:r,error:n,disabled:a,testId:i,onBlur:l,readOnly:c,className:u,variant:d})=>{const h=o();return((e,t,r="window",n)=>{const a=o();s((()=>{a.current=t}),[t]),s((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const i=e=>a.current(e);return t.addEventListener(e,i,n),()=>{t.removeEventListener(e,i,n)}}),[e,r])})("mousedown",(function(e){if(!a){if(h&&h.current.contains(e.target))return;r&&l()}}),"document"),t(bu,Object.assign({className:u,$variant:d},{children:t(Fu,Object.assign({ref:h,error:n&&!r,disabled:a,$readOnly:c,expanded:r,"data-testid":i},{children:e}))}))},Eu=n=>{var{selectedOptions:a,placeholder:l="Select",options:c,className:u,disabled:d,error:h,"data-testid":p,enableSearch:f=!1,searchFunction:g,searchPlaceholder:m,valueExtractor:y,listExtractor:b,onSelectOptions:v,listStyleWidth:w,onShowOptions:$,onHideOptions:F,onRetry:x,onBlur:S,optionsLoadState:_="success",optionTruncationType:k="end",variant:D="default"}=n,O=B(n,["selectedOptions","placeholder","options","className","disabled","error","data-testid","enableSearch","searchFunction","searchPlaceholder","valueExtractor","listExtractor","onSelectOptions","listStyleWidth","onShowOptions","onHideOptions","onRetry","onBlur","optionsLoadState","optionTruncationType","variant"]);const[E,A]=i(a||[]),[j,C]=i(!1),I=o();s((()=>{A(a||[])}),[a]);const P=(e,t)=>{const r=[...E],n=fi(E,(e=>(y?y(e):e)===t));n>-1?r.splice(n,1):r.push(e),A(r),H(!1),I&&I.current.focus(),N(r)},z=()=>{j&&(C(!1),H(!1)),I&&I.current.focus()},T=()=>{E&&E.length>0?(A([]),N([])):(A(c),N(c))},H=e=>{!e&&F&&F(),e&&$&&$()},N=e=>{v&&v(e)};return e(Ou,Object.assign({show:j,error:h&&!j,disabled:d,testId:p,className:u,onBlur:()=>{null==S||S(),C(!1),H(!1)},variant:D},{children:[t(wu,Object.assign({ref:I,type:"button","data-testid":"selector",onClick:e=>{e.preventDefault(),d||(C(!j),H(!j),j&&(null==S||S()))},onBlur:()=>{j||null==S||S()},$variant:D},O,{children:e(r,{children:[t(Bu,{children:E&&0!==E.length?t(ku,Object.assign({$variant:D},{children:E&&0!=E.length?c&&E.length===c.length?"All selected":`${E.length} selected`:l})):t(Du,Object.assign({truncateType:k,$variant:D},{children:l}))}),t(xu,Object.assign({expanded:j},{children:t(Su,{$variant:D})}))]})})),j&&t(_u,{}),c&&c.length>0||x?t(gu,{listItems:c,onSelectItem:P,onDismiss:z,valueExtractor:y,listExtractor:b,listStyleWidth:w,visible:j,enableSearch:f,searchFunction:g,searchPlaceholder:m,"data-testid":"dropdown-list",multiSelect:!0,selectedItems:E,onSelectAll:T,onRetry:x,itemsLoadState:_,itemTruncationType:k,variant:D}):null]}))};export{Eu as InputMultiSelect};
