...
`,Fl={collections:{base:{InputBoxShadow:y`
	...
	${e=>"small"===e.$buttonSizeStyle?y`
                ...
                `}
`;const El=v((({color:n,className:r,size:o=18})=>e(yl,Object.assign({className:r,$size:o,$color:n},{children:[t(wl,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(xl,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t($l,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(Sl,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
...
`,Sc=o.forwardRef(((e,n)=>{var{children:r,focusHighlight:o=!0,focusOutline:i="none",type:a="button"}=e,l=Ya(e,["children","focusHighlight","focusOutline","type"]);return t($c,Object.assign({ref:n,$outline:i,$highlight:o,type:a},l,{children:r}))})),Fc=e=>"small"===e?1:1.125,Dc=e=>y`
        height: ${Fc(e)}rem;
        width: ${Fc(e)}rem;
    `,Bc=v.div`
