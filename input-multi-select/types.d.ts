...
import { DropdownCustomLabelProps, DropdownDisplayProps, DropdownSearchProps, DropdownVariantType } from "../shared/dropdown-list/types";
import { DropdownAlignmentType } from "../shared/dropdown-wrapper";
export interface InputMultiSelectProps<T, V> extends React.HTMLAttributes<HTMLElement>, InputSelectOptionsProps<T>, InputSelectSharedProps<T>, Omit<DropdownDisplayProps<T, V>, "isOptionDisabled">, DropdownSearchProps<T> {
