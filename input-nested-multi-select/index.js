...
`,Ha=m.div`
    ...
    ${e=>"next-line"===e.$labelDisplayType?p`
                    ${ja["body-md-semibold"]}
                `:p`
                    ${ja["body-baseline-regular"]}
                `}
`,Va=m.span`
    font-weight: ${ja.Spec["weight-semibold"]};
`,Ua=m.div`
    text-align: left;
    width: 100%;
    overflow: hidden;
    ...
    ${e=>"small"===e.$variant?ja["body-md-regular"]:ja["body-baseline-regular"]}
...
`,Ds=({color:t,className:n,size:i})=>e(vs,Object.assign({className:n,$size:i,$color:t},{children:[r(ws,{id:"inner1"}),r(Fs,{id:"inner2"}),r($s,{id:"inner3"}),r(Es,{id:"inner4"})]})),Cs=p`
    outline-offset: -1px;
    outline: ${Ta["width-020"]} ${Ta.solid} ${Ba["border-focus"]};
`,_s=p`
    outline-color: ${Ba["border-focus"]};
`,Os=p`
    outline-color: ${Ba["border-disabled"]};
`,As=p`
    outline-color: ${Ba["border-error-focus"]};
`,ks=m.div`
    border: ${Ta["width-010"]} ${Ta.solid} ${Ba.border};
    border-radius: ${Pa.sm};
    background: ${Ba.bg};
...
`,Bs=m.div`
    ...
    ::-webkit-scrollbar-thumb {
        background: ${Ba["bg-inverse-subtlest"]};
...
`,m.li`
    ...
    ${e=>e.$active&&e.$selected?p`
            ...
            `:e.$active?p`
                background: ${Ba["bg-hover-subtle"]};
            `:void 0}
`;const Ms=m($)`
    flex-shrink: 0;
    height: 1lh;
    width: 1rem;
    color: ${Ba["icon-selected"]};
`;m.div`
    flex-shrink: 0;
    height: 1lh;
    width: 1rem;
...
`,Is=m(w)`
    ...
    height: 1lh;
    width: 1lh;
    color: ${Ba["icon-primary-subtlest"]};
`,Ps=m.div`
    width: 100%;
    display: flex;
...
`,Ys=m(Ss)`
    cursor: pointer;
    overflow: hidden;
    color: ${Ba["text-primary"]};
    font-size: inherit;
`,Ls=m(Ys)`
    ${ja["body-baseline-semibold"]}
`,Rs=m(Ys)`
    ${ja["body-md-semibold"]}
...
`,"function"==typeof SuppressedError&&SuppressedError;const Vs=m.button`
    ...
    &:focus {
        ...
        ${({$highlight:e})=>e&&p`
                background-color: ${Ba["bg-hover-neutral"]};
            `}
    }
...
`,rl=g((({children:t,disabled:n,expanded:i,listboxId:o,popupRole:a,readOnly:s,variant:l},d)=>e(Qs,Object.assign({ref:d,type:"button","aria-expanded":i,"aria-haspopup":a,"data-testid":"selector",disabled:n,"aria-controls":o,$variant:l},{children:[t,!s&&r(el,Object.assign({$expanded:i,$variant:l},{children:r(C,{"aria-hidden":!0})}))]}))));m.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return p`
                    background-color: ${Ba.Primitive.white};
                    border-color: ${e.$buttonIsDanger?Ba["border-error-strong"]:Ba["border-primary"]};

                    color: ${e.$buttonIsDanger?Ba["text-error"]:Ba["text-primary"]};
                ...
                `;case"light":return p`
                    background-color: ${Ba.bg};
                    border-color: ${Ba.border};
                ...
                `;case"disabled":return p`
                    background-color: ${Ba["bg-disabled"]};
                    ...
                    color: ${Ba["text-disabled"]};
                `;default:return p`
                    background-color: ${e.$buttonIsDanger?Ba["bg-error-strong"]:Ba["bg-primary"]};

                    ${La.MaxWidth.md} {
                        width: 100%;
                    }

                    color: ${Ba["text-inverse"]};

                    &:hover,
                    &:active {
                        background-color: ${e.$buttonIsDanger?Ba["bg-error-strong-hover"]:Ba["bg-primary-hover"]};
                    }
                `}}}
...
`;const nd=p`
    ...
    :focus-visible {
        outline: 2px solid ${Ba["border-focus"]};
    }
`,id=m.button`
    ${nd}
    cursor: pointer;
...
`;m.div`
    ...
    :focus-within {
        border-color: ${Ba["border-focus"]};
        box-shadow: 0px 0px 4px 0px
            rgb(from ${Ba["border-focus"]} r g b / 50%) inset; // TODO: confirm shadow
    }
    ...
    ${e=>e.disabled?p`
            ...
            `:e.error?p`
                ...
                :focus-within {
                    border-color: ${Ba["border-error"]};
                    box-shadow: 0px 0px 4px 0px
                        rgb(from ${Ba["border-error"]} r g b / 50%) inset; // TODO: confirm shadow
                }
            `:void 0}
`,m.div`
    transform: rotate(${e=>e.expanded?180:0}deg);
...
`;var dd;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(dd||(dd={}));const cd=m.div`
    display: flex;
    flex-direction: column;
`,ud=e=>"right"===e?"bottom-end":"bottom-start",hd=({enabled:n,isOpen:i,onOpen:s,onClose:l,onDismiss:d,renderElement:c,renderDropdown:h,customZIndex:b,clickToToggle:f=!1,offset:g=0,alignment:m="left",fitAvailableHeight:p})=>{var v;const x=y(),w=Ya["sm-max"]({theme:x}),F=o(null),$=o(null),{width:E}=yo({targetRef:F,handleHeight:!1}),D={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<w;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:C,floatingStyles:_,context:O}=z({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==d||d():e&&!i?null==s||s():!e&&i&&(null==l||l(t))},whileElementsMounted:S,placement:ud(m),middleware:[B(g),j(),M({limiter:T()}),I({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:p?`${e}px`:void 0,overflowY:p?"hidden":void 0})}}),D]}),A=(()=>{const[e,r]=a(void 0),t=k();return u((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(dd.Change,e),t.events.emit(dd.Ready),()=>t.events.off(dd.Change,e)}),[t]),e})(),{isMounted:H,styles:V}=P(O,{initial:{opacity:0},open:{opacity:1},duration:300}),U=Y(O,{enabled:n,toggle:f}),Z=L(O,{enabled:n}),{getReferenceProps:q,getFloatingProps:K}=R([U,Z]);return e(t,{children:[r("div",Object.assign({ref:e=>{F.current=e,C.setReference(e)}},q(),{children:c()})),H&&r(W,{children:r(N,Object.assign({context:O,modal:!1,initialFocus:$,returnFocus:!1},{children:r("div",Object.assign({ref:C.setFloating,style:Object.assign(Object.assign({},_),{zIndex:null!==(v=null!=b?b:A)&&void 0!==v?v:50})},K(),{children:r(cd,Object.assign({ref:$,style:Object.assign({},V),inert:V.opacity<1?"":void 0},{children:h({elementWidth:E})}))}))}))})]})},bd=(e,r)=>{const[t,...n]=r;if(Vr(e)||!t)return;const i=e.find((e=>e.key===t));return i?n.length?bd(i.subItems,n):i:void 0},fd=(e,r)=>{const t=[];for(const n of e)n.subItems?t.push(...fd(n.subItems,[...r,n.key])):t.push({value:n.value,label:n.label,keyPath:[...r,n.key]});return t},gd=({placeholder:e="Select",options:t,disabled:n,error:i,className:s,"data-testid":l,id:d,selectedKeyPaths:c,mode:h,valueToStringFunction:b,enableSearch:f,searchPlaceholder:g,hideNoResultsDisplay:m,readOnly:p,onSearch:y,onSelectOptions:v,onShowOptions:x,onHideOptions:w,onRetry:F,onBlur:$,optionsLoadState:E="success",optionTruncationType:D="end",variant:C,alignment:_,dropdownZIndex:O})=>{const A=t,[k,z]=a(c||[]),[S,B]=a([]),[j,M]=a(!1),[T,I]=a(!1),[P]=a((()=>ps.generate())),Y=o(),L=o(),R=o();u((()=>{const e=c||[],r=((e,r)=>{const t=[];for(let n=0;n<r.length;n++){const i=r[n],o=bd(e,i);o&&t.push({value:o.value,label:o.label,keyPath:i})}return t})(A,e);z(e),B(r)}),[c,A]);const W=(e,r)=>{const t=r.map((e=>({keyPath:e.keyPath,label:e.item.label,value:e.item.value})));z(e),B(t),K(e,t)},N=e=>{const r=J(e),t=r.map((e=>e.keyPath));B(r),z(t),K(t,r)},H=()=>{T||j||I(!0)},V=e=>{!T||j||Y.current.contains(e.relatedTarget)||(I(!1),null==$||$())},U=()=>{const{label:e,value:r}=S[0];return S.length>1?`${S.length} selected`:b?b(r)||r.toString():e},Z=e=>{if("middle"===D){let r=0;return R&&R.current&&(r=R.current.getBoundingClientRect().width),Ra.truncateOneLine(e,r,120,6)}return e},q=e=>{!e&&w&&w(),e&&x&&x()},K=(e,r)=>{if(v){const t=r.map((e=>e.value));v(e,t)}},J=e=>{if(!0===e.checked)return S.filter((r=>{const t=r.keyPath.slice(0,e.keyPath.length);return!Fi(e.keyPath,t)}));{const r=[...S],t=e.hasSubItems?((e,r)=>{const t=bd(e,r);return t&&t.subItems?fd(t.subItems,r):[]})(A,e.keyPath):[{value:e.item.value,label:e.item.label,keyPath:e.keyPath}];return t.forEach((e=>{S.find((r=>Fi(r.keyPath,e.keyPath)))||r.push(e)})),r}};return r(hd,{enabled:!p&&!n,isOpen:j,renderElement:()=>r(ks,Object.assign({className:s,"data-testid":l,id:d,ref:Y,tabIndex:-1,onFocus:H,onBlur:V,$focused:T,$disabled:n,$readOnly:p,$error:i},{children:r(rl,Object.assign({ref:L,disabled:n,expanded:j,listboxId:P,popupRole:"tree",readOnly:p,variant:C},{children:r(ad,Object.assign({ref:R,$disabled:n},{children:Vr(S)?r(ld,Object.assign({truncateType:D},{children:e})):r(sd,Object.assign({truncateType:D},{children:Z(U())}))}))}))})),renderDropdown:({elementWidth:e})=>r(rd,{listboxId:P,listItems:A,multiSelect:!0,selectedKeyPaths:k,itemsLoadState:E,itemTruncationType:D,enableSearch:f,searchPlaceholder:g,hideNoResultsDisplay:m,onSelectItem:N,onSelectAll:W,onRetry:F,onSearch:y,variant:C,mode:h,width:e}),onOpen:()=>{M(!0),q(!0),I(!0)},onClose:e=>{M(!1),q(!1),"click"!==e&&(I(!1),null==$||$())},onDismiss:()=>{L.current.focus(),M(!1),q(!1)},clickToToggle:!0,offset:8,alignment:_,fitAvailableHeight:!0,customZIndex:O})};export{gd as InputNestedMultiSelect};
