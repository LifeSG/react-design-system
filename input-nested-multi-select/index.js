...
`,Zs=n=>{var{external:r=!1,children:i}=n,o=D(n,["external","children"]);return e(qs,Object.assign({},o,{children:[i,r&&t(Qs,{})]}))};var Ks;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ks||(Ks={}));const Gs={collections:{base:{InputBoxShadow:m`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const ec=p((({color:n,className:r,size:i=18})=>e(Ps,Object.assign({className:r,$size:i,$color:n},{children:[t(Es,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(Is,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(Ms,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(Cs,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
...
`,Oc=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:o,sizeType:a="default",type:s="button"}=e,c=D(e,["data-testid","styleType","children","sizeType","type"]);return t(Bc,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:a,$styleType:i},c,{children:o}))})),Pc=p.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,qc=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=D(e,["children","focusHighlight","focusOutline","type"]);return t(Uc,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Qc=m`
...
`,Al=({children:e,show:n,error:r,disabled:i,testId:o,onBlur:s,readOnly:c,className:l,variant:u})=>{const d=a();return tc("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&s()}}),"document"),t(wl,Object.assign({className:l,$variant:u},{children:t(Fl,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":o},{children:e}))}))};p.div`
    display: flex;
    flex-direction: column;
`;const El=r=>{var{placeholder:i="Select",options:c,disabled:l,error:u,className:d,"data-testid":h,id:f,selectedKeyPaths:p,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,listStyleWidth:w,readOnly:S,onSearch:$,onSelectOptions:_,onShowOptions:F,onHideOptions:x,onRetry:k,optionsLoadState:B="success",optionTruncationType:O="end"}=r,P=D(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPaths","mode","valueToStringFunction","enableSearch","searchPlaceholder","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOptions","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[A,E]=o(p||[]),[I,M]=o([]),[C,z]=o(!1),j=a(),T=a();s((()=>{const e=p||[],t=q(c,e);E(e),M(t)}),[p,c]);const H=e=>{const t=W(e.keyPath);let n=[];if(t.subItems){const r=U(t,e.keyPath);n=A.filter((t=>Y(t,e.keyPath))).length<r.length?[...new Map([...A,...r].map((e=>[e.join("-"),e]))).values()]:A.filter((t=>!Y(t,e.keyPath)))}else{if(A.some((t=>Y(t,e.keyPath)))){n=I.filter((({keyPath:t})=>JSON.stringify(t)!==JSON.stringify(e.keyPath))).map((e=>e.keyPath))}else n=[...A,e.keyPath]}const r=q(c,n);E(n),M(r),j.current&&j.current.focus(),L(n,r)},N=(e,t)=>{e&&e.length>0?(E(e),M(t),L(e,t)):(E([]),M([]),L())},R=e=>{C&&(z(!1),Z(!1)),e&&j.current&&j.current.focus()},L=(e=[],t=[])=>{if(_){const n=t.map((e=>e.value));_(e,n)}},V=()=>{const{label:e,value:t}=I[0];return I.length>1?`${I.length} selected`:m?m(t)||t.toString():e},W=e=>{const t=(e,n)=>{const[r,...i]=n;if(Dt(e)||!r)return;const o=e.find((e=>e.key===r));return o&&i.length?t(o.subItems,i):o};return t(c,e)},Y=(e,t)=>JSON.stringify(t)===JSON.stringify(e.slice(0,t.length)),U=(e,t)=>{const n=[],r=t.slice(0,-1),i=(e,t)=>{const r=[...t,e.key];e.subItems?e.subItems.forEach((e=>i(e,r))):n.push(r)};return i(e,r),n},q=(e,t)=>{let n=0;const r=(e,i)=>{const[o,...a]=i;if(Dt(e)||!o)return;const s=e.find((e=>e.key===o));if(!s)return;const{label:c,value:l,subItems:u}=s;if(!a.length){const e={label:c,value:l,keyPath:t[n]};return n+=1,e}return r(u,a)},i=[];for(let n=0;n<t.length;n++){const o=r(e,t[n]);o&&i.push({value:o.value,label:o.label,keyPath:o.keyPath})}return i},Q=e=>{if("middle"===O){let t=0;return T&&T.current&&(t=T.current.getBoundingClientRect().width),Fc.truncateOneLine(e,t,120,6)}return e},Z=e=>{!e&&x&&x(),e&&F&&F()};return e(Al,Object.assign({className:d,show:C,error:u&&!C,disabled:l,readOnly:S,testId:h,onBlur:()=>{z(!1),Z(!1)}},{children:[t($l,Object.assign({ref:j,type:"button","data-testid":f||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||S||(z(!C),Z(!C))}},P,{children:e(n,{children:[t(Bl,Object.assign({ref:T},{children:Dt(I)?t(Pl,Object.assign({truncateType:O},{children:i})):t(Ol,Object.assign({truncateType:O},{children:Q(V())}))})),!S&&t(xl,Object.assign({expanded:C},{children:t(kl,{})}))]})})),C&&t(Dl,{}),c&&c.length>0||k?t(yl,{"data-testid":"nested-dropdown-list",multiSelect:!0,listItems:c,listStyleWidth:w,visible:C,mode:g,selectedKeyPaths:A,itemsLoadState:B,itemTruncationType:O,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,onDismiss:R,onSelectAll:N,onSelectItem:H,onSearch:$,onRetry:k}):null]}))};export{El as InputNestedMultiSelect};
