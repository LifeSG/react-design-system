...
`,ec=n=>{var{external:r=!1,children:i}=n,o=O(n,["external","children"]);return e(Xs,Object.assign({},o,{children:[i,r&&t(Js,{})]}))};var tc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(tc||(tc={})),p.button`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const nc=p((({color:n,className:r,size:i=18})=>e(Es,Object.assign({className:r,$size:i,$color:n},{children:[t(Cs,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ts,{id:"inner2",$size:i-2,$borderWidth:2}),t(Ns,{id:"inner3",$size:i-2,$borderWidth:2}),t(Hs,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,Mc=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:o,sizeType:a="default",type:s="button"}=e,c=O(e,["data-testid","styleType","children","sizeType","type"]);return t(Pc,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:a,$styleType:i},c,{children:o}))})),Ac=p.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,Zc=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=O(e,["children","focusHighlight","focusOutline","type"]);return t(Qc,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Kc={collections:{base:{InputBoxShadow:m`
    ...
    `,ElevationBoxShadow:m`
      0px 2px 8px ${Ms.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},Gc=e=>t=>{var n;const r=t.theme,i=Os(Kc,r[Ds.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?ks(i,e,r.options.designToken):ks(i,e)},Xc=Gc("InputBoxShadow"),Jc=Gc("InputErrorBoxShadow");Gc("ElevationBoxShadow"),Gc("Table.Header"),Gc("Table.Cell.Primary"),Gc("Table.Cell.Secondary"),Gc("Table.Cell.Selected"),Gc("Table.Cell.Hover");p.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${Ms.Neutral[5]};
...
`,Bl=p(Dl)`
    color: ${Ms.Neutral[3]};
`,Pl=({children:e,show:n,error:r,disabled:i,testId:o,onBlur:a,readOnly:s,className:l})=>{const u=c();return rc("mousedown",(function(e){if(!i){if(u&&u.current.contains(e.target))return;n&&a()}}),"document"),t(vl,Object.assign({className:l},{children:t($l,Object.assign({ref:u,error:r&&!n,disabled:i,$readOnly:s,expanded:n,"data-testid":o},{children:e}))}))},Ml=r=>{var{placeholder:i="Select",options:a,disabled:l,error:u,className:d,"data-testid":h,id:f,selectedKeyPaths:p,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,listStyleWidth:w,readOnly:_,onSearch:S,onSelectOptions:$,onShowOptions:x,onHideOptions:F,onRetry:k,optionsLoadState:D="success",optionTruncationType:B="end"}=r,P=O(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPaths","mode","valueToStringFunction","enableSearch","searchPlaceholder","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOptions","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[M,A]=s(p||[]),[j,I]=s([]),[E,z]=s(!1),C=c(),T=c();o((()=>{const e=p||[],t=q(a,e);A(e),I(t)}),[p,a]);const N=e=>{const t=W(e.keyPath);let n=[];if(t.subItems){const r=U(t,e.keyPath);n=M.filter((t=>Y(t,e.keyPath))).length<r.length?[...new Map([...M,...r].map((e=>[e.join("-"),e]))).values()]:M.filter((t=>!Y(t,e.keyPath)))}else{if(M.some((t=>Y(t,e.keyPath)))){n=j.filter((({keyPath:t})=>JSON.stringify(t)!==JSON.stringify(e.keyPath))).map((e=>e.keyPath))}else n=[...M,e.keyPath]}const r=q(a,n);A(n),I(r),C.current&&C.current.focus(),L(n,r)},H=(e,t)=>{e&&e.length>0?(A(e),I(t),L(e,t)):(A([]),I([]),L())},R=e=>{E&&(z(!1),Z(!1)),e&&C.current&&C.current.focus()},L=(e=[],t=[])=>{if($){const n=t.map((e=>e.value));$(e,n)}},V=()=>{const{label:e,value:t}=j[0];return j.length>1?`${j.length} selected`:m?m(t)||t.toString():e},W=e=>{const t=(e,n)=>{const[r,...i]=n;if(Ft(e)||!r)return;const o=e.find((e=>e.key===r));return o&&i.length?t(o.subItems,i):o};return t(a,e)},Y=(e,t)=>JSON.stringify(t)===JSON.stringify(e.slice(0,t.length)),U=(e,t)=>{const n=[],r=t.slice(0,-1),i=(e,t)=>{const r=[...t,e.key];e.subItems?e.subItems.forEach((e=>i(e,r))):n.push(r)};return i(e,r),n},q=(e,t)=>{let n=0;const r=(e,i)=>{const[o,...a]=i;if(Ft(e)||!o)return;const s=e.find((e=>e.key===o)),{label:c,value:l,subItems:u}=s;if(!s||!a.length){const e={label:c,value:l,keyPath:t[n]};return n+=1,e}return r(u,a)},i=[];for(let n=0;n<t.length;n++){const o=r(e,t[n]);o&&i.push({value:o.value,label:o.label,keyPath:o.keyPath})}return i},Q=e=>{if("middle"===B){let t=0;return T&&T.current&&(t=T.current.getBoundingClientRect().width),kc.truncateOneLine(e,t,120,6)}return e},Z=e=>{!e&&F&&F(),e&&x&&x()};return e(Pl,Object.assign({className:d,show:E,error:u&&!E,disabled:l,readOnly:_,testId:h,onBlur:()=>{z(!1),Z(!1)}},{children:[t(_l,Object.assign({ref:C,type:"button","data-testid":f||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||_||(z(!E),Z(!E))}},P,{children:e(n,{children:[t(Ol,Object.assign({ref:T},{children:Ft(j)?t(Bl,Object.assign({truncateType:B},{children:i})):t(Dl,Object.assign({truncateType:B},{children:Q(V())}))})),!_&&t(xl,Object.assign({expanded:E},{children:t(Fl,{})}))]})})),E&&t(kl,{}),a&&a.length>0||k?t(yl,{"data-testid":"nested-dropdown-list",multiSelect:!0,listItems:a,listStyleWidth:w,visible:E,mode:g,selectedKeyPaths:M,itemsLoadState:D,itemTruncationType:B,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,onDismiss:R,onSelectAll:H,onSelectItem:N,onSearch:S,onRetry:k}):null]}))};export{Ml as InputNestedMultiSelect};
