...
`,ec=n=>{var{external:r=!1,children:i}=n,o=O(n,["external","children"]);return e(Xs,Object.assign({},o,{children:[i,r&&t(Js,{})]}))};var tc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(tc||(tc={})),f.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
	...
	${e=>"small"===e.$buttonSizeStyle?g`
                ...
                `}
`;const nc=f((({color:n,className:r,size:i=18})=>e(zs,Object.assign({className:r,$size:i,$color:n},{children:[t(Es,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ts,{id:"inner2",$size:i-2,$borderWidth:2}),t(Ns,{id:"inner3",$size:i-2,$borderWidth:2}),t(Hs,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,Mc=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:o,sizeType:a="default",type:s="button"}=e,c=O(e,["data-testid","styleType","children","sizeType","type"]);return t(Bc,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:a,$styleType:i},c,{children:o}))})),jc=f.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,Zc=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=O(e,["children","focusHighlight","focusOutline","type"]);return t(Qc,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Kc={collections:{base:{InputBoxShadow:g`
    ...
    `,ElevationBoxShadow:g`
      0px 2px 8px ${Ms.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},Gc=e=>t=>{var n;const r=t.theme,i=Os(Kc,r[Ds.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?Fs(i,e,r.options.designToken):Fs(i,e)},Xc=Gc("InputBoxShadow"),Jc=Gc("InputErrorBoxShadow");Gc("ElevationBoxShadow"),Gc("Table.Header"),Gc("Table.Cell.Primary"),Gc("Table.Cell.Secondary"),Gc("Table.Cell.Selected"),Gc("Table.Cell.Hover");f.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${Ms.Neutral[5]};
