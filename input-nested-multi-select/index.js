...
`,Gs=n=>{var{external:r=!1,children:i}=n,a=B(n,["external","children"]);return e(Zs,Object.assign({},a,{children:[i,r&&t(Ks,{})]}))};var Xs;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Xs||(Xs={}));const el={collections:{base:{InputBoxShadow:m`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const rl=p((({color:n,className:r,size:i=18})=>e(Ps,Object.assign({className:r,$size:i,$color:n},{children:[t(Es,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(Is,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(Ms,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(Cs,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
...
`,El=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:a,sizeType:o="default",type:s="button"}=e,l=B(e,["data-testid","styleType","children","sizeType","type"]);return t(Al,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:o,$styleType:i},l,{children:a}))})),Il=p.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,Ic=p(Ec)`
    color: ${ks.Neutral[3]};
`,Mc=({children:e,show:n,error:r,disabled:i,testId:a,onBlur:s,readOnly:l,className:c,variant:u})=>{const d=o();return il("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&s()}}),"document"),t(_c,Object.assign({className:c,$variant:u},{children:t(Bc,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:l,expanded:n,"data-testid":a},{children:e}))}))};var Cc;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Cc||(Cc={})),p.div`
    display: flex;
    flex-direction: column;
`;const zc=r=>{var{placeholder:i="Select",options:l,disabled:c,error:u,className:d,"data-testid":h,id:f,selectedKeyPaths:p,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,listStyleWidth:S,readOnly:w,onSearch:$,onSelectOptions:_,onShowOptions:F,onHideOptions:x,onRetry:k,optionsLoadState:D="success",optionTruncationType:O="end"}=r,P=B(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPaths","mode","valueToStringFunction","enableSearch","searchPlaceholder","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOptions","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[A,E]=a(p||[]),[I,M]=a([]),[C,z]=a(!1),j=o(),H=o();s((()=>{const e=p||[],t=q(l,e);E(e),M(t)}),[p,l]);const T=e=>{const t=V(e.keyPath);let n=[];if(t.subItems){const r=U(t,e.keyPath);n=A.filter((t=>Y(t,e.keyPath))).length<r.length?[...new Map([...A,...r].map((e=>[e.join("-"),e]))).values()]:A.filter((t=>!Y(t,e.keyPath)))}else{if(A.some((t=>Y(t,e.keyPath)))){n=I.filter((({keyPath:t})=>JSON.stringify(t)!==JSON.stringify(e.keyPath))).map((e=>e.keyPath))}else n=[...A,e.keyPath]}const r=q(l,n);E(n),M(r),j.current&&j.current.focus(),L(n,r)},N=(e,t)=>{e&&e.length>0?(E(e),M(t),L(e,t)):(E([]),M([]),L())},R=e=>{C&&(z(!1),Q(!1)),e&&j.current&&j.current.focus()},L=(e=[],t=[])=>{if(_){const n=t.map((e=>e.value));_(e,n)}},W=()=>{const{label:e,value:t}=I[0];return I.length>1?`${I.length} selected`:m?m(t)||t.toString():e},V=e=>{const t=(e,n)=>{const[r,...i]=n;if(Bt(e)||!r)return;const a=e.find((e=>e.key===r));return a&&i.length?t(a.subItems,i):a};return t(l,e)},Y=(e,t)=>JSON.stringify(t)===JSON.stringify(e.slice(0,t.length)),U=(e,t)=>{const n=[],r=t.slice(0,-1),i=(e,t)=>{const r=[...t,e.key];e.subItems?e.subItems.forEach((e=>i(e,r))):n.push(r)};return i(e,r),n},q=(e,t)=>{let n=0;const r=(e,i)=>{const[a,...o]=i;if(Bt(e)||!a)return;const s=e.find((e=>e.key===a));if(!s)return;const{label:l,value:c,subItems:u}=s;if(!o.length){const e={label:l,value:c,keyPath:t[n]};return n+=1,e}return r(u,o)},i=[];for(let n=0;n<t.length;n++){const a=r(e,t[n]);a&&i.push({value:a.value,label:a.label,keyPath:a.keyPath})}return i},J=e=>{if("middle"===O){let t=0;return H&&H.current&&(t=H.current.getBoundingClientRect().width),Bl.truncateOneLine(e,t,120,6)}return e},Q=e=>{!e&&x&&x(),e&&F&&F()};return e(Mc,Object.assign({className:d,show:C,error:u&&!C,disabled:c,readOnly:w,testId:h,onBlur:()=>{z(!1),Q(!1)}},{children:[t(xc,Object.assign({ref:j,type:"button","data-testid":f||"selector",disabled:c,onClick:e=>{e.preventDefault(),c||w||(z(!C),Q(!C))}},P,{children:e(n,{children:[t(Ac,Object.assign({ref:H},{children:Bt(I)?t(Ic,Object.assign({truncateType:O},{children:i})):t(Ec,Object.assign({truncateType:O},{children:J(W())}))})),!w&&t(Dc,Object.assign({expanded:C},{children:t(Oc,{})}))]})})),C&&t(Pc,{}),l&&l.length>0||k?t(Sc,{"data-testid":"nested-dropdown-list",multiSelect:!0,listItems:l,listStyleWidth:S,visible:C,mode:g,selectedKeyPaths:A,itemsLoadState:D,itemTruncationType:O,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,onDismiss:R,onSelectAll:N,onSelectItem:T,onSearch:$,onRetry:k}):null]}))};export{zc as InputNestedMultiSelect};
