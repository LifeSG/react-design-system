...
`,ec=n=>{var{external:r=!1,children:i}=n,o=D(n,["external","children"]);return e(Xs,Object.assign({},o,{children:[i,r&&t(Js,{})]}))};var tc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(tc||(tc={}));const nc={collections:{base:{InputBoxShadow:m`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const oc=f((({color:n,className:r,size:i=18})=>e(Es,Object.assign({className:r,$size:i,$color:n},{children:[t(zs,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ts,{id:"inner2",$size:i-2,$borderWidth:2}),t(Ns,{id:"inner3",$size:i-2,$borderWidth:2}),t(Hs,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
