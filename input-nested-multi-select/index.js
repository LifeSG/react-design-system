...
`,ec=n=>{var{external:r=!1,children:i}=n,o=D(n,["external","children"]);return e(Xs,Object.assign({},o,{children:[i,r&&t(Js,{})]}))};var tc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(tc||(tc={}));const nc={collections:{base:{InputBoxShadow:m`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return m`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?ic.Button.Danger.Border:Ms.Primary};

                    span {
                        color: ${e.$buttonIsDanger?ic.Button.Danger.Primary:Ms.Primary};
                    }
                `;case"light":return m`
                    background-color: ${Ms.Neutral[8]};
                ...
                `;case"link":return m`
                    ...
                    :focus {
                        span {
                            color: ${e.$buttonIsDanger?ic.Button.Danger.Hover:Ms.Secondary};
                        }
                    }
                `;default:return m`
                    background-color: ${e.$buttonIsDanger?ic.Button.Danger.BackgroundColor:Ms.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const oc=p((({color:n,className:r,size:i=18})=>e(Es,Object.assign({className:r,$size:i,$color:n},{children:[t(zs,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ts,{id:"inner2",$size:i-2,$borderWidth:2}),t(Ns,{id:"inner3",$size:i-2,$borderWidth:2}),t(Hs,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?ic.Button.Danger.Primary:Ms.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Ms.Neutral[3](e);break;default:t=Ms.Neutral[8](e)}return m`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,jc=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:o,sizeType:a="default",type:s="button"}=e,c=D(e,["data-testid","styleType","children","sizeType","type"]);return t(Ic,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:a,$styleType:i},c,{children:o}))})),Ec=p.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,Kc=({item:r,selectableCategory:i,searchValue:o,itemTruncationType:a,multiSelect:s,visible:l,onBlur:u,onExpand:d,onRef:h,onSelect:f,onSelectCategory:p})=>{const g=c(),m=c(),y=e=>{e.preventDefault(),d(r.keyPath)},b=e=>{e.preventDefault(),f(r)},v=e=>{e.stopPropagation(),p(r)},w=()=>{u&&u()},_=(e,t)=>{const n=e.label;let r=0;return"label"===t&&g&&g.current&&(r=g.current.getBoundingClientRect().width),"category"===t&&m&&m.current&&(r=m.current.getBoundingClientRect().width),Bc.shouldTruncateToTwoLines(n,r)},S=n=>e(Hc,Object.assign({"data-testid":"truncate-middle-container"},{children:[t(Rc,{children:$(n)}),t(Lc,{children:$(n)})]})),$=r=>{if(!r.isSearchTerm)return t(n,{children:r.label});const i=r.label,a=o.toLowerCase().trim(),s=i.toLowerCase().indexOf(a),c=s+a.length;return-1==s?t(n,{children:i}):e(n,{children:[`${i.slice(0,s)}`,t(Nc,{children:i.slice(s,c)}),`${i.slice(c)}`]})};return r.subItems?e("li",{children:[(()=>{let n={},o={};return i&&(o={onClick:b}),s?o={onClick:y,tabIndex:-1}:n={onClick:y},e(Ec,Object.assign({},n,{children:[e(Vc,{children:[t(Yc,Object.assign({ref:e=>h(e,r.keyPath),$expanded:r.expanded,"aria-expanded":r.expanded,onClick:y},{children:t(Uc,{})})),s&&t(Wc,{displaySize:"small",$type:"category",checked:r.checked,indeterminate:r.indeterminate,onChange:v})]}),t(qc,Object.assign({},o,{children:t(Qc,Object.assign({ref:m,$truncateType:a},{children:"middle"===a&&_(r,"category")?S(r):r.label}))}))]}))})(),(()=>{const e=r.subItems.values();return t(Zc,Object.assign({$expanded:r.expanded,$multiSelect:s},{children:[...e].map((e=>t(Kc,{item:e,selectableCategory:i,searchValue:o,itemTruncationType:a,multiSelect:s,visible:l,onBlur:u,onExpand:d,onRef:h,onSelect:f,onSelectCategory:p},e.keyPath.join("-"))))}))})()]}):t(zc,Object.assign({ref:g,$level:r.keyPath.length,$multiSelect:s},{children:t(Cc,Object.assign({ref:e=>h(e,r.keyPath),type:"button",tabIndex:l?0:-1,$selected:r.selected,$multiSelect:s,onBlur:w,onClick:b},{children:e(n,{children:[s&&t(Wc,{displaySize:"small",checked:r.checked,$type:"label"}),t(Tc,Object.assign({$truncateType:a},{children:"middle"===a&&_(r,"label")?S(r):$(r)}))]})}))}))},Gc=p.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,Xc=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=D(e,["children","focusHighlight","focusOutline","type"]);return t(Gc,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))}));p.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${Ms.Neutral[5]};
    ...
    ${e=>e.$readOnly?m`
            ...
            `:e.$error?m`
                ...
                :focus-within {
                    border: 1px solid ${Ms.Validation.Red.Border};
                    box-shadow: ${ic.InputErrorBoxShadow};
                }
            `:void 0}
`;const Jc=p.input`
    ${Zs("Body","regular")}
...
`,Ol=p(Dl)`
    color: ${Ms.Neutral[3]};
`,Bl=({children:e,show:n,error:r,disabled:i,testId:o,onBlur:a,readOnly:s,className:l})=>{const u=c();return ac("mousedown",(function(e){if(!i){if(u&&u.current.contains(e.target))return;n&&a()}}),"document"),t(bl,Object.assign({className:l},{children:t(Sl,Object.assign({ref:u,error:r&&!n,disabled:i,$readOnly:s,expanded:n,"data-testid":o},{children:e}))}))},Pl=r=>{var{placeholder:i="Select",options:a,disabled:l,error:u,className:d,"data-testid":h,id:f,selectedKeyPaths:p,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,listStyleWidth:w,readOnly:_,onSearch:S,onSelectOptions:$,onShowOptions:x,onHideOptions:F,onRetry:k,optionsLoadState:O="success",optionTruncationType:B="end"}=r,P=D(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPaths","mode","valueToStringFunction","enableSearch","searchPlaceholder","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOptions","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[M,A]=s(p||[]),[I,j]=s([]),[E,C]=s(!1),z=c(),T=c();o((()=>{const e=p||[],t=q(a,e);A(e),j(t)}),[p,a]);const N=e=>{const t=W(e.keyPath);let n=[];if(t.subItems){const r=U(t,e.keyPath);n=M.filter((t=>Y(t,e.keyPath))).length<r.length?[...new Map([...M,...r].map((e=>[e.join("-"),e]))).values()]:M.filter((t=>!Y(t,e.keyPath)))}else{if(M.some((t=>Y(t,e.keyPath)))){n=I.filter((({keyPath:t})=>JSON.stringify(t)!==JSON.stringify(e.keyPath))).map((e=>e.keyPath))}else n=[...M,e.keyPath]}const r=q(a,n);A(n),j(r),z.current&&z.current.focus(),L(n,r)},H=(e,t)=>{e&&e.length>0?(A(e),j(t),L(e,t)):(A([]),j([]),L())},R=e=>{E&&(C(!1),Z(!1)),e&&z.current&&z.current.focus()},L=(e=[],t=[])=>{if($){const n=t.map((e=>e.value));$(e,n)}},V=()=>{const{label:e,value:t}=I[0];return I.length>1?`${I.length} selected`:m?m(t)||t.toString():e},W=e=>{const t=(e,n)=>{const[r,...i]=n;if(Ft(e)||!r)return;const o=e.find((e=>e.key===r));return o&&i.length?t(o.subItems,i):o};return t(a,e)},Y=(e,t)=>JSON.stringify(t)===JSON.stringify(e.slice(0,t.length)),U=(e,t)=>{const n=[],r=t.slice(0,-1),i=(e,t)=>{const r=[...t,e.key];e.subItems?e.subItems.forEach((e=>i(e,r))):n.push(r)};return i(e,r),n},q=(e,t)=>{let n=0;const r=(e,i)=>{const[o,...a]=i;if(Ft(e)||!o)return;const s=e.find((e=>e.key===o));if(!s)return;const{label:c,value:l,subItems:u}=s;if(!a.length){const e={label:c,value:l,keyPath:t[n]};return n+=1,e}return r(u,a)},i=[];for(let n=0;n<t.length;n++){const o=r(e,t[n]);o&&i.push({value:o.value,label:o.label,keyPath:o.keyPath})}return i},Q=e=>{if("middle"===B){let t=0;return T&&T.current&&(t=T.current.getBoundingClientRect().width),Bc.truncateOneLine(e,t,120,6)}return e},Z=e=>{!e&&F&&F(),e&&x&&x()};return e(Bl,Object.assign({className:d,show:E,error:u&&!E,disabled:l,readOnly:_,testId:h,onBlur:()=>{C(!1),Z(!1)}},{children:[t(wl,Object.assign({ref:z,type:"button","data-testid":f||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||_||(C(!E),Z(!E))}},P,{children:e(n,{children:[t(kl,Object.assign({ref:T},{children:Ft(I)?t(Ol,Object.assign({truncateType:B},{children:i})):t(Dl,Object.assign({truncateType:B},{children:Q(V())}))})),!_&&t($l,Object.assign({expanded:E},{children:t(xl,{})}))]})})),E&&t(Fl,{}),a&&a.length>0||k?t(ml,{"data-testid":"nested-dropdown-list",multiSelect:!0,listItems:a,listStyleWidth:w,visible:E,mode:g,selectedKeyPaths:M,itemsLoadState:O,itemTruncationType:B,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:v,onDismiss:R,onSelectAll:H,onSelectItem:N,onSearch:S,onRetry:k}):null]}))};export{Pl as InputNestedMultiSelect};
