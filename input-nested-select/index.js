...
`,Oc=i.forwardRef(((e,r)=>{var{"data-testid":n,styleType:i="primary",children:a,sizeType:o="default",type:s="button"}=e,c=D(e,["data-testid","styleType","children","sizeType","type"]);return t(Bc,Object.assign({"data-testid":n||"iconButton",ref:r,type:s,$sizeType:o,$styleType:i},c,{children:a}))})),Pc=f.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,Tc=f.div`
    display: flex;
`,Hc=f((r=>{var{className:n,checked:i,disabled:a,indeterminate:c,onChange:l,onKeyPress:u,displaySize:d="default"}=r,h=D(r,["className","checked","disabled","indeterminate","onChange","onKeyPress","displaySize"]);const p=o();s((()=>{p.current.indeterminate=c}),[c]);const f=e=>{if(!a){const t=e;if(!(" "===t.key||"change"===e.type))return;l&&l(e),u&&u(t)}};return e(kc,Object.assign({className:n,"data-testid":"checkbox",role:"checkbox","aria-checked":c?"mixed":i,"aria-labelledby":"checkbox-input",tabIndex:a?-1:0,onKeyDown:f,$displaySize:d,$disabled:a,$unchecked:!(c||i||a)},{children:[t(Dc,Object.assign({id:"checkbox-input","data-testid":"checkbox-input","aria-hidden":"true",type:"checkbox",checked:i,ref:p,tabIndex:-1,onChange:f,disabled:a},h)),c?t(b,{"data-testid":"indeterminate"}):i?t(v,{"data-testid":"checkmark"}):a?t(w,{"data-testid":"disabled-empty-checkbox"}):t(S,{"data-testid":"empty-checkbox"})]}))}))`
    min-width: 1.5rem;
    max-width: 1.5rem;
...
`,qc=i.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=D(e,["children","focusHighlight","focusOutline","type"]);return t(Uc,Object.assign({ref:r,$outline:a,$highlight:i,type:o},s,{children:n}))}));f.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${ks.Neutral[5]};
...
`,el=f(qc)`
    ...
    ${e=>{if("small"===e.$variant)return m`
            ...
            `}}
`,tl=l(((r,n)=>{const{onClear:i}=r,a=D(r,["onClear"]);return e(Gc,{children:[t(Jc,{$variant:r.variant}),t(Xc,Object.assign({ref:n,$variant:r.variant},a)),a.value&&t(el,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:i,$variant:r.variant},{children:t($,{})}))]},"search")}));var rl;!function(e){e.getInitialItems=(e,t,r)=>{const n=(e,t)=>e.reduce(((e,i)=>{const{key:a,label:o,value:s,subItems:c}=i,l=a.toString(),u=[...t,l],d={label:o,value:s,expanded:"expand"===r,isSearchTerm:!1,selected:!1,checked:!1,indeterminate:!1,keyPath:u,subItems:c?n(c,u):void 0};return e.set(l,d),e}),new Map);return n(e,t)},e.getInitialDropdown=(t,r)=>{let n=r;n&&n.length||(n=[nl(t)]);return yr(t,(t=>{let i=[];n.forEach((n=>{i=[],n.forEach((n=>{i.push(n);const a=e.getItemAtKeyPath(t,i),o=r.some((e=>JSON.stringify(e)===JSON.stringify(a.keyPath)));a.subItems&&(a.expanded=!0),o&&(a.selected=!0)}))}))}))},e.updateSelectedAll=(e,t)=>{let r=e,n=[],i=[];if(t){const{keyPaths:t,items:a}=il(r);n=t,i=a,r=yr(e,(e=>{for(const t of e.values()){const e=t=>{if(t.subItems)return t.expanded=!0,t.subItems.forEach((t=>e(t)))};e(t)}}))}return{keyPaths:n,items:i,list:r}},e.getVisibleKeyPaths=e=>{const t=[],r=e=>{if(e&&e.size)for(const n of e.values())t.push(n.keyPath),n.expanded&&r(n.subItems)};return r(e),t},e.getUpdateCheckbox=(e,t)=>{const r=yr(e,(e=>{const r=e=>{for(const n of e.values())if(n.subItems){r(n.subItems);const e=n.subItems,{checked:t,indeterminate:i}=Array.from(e).reduce(((e,t)=>{const r=t[1];return e.checked.push(r.checked),e.indeterminate.push(r.indeterminate),e}),{checked:[],indeterminate:[]}),a=t.every(Boolean),o=t.some(Boolean),s=i.some(Boolean);a?(n.checked=!0,n.indeterminate=!1):o||s?(n.checked=!1,n.indeterminate=!0):(n.checked=!1,n.indeterminate=!1)}else{const e=t.some((e=>JSON.stringify(e)===JSON.stringify(n.keyPath)));n.checked=e}};r(e)}));return r},e.getItemAtKeyPath=(e,t)=>t.reduce(((t,r)=>t?t.subItems.get(r):e.get(r)),null)}(rl||(rl={}));const nl=e=>{for(const t of e.values())if(t.subItems&&t.subItems.size)return nl(t.subItems);return e.values().next().value.keyPath},il=e=>{const t=[],r=[],n=e=>{if(e&&e.size)for(const i of e.values()){const{keyPath:e,label:a,value:o}=i;i.subItems&&i.subItems.size?n(i.subItems):(t.push(i.keyPath),r.push({label:a,value:o,keyPath:e}))}};return n(e),{keyPaths:t,items:r}},al=f(ws.div)`
    overflow: hidden;
...
`,dl=f.button`
    ...
    overflow: hidden;
    outline: none;
`;!function(){class e extends Map{constructor(e,t){super(),this[Pt]={type_:2,parent_:t,scope_:t?t.scope_:Xt(),modified_:!1,finalized_:!1,copy_:void 0,assigned_:void 0,base_:e,draft_:this,isManual_:!1,revoked_:!1}}get size(){return Wt(this[Pt]).size}has(e){return Wt(this[Pt]).has(e)}set(e,r){const n=this[Pt];return i(n),Wt(n).has(e)&&Wt(n).get(e)===r||(t(n),hr(n),n.assigned_.set(e,!0),n.copy_.set(e,r),n.assigned_.set(e,!0)),this}delete(e){if(!this.has(e))return!1;const r=this[Pt];return i(r),t(r),hr(r),r.base_.has(e)?r.assigned_.set(e,!1):r.assigned_.delete(e),r.copy_.delete(e),!0}clear(){const e=this[Pt];i(e),Wt(e).size&&(t(e),hr(e),e.assigned_=new Map,Tt(e.base_,(t=>{e.assigned_.set(t,!1)})),e.copy_.clear())}forEach(e,t){Wt(this[Pt]).forEach(((r,n,i)=>{e.call(t,this.get(n),n,this)}))}get(e){const r=this[Pt];i(r);const n=Wt(r).get(e);if(r.finalized_||!Ct(n))return n;if(n!==r.base_.get(e))return n;const a=fr(n,r);return t(r),r.copy_.set(e,a),a}keys(){return Wt(this[Pt]).keys()}values(){const e=this.keys();return{[Symbol.iterator]:()=>this.values(),next:()=>{const t=e.next();if(t.done)return t;return{done:!1,value:this.get(t.value)}}}}entries(){const e=this.keys();return{[Symbol.iterator]:()=>this.entries(),next:()=>{const t=e.next();if(t.done)return t;const r=this.get(t.value);return{done:!1,value:[t.value,r]}}}}[Symbol.iterator](){return this.entries()}}function t(e){e.copy_||(e.assigned_=new Map,e.copy_=new Map(e.base_))}class r extends Set{constructor(e,t){super(),this[Pt]={type_:3,parent_:t,scope_:t?t.scope_:Xt(),modified_:!1,finalized_:!1,copy_:void 0,base_:e,draft_:this,drafts_:new Map,revoked_:!1,isManual_:!1}}get size(){return Wt(this[Pt]).size}has(e){const t=this[Pt];return i(t),t.copy_?!!t.copy_.has(e)||!(!t.drafts_.has(e)||!t.copy_.has(t.drafts_.get(e))):t.base_.has(e)}add(e){const t=this[Pt];return i(t),this.has(e)||(n(t),hr(t),t.copy_.add(e)),this}delete(e){if(!this.has(e))return!1;const t=this[Pt];return i(t),n(t),hr(t),t.copy_.delete(e)||!!t.drafts_.has(e)&&t.copy_.delete(t.drafts_.get(e))}clear(){const e=this[Pt];i(e),Wt(e).size&&(n(e),hr(e),e.copy_.clear())}values(){const e=this[Pt];return i(e),n(e),e.copy_.values()}entries(){const e=this[Pt];return i(e),n(e),e.copy_.entries()}keys(){return this.values()}[Symbol.iterator](){return this.values()}forEach(e,t){const r=this.values();let n=r.next();for(;!n.done;)e.call(t,n.value,n.value,this),n=r.next()}}function n(e){e.copy_||(e.copy_=new Set,e.base_.forEach((t=>{if(Ct(t)){const r=fr(t,e);e.drafts_.set(t,r),e.copy_.add(r)}else e.copy_.add(t)})))}function i(e){e.revoked_&&It(3,JSON.stringify(Wt(e)))}var a,o;o={proxyMap_:function(t,r){return new e(t,r)},proxySet_:function(e,t){return new r(e,t)}},Kt[a="MapSet"]||(Kt[a]=o)}();const hl=n=>{var{listItems:i,listStyleWidth:c,hideNoResultsDisplay:l,enableSearch:u,searchPlaceholder:d="Search",visible:p,mode:f="default",multiSelect:g,selectedKeyPaths:m,selectableCategory:y,itemsLoadState:b="success",itemTruncationType:v="end",onBlur:w,onDismiss:S,onSelectAll:$,onRetry:_,onSearch:x,onSelectItem:F}=n,k=D(n,["listItems","listStyleWidth","hideNoResultsDisplay","enableSearch","searchPlaceholder","visible","mode","multiSelect","selectedKeyPaths","selectableCategory","itemsLoadState","itemTruncationType","onBlur","onDismiss","onSelectAll","onRetry","onSearch","onSelectItem"]);const B=h((()=>i&&i.length?rl.getInitialItems(i,[],f):new Map([])),[i]),[O,P]=a(""),[A,I]=a(0),[M,E]=a(!1),[C,j]=a(B),[z,T]=a(B),[H,N]=a(0),[R,L]=a([]),V=rs({height:A}),W=o(),Y=o(),U=o({}),q=o();s((()=>{var e;if(p){const t=oe(),r=rl.getVisibleKeyPaths(t);if(q.current)q.current.focus();else if(U.current){const t=r[H];null===(e=U.current[t[0]])||void 0===e||e.ref.focus()}if(g){const e=rl.getUpdateCheckbox(t,m);j(e)}else j(t);L(r),setTimeout((()=>{I(ie())}))}else U.current={},N(0),I(0),P(""),j(B)}),[p]),s((()=>{if(p){const e=ie();I(e)}}),[C,z]),s((()=>{ce(O)}),[O]),s((()=>{if(p&&g){const e=M?z:C,t=rl.getUpdateCheckbox(e,m);M?T(t):j(t)}}),[m,M]),tc("keydown",(function(e){if(W.current&&W.current.contains(e.target))switch(e.code){case"ArrowDown":if(H+1>=R.length)return;J("down");break;case"ArrowUp":if(H-1<0)return void(u&&q.current.focus());J("up");break;case"Escape":S&&S(!0)}}),"document");const Q=e=>{const{label:t,keyPath:r,value:n}=e;F({label:t,keyPath:r,value:n})},Z=e=>{const t=M?z:C,{label:r,keyPath:n,value:i}=e,a=yr(t,(e=>{const t=rl.getItemAtKeyPath(e,n);if(t.expanded=!0,t.subItems&&t.subItems.size)for(const e of t.subItems.values())e.expanded=!0})),o=rl.getVisibleKeyPaths(a);L(o),M?T(a):j(a),F({label:r,keyPath:n,value:i})},K=()=>{const e=!m.length,{keyPaths:t,items:r,list:n}=rl.updateSelectedAll(C,e);$&&(j(n),e?$(t,r):$([],[]))},G=e=>{const t=yr(M?z:C,(t=>{const r=rl.getItemAtKeyPath(t,e);r.expanded=!r.expanded})),r=rl.getVisibleKeyPaths(t);L(r),M?T(t):j(t)},X=(e,t,r=U.current)=>{const[n,...i]=t;r[n]||(r[n]={ref:void 0,subItems:{}}),i.length?X(e,i,r[n].subItems):r[n].ref=e},J=e=>{const t="down"===e?H+1:H-1;N(t);const r=R[t];Nn(U.current,r.join(".subItems.")).ref.focus()},ee=e=>{const t=e.target.value;P(t),x&&x()},te=()=>{P(""),q.current.focus(),x&&x()};const re=()=>{},ne=()=>{_&&_()},ie=()=>Y&&Y.current?Y.current.getBoundingClientRect().height:0,ae=()=>{const e=(t,r)=>{const n=O.toLowerCase().trim(),i=-1!=t.label.toLowerCase().indexOf(n),a=-1!=B.get(t.keyPath[0]).label.toLowerCase().indexOf(n);if(!t.subItems)return i?Object.assign(Object.assign({},t),{expanded:!1,isSearchTerm:!0}):r||a?Object.assign(Object.assign({},t),{expanded:!1,isSearchTerm:!1}):void 0;const o=new Map;t.subItems.forEach((t=>{const r=e(t,i);if(r){const e=r.keyPath[r.keyPath.length-1];o.set(e,r)}}));let s=!1;for(const e of o.values())if((e.isSearchTerm||e.expanded)&&(s=!0),e.subItems&&0===e.subItems.size){const t=e.keyPath[e.keyPath.length-1];o.delete(t)}return Object.assign(Object.assign({},t),{expanded:s,isSearchTerm:i,subItems:o})},t=new Map;for(const[r,n]of B){const i=e(n);(i&&i.subItems&&i.subItems.size||i&&i.isSearchTerm)&&t.set(r,i)}return t},oe=()=>{if(["expand","collapse"].includes(f))return B;return rl.getInitialDropdown(B,m)},se=e=>{const t=rl.getVisibleKeyPaths(e);L(t),N(0)},ce=e=>{if(""===e)se(C),T(B),E(!1);else if(e.trim().length>=3){U.current={};const e=ae();if(T(e),se(e),E(!0),g){const t=rl.getUpdateCheckbox(e,m);T(t)}}},le=()=>{if(!_||_&&"success"===b){const e=M?z:C;return Array.from(e).map((([e,r])=>t(Yc,{item:r,selectableCategory:y,searchValue:O,itemTruncationType:v,multiSelect:g,visible:p,onBlur:re,onExpand:G,onRef:X,onSelect:Q,onSelectCategory:Z},e)))}},ue=()=>{if(g&&B.size>0&&!M&&"success"===b)return t(ul,{children:t(dl,Object.assign({onClick:K,type:"button"},{children:0===m.length?"Select all":"Clear all"}))})},de=()=>{if(M&&!l&&!z.size)return e(sl,Object.assign({"data-testid":"list-no-results"},{children:[t(ll,{"data-testid":"no-result-icon"}),t(cl,{children:"No results found."})]}),"noResults")},he=()=>{if(_&&"loading"===b)return e(sl,Object.assign({"data-testid":"list-loading"},{children:[t(ec,{$buttonStyle:"secondary",size:24}),t(cl,{children:"Loading..."})]}),"loading")},pe=()=>{if(_&&"fail"===b)return e(sl,Object.assign({"data-testid":"list-fail"},{children:[t(ll,{"data-testid":"load-error-icon"}),t(cl,{children:"Failed to load."}),t(dl,Object.assign({onClick:ne,type:"button"},{children:"Try again."}))]}),"noResults")};return t(r,{children:t(al,Object.assign({style:V,"data-testid":p?"dropdown-container":"dropdown-container-hidden",ref:W},{children:(()=>{if(p)return e(ol,Object.assign({ref:Y,"data-testid":"dropdown-list",width:c,role:"list"},k,{children:[u&&"success"===b?t(tl,{ref:q,onChange:ee,value:O,placeholder:d,"data-testid":"search-input","aria-label":"Type to search",tabIndex:p?0:-1,onClear:te}):null,ue(),he(),de(),pe(),le()]}))})()}))})},pl="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",fl=e=>"small"===e?2.5:3,gl=f.div`
    position: relative;
    width: 100%;
    ${e=>{const t=fl(e.$variant);return m`
            min-height: ${t}rem;
...
`,ml=m`
    ...
    height: calc(${e=>fl(e.$variant)}rem - 2px);
    width: 100%;
    border-radius: ${"4px"};
    border: none;
    background: transparent;
...
`,Fl=f(xl)`
    color: ${ks.Neutral[3]};
`,kl=({children:e,show:r,error:n,disabled:i,testId:a,onBlur:s,readOnly:c,className:l,variant:u})=>{const d=o();return tc("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;r&&s()}}),"document"),t(gl,Object.assign({className:l,$variant:u},{children:t(vl,Object.assign({ref:d,error:n&&!r,disabled:i,$readOnly:c,expanded:r,"data-testid":a},{children:e}))}))},Dl=n=>{var{placeholder:i="Select",options:c,disabled:l,error:u,className:d,"data-testid":h,id:p,selectedKeyPath:f,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,selectableCategory:v,hideNoResultsDisplay:w,listStyleWidth:S,readOnly:$,onSearch:_,onSelectOption:x,onShowOptions:F,onHideOptions:k,onRetry:B,optionsLoadState:O="success",optionTruncationType:P="end"}=n,A=D(n,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPath","mode","valueToStringFunction","enableSearch","searchPlaceholder","selectableCategory","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOption","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[I,M]=a(f?[f]:[]),[E,C]=a(),[j,z]=a(!1),T=o(),H=o();s((()=>{M(f?[f]:[]),V(c,f||[])}),[f,c]);const N=e=>{const{keyPath:t,value:r,label:n}=e;M([t]),C({label:n,value:r}),z(!1),Y(!1),T.current&&T.current.focus(),x&&x(t,r)},R=e=>{j&&(z(!1),Y(!1)),e&&T.current&&T.current.focus()},L=()=>{const{label:e,value:t}=E;return m?m(t)||t.toString():e},V=(e,t)=>{const r=(e,t)=>{const[n,...i]=t;if(Dt(e)||!n)return;const a=e.find((e=>e.key===n));return a&&i.length?r(a.subItems,i):a},n=r(e,t);if(n){const{label:e,value:t}=n;C({label:e,value:t})}else C(void 0)},W=e=>{if("middle"===P){let t=0;return H&&H.current&&(t=H.current.getBoundingClientRect().width),xc.truncateOneLine(e,t,120,6)}return e},Y=e=>{!e&&k&&k(),e&&F&&F()};return e(kl,Object.assign({className:d,show:j,error:u&&!j,disabled:l,readOnly:$,testId:h,onBlur:()=>{z(!1),Y(!1)}},{children:[t(yl,Object.assign({ref:T,type:"button","data-testid":p||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||$||(z(!j),Y(!j))}},A,{children:e(r,{children:[t(_l,Object.assign({ref:H},{children:Dt(E)?t(Fl,Object.assign({truncateType:P},{children:i})):t(xl,Object.assign({truncateType:P},{children:W(L())}))})),!$&&t(wl,Object.assign({expanded:j},{children:t(Sl,{})}))]})})),j&&t($l,{}),c&&c.length>0||B?t(hl,{"data-testid":"nested-dropdown-list",listItems:c,listStyleWidth:S,visible:j,mode:g,selectedKeyPaths:I,selectableCategory:v,itemsLoadState:O,itemTruncationType:P,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:w,onDismiss:R,onSelectItem:N,onSearch:_,onRetry:B}):null]}))};export{Dl as InputNestedSelect};
