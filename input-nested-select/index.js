...
`,cu={collections:{base:{InputBoxShadow:y`
    ...
    `,ElevationBoxShadow:y`
      0px 2px 8px ${Ro.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},uu=e=>t=>{var n;const r=t.theme,o=xo(cu,r[wo.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?So(o,e,r.options.designToken):So(o,e)},du={InputBoxShadow:uu("InputBoxShadow"),InputErrorBoxShadow:uu("InputErrorBoxShadow"),ElevationBoxShadow:uu("ElevationBoxShadow"),Table:{Header:uu("Table.Header"),Cell:{Primary:uu("Table.Cell.Primary"),Secondary:uu("Table.Cell.Secondary"),Selected:uu("Table.Cell.Selected"),Hover:uu("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:uu("Button.Danger.BackgroundColor"),Hover:uu("Button.Danger.Hover"),Primary:uu("Button.Danger.Primary"),Border:uu("Button.Danger.Border")}}};v.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return y`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?du.Button.Danger.Border:Ro.Primary};

                    color: ${e.$buttonIsDanger?du.Button.Danger.Primary:Ro.Primary};
                `;case"light":return y`
                    background-color: ${Ro.Neutral[8]};
                ...
                `;case"link":return y`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?du.Button.Danger.Hover:Ro.Secondary};
                    }
                `;default:return y`
                    background-color: ${e.$buttonIsDanger?du.Button.Danger.BackgroundColor:Ro.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?y`
                ...
                `}
`;const fu=v((({color:n,className:r,size:o=18})=>e(ru,Object.assign({className:r,$size:o,$color:n},{children:[t(iu,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(au,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(su,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(lu,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?du.Button.Danger.Primary:Ro.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Ro.Neutral[3](e);break;default:t=Ro.Neutral[8](e)}return y`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
