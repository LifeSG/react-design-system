...
`,Ds=({color:t,className:n,size:i})=>e(vs,Object.assign({className:n,$size:i,$color:t},{children:[r(ws,{id:"inner1"}),r(Fs,{id:"inner2"}),r($s,{id:"inner3"}),r(Es,{id:"inner4"})]})),Cs=p`
    outline-offset: -1px;
...
`,rl=g((({children:t,disabled:n,expanded:i,listboxId:o,popupRole:a,readOnly:s,variant:l},d)=>e(Qs,Object.assign({ref:d,type:"button","aria-expanded":i,"aria-haspopup":a,"data-testid":"selector",disabled:n,"aria-controls":o,$variant:l},{children:[t,!s&&r(el,Object.assign({$expanded:i,$variant:l},{children:r(C,{"aria-hidden":!0})}))]}))));m.button`
...
`,rd=m(A)`
    ...
    width: 1lh;
    color: ${so["icon-selected"]};
`,td=({listItems:t,multiSelect:n,selectedKeyPaths:i,itemsLoadState:s="success",itemTruncationType:l="end",itemMaxLines:d=2,variant:c="default",listboxId:h,width:b,mode:g="default",selectableCategory:m,onSelectItem:p,onSelectAll:y,onRetry:v,enableSearch:x,hideNoResultsDisplay:w,searchPlaceholder:F="Search",onSearch:$})=>{const E=n||m,[D,C]=a(""),O=D.toLowerCase().trim(),[A,z]=a(!1),S=o(),k=o(),B=o([]),j=o(),M=(()=>{const[e,r]=a(!1);return u((()=>{r(!0)}),[]),e})(),[T,I]=a([]),[P,Y]=a([]),L=f((()=>{let e=0;for(const r of T)r.level>e&&(e=r.level);return e}),[T]),[R,W]=a(0),N=e=>{const r=e.target.value;C(r),""===r?z(!1):r.trim().length>=3&&z(!0),null==$||$()},H=()=>{C(""),z(!1),j.current.focus(),null==$||$()},V=()=>{null==v||v()},U=()=>{if(0===i.length){const e=[],r=[];T.forEach((t=>{t.hasSubItems||(e.push(t.keyPath),r.push(t))})),null==y||y(e,r)}else null==y||y([],[])},Z=ys(((e,r)=>((e,r,t,n,i)=>{const o=[],a=(e,s)=>{var l,d;const c=[],u=!!e.find((e=>{var r;return null===(r=e.subItems)||void 0===r?void 0:r.length}));for(let h=0;h<e.length;h++){const b=e[h],f=s?s.level+1:0,g={item:b,index:o.length,indexInParent:h,parentSetSize:e.length,keyPath:s?[...s.keyPath,b.key]:[b.key],parentIndex:s?s.index:-1,parentKeyPath:s?s.keyPath:[],level:f,visible:0===f||i||s.expanded,expanded:i,checked:!1,hasSubItems:!!(null===(l=b.subItems)||void 0===l?void 0:l.length),subItemIndexes:[],hasNestedSiblings:u,matched:!!n&&-1!==b.label.toLowerCase().indexOf(n),hasMatchedSubItems:!1};if(g.checked=!!r.find((e=>Ka(e,g.keyPath))),c.push(g),o.push(g),null===(d=b.subItems)||void 0===d?void 0:d.length){const e=a(b.subItems,g);if(t&&!0!==g.checked){const r=e.every((e=>!0===e.checked)),t=e.some((e=>!1!==e.checked));r?g.checked=!0:t&&(g.checked="mixed")}g.hasMatchedSubItems=e.some((e=>e.matched||e.hasMatchedSubItems)),g.subItemIndexes=e.map((e=>e.index))}}return c};return a(e,void 0),o})(e,i,n,O,r))),q=ys((e=>{return i.length?(r=Z(e,!1),Ul(r,(e=>{const r=e.filter((e=>!0===e.checked));for(const t of r){let r=t.parentIndex;for(;r>=0;){const t=e[r];t.visible=!0,t.expanded=!0;for(const r of t.subItemIndexes)e[r].visible=!0;r=t.parentIndex}}}))):(e=>Ul(e,(e=>{const r=e.findIndex((e=>e.hasSubItems));if(r<0)return;let t=r,n=0;for(let r=t;r<e.length;r++){const i=e[r].keyPath.length;if(i>n)n=i;else if(i<n)break;t=r,e[r].visible=!0,e[r].expanded=!0}for(let r=0;r<e.length;r++){const n=e[r],i=n.keyPath.slice(0,-1),o=e[t].keyPath.slice(0,i.length);Ka(i,o)&&(n.visible=!0)}return e})))(Z(e,!1));var r})),K=ys((e=>{const r=e=>{const t=[];for(const n of e){if(-1!==n.label.toLowerCase().indexOf(O))t.push(n);else if(n.subItems){const e=r(n.subItems);if(e.length>0){t.push(Object.assign(Object.assign({},n),{subItems:e}));continue}}}return t};return r(e)})),J=ys((()=>{I((e=>Zl(e,i,n))),A&&Y((e=>Zl(e,i,n)))})),X=(e,r)=>{const t=((e,r,t)=>Ul(e,(e=>{e[r].expanded=t;const n=e[r].keyPath;for(let i=r+1;i<e.length;i++){const r=e[i],o=e[r.parentIndex],a=r.keyPath.slice(0,n.length);if(!Ka(n,a))break;r.visible=t&&o.expanded&&o.visible}})))(A?P:T,e,r);W(e),A?Y(t):I(t)};((e,r,t="window",n)=>{const i=o();u((()=>{i.current=r}),[r]),u((()=>{let r;switch(t){case"window":r=window;break;case"document":r=document;break;default:r=t}if(!r||!r.addEventListener)return;const o=e=>i.current(e);return r.addEventListener(e,o,n),()=>{r.removeEventListener(e,o,n)}}),[e,t])})("keydown",(e=>{const r=A?P:T;switch(e.code){case"ArrowDown":{e.preventDefault();const t=((e,r,t)=>{for(let n=t;n<e.length;n++)if(r(e[n]))return n;return-1})(r,(e=>e.visible),R+1);t>=0&&(W(t),B.current[t].focus());break}case"ArrowUp":{e.preventDefault();const t=((e,r,t)=>{for(let n=t;n>=0;n--)if(r(e[n]))return n;return-1})(r,(e=>e.visible),R-1);t>=0?(W(t),B.current[t].focus()):0===R&&j.current&&(j.current.focus(),W(-1));break}case"ArrowRight":e.preventDefault(),X(R,!0);break;case"ArrowLeft":e.preventDefault(),X(R,!1);break;case"Space":if(document.activeElement===B.current[R]){e.preventDefault();const t=r[R];if(t.hasSubItems&&!E)return;null==p||p(t)}}})),u((()=>{let e;"default"===g?e=q(t):"expand"===g?e=Z(t,!0):"collapse"===g&&(e=Z(t,!1)),I(e)}),[Z,q,t,g]),u((()=>{J()}),[n,i,J]),u((()=>{if(A&&D.trim().length>=3){const e=K(t),r=(e=>Ul(e,(e=>{for(const r of e)if(r.matched&&(r.visible=!0),r.hasMatchedSubItems){r.visible=!0,r.expanded=!0;for(const t of r.subItemIndexes)e[t].visible=!0}})))(Z(e,!1));Y(r)}}),[K,Z,t,A,D]),u((()=>{M||(j.current?(W(-1),setTimeout((()=>{var e;return null===(e=j.current)||void 0===e?void 0:e.focus()}),200)):B.current[R]?setTimeout((()=>{var e;return null===(e=B.current[R])||void 0===e?void 0:e.focus()}),200):(W(0),setTimeout((()=>{var e;return null===(e=B.current[0])||void 0===e?void 0:e.focus()}),200)))}),[R,M,W]);const G=()=>{if(x&&"success"===s)return r(Gs,{ref:j,onChange:N,value:D,placeholder:F,"data-testid":"search-input","aria-label":"Enter text to search",onClear:H,variant:c})},Q=()=>{if(n&&!A&&T.length>0&&"success"===s)return r(Ps,{children:r(Rs,Object.assign({onClick:U,type:"button",$variant:c},{children:0===i.length?"Select all":"Clear all"}))})},ee=()=>{if(!w&&A&&0===P.length&&"success"===s)return e(Ws,Object.assign({"data-testid":"list-no-results"},{children:[r(Ns,{"data-testid":"no-result-icon"}),"No results found."]}))},re=()=>{if(v&&"loading"===s)return e(Ws,Object.assign({"data-testid":"list-loading"},{children:[r(tl,{}),"Loading..."]}))},te=()=>{if(v&&"fail"===s)return e(Ws,Object.assign({"data-testid":"list-fail"},{children:[r(Ns,{"data-testid":"load-error-icon"}),"Failed to load. ",r(Ls,Object.assign({onClick:V,type:"button",$variant:c},{children:"Try again."}))]}))},ne=e=>{if(n)switch(e.checked){case"mixed":return r(rd,{"aria-hidden":!0});case!0:return r(Ts,{"aria-hidden":!0});default:return r(Is,{"aria-hidden":!0})}if(!e.hasSubItems)return r(ed,Object.assign({$hasNestedSiblings:e.hasNestedSiblings||0===e.level},{children:e.checked&&r(Ms,{"aria-hidden":!0})}))},ie=()=>(A?P:T).map(((t,i)=>{const{item:o,level:a,visible:s,expanded:c,keyPath:u,checked:h,hasSubItems:b,indexInParent:f,parentSetSize:g}=t,m=R===i,y=b&&!E;return e(Kl,Object.assign({$visible:s},{children:[L>0&&r(Xl,{$level:a}),L>0&&!b&&n&&r(Ql,{}),e(Jl,Object.assign({"aria-checked":h,"aria-selected":!!h,"aria-expanded":b?c:void 0,"aria-level":a+1,"aria-posinset":f+1,"aria-setsize":g,"data-testid":"list-item",onClick:e=>{var r;e.stopPropagation(),y?X(i,!c):(W(r=i),null==p||p((A?P:T)[r]))},onMouseEnter:()=>{W(i)},ref:e=>B.current[i]=e,role:"treeitem",tabIndex:m?0:-1,$active:m,$toggleable:y},{children:[b&&r(Gl,Object.assign({"data-testid":"toggle-category-button",onClick:e=>{e.stopPropagation(),X(i,!c)},$expanded:c},{children:r(_,{})})),ne(t),r(Eo,{bold:b,searchTerm:A?O:void 0,label:o.label,selected:!!h,truncationType:l,maxLines:d})]}))]}),`[${u.join("---")}]`)}));return r(Bs,Object.assign({"data-testid":"dropdown-container",ref:S,$width:b,$variant:c},{children:e(js,Object.assign({"data-testid":"nested-dropdown-list"},{children:[G(),Q(),ee(),re(),te(),r("div",Object.assign({"aria-multiselectable":n,id:h,ref:k,role:"tree"},{children:ie()}))]}))}))},nd=e=>"small"===e?2.5:3;m.div`
    position: relative;
    width: 100%;
...
`;var cd;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(cd||(cd={}));const ud=m.div`
    display: flex;
    flex-direction: column;
`,hd=e=>"right"===e?"bottom-end":"bottom-start",bd=({enabled:n,isOpen:i,onOpen:s,onClose:l,onDismiss:d,renderElement:c,renderDropdown:h,customZIndex:b,clickToToggle:f=!1,offset:g=0,alignment:m="left",fitAvailableHeight:p})=>{var v;const x=y(),w=fo["sm-max"]({theme:x}),F=o(null),$=o(null),{width:E}=Lt({targetRef:F,handleHeight:!1}),D={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<w;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:C,floatingStyles:_,context:O}=S({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==d||d():e&&!i?null==s||s():!e&&i&&(null==l||l(t))},whileElementsMounted:k,placement:hd(m),middleware:[B(g),j(),M({limiter:T()}),I({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:p?`${e}px`:void 0,overflowY:p?"hidden":void 0})}}),D]}),A=(()=>{const[e,r]=a(void 0),t=z();return u((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(cd.Change,e),t.events.emit(cd.Ready),()=>t.events.off(cd.Change,e)}),[t]),e})(),{isMounted:H,styles:V}=P(O,{initial:{opacity:0},open:{opacity:1},duration:300}),U=Y(O,{enabled:n,toggle:f}),Z=L(O,{enabled:n}),{getReferenceProps:q,getFloatingProps:K}=R([U,Z]);return e(t,{children:[r("div",Object.assign({ref:e=>{F.current=e,C.setReference(e)}},q(),{children:c()})),H&&r(W,{children:r(N,Object.assign({context:O,modal:!1,initialFocus:$,returnFocus:!1},{children:r("div",Object.assign({ref:C.setFloating,style:Object.assign(Object.assign({},_),{zIndex:null!==(v=null!=b?b:A)&&void 0!==v?v:50})},K(),{children:r(ud,Object.assign({ref:$,style:Object.assign({},V),inert:V.opacity<1?"":void 0},{children:h({elementWidth:E})}))}))}))})]})},fd=({placeholder:e="Select",options:t,disabled:n,error:i,className:s,"data-testid":l,id:d,selectedKeyPath:c,mode:h,valueToStringFunction:b,enableSearch:f,searchPlaceholder:g,selectableCategory:m,hideNoResultsDisplay:p,readOnly:y,onBlur:v,onSearch:x,onSelectOption:w,onShowOptions:F,onHideOptions:$,onRetry:E,optionsLoadState:D="success",optionTruncationType:C="end",variant:_,alignment:O,dropdownZIndex:A})=>{const z=t,[S,k]=a(c?[c]:[]),[B,j]=a(),[M,T]=a(!1),[I,P]=a(!1),[Y]=a((()=>ps.generate())),L=o(),R=o(),W=o();u((()=>{k(c?[c]:[]);const e=ql(z,c||[]);j(null!=e?e:void 0)}),[c,z]);const N=e=>{var r;const{keyPath:t,item:{label:n,value:i}}=e;k([t]),j({label:n,value:i}),T(!1),q(!1),null===(r=R.current)||void 0===r||r.focus(),null==w||w(t,i)},H=()=>{I||M||P(!0)},V=e=>{!I||M||L.current.contains(e.relatedTarget)||(P(!1),null==v||v())},U=()=>{const{label:e,value:r}=B;return b?b(r)||r.toString():e},Z=e=>{if("middle"===C){let r=0;return W&&W.current&&(r=W.current.getBoundingClientRect().width),mo.truncateOneLine(e,r,120,6)}return e},q=e=>{!e&&$&&$(),e&&F&&F()};return r(bd,{enabled:!y&&!n,isOpen:M,renderElement:()=>r(zs,Object.assign({className:s,"data-testid":l,id:d,ref:L,tabIndex:-1,onFocus:H,onBlur:V,$focused:I,$disabled:n,$readOnly:y,$error:i},{children:r(rl,Object.assign({ref:R,disabled:n,expanded:M,listboxId:Y,popupRole:"tree",readOnly:y,variant:_},{children:r(sd,Object.assign({ref:W,$disabled:n},{children:Vr(B)?r(dd,Object.assign({truncateType:C},{children:e})):r(ld,Object.assign({truncateType:C},{children:Z(U())}))}))}))})),renderDropdown:({elementWidth:e})=>r(td,{listboxId:Y,listItems:z,selectedKeyPaths:S,selectableCategory:m,itemsLoadState:D,itemTruncationType:C,enableSearch:f,searchPlaceholder:g,hideNoResultsDisplay:p,onSelectItem:N,onRetry:E,onSearch:x,variant:_,mode:h,width:e}),onOpen:()=>{T(!0),q(!0),P(!0)},onClose:e=>{T(!1),q(!1),"click"!==e&&(P(!1),null==v||v())},onDismiss:()=>{R.current.focus(),T(!1),q(!1)},clickToToggle:!0,offset:8,alignment:O,fitAvailableHeight:!0,customZIndex:A})};export{fd as InputNestedSelect};
