...
`,Zs=n=>{var{external:r=!1,children:i}=n,o=k(n,["external","children"]);return e(qs,Object.assign({},o,{children:[i,r&&t(Qs,{})]}))};var Ks;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ks||(Ks={}));const Gs={collections:{base:{InputBoxShadow:m`
    ...
    `,ElevationBoxShadow:m`
      0px 2px 8px ${Ds.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Xs=e=>t=>{var n;const r=t.theme,i=Ss(Gs,r[$s.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?_s(i,e,r.options.designToken):_s(i,e)},Js={InputBoxShadow:Xs("InputBoxShadow"),InputErrorBoxShadow:Xs("InputErrorBoxShadow"),ElevationBoxShadow:Xs("ElevationBoxShadow"),Table:{Header:Xs("Table.Header"),Cell:{Primary:Xs("Table.Cell.Primary"),Secondary:Xs("Table.Cell.Secondary"),Selected:Xs("Table.Cell.Selected"),Hover:Xs("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Xs("Button.Danger.BackgroundColor"),Hover:Xs("Button.Danger.Hover"),Primary:Xs("Button.Danger.Primary"),Border:Xs("Button.Danger.Border")}}};f.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const ec=f((({color:n,className:r,size:i=18})=>e(Ps,Object.assign({className:r,$size:i,$color:n},{children:[t(Ms,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(Es,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(Is,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(Cs,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
...
`,Oc=i.forwardRef(((e,n)=>{var{"data-testid":r,styleType:i="primary",children:o,sizeType:a="default",type:s="button"}=e,c=k(e,["data-testid","styleType","children","sizeType","type"]);return t(Bc,Object.assign({"data-testid":r||"iconButton",ref:n,type:s,$sizeType:a,$styleType:i},c,{children:o}))})),Pc=f.div`
    display: flex;
    cursor: pointer;
    padding: 0.5rem;
    min-height: 2.625rem;
...
`,qc=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=k(e,["children","focusHighlight","focusOutline","type"]);return t(Uc,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))}));f.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${Ds.Neutral[5]};
...
`,$l=f(Sl)`
    color: ${Ds.Neutral[3]};
`,xl=({children:e,show:n,error:r,disabled:i,testId:o,onBlur:s,readOnly:c,className:l})=>{const u=a();return tc("mousedown",(function(e){if(!i){if(u&&u.current.contains(e.target))return;n&&s()}}),"document"),t(pl,Object.assign({className:l},{children:t(yl,Object.assign({ref:u,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":o},{children:e}))}))},Fl=r=>{var{placeholder:i="Select",options:c,disabled:l,error:u,className:d,"data-testid":h,id:p,selectedKeyPath:f,mode:g,valueToStringFunction:m,enableSearch:y,searchPlaceholder:b,selectableCategory:v,hideNoResultsDisplay:w,listStyleWidth:_,readOnly:S,onSearch:$,onSelectOption:x,onShowOptions:F,onHideOptions:D,onRetry:B,optionsLoadState:O="success",optionTruncationType:P="end"}=r,A=k(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPath","mode","valueToStringFunction","enableSearch","searchPlaceholder","selectableCategory","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOption","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[M,E]=o(f?[f]:[]),[I,C]=o(),[j,z]=o(!1),T=a(),H=a();s((()=>{E(f?[f]:[]),V(c,f||[])}),[f,c]);const N=e=>{const{keyPath:t,value:n,label:r}=e;E([t]),C({label:r,value:n}),z(!1),Y(!1),T.current&&T.current.focus(),x&&x(t,n)},R=e=>{j&&(z(!1),Y(!1)),e&&T.current&&T.current.focus()},L=()=>{const{label:e,value:t}=I;return m?m(t)||t.toString():e},V=(e,t)=>{const n=(e,t)=>{const[r,...i]=t;if(kt(e)||!r)return;const o=e.find((e=>e.key===r));return o&&i.length?n(o.subItems,i):o},r=n(e,t);if(r){const{label:e,value:t}=r;C({label:e,value:t})}else C(void 0)},W=e=>{if("middle"===P){let t=0;return H&&H.current&&(t=H.current.getBoundingClientRect().width),xc.truncateOneLine(e,t,120,6)}return e},Y=e=>{!e&&D&&D(),e&&F&&F()};return e(xl,Object.assign({className:d,show:j,error:u&&!j,disabled:l,readOnly:S,testId:h,onBlur:()=>{z(!1),Y(!1)}},{children:[t(gl,Object.assign({ref:T,type:"button","data-testid":p||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||S||(z(!j),Y(!j))}},A,{children:e(n,{children:[t(_l,Object.assign({ref:H},{children:kt(I)?t($l,Object.assign({truncateType:P},{children:i})):t(Sl,Object.assign({truncateType:P},{children:W(L())}))})),!S&&t(bl,Object.assign({expanded:j},{children:t(vl,{})}))]})})),j&&t(wl,{}),c&&c.length>0||B?t(dl,{"data-testid":"nested-dropdown-list",listItems:c,listStyleWidth:_,visible:j,mode:g,selectedKeyPaths:M,selectableCategory:v,itemsLoadState:O,itemTruncationType:P,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:w,onDismiss:R,onSelectItem:N,onSearch:$,onRetry:B}):null]}))};export{Fl as InputNestedSelect};
