...
`,Zs=n=>{var{external:r=!1,children:i}=n,o=D(n,["external","children"]);return e(qs,Object.assign({},o,{children:[i,r&&t(Qs,{})]}))};var Ks;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ks||(Ks={}));const Gs={collections:{base:{InputBoxShadow:m`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const ec=f((({color:n,className:r,size:i=18})=>e(Ps,Object.assign({className:r,$size:i,$color:n},{children:[t(As,{id:"inner1",$size:i-2,$borderWidth:2}),t(Is,{id:"inner2",$size:i-2,$borderWidth:2}),t(Es,{id:"inner3",$size:i-2,$borderWidth:2}),t(Cs,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
