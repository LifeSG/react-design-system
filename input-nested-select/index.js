...
`,Gs=n=>{var{external:r=!1,children:i}=n,a=B(n,["external","children"]);return e(Zs,Object.assign({},a,{children:[i,r&&t(Ks,{})]}))};var Xs;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Xs||(Xs={}));const el={collections:{base:{InputBoxShadow:m`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const rl=p((({color:n,className:r,size:i=18})=>e(Ps,Object.assign({className:r,$size:i,$color:n},{children:[t(Es,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(Is,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(Cs,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(Ms,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
