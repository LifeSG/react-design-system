...
`,Pl=f(Dl)`
    color: ${Ms.Neutral[3]};
`,Bl=({children:e,show:n,error:r,disabled:i,testId:o,onBlur:a,readOnly:s,className:l})=>{const u=c();return rc("mousedown",(function(e){if(!i){if(u&&u.current.contains(e.target))return;n&&a()}}),"document"),t(vl,Object.assign({className:l},{children:t($l,Object.assign({ref:u,error:r&&!n,disabled:i,$readOnly:s,expanded:n,"data-testid":o},{children:e}))}))},Ml=r=>{var{placeholder:i="Select",options:a,disabled:l,error:u,className:d,"data-testid":h,id:p,selectedKeyPath:f,mode:m,valueToStringFunction:g,enableSearch:y,searchPlaceholder:b,selectableCategory:v,hideNoResultsDisplay:w,listStyleWidth:_,readOnly:S,onSearch:$,onSelectOption:x,onShowOptions:k,onHideOptions:F,onRetry:D,optionsLoadState:P="success",optionTruncationType:B="end"}=r,M=O(r,["placeholder","options","disabled","error","className","data-testid","id","selectedKeyPath","mode","valueToStringFunction","enableSearch","searchPlaceholder","selectableCategory","hideNoResultsDisplay","listStyleWidth","readOnly","onSearch","onSelectOption","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType"]);const[j,A]=s(f?[f]:[]),[I,z]=s(),[C,E]=s(!1),T=c(),N=c();o((()=>{A(f?[f]:[]),V(a,f||[])}),[f,a]);const H=e=>{const{keyPath:t,value:n,label:r}=e;A([t]),z({label:r,value:n}),E(!1),Y(!1),T.current&&T.current.focus(),x&&x(t,n)},R=e=>{C&&(E(!1),Y(!1)),e&&T.current&&T.current.focus()},L=()=>{const{label:e,value:t}=I;return g?g(t)||t.toString():e},V=(e,t)=>{const n=(e,t)=>{const[r,...i]=t;if(kt(e)||!r)return;const o=e.find((e=>e.key===r));return o&&i.length?n(o.subItems,i):o},r=n(e,t);if(r){const{label:e,value:t}=r;z({label:e,value:t})}else z(void 0)},W=e=>{if("middle"===B){let t=0;return N&&N.current&&(t=N.current.getBoundingClientRect().width),Fc.truncateOneLine(e,t,120,6)}return e},Y=e=>{!e&&F&&F(),e&&k&&k()};return e(Bl,Object.assign({className:d,show:C,error:u&&!C,disabled:l,readOnly:S,testId:h,onBlur:()=>{E(!1),Y(!1)}},{children:[t(_l,Object.assign({ref:T,type:"button","data-testid":p||"selector",disabled:l,onClick:e=>{e.preventDefault(),l||S||(E(!C),Y(!C))}},M,{children:e(n,{children:[t(Ol,Object.assign({ref:N},{children:kt(I)?t(Pl,Object.assign({truncateType:B},{children:i})):t(Dl,Object.assign({truncateType:B},{children:W(L())}))})),!S&&t(xl,Object.assign({expanded:C},{children:t(kl,{})}))]})})),C&&t(Fl,{}),a&&a.length>0||D?t(yl,{"data-testid":"nested-dropdown-list",listItems:a,listStyleWidth:_,visible:C,mode:m,selectedKeyPaths:j,selectableCategory:v,itemsLoadState:P,itemTruncationType:B,enableSearch:y,searchPlaceholder:b,hideNoResultsDisplay:w,onDismiss:R,onSelectItem:H,onSearch:$,onRetry:D}):null]}))};export{Ml as InputNestedSelect};
