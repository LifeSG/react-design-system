...
`,ru=a.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=O(e,["children","focusHighlight","focusOutline","type"]);return t(tu,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))}));f.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${oc.Neutral[5]};
...
`,Ou=f.div`
    ...
    ${e=>{if(e.$wrap)return m`
                display: none;
            `}}
`,Du=({children:r,currentActive:n,error:a,className:i,wrap:o})=>{const[s,l]=r;return e(Su,Object.assign({className:i,$wrap:o},{children:[t(Bu,Object.assign({"data-id":"range-container-elem1-container"},{children:s})),t(ku,{}),o&&t(_u,{}),t(Bu,Object.assign({"data-id":"range-container-elem2-container"},{children:l})),t(Ou,{"data-id":"range-container-indicator",$position:n,$error:a,$wrap:o})]}))};f.input`
    ${Sc("Body","regular")}
    color: ${oc.Neutral[1]};
