...
`,Vu=g.div`
    ...
    ${e=>{if(e.$minWidthBeforeWrap)return y`
            ...
            `}}
`,Ru=({children:e,currentActive:r,error:i,className:o,minWidthBeforeWrap:a})=>{const[s,l]=e;return t(Mu,{className:o,$minWidthBeforeWrap:a,children:[n(Tu,{"data-id":"range-container-elem1-container",children:s}),n(Lu,{}),n(Tu,{"data-id":"range-container-elem2-container",children:l}),n(Vu,{"data-id":"range-container-indicator",$position:r,$error:i,$minWidthBeforeWrap:a})]})},Wu=({selectedOptions:e,placeholders:r={from:"Select",to:"Select"},options:i,disabled:o,className:s,readOnly:u,error:d,"data-testid":h,id:p,enableSearch:f=!1,searchFunction:g,searchPlaceholder:m,valueExtractor:y,valueToStringFunction:v,listExtractor:b,displayValueExtractor:w,onSelectOption:_,listStyleWidth:x,onShowOptions:S,onHideOptions:$,onRetry:C,optionsLoadState:F={from:"success",to:"success"},optionTruncationType:k="middle",renderCustomSelectedOption:B,renderListItem:j,renderCustomCallToAction:O,...A})=>{const[E,I]=l(),[D,P]=l(),z=c(),H={from:c(),to:c()},[N,M]=l("none");a((()=>{I(e?.from),P(e?.to)}),[e]);const T=e=>t=>{t.stopPropagation(),t.preventDefault(),o||u||M("from"===e?"from":"to"===e&&E?"to":"from")},L=e=>{const t="from"===e?E:D;return w?w(t):y?y(t):t?.toString()},V=(e,t)=>{if("middle"===k){let n=0;return H[e]&&H[e].current&&(n=H[e].current.getBoundingClientRect().width),Bc.truncateOneLine((e=>"string"==typeof e?e:v(e)||e.toString())(t),n,120,8)}return t},R=e=>{!e&&$&&$(),e&&S&&S()},W=e=>{const t="from"===e?E:D;return t?B?B(t):n(Du,{truncateType:k,children:V(e,L(e))}):n(Pu,{truncateType:k,children:V(e,r[e])})},q=e=>n(Iu,{onClick:T(e),ref:H[e],children:W(e)});return t(zu,{show:"none"!==N,"data-testid":A["data-testid"],error:d&&!("none"!==N),disabled:o,readOnly:u,testId:h,onBlur:()=>{R(!1),M("none"),E&&D||(P(void 0),I(void 0))},className:s,children:[n(ju,{type:"button","data-testid":p||"selector",disabled:o,ref:z,onClick:T(),...A,children:t(Ru,{currentActive:(()=>{switch(N){case"from":return"start";case"to":return"end";case"none":return N}})(),children:[q("from"),q("to")]})}),"none"!==N&&n(Eu,{}),(()=>{if("none"===N)return null;const e=i[N];if(e&&e.length>0){const t="from"===N?E:D;return n(xu,{listItems:e,onSelectItem:(e,t)=>{return n=e,r=t,"from"===(i=N)?I(n):P(n),R(!1),z&&z.current.focus(),_&&_({[i]:n},r),void("from"===i?(P(void 0),M("to"),R(!0)):M("none"));var n,r,i},onDismiss:()=>(M("none"),R(!1),z&&z.current.focus(),void(E&&D||(P(void 0),I(void 0)))),valueExtractor:y,listExtractor:b,listStyleWidth:x,visible:!0,enableSearch:f,searchPlaceholder:m,searchFunction:g,"data-testid":`${N}-dropdown-list`,selectedItems:t?[t]:[],onRetry:C,itemsLoadState:F[N],itemTruncationType:k,renderListItem:j,renderCustomCallToAction:O})}return null})()]})};export{Wu as InputRangeSelect};
