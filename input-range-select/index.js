...
`,vc={Regular:"Open Sans",Semibold:"Open Sans Semibold",Bold:"Open Sans Bold",Light:"Open Sans Light"},wc={collections:{base:{D1:{fontFamily:vc.Bold,fontSize:3,fontWeight:700,lineHeight:4,letterSpacing:-.056},D2:{fontFamily:vc.Bold,fontSize:2.5,fontWeight:700,lineHeight:3.5,letterSpacing:-.032},D3:{fontFamily:vc.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},D4:{fontFamily:vc.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},DBody:{fontFamily:vc.Regular,fontSize:1.375,lineHeight:1.75},H1:{fontFamily:vc.Bold,fontSize:2,fontWeight:700,lineHeight:2.5},H2:{fontFamily:vc.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},H3:{fontFamily:vc.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},H4:{fontFamily:vc.Bold,fontSize:1.125,fontWeight:700,lineHeight:1.625},H5:{fontFamily:vc.Bold,fontSize:1,fontWeight:700,lineHeight:1.5,letterSpacing:.014},H6:{fontFamily:vc.Bold,fontSize:.875,fontWeight:700,lineHeight:1.6,letterSpacing:.012},Body:{fontFamily:vc.Regular,fontSize:1.125,lineHeight:1.625},BodySmall:{fontFamily:vc.Regular,fontSize:1,lineHeight:1.5,letterSpacing:.014},XSmall:{fontFamily:vc.Regular,fontSize:.75,lineHeight:1.2,letterSpacing:.012}}},defaultValue:"base"},xc=e=>t=>{const n=t.theme,r=oc(wc,n[ac.textStyleScheme]);return n.options&&n.options.textStyle?ic(r,e,n.options.textStyle):ic(r,e)},$c={D1:{fontFamily:xc("D1.fontFamily"),fontSize:xc("D1.fontSize"),fontWeight:xc("D1.fontWeight"),lineHeight:xc("D1.lineHeight"),letterSpacing:xc("D1.letterSpacing")},D2:{fontFamily:xc("D2.fontFamily"),fontSize:xc("D2.fontSize"),fontWeight:xc("D2.fontWeight"),lineHeight:xc("D2.lineHeight"),letterSpacing:xc("D2.letterSpacing")},D3:{fontFamily:xc("D3.fontFamily"),fontSize:xc("D3.fontSize"),fontWeight:xc("D3.fontWeight"),lineHeight:xc("D3.lineHeight"),letterSpacing:xc("D3.letterSpacing")},D4:{fontFamily:xc("D4.fontFamily"),fontSize:xc("D4.fontSize"),fontWeight:xc("D4.fontWeight"),lineHeight:xc("D4.lineHeight"),letterSpacing:xc("D4.letterSpacing")},DBody:{fontFamily:xc("DBody.fontFamily"),fontSize:xc("DBody.fontSize"),fontWeight:xc("DBody.fontWeight"),lineHeight:xc("DBody.lineHeight"),letterSpacing:xc("DBody.letterSpacing")},H1:{fontFamily:xc("H1.fontFamily"),fontSize:xc("H1.fontSize"),fontWeight:xc("H1.fontWeight"),lineHeight:xc("H1.lineHeight"),letterSpacing:xc("H1.letterSpacing")},H2:{fontFamily:xc("H2.fontFamily"),fontSize:xc("H2.fontSize"),fontWeight:xc("H2.fontWeight"),lineHeight:xc("H2.lineHeight"),letterSpacing:xc("H2.letterSpacing")},H3:{fontFamily:xc("H3.fontFamily"),fontSize:xc("H3.fontSize"),fontWeight:xc("H3.fontWeight"),lineHeight:xc("H3.lineHeight"),letterSpacing:xc("H3.letterSpacing")},H4:{fontFamily:xc("H4.fontFamily"),fontSize:xc("H4.fontSize"),fontWeight:xc("H4.fontWeight"),lineHeight:xc("H4.lineHeight"),letterSpacing:xc("H4.letterSpacing")},H5:{fontFamily:xc("H5.fontFamily"),fontSize:xc("H5.fontSize"),fontWeight:xc("H5.fontWeight"),lineHeight:xc("H5.lineHeight"),letterSpacing:xc("H5.letterSpacing")},H6:{fontFamily:xc("H6.fontFamily"),fontSize:xc("H6.fontSize"),fontWeight:xc("H6.fontWeight"),lineHeight:xc("H6.lineHeight"),letterSpacing:xc("H6.letterSpacing")},Body:{fontFamily:xc("Body.fontFamily"),fontSize:xc("Body.fontSize"),fontWeight:xc("Body.fontWeight"),lineHeight:xc("Body.lineHeight"),letterSpacing:xc("Body.letterSpacing")},BodySmall:{fontFamily:xc("BodySmall.fontFamily"),fontSize:xc("BodySmall.fontSize"),fontWeight:xc("BodySmall.fontWeight"),lineHeight:xc("BodySmall.lineHeight"),letterSpacing:xc("BodySmall.letterSpacing")},XSmall:{fontFamily:xc("XSmall.fontFamily"),fontSize:xc("XSmall.fontSize"),fontWeight:xc("XSmall.fontWeight"),lineHeight:xc("XSmall.lineHeight"),letterSpacing:xc("XSmall.letterSpacing")}},Sc=e=>{switch(e){case 700:case"bold":return vc.Bold;case 600:case"semibold":return vc.Semibold;case 300:case"light":return vc.Light;case 400:case"regular":return vc.Regular;default:return""}},_c=(e,t)=>n=>{var r;const i=$c[e].fontFamily(n),o=$c[e].fontWeight(n);return Object.values(vc).includes(i)?m`
        ...
        `:m`
            display: block;
            ${kc(n)}
        `;var jc;!function(e){e.D1=f.h1`
        ${e=>m`
                ${Oc("D1",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D2=f.h1`
        ${e=>m`
                ${Oc("D2",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D3=f.h1`
        ${e=>m`
                ${Oc("D3",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D4=f.h1`
        ${e=>m`
                ${Oc("D4",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.DBody=f.h1`
        ${e=>m`
                ${Oc("DBody",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H1=f.h1`
        ${e=>m`
                ${Oc("H1",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H2=f.h2`
        ${e=>m`
                ${Oc("H2",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H3=f.h3`
        ${e=>m`
                ${Oc("H3",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H4=f.h4`
        ${e=>m`
                ${Oc("H4",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H5=f.h5`
        ${e=>m`
                ${Oc("H5",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H6=f.h6`
        ${e=>m`
                ${Oc("H6",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.Body=f.p`
        ${e=>m`
                ${Oc("Body",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.BodySmall=f.p`
        ${e=>m`
                ${Oc("BodySmall",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.XSmall=f.span`
        ${e=>m`
                ${Oc("XSmall",e.weight,e.paragraph)}
                color: ${cc.Neutral[1]};
                ${Bc(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.Hyperlink={Default:e=>Dc(Object.assign(Object.assign({},e),{textStyle:"Body"})),Small:e=>Dc(Object.assign(Object.assign({},e),{textStyle:"BodySmall"}))}}(jc||(jc={}));const Ac=f.a`
    ${e=>m`
            ${Oc(e.textStyle,e.weight)}
            color: ${cc.Primary};
...
`,Dc=n=>{var{external:r=!1,children:i}=n,o=O(n,["external","children"]);return e(Ac,Object.assign({},o,{children:[i,r&&t(Ec,{})]}))};var Cc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Cc||(Cc={})),f.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
...
`,nu=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=O(e,["children","focusHighlight","focusOutline","type"]);return t(tu,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),ru={collections:{base:{InputBoxShadow:m`
    ...
    `,ElevationBoxShadow:m`
      0px 2px 8px ${cc.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},iu=e=>t=>{var n;const r=t.theme,i=oc(ru,r[ac.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?ic(i,e,r.options.designToken):ic(i,e)},ou=iu("InputBoxShadow"),au=iu("InputErrorBoxShadow");iu("ElevationBoxShadow"),iu("Table.Header"),iu("Table.Cell.Primary"),iu("Table.Cell.Secondary"),iu("Table.Cell.Selected"),iu("Table.Cell.Hover");f.div`
    display: flex;
    align-items: center;
    position: relative;
...
`,hu=f(_)`
    ...
    width: 1.375rem;
    color: ${cc.Neutral[3]};
`,pu=c(((n,r)=>{const{onClear:i}=n,o=O(n,["onClear"]);return e(lu,{children:[t(uu,{}),t(cu,Object.assign({ref:r},o)),o.value&&t(du,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:i},{children:t(hu,{})}))]},"search")})),fu=r=>{var{listItems:i,listExtractor:a,valueExtractor:c,onSelectItem:u,listStyleWidth:d,visible:h,enableSearch:p,searchPlaceholder:f="Search",onSearch:g,searchFunction:m,onDismiss:y,disableItemFocus:b,multiSelect:v,selectedItems:w,onSelectAll:x,onRetry:$,itemsLoadState:S="success",itemTruncationType:_="end",itemMaxLines:F=2,labelDisplayType:k="inline",renderListItem:B,onBlur:j,hideNoResultsDisplay:A,renderCustomCallToAction:E}=r,D=O(r,["listItems","listExtractor","valueExtractor","onSelectItem","listStyleWidth","visible","enableSearch","searchPlaceholder","onSearch","searchFunction","onDismiss","disableItemFocus","multiSelect","selectedItems","onSelectAll","onRetry","itemsLoadState","itemTruncationType","itemMaxLines","labelDisplayType","renderListItem","onBlur","hideNoResultsDisplay","renderCustomCallToAction"]);const[C,P]=s(0),[I,z]=s(""),[T,H]=s(i),[N,L]=s(0),M=Pl({height:N}),V=l(),R=l(),W=l([]),q=l(),U=l(),Q=l(C),G=l(T),X=e=>{Q.current=e,P(e)},Z=e=>{G.current=e,H(e)};o((()=>(document.addEventListener("keydown",ne),()=>{document.removeEventListener("keydown",ne)})),[]),o((()=>{ee(I)}),[I]),o((()=>{if(z(""),h){if(setTimeout((()=>{L(te())})),b)return;q&&q.current?(q.current.focus(),X(-1)):W.current[C]&&W.current[C].focus()}else L(0)}),[h]),o((()=>{if(h){const e=te();L(e)}}),[T,S]),o((()=>{Z(i),z(""),X(0)}),[i]);const K=e=>a?a(e):e.toString(),Y=e=>{if("inline"!==k)return!1;let t=0;R&&R.current&&(t=R.current.getBoundingClientRect().width-60);return Ic.getTextWidth(e,"1.125rem 'Open Sans'")>t*F},J=e=>!!go(w,(t=>yo(t,e))),ee=e=>{if(""===e)Z(i);else if(m){const t=m(e);Z(t)}else{const t=i.filter((t=>{var n;const r=K(t),i="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),o="string"==typeof r||null===(n=r.secondaryLabel)||void 0===n?void 0:n.toLowerCase(),a=e.trim().toLowerCase();return i.includes(a)||o&&o.includes(a)}));Z(t)}},te=()=>(R&&R.current?R.current.getBoundingClientRect().height:0)+(U.current?U.current.getBoundingClientRect().height:0),ne=e=>{if(V&&V.current.contains(e.target))switch(e.code){case"ArrowDown":if(Q.current<G.current.length-1){const e=Q.current+1;W.current[e].focus(),X(e)}break;case"ArrowUp":if(Q.current>0){const e=Q.current-1;W.current[e].focus(),X(Q.current-1)}break;case"Escape":y&&y(!0)}},re=(e,t)=>{e.preventDefault(),u&&u(t,(e=>c?c(e):e)(t))},ie=e=>{const t=e.target.value;z(t),g&&g()},oe=()=>{z(""),q.current.focus(),g&&g()},ae=()=>{$&&$()},se=()=>{j&&j()},le=r=>e(n,{children:[t(Qc,Object.assign({$maxLines:F,"aria-hidden":!0},{children:r})),t(Gc,Object.assign({$maxLines:F,"aria-hidden":!0},{children:r}))]}),ce=n=>{const r=K(n),i="string"==typeof r?r:r.title,o="string"==typeof r?void 0:r.secondaryLabel,a=Y(i),s=o&&Y(o),l=a||s?"next-line":k;return e(Uc,Object.assign({$labelDisplayType:l},{children:[t(Wc,Object.assign({$truncateType:_,$maxLines:F,"aria-label":i},{children:"middle"===_&&a?le(i):i})),o&&t(qc,Object.assign({$truncateType:_,$maxLines:F,$labelDisplayType:k,"aria-label":o},{children:"middle"===_&&s?le(o):o}))]}))},ue=()=>{if(!$||$&&"success"===S)return T.map(((n,r)=>t(Mc,Object.assign({$checked:J(n)&&!v},{children:e(Vc,Object.assign({$hasNextLineLabel:"next-line"===k&&T.length>0&&a&&"string"!=typeof a(T[0]),onClick:e=>{re(e,n)},ref:e=>W.current[r]=e,"data-testid":"list-item",type:"button",tabIndex:h?0:-1,$multiSelect:v,onBlur:se},{children:[v&&t(Xc,{checked:J(n),displaySize:"small"}),B?B(n,{selected:J(n)}):ce(n)]}))}),((e,t)=>`item_${t}__${c?c(e):e}`)(n,r))))},de=()=>{if(v&&T.length>0&&!I&&"success"===S)return t(Zc,{children:t(Kc,Object.assign({onClick:x,type:"button"},{children:0===w.length?"Select all":"Clear all"}))},"selectAll")},he=()=>{if(!A&&(I||!p)&&0===T.length&&"success"===S)return e(Yc,Object.assign({"data-testid":"list-no-results"},{children:[t(eu,{"data-testid":"no-result-icon"}),t(Jc,{children:"No results found."})]}),"noResults")},pe=()=>{if($&&"loading"===S)return e(Yc,Object.assign({"data-testid":"list-loading"},{children:[t(Pc,{$buttonStyle:"secondary",size:24}),t(Jc,{children:"Loading..."})]}),"loading")},fe=()=>{if($&&"fail"===S)return e(Yc,Object.assign({"data-testid":"list-fail"},{children:[t(eu,{"data-testid":"load-error-icon"}),t(Jc,{children:"Failed to load."}),t(Kc,Object.assign({onClick:ae,type:"button"},{children:"Try again."}))]}),"noResults")};return t(n,{children:e(Nc,Object.assign({style:M,"data-testid":h?"dropdown-container":"dropdown-container-hidden",ref:V},{children:[(()=>{if(h)return e(Lc,Object.assign({ref:R,"data-testid":"dropdown-list",width:d,role:"list"},D,{children:[(p||m)&&"success"===S?t(pu,{ref:q,onChange:ie,value:I,placeholder:f,"data-testid":"search-input","aria-label":"search-input",tabIndex:h?0:-1,onClear:oe}):null,de(),he(),pe(),fe(),ue()]}))})(),(()=>{if(h&&E)return t("div",Object.assign({ref:U,"data-testid":"custom-cta"},{children:E(y,T)}))})()]}))})},gu="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",mu=f.div`
    position: relative;
    min-height: 3rem;
...
`,Au=f.div`
    ...
    ${e=>{if(e.$minWidthBeforeWrap)return m`
            ...
            `}}
`,Eu=({children:n,currentActive:r,error:i,className:o,minWidthBeforeWrap:a})=>{const[s,l]=n;return e(Ou,Object.assign({className:o,$minWidthBeforeWrap:a},{children:[t(Bu,Object.assign({"data-id":"range-container-elem1-container"},{children:s})),t(ju,{}),t(Bu,Object.assign({"data-id":"range-container-elem2-container"},{children:l})),t(Au,{"data-id":"range-container-indicator",$position:r,$error:i,$minWidthBeforeWrap:a})]}))};f.input`
    ${Oc("Body","regular")}
    color: ${cc.Neutral[1]};
...
`,Tu=n=>{var{selectedOptions:r,placeholders:i={from:"Select",to:"Select"},options:a,disabled:c,className:u,readOnly:d,error:h,"data-testid":p,id:f,enableSearch:g=!1,searchFunction:m,searchPlaceholder:y,valueExtractor:b,valueToStringFunction:v,listExtractor:w,displayValueExtractor:x,onSelectOption:$,listStyleWidth:S,onShowOptions:_,onHideOptions:F,onRetry:k,optionsLoadState:B={from:"success",to:"success"},optionTruncationType:j="middle",renderCustomSelectedOption:A,renderListItem:E,renderCustomCallToAction:D}=n,C=O(n,["selectedOptions","placeholders","options","disabled","className","readOnly","error","data-testid","id","enableSearch","searchFunction","searchPlaceholder","valueExtractor","valueToStringFunction","listExtractor","displayValueExtractor","onSelectOption","listStyleWidth","onShowOptions","onHideOptions","onRetry","optionsLoadState","optionTruncationType","renderCustomSelectedOption","renderListItem","renderCustomCallToAction"]);const[P,I]=s(),[z,T]=s(),H=l(),N={from:l(),to:l()},[L,M]=s("none");o((()=>{I(null==r?void 0:r.from),T(null==r?void 0:r.to)}),[r]);const V=e=>t=>{t.stopPropagation(),t.preventDefault(),c||d||M("from"===e?"from":"to"===e&&P?"to":"from")},R=e=>{const t="from"===e?P:z;return x?x(t):b?b(t):null==t?void 0:t.toString()},W=(e,t)=>{if("middle"===j){let n=0;return N[e]&&N[e].current&&(n=N[e].current.getBoundingClientRect().width),Ic.truncateOneLine((e=>"string"==typeof e?e:v(e)||e.toString())(t),n,120,8)}return t},q=e=>{!e&&F&&F(),e&&_&&_()},U=e=>{const n="from"===e?P:z;return n?A?A(n):t(Su,Object.assign({truncateType:j},{children:W(e,R(e))})):t(_u,Object.assign({truncateType:j},{children:W(e,i[e])}))},Q=e=>t($u,Object.assign({onClick:V(e),ref:N[e]},{children:U(e)}));return e(Fu,Object.assign({show:"none"!==L,"data-testid":C["data-testid"],error:h&&!("none"!==L),disabled:c,readOnly:d,testId:p,onBlur:()=>{q(!1),M("none"),P&&z||(T(void 0),I(void 0))},className:u},{children:[e(Pu,{children:[t(zu,Object.assign({type:"button","data-testid":f||"selector",disabled:c,ref:H,onClick:V()},C,{children:e(Eu,Object.assign({currentActive:(()=>{switch(L){case"from":return"start";case"to":return"end";case"none":return L}})()},{children:[Q("from"),Q("to")]}))})),"none"===L&&P&&z&&!d&&!c&&t(Iu,Object.assign({onClick:e=>{e.stopPropagation(),I(void 0),T(void 0),$&&$({from:void 0,to:void 0},void 0)},type:"button","aria-label":"Clear"},{children:t(Cu,{"aria-hidden":!0})}))]}),"none"!==L&&t(xu,{}),(()=>{if("none"===L)return null;const e=a[L];if(e&&e.length>0){const n="from"===L?P:z;return t(fu,{listItems:e,onSelectItem:(e,t)=>{return n=e,r=t,"from"===(i=L)?I(n):T(n),q(!1),H&&H.current.focus(),$&&$({[i]:n},r),void("from"===i?(T(void 0),M("to"),q(!0)):M("none"));var n,r,i},onDismiss:()=>(M("none"),q(!1),H&&H.current.focus(),void(P&&z||(T(void 0),I(void 0)))),valueExtractor:b,listExtractor:w,listStyleWidth:S,visible:!0,enableSearch:g,searchPlaceholder:y,searchFunction:m,"data-testid":`${L}-dropdown-list`,selectedItems:n?[n]:[],onRetry:k,itemsLoadState:B[L],itemTruncationType:j,renderListItem:E,renderCustomCallToAction:D})}return null})()]}))};export{Tu as InputRangeSelect};
