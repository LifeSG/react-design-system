...
`,nn=n=>{var{value:o,min:a=0,max:s=100,step:c=1,minRange:u,numOfThumbs:p=2,colors:h,disabled:d,readOnly:f,ariaLabels:g,showSliderLabels:m,sliderLabelPrefix:F,sliderLabelSuffix:y,renderSliderLabel:v,onChange:b,onChangeEnd:B}=n,S=l(n,["value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","ariaLabels","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","renderSliderLabel","onChange","onChangeEnd"]);const[D,E]=r(k()),x=function(){const e=function(){const e=d||f?Et.Neutral[5]:Et.Neutral[4],t=d||f?Et.Neutral[4]:Et.Primary;if(1===p)return[t,e];const n=[];n.push(e);for(let e=0;e<p-1;e++)n.push(t);return n.push(e),n}();return new Array(p+1).fill(0).map(((t,n)=>(null==h?void 0:h[n])||e[n]))}();i((()=>{o!==D&&E(k())}),[o]);function k(){if(o&&o.length===p)return o;const e=[];for(let t=0;t<p;t++)e.push(a+c*t);return e}const A=t=>v?v(t):e(Jt,{children:[F,t,y]});return e(Yt,Object.assign({},S,{children:[t(Qt,{step:c,min:a,max:s,value:D,disabled:d||f,onChange:(e,t)=>{if("number"==typeof e){const t=[e];E(t),null==b||b(t)}else{if(t>-1&&D[t]===e[t])return;E(e),null==b||b(e)}},onAfterChange:e=>{if("number"==typeof e){const t=[e];E(t),null==B||B(t)}else E(e),null==B||B(e)},minDistance:u,ariaLabel:g,renderThumb:(e,n)=>t(en,Object.assign({"data-testid":`slider-thumb-${n.index}`},e,{tabIndex:d?void 0:e.tabIndex},{children:t(Zt,{$disabled:d,$readOnly:f})})),renderTrack:(e,n)=>t(tn,Object.assign({"data-testid":`slider-track-${n.index}`},e,{$color:x[n.index]}))}),m&&e(qt,{children:[t("div",{children:A(a)}),t("div",{children:A(s)})]})]}))};export{nn as InputRangeSlider};
