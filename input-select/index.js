...
`,ws=v(ys)`
    ...
    ${e=>y`
        ...
        `}
`,Ds=p(((r,n)=>{var{value:i,variant:a,onClear:o}=r,l=xn(r,["value","variant","onClear"]);return e(Ss,{children:[e(Fs,{children:[t(Bs,{$variant:a,"aria-hidden":!0}),t(xs,Object.assign({ref:n,value:i,$variant:a},l))]}),i&&t(ws,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:a},{children:t(O,{"aria-hidden":!0})}))]})})),Os=({listItems:r,multiSelect:n,selectedItems:i,disableItemFocus:l,itemsLoadState:s="success",itemTruncationType:c="end",itemMaxLines:u=2,labelDisplayType:f="inline",variant:h="default",listboxId:g,width:p,onSelectItem:v,onSelectAll:y,onDismiss:b,onRetry:$,valueExtractor:S,listExtractor:F,renderListItem:x,renderCustomCallToAction:B,enableSearch:w,hideNoResultsDisplay:D,searchPlaceholder:O="Search",searchFunction:k,onSearch:E})=>{const{focusedIndex:H,setFocusedIndex:j}=m(Zl),[A,_]=o(""),[T,z]=o(r),M=Jl(s),C=(()=>{const[e,t]=o(!1);return d((()=>{t(!0)}),[]),e})(),I=a(),L=a(),W=a([]),P=a(),R=e=>F?F(e):e.toString(),N=Vl((()=>k(A))),Y=Vl((()=>r.filter((e=>{var t;const r=R(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),a=A.trim().toLowerCase();return n.includes(a)||i&&i.includes(a)})))),V=(e,t)=>{j(t),null==v||v(e,(e=>S?S(e):e)(e))},J=e=>{const t=e.target.value;_(t),null==E||E()},Z=()=>{var e;_(""),null===(e=P.current)||void 0===e||e.focus(),null==E||E()},U=()=>{null==$||$()};((e,t,r="window",n)=>{const i=a();d((()=>{i.current=t}),[t]),d((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const a=e=>i.current(e);return t.addEventListener(e,a,n),()=>{t.removeEventListener(e,a,n)}}),[e,r])})("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),H<T.length-1){const e=H+1;null===(t=W.current[e])||void 0===t||t.focus(),j(e)}break;case"ArrowUp":if(e.preventDefault(),H>0){const e=H-1;null===(r=W.current[e])||void 0===r||r.focus(),j(e)}else 0===H&&P.current&&(P.current.focus(),j(-1));break;case"Space":document.activeElement===W.current[H]&&(e.preventDefault(),T[H]&&V(T[H],H))}})),d((()=>{C||l||(P.current?(j(-1),setTimeout((()=>{var e;return null===(e=P.current)||void 0===e?void 0:e.focus()}),200)):W.current[H]?setTimeout((()=>{var e;return null===(e=W.current[H])||void 0===e?void 0:e.focus()}),200):(j(0),setTimeout((()=>{var e;return null===(e=W.current[0])||void 0===e?void 0:e.focus()}),200)))}),[l,H,C,j]),d((()=>{C&&M&&(l||"success"===s&&P.current&&(j(-1),P.current.focus()))}),[C,M,s,j,l]),d((()=>{z(""===A?r:k?N():Y())}),[N,Y,r,k,A]);const X=e=>n?t(e?ss:cs,{"aria-hidden":!0}):e?t(os,{"aria-hidden":!0}):t(ls,{}),G=(e,r)=>{const n=R(e),i="string"==typeof n?n:n.title,a="string"==typeof n?void 0:n.secondaryLabel;return t(Wn,{displayType:f,label:i,maxLines:u,selected:r,sublabel:a,truncationType:c,variant:h})},q=()=>{if(!$||$&&"success"===s)return T.map(((t,r)=>{const a=(e=>!!ll(i,(t=>cl(t,e))))(t),o=r===H;return e(as,Object.assign({"aria-selected":a,"aria-multiselectable":n,"data-testid":"list-item",onClick:()=>V(t,r),onMouseEnter:()=>(e=>{j(e)})(r),ref:e=>W.current[r]=e,role:"option",tabIndex:o?0:-1,$active:o},{children:[X(a),x?x(t,{selected:a}):G(t,a)]}),((e,t)=>`item_${t}__${S?S(e):e}`)(t,r))}))},Q=()=>{if((w||k)&&"success"===s)return t(Ds,{ref:P,onChange:J,value:A,placeholder:O,"data-testid":"search-input","aria-label":"Enter text to search",onClear:Z,variant:h})},K=()=>{if(n&&T.length>0&&!A&&"success"===s)return t(us,{children:t(hs,Object.assign({onClick:y,type:"button",$variant:h},{children:0===i.length?"Select all":"Clear all"}))})},ee=()=>{if(!D&&(A||!w)&&0===T.length&&"success"===s)return e(gs,Object.assign({"data-testid":"list-no-results"},{children:[t(ms,{"data-testid":"no-result-icon",$variant:h}),t(ps,Object.assign({$variant:h},{children:"No results found."}))]}))},te=()=>{if($&&"loading"===s){const r="small"===h?16:18;return e(gs,Object.assign({"data-testid":"list-loading"},{children:[t(Fl,{$buttonStyle:"secondary",size:r}),t(ps,Object.assign({$variant:h},{children:"Loading..."}))]}))}},re=()=>{if($&&"fail"===s)return e(gs,Object.assign({"data-testid":"list-fail"},{children:[t(ms,{"data-testid":"load-error-icon",$variant:h}),t(ps,Object.assign({$variant:h},{children:"Failed to load."}))," ",t(fs,Object.assign({onClick:U,type:"button",$variant:h},{children:"Try again."}))]}))};return e(rs,Object.assign({"data-testid":"dropdown-container",ref:I,$width:p},{children:[e(ns,Object.assign({ref:L,"data-testid":"dropdown-list"},{children:[Q(),K(),ee(),te(),re(),t(is,Object.assign({role:"listbox",id:g},{children:q()}))]})),(()=>{if(B)return t("div",Object.assign({"data-testid":"custom-cta"},{children:B(b,T)}))})()]}))},ks="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Es=v(ts)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
