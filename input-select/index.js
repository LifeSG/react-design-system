...
`,$l={collections:{base:{InputBoxShadow:y`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return y`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Fl.Button.Danger.Border:Dn.Primary};

                    color: ${e.$buttonIsDanger?Fl.Button.Danger.Primary:Dn.Primary};
                `;case"light":return y`
                    background-color: ${Dn.Neutral[8]};
                ...
                `;case"link":return y`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Fl.Button.Danger.Hover:Dn.Secondary};
                    }
                `;default:return y`
                    background-color: ${e.$buttonIsDanger?Fl.Button.Danger.BackgroundColor:Dn.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?y`
                ...
                `}
`;const xl=v((({color:r,className:n,size:i=18})=>e(gl,Object.assign({className:n,$size:i,$color:r},{children:[t(ml,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),t(vl,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),t(yl,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),t(bl,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Fl.Button.Danger.Primary:Dn.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Dn.Neutral[3](e);break;default:t=Dn.Neutral[8](e)}return y`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Kl=y`
    ...
    box-shadow: ${Fl.InputErrorBoxShadow};
`,es=v.div`
    border: 1px solid ${Dn.Neutral[5]};
    border-radius: 4px;
...
`,bs=i.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,l=xn(e,["children","focusHighlight","focusOutline","type"]);return t(ys,Object.assign({ref:r,$outline:a,$highlight:i,type:o},l,{children:n}))})),$s=e=>"small"===e?1:1.125,Ss=e=>y`
        height: ${$s(e)}rem;
        width: ${$s(e)}rem;
    `,Fs=v.div`
...
`,Ds=v(bs)`
    ...
    ${e=>y`
        ...
        `}
`,Os=p(((r,n)=>{var{value:i,variant:a,onClear:o}=r,l=xn(r,["value","variant","onClear"]);return e(Fs,{children:[e(xs,{children:[t(Bs,{$variant:a,"aria-hidden":!0}),t(ws,Object.assign({ref:n,value:i,$variant:a},l))]}),i&&t(Ds,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:a},{children:t(O,{"aria-hidden":!0})}))]})})),ks=({listItems:n,multiSelect:i,selectedItems:l,disableItemFocus:s,itemsLoadState:c="success",itemTruncationType:u="end",itemMaxLines:f=2,labelDisplayType:h="inline",variant:g="default",listboxId:p,width:v,topScrollItem:y,onSelectItem:b,onSelectAll:$,onDismiss:S,onRetry:F,valueExtractor:x,listExtractor:w,renderListItem:B,renderCustomCallToAction:D,enableSearch:O,hideNoResultsDisplay:k,searchPlaceholder:E="Search",searchFunction:H,onSearch:j})=>{const{focusedIndex:T,setFocusedIndex:A}=m(Ul),[_,z]=o(""),[M,C]=o(n),I=Zl(c),L=(()=>{const[e,t]=o(!1);return d((()=>{t(!0)}),[]),e})(),W=a(),P=a(),R=a([]),N=a(),Y=e=>w?w(e):e.toString(),V=Jl((()=>H(_))),J=Jl((()=>n.filter((e=>{var t;const r=Y(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),a=_.trim().toLowerCase();return n.includes(a)||i&&i.includes(a)})))),Z=(e,t)=>{A(t),null==b||b(e,(e=>x?x(e):e)(e))},U=e=>{const t=e.target.value;z(t),null==j||j()},X=()=>{var e;z(""),null===(e=N.current)||void 0===e||e.focus(),null==j||j()},G=()=>{null==F||F()};((e,t,r="window",n)=>{const i=a();d((()=>{i.current=t}),[t]),d((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const a=e=>i.current(e);return t.addEventListener(e,a,n),()=>{t.removeEventListener(e,a,n)}}),[e,r])})("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),T<M.length-1){const e=T+1;null===(t=R.current[e])||void 0===t||t.focus(),A(e)}break;case"ArrowUp":if(e.preventDefault(),T>0){const e=T-1;null===(r=R.current[e])||void 0===r||r.focus(),A(e)}else 0===T&&N.current&&(N.current.focus(),A(-1));break;case"Space":case"Enter":document.activeElement===R.current[T]&&(e.preventDefault(),M[T]&&Z(M[T],T))}})),d((()=>{if(void 0===y)return;const e=setTimeout((()=>{var e;const t=n.indexOf(y),r=R.current[t];if(W.current){const t=null!==(e=null==r?void 0:r.offsetTop)&&void 0!==e?e:0;W.current.scrollTop=t-8}A(t)}),0);return()=>clearTimeout(e)}),[R,n,A,y]),d((()=>{L||s||(N.current?(A(-1),setTimeout((()=>{var e;return null===(e=N.current)||void 0===e?void 0:e.focus()}),200)):R.current[T]?setTimeout((()=>{var e;return null===(e=R.current[T])||void 0===e?void 0:e.focus()}),200):(A(0),setTimeout((()=>{var e;return null===(e=R.current[0])||void 0===e?void 0:e.focus()}),200)))}),[s,T,L,A]),d((()=>{L&&I&&(s||"success"===c&&N.current&&(A(-1),N.current.focus()))}),[L,I,c,A,s]),d((()=>{C(""===_?n:H?V():J())}),[V,J,n,H,_]);const q=e=>i?t(e?cs:us,{"aria-hidden":!0}):e?t(ls,{"aria-hidden":!0}):t(ss,{}),Q=(e,r)=>{const n=Y(e),i="string"==typeof n?n:n.title,a="string"==typeof n?void 0:n.secondaryLabel;return t(Wn,{displayType:h,label:i,maxLines:f,selected:r,sublabel:a,truncationType:u,variant:g})},K=()=>{if(!F||F&&"success"===c)return M.map(((n,a)=>{const o=(e=>!!ll(l,(t=>cl(t,e))))(n),s=a===T;return t(os,Object.assign({"aria-selected":o,"aria-multiselectable":i,"data-testid":"list-item",onClick:()=>Z(n,a),onMouseEnter:()=>(e=>{A(e)})(a),ref:e=>R.current[a]=e,role:"option",tabIndex:s?0:-1,$active:s},{children:B?B(n,{selected:o}):e(r,{children:[q(o),Q(n,o)]})}),((e,t)=>`item_${t}__${x?x(e):e}`)(n,a))}))},ee=()=>{if((O||H)&&"success"===c)return t(Os,{ref:N,onChange:U,value:_,placeholder:E,"data-testid":"search-input","aria-label":"Enter text to search",onClear:X,variant:g})},te=()=>{if(i&&M.length>0&&!_&&"success"===c)return t(ds,{children:t(gs,Object.assign({onClick:$,type:"button",$variant:g},{children:0===l.length?"Select all":"Clear all"}))})},re=()=>{if(!k&&(_||!O)&&0===M.length&&"success"===c)return e(ps,Object.assign({"data-testid":"list-no-results"},{children:[t(vs,{"data-testid":"no-result-icon",$variant:g}),t(ms,Object.assign({$variant:g},{children:"No results found."}))]}))},ne=()=>{if(F&&"loading"===c){const r="small"===g?16:18;return e(ps,Object.assign({"data-testid":"list-loading"},{children:[t(xl,{$buttonStyle:"secondary",size:r}),t(ms,Object.assign({$variant:g},{children:"Loading..."}))]}))}},ie=()=>{if(F&&"fail"===c)return e(ps,Object.assign({"data-testid":"list-fail"},{children:[t(vs,{"data-testid":"load-error-icon",$variant:g}),t(ms,Object.assign({$variant:g},{children:"Failed to load."}))," ",t(hs,Object.assign({onClick:G,type:"button",$variant:g},{children:"Try again."}))]}))};return e(ns,Object.assign({"data-testid":"dropdown-container",ref:W,$width:v},{children:[e(is,Object.assign({ref:P,"data-testid":"dropdown-list"},{children:[ee(),te(),re(),ne(),ie(),t(as,Object.assign({role:"listbox",id:p},{children:K()}))]})),(()=>{if(D)return t("div",Object.assign({"data-testid":"custom-cta"},{children:D(S,M)}))})()]}))},Es="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Hs=v(rs)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,Ts=p((({children:r,disabled:n,expanded:i,listboxId:a,readOnly:o,variant:l},s)=>e(Hs,Object.assign({ref:s,type:"button","aria-expanded":i,"aria-haspopup":"listbox","data-testid":"selector",disabled:n,"aria-controls":a,$variant:l},{children:[r,!o&&t(js,Object.assign({$expanded:i,$variant:l},{children:t(E,{"aria-hidden":!0})}))]})))),As=e=>"small"===e?2.5:3;v.div`
    position: relative;
    width: 100%;
    ${e=>{const t=As(e.$variant);return y`
            min-height: ${t}rem;
...
`,Ls=v(Is)`
    color: ${Dn.Neutral[3]};
`;var Ws;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Ws||(Ws={}));const Ps=v.div`
    display: flex;
    flex-direction: column;
`,Rs=e=>"right"===e?"bottom-end":"bottom-start",Ns=({enabled:n,isOpen:i,onOpen:l,onClose:s,onDismiss:c,renderElement:u,renderDropdown:f,customZIndex:h,clickToToggle:g=!1,offset:p=0,alignment:m="left",fitAvailableHeight:v})=>{var y;const b=a(null),$=a(null),{width:S}=Ie({targetRef:b,handleHeight:!1}),F={name:"center",fn:({x:e,rects:t})=>{const r=0===e||e+t.floating.width===window.innerWidth,n=window.innerWidth<hl.mobileL;return{x:r&&n?(window.innerWidth-t.floating.width)/2:e}}},{refs:x,floatingStyles:w,context:B}=j({open:i,onOpenChange:(e,t,r)=>{"escape-key"===r?null==c||c():e&&!i?null==l||l():!e&&i&&(null==s||s(r))},whileElementsMounted:T,placement:Rs(m),middleware:[A(p),_(),z({limiter:M()}),C({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:v?`${e}px`:void 0,overflowY:v?"hidden":void 0})}}),F]}),D=(()=>{const[e,t]=o(void 0),r=H();return d((()=>{if(!r)return void t(void 0);const e=e=>{t(e.zIndex)};return r.events.on(Ws.Change,e),r.events.emit(Ws.Ready),()=>r.events.off(Ws.Change,e)}),[r]),e})(),{isMounted:O,styles:k}=I(B,{initial:{opacity:0},open:{opacity:1},duration:300}),E=L(B,{enabled:n,toggle:g}),Y=W(B,{enabled:n}),{getReferenceProps:V,getFloatingProps:J}=P([E,Y]);return e(r,{children:[t("div",Object.assign({ref:e=>{b.current=e,x.setReference(e)}},V(),{children:u()})),O&&t(R,{children:t(N,Object.assign({context:B,modal:!1,initialFocus:$,returnFocus:!1},{children:t("div",Object.assign({ref:x.setFloating,style:Object.assign(Object.assign({},w),{zIndex:null!==(y=null!=h?h:D)&&void 0!==y?y:50})},J(),{children:t(Ps,Object.assign({ref:$,style:Object.assign({},k),inert:k.opacity<1?"":void 0},{children:f({elementWidth:S})}))}))}))})]})},Ys=({selectedOption:e,placeholder:r="Select",options:n,disabled:i,error:l,className:s,"data-testid":c,id:u,enableSearch:f=!1,searchFunction:h,searchPlaceholder:g,valueExtractor:p,valueToStringFunction:m,listExtractor:v,displayValueExtractor:y,onSelectOption:b,onShowOptions:$,onHideOptions:S,onRetry:F,optionsLoadState:x="success",optionTruncationType:w="end",renderCustomSelectedOption:B,renderListItem:D,hideNoResultsDisplay:O,renderCustomCallToAction:k,onBlur:E,variant:H="default",readOnly:j,alignment:T,dropdownZIndex:A})=>{const[_,z]=o(e),[M,C]=o(!1),[I,L]=o(!1),[W]=o((()=>Vl.generate())),P=a(),R=a(),N=a();d((()=>{z(e)}),[e]);const Y=(e,t)=>{R.current.focus(),z(e),C(!1),X(!1),null==b||b(e,t)},V=()=>{M&&(C(!1),X(!1))},J=()=>{I||M||L(!0)},Z=e=>{!I||M||P.current.contains(e.relatedTarget)||(L(!1),null==E||E())},U=e=>{if("middle"===w){let t=0;return N&&N.current&&(t=N.current.getBoundingClientRect().width),An.truncateOneLine((e=>"string"==typeof e?e:m(e)||e.toString())(e),t,120,8)}return e},X=e=>{e?null==$||$():null==S||S()};return t(Xl,{children:t(Ns,{enabled:!j&&!i,isOpen:M,renderElement:()=>t(es,Object.assign({className:s,"data-testid":c,id:u,ref:P,tabIndex:-1,onFocus:J,onBlur:Z,$focused:I,$disabled:i,$readOnly:j,$error:l},{children:t(Ts,Object.assign({ref:R,disabled:i,expanded:M,listboxId:W,readOnly:j,variant:H},{children:t(Cs,Object.assign({ref:N},{children:_?B?B(_):t(Is,Object.assign({truncateType:w,$variant:H},{children:U(y?y(_):p?p(_):_.toString())})):t(Ls,Object.assign({truncateType:w,$variant:H},{children:r}))}))}))})),renderDropdown:({elementWidth:e})=>t(ks,{listboxId:W,listItems:n,onSelectItem:Y,onDismiss:V,valueExtractor:p,listExtractor:v,enableSearch:f,searchPlaceholder:g,searchFunction:h,selectedItems:_?[_]:[],onRetry:F,itemsLoadState:x,itemTruncationType:w,renderListItem:D,hideNoResultsDisplay:O,renderCustomCallToAction:k,variant:H,width:e}),onOpen:()=>{C(!0),X(!0),L(!0)},onClose:e=>{C(!1),X(!1),"click"!==e&&(L(!1),null==E||E())},onDismiss:()=>{R.current.focus(),C(!1),X(!1)},clickToToggle:!0,offset:8,alignment:T,fitAvailableHeight:!0,customZIndex:A})})};export{Ys as InputSelect};
