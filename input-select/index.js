...
`,Xl=p.div`
    ...
    border-style: solid;
    border-radius: 50%;
    border-color: ${t=>t.$color||Ll.Neutral[8](t)}
...
`;var gc;!function(t){t.D1=p.h1`
    ...
    `,t.XSmall=p.span`
        ${t=>g`
                ...
                ${sc(t.inline,t.paragraph)}
            `}
    `,t.Hyperlink={Default:t=>vc({...t,textStyle:"Body"}),Small:t=>vc({...t,textStyle:"BodySmall"})}}(gc||(gc={}));const mc=p.a`
    ${t=>g`
...
`,yc=p(pc)`
    margin-left: 0.4rem;
`,vc=({external:n=!1,children:r,...i})=>t(mc,{...i,children:[r,n&&e(yc,{type:"external"})]});var bc;!function(t){t[t.Subpage=0]="Subpage",t[t.Domain=1]="Domain"}(bc||(bc={})),p.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${t=>{switch(t.$buttonStyle){case"secondary":return g`
                    background-color: ${Ll.Neutral[8](t)};
                    border: 1px solid ${Ll.Primary(t)};
                ...
                `;case"light":return g`
                    background-color: ${Ll.Neutral[8](t)};
                    border: 1px solid ${Ll.Neutral[5](t)};

                    span {
                        color: ${Ll.Primary(t)};
                    }
                `;case"disabled":return g`
                    background-color: ${Ll.Neutral[6](t)};
	...
	${t=>"small"===t.$buttonSizeStyle?g`
                ...
                `}
`;const wc=p((({color:n,className:r,size:i=18})=>t(Ql,{className:r,$size:i,$color:n,children:[e(Xl,{id:"inner1",$size:i-2,$borderWidth:2}),e(Zl,{id:"inner2",$size:i-2,$borderWidth:2}),e(Kl,{id:"inner3",$size:i-2,$borderWidth:2}),e(Yl,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${t=>{let e;switch(t.$buttonStyle){case"secondary":case"light":case"link":e=Ll.Primary(t);break;case"disabled":e=Ll.Neutral[3](t);break;default:e=Ll.Neutral[8](t)}return g`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`;var _c;!function(t){t.transformWithSpaces=(t,e)=>{const n="(.{"+e+"})";return t.replace(/[^\dA-Z]/gi,"").replace(new RegExp(n,"g"),"$1 ").trim()},t.padValue=(t,e)=>{if("0"===t)return e?t:t.padStart(2,"0");if(""===t)return t;return parseInt(t).toString().padStart(2,"0")},t.shouldTruncateToTwoLines=(t,e)=>{const n=Math.floor(e/9);return t.length>=2*n||1===t.split(" ").length&&t.length>n},t.truncateOneLine=(t,e,n,r)=>{let i=0;e>n&&(i=Math.floor((e-n)/8));const o=r+i;if(o<t.length){const e=Math.floor(o/2);return t.substring(0,e)+" ... "+t.substring(t.length-e,t.length)}return t}}(_c||(_c={}));const Sc=p.div`
    ...
    border: 1px solid ${Ll.Accent.Light[2]};
    background: transparent;

    ${t=>{let e,n;return t.selected&&(e=Ll.Primary(t),n=Ll.Primary(t)),t.disabled&&(e=Ll.Neutral[6](t),n=Ll.Neutral[6](t)),`\n\t\t\tborder: 1px solid ${e};\n\t\t\tbackground: ${n};\n\t\t`}}
`,xc=p.input`
    position: absolute;
    opacity: 0;
    height: 100%;
...
`,$c=p(pc)`
    ${t=>{let e;if("small"===t.$displaySize)e="1.3rem";else e="1.5rem";return g`
        ...
        `}}
    font-weight: bold;
    color: ${t=>t.disabled?Ll.Neutral[4]:Ll.Neutral[8]};
`,kc=p(Hl.div)`
    overflow: hidden;
...
`,Fc=p.ul`
    ...
    ::-webkit-scrollbar-thumb {
        background: ${Ll.Neutral[4]};
        border-right: 5px solid ${Ll.Neutral[8]};
...
`,jc=p.button`
    ...
    :focus,
    :active {
        outline-color: ${Ll.Accent.Light[3]};
    }
...
`,Pc=p.div`
    ...
    direction: rtl;
    text-align: right;
`;p(gc.Hyperlink.Default)`
    color: ${Ll.Neutral[1]} !important;
...
`;const Cc=p((({className:n,checked:r,disabled:i,onClick:s,onKeyPress:l,displaySize:c="default",...u})=>{const[d,h]=a(r);o((()=>{h(r)}),[r]);const p=t=>{i||(s&&s(t),l&&l(t))};return t(Sc,{selected:d,disabled:i,className:n,"data-testid":"checkbox",onKeyPress:p,tabIndex:i?-1:0,role:"checkbox",$displaySize:c,children:[e(xc,{type:"checkbox","data-testid":"checkbox-input",onClick:p,disabled:i,tabIndex:-1,...u}),d&&e($c,{type:"check",id:"checkmark","data-testid":"checkmark",disabled:i,$displaySize:c})]})}))`
    flex: 0 0 1.5rem;
    margin-right: 1rem;
`,Dc=p.div`
    width: 100%;
...
`,Hc=p(gc.Body)``,Nc=p.div`
    ...
    ${t=>g`
            color: ${Ll.Validation.Red.Icon(t)};
        `}
`,Mc=p.li`
    background: ${Ll.Neutral[7]};
    display: flex;
    border-radius: 4px;
    align-items: center;
`,Tc=p.input`
...
`,Rc=l(((n,r)=>t(Mc,{children:[e(Vc,{type:"search"}),e(Tc,{ref:r,...n})]},"search"))),Lc=({listItems:n,listExtractor:r,valueExtractor:i,onSelectItem:l,listStyleWidth:c,visible:u,enableSearch:d,searchPlaceholder:h="Search",onSearch:p,searchFunction:f,onDismiss:g,multiSelect:m,selectedItems:y,onSelectAll:v,onRetry:b,itemsLoadState:w="success",itemTruncationType:_="end",...S})=>{const[x,$]=a(0),[k,F]=a(""),[O,j]=a(n),[z,B]=a(0),A=function(t,e){const n=vo.fun(t),[[r],i]=fl(1,n?t:[t],n?e||[]:e);return n||2==arguments.length?[r,i]:r}({height:z}),P=s(),C=s(),D=s([]),E=s(),I=s(x),H=s(O),N=t=>{I.current=t,$(t)},M=t=>{H.current=t,j(t)};o((()=>(document.addEventListener("keydown",q),()=>{document.removeEventListener("keydown",q)})),[]),o((()=>{L(k)}),[k]),o((()=>{F(""),u?(B(W()),E&&E.current?(E.current.focus(),N(-1)):D.current[x]&&D.current[x].focus()):B(0)}),[u]),o((()=>{if(u){const t=W();B(t)}}),[O]),o((()=>{M(n),F(""),N(0)}),[n]);const T=t=>r?r(t):t.toString(),V=t=>{const e=r?r(t):t.toString();let n=0;return C&&C.current&&(n=C.current.getBoundingClientRect().width-100),_c.shouldTruncateToTwoLines(e,n)},R=t=>Li(y,t)>-1,L=t=>{if(""===t)M(n);else if(f){const e=f(t);M(e)}else{const e=n.filter((e=>T(e).toLowerCase().includes(t.trim().toLowerCase())));M(e)}},W=()=>C&&C.current?C.current.getBoundingClientRect().height:0,q=t=>{if(P&&P.current.contains(t.target))switch(t.code){case"ArrowDown":if(I.current<H.current.length-1){const t=I.current+1;D.current[t].focus(),N(t)}break;case"ArrowUp":if(I.current>0){const t=I.current-1;D.current[t].focus(),N(I.current-1)}break;case"Escape":g&&g()}},U=(t,e)=>{t.preventDefault(),l&&l(e,(t=>i?i(t):t)(e))},Q=()=>{b&&b()},G=n=>{const i=r?r(n):n.toString();return t(Bc,{"data-testid":"truncate-middle-container",children:[e(Ac,{children:i}),t(Pc,{children:[" ",i]})]})};return e(kc,{style:A,"data-testid":u?"dropdown-container":"dropdown-container-hidden",ref:P,children:t(Fc,{ref:C,"data-testid":"dropdown-list",width:c,role:"list",...S,children:[(d||f)&&"success"===w?e(Rc,{ref:E,onChange:t=>{const e=t.target.value;F(e),p&&p()},value:k,placeholder:h,"data-testid":"search-input","aria-label":"search-input",tabIndex:u?0:-1}):null,(()=>{if(m&&O.length>0&&!k&&"success"===w)return e(Dc,{children:e(Ec,{onClick:v,children:0===y.length?"Select all":"Unselect all"})},"selectAll")})(),(()=>{if(k&&0===O.length)return t(Ic,{"data-testid":"list-no-results",children:[e(Nc,{"data-testid":"no-result-icon",children:e(Ki,{})}),e(Hc,{children:"No results found."})]},"noResults")})(),(()=>{if(b&&"loading"===w)return t(Ic,{"data-testid":"list-loading",children:[e(wc,{$buttonStyle:"secondary",size:24}),e(Hc,{children:"Loading..."})]},"loading")})(),(()=>{if(b&&"fail"===w)return t(Ic,{"data-testid":"list-fail",children:[e(Nc,{"data-testid":"load-error-icon",children:e(Ki,{})}),e(Hc,{children:"Failed to load."}),e(Ec,{onClick:Q,children:"Try again."})]},"noResults")})(),(()=>{if(!b||b&&"success"===w)return O.map(((n,r)=>e(Oc,{checked:R(n)&&!m,children:t(jc,{onClick:t=>{U(t,n)},ref:t=>D.current[r]=t,"data-testid":"list-item",type:"button",tabIndex:u?0:-1,multiSelect:m,children:[m&&e(Cc,{checked:R(n),displaySize:"small"}),e(zc,{truncateType:_,children:"middle"===_&&V(n)?G(n):T(n)})]})},((t,e)=>`item_${e}__${i?i(t):t}`)(n,r))))})()]})})},Wc="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",qc=p.div`
    position: relative;
    min-height: 3rem;
    height: 3rem;
    width: 100%;
...
`,Gc=p.div`
    position: relative;
    border: 1px solid ${Ll.Neutral[5]};
    border-radius: ${"4px"};
    background: ${Ll.Neutral[8]};

    :focus-within {
        border: 1px solid ${Ll.Accent.Light[1]};
    ...
    ${t=>t.disabled?g`
            ...
            `:t.error?g`
                border: 1px solid ${Ll.Validation.Red.Border(t)};
...
`,tu=p(Jc)`
    color: ${Ll.Neutral[3]};
`,eu=({children:t,show:n,error:r,disabled:i,testId:a,onBlur:l})=>{const c=s(),u=s(n);o((()=>(document.addEventListener("mousedown",d),()=>{document.removeEventListener("mousedown",d)})),[]),o((()=>{u.current=n}),[n]);const d=t=>{if(!i){if(c&&c.current.contains(t.target))return;u.current&&l()}};return e(qc,{children:e(Gc,{ref:c,error:r&&!n,disabled:i,expanded:n,"data-testid":a,children:t})})},nu=({selectedOption:r,placeholder:i="Select",options:l,disabled:c,error:u,"data-testid":d,id:h,enableSearch:p=!1,searchFunction:f,searchPlaceholder:g,valueExtractor:m,valueToStringFunction:y,listExtractor:v,displayValueExtractor:b,onSelectOption:w,listStyleWidth:_,onShowOptions:S,onHideOptions:x,onRetry:$,optionsLoadState:k="success",optionTruncationType:F="end",...O})=>{const[j,z]=a(r),[B,A]=a(!1),P=s(),C=s();o((()=>{z(r)}),[r]);const D=(t,e)=>{z(t),A(!1),H(!1),P&&P.current.focus(),w&&w(t,e)},E=()=>{B&&(A(!1),H(!1)),P&&P.current.focus()},I=t=>{if("middle"===F){let e=0;return C&&C.current&&(e=C.current.getBoundingClientRect().width),_c.truncateOneLine((t=>"string"==typeof t?t:y(t)||t.toString())(t),e,120,8)}return t},H=t=>{!t&&x&&x(),t&&S&&S()};return t(eu,{show:B,error:u&&!B,disabled:c,testId:d,onBlur:()=>{A(!1),H(!1)},children:[e(Uc,{ref:P,type:"button","data-testid":h||"selector",onClick:t=>{t.preventDefault(),c||(A(!B),H(!B))},...O,children:t(n,{children:[e(Yc,{ref:C,children:j?e(Jc,{truncateType:F,children:I(b?b(j):m?m(j):j.toString())}):e(tu,{truncateType:F,children:i})}),e(Xc,{expanded:B,children:e(Zc,{type:"chevron-down"})})]})}),B&&e(Kc,{}),l&&l.length>0?e(Lc,{listItems:l,onSelectItem:D,onDismiss:E,valueExtractor:m,listExtractor:v,listStyleWidth:_,visible:B,enableSearch:p,searchPlaceholder:g,searchFunction:f,"data-testid":"dropdown-list",selectedItems:j?[j]:[],onRetry:$,itemsLoadState:k,itemTruncationType:F}):null]})},ru=({selectedOptions:r,placeholder:i="Select",options:l,disabled:c,error:u,"data-testid":d,enableSearch:h=!1,searchFunction:p,searchPlaceholder:f,valueExtractor:g,listExtractor:m,onSelectOptions:y,listStyleWidth:v,onShowOptions:b,onHideOptions:w,onRetry:_,optionsLoadState:S="success",optionTruncationType:x="end",...$})=>{const[k,F]=a(r||[]),[O,j]=a(!1),z=s();o((()=>{F(r||[])}),[r]);const B=(t,e)=>{const n=[...k],r=Li(k,(t=>(g?g(t):t)===e));r>-1?n.splice(r,1):n.push(t),F(n),C(!1),z&&z.current.focus(),y&&y(n)},A=()=>{O&&(j(!1),C(!1)),z&&z.current.focus()},P=()=>{k&&k.length>0?(F([]),y([])):(F(l),y(l))},C=t=>{!t&&w&&w(),t&&b&&b()};return t(eu,{show:O,error:u&&!O,disabled:c,testId:d,onBlur:()=>{j(!1),C(!1)},children:[e(Uc,{ref:z,type:"button","data-testid":"selector",onClick:t=>{t.preventDefault(),c||(j(!O),C(!O))},...$,children:t(n,{children:[e(Yc,{children:k&&0!==k.length?e(Jc,{children:k&&0!=k.length?`${k.length} selected`:i}):e(tu,{truncateType:x,children:i})}),e(Xc,{expanded:O,children:e(Zc,{type:"chevron-down"})})]})}),O&&e(Kc,{}),l&&l.length>0||_?e(Lc,{listItems:l,onSelectItem:B,onDismiss:A,valueExtractor:g,listExtractor:m,listStyleWidth:v,visible:O,enableSearch:h,searchFunction:p,searchPlaceholder:f,"data-testid":"dropdown-list",multiSelect:!0,selectedItems:k,onSelectAll:P,onRetry:_,itemsLoadState:S,itemTruncationType:x}):null]})};export{ru as InputMultiSelect,nu as InputSelect};
