...
`,sd={collections:{base:{InputBoxShadow:b`
    ...
    `,ElevationBoxShadow:b`
      0px 2px 8px ${Hr.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},cd=e=>t=>{var n;const r=t.theme,o=gr(sd,r[pr.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?hr(o,e,r.options.designToken):hr(o,e)},ud={InputBoxShadow:cd("InputBoxShadow"),InputErrorBoxShadow:cd("InputErrorBoxShadow"),ElevationBoxShadow:cd("ElevationBoxShadow"),Table:{Header:cd("Table.Header"),Cell:{Primary:cd("Table.Cell.Primary"),Secondary:cd("Table.Cell.Secondary"),Selected:cd("Table.Cell.Selected"),Hover:cd("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:cd("Button.Danger.BackgroundColor"),Hover:cd("Button.Danger.Hover"),Primary:cd("Button.Danger.Primary"),Border:cd("Button.Danger.Border")}}};y.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return b`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?ud.Button.Danger.Border:Hr.Primary};

                    color: ${e.$buttonIsDanger?ud.Button.Danger.Primary:Hr.Primary};
                `;case"light":return b`
                    background-color: ${Hr.Neutral[8]};
                ...
                `;case"link":return b`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?ud.Button.Danger.Hover:Hr.Secondary};
                    }
                `;default:return b`
                    background-color: ${e.$buttonIsDanger?ud.Button.Danger.BackgroundColor:Hr.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?b`
                ...
                `}
`;const dd=y((({color:n,className:r,size:o=18})=>e(nd,Object.assign({className:r,$size:o,$color:n},{children:[t(od,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(id,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(ad,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(ld,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?ud.Button.Danger.Primary:Hr.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Hr.Neutral[3](e);break;default:t=Hr.Neutral[8](e)}return b`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Wd=b`
    ...
    box-shadow: ${ud.InputErrorBoxShadow};
`,Pd=y.div`
    border: 1px solid ${Hr.Neutral[5]};
    border-radius: 4px;
