...
`,Zu=g.div`
    ...
    ${e=>{if(!e.$disableMobile)return y`
            ...
            `}}
`,Xu=({selectedOptions:e,placeholders:i={from:"Select",to:"Select"},options:o,disabled:s,readOnly:u,error:d,"data-testid":h,id:p,enableSearch:f=!1,searchFunction:g,searchPlaceholder:m,valueExtractor:y,valueToStringFunction:v,listExtractor:b,displayValueExtractor:w,onSelectOption:_,listStyleWidth:S,onShowOptions:x,onHideOptions:$,onRetry:C,optionsLoadState:k={from:"success",to:"success"},optionTruncationType:F="middle",renderCustomSelectedOption:O,renderListItem:B,renderCustomCallToAction:j,...A})=>{const[I,P]=l(),[E,D]=l(),z=c(),H={from:c(),to:c()},[T,M]=l("none");a((()=>{P(e?.from),D(e?.to)}),[e]);const N=(e,t)=>{e.stopPropagation(),e.preventDefault(),s||u||M("from"===t?"from":"to"===t&&I?"to":"from")},L=e=>{const t="from"===e?I:E;return w?w(t):y?y(t):t?.toString()},V=(e,t)=>{if("middle"===F){let n=0;return H[e]&&H[e].current&&(n=H[e].current.getBoundingClientRect().width),Bc.truncateOneLine((e=>"string"==typeof e?e:v(e)||e.toString())(t),n,120,8)}return t},R=e=>{!e&&$&&$(),e&&x&&x()},W=e=>{const t="from"===e?I:E;return t?O?O(t):n(zu,{truncateType:F,children:V(e,L(e))}):n(Hu,{truncateType:F,children:V(e,i[e])})},q=e=>n(Du,{onClick:t=>N(t,e),style:"to"===e&&u?{marginLeft:"1rem"}:{},ref:H[e],children:W(e)}),U=(e,t)=>{if(e&&e.length>0){const r="from"===t?I:E;return n(vu,{listItems:e,onSelectItem:(e,n)=>((e,t,n)=>{"from"===n?P(e):D(e),R(!1),z&&z.current.focus(),_&&_({[n]:e},t),"from"===n?(D(void 0),M("to"),R(!0)):M("none")})(e,n,t),onDismiss:()=>(M("none"),R(!1),z&&z.current.focus(),void(I&&E||(D(void 0),P(void 0)))),valueExtractor:y,listExtractor:b,listStyleWidth:S,visible:"none"!==T,enableSearch:f,searchPlaceholder:m,searchFunction:g,"data-testid":`${t}-dropdown-list`,selectedItems:r?[r]:[],onRetry:C,itemsLoadState:k[t],itemTruncationType:F,renderListItem:B,renderCustomCallToAction:j})}return null};return t(Mu,{show:"none"!==T,"data-testid":A["data-testid"],error:d&&!("none"!==T),disabled:s,readOnly:u,testId:h,onBlur:()=>{R(!1),M("none"),I&&E||(D(void 0),P(void 0))},children:[t(Bu,{type:"button","data-testid":p||"selector",disabled:s,ref:z,style:{gap:"1.8rem"},onClick:e=>N(e),...A,children:[q("from"),n(Tu,{tabIndex:-1,children:n(Qu,{})}),q("to")]}),"none"!==T&&n(Eu,{}),"from"===T?U(o.from,"from"):"to"===T?U(o.to,"to"):n(r,{}),n(Zu,{$stickTo:"top",$position:"from"===T?"start":"to"===T?"end":"none",$disableMobile:!1})]})};export{Lu as InputMultiSelect,Xu as InputRangeSelect,Nu as InputSelect};
