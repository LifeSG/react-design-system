...
import { DropdownDisplayExtractorProps, DropdownSearchProps, DropdownStyleProps, ItemsLoadStateType, TruncateType } from "../shared/dropdown-list/types";
...
export interface InputSelectProps<T, V> extends React.HTMLAttributes<HTMLElement>, InputSelectOptionsProps<T>, InputSelectSharedProps<T>, DropdownDisplayExtractorProps<T, V>, DropdownSearchProps<T>, DropdownStyleProps {
...
export interface InputMultiSelectProps<T, V> extends React.HTMLAttributes<HTMLElement>, InputSelectOptionsProps<T>, InputSelectSharedProps<T>, DropdownDisplayExtractorProps<T, V>, DropdownSearchProps<T>, DropdownStyleProps {
