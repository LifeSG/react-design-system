...
`,nn=n=>{var{value:o,min:a=0,max:s=100,step:c=1,minRange:u,numOfThumbs:h=2,colors:p,disabled:d,readOnly:f,ariaLabels:g,showSliderLabels:m,sliderLabelPrefix:y,sliderLabelSuffix:v,renderSliderLabel:F,onChange:b,onChangeEnd:S}=n,B=l(n,["value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","ariaLabels","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","renderSliderLabel","onChange","onChangeEnd"]);const[D,E]=r(w()),x=function(){const e=function(){const e=d||f?Et.Neutral[5]:Et.Neutral[4],t=d||f?Et.Neutral[4]:Et.Primary;if(1===h)return[t,e];const n=[];n.push(e);for(let e=0;e<h-1;e++)n.push(t);return n.push(e),n}();return new Array(h+1).fill(0).map(((t,n)=>(null==p?void 0:p[n])||e[n]))}();i((()=>{o!==D&&E(w())}),[o]);function w(){if(o&&o.length===h)return o;const e=[];for(let t=0;t<h;t++)e.push(a+c*t);return e}const k=t=>F?F(t):e(Jt,{children:[y,t,v]});return e(Yt,Object.assign({},B,{children:[t(Qt,{step:c,min:a,max:s,value:D,disabled:d||f,onChange:(e,t)=>{if("number"==typeof e){const t=[e];E(t),null==b||b(t)}else{if(t>-1&&D[t]===e[t])return;E(e),null==b||b(e)}},onAfterChange:e=>{if("number"==typeof e){const t=[e];E(t),null==S||S(t)}else E(e),null==S||S(e)},minDistance:u,ariaLabel:g,renderThumb:(e,n)=>t(en,Object.assign({"data-testid":`slider-thumb-${n.index}`},e,{tabIndex:d?void 0:e.tabIndex},{children:t(Zt,{$disabled:d,$readOnly:f})})),renderTrack:(e,n)=>t(tn,Object.assign({"data-testid":`slider-track-${n.index}`},e,{$color:x[n.index]}))}),m&&e(qt,{children:[t("div",{children:k(a)}),t("div",{children:k(s)})]})]}))},rn=e=>{var{value:n,ariaLabel:o,onChange:a,onChangeEnd:s}=e,c=l(e,["value","ariaLabel","onChange","onChangeEnd"]);const[u,h]=r(p());i((()=>{n!==u[0]&&h(p())}),[n]);function p(){return null!=n?[n]:[0]}return t(nn,Object.assign({},c,{value:u,numOfThumbs:1,onChange:e=>{const[t]=e;h([t]),null==a||a(t)},onChangeEnd:e=>{const[t]=e;h([t]),null==s||s(t)},ariaLabels:o?[o]:void 0}))};export{rn as InputSlider};
