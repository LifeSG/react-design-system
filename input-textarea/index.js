...
`,Yt=i.textarea`
    ...
    ${e=>e.readOnly?l`
            ...
            `:void 0}
`;a.forwardRef(((e,n)=>{var{value:a,disabled:r,error:o,rows:i=5}=e,l=d(e,["value","disabled","error","rows"]);return t(Yt,Object.assign({ref:n,disabled:r,value:a,error:o,rows:i},l))}));const Zt=a.forwardRef(((n,a)=>{var{value:i,disabled:l,rows:c=5,onChange:g,transformValue:F}=n,u=d(n,["value","disabled","rows","onChange","transformValue"]);const[h,f]=r(i);o((()=>{f(i)}),[i]);return e(Qt,{children:[t(Yt,Object.assign({ref:a,disabled:l,value:h,rows:c||5,onChange:e=>{const t=e.target.value,n=F?F(null!=t?t:""):t;f(n),e.target.value=n,g&&g(e)}},u)),u.maxLength&&t(Gt,{disabled:l,value:h,maxLength:u.maxLength,renderCustomCounter:u.renderCustomCounter})]})}));export{Zt as Textarea};
