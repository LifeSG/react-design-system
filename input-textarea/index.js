...
`,Nt=r=>{var{external:n=!1,children:a}=r,o=d(r,["external","children"]);return e(Wt,Object.assign({},o,{children:[a,n&&t(Lt,{})]}))};var It;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(It||(It={}));const Pt=i(jt.H6)`
    text-align: right;
    color: ${$t.Neutral[3]};
    ...
    ${e=>{if(e.disabled)return l`
                color: ${$t.Neutral[4](e)};
            `}}
`,Rt=({value:e,maxLength:i,disabled:l,renderCustomCounter:c})=>{const[d,g]=a("");o((()=>{g(u(`${e||""}`))}),[e,i]);const u=e=>{if(c)return c(i,e.toString().length);{const t=i-e.toString().length;return 1===t?`${t} character left`:`${t.toLocaleString()} characters left`}};return t(r,{children:n.isValidElement(d)?d:t(Pt,Object.assign({"data-testid":"counter-label",weight:"semibold",disabled:l},{children:d}))})},Vt={collections:{base:{InputBoxShadow:l`
