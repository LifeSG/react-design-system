...
`,Bn=a.div`
    display: flex;
    width: 100%;
`,bn=r.forwardRef(((r,a)=>{var{value:s,spacing:l,type:c,error:d,disabled:h,readOnly:f,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:v="bordered"}=r,F=u(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const S=i();o(a,(()=>S.current),[]);const $=function({ref:t,formatter:e}){return()=>{const n=t.current,r=n.value,i=e(r),o=r.substring(0,n.selectionEnd),a=e(o),s=o.length-a.length,l=Math.max(0,n.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{n.value=i,n.setSelectionRange(l,l)}}}}({ref:S,formatter:t=>Fn.transformWithSpaces(t,l)}),D=t=>{g&&(b()?x(t):g(t))},B=()=>{p&&p(),S&&S.current&&S.current.focus()},b=()=>"tel"===c&&l,x=t=>{const{nextValue:e,updateCaretPosition:n}=$(),r=e.replace(/\s/g,"");t.target.value=r,g(t),n()},w=s?(t=>t?b()?Fn.transformWithSpaces(t,l):t:"")(s):s,H=()=>t(n,{children:[e(Sn,Object.assign({"data-testid":"input",ref:S,disabled:h,value:w,onChange:D,type:c,readOnly:f},F)),m&&!h&&!f&&!!s&&e($n,Object.assign({onClick:B,type:"button"},{children:e(Dn,{"aria-hidden":!0})}))]});return e(n,{children:"no-border"===v?e(Bn,Object.assign({className:y},{children:H()})):e(Ge,Object.assign({$disabled:h,$error:d,$readOnly:f,className:y},{children:H()}))})}));export{bn as Input};
