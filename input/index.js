...
`,xn=o.div`
    display: flex;
    width: 100%;
`,wn=r.forwardRef(((r,o)=>{var{value:s,spacing:c,type:l,error:d,disabled:h,readOnly:f,onChange:g,onClear:p,allowClear:m=!1,className:F,styleType:y="bordered"}=r,v=u(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const D=a();i(o,(()=>D.current),[]);const B=function({ref:e,formatter:t}){return()=>{const n=e.current,r=n.value,a=t(r),i=r.substring(0,n.selectionEnd),o=t(i),s=i.length-o.length,c=Math.max(0,n.selectionEnd-s);return{nextValue:a,updateCaretPosition:()=>{n.value=a,n.setSelectionRange(c,c)}}}}({ref:D,formatter:e=>Bn.transformWithSpaces(e,c)}),S=e=>{g&&(b()?x(e):g(e))},$=()=>{p&&p(),D&&D.current&&D.current.focus()},b=()=>"tel"===l&&c,x=e=>{const{nextValue:t,updateCaretPosition:n}=B(),r=t.replace(/\s/g,"");e.target.value=r,g(e),n()},w=s?(e=>e?b()?Bn.transformWithSpaces(e,c):e:"")(s):s,E=()=>e(n,{children:[t(Sn,Object.assign({"data-testid":"input",ref:D,disabled:h,value:w,onChange:S,type:l,readOnly:f},v)),m&&!h&&!f&&!!s&&t($n,Object.assign({onClick:$,type:"button"},{children:t(bn,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===y?t(xn,Object.assign({className:F},{children:E()})):t(qt,Object.assign({$disabled:h,$error:d,$readOnly:f,className:F},{children:E()}))})}));export{wn as Input};
