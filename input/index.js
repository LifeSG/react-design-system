...
`,Kt=s`
    ...
    box-shadow: none;
`,en=s`
    border: 1px solid ${Mt.Red.Border};
    box-shadow: ${_t};
`,tn=o.div`
    border: 1px solid ${At[5]};
    border-radius: 4px;
