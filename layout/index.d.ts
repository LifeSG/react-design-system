...
export declare const Layout: {
    ...
    ColDiv: (props: import("./types").ColDivProps & import("react").RefAttributes<HTMLDivElement>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
};
export * from "./types";
