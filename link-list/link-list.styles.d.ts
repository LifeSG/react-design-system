...
export declare const ItemTitleDefault: import("styled-components").StyledComponent<"h3", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
export declare const ItemTitleSmall: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const Description: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const ToggleButtonLabel: import("styled-components").StyledComponent<"h5", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
