 ...
 */
export interface LinkListItemProps<T> extends Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, "title"> {
 ...
 */
export type LinkListProps<T> = LinkListBaseProps<T> & (LinkListEagerProps | LinkListLazyProps);
