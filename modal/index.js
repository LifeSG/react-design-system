...
`,u=c.div`
    ...
    ${t=>{let e="";return t.$show?e+=l`
            ...
            `,t.$disableTransition&&(e+=l`
                transition: none;
            `),e}}
`,h=({show:e=!1,rootId:c,onOverlayClick:l,children:d,backgroundOpacity:h,backgroundBlur:v=!0,disableTransition:f=!1,enableOverlayClick:g=!1,zIndex:y,id:b})=>{const[m,B]=n(null),[w,E]=n(),_=o(),k=o(!1),D=o(null),A=d&&r.cloneElement(d,{ref:D}),$=b?`lifesg-ds-overlay-root-${b}`:"lifesg-ds-overlay-root";i((()=>{const t=!0===k.current;if(t||(k.current=!0),e){const t=O();if(C(t),!t){const t=setTimeout((()=>{S("add")}),200);return()=>clearTimeout(t)}}else{if(!t)return;if(!_.current){const t=setTimeout((()=>{S("remove")}),200);return()=>clearTimeout(t)}}}),[e]),i((()=>{B(x());const t=O();return C(t),t||T(),()=>{S("remove")}}),[]);const C=t=>{_.current=t,E(t)},x=()=>document&&c?document.getElementById(c):document?document.body:null,O=()=>document.body.classList.contains(F),T=()=>{if(!document.getElementById(p)){const t=document.createElement("style");t.id=p;const e=document.documentElement.clientWidth,r=window.innerWidth-e;t.innerHTML=`\n\t\t\t\t.${F} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${r}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${F}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(t)}},S=t=>{const e=document.body.classList.contains(F);"add"!==t||e?"remove"===t&&e&&document.body.classList.remove(F):document.body.classList.add(F)},j=t=>{const e=D.current?.firstChild;e&&e.contains(t.target)||l&&g&&(t.preventDefault(),l())};return m?a.createPortal(t(s,{id:$,"data-testid":$,$show:e,zIndex:y,$stacked:w,children:d&&t(u,{"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:h||(w?.5:.8),$backgroundBlur:v,$disableTransition:f,$enableOverlayClick:g,onClick:j,children:A})}),m):null},p="lifesg-ds-overlay-stylesheet",F="lifesg-ds-overlay-open",v={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},f=t=>Object.keys(v).reduce(((e,r)=>{const n=v[r];return e[r]=`@media screen and (${t}: ${n}px)`,e}),{}),g=f("max-width"),y=(f("min-width"),c.div`
    position: relative;
    display: flex;
