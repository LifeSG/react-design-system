...
`,sr=t.div`
    ...
    ${e=>{let t="";return e.$show?t+=r`
            ...
            `,e.$disableTransition&&(t+=r`
                transition: none;
            `),t}}
`,dr=({show:e=!1,rootId:t,onOverlayClick:r,children:n,backgroundOpacity:o,backgroundBlur:a=!0,disableTransition:h=!1,enableOverlayClick:p=!1,zIndex:f,id:g})=>{const[m,y]=s(null),[b,v]=s(),$=d(),w=d(!1),F=d(null),S=n&&l.cloneElement(n,{ref:F}),B=g?`lifesg-ds-overlay-root-${g}`:"lifesg-ds-overlay-root";c((()=>{const t=!0===w.current;if(t||(w.current=!0),e){const e=A();if(x(e),!e){const e=setTimeout((()=>{E("add")}),200);return()=>clearTimeout(e)}}else{if(!t)return;if(!$.current){const e=setTimeout((()=>{E("remove")}),200);return()=>clearTimeout(e)}}}),[e]),c((()=>{y(k());const e=A();return x(e),e||_(),()=>{E("remove")}}),[]);const x=e=>{$.current=e,v(e)},k=()=>document&&t?document.getElementById(t):document?document.body:null,A=()=>document.body.classList.contains(hr),_=()=>{if(!document.getElementById(ur)){const e=document.createElement("style");e.id=ur;const t=document.documentElement.clientWidth,r=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${hr} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${r}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${hr}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},E=e=>{const t=document.body.classList.contains(hr);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(hr):document.body.classList.add(hr)},H=e=>{const t=F.current?.firstChild;t&&t.contains(e.target)||r&&p&&(e.preventDefault(),r())};return m?u.createPortal(i(cr,{id:B,"data-testid":B,$show:e,zIndex:f,$stacked:b,children:n&&i(sr,{"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:o||(b?.5:.8),$backgroundBlur:a,$disableTransition:h,$enableOverlayClick:p,onClick:H,children:S})}),m):null},ur="lifesg-ds-overlay-stylesheet",hr="lifesg-ds-overlay-open",pr=t.a`
    display: flex;
    justify-content: center;
