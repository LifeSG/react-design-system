...
`,zo=e=>{var{external:t=!1,children:r}=e,n=Vt(e,["external","children"]);return a(_o,Object.assign({},n,{children:[r,t&&i(jo,{})]}))};var Mo;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Mo||(Mo={}));const To={collections:{base:{InputBoxShadow:r`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return r`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?No.Button.Danger.Border:Wt.Primary};

                    color: ${e.$buttonIsDanger?No.Button.Danger.Primary:Wt.Primary};
                `;case"light":return r`
                    background-color: ${Wt.Neutral[8]};
                ...
                `;case"link":return r`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?No.Button.Danger.Hover:Wt.Secondary};
                    }
                `;default:return r`
                    background-color: ${e.$buttonIsDanger?No.Button.Danger.BackgroundColor:Wt.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?r`
                ...
                `}
`,Wo=t((({color:e,className:t,size:r=18})=>a(mo,Object.assign({className:t,$size:r,$color:e},{children:[i(bo,{id:"inner1",$size:r-2,$borderWidth:2,$color:e}),i(vo,{id:"inner2",$size:r-2,$borderWidth:2,$color:e}),i($o,{id:"inner3",$size:r-2,$borderWidth:2,$color:e}),i(Fo,{id:"inner4",$size:r-2,$borderWidth:2,$color:e})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?No.Button.Danger.Primary:Wt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Wt.Neutral[3](e);break;default:t=Wt.Neutral[8](e)}return r`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
        ...
        `}}
`,Yo={Default:s.forwardRef(((e,t)=>{const{children:r,disabled:n=!1,loading:o=!1,styleType:s="default",danger:l=!1}=e,c=Vt(e,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:n?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return a(Lo,Object.assign({ref:t,"data-testid":c["data-testid"]||"button",disabled:n},d,c,{children:[o&&i(Wo,Object.assign({},d)),i("span",{children:r})]}))})),Small:s.forwardRef(((e,t)=>{const{children:r,disabled:n=!1,loading:o=!1,styleType:s="default",danger:l=!1}=e,c=Vt(e,["children","disabled","loading","styleType","danger"]),d={$buttonStyle:n?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return a(Lo,Object.assign({ref:t,"data-testid":c["data-testid"]||"button",disabled:n},d,c,{children:[o&&i(Wo,Object.assign({},d,{size:16})),i("span",{children:r})]}))}))},Ro=t.ul`
    display: flex;
    list-style: none;
    margin-left: 4rem;
    flex-shrink: 0;
