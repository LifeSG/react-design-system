...
`,Kt=h.div`
    ...
    ${e=>{let r="";return e.$show?r+=b`
            ...
            `,e.$disableTransition&&(r+=b`
                transition: none;
            `),r}};
`;var ea;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(ea||(ea={}));const ra=({show:r=!1,rootId:n,onOverlayClick:s,children:t,backgroundOpacity:o,backgroundBlur:d=!0,disableTransition:g=!1,enableOverlayClick:c=!1,zIndex:u,id:m,containerRef:h})=>{const[b,p]=l(null),[f,y]=l(),[x]=l((()=>Xt.generate())),$=w(),C=i(),E=i(!1),D=i(null),k=m?`lifesg-ds-overlay-root-${m}`:"lifesg-ds-overlay-root",S=null!=u?u:f?99999:99998;(e=>{const r=v();a((()=>{if(!r)return;const n={zIndex:e};r.events.emit(ea.Change,n)}),[r,e]),a((()=>{if(!r)return;const n=()=>{const n={zIndex:e};r.events.emit(ea.Change,n)};return null==r||r.events.on(ea.Ready,n),()=>null==r?void 0:r.events.off(ea.Ready,n)}),[r,e])})(S),a((()=>(M(),p(z()),()=>{L(),_().length<1&&(A()&&(W("remove"),N()),j("remove"))})),[]),a((()=>{if(r){const e=O();B(e),P(),A()&&1===_().length&&(T(),W("add"));const r=setTimeout((()=>{j("add")}),200);return()=>clearTimeout(r)}{L(),A()&&_().length<1&&(W("remove"),N());const e=setTimeout((()=>{_().length<1&&j("remove")}),200);return()=>clearTimeout(e)}}),[r]),a((()=>{if(r)return document.addEventListener("mousedown",Y,!0),()=>{document.removeEventListener("mousedown",Y,!0)}}),[r]);const B=e=>{C.current=e,y(e)},A=()=>/(iPad|iPhone|iPod)/g.test(navigator.userAgent),z=()=>document&&n?document.getElementById(n):document?document.body:null,O=()=>_().length>0,M=()=>{if(!document.getElementById(sa)){const e=document.createElement("style");e.id=sa;const r=document.documentElement.clientWidth,n=window.innerWidth-r;e.innerHTML=`\n\t\t\t\t.${ta} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${ta}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\n\t\t\t\t.${aa} {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: var(${ia}, 0);\n\t\t\t\t\tbottom: 0;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},j=e=>{const r=document.body.classList.contains(ta);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(ta):document.body.classList.add(ta)},_=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},P=()=>{const e=_();document.body.dataset.lifesgDsOverlayOrder=[...e,x].join(",")},L=()=>{const e=_();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==x)).join(",")},W=e=>{if(!A())return;const r=document.body.classList.contains(aa);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(aa):document.body.classList.add(aa)},T=()=>{const e=document.body.style,r=e.top?e.top:window.scrollY+"px";document.body.style.setProperty(ia,r)},N=()=>{if(!A())return;const e=document.body.style.getPropertyValue(ia);requestAnimationFrame((()=>{window.scrollTo({top:parseFloat(e)})}))},Y=e=>{var r;const n=null!==(r=null==h?void 0:h.current)&&void 0!==r?r:D.current,s=D.current;if(!n)return void(E.current=!1);const t=e.target,a=s===t,i=n===t,o=n.contains(t);E.current=!a&&(i||o)},R=e=>{var r;const n=null!==(r=null==h?void 0:h.current)&&void 0!==r?r:D.current,t=D.current;if(!n)return void(E.current=!1);const a=e.target,i=t===a,o=n===a,d=n.contains(a);!i&&(o||d)||E.current||!s||!c||(e.preventDefault(),s()),E.current=!1};return b?I.createPortal(e(Zt,{id:k,"data-testid":k,$show:r,$zIndex:S,children:t&&e(F,{id:$,children:e(Kt,{ref:D,"data-testid":"overlay-wrapper",$show:r,$stacked:f,$backgroundBlur:d,$disableTransition:g,onClick:R,children:t})})}),b):null},na=r=>e(x,{children:e(ra,Object.assign({},r))}),sa="lifesg-ds-overlay-stylesheet",ta="lifesg-ds-overlay-open",aa="lifesg-ds-overlay-scroll-lock",ia="--lifesg-ds-overlay-scroll-y",oa=h.a`
    display: flex;
...
`;const Il=s.forwardRef((function(n,s){var{id:t="modal-box",children:a,onClose:i,showCloseButton:o=!0}=n,d=R(n,["id","children","onClose","showCloseButton"]);return r(Pl,Object.assign({ref:s,"data-testid":t},d,{onClick:e=>{e.stopPropagation()},children:[o&&e(Ll,{onClick:i,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:e(W,{})}),a]}))}));Il.displayName="Modal.Box";const Wl=e=>{const{textSize:r}=e||{};return b`
        // Text styling
        ${r&&Zs[`${r}-regular`]}
    ...
    pointer-events: auto;
    outline: none;
`,Nl=h((r=>{var{children:n}=r,s=R(r,["children"]);const t=s["data-testid"]||"card";return e(_l,Object.assign({},s,{"data-testid":t,children:"string"==typeof n?e(xl.BodyBL,{children:n}):n}))}))`
    color: ${Gs.text};
    ${Wl({textSize:"body-md"})}
...
`;const Yl=g({onClose:()=>{}}),Rl=h.div`
    ...
    ${e=>b`
        ...
        &[data-status="open"] {
            opacity: 1;
            ${e.$animationFrom}: 0;
            transition: all ${Ks["duration-250"]} ${Ks["ease-entrance"]};
        ...
        &[data-status="close"] {
            opacity: 0;
            ${e.$animationFrom}: -3%;
            transition: all ${Ks["duration-250"]} ${Ks["ease-exit"]};
        }
    `}
`,Hl=h.div`
    display: flex;
...
`,Gl=h.div`
    ...
    ${e=>e.$hasCloseButton?b`
              ...
              `}
`,Zl=r=>{var{"data-testid":n="modal-close-button"}=r,s=R(r,["data-testid"]);const{onClose:a}=t(Yl);return e(Ql,Object.assign({"data-testid":n},s,{children:e(ql,{onClick:a,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser","aria-label":"Close button",children:e(W,{"aria-hidden":!0})})}))};Zl.displayName="ModalV2.CloseButton";const Kl=r=>{var{"data-testid":n="modal-content",children:s}=r,t=R(r,["data-testid","children"]);return e(Jl,Object.assign({"data-testid":n},t,{children:s}))};Kl.displayName="ModalV2.Content";const eg=e=>{var{"data-testid":n="modal-footer",primaryButton:s,secondaryButton:t}=e,a=R(e,["data-testid","primaryButton","secondaryButton"]);return r(Xl,Object.assign({"data-testid":n},a,{children:[s,t]}))};eg.displayName="ModalV2.Footer";const rg=s.forwardRef((function(e,n){var{id:t,"data-testid":a="modal-card",children:i}=e,o=R(e,["id","data-testid","children"]);const d=e=>s.Children.toArray(i).find((r=>((e,r)=>y(e.type)?e.type.target===r:e.type===r)(r,e))),l=d(Zl),g=d(Kl),c=d(eg),u=!!l;return r(Ul,Object.assign({ref:n,id:t,"data-testid":a},o,{onClick:e=>{e.stopPropagation()},children:[r(Gl,{$hasCloseButton:u,children:[g,c]}),u&&l]}))}));rg.displayName="ModalV2.Card";const ng=Object.assign((r=>{var{id:n,show:t,onClose:g,animationFrom:c="bottom",children:u,enableOverlayClick:m=!0,rootComponentId:h,zIndex:b,onOverlayClick:p,dismissKeyboardOnShow:f=!0,"data-testid":y="modal","aria-label":v,"aria-labelledby":x,"aria-describedby":w,disableInitialFocus:F=!1}=r,S=R(r,["id","show","onClose","animationFrom","children","enableOverlayClick","rootComponentId","zIndex","onOverlayClick","dismissKeyboardOnShow","data-testid","aria-label","aria-labelledby","aria-describedby","disableInitialFocus"]);const{verticalHeight:B,offsetTop:A}=(()=>{const[e,r]=l(),[n,s]=l(),t=d((()=>{const e=.01*window.innerHeight;r(e)}),[]),i=d((()=>{if(window.visualViewport){const e=.01*window.visualViewport.height;r(e),s(window.visualViewport.offsetTop)}}),[]);return a((()=>window.visualViewport?(i(),window.visualViewport.addEventListener("resize",i),()=>{var e;null===(e=window.visualViewport)||void 0===e||e.removeEventListener("resize",i)}):(t(),window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t)})),[]),{verticalHeight:e,offsetTop:n}})(),z=i(null),O=u&&s.cloneElement(u,{ref:z}),{refs:M,context:j}=$({open:t,onOpenChange:e=>{e||null==g||g()}}),{isMounted:_,status:P}=C(j,{duration:300}),L=E(j,{outsidePress:!1,enabled:!!g}),{getFloatingProps:I}=D([L]),W=function(e){const r=i(null);return o((()=>{r.current=e}),[e]),d(((...e)=>{var n;return null===(n=r.current)||void 0===n?void 0:n.call(r,...e)}),[])}((()=>{var e,r;f&&(null===(r=null===(e=document.activeElement)||void 0===e?void 0:e.blur)||void 0===r||r.call(e))}));return a((()=>{t&&W()}),[t,W]),e(na,{"data-testid":`${y}-overlay`,show:_,enableOverlayClick:m,onOverlayClick:p,id:n,rootId:h,containerRef:z,zIndex:b,children:e(Rl,Object.assign({$show:_,$animationFrom:c,"data-testid":y,$verticalHeight:B,$offsetTop:A,"data-status":P},S,{children:e(Yl.Provider,{value:{onClose:g},children:_&&e(k,{context:j,initialFocus:F?-1:M.floating,children:e(Hl,{children:e(Vl,Object.assign({ref:M.setFloating},I(),{role:"dialog","aria-label":v,"aria-labelledby":x,"aria-describedby":w,children:O}))})})})}))})}),{Card:rg,CloseButton:Zl,Content:Kl,Footer:eg}),sg=s=>{var{children:a,visible:i,onMobileClose:o,maxHeight:d,overflow:l,ariaLabel:g,id:c}=s,u=R(s,["children","visible","onMobileClose","maxHeight","overflow","ariaLabel","id"]);const m=u["data-testid"]||"popover",h=t(p),b=tt["sm-max"]({theme:h}),f=jl.useMediaQuery({maxWidth:b}),y=()=>{o&&o()},v=()=>"string"==typeof a?e(xl.BodyMD,{children:a}):a;return r(n,{children:[i&&e(Tl,Object.assign({tabIndex:0,"data-testid":m},u,{id:c,role:"dialog","aria-label":null!=g?g:"More information",children:e(Nl,{$maxHeight:d,$overflow:l,children:v()})})),f&&e(ng,{show:null!=i&&i,onOverlayClick:y,onClose:y,id:c,role:"dialog","aria-label":null!=g?g:"More information",children:r(ng.Card,{children:[e(ng.Content,{children:v()}),e(ng.CloseButton,{})]})})]})},tg=h.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,ag=s=>{var o,d,{children:g,popoverContent:c,trigger:u="click",position:m="top",zIndex:h,rootNode:b,customOffset:f,delay:y,onPopoverAppear:x,onPopoverDismiss:w,popoverAriaLabel:F,enableFlip:C=!0,enableResize:I=!1,overflow:W="auto",triggerOnFocus:T=!1,isModal:N=!0}=s,Y=R(s,["children","popoverContent","trigger","position","zIndex","rootNode","customOffset","delay","onPopoverAppear","onPopoverDismiss","popoverAriaLabel","enableFlip","enableResize","overflow","triggerOnFocus","isModal"]);const[H,V]=l(!1),U=i(null),Q=i(null),q=t(p),J=tt["sm-max"]({theme:q}),X=jl.useMediaQuery({maxWidth:J}),[G,Z]=l(0),K=`${i(Xt.generate()).current}-popover`,{refs:ee,floatingStyles:re,context:ne}=$({open:H,placement:m,whileElementsMounted:S,middleware:[B(null!=f?f:16),C&&A(),z({limiter:O()}),I&&M({apply({availableHeight:e}){Z(e)}})],onOpenChange:e=>{V(e),H!==e&&ue(e)}}),se=(()=>{const[e,r]=l(void 0),n=v();return a((()=>{if(!n)return void r(void 0);const e=e=>{r(e.zIndex)};return n.events.on(ea.Change,e),n.events.emit(ea.Ready),()=>n.events.off(ea.Change,e)}),[n]),e})(),te="hover"===(X?"click":u),ae=j(ne,{ignoreMouse:te}),ie=E(ne),oe=_(ne,{enabled:te,delay:{open:null!==(o=null==y?void 0:y.open)&&void 0!==o?o:0,close:null!==(d=null==y?void 0:y.close)&&void 0!==d?d:500}}),de=P(ne,{enabled:T}),{getReferenceProps:le,getFloatingProps:ge}=D([ae,ie,oe,de]),ce=()=>{V(!1),ue(!1)},ue=e=>{e&&x&&x(),!e&&w&&w()};return r(n,{children:[e(tg,Object.assign({ref:e=>{U.current=e,ee.setReference(e)}},le({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),Y,{children:g})),H&&e(L,{root:b,children:e(k,Object.assign({context:ne},!N&&{initialFocus:-1,returnFocus:!1,modal:!1},{children:e("div",Object.assign({ref:e=>{Q.current=e,ee.setFloating(e)},onBlur:e=>{var r;const n=null!==(r=e.relatedTarget)&&void 0!==r?r:document.activeElement;n&&(e=>{var r;if(!e)return!1;if(e instanceof HTMLElement&&e.hasAttribute("data-floating-ui-focus-guard"))return!0;const n=U.current,s=null===(r=Q.current)||void 0===r?void 0:r.parentElement;return!!n&&n.contains(e)||!!s&&s.contains(e)})(n)||(V(!1),ue(!1))},style:Object.assign(Object.assign({},re),{outline:"none",zIndex:null!=h?h:se})},ge(),{children:"function"==typeof c?c(I?{maxHeight:G,overflow:W}:{}):e(sg,{visible:!0,onMobileClose:ce,maxHeight:I?G:void 0,overflow:I?W:void 0,ariaLabel:F,id:K,children:c})}))}))})]})},ig=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}};h.span`
...
`,dg=r=>{var{children:n,"data-testid":s="menu-content",overflow:t,maxHeight:a}=r,i=R(r,["children","data-testid","overflow","maxHeight"]);return e(og,Object.assign({$overflow:t,$maxHeight:a,"data-testid":s,tabIndex:-1,onKeyDown:e=>{var r;const n="ArrowDown"===e.key||"ArrowRight"===e.key,s="ArrowUp"===e.key||"ArrowLeft"===e.key;if(!n&&!s)return;const t=(e=>Array.from(e.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter((e=>!e.hasAttribute("disabled"))))(e.currentTarget);if(!t.length)return;const a=document.activeElement,i=a?t.indexOf(a):-1;e.preventDefault();const o=n?1:-1;null===(r=t[-1===i?n?0:t.length-1:(i+o+t.length)%t.length])||void 0===r||r.focus()}},i,{children:n}))};dg.displayName="Menu.Content";const lg=h.li`
    display: flex;
    flex-direction: column;
    padding: ${rt["spacing-8"]} ${rt["spacing-16"]};
`,gg=h(xl.BodySM)`
    color: ${Gs["text-subtler"]};
`,cg=n=>{var{label:s,subLabel:t,children:a,"data-testid":i="menu-item"}=n,o=R(n,["label","subLabel","children","data-testid"]);return r(lg,Object.assign({"data-testid":i},o,{children:[s&&e(xl.BodyMD,{weight:"semibold",children:s}),t&&e(gg,{children:t}),a]}))};cg.displayName="Menu.Item";const ug=h.li`
    display: flex;
    flex-direction: column;
`,mg=h(xl.LinkMD)`
    color: ${Gs.text};
...
`,hg=r=>{var{children:n,"data-testid":s="menu-link"}=r,t=R(r,["children","data-testid"]);return e(ug,{children:e(mg,Object.assign({"data-testid":s,underlineStyle:"none"},t,{children:n}))})};hg.displayName="Menu.Link";const bg=h.ul`
    ${e=>e.$showDivider&&b`
...
`,pg=h(xl.BodyXS)`
    ...
    color: ${Gs["text-subtler"]};
`,fg=n=>{var{children:s,label:t,showDivider:a=!0,"data-testid":i="menu-section"}=n,o=R(n,["children","label","showDivider","data-testid"]);const[d]=l((()=>Xt.generate()));return r(bg,Object.assign({$showDivider:a,"data-testid":i,"aria-labelledby":d},o,{children:[t&&e(pg,{weight:"semibold",id:d,children:t}),s]}))};fg.displayName="Menu.Section";const yg=Object.assign((r=>{var{children:n,position:s="bottom-start",menuContent:t,"data-testid":a="menu"}=r,i=R(r,["children","position","menuContent","data-testid"]);return e(ag,Object.assign({position:s,popoverContent:e=>c(t,{overflow:e.overflow,maxHeight:e.maxHeight}),"data-testid":a},i,{children:n}))}),{Content:dg,Section:fg,Item:cg,Link:hg}),vg=h.ul`
    list-style: none;
    display: flex;
    flex-direction: column;
...
`,Fg=({items:r,onItemClick:s})=>{const t=e=>r=>{r.stopPropagation(),s(r,e)};return(null==r?void 0:r.length)?e(vg,{children:r.map(((r,n)=>{const{children:s,options:a}=r,i=R(r,["children","options"]),o=`menu__mobile-${n+1}`;return e(xg,{children:e(wg,Object.assign({"data-testid":o},i,a,{onClick:t(r),underlineStyle:"none",children:s}))},n)}))}):e(n,{})},$g=h.ul`
    display: flex;
    list-style: none;
    position: relative;
...
`,jg=({items:s,selectedId:t,mobile:o=!1,hideNavBranding:d,hideLinkIndicator:g=!1,onItemClick:c})=>{const[u,m]=l(-1),[h,b]=l(!1),[p,f]=l(null),y=i(null),[v]=l((()=>Xt.generate()));a((()=>{const e=e=>{y.current&&!y.current.contains(e.target)&&(b(!1),m(-1),f(null))};return document.addEventListener("click",e,!0),()=>{document.removeEventListener("click",e,!0)}}),[]);const x=(e,r)=>n=>{var s;if(n.stopPropagation(),o&&(null===(s=e.subMenu)||void 0===s?void 0:s.length)){const e=!(u===r&&h);m(r),b(e)}c(n,e)},w=(e,r)=>{e.stopPropagation(),c(e,r),b(!1),m(-1)},F=(r,n)=>e(yg.Content,{id:n,children:e(yg.Section,{showDivider:!1,children:r.map(((r,n)=>e(yg.Link,{href:r.href,children:r.children},`${r.id}-${n}`)))})}),$=r=>e(Fg,{items:r,onItemClick:w}),C=(s,a)=>{const{children:i,options:l,subMenu:c}=s,m=R(s,["children","options","subMenu"]),b=!!(null==c?void 0:c.length),y=(e=>{var r;return e.id===t||!!(null===(r=e.subMenu)||void 0===r?void 0:r.length)&&!!e.subMenu.find((e=>e.id===t))})(s),w=o&&b&&u===a&&h,C=!o&&b&&p===a||w,E=null!==p?p===a:y,D=!g&&E,k=E?o?"bold":"semibold":"regular",S=o?`link__mobile-${a+1}`:`link__${a+1}`,B=()=>D?e(Ag,{"data-testid":`${S}-indicator`,$selected:E}):null;return e(Eg,{$hiddenBranding:d,children:b?(()=>{const t=`navbar-submenu-${v}-${s.id}`;return o?r(n,{children:[r(kg,Object.assign({"data-testid":S,weight:k,$selected:E,underlineStyle:"none"},m,{"aria-current":y?"page":void 0,"aria-haspopup":"menu","aria-expanded":C,onClick:x(s,a)},l,{children:[e(Bg,{children:i}),B(),o&&b?e(zg,{children:e(Og,{"data-testid":`${S}-expand-collapse-button`,$selected:w,focusHighlight:!1,focusOutline:"browser","aria-label":w?"Collapse":"Expand",children:e(Mg,{$selected:E})})}):null]})),w&&$(c)]}):e(yg,{position:"bottom",customOffset:0,menuContent:F(c,t),triggerOnFocus:!0,isModal:!1,onPopoverAppear:()=>f(a),onPopoverDismiss:()=>{f((e=>e===a?null:e))},children:r(Sg,Object.assign({type:"button",tabIndex:0,"data-testid":S,weight:k,$selected:E,"aria-haspopup":"menu","aria-expanded":C},l,{children:[e(Bg,{children:i}),B()]}))})})():r(kg,Object.assign({tabIndex:0,"data-testid":S,weight:k,$selected:E,underlineStyle:"none"},m,{"aria-current":y?"page":void 0,onClick:x(s,a)},l,{children:[e(Bg,{children:i}),B()]}))},a)},E=()=>s.map(((r,n)=>{var s;return"component"===r.itemType?e("li",{children:null!==(s=r.children)&&void 0!==s?s:null},n):C(r,n)}));return s&&s.length>0?o?e(Cg,{ref:y,children:E()}):e($g,{ref:y,$alignLeft:d,children:E()}):e(n,{})},_g={primary:{brandName:"LifeSG",logoSrc:"https://assets.life.gov.sg/lifesg/logo-lifesg.svg"}},Pg={primary:{brandName:"BookingSG",logoSrc:"https://www.booking.gov.sg/logo.svg"}},Lg={primary:{brandName:"CCube",logoSrc:"https://assets.life.gov.sg/ccube/logo-ccube.svg"}},Ig={primary:{brandName:"IMDA",logoSrc:"https://assets.life.gov.sg/react-design-system/img/logo/imda-logo.svg"}},Wg={primary:{brandName:"MyLegacy",logoSrc:"https://mylegacy.life.gov.sg/images/site-logo.png"}},Tg={primary:{brandName:"SPF",logoSrc:"https://assets.life.gov.sg/react-design-system/img/logo/spf-logo.png"}},Ng={primary:{brandName:"SupportGoWhere",logoSrc:"https://assets.life.gov.sg/react-design-system/img/logo/sgw-logo.png"}},Yg=u(((s,o)=>{var{items:d,className:g,id:c,selectedId:u,compress:h=!1,fixed:b=!0,resources:f,hideNavElements:y=!1,hideNavBranding:v=!1,hideLinkIndicator:x=!1,drawerDismissalExclusions:w=[],actionButtons:F,onItemClick:$,onActionButtonClick:C,onBrandClick:E,masthead:D=!0,layout:k="default",headerLabel:S="Main navigation menu",drawerLabel:B}=s,A=R(s,["items","className","id","selectedId","compress","fixed","resources","hideNavElements","hideNavBranding","hideLinkIndicator","drawerDismissalExclusions","actionButtons","onItemClick","onActionButtonClick","onBrandClick","masthead","layout","headerLabel","drawerLabel"]);const[z,O]=l(!1),[M,j]=l(!1),_=i(null),P="stretch"===k,L=i(null),I=t(p),W=(e=>{switch(e){case"bookingsg":return Pg;case"mylegacy":return Wg;case"ccube":return Lg;case"spf":return Tg;case"supportgowhere":return Ng;case"imda":return Ig;default:return _g}})(null==I?void 0:I.resourceScheme),T=tt["lg-max"]({theme:I}),N=(null==f?void 0:f.primary)||W.primary,Y=null==f?void 0:f.secondary;m(o,(()=>Object.assign(L.current,{dismissDrawer:()=>{H()}})),[z]),a((()=>(U(),window.addEventListener("resize",U),()=>{window.removeEventListener("resize",U)})),[]);const H=()=>{O(!1),setTimeout((()=>{j(!1)}),550)},V=e=>z&&-1===w.indexOf(e),U=()=>{window.innerWidth<=T&&z&&H()},Q=(e,r)=>{E&&E(r),V("brand-click")&&H()},q=(e,r)=>{zl.isNavItemCommon(r)&&r.onClick?r.onClick(e):$&&(e.preventDefault(),$(r)),zl.isNavItemLink(r)&&!r.subMenu&&V("item-click")&&H()},J=(e,r)=>{var n;"button"!==r.type&&"download"!==r.type||!(null===(n=r.args)||void 0===n?void 0:n.onClick)?C&&(e.preventDefault(),C(r)):r.args.onClick(e),V("item-click")&&H()},X=()=>{O(!0),j(!0)},G=()=>{V("close-button-click")&&H()},Z=()=>{const r=d.mobile||d.desktop;return r&&r.length>0||F&&(e=>{const r=e.mobile||e.desktop;return!!r&&r.length&&r.some((e=>!e.uncollapsible))})(F)?e(wa,{ref:_,"aria-label":z?"Close nav menu":"Open nav menu","aria-expanded":z,"data-testid":"button__mobile-menu",onClick:X,focusHighlight:!1,children:e(Fa,{})}):null};return r(ya,{ref:L,$fixed:b,className:g,id:c||"navbar-wrapper","data-testid":A["data-testid"]||"navbar-wrapper",children:[D&&e(Et,{stretch:P}),r($t.Content,{stretch:P,children:[r(va,{$compress:h,"aria-label":S,children:[!v&&r($a,{$compress:h,"data-id":"brand-container",children:[N&&e(la,{resources:N,onClick:Q,"data-id":"brand-primary","data-testid":"main__brand",type:"primary"}),Y&&r(n,{children:[e(Ca,{$compress:h}),e(la,{resources:Y,onClick:Q,"data-id":"brand-secondary","data-testid":"main__brand-secondary",type:"secondary"})]})]}),!y&&r(xa,{$hideNavBranding:v,children:[e(jg,{items:d.desktop,onItemClick:q,selectedId:u,hideNavBranding:v,hideLinkIndicator:x}),e(Al,{actionButtons:F,onActionButtonClick:J}),Z()]})]}),!y&&e(na,{show:M,enableOverlayClick:!0,onOverlayClick:G,children:r(Ea,{show:z,resources:{primary:N,secondary:Y},onClose:G,onBrandClick:Q,actionButtons:F,hideNavBranding:v,mobileMenuRef:_,drawerLabel:B,children:[e(jg,{items:d.mobile||d.desktop,onItemClick:q,selectedId:u,mobile:!0,hideLinkIndicator:x}),e(Al,{actionButtons:F,onActionButtonClick:J,mobile:!0})]})})]})]})}));export{Yg as Navbar};
