...
`,Ya=({items:e,selectedId:i,mobile:o=!1,onItemClick:a})=>{const[l,u]=s(-1),[h,p]=s(!1),f=d(null);c((()=>{const e=e=>{f.current&&!f.current.contains(e.target)&&g()};return document.addEventListener("click",e,!0),()=>{document.removeEventListener("click",e,!0)}}),[]);const g=()=>{p(!1)},m=(e,t)=>r=>{r.stopPropagation(),u(t),p(!0),a(r,e)},y=(e,t)=>{e.stopPropagation(),a(e,t),p(!1)},b=()=>e.map(((e,n)=>{const a=(e=>{if(e.id===i)return!0;if(e?.subMenu&&e.subMenu.length>=1)return!!e.subMenu.find((e=>e.id===i));return!1})(e),{children:c,options:s,...d}=e,u=o?`link__mobile-${n+1}`:`link__${n+1}`,p=l>=0&&l===n&&h;return r(Ta,{children:[r(La,{"data-testid":u,weight:a?o?"bold":"semibold":"regular",$selected:a,...d,onClick:m(e,n),...s,children:[t(Pa,{children:c}),a&&t(Ra,{}),o&&e.subMenu&&t(Va,{children:t(Ma,{"data-testid":`${u}-expand-collapse-button`,$selected:p,focusHighlight:!1,focusOutline:"browser","aria-label":p?"Collapse":"Expand",children:t(Ua,{})})})]}),p&&t(Da,{items:e.subMenu,mobile:o,onItemClick:y})]},n)}));if(e&&e.length>0){return t(o?Wa:Ia,{ref:f,children:b()})}return t(n,{})},Ga=l.forwardRef((({items:e,id:i,selectedId:o,compress:a=!1,fixed:l=!0,resources:d=Qa,hideNavElements:u=!1,drawerDismissalExclusions:h=[],actionButtons:p,onItemClick:f,onActionButtonClick:g,onBrandClick:m,masthead:y=!0,layout:b="default",...v},w)=>{const[$,x]=s(!1),[S,B]=s(!1),C="stretch"===b,{primary:k=Qa.primary,secondary:F}=d;c((()=>(H(),window.addEventListener("resize",H),()=>{window.removeEventListener("resize",H)})),[]);const _=()=>{x(!1),setTimeout((()=>{B(!1)}),550)},A=e=>$&&-1===h.indexOf(e),H=()=>{window.innerWidth<=Tt.tablet&&$&&_()},j=(e,t)=>{m&&(e.preventDefault(),m(t)),A("brand-click")&&_()},D=(e,t)=>{t.onClick?t.onClick(e):f&&(e.preventDefault(),f(t)),!t?.subMenu&&A("item-click")&&_()},E=(e,t)=>{t.args&&t.args.onClick?t.args.onClick(e):g&&(e.preventDefault(),g(t)),A("item-click")&&_()},z=()=>{x(!0),B(!0)},O=()=>{A("close-button-click")&&_()};return r(Yt,{ref:w,$fixed:l,id:i||"navbar-wrapper","data-testid":v["data-testid"]||"navbar-wrapper",children:[y&&t(ar,{}),r(ir.Content,{stretch:C,children:[r(Gt,{$compress:a,children:[r(Kt,{children:[t(mr,{resources:k,compress:a,onClick:j,"data-testid":"main__brand",type:"primary"}),F&&r(n,{children:[t(qt,{$compress:a}),t(mr,{resources:F,compress:a,onClick:j,"data-testid":"main__brand-secondary",type:"secondary"})]})]}),!u&&r(Qt,{children:[t(Ya,{items:e.desktop,onItemClick:D,selectedId:o}),t(Ba,{actionButtons:p&&p.desktop,onActionButtonClick:E}),t(Xt,{"aria-label":"Open nav menu","data-testid":"button__mobile-menu",onClick:z,focusHighlight:!1,children:t(Jt,{})})]})]}),!u&&t(ur,{show:S,enableOverlayClick:!0,onOverlayClick:O,children:r(Fr,{show:$,resources:{primary:k,secondary:F},onClose:O,onBrandClick:j,actionButtons:p,children:[t(Ya,{items:e.mobile||e.desktop,onItemClick:D,selectedId:o,mobile:!0}),t(Ba,{actionButtons:p&&(p?.mobile||p.desktop),onActionButtonClick:E,mobile:!0})]})})]})]})})),Qa={primary:{brandName:"LifeSG",logoSrc:"https://assets.life.gov.sg/lifesg/logo-lifesg.svg"}},Xa=Ut,Ja=3.5;export{Ga as Navbar,Xa as NavbarHeight,Ja as NavbarMobileHeight};
