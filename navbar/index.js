...
`,Ia=({items:e,selectedId:t,mobile:r=!1,onItemClick:n})=>{const[l,u]=s(-1),[h,p]=s(!1),g=d(null);c((()=>{const e=e=>{g.current&&!g.current.contains(e.target)&&f()};return document.addEventListener("click",e,!0),()=>{document.removeEventListener("click",e,!0)}}),[]);const f=()=>{p(!1)},m=(e,t)=>r=>{r.stopPropagation(),u(t),p(!0),n(r,e)},b=(e,t)=>{e.stopPropagation(),n(e,t),p(!1)},y=()=>e.map(((e,n)=>{if("component"===e.itemType){const t=e&&e.children||null;return i("li",{children:t},n)}{const a=(e=>{if(e.id===t)return!0;if((null==e?void 0:e.subMenu)&&e.subMenu.length>=1)return!!e.subMenu.find((e=>e.id===t));return!1})(e),{children:c,options:s}=e,d=Vt(e,["children","options"]),u=a?r?"bold":"semibold":"regular",p=r?`link__mobile-${n+1}`:`link__${n+1}`,g=l>=0&&l===n&&h;return o(Ea,{children:[o(Ha,Object.assign({"data-testid":p,weight:u,$selected:a},d,{onClick:m(e,n)},s,{children:[i(Da,{children:c}),a&&i(Oa,{}),r&&e.subMenu&&i(Ca,{children:i(za,Object.assign({"data-testid":`${p}-expand-collapse-button`,$selected:g,focusHighlight:!1,focusOutline:"browser","aria-label":g?"Collapse":"Expand"},{children:i(Na,{})}))})]})),g&&i(Aa,{items:e.subMenu,mobile:r,onItemClick:b})]},n)}}));if(e&&e.length>0){return i(r?_a:ja,Object.assign({ref:g},{children:y()}))}return i(a,{})},Ta=u(((e,t)=>{var{items:r,className:n,id:l,selectedId:u,compress:p=!1,fixed:g=!0,resources:f=Wa,hideNavElements:m=!1,drawerDismissalExclusions:b=[],actionButtons:y,onItemClick:v,onActionButtonClick:$,onBrandClick:w,masthead:F=!0,layout:S="default"}=e,x=Vt(e,["items","className","id","selectedId","compress","fixed","resources","hideNavElements","drawerDismissalExclusions","actionButtons","onItemClick","onActionButtonClick","onBrandClick","masthead","layout"]);const[B,k]=s(!1),[A,j]=s(!1),_="stretch"===S,E=d(),{primary:H=Wa.primary,secondary:D}=f;h(t,(()=>Object.assign(E.current,{dismissDrawer:()=>{O()}})),[B]),c((()=>(z(),window.addEventListener("resize",z),()=>{window.removeEventListener("resize",z)})),[]);const O=()=>{k(!1),setTimeout((()=>{j(!1)}),550)},C=e=>B&&-1===b.indexOf(e),z=()=>{window.innerWidth<=Pt.tablet&&B&&O()},N=(e,t)=>{w&&(e.preventDefault(),w(t)),C("brand-click")&&O()},I=(e,t)=>{t.onClick?t.onClick(e):v&&(e.preventDefault(),v(t)),!(null==t?void 0:t.subMenu)&&C("item-click")&&O()},T=(e,t)=>{t.args&&t.args.onClick?t.args.onClick(e):$&&(e.preventDefault(),$(t)),C("item-click")&&O()},W=()=>{k(!0),j(!0)},P=()=>{C("close-button-click")&&O()};return o(Qt,Object.assign({ref:E,$fixed:g,className:n,id:l||"navbar-wrapper","data-testid":x["data-testid"]||"navbar-wrapper"},{children:[F&&i(cr,{}),o(ar.Content,Object.assign({stretch:_},{children:[o(Xt,Object.assign({$compress:p},{children:[o(Zt,Object.assign({$compress:p,"data-id":"brand-container"},{children:[i(yr,{resources:H,onClick:N,"data-id":"brand-primary","data-testid":"main__brand",type:"primary"}),D&&o(a,{children:[i(er,{$compress:p}),i(yr,{resources:D,onClick:N,"data-id":"brand-secondary","data-testid":"main__brand-secondary",type:"secondary"})]})]})),!m&&o(Jt,{children:[i(Ia,{items:r.desktop,onItemClick:I,selectedId:u}),i(va,{actionButtons:y,onActionButtonClick:T}),i(Kt,Object.assign({"aria-label":"Open nav menu","data-testid":"button__mobile-menu",onClick:W,focusHighlight:!1},{children:i(qt,{})}))]})]})),!m&&i(pr,Object.assign({show:A,enableOverlayClick:!0,onOverlayClick:P},{children:o(Br,Object.assign({show:B,resources:{primary:H,secondary:D},onClose:P,onBrandClick:N,actionButtons:y},{children:[i(Ia,{items:r.mobile||r.desktop,onItemClick:I,selectedId:u,mobile:!0}),i(va,{actionButtons:y,onActionButtonClick:T,mobile:!0})]}))}))]}))]}))})),Wa={primary:{brandName:"LifeSG",logoSrc:"https://assets.life.gov.sg/lifesg/logo-lifesg.svg"}},Pa=Gt,Ra=3.5;export{Ta as Navbar,Pa as NavbarHeight,Ra as NavbarMobileHeight};
