...
`,Vr=s(h)`
    ...
    width: 1.5rem;
    color: ${kt.Neutral[3]};
`,Zr=(e,t)=>{const{textColor:r=kt.Neutral[1]}=t||{};return c`
        // Text
        ${Xt(e,"regular")}
        color: ${r};
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,s((e=>{var{children:r}=e,n=f(e,["children"]);const i=n["data-testid"]||"card";return t(Nr,Object.assign({},n,{"data-testid":i},{children:"string"==typeof r?t(Jt.Body,{children:r}):r}))}))`
    ${Zr("BodySmall")}
