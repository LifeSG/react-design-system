...
`,Wt=t.forwardRef(((r,n)=>{var{children:t,focusHighlight:i=!0,focusOutline:s="none",type:o="button"}=r,a=b(r,["children","focusHighlight","focusOutline","type"]);return e(jt,Object.assign({ref:n,$outline:s,$highlight:i,type:o},a,{children:t}))})),Ht=l.div`
    position: relative;
    display: flex;
...
`,Rt=e=>{const{textSize:r}=e||{};return d`
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((r=>{var{children:n}=r,t=b(r,["children"]);const i=t["data-testid"]||"card";return e(Lt,Object.assign({},t,{"data-testid":i,children:"string"==typeof n?e(Yt.BodyBL,{children:n}):n}))}))`
    color: ${gt.text};
    ${Rt({textSize:"body-md"})}
