...
`,Wt=t.forwardRef(((r,n)=>{var{children:t,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=r,s=A(r,["children","focusHighlight","focusOutline","type"]);return e(It,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:t}))})),Ht=u.div`
    position: relative;
    display: flex;
...
`,Rt=u(Wt)`
    position: absolute;
    top: var(--close-button-top-inset, ${bt["spacing-16"]});
    right: var(--close-button-right-inset, ${bt["spacing-16"]});
    padding: 0;
    color: ${ct.icon};
    ...
    ${ft.MaxWidth.sm} {
        right: var(--close-button-right-inset, ${bt["spacing-20"]});
    }
`,Pt=e=>{const{textSize:r}=e||{};return g`
        // Text styling
        ${r&&ut[`${r}-regular`]}
    ...
    pointer-events: auto;
    outline: none;
`,u((r=>{var{children:n}=r,t=A(r,["children"]);const i=t["data-testid"]||"card";return e(Yt,Object.assign({},t,{"data-testid":i,children:"string"==typeof n?e(Lt.BodyBL,{children:n}):n}))}))`
    color: ${ct.text};
    ${Pt({textSize:"body-md"})}
    ...
    &::-webkit-scrollbar-thumb {
        ...
        border-radius: ${ht.full};
        background-clip: padding-box;
    }
`,u((n=>{var{id:t="modal-box",children:i,onClose:o,showCloseButton:a=!0}=n,s=A(n,["id","children","onClose","showCloseButton"]);return r(Ht,Object.assign({"data-testid":t},s,{onClick:e=>{e.stopPropagation()},children:[a&&e(Rt,{onClick:o,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:e(y,{})}),i]}))}))`
...
`,bi=u.div`
    ...
    ${e=>{let r="";return e.$show?r+=g`
            ...
            `,e.$disableTransition&&(r+=g`
                transition: none;
            `),r}};
`;var hi;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(hi||(hi={}));const yi=({show:r=!1,rootId:n,onOverlayClick:s,children:l,backgroundOpacity:d,backgroundBlur:c=!0,disableTransition:u=!1,enableOverlayClick:g=!1,zIndex:m,id:b})=>{const[h,y]=o(null),[f,F]=o(),[w]=o((()=>ui.generate())),$=x(),E=a(),C=a(null),B=l&&t.cloneElement(l,{ref:C}),A=b?`lifesg-ds-overlay-root-${b}`:"lifesg-ds-overlay-root",S=null!=m?m:f?99999:99998;(e=>{const r=p();i((()=>{if(!r)return;const n={zIndex:e};r.events.emit(hi.Change,n)}),[r,e]),i((()=>{if(!r)return;const n=()=>{const n={zIndex:e};r.events.emit(hi.Change,n)};return null==r||r.events.on(hi.Ready,n),()=>null==r?void 0:r.events.off(hi.Ready,n)}),[r,e])})(S),i((()=>(_(),y(O()),()=>{Y(),j().length<1&&(I("remove"),H(),T("remove"))})),[]),i((()=>{if(r){const e=M();k(e),L(),z()&&1===j().length&&(W(),I("add"));const r=setTimeout((()=>{T("add")}),200);return()=>clearTimeout(r)}{Y(),z()&&j().length<1&&(I("remove"),H());const e=setTimeout((()=>{j().length<1&&T("remove")}),200);return()=>clearTimeout(e)}}),[r]);const k=e=>{E.current=e,F(e)},z=()=>/(iPad|iPhone|iPod)/g.test(navigator.userAgent),O=()=>document&&n?document.getElementById(n):document?document.body:null,M=()=>j().length>0,_=()=>{if(!document.getElementById(fi)){const e=document.createElement("style");e.id=fi;const r=document.documentElement.clientWidth,n=window.innerWidth-r;e.innerHTML=`\n\t\t\t\t.${xi} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${xi}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\n\t\t\t\t.${vi} {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: var(${Fi}, 0);\n\t\t\t\t\tbottom: 0;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},T=e=>{const r=document.body.classList.contains(xi);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(xi):document.body.classList.add(xi)},j=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},L=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=[...e,w].join(",")},Y=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==w)).join(",")},I=e=>{if(!z())return;const r=document.body.classList.contains(vi);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(vi):document.body.classList.add(vi)},W=()=>{const e=document.body.style,r=e.top?e.top:window.scrollY+"px";document.body.style.setProperty(Fi,r)},H=()=>{const e=document.body.style.getPropertyValue(Fi);requestAnimationFrame((()=>{window.scrollTo({top:parseFloat(e)})}))},R=e=>{var r;const n=null===(r=C.current)||void 0===r?void 0:r.firstChild;n&&n.contains(e.target)||s&&g&&(e.preventDefault(),s())};return h?D.createPortal(e(mi,{id:A,"data-testid":A,$show:r,$zIndex:S,children:l&&e(v,{id:$,children:e(bi,{"data-testid":"overlay-wrapper",$show:r,$stacked:f,$backgroundBlur:c,$disableTransition:u,onClick:R,children:B})})}),h):null},pi=r=>e(f,{children:e(yi,Object.assign({},r))}),fi="lifesg-ds-overlay-stylesheet",xi="lifesg-ds-overlay-open",vi="lifesg-ds-overlay-scroll-lock",Fi="--lifesg-ds-overlay-scroll-y",wi=l({onClose:()=>{}}),$i=u.div`
    position: relative;
    width: 100%;
    height: 100%;
    ...
    ${e=>g`
        ...
        &[data-status="open"] {
            opacity: 1;
            ${e.$animationFrom}: 0;
            transition: all ${gt["duration-250"]}
                ${gt["ease-entrance"]}
            transition-delay: ${gt["duration-150"]};
        }
...
`,Di=u.div`
    width: 40rem;
    margin: ${bt["spacing-64"]} auto;
    background: ${ct.bg};
    box-shadow: ${yt["xs-strong"]};
    border-radius: ${ht.lg};

    display: flex;
    flex-direction: column-reverse;

    max-width: calc(100% - ${pt["xxl-margin"]}px * 2);

    ${ft.MaxWidth.xl} {
        max-width: calc(100% - ${pt["xl-margin"]}px * 2);
    }

    ${ft.MaxWidth.lg} {
        max-width: calc(100% - ${pt["lg-margin"]}px * 2);
    }

    ${ft.MaxWidth.md} {
        max-width: calc(100% - ${pt["md-margin"]}px * 2);
    }

    ${ft.MaxWidth.sm} {
        max-width: calc(100% - ${pt["sm-margin"]}px * 2);
    }

    ${ft.MaxWidth.xs} {
        max-width: calc(100% - ${pt["xs-margin"]}px * 2);
    }

    ${ft.MaxWidth.xxs} {
        max-width: calc(100% - ${pt["xxs-margin"]}px * 2);
    }
`,Bi=u.div`
...
`,Si=u.div`
    margin-right: ${bt["spacing-64"]};
    margin-left: ${bt["spacing-64"]};

    ${ft.MaxWidth.sm} {
        margin-right: ${bt["spacing-20"]};
        margin-left: ${bt["spacing-20"]};
    }
`,ki=u.div`
    margin-right: ${bt["spacing-64"]};
    margin-left: ${bt["spacing-64"]};
    ...
    column-gap: ${bt["spacing-32"]};
    row-gap: ${bt["spacing-16"]};
...
`,zi=u.div`
    :where(& > ${Si}:last-child) {
        margin-bottom: ${bt["spacing-64"]};
    }

    :where(& > ${ki}:not(:first-child)) {
    ...
    ${e=>e.$hasCloseButton?g`
                  :where(& > ${Si}:first-child),
                  :where(& > ${ki}:first-child) {
                      margin-top: 0;
                  }
              `:g`
                  :where(& > ${Si}:first-child),
                  :where(& > ${ki}:first-child) {
                      margin-top: ${bt["spacing-64"]};
                  }
              `}
`,Oi=r=>{var{"data-testid":n="modal-close-button"}=r,t=A(r,["data-testid"]);const{onClose:i}=d(wi);return e(Bi,Object.assign({"data-testid":n},t,{children:e(Ai,{onClick:i,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser","aria-label":"Close button",children:e(y,{"aria-hidden":!0})})}))};Oi.displayName="ModalV2.CloseButton";const Mi=r=>{var{"data-testid":n="modal-content",children:t}=r,i=A(r,["data-testid","children"]);return e(Si,Object.assign({"data-testid":n},i,{children:t}))};Mi.displayName="ModalV2.Content";const _i=e=>{var{"data-testid":n="modal-footer",primaryButton:t,secondaryButton:i}=e,o=A(e,["data-testid","primaryButton","secondaryButton"]);return r(ki,Object.assign({"data-testid":n},o,{children:[t,i]}))};_i.displayName="ModalV2.Footer";const Ti=e=>{var{id:n,"data-testid":i="modal-card",children:o}=e,a=A(e,["id","data-testid","children"]);const s=e=>t.Children.toArray(o).find((r=>((e,r)=>m(e.type)?e.type.target===r:e.type===r)(r,e))),l=s(Oi),d=s(Mi),c=s(_i),u=!!l;return r(Di,Object.assign({id:n,"data-testid":i},a,{onClick:e=>{e.stopPropagation()},children:[r(zi,{$hasCloseButton:u,children:[d,c]}),u&&l]}))};Ti.displayName="ModalV2.Card",Object.assign((r=>{var{id:n,show:t,onClose:a,animationFrom:l="bottom",children:d,enableOverlayClick:c=!0,rootComponentId:u,zIndex:g,onOverlayClick:m,dismissKeyboardOnShow:b=!0,"data-testid":h="modal"}=r,y=A(r,["id","show","onClose","animationFrom","children","enableOverlayClick","rootComponentId","zIndex","onOverlayClick","dismissKeyboardOnShow","data-testid"]);const{verticalHeight:p,offsetTop:f}=(()=>{const[e,r]=o(),[n,t]=o(),a=s((()=>{const e=.01*window.innerHeight;r(e)}),[]),l=s((()=>{if(window.visualViewport){const e=.01*window.visualViewport.height;r(e),t(window.visualViewport.offsetTop)}}),[]);return i((()=>window.visualViewport?(l(),window.visualViewport.addEventListener("resize",l),()=>{var e;null===(e=window.visualViewport)||void 0===e||e.removeEventListener("resize",l)}):(a(),window.addEventListener("resize",a),()=>{window.removeEventListener("resize",a)})),[]),{verticalHeight:e,offsetTop:n}})(),{refs:x,context:v}=F({open:t,onOpenChange:e=>{e||null==a||a()}}),{isMounted:D,status:B}=w(v,{duration:300}),S=$(v,{outsidePress:!1,enabled:!!a}),{getFloatingProps:k}=E([S]);return i((()=>{var e,r;t&&b&&(null===(r=null===(e=document.activeElement)||void 0===e?void 0:e.blur)||void 0===r||r.call(e))}),[b,t]),e(pi,{"data-testid":`${h}-overlay`,show:D,enableOverlayClick:c,onOverlayClick:m,id:n,rootId:u,zIndex:g,children:e($i,Object.assign({$show:D,$animationFrom:l,"data-testid":h,$verticalHeight:p,$offsetTop:f},y,{"data-status":B,children:e(wi.Provider,{value:{onClose:a},children:D&&e(C,{context:v,initialFocus:x.floating,children:e(Ei,{children:e(Ci,Object.assign({ref:x.setFloating},k(),{"aria-modal":!0,role:"dialog",children:d}))})})})}))})}),{Card:Ti,CloseButton:Oi,Content:Mi,Footer:_i}),u.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`;const ji=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}};u.span`
...
`;u.span`
    ...
    display: block;
`;const Wi=n=>r(Yi,{children:[e(Li,{"aria-hidden":!0}),e(Ii,Object.assign({},n))]}),Hi=u.span`
    clip-path: inset(50%);
    height: 1px;
    width: 1px;
    overflow: hidden;
...
`,Ni=u.div`
    ...
    animation: ${Pi} 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
`,Vi=u(Ni)`
...
`,Ui={Button:{"button-radius":rt.md,"button-default-colour-bg":Bn["bg-primary"],"button-default-colour-bg-hover":Bn["bg-primary-hover"],"button-default-colour-text":Bn["text-inverse"],"button-secondary-colour-border":Bn["border-primary"],"button-secondary-colour-text":Bn["text-primary"],"button-light-colour-text":Bn["text-primary"],"button-link-colour-text":Bn["text-primary"]},Animation:{"loading-dots-spinner-colour":Bn["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Bn.bg,"navbar-colour-icon":Bn.icon,"navbar-link-colour-text":Bn.text,"navbar-link-colour-text-hover":Bn["text-hover"],"navbar-link-colour-text-selected-hover":Bn["text-selected-hover"]},Footer:{"footer-colour-bg":Bn["bg-strong"],"footer-colour-text":Bn.text,"footer-link-colour-text":Bn.text,"footer-link-colour-text-hover":Bn["text-hover"],"footer-disclaimer-link-colour-text":Bn.text,"footer-disclaimer-link-colour-text-hover":Bn["text-subtler"]}},Ji={Button:{"button-radius":rt.sm,"button-default-colour-bg":Bn["bg-primary"],"button-default-colour-bg-hover":Bn["bg-primary-hover"],"button-default-colour-text":Bn["text-inverse"],"button-secondary-colour-border":Bn["border-primary"],"button-secondary-colour-text":Bn["text-primary"],"button-light-colour-text":Bn["text-primary"],"button-link-colour-text":Bn["text-primary"]},Animation:{"loading-dots-spinner-colour":Bn["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Bn.bg,"navbar-colour-icon":Bn.icon,"navbar-link-colour-text":Bn.text,"navbar-link-colour-text-hover":Bn["text-hover"],"navbar-link-colour-text-selected-hover":Bn["text-selected-hover"]},Footer:{"footer-colour-bg":Bn["bg-strong"],"footer-colour-text":Bn.text,"footer-link-colour-text":Bn.text,"footer-link-colour-text-hover":Bn["text-hover"],"footer-disclaimer-link-colour-text":Bn.text,"footer-disclaimer-link-colour-text-hover":Bn["text-subtler"]}},qi={Button:{"button-radius":rt.sm,"button-default-colour-bg":Bn["bg-primary"],"button-default-colour-bg-hover":Bn["bg-primary-hover"],"button-default-colour-text":Bn["text-inverse"],"button-secondary-colour-border":Bn["border-primary"],"button-secondary-colour-text":Bn["text-primary"],"button-light-colour-text":Bn["text-primary"],"button-link-colour-text":Bn["text-primary"]},Animation:{"loading-dots-spinner-colour":ct.Primitive["brand-50"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Bn.bg,"navbar-colour-icon":Bn.icon,"navbar-link-colour-text":Bn.text,"navbar-link-colour-text-hover":Bn["text-hover"],"navbar-link-colour-text-selected-hover":Bn["text-selected-hover"]},Footer:{"footer-colour-bg":Bn["bg-strong"],"footer-colour-text":Bn.text,"footer-link-colour-text":Bn.text,"footer-link-colour-text-hover":Bn["text-hover"],"footer-disclaimer-link-colour-text":Bn.text,"footer-disclaimer-link-colour-text-hover":Bn["text-subtler"]}},Gi={collections:{default:Ji,pa:{Button:{"button-radius":rt.full,"button-default-colour-bg":Bn["bg-primary"],"button-default-colour-bg-hover":Bn["bg-primary-hover"],"button-default-colour-text":Bn["text-inverse"],"button-secondary-colour-border":Bn["border-primary"],"button-secondary-colour-text":Bn["text-primary"],"button-light-colour-text":Bn["text-primary"],"button-link-colour-text":Bn["text-primary"]},Animation:{"loading-dots-spinner-colour":Bn["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Bn.bg,"navbar-colour-icon":Bn.icon,"navbar-link-colour-text":Bn.text,"navbar-link-colour-text-hover":Bn["text-hover"],"navbar-link-colour-text-selected-hover":Bn["text-selected-hover"]},Footer:{"footer-colour-bg":Bn["bg-strong"],"footer-colour-text":Bn.text,"footer-link-colour-text":Bn.text,"footer-link-colour-text-hover":Bn["text-hover"],"footer-disclaimer-link-colour-text":Bn.text,"footer-disclaimer-link-colour-text-hover":Bn["text-subtler"]}},a11yplayground:Ui,lifesg:qi,spf:{Button:{"button-radius":rt.md,"button-default-colour-bg":Bn["bg-primary"],"button-default-colour-bg-hover":Bn["bg-primary-hover"],"button-default-colour-text":Bn["text-inverse"],"button-secondary-colour-border":Bn["border-primary"],"button-secondary-colour-text":Bn["text-primary"],"button-light-colour-text":Bn["text-primary"],"button-link-colour-text":Bn["text-primary"]},Animation:{"loading-dots-spinner-colour":Bn["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"3rem","navbar-compressed-height":"5rem","navbar-compressed-logo-height":"2rem","navbar-mobile-height":"4rem","navbar-mobile-logo-height":"2rem","navbar-colour-bg":Bn.bg,"navbar-colour-icon":Bn.icon,"navbar-link-colour-text":Bn["text-primary-strongest"],"navbar-link-colour-text-hover":Bn["text-subtler"],"navbar-link-colour-text-selected-hover":Bn["text-subtler"]},Footer:{"footer-colour-bg":Bn["bg-inverse"],"footer-colour-text":Bn["text-inverse"],"footer-link-colour-text":Bn["text-inverse"],"footer-link-colour-text-hover":Bn["text-inverse"],"footer-disclaimer-link-colour-text":Bn["text-inverse"],"footer-disclaimer-link-colour-text-hover":Bn["text-inverse"]}}},defaultValue:"default"},Ki=(e,r)=>n=>{var t,i;const o=n.theme,a=Kr(Gi,null==o?void 0:o.componentScheme);return Qi((null===(i=null===(t=null==o?void 0:o.componentOverrides)||void 0===t?void 0:t[e])||void 0===i?void 0:i[r])||a[e][r],n)},Qi=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},eo=Ki("Button","button-radius"),ro=Ki("Button","button-default-colour-bg"),no=Ki("Button","button-default-colour-bg-hover"),to=Ki("Button","button-default-colour-text"),io=Ki("Button","button-secondary-colour-border"),oo=Ki("Button","button-secondary-colour-text"),ao=Ki("Button","button-light-colour-text"),so=Ki("Button","button-link-colour-text"),lo=u.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return g`
                    ...
                    border-color: ${e.$buttonIsDanger?ct["border-error-strong"]:io};

                    color: ${e.$buttonIsDanger?ct["text-error"]:oo};
                ...
                `;case"light":return g`
                    ...
                    color: ${e.$buttonIsDanger?ct["text-error"]:ao};
                ...
                `;case"link":return g`
                    ...
                    color: ${e.$buttonIsDanger?ct["text-error"]:so};
                    &:hover,
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${ct["bg-hover-neutral"]};
                ...
                `;default:return g`
                    background-color: ${e.$buttonIsDanger?ct["bg-error-strong"]:ro};
                    ...
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${e.$buttonIsDanger?ct["bg-error-strong-hover"]:no};
                        }
                    }
                `}}}
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return g`
                ...
                `}}}
`,co=u((({color:n,className:t,size:i})=>r(Ri,{className:t,$size:i,$color:n,"data-testid":"component-loading-spinner",children:[e(Ni,{id:"inner1"}),e(Vi,{id:"inner2"}),e(Zi,{id:"inner3"}),e(Xi,{id:"inner4"})]})))`
    margin-right: ${e=>e.$hasChildren?"0.5rem":"0"};
`,uo=e=>t.Children.toArray(e).some((e=>"string"==typeof e?""!==e.trim():null!=e)),go=(n,t)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=A(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return r(lo,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},g,u,{children:[a&&e(co,{$hasChildren:uo(i)}),e("span",{children:i})]}))};go.displayName="Button.Default";const mo=(n,t)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=A(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return r(lo,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},g,u,{children:[a&&e(co,{$hasChildren:uo(i)}),e("span",{children:i})]}))};mo.displayName="Button.Small";const bo=(n,t)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=A(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return r(lo,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:o&&!d,"aria-disabled":o,"aria-busy":a,onClick:o?void 0:c},g,u,{children:[a&&e(co,{$hasChildren:uo(i)}),e("span",{children:i})]}))};bo.displayName="Button.Large";const ho={Default:t.forwardRef(go),Small:t.forwardRef(mo),Large:t.forwardRef(bo)},yo=g`
    outline-offset: -1px;
    outline: ${mt["width-020"]} ${mt.solid} ${ct["border-focus"]};
`,po=g`
...
`,vo=g`
    outline: none;
`,Fo=u.div`
    border: ${mt["width-010"]} ${mt.solid} ${ct.border};
    border-radius: ${ht.sm};
    background: ${ct.bg};
...
`;u(Fo)`
    ...
    height: max-content;
    width: 100%;
    padding: 0 ${bt["spacing-16"]} 0
        ${e=>e.$readOnly?"0":bt["spacing-16"]};
...
`,Eo=u(wo)`
    ...
    ${e=>"no-border"!==e.$styleType&&g`
            padding-left: ${e.$visuallyReadOnly?0:bt["spacing-16"]};
            padding-right: ${e.$visuallyReadOnly||e.$showClear?0:bt["spacing-16"]};
        `}
`,Co=u($o)`
    height: auto;
    padding: ${bt["spacing-12"]} ${bt["spacing-16"]};

    cursor: pointer;
    color: ${ct.icon};

    ${e=>"no-border"===e.$styleType&&g`
            margin-right: -${bt["spacing-12"]};
        `}
`,Do=u(y)`
    height: 1.25rem;
    width: 1.25rem;
...
`,Ao=u(Fo)`
    ...
    align-items: center;
    width: 100%;
`,So=t.forwardRef(((t,i)=>{var{value:o,spacing:s,type:l,error:d,disabled:u,readOnly:g,onChange:m,onClear:b,allowClear:h=!1,className:y,styleType:p="bordered"}=t,f=A(t,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const x=((e,r)=>"tel"===e&&!!r)(l,s),v=a(null);c(i,(()=>v.current),[]);const F=function({ref:e,formatter:r}){return()=>{var n;const t=e.current;if(!t)return;const i=t.value,o=r(i),a=null!==(n=t.selectionEnd)&&void 0!==n?n:0,s=i.substring(0,a),l=r(s),d=s.length-l.length,c=Math.max(0,a-d);return{nextValue:o,updateCaretPosition:()=>{t.value=o,t.setSelectionRange(c,c)}}}}({ref:v,formatter:e=>x?gi.transformWithSpaces(e,s):e}),w=e=>{m&&(x?E(e):m(e))},$=()=>{b&&b(),v&&v.current&&v.current.focus()},E=e=>{const r=F();if(!r)return;const{nextValue:n,updateCaretPosition:t}=r,i=n.replace(/\s/g,"");e.target.value=i,null==m||m(e),t()},C=o?(e=>e?x?gi.transformWithSpaces(e,s):e:"")(o):o,D=h&&!u&&!g&&!!o,B=()=>r(n,{children:[e(Eo,Object.assign({"data-testid":"input",ref:v,"aria-disabled":u,value:C,onChange:w,type:l,readOnly:g||u,$showClear:D,$styleType:p,$visuallyReadOnly:g},f)),D&&e(Co,{onClick:$,type:"button","aria-label":"Clear input",$styleType:p,children:e(Do,{"aria-hidden":!0})})]});return e(n,{children:"no-border"===p?e(Bo,{className:y,children:B()}):e(Ao,{$disabled:u,$error:d,$readOnly:g,className:y,children:B()})})})),ko=u.div`
    display: flex;
    flex-direction: column;
`,zo=u.div`
    display: flex;
...
`,Mo=u(ho.Small)`
    margin: ${bt["spacing-32"]} 0;
`,_o=u(Lt.BodyBL)`
    flex-shrink: 0;
`,To=(e,r=1)=>!!e&&RegExp(`^[0-9]{${r}}$`).test(e),jo=(e,r,n)=>{if(e.length===r)return e;if(n){const[t,i]=e.split(n.separator);return t===n.value&&i.length===r?i:""}return""},Lo=n=>{var{id:t,value:s=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:g,numOfInput:m,prefix:b,onChange:h,onCooldownStart:y,onCooldownEnd:p}=n,f=A(n,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","prefix","onChange","onCooldownStart","onCooldownEnd"]);const x=null!=u?u:{},{disabled:v,onClick:F,styleType:w="secondary"}=x,$=A(x,["disabled","onClick","styleType"]),E=a([]),C=a(h),[D,B]=o(new Array(m).fill("")),[S,k]=o(c),[z,O]=o(new Date),[M]=o((()=>ui.generate())),_=!!g,T=`${M}-error`,j=`${M}-timer`;i((()=>{var e;return null===(e=null==E?void 0:E.current[0])||void 0===e||e.focus(),document.addEventListener("paste",W),()=>document.removeEventListener("paste",W)}),[]),i((()=>{if(0!==c){y&&y();const e=R();return()=>e()}}),[z]),i((()=>{C.current=h}),[h]),i((()=>{s.length===m&&B(s)}),[s]);const L=e=>{if(e&&To(e,m)){const r=e.split("");return B(r),C.current&&C.current(r),!0}return!1},Y=e=>r=>{var n;const t=r.target.value,i=D.every((e=>""===e)),o=jo(t,m,b);if(i&&L(o))return;const a=t.replace(/[^0-9]/g,"");if(To(a)){const r=[...D];r[e]=a.substring(a.length-1),null===(n=E.current[e+1])||void 0===n||n.focus(),B(r),h&&h(r)}},I=e=>r=>{var n,t,i;const{key:o,code:a}=r;if("Backspace"===o||"Backspace"===a){const r=[...D];""!==r[e]?r[e]="":0!==e&&(r[e-1]="",null===(n=E.current[e-1])||void 0===n||n.focus()),B(r),h&&h(r)}else"ArrowRight"===r.code?null===(t=E.current[e+1])||void 0===t||t.focus():"ArrowLeft"===r.code&&(null===(i=E.current[e-1])||void 0===i||i.focus())},W=e=>{if(!e.clipboardData)return;const r=e.clipboardData.getData("text"),n=jo(r,m,b);L(n)||e.preventDefault()},H=()=>{const e=Date.now(),r=1e3*c;return e<z.valueOf()+r},R=()=>{const e=setInterval((()=>{const r=Date.now(),n=1e3*c,t=Math.ceil((z.valueOf()+n-r)/1e3);k(t),t<=0&&(p&&p(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},P=(e,r,n)=>n?`${n}-${r}-${e+1}`:`${r}-${e+1}`,N=e=>`${e} second${1===e?"":"s"}`;return r(ko,{id:t,"data-testid":l,className:d,children:[r(zo,{role:"group","aria-label":`${m}-digit OTP input field`,children:[b&&r(_o,{forwardedAs:"span","data-testid":"otp-prefix",weight:"semibold",children:[e(Hi,{children:"O T P prefix"}),`${b.value} ${b.separator}`]}),D.map(((r,n)=>e(Oo,Object.assign({id:P(n,"otp-input",t),"data-testid":P(n,"otp-input",l),"aria-label":`${gi.formatOrdinal(n+1)} digit`,"aria-invalid":_,"aria-describedby":_?T:void 0,ref:e=>E.current[n]=e,type:"text",inputMode:"numeric",value:r,error:_,onChange:Y(n),onKeyDown:I(n),autoComplete:"off"},f),n)))]}),g&&e(Wi,{id:T,children:g}),r(Hi,{role:"timer",id:j,children:[N(S)," remaining"]}),e(Hi,{"aria-live":"polite",children:S>0?"":"Ready to resend OTP"}),e(Mo,Object.assign({styleType:w,type:"button"},$,{onClick:e=>{B(new Array(m).fill("")),H()||(O(new Date),k(c)),F&&F(e)},disabled:v||H()},$.children?{children:$.children}:{children:S>0?`Resend OTP in ${N(S)}`:"Resend OTP","aria-label":S>0?`Resend OTP in ${N(c)}`:"Resend OTP","aria-describedby":j}))]})};export{Lo as OtpInput};
