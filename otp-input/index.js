...
`;var An;!function(t){const n=(e,r,t)=>{const n=l(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
        ...
        `;return t.displayName=`Typography.${r}`,t};t.BodyBL=s("body-baseline","BodyBL"),t.BodyMD=s("body-md","BodyMD"),t.BodySM=s("body-sm","BodySM"),t.BodyXS=s("body-xs","BodyXS");const i=(t,n)=>{const s=l.a`
            ...
            `}
        `,i=t=>{var{external:n=!1,children:i}=t,a=g(t,["external","children"]);return e(s,Object.assign({},a,{children:[i,n&&r(zn,{})]}))};return i.displayName=`Typography.${n}`,i};t.LinkBL=i("body-baseline","LinkBL"),t.LinkMD=i("body-md","LinkMD"),t.LinkSM=i("body-sm","LinkSM"),t.LinkXS=i("body-xs","LinkXS")}(An||(An={}));const zn=l(h)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
    vertical-align: middle;
...
`,kn=n.forwardRef(((e,t)=>{var{children:n,focusHighlight:s=!0,focusOutline:i="none",type:a="button"}=e,o=g(e,["children","focusHighlight","focusOutline","type"]);return r(Mn,Object.assign({ref:t,$outline:i,$highlight:s,type:a},o,{children:n}))})),On=l.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,Yn=e=>{const{textSize:r}=e||{};return c`
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((e=>{var{children:t}=e,n=g(e,["children"]);const s=n["data-testid"]||"card";return r(Sn,Object.assign({},n,{"data-testid":s},{children:"string"==typeof t?r(An.BodyBL,{children:t}):t}))}))`
    color: ${Ct.text};
    ${Yn({textSize:"body-md"})}
...
`,l((t=>{var{id:n="modal-box",children:s,onClose:i,showCloseButton:a=!0}=t,o=g(t,["id","children","onClose","showCloseButton"]);return e(On,Object.assign({"data-testid":n},o,{onClick:e=>{e.stopPropagation()}},{children:[a&&r(_n,Object.assign({onClick:i,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser"},{children:r(u,{})})),s]}))}))`
