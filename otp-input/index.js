...
`,nn=n=>{var{external:r=!1,children:a}=n,i=f(n,["external","children"]);return e(en,Object.assign({},i,{children:[a,r&&t(tn,{})]}))};var rn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(rn||(rn={}));const an={collections:{base:{InputBoxShadow:d`
	...
	${e=>"small"===e.$buttonSizeStyle?d`
                ...
                `}
`,cn=s((({color:n,className:r,size:a=18})=>e(Mt,Object.assign({className:r,$size:a,$color:n},{children:[t(Tt,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(Wt,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(_t,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(It,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?ln.Button.Danger.Primary:Ot.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Ot.Neutral[3](e);break;default:t=Ot.Neutral[8](e)}return d`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Xn=s(dn.Small)`
    margin: 2rem 0rem;
`;var Un;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Un||(Un={}));s.div`
    position: fixed;
    left: 0;
    top: 0;
    height: 0;
...
`,tr=e=>{const{textSize:t}=e||{};return d`
        // Text styling
        ${t&&qt(t,"regular")}
