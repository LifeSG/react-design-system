...
`}
        `;var r},Mt=(e,r)=>d`
    ${kt(e,r.weight||"regular",r.paragraph)}
    ${((e=!1,r=!1,n)=>r?d`
            display: block;
            ${zt(n)}
        `:e?d`
    ...
    color: ${gt.text};
`;var Ot;!function(n){const t=(e,r,n)=>{const t=l(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${e=>Mt(r,e)}
        ...
        `;return n.displayName=`Typography.${r}`,n};n.BodyBL=i("body-baseline","BodyBL"),n.BodyMD=i("body-md","BodyMD"),n.BodySM=i("body-sm","BodySM"),n.BodyXS=i("body-xs","BodyXS");const s=(n,t)=>{const i=l.a`
            ...
            `}
        `,s=n=>{var{external:t=!1,children:s}=n,o=b(n,["external","children"]);return e(i,Object.assign({},o,{children:[s,t&&r(_t,{})]}))};return s.displayName=`Typography.${t}`,s};n.LinkBL=s("body-baseline","LinkBL"),n.LinkMD=s("body-md","LinkMD"),n.LinkSM=s("body-sm","LinkSM"),n.LinkXS=s("body-xs","LinkXS")}(Ot||(Ot={}));const _t=l(u)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
...
`,jt=t.forwardRef(((e,n)=>{var{children:t,focusHighlight:i=!0,focusOutline:s="none",type:o="button"}=e,a=b(e,["children","focusHighlight","focusOutline","type"]);return r(Yt,Object.assign({ref:n,$outline:s,$highlight:i,type:o},a,{children:t}))})),Lt=l.div`
    position: relative;
    display: flex;
...
`,Ht=e=>{const{textSize:r}=e||{};return d`
        // Text styling
        ${r&&bt[`${r}-regular`]}
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((e=>{var{children:n}=e,t=b(e,["children"]);const i=t["data-testid"]||"card";return r(Tt,Object.assign({},t,{"data-testid":i,children:"string"==typeof n?r(Ot.BodyBL,{children:n}):n}))}))`
    color: ${gt.text};
    ${Ht({textSize:"body-md"})}
...
`,l((n=>{var{id:t="modal-box",children:i,onClose:s,showCloseButton:o=!0}=n,a=b(n,["id","children","onClose","showCloseButton"]);return e(Lt,Object.assign({"data-testid":t},a,{onClick:e=>{e.stopPropagation()},children:[o&&r(Wt,{onClick:s,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:r(g,{})}),i]}))}))`
...
`,l.div`
    ...
    cursor: pointer;
    position: relative;
`;const It=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}};l.span`
...
`;l.span`
    ...
    display: block;
`;const Pt=e=>r(Rt,Object.assign({},e)),Nt=l.div`
    clip-path: inset(50%);
    height: 1px;
    width: 1px;
    overflow: hidden;
...
`,qt={Button:{"button-radius":tt.md,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},Kt={collections:{default:{Button:{"button-radius":tt.sm,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},pa:{Button:{"button-radius":tt.full,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},a11yplayground:qt},defaultValue:"default"},Qt=(e,r)=>n=>{var t,i;const s=n.theme,o=an(Kt,null==s?void 0:s.componentScheme);return ei((null===(i=null===(t=null==s?void 0:s.componentOverrides)||void 0===t?void 0:t[e])||void 0===i?void 0:i[r])||o[e][r],n)},ei=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},ri=Qt("Button","button-radius"),ni=Qt("Button","button-default-colour-bg"),ti=Qt("Button","button-default-colour-bg-hover"),ii=Qt("Button","button-default-colour-text"),si=Qt("Button","button-secondary-colour-border"),oi=Qt("Button","button-secondary-colour-text"),ai=Qt("Button","button-light-colour-text"),li=Qt("Button","button-link-colour-text"),di=l.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return d`
                    ...
                    border-color: ${e.$buttonIsDanger?gt["border-error-strong"]:si};

                    color: ${e.$buttonIsDanger?gt["text-error"]:oi};
                ...
                `;case"light":return d`
                    ...
                    color: ${e.$buttonIsDanger?gt["text-error"]:ai};
                ...
                `;default:return d`
                    background-color: ${e.$buttonIsDanger?gt["bg-error-strong"]:ni};
                    ...
                    &:hover,
                    &:active {
                        background-color: ${e.$buttonIsDanger?gt["bg-error-strong-hover"]:ti};
                    }
                `}}}
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return d`
                ...
                `}}}
`,ci=l((({color:n,className:t,size:i})=>e(Vt,{className:t,$size:i,$color:n,"data-testid":"component-loading-spinner",children:[r(Xt,{id:"inner1"}),r(Ut,{id:"inner2"}),r(Jt,{id:"inner3"}),r(Gt,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,ui=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(di,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(ci,{}),r("span",{children:i})]}))};ui.displayName="Button.Default";const gi=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(di,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(ci,{}),r("span",{children:i})]}))};gi.displayName="Button.Small";const bi=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(di,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(ci,{}),r("span",{children:i})]}))};bi.displayName="Button.Large";const hi={Default:t.forwardRef(ui),Small:t.forwardRef(gi),Large:t.forwardRef(bi)},mi=d`
    outline-offset: -1px;
...
`,Mi=n=>{var{id:t,value:s=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:g,numOfInput:h,onChange:m,onCooldownStart:y,onCooldownEnd:p}=n,f=b(n,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","onChange","onCooldownStart","onCooldownEnd"]);const v=null!=u?u:{},{disabled:x,onClick:F,styleType:w="secondary"}=v,D=b(v,["disabled","onClick","styleType"]),E=i([]),C=i(m),[$,B]=o(new Array(h).fill("")),[S,A]=o(c),[k,z]=o(new Date),[M]=o((()=>j.generate())),O=!!g,_=`${M}-error`,T=`${M}-timer`;a((()=>{var e;return null===(e=null==E?void 0:E.current[0])||void 0===e||e.focus(),document.addEventListener("paste",H),()=>document.removeEventListener("paste",H)}),[]),a((()=>{if(0!==c){y&&y();const e=P();return()=>e()}}),[k]),a((()=>{C.current=m}),[m]),a((()=>{s.length===h&&B(s)}),[s]);const Y=e=>r=>{var n;const t=r.target.value.replace(/[^0-9]/g,"");if(I(t)){const r=[...$];r[e]=t.substring(t.length-1),null===(n=E.current[e+1])||void 0===n||n.focus(),B(r),m&&m(r)}},W=e=>r=>{var n,t,i;const{key:s,code:o}=r;if("Backspace"===s||"Backspace"===o){const r=[...$];""!==r[e]?r[e]="":0!==e&&(r[e-1]="",null===(n=E.current[e-1])||void 0===n||n.focus()),B(r),m&&m(r)}else"ArrowRight"===r.code?null===(t=E.current[e+1])||void 0===t||t.focus():"ArrowLeft"===r.code&&(null===(i=E.current[e-1])||void 0===i||i.focus())},H=e=>{if(!e.clipboardData)return;const r=e.clipboardData.getData("text"),n=r.split("");r&&I(r,h)?(B(n),C.current&&C.current(n)):e.preventDefault()},I=(e,r=1)=>!!e&&RegExp(`^[0-9]{${r}}$`).test(e),R=()=>{const e=Date.now(),r=1e3*c;return e<k.valueOf()+r},P=()=>{const e=setInterval((()=>{const r=Date.now(),n=1e3*c,t=Math.ceil((k.valueOf()+n-r)/1e3);A(t),t<=0&&(p&&p(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},N=(e,r,n)=>n?`${n}-${r}-${e+1}`:`${r}-${e+1}`,V=e=>`${e} second${1===e?"":"s"}`;return e(Si,{id:t,"data-testid":l,className:d,children:[r(Ai,{role:"group","aria-label":`${h}-digit OTP input field`,children:$.map(((e,n)=>r(ki,Object.assign({id:N(n,"otp-input",t),"data-testid":N(n,"otp-input",l),"aria-label":`${L.formatOrdinal(n+1)} digit`,"aria-invalid":O,"aria-describedby":O?_:void 0,ref:e=>E.current[n]=e,type:"text",inputMode:"numeric",value:e,error:O,onChange:Y(n),onKeyDown:W(n),autoComplete:"off"},f),n)))}),g&&r(Pt,{id:_,children:g}),e(Nt,{role:"timer",id:T,children:[V(S)," remaining"]}),r(Nt,{"aria-live":"polite",children:S>0?"":"Ready to resend OTP"}),r(zi,Object.assign({styleType:w,type:"button"},D,{onClick:e=>{B(new Array(h).fill("")),R()||(z(new Date),A(c)),F&&F(e)},disabled:x||R()},D.children?{children:D.children}:{children:S>0?`Resend OTP in ${V(S)}`:"Resend OTP","aria-label":S>0?`Resend OTP in ${V(c)}`:"Resend OTP","aria-describedby":T}))]})};export{Mi as OtpInput};
