...
`,Kt=r=>{var{external:n=!1,children:i}=r,o=f(r,["external","children"]);return e(Jt,Object.assign({},o,{children:[i,n&&t(qt,{})]}))};var Qt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Qt||(Qt={}));const er={collections:{base:{InputBoxShadow:c`
	...
	${e=>"small"===e.$buttonSizeStyle?c`
                ...
                `}
`,ir=l((({color:r,className:n,size:i=18})=>e(At,Object.assign({className:n,$size:i,$color:r},{children:[t(zt,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),t(_t,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),t(It,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),t(Yt,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?rr.Button.Danger.Primary:kt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=kt.Neutral[3](e);break;default:t=kt.Neutral[8](e)}return c`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
        ...
        `}}
`,or={Default:n.forwardRef(((r,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,d=f(r,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(nr,Object.assign({ref:n,"data-testid":d["data-testid"]||"button",disabled:o},c,d,{children:[a&&t(ir,Object.assign({},c)),t("span",{children:i})]}))})),Small:n.forwardRef(((r,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,d=f(r,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(nr,Object.assign({ref:n,"data-testid":d["data-testid"]||"button",disabled:o},c,d,{children:[a&&t(ir,Object.assign({},c,{size:16})),t("span",{children:i})]}))}))},ar=l.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${kt.Neutral[5]};
...
`,Ar=l.div`
    display: flex;
    width: 100%;
`,Tr=n.forwardRef(((n,a)=>{var{value:s,spacing:l,type:d,error:c,disabled:u,readOnly:h,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:$="bordered"}=n,b=f(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=i();o(a,(()=>v.current),[]);const F=function({ref:e,formatter:t}){return()=>{const r=e.current,n=r.value,i=t(n),o=n.substring(0,r.selectionEnd),a=t(o),s=o.length-a.length,l=Math.max(0,r.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{r.value=i,r.setSelectionRange(l,l)}}}}({ref:v,formatter:e=>kr.transformWithSpaces(e,l)}),S=e=>{g&&(B()?x(e):g(e))},D=()=>{p&&p(),v&&v.current&&v.current.focus()},B=()=>"tel"===d&&l,x=e=>{const{nextValue:t,updateCaretPosition:r}=F(),n=t.replace(/\s/g,"");e.target.value=n,g(e),r()},w=s?(e=>e?B()?kr.transformWithSpaces(e,l):e:"")(s):s,E=()=>e(r,{children:[t(Or,Object.assign({"data-testid":"input",ref:v,disabled:u,value:w,onChange:S,type:d,readOnly:h},b)),m&&!u&&!h&&!!s&&t(Cr,Object.assign({onClick:D,type:"button"},{children:t(Mr,{"aria-hidden":!0})}))]});return t(r,{children:"no-border"===$?t(Ar,Object.assign({className:y},{children:E()})):t(ar,Object.assign({$disabled:u,$error:c,$readOnly:h,className:y},{children:E()}))})})),zr=l.div`
    display: flex;
...
`,Wr=n.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=f(e,["children","focusHighlight","focusOutline","type"]);return t(Nr,Object.assign({ref:r,$outline:o,$highlight:i,type:a},s,{children:n}))})),jr=l.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,Rr=l(h)`
    ...
    width: 1.5rem;
    color: ${kt.Neutral[3]};
`,Vr=(e,t)=>{const{textColor:r=kt.Neutral[1]}=t||{};return c`
        // Text
        ${Ut(e,"regular")}
        color: ${r};
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((e=>{var{children:r}=e,n=f(e,["children"]);const i=n["data-testid"]||"card";return t(Lr,Object.assign({},n,{"data-testid":i},{children:"string"==typeof r?t(Gt.Body,{children:r}):r}))}))`
    ${Vr("BodySmall")}

    ${Mt.mobileL} {
        display: none;
    }
`,l((r=>{var{id:n="modal-box",children:i,onClose:o,showCloseButton:a=!0}=r,s=f(r,["id","children","onClose","showCloseButton"]);return e(jr,Object.assign({"data-testid":n},s,{onClick:e=>{e.stopPropagation()}},{children:[a&&t(Pr,Object.assign({onClick:o,"data-testid":"close-button",focusHighlight:!1},{children:t(Rr,{})})),i]}))}))`
...
`;l(Gt.BodySmall)`
    color: ${kt.Neutral[3]};
`;const Ur=e=>t(Zr,Object.assign({weight:"semibold"},e)),Xr=r=>{var{id:n,value:o=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:h,numOfInput:g,onChange:p,onCooldownStart:m,onCooldownEnd:y}=r,$=f(r,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","onChange","onCooldownStart","onCooldownEnd"]);const b=null!=u?u:{},{disabled:v,onClick:F,styleType:S="secondary"}=b,D=f(b,["disabled","onClick","styleType"]),B=i([]),x=i(p),[w,E]=a(new Array(g).fill("")),[H,k]=a(c),[O,C]=a(new Date);s((()=>{var e;return null===(e=null==B?void 0:B.current[0])||void 0===e||e.focus(),document.addEventListener("paste",T),()=>document.removeEventListener("paste",T)}),[]),s((()=>{if(0!==c){m&&m();const e=I();return()=>e()}}),[O]),s((()=>{x.current=p}),[p]),s((()=>{o.length===g&&E(o)}),[o]);const M=e=>t=>{var r;const n=t.target.value.replace(/[^0-9]/g,"");if(z(n)){const t=[...w];t[e]=n.substring(n.length-1),null===(r=B.current[e+1])||void 0===r||r.focus(),E(t),p&&p(t)}},A=e=>t=>{var r;const{key:n,code:i}=t;if("Backspace"===n||"Backspace"===i){const t=[...w];""!==t[e]?t[e]="":0!==e&&(t[e-1]="",null===(r=B.current[e-1])||void 0===r||r.focus()),E(t),p&&p(t)}},T=e=>{const t=e.clipboardData.getData("text"),r=t.split("");t&&z(t,g)?(E(r),x.current&&x.current(r)):e.preventDefault()},z=(e,t=1)=>!!e&&RegExp(`^[0-9]{${t}}$`).test(e),_=()=>{const e=Date.now(),t=1e3*c;return e<O.valueOf()+t},I=()=>{const e=setInterval((()=>{const t=Date.now(),r=1e3*c,n=Math.ceil((O.valueOf()+r-t)/1e3);k(n),n<=0&&(y&&y(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},Y=(e,t,r)=>r?`${r}-${t}-${e+1}`:`${t}-${e+1}`;return e(zr,Object.assign({id:n,"data-testid":l,className:d},{children:[t(_r,{children:w.map(((e,r)=>t(Ir,Object.assign({id:Y(r,"otp-input",n),"data-testid":Y(r,"otp-input",l),ref:e=>B.current[r]=e,type:"text",inputMode:"numeric",value:e,error:!!h,onChange:M(r),onKeyDown:A(r)},$),r)))}),h&&t(Ur,{children:h}),t(Yr,Object.assign({styleType:S,type:"button"},D,{onClick:e=>{E(new Array(g).fill("")),_()||(C(new Date),k(c)),F&&F(e)},disabled:v||_()},{children:D.children?D.children:"Resend OTP"+(H?` in ${H} second${H>1?"s":""}`:"")}))]}))};export{Xr as OtpInput};
