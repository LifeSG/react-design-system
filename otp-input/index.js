...
`,vt={collections:{default:{Button:{"button-radius":Rn.sm,"button-default-colour-bg":pn["bg-primary"],"button-default-colour-bg-hover":pn["bg-primary-hover"],"button-default-colour-text":pn["text-inverse"],"button-secondary-colour-border":pn["border-primary"],"button-secondary-colour-text":pn["text-primary"],"button-light-colour-text":pn["text-primary"],"button-link-colour-text":pn["text-primary"]}},pa:{Button:{"button-radius":Rn.full,"button-default-colour-bg":pn["bg-primary"],"button-default-colour-bg-hover":pn["bg-primary-hover"],"button-default-colour-text":pn["text-inverse"],"button-secondary-colour-border":pn["border-primary"],"button-secondary-colour-text":pn["text-primary"],"button-light-colour-text":pn["text-primary"],"button-link-colour-text":pn["text-primary"]}}},defaultValue:"default"},Ft=(e,r)=>n=>{var t,i;const s=n.theme,o=an(vt,null==s?void 0:s.componentScheme);return wt((null===(i=null===(t=null==s?void 0:s.componentOverrides)||void 0===t?void 0:t[e])||void 0===i?void 0:i[r])||o[e][r],n)},wt=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},Dt=Ft("Button","button-radius"),$t=Ft("Button","button-default-colour-bg"),Et=Ft("Button","button-default-colour-bg-hover"),Ct=Ft("Button","button-default-colour-text"),Bt=Ft("Button","button-secondary-colour-border"),At=Ft("Button","button-secondary-colour-text"),zt=Ft("Button","button-light-colour-text"),St=Ft("Button","button-link-colour-text"),Mt=l.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return d`
                    ...
                    border-color: ${e.$buttonIsDanger?Zn["border-error-strong"]:Bt};

                    color: ${e.$buttonIsDanger?Zn["text-error"]:At};
                ...
                `;default:return d`
                    background-color: ${e.$buttonIsDanger?Zn["bg-error-strong"]:$t};};
                    ...
                    &:hover,
                    &:active {
                        background-color: ${e.$buttonIsDanger?Zn["bg-error-strong-hover"]:Et}
                        };
                    }
                `}}}
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return d`
                ...
                `}}}
`,kt=l((({color:n,className:t,size:i})=>e(bt,{className:t,$size:i,$color:n,"data-testid":"component-loading-spinner",children:[r(yt,{id:"inner1"}),r(ft,{id:"inner2"}),r(pt,{id:"inner3"}),r(xt,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,Ot=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1}=n,d=h(n,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Mt,Object.assign({ref:t,"data-testid":d["data-testid"]||"button",disabled:s},c,d,{children:[o&&r(kt,{}),r("span",{children:i})]}))};Ot.displayName="Button.Default";const _t=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1}=n,d=h(n,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Mt,Object.assign({ref:t,"data-testid":d["data-testid"]||"button",disabled:s},c,d,{children:[o&&r(kt,{}),r("span",{children:i})]}))};_t.displayName="Button.Small";const Yt=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1}=n,d=h(n,["children","disabled","loading","styleType","danger"]),c={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(Mt,Object.assign({ref:t,"data-testid":d["data-testid"]||"button",disabled:s},c,d,{children:[o&&r(kt,{}),r("span",{children:i})]}))};Yt.displayName="Button.Large";const Tt={Default:t.forwardRef(Ot),Small:t.forwardRef(_t),Large:t.forwardRef(Yt)},Lt=d`
    outline-offset: -1px;
...
`,Ut=l(Wt)`
    ...
    align-items: center;
    width: 100%;
`,Jt=t.forwardRef(((t,o)=>{var{value:a,spacing:l,type:d,error:c,disabled:u,readOnly:g,onChange:b,onClear:m,allowClear:y=!1,className:f,styleType:p="bordered"}=t,x=h(t,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=((e,r)=>"tel"===e&&!!r)(d,l),F=i(null);s(o,(()=>F.current),[]);const w=function({ref:e,formatter:r}){return()=>{var n;const t=e.current;if(!t)return;const i=t.value,s=r(i),o=null!==(n=t.selectionEnd)&&void 0!==n?n:0,a=i.substring(0,o),l=r(a),d=a.length-l.length,c=Math.max(0,o-d);return{nextValue:s,updateCaretPosition:()=>{t.value=s,t.setSelectionRange(c,c)}}}}({ref:F,formatter:e=>v?j.transformWithSpaces(e,l):e}),D=e=>{b&&(v?E(e):b(e))},$=()=>{m&&m(),F&&F.current&&F.current.focus()},E=e=>{const r=w();if(!r)return;const{nextValue:n,updateCaretPosition:t}=r,i=n.replace(/\s/g,"");e.target.value=i,null==b||b(e),t()},C=a?(e=>e?v?j.transformWithSpaces(e,l):e:"")(a):a,B=y&&!u&&!g&&!!a,A=()=>e(n,{children:[r(Pt,Object.assign({"data-testid":"input",ref:F,disabled:u,value:C,onChange:D,type:d,readOnly:g,$showClear:B,$styleType:p},x)),B&&r(Vt,{onClick:$,type:"button",$styleType:p,children:r(Zt,{"aria-hidden":!0})})]});return r(n,{children:"no-border"===p?r(Xt,{className:f,children:A()}):r(Ut,{$disabled:u,$error:c,$readOnly:g,className:f,children:A()})})})),Gt=l.div`
    display: flex;
    flex-direction: column;
`,qt=l.div`
    display: flex;
...
`,ei=n=>{var{id:t,value:s=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:g,numOfInput:b,onChange:m,onCooldownStart:y,onCooldownEnd:f}=n,p=h(n,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","onChange","onCooldownStart","onCooldownEnd"]);const x=null!=u?u:{},{disabled:v,onClick:F,styleType:w="secondary"}=x,D=h(x,["disabled","onClick","styleType"]),$=i([]),E=i(m),[C,B]=o(new Array(b).fill("")),[A,z]=o(c),[S,M]=o(new Date),[k]=o((()=>L.generate())),O=!!g;a((()=>{var e;return null===(e=null==$?void 0:$.current[0])||void 0===e||e.focus(),document.addEventListener("paste",T),()=>document.removeEventListener("paste",T)}),[]),a((()=>{if(0!==c){y&&y();const e=W();return()=>e()}}),[S]),a((()=>{E.current=m}),[m]),a((()=>{s.length===b&&B(s)}),[s]);const _=e=>r=>{var n;const t=r.target.value.replace(/[^0-9]/g,"");if(I(t)){const r=[...C];r[e]=t.substring(t.length-1),null===(n=$.current[e+1])||void 0===n||n.focus(),B(r),m&&m(r)}},Y=e=>r=>{var n,t,i;const{key:s,code:o}=r;if("Backspace"===s||"Backspace"===o){const r=[...C];""!==r[e]?r[e]="":0!==e&&(r[e-1]="",null===(n=$.current[e-1])||void 0===n||n.focus()),B(r),m&&m(r)}else"ArrowRight"===r.code?null===(t=$.current[e+1])||void 0===t||t.focus():"ArrowLeft"===r.code&&(null===(i=$.current[e-1])||void 0===i||i.focus())},T=e=>{if(!e.clipboardData)return;const r=e.clipboardData.getData("text"),n=r.split("");r&&I(r,b)?(B(n),E.current&&E.current(n)):e.preventDefault()},I=(e,r=1)=>!!e&&RegExp(`^[0-9]{${r}}$`).test(e),H=()=>{const e=Date.now(),r=1e3*c;return e<S.valueOf()+r},W=()=>{const e=setInterval((()=>{const r=Date.now(),n=1e3*c,t=Math.ceil((S.valueOf()+n-r)/1e3);z(t),t<=0&&(f&&f(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},R=(e,r,n)=>n?`${n}-${r}-${e+1}`:`${r}-${e+1}`;return e(Gt,{id:t,"data-testid":l,className:d,children:[r(qt,{role:"group","aria-label":`${b}-digit OTP input field`,children:C.map(((e,n)=>r(Kt,Object.assign({id:R(n,"otp-input",t),"data-testid":R(n,"otp-input",l),"aria-label":`${j.formatOrdinal(n+1)} digit`,"aria-invalid":O,"aria-describedby":O?k:void 0,ref:e=>$.current[n]=e,type:"text",inputMode:"numeric",value:e,error:O,onChange:_(n),onKeyDown:Y(n),autoComplete:"off"},p),n)))}),g&&r(ht,{id:k,children:g}),r(Qt,Object.assign({styleType:w,type:"button"},D,{onClick:e=>{B(new Array(b).fill("")),H()||(M(new Date),z(c)),F&&F(e)},disabled:v||H(),children:D.children?D.children:"Resend OTP"+(A?` in ${A} second${A>1?"s":""}`:"")}))]})};export{ei as OtpInput};
