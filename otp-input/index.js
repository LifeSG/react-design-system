...
`,qt=n=>{var{external:r=!1,children:i}=n,o=f(n,["external","children"]);return e(Gt,Object.assign({},o,{children:[i,r&&t(Jt,{})]}))};var Kt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Kt||(Kt={}));const Qt=l.button`
	...
	${e=>"small"===e.$buttonSizeStyle?d`
                ...
                `}
`,en=l((({color:n,className:r,size:i=18})=>e(Et,Object.assign({className:r,$size:i,$color:n},{children:[t(_t,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ct,{id:"inner2",$size:i-2,$borderWidth:2}),t(At,{id:"inner3",$size:i-2,$borderWidth:2}),t(Wt,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,tn={Default:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default"}=n,l=f(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default"};return e(Qt,Object.assign({ref:r,"data-testid":l["data-testid"]||"button",disabled:o},c,l,{children:[a&&t(en,Object.assign({},c)),t("span",{children:i})]}))})),Small:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default"}=n,l=f(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small"};return e(Qt,Object.assign({ref:r,"data-testid":l["data-testid"]||"button",disabled:o},c,l,{children:[a&&t(en,Object.assign({},c,{size:16})),t("span",{children:i})]}))}))},nn={collections:{base:{InputBoxShadow:d`
    ...
    `,ElevationBoxShadow:d`
      0px 2px 8px ${Ot.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},rn=e=>t=>{var n;const r=t.theme,i=wt(nn,r[Dt.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?xt(i,e,r.options.designToken):xt(i,e)},on=rn("InputBoxShadow"),an=rn("InputErrorBoxShadow"),sn=(rn("ElevationBoxShadow"),rn("Table.Header"),rn("Table.Cell.Primary"),rn("Table.Cell.Secondary"),rn("Table.Cell.Selected"),rn("Table.Cell.Hover"),l.div`
    display: flex;
    align-items: center;
    position: relative;
...
`,_n=l.div`
    display: flex;
    width: 100%;
`,Cn=r.forwardRef(((r,a)=>{var{value:s,spacing:l,type:c,error:d,disabled:u,readOnly:h,onChange:p,onClear:g,allowClear:m=!1,className:y,styleType:b="bordered"}=r,v=f(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const $=i();o(a,(()=>$.current),[]);const S=function({ref:e,formatter:t}){return()=>{const n=e.current,r=n.value,i=t(r),o=r.substring(0,n.selectionEnd),a=t(o),s=o.length-a.length,l=Math.max(0,n.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{n.value=i,n.setSelectionRange(l,l)}}}}({ref:$,formatter:e=>Mn.transformWithSpaces(e,l)}),F=e=>{p&&(w()?D(e):p(e))},x=()=>{g&&g(),$&&$.current&&$.current.focus()},w=()=>"tel"===c&&l,D=e=>{const{nextValue:t,updateCaretPosition:n}=S(),r=t.replace(/\s/g,"");e.target.value=r,p(e),n()},B=s?(e=>e?w()?Mn.transformWithSpaces(e,l):e:"")(s):s,H=()=>e(n,{children:[t(zn,Object.assign({"data-testid":"input",ref:$,disabled:u,value:B,onChange:F,type:c,readOnly:h},v)),m&&!u&&!h&&!!s&&t(En,Object.assign({onClick:x,type:"button"},{children:t(Tn,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===b?t(_n,Object.assign({className:y},{children:H()})):t(sn,Object.assign({$disabled:u,$error:d,$readOnly:h,className:y},{children:H()}))})})),An=l.div`
    display: flex;
