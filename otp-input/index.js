...
`,Je=n=>{var{external:r=!1,children:i}=n,o=f(n,["external","children"]);return t(Ue,Object.assign({},o,{children:[i,r&&e(Ge,{})]}))};var qe;!function(t){t[t.Subpage=0]="Subpage",t[t.Domain=1]="Domain"}(qe||(qe={}));const Ke=s.button`
	...
	${t=>"small"===t.$buttonSizeStyle?d`
                ...
                `}
`,Qe=s((({color:n,className:r,size:i=18})=>t(Ee,Object.assign({className:r,$size:i,$color:n},{children:[e(_e,{id:"inner1",$size:i-2,$borderWidth:2}),e(Ce,{id:"inner2",$size:i-2,$borderWidth:2}),e(Ae,{id:"inner3",$size:i-2,$borderWidth:2}),e(We,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,tn={Default:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:l="default"}=n,s=f(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"default"};return t(Ke,Object.assign({ref:r,"data-testid":s["data-testid"]||"button",disabled:o},c,s,{children:[a&&e(Qe,Object.assign({},c)),e("span",{children:i})]}))})),Small:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:l="default"}=n,s=f(n,["children","disabled","loading","styleType"]),c={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"small"};return t(Ke,Object.assign({ref:r,"data-testid":s["data-testid"]||"button",disabled:o},c,s,{children:[a&&e(Qe,Object.assign({},c,{size:16})),e("span",{children:i})]}))}))},en={collections:{base:{InputBoxShadow:d`
        inset 0 0 4px 0px ${Oe.Shadow.Accent}
    `,InputErrorBoxShadow:d`
        inset 0 0 4px 0px ${Oe.Shadow.Red}
    ...
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F9F6FF",Hover:"#E8E1F5"}}},rbs:{InputBoxShadow:d`
        inset 0 0 3px 0px ${Oe.Shadow.Accent}
    `,InputErrorBoxShadow:d`
        inset 0 0 3px 0px ${Oe.Shadow.Red}
    `,ElevationBoxShadow:d`
      0px 2px 8px ${Oe.Shadow.Elevation}
...
`,Tn=s.div`
    display: flex;
    width: 100%;
`,_n=r.forwardRef(((r,a)=>{var{value:l,spacing:s,type:c,error:d,disabled:u,readOnly:h,onChange:p,onClear:g,allowClear:m=!1,className:y,styleType:b="bordered"}=r,v=f(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const $=i();o(a,(()=>$.current),[]);const S=function({ref:t,formatter:e}){return()=>{const n=t.current,r=n.value,i=e(r),o=r.substring(0,n.selectionEnd),a=e(o),l=o.length-a.length,s=Math.max(0,n.selectionEnd-l);return{nextValue:i,updateCaretPosition:()=>{n.value=i,n.setSelectionRange(s,s)}}}}({ref:$,formatter:t=>kn.transformWithSpaces(t,s)}),F=t=>{p&&(x()?D(t):p(t))},w=()=>{g&&g(),$&&$.current&&$.current.focus()},x=()=>"tel"===c&&s,D=t=>{const{nextValue:e,updateCaretPosition:n}=S(),r=e.replace(/\s/g,"");t.target.value=r,p(t),n()},B=l?(t=>t?x()?kn.transformWithSpaces(t,s):t:"")(l):l,H=()=>t(n,{children:[e(Mn,Object.assign({"data-testid":"input",ref:$,disabled:u,value:B,onChange:F,type:c,readOnly:h},v)),m&&!u&&!h&&!!l&&e(zn,Object.assign({onClick:w,type:"button"},{children:e(En,{"aria-hidden":!0})}))]});return e(n,{children:"no-border"===b?e(Tn,Object.assign({className:y},{children:H()})):e(an,Object.assign({$disabled:u,$error:d,$readOnly:h,className:y},{children:H()}))})})),Cn=s.div`
    display: flex;
...
`,jn=r.forwardRef(((t,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=t,l=f(t,["children","focusHighlight","focusOutline","type"]);return e(Yn,Object.assign({ref:n,$outline:o,$highlight:i,type:a},l,{children:r}))})),Ln=s.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,Rn=s(h)`
    ...
    width: 1.5rem;
    color: ${Oe.Neutral[3]};
`,Pn="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)";s.div`
    max-width: 30rem;
    pointer-events: auto;
    position: absolute;
...
`,s((n=>{var{id:r="modal-box",children:i,onClose:o,showCloseButton:a=!0}=n,l=f(n,["id","children","onClose","showCloseButton"]);return t(Ln,Object.assign({"data-testid":r},l,{onClick:t=>{t.stopPropagation()}},{children:[a&&e(In,Object.assign({onClick:o,"data-testid":"close-button",focusHighlight:!1},{children:e(Rn,{})})),i]}))}))`
