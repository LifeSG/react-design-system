...
`,Nn=s.div`
    display: flex;
    width: 100%;
`,Rn=r.forwardRef(((r,o)=>{var{value:l,spacing:s,type:c,error:d,disabled:u,readOnly:h,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:S="bordered"}=r,F=f(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const $=a();i(o,(()=>$.current),[]);const b=function({ref:e,formatter:t}){return()=>{const n=e.current,r=n.value,a=t(r),i=r.substring(0,n.selectionEnd),o=t(i),l=i.length-o.length,s=Math.max(0,n.selectionEnd-l);return{nextValue:a,updateCaretPosition:()=>{n.value=a,n.setSelectionRange(s,s)}}}}({ref:$,formatter:e=>Yn.transformWithSpaces(e,s)}),v=e=>{g&&(D()?x(e):g(e))},B=()=>{p&&p(),$&&$.current&&$.current.focus()},D=()=>"tel"===c&&s,x=e=>{const{nextValue:t,updateCaretPosition:n}=b(),r=t.replace(/\s/g,"");e.target.value=r,g(e),n()},w=l?(e=>e?D()?Yn.transformWithSpaces(e,s):e:"")(l):l,H=()=>e(n,{children:[t(Pn,Object.assign({"data-testid":"input",ref:$,disabled:u,value:w,onChange:v,type:c,readOnly:h},F)),m&&!u&&!h&&!!l&&t(Ln,Object.assign({onClick:B,type:"button"},{children:t(Vn,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===S?t(Nn,Object.assign({className:y},{children:H()})):t(mn,Object.assign({$disabled:u,$error:d,$readOnly:h,className:y},{children:H()}))})})),jn=s.div`
    display: flex;
...
`,qn=r.forwardRef(((e,n)=>{var{children:r,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,l=f(e,["children","focusHighlight","focusOutline","type"]);return t(Qn,Object.assign({ref:n,$outline:i,$highlight:a,type:o},l,{children:r}))})),Kn=s.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,tr=e=>{const{textSize:t}=e||{};return c`
        ...
        strong {
            font-family: ${Vt.OpenSans.Semibold};
            ${t&&en(t,"semibold")}
        }
...
`,s((n=>{var{id:r="modal-box",children:a,onClose:i,showCloseButton:o=!0}=n,l=f(n,["id","children","onClose","showCloseButton"]);return e(Kn,Object.assign({"data-testid":r},l,{onClick:e=>{e.stopPropagation()}},{children:[o&&t(er,Object.assign({onClick:i,"data-testid":"close-button",focusHighlight:!1},{children:t(h,{})})),a]}))}))`
