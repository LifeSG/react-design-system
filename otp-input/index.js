...
`,Ir=l.div`
    display: flex;
    width: 100%;
`,Lr=n.forwardRef(((n,o)=>{var{value:s,spacing:l,type:c,error:d,disabled:u,readOnly:h,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:$="bordered"}=n,b=f(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=i();a(o,(()=>v.current),[]);const F=function({ref:e,formatter:t}){return()=>{const r=e.current,n=r.value,i=t(n),a=n.substring(0,r.selectionEnd),o=t(a),s=a.length-o.length,l=Math.max(0,r.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{r.value=i,r.setSelectionRange(l,l)}}}}({ref:v,formatter:e=>Tr.transformWithSpaces(e,l)}),S=e=>{g&&(B()?x(e):g(e))},D=()=>{p&&p(),v&&v.current&&v.current.focus()},B=()=>"tel"===c&&l,x=e=>{const{nextValue:t,updateCaretPosition:r}=F(),n=t.replace(/\s/g,"");e.target.value=n,g(e),r()},w=s?(e=>e?B()?Tr.transformWithSpaces(e,l):e:"")(s):s,k=()=>e(r,{children:[t(zr,Object.assign({"data-testid":"input",ref:v,disabled:u,value:w,onChange:S,type:c,readOnly:h},b)),m&&!u&&!h&&!!s&&t(_r,Object.assign({onClick:D,type:"button"},{children:t(Yr,{"aria-hidden":!0})}))]});return t(r,{children:"no-border"===$?t(Ir,Object.assign({className:y},{children:k()})):t(ur,Object.assign({$disabled:u,$error:d,$readOnly:h,className:y},{children:k()}))})})),Nr=l.div`
    display: flex;
...
`,Zr=n.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=f(e,["children","focusHighlight","focusOutline","type"]);return t(Vr,Object.assign({ref:r,$outline:a,$highlight:i,type:o},s,{children:n}))})),Ur=l.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,Gr=l(h)`
    ...
    width: 1.5rem;
    color: ${Ht.Neutral[3]};
`,Jr=e=>{const{textSize:t}=e||{};return d`
        // Text styling
        ${t&&Xt(t,"regular")}
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((e=>{var{children:r}=e,n=f(e,["children"]);const i=n["data-testid"]||"card";return t(Rr,Object.assign({},n,{"data-testid":i},{children:"string"==typeof r?t(Jt.Body,{children:r}):r}))}))`
    color: ${Ht.Neutral[1]};
    ${Jr({textSize:"BodySmall"})}

    ${Mt.mobileL} {
        display: none;
    }
`,l((r=>{var{id:n="modal-box",children:i,onClose:a,showCloseButton:o=!0}=r,s=f(r,["id","children","onClose","showCloseButton"]);return e(Ur,Object.assign({"data-testid":n},s,{onClick:e=>{e.stopPropagation()}},{children:[o&&t(Xr,Object.assign({onClick:a,"data-testid":"close-button",focusHighlight:!1},{children:t(Gr,{})})),i]}))}))`
