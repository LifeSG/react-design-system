...
`,l.div`
    ...
    left: 0;
    top: 0;
    background-color: ${e=>e.$stacked?lt["overlay-subtle"]:lt["overlay-strong"]};
    ...
    ${e=>{let r="";return e.$show?r+=d`
            ...
            `,e.$disableTransition&&(r+=d`
                transition: none;
            `),r}}
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Et||(Et={}));l.div`
    position: relative;
    display: flex;
...
`}
        `;var r},Bt=(e,r)=>d`
    ${Ct(e,r.weight||"regular",r.paragraph)}
    ${((e=!1,r=!1,n)=>r?d`
            display: block;
            ${$t(n)}
        `:e?d`
    ...
    color: ${lt.text};
`;var At;!function(n){const t=(e,r,n)=>{const t=l(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${e=>Bt(r,e)}
        ...
        `;return n.displayName=`Typography.${r}`,n};n.BodyBL=i("body-baseline","BodyBL"),n.BodyMD=i("body-md","BodyMD"),n.BodySM=i("body-sm","BodySM"),n.BodyXS=i("body-xs","BodyXS");const s=(n,t)=>{const i=l.a`
            ...
            `}
        `,s=n=>{var{external:t=!1,children:s}=n,o=b(n,["external","children"]);return e(i,Object.assign({},o,{children:[s,t&&r(St,{})]}))};return s.displayName=`Typography.${t}`,s};n.LinkBL=s("body-baseline","LinkBL"),n.LinkMD=s("body-md","LinkMD"),n.LinkSM=s("body-sm","LinkSM"),n.LinkXS=s("body-xs","LinkXS")}(At||(At={}));const St=l(u)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
...
`,zt=l.button`
    ...
    &:focus {
        ...
        ${({$highlight:e})=>e&&d`
                background-color: ${lt["bg-hover-neutral"]};
            `}
    }
`,Mt=t.forwardRef(((e,n)=>{var{children:t,focusHighlight:i=!0,focusOutline:s="none",type:o="button"}=e,a=b(e,["children","focusHighlight","focusOutline","type"]);return r(zt,Object.assign({ref:n,$outline:s,$highlight:i,type:o},a,{children:t}))})),Ot=l.div`
    position: relative;
    display: flex;
...
`,_t=l(Mt)`
    position: absolute;
    top: var(--close-button-top-inset, ${gt["spacing-16"]});
    right: var(--close-button-right-inset, ${gt["spacing-16"]});
    padding: 0;
    color: ${lt.icon};
    ...
    ${ht.MaxWidth.sm} {
        right: var(--close-button-right-inset, ${gt["spacing-20"]});
    }
`,Tt=e=>{const{textSize:r}=e||{};return d`
        // Text styling
        ${r&&dt[`${r}-regular`]}
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,l((e=>{var{children:n}=e,t=b(e,["children"]);const i=t["data-testid"]||"card";return r(kt,Object.assign({},t,{"data-testid":i,children:"string"==typeof n?r(At.BodyBL,{children:n}):n}))}))`
    color: ${lt.text};
    ${Tt({textSize:"body-md"})}
    ...
    &::-webkit-scrollbar-thumb {
        background: ${lt["bg-inverse-subtlest"]};
        border: 5px solid transparent;
        border-radius: ${bt.full};
        background-clip: padding-box;
    }
`,l((n=>{var{id:t="modal-box",children:i,onClose:s,showCloseButton:o=!0}=n,a=b(n,["id","children","onClose","showCloseButton"]);return e(Ot,Object.assign({"data-testid":t},a,{onClick:e=>{e.stopPropagation()},children:[o&&r(_t,{onClick:s,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:r(g,{})}),i]}))}))`
...
`,l.div`
    ...
    cursor: pointer;
    position: relative;
`;const Yt=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}};l.span`
...
`,l.div`
    padding-left: ${gt["spacing-4"]};
    display: inline;
`,l.div`
    margin-bottom: ${gt["spacing-8"]};
`,l.label`
    color: ${lt["text-subtle"]};
...
`;l.span`
    ${dt["form-description"]}
    color: ${lt["text-subtler"]};
    display: block;
`;const Lt=e=>r(jt,Object.assign({},e)),Wt=l.div`
    clip-path: inset(50%);
    height: 1px;
    width: 1px;
    overflow: hidden;
...
`,Zt={Button:{"button-radius":tt.md,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},Xt={collections:{default:{Button:{"button-radius":tt.sm,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},pa:{Button:{"button-radius":tt.full,"button-default-colour-bg":On["bg-primary"],"button-default-colour-bg-hover":On["bg-primary-hover"],"button-default-colour-text":On["text-inverse"],"button-secondary-colour-border":On["border-primary"],"button-secondary-colour-text":On["text-primary"],"button-light-colour-text":On["text-primary"],"button-link-colour-text":On["text-primary"]}},a11yplayground:Zt},defaultValue:"default"},Ut=(e,r)=>n=>{var t,i;const s=n.theme,o=an(Xt,null==s?void 0:s.componentScheme);return Jt((null===(i=null===(t=null==s?void 0:s.componentOverrides)||void 0===t?void 0:t[e])||void 0===i?void 0:i[r])||o[e][r],n)},Jt=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},Gt=Ut("Button","button-radius"),qt=Ut("Button","button-default-colour-bg"),Kt=Ut("Button","button-default-colour-bg-hover"),Qt=Ut("Button","button-default-colour-text"),ei=Ut("Button","button-secondary-colour-border"),ri=Ut("Button","button-secondary-colour-text"),ni=Ut("Button","button-light-colour-text"),ti=Ut("Button","button-link-colour-text"),ii=l.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return d`
                    ...
                    border-color: ${e.$buttonIsDanger?lt["border-error-strong"]:ei};

                    color: ${e.$buttonIsDanger?lt["text-error"]:ri};
                ...
                `;case"light":return d`
                    ...
                    color: ${e.$buttonIsDanger?lt["text-error"]:ni};
                ...
                `;case"link":return d`
                    ...
                    color: ${e.$buttonIsDanger?lt["text-error"]:ti};
                    &:hover,
                    &:active {
                        background-color: ${lt["bg-hover-neutral"]};
                    }
                `;case"disabled":return d`
                    background-color: ${lt["bg-disabled"]};
                    ...
                    color: ${lt["text-disabled"]};
                `;default:return d`
                    background-color: ${e.$buttonIsDanger?lt["bg-error-strong"]:qt};};
                    ...
                    &:hover,
                    &:active {
                        background-color: ${e.$buttonIsDanger?lt["bg-error-strong-hover"]:Kt}
                        };
                    }
                `}}}
	...
	${e=>{switch(e.$buttonSizeStyle){case"small":return d`
                ...
                `}}}
`,si=l((({color:n,className:t,size:i})=>e(Ht,{className:t,$size:i,$color:n,"data-testid":"component-loading-spinner",children:[r(Rt,{id:"inner1"}),r(Pt,{id:"inner2"}),r(Nt,{id:"inner3"}),r(Vt,{id:"inner4"})]})))`
    margin-right: 0.5rem;
`,oi=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(ii,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(si,{}),r("span",{children:i})]}))};oi.displayName="Button.Default";const ai=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(ii,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(si,{}),r("span",{children:i})]}))};ai.displayName="Button.Small";const li=(n,t)=>{const{children:i,disabled:s=!1,loading:o=!1,styleType:a="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=n,u=b(n,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:s?"disabled":a,$buttonSizeStyle:"large",$buttonIsDanger:l};return e(ii,Object.assign({ref:t,"data-testid":u["data-testid"]||"button",disabled:s&&!d,"aria-disabled":s,"aria-busy":o,onClick:s?void 0:c},g,u,{children:[o&&r(si,{}),r("span",{children:i})]}))};li.displayName="Button.Large";const di={Default:t.forwardRef(oi),Small:t.forwardRef(ai),Large:t.forwardRef(li)},ci=d`
    outline-offset: -1px;
    outline: ${ut["width-020"]} ${ut.solid} ${lt["border-focus"]};
`,ui=d`
    outline-color: ${lt["border-focus"]};
`,gi=d`
    outline-color: ${lt["border-disabled"]};
`,bi=d`
    outline-color: ${lt["border-error-focus"]};
`,hi=l.div`
    border: ${ut["width-010"]} ${ut.solid} ${lt.border};
    border-radius: ${bt.sm};
    background: ${lt.bg};
...
`,pi=l(mi)`
    ...
    ${e=>"no-border"!==e.$styleType&&d`
            padding-left: ${gt["spacing-16"]};
            padding-right: ${e.$showClear?0:gt["spacing-16"]};
        `}
`,fi=l(yi)`
    height: auto;
...
`,Fi=l(hi)`
    ...
    align-items: center;
    width: 100%;
`,wi=t.forwardRef(((t,o)=>{var{value:a,spacing:l,type:d,error:c,disabled:u,readOnly:g,onChange:h,onClear:m,allowClear:y=!1,className:p,styleType:f="bordered"}=t,v=b(t,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const x=((e,r)=>"tel"===e&&!!r)(d,l),F=i(null);s(o,(()=>F.current),[]);const w=function({ref:e,formatter:r}){return()=>{var n;const t=e.current;if(!t)return;const i=t.value,s=r(i),o=null!==(n=t.selectionEnd)&&void 0!==n?n:0,a=i.substring(0,o),l=r(a),d=a.length-l.length,c=Math.max(0,o-d);return{nextValue:s,updateCaretPosition:()=>{t.value=s,t.setSelectionRange(c,c)}}}}({ref:F,formatter:e=>x?L.transformWithSpaces(e,l):e}),D=e=>{h&&(x?C(e):h(e))},E=()=>{m&&m(),F&&F.current&&F.current.focus()},C=e=>{const r=w();if(!r)return;const{nextValue:n,updateCaretPosition:t}=r,i=n.replace(/\s/g,"");e.target.value=i,null==h||h(e),t()},$=a?(e=>e?x?L.transformWithSpaces(e,l):e:"")(a):a,B=y&&!u&&!g&&!!a,A=()=>e(n,{children:[r(pi,Object.assign({"data-testid":"input",ref:F,"aria-disabled":u,value:$,onChange:D,type:d,readOnly:g||u,$showClear:B,$styleType:f},v)),B&&r(fi,{onClick:E,type:"button",$styleType:f,children:r(vi,{"aria-hidden":!0})})]});return r(n,{children:"no-border"===f?r(xi,{className:p,children:A()}):r(Fi,{$disabled:u,$error:c,$readOnly:g,className:p,children:A()})})})),Di=l.div`
    display: flex;
    flex-direction: column;
`,Ei=l.div`
    display: flex;
...
`,Ci=l(wi)`
    ...
    input {
        ...
        ${ht.MaxWidth.xs} {
            padding: 0 ${gt["spacing-8"]};
        }
    }
`,$i=l(di.Small)`
    margin: ${gt["spacing-32"]} 0;
`,Bi=n=>{var{id:t,value:s=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:g,numOfInput:h,onChange:m,onCooldownStart:y,onCooldownEnd:p}=n,f=b(n,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","onChange","onCooldownStart","onCooldownEnd"]);const v=null!=u?u:{},{disabled:x,onClick:F,styleType:w="secondary"}=v,D=b(v,["disabled","onClick","styleType"]),E=i([]),C=i(m),[$,B]=o(new Array(h).fill("")),[A,S]=o(c),[k,z]=o(new Date),[M]=o((()=>j.generate())),O=!!g,_=`${M}-error`,T=`${M}-timer`;a((()=>{var e;return null===(e=null==E?void 0:E.current[0])||void 0===e||e.focus(),document.addEventListener("paste",H),()=>document.removeEventListener("paste",H)}),[]),a((()=>{if(0!==c){y&&y();const e=P();return()=>e()}}),[k]),a((()=>{C.current=m}),[m]),a((()=>{s.length===h&&B(s)}),[s]);const Y=e=>r=>{var n;const t=r.target.value.replace(/[^0-9]/g,"");if(I(t)){const r=[...$];r[e]=t.substring(t.length-1),null===(n=E.current[e+1])||void 0===n||n.focus(),B(r),m&&m(r)}},W=e=>r=>{var n,t,i;const{key:s,code:o}=r;if("Backspace"===s||"Backspace"===o){const r=[...$];""!==r[e]?r[e]="":0!==e&&(r[e-1]="",null===(n=E.current[e-1])||void 0===n||n.focus()),B(r),m&&m(r)}else"ArrowRight"===r.code?null===(t=E.current[e+1])||void 0===t||t.focus():"ArrowLeft"===r.code&&(null===(i=E.current[e-1])||void 0===i||i.focus())},H=e=>{if(!e.clipboardData)return;const r=e.clipboardData.getData("text"),n=r.split("");r&&I(r,h)?(B(n),C.current&&C.current(n)):e.preventDefault()},I=(e,r=1)=>!!e&&RegExp(`^[0-9]{${r}}$`).test(e),R=()=>{const e=Date.now(),r=1e3*c;return e<k.valueOf()+r},P=()=>{const e=setInterval((()=>{const r=Date.now(),n=1e3*c,t=Math.ceil((k.valueOf()+n-r)/1e3);S(t),t<=0&&(p&&p(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},N=(e,r,n)=>n?`${n}-${r}-${e+1}`:`${r}-${e+1}`,V=e=>`${e} second${1===e?"":"s"}`;return e(Di,{id:t,"data-testid":l,className:d,children:[r(Ei,{role:"group","aria-label":`${h}-digit OTP input field`,children:$.map(((e,n)=>r(Ci,Object.assign({id:N(n,"otp-input",t),"data-testid":N(n,"otp-input",l),"aria-label":`${L.formatOrdinal(n+1)} digit`,"aria-invalid":O,"aria-describedby":O?_:void 0,ref:e=>E.current[n]=e,type:"text",inputMode:"numeric",value:e,error:O,onChange:Y(n),onKeyDown:W(n),autoComplete:"off"},f),n)))}),g&&r(Lt,{id:_,children:g}),e(Wt,{role:"timer",id:T,children:[V(A)," remaining"]}),r(Wt,{"aria-live":"polite",children:A>0?"":"Ready to resend OTP"}),r($i,Object.assign({styleType:w,type:"button"},D,{onClick:e=>{B(new Array(h).fill("")),R()||(z(new Date),S(c)),F&&F(e)},disabled:x||R()},D.children?{children:D.children}:{children:A>0?`Resend OTP in ${V(A)}`:"Resend OTP","aria-label":A>0?`Resend OTP in ${V(c)}`:"Resend OTP","aria-describedby":T}))]})};export{Bi as OtpInput};
