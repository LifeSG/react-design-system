...
`,un=({external:e=!1,children:r,...i})=>t(sn,{...i,children:[r,e&&n(hn,{})]});var pn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(pn||(pn={}));const gn=c.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
	...
	${e=>"small"===e.$buttonSizeStyle?d`
                ...
                `}
`,fn=c((({color:e,className:r,size:i=18})=>t(Jt,{className:r,$size:i,$color:e,children:[n(en,{id:"inner1",$size:i-2,$borderWidth:2}),n(tn,{id:"inner2",$size:i-2,$borderWidth:2}),n(nn,{id:"inner3",$size:i-2,$borderWidth:2}),n(rn,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Bt.Primary(e);break;case"disabled":t=Bt.Neutral[3](e);break;default:t=Bt.Neutral[8](e)}return d`
        ...
        `}}
`,mn={Default:r.forwardRef(((e,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:l="default",...c}=e,d={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"default"};return t(gn,{ref:r,"data-testid":c["data-testid"]||"button",disabled:o,...d,...c,children:[a&&n(fn,{...d}),n("span",{children:i})]})})),Small:r.forwardRef(((e,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:l="default",...c}=e,d={$buttonStyle:o?"disabled":l,$buttonSizeStyle:"small"};return t(gn,{ref:r,"data-testid":c["data-testid"]||"button",disabled:o,...d,...c,children:[a&&n(fn,{...d,size:16}),n("span",{children:i})]})}))},yn=c.div`
    display: flex;
...
`,Bn=r.forwardRef((({children:e,focusHighlight:t=!0,focusOutline:r="none",...i},o)=>n(xn,{ref:o,$outline:r,$highlight:t,...i,children:e}))),Hn=c.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,c((({id:e="modal-box",children:r,onClose:i,showCloseButton:o=!0,...a})=>t(Hn,{"data-testid":e,...a,onClick:e=>{e.stopPropagation()},children:[o&&n(Cn,{type:"button",onClick:i,"data-testid":"close-button",focusHighlight:!1,children:n(Dn,{})}),r]})))`
