...
`,Gr=e=>{const{textSize:t}=e||{};return d`
        // Text styling
        ${t&&Xt(t,"regular")}
...
`,l((e=>{var{children:r}=e,n=f(e,["children"]);const i=n["data-testid"]||"card";return t(Rr,Object.assign({},n,{"data-testid":i},{children:"string"==typeof r?t(Jt.Body,{children:r}):r}))}))`
    color: ${Ht.Neutral[1]};
    ${Gr({textSize:"BodySmall"})}

    ${Mt.mobileL} {
        display: none;
    }
`,l((r=>{var{id:n="modal-box",children:i,onClose:a,showCloseButton:o=!0}=r,s=f(r,["id","children","onClose","showCloseButton"]);return e(Ur,Object.assign({"data-testid":n},s,{onClick:e=>{e.stopPropagation()}},{children:[o&&t(Xr,Object.assign({onClick:a,"data-testid":"close-button",focusHighlight:!1},{children:t(h,{})})),i]}))}))`
