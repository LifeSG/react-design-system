...
`,_i=n=>{var{id:t,value:s=[],"data-testid":l,className:d,cooldownDuration:c,actionButtonProps:u,errorMessage:g,numOfInput:h,onChange:m,onCooldownStart:y,onCooldownEnd:p}=n,f=b(n,["id","value","data-testid","className","cooldownDuration","actionButtonProps","errorMessage","numOfInput","onChange","onCooldownStart","onCooldownEnd"]);const v=null!=u?u:{},{disabled:x,onClick:F,styleType:w="secondary"}=v,$=b(v,["disabled","onClick","styleType"]),D=i([]),E=i(m),[C,B]=o(new Array(h).fill("")),[S,A]=o(c),[k,z]=o(new Date),[M]=o((()=>j.generate())),O=!!g,_=`${M}-error`,T=`${M}-timer`;a((()=>{var e;return null===(e=null==D?void 0:D.current[0])||void 0===e||e.focus(),document.addEventListener("paste",H),()=>document.removeEventListener("paste",H)}),[]),a((()=>{if(0!==c){y&&y();const e=P();return()=>e()}}),[k]),a((()=>{E.current=m}),[m]),a((()=>{s.length===h&&B(s)}),[s]);const Y=e=>r=>{var n;const t=r.target.value.replace(/[^0-9]/g,"");if(I(t)){const r=[...C];r[e]=t.substring(t.length-1),null===(n=D.current[e+1])||void 0===n||n.focus(),B(r),m&&m(r)}},W=e=>r=>{var n,t,i;const{key:s,code:o}=r;if("Backspace"===s||"Backspace"===o){const r=[...C];""!==r[e]?r[e]="":0!==e&&(r[e-1]="",null===(n=D.current[e-1])||void 0===n||n.focus()),B(r),m&&m(r)}else"ArrowRight"===r.code?null===(t=D.current[e+1])||void 0===t||t.focus():"ArrowLeft"===r.code&&(null===(i=D.current[e-1])||void 0===i||i.focus())},H=e=>{if(!e.clipboardData)return;const r=e.clipboardData.getData("text"),n=r.split("");r&&I(r,h)?(B(n),E.current&&E.current(n)):e.preventDefault()},I=(e,r=1)=>!!e&&RegExp(`^[0-9]{${r}}$`).test(e),R=()=>{const e=Date.now(),r=1e3*c;return e<k.valueOf()+r},P=()=>{const e=setInterval((()=>{const r=Date.now(),n=1e3*c,t=Math.ceil((k.valueOf()+n-r)/1e3);A(t),t<=0&&(p&&p(),clearInterval(e))}),1e3);return()=>{clearInterval(e)}},N=(e,r,n)=>n?`${n}-${r}-${e+1}`:`${r}-${e+1}`,V=e=>`${e} second${1===e?"":"s"}`;return r(ki,{id:t,"data-testid":l,className:d,children:[e(zi,{role:"group","aria-label":`${h}-digit OTP input field`,children:C.map(((r,n)=>e(Mi,Object.assign({id:N(n,"otp-input",t),"data-testid":N(n,"otp-input",l),"aria-label":`${L.formatOrdinal(n+1)} digit`,"aria-invalid":O,"aria-describedby":O?_:void 0,ref:e=>D.current[n]=e,type:"text",inputMode:"numeric",value:r,error:O,onChange:Y(n),onKeyDown:W(n),autoComplete:"off"},f),n)))}),g&&e(Vt,{id:_,children:g}),r(Zt,{role:"timer",id:T,children:[V(S)," remaining"]}),e(Zt,{"aria-live":"polite",children:S>0?"":"Ready to resend OTP"}),e(Oi,Object.assign({styleType:w,type:"button"},$,{onClick:e=>{B(new Array(h).fill("")),R()||(z(new Date),A(c)),F&&F(e)},disabled:x||R()},$.children?{children:$.children}:{children:S>0?`Resend OTP in ${V(S)}`:"Resend OTP","aria-label":S>0?`Resend OTP in ${V(c)}`:"Resend OTP","aria-describedby":T}))]})};export{_i as OtpInput};
