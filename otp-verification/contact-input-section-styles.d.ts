...
export declare const PhoneContactInput: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("..").PhoneNumberInputProps, never>> & string & Omit<({ onChange, value, allowClear, onClear, onBlur, error, fixedCountry, optionPlaceholder, optionSearchPlaceholder, enableSearch, onHideOptions, onShowOptions, placeholder, autoComplete, noBorder, ...otherProps }: import("..").PhoneNumberInputProps) => import("react/jsx-runtime").JSX.Element, keyof import("react").Component<any, {}, any>>;
export {};
