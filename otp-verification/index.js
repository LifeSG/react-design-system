...
`;const fa=o.forwardRef((function(t,n){var{id:o="modal-box",children:i,onClose:a,showCloseButton:s=!0}=t,l=ne(t,["id","children","onClose","showCloseButton"]);return r(ha,Object.assign({ref:n,"data-testid":o},l,{onClick:e=>{e.stopPropagation()},children:[s&&e(ma,{onClick:a,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser",children:e(B,{})}),i]}))}));fa.displayName="Modal.Box";const ba=e=>{const{textSize:r}=e||{};return F`
        // Text styling
        ${r&&ji[`${r}-regular`]}
...
`,ya=$.div`
    ...
    ${e=>{let r="";return e.$show?r+=F`
            ...
            `,e.$disableTransition&&(r+=F`
                transition: none;
            `),r}};
`;var va;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(va||(va={}));const xa=({show:r=!1,rootId:t,onOverlayClick:n,children:o,backgroundOpacity:i,backgroundBlur:l=!0,disableTransition:d=!1,enableOverlayClick:c=!1,zIndex:u,id:h,containerRef:m})=>{const[f,b]=s(null),[p,y]=s(),[v]=s((()=>ke.generate())),x=T(),w=a(),$=a(!1),F=a(null),C=h?`lifesg-ds-overlay-root-${h}`:"lifesg-ds-overlay-root",E=null!=u?u:p?99999:99998;(e=>{const r=k();g((()=>{if(!r)return;const t={zIndex:e};r.events.emit(va.Change,t)}),[r,e]),g((()=>{if(!r)return;const t=()=>{const t={zIndex:e};r.events.emit(va.Change,t)};return null==r||r.events.on(va.Ready,t),()=>null==r?void 0:r.events.off(va.Ready,t)}),[r,e])})(E),g((()=>(A(),b(B()),()=>{L(),M().length<1&&(D()&&(_("remove"),H()),I("remove"))})),[]),g((()=>{if(r){const e=O();S(e),j(),D()&&1===M().length&&(R(),_("add"));const r=setTimeout((()=>{I("add")}),200);return()=>clearTimeout(r)}{L(),D()&&M().length<1&&(_("remove"),H());const e=setTimeout((()=>{M().length<1&&I("remove")}),200);return()=>clearTimeout(e)}}),[r]),g((()=>{if(r)return document.addEventListener("mousedown",P,!0),()=>{document.removeEventListener("mousedown",P,!0)}}),[r]);const S=e=>{w.current=e,y(e)},D=()=>/(iPad|iPhone|iPod)/g.test(navigator.userAgent),B=()=>document&&t?document.getElementById(t):document?document.body:null,O=()=>M().length>0,A=()=>{if(!document.getElementById($a)){const e=document.createElement("style");e.id=$a;const r=document.documentElement.clientWidth,t=window.innerWidth-r;e.innerHTML=`\n\t\t\t\t.${Fa} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${t}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Fa}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\n\t\t\t\t.${Ca} {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: var(${Ea}, 0);\n\t\t\t\t\tbottom: 0;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},I=e=>{const r=document.body.classList.contains(Fa);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(Fa):document.body.classList.add(Fa)},M=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},j=()=>{const e=M();document.body.dataset.lifesgDsOverlayOrder=[...e,v].join(",")},L=()=>{const e=M();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==v)).join(",")},_=e=>{if(!D())return;const r=document.body.classList.contains(Ca);"add"!==e||r?"remove"===e&&r&&document.body.classList.remove(Ca):document.body.classList.add(Ca)},R=()=>{const e=document.body.style,r=e.top?e.top:window.scrollY+"px";document.body.style.setProperty(Ea,r)},H=()=>{if(!D())return;const e=document.body.style.getPropertyValue(Ea);requestAnimationFrame((()=>{window.scrollTo({top:parseFloat(e)})}))},P=e=>{var r;const t=null!==(r=null==m?void 0:m.current)&&void 0!==r?r:F.current,n=F.current;if(!t)return void($.current=!1);const o=e.target,i=n===o,a=t===o,s=t.contains(o);$.current=!i&&(a||s)},W=e=>{var r;const t=null!==(r=null==m?void 0:m.current)&&void 0!==r?r:F.current,o=F.current;if(!t)return void($.current=!1);const i=e.target,a=o===i,s=t===i,l=t.contains(i);!a&&(s||l)||$.current||!n||!c||(e.preventDefault(),n()),$.current=!1};return f?q.createPortal(e(pa,{id:C,"data-testid":C,$show:r,$zIndex:E,children:o&&e(z,{id:x,children:e(ya,{ref:F,"data-testid":"overlay-wrapper",$show:r,$stacked:p,$backgroundBlur:l,$disableTransition:d,onClick:W,children:o})})}),f):null},wa=r=>e(O,{children:e(xa,Object.assign({},r))}),$a="lifesg-ds-overlay-stylesheet",Fa="lifesg-ds-overlay-open",Ca="lifesg-ds-overlay-scroll-lock",Ea="--lifesg-ds-overlay-scroll-y",Sa=f({onClose:()=>{}}),Da=$.div`
    position: relative;
    width: 100%;
    height: 100%;
...
`,Ma=$.div`
    ...
    ${e=>e.$hasCloseButton?F`
              ...
              `}
`,ja=r=>{var{"data-testid":t="modal-close-button"}=r,n=ne(r,["data-testid"]);const{onClose:o}=b(Sa);return e(Ta,Object.assign({"data-testid":t},n,{children:e(za,{onClick:o,"data-testid":"close-button",focusHighlight:!1,focusOutline:"browser","aria-label":"Close button",children:e(B,{"aria-hidden":!0})})}))};ja.displayName="ModalV2.CloseButton";const La=r=>{var{"data-testid":t="modal-content",children:n}=r,o=ne(r,["data-testid","children"]);return e(Aa,Object.assign({"data-testid":t},o,{children:n}))};La.displayName="ModalV2.Content";const _a=e=>{var{"data-testid":t="modal-footer",primaryButton:n,secondaryButton:o}=e,i=ne(e,["data-testid","primaryButton","secondaryButton"]);return r(Ia,Object.assign({"data-testid":t},i,{children:[n,o]}))};_a.displayName="ModalV2.Footer";const Ra=o.forwardRef((function(e,t){var{id:n,"data-testid":i="modal-card",children:a}=e,s=ne(e,["id","data-testid","children"]);const l=e=>o.Children.toArray(a).find((r=>((e,r)=>C(e.type)?e.type.target===r:e.type===r)(r,e))),d=l(ja),c=l(La),u=l(_a),g=!!d;return r(Oa,Object.assign({ref:t,id:n,"data-testid":i},s,{onClick:e=>{e.stopPropagation()},children:[r(Ma,{$hasCloseButton:g,children:[c,u]}),g&&d]}))}));Ra.displayName="ModalV2.Card",Object.assign((r=>{var{id:t,show:n,onClose:i,animationFrom:l="bottom",children:d,enableOverlayClick:c=!0,rootComponentId:u,zIndex:h,onOverlayClick:f,dismissKeyboardOnShow:b=!0,"data-testid":p="modal","aria-label":y,"aria-labelledby":v,"aria-describedby":x,disableInitialFocus:w=!1}=r,$=ne(r,["id","show","onClose","animationFrom","children","enableOverlayClick","rootComponentId","zIndex","onOverlayClick","dismissKeyboardOnShow","data-testid","aria-label","aria-labelledby","aria-describedby","disableInitialFocus"]);const{verticalHeight:F,offsetTop:C}=(()=>{const[e,r]=s(),[t,n]=s(),o=m((()=>{const e=.01*window.innerHeight;r(e)}),[]),i=m((()=>{if(window.visualViewport){const e=.01*window.visualViewport.height;r(e),n(window.visualViewport.offsetTop)}}),[]);return g((()=>window.visualViewport?(i(),window.visualViewport.addEventListener("resize",i),()=>{var e;null===(e=window.visualViewport)||void 0===e||e.removeEventListener("resize",i)}):(o(),window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)})),[]),{verticalHeight:e,offsetTop:t}})(),E=a(null),S=d&&o.cloneElement(d,{ref:E}),{refs:D,context:B}=A({open:n,onOpenChange:e=>{e||null==i||i()}}),{isMounted:k,status:O}=I(B,{duration:300}),T=M(B,{outsidePress:!1,enabled:!!i}),{getFloatingProps:z}=j([T]),_=Sr((()=>{var e,r;b&&(null===(r=null===(e=document.activeElement)||void 0===e?void 0:e.blur)||void 0===r||r.call(e))}));return g((()=>{n&&_()}),[n,_]),e(wa,{"data-testid":`${p}-overlay`,show:k,enableOverlayClick:c,onOverlayClick:f,id:t,rootId:u,containerRef:E,zIndex:h,children:e(Da,Object.assign({$show:k,$animationFrom:l,"data-testid":p,$verticalHeight:F,$offsetTop:C,"data-status":O},$,{children:e(Sa.Provider,{value:{onClose:i},children:k&&e(L,{context:B,initialFocus:w?-1:D.floating,children:e(Ba,{children:e(ka,Object.assign({ref:D.setFloating},z(),{role:"dialog","aria-label":y,"aria-labelledby":v,"aria-describedby":x,children:S}))})})})}))})}),{Card:Ra,CloseButton:ja,Content:La,Footer:_a}),$.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`;const Ha=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}};$.span`
...
`;$.span`
    ...
    display: block;
`;const Va=t=>r(Wa,{children:[e(Pa,{"aria-hidden":!0}),e(Na,Object.assign({},t))]}),Ya=$.div`
    display: inline-block;
    position: relative;
...
`,Xa=({color:t,className:n,size:o})=>r(Ya,{className:n,$size:o,$color:t,"data-testid":"component-loading-spinner",children:[e(qa,{id:"inner1"}),e(Ga,{id:"inner2"}),e(Za,{id:"inner3"}),e(Ka,{id:"inner4"})]}),Qa=$.button`
...
`,es=e=>o.Children.toArray(e).some((e=>"string"==typeof e?""!==e.trim():null!=e)),rs=(t,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=ne(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return r(Qa,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":a,onClick:i?void 0:c},g,u,{children:[a&&e(Ja,{$hasChildren:es(o)}),e("span",{children:o})]}))};rs.displayName="Button.Default";const ts=(t,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=ne(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return r(Qa,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":a,onClick:i?void 0:c},g,u,{children:[a&&e(Ja,{$hasChildren:es(o)}),e("span",{children:o})]}))};ts.displayName="Button.Small";const ns=(t,n)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:s="default",danger:l=!1,focusableWhenDisabled:d=!1,onClick:c}=t,u=ne(t,["children","disabled","loading","styleType","danger","focusableWhenDisabled","onClick"]),g={$buttonStyle:i?"disabled":s,$buttonSizeStyle:"large",$buttonIsDanger:l};return r(Qa,Object.assign({ref:n,"data-testid":u["data-testid"]||"button",disabled:i&&!d,"aria-disabled":i,"aria-busy":a,onClick:i?void 0:c},g,u,{children:[a&&e(Ja,{$hasChildren:es(o)}),e("span",{children:o})]}))};ns.displayName="Button.Large";const os={Default:o.forwardRef(rs),Small:o.forwardRef(ts),Large:o.forwardRef(ns)},is=$.span`
    clip-path: inset(50%);
    height: 1px;
    width: 1px;
    overflow: hidden;
...
`,wf=v(((t,n)=>{var{children:o,disabled:i,expanded:a,listboxId:s,popupRole:l,readOnly:d,variant:c}=t,u=ne(t,["children","disabled","expanded","listboxId","popupRole","readOnly","variant"]);return r(vf,Object.assign({ref:n,type:"button",role:"combobox","aria-expanded":a,"aria-haspopup":l,"aria-controls":a?s:void 0,"data-testid":"selector","aria-disabled":i,"aria-readonly":d,$variant:c,$readOnly:d},u,{children:[o,!d&&e(xf,{$expanded:a,$variant:c,children:e(K,{"aria-hidden":!0})})]}))}));$.li`
