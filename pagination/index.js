...
`,du=d.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=I(e,["children","focusHighlight","focusOutline","type"]);return t(uu,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),hu={collections:{base:{InputBoxShadow:_`
        inset 0 0 6px 1px ${vc.Shadow.Accent}
    `,InputErrorBoxShadow:_`
        inset 0 0 6px 1px ${vc.Shadow.Red}
...
`,_d=$.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,Od=d.forwardRef((({id:n,"data-testid":u,className:d,pageSize:f=10,totalItems:m,activePage:g,pageSizeOptions:y=jd,showFirstAndLastNav:v,showPageSizeChanger:b=!1,onPageChange:w,onPageSizeChange:x},$)=>{const S=T.exports.useMediaQuery({maxWidth:bc.mobileL}),_=y,[O,j]=p(!1),[F,k]=p(!1),[D,M]=p(""),[B,A]=p(_&&_.length>=1?_[0]:null),[C,P]=p(!S&&b&&B?B.value:f),E=Math.ceil(m/C),I=1===g,z=g===E,N=g>1?()=>U(1):void 0,H=g<E?()=>U(E):void 0,L=g>1?()=>U(g-1):void 0,R=g<E?()=>U(parseInt(g.toString())+1):void 0,W=e=>e?()=>ee():()=>J(),V=e=>e?()=>te():()=>K();h((()=>{g&&Y(g)}),[g]);const Y=e=>{M(e.toString())},q=()=>{j(!1),k(!1)},U=e=>{w&&(w(e),Y(e))},Q=()=>{const e=Math.min(E,g+5);U(e),Y(e),j(!0),k(!1)},Z=()=>{const e=Math.max(1,g-5);U(e),Y(e),j(!1),k(!0)},X=e=>{const t=e.target.value;if(void 0===t||0===t.length)M("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));Y(Math.max(1,Math.min(E,e)))}else M(t.replace(/[^0-9]/g,""))},G=e=>{e.preventDefault(),D&&w(parseInt(D))},J=()=>{j(!0)},K=()=>{j(!1)},ee=()=>{k(!0)},te=()=>{k(!1)},ne=(n,o,a)=>e(vd,{children:[t(md,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":n?"Previous 5 pages":"Next 5 pages",onMouseOver:W(n),onMouseOut:V(n),onFocus:W(n),onBlur:V(n),onClick:n?Z:Q},{children:t(n&&F?r:o&&O?i:c,{"aria-hidden":!0})})),n&&F&&t(Sd,{children:"Previous 5 pages"}),o&&O&&t(Sd,{children:"Next 5 pages"})]},a);return e(hd,Object.assign({className:d,ref:$,id:n||"pagination-wrapper","data-testid":u||"pagination","aria-label":"Pagination"},{children:[t(fd,{children:e(pd,{children:[v&&t(gd,Object.assign({onClick:N,disabled:I,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:t(a,{"aria-hidden":!0})})),t(gd,Object.assign({onClick:L,disabled:I,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:t(o,{"aria-hidden":!0})})),S?e(bd,{children:[t("form",Object.assign({onSubmit:G},{children:t($d,{value:D,onChange:X,autoComplete:"off",type:"numeric",id:(n||"pagination")+"-input","data-testid":(u||"pagination")+"-input"})})),t(xd,{children:"/"}),t(wd,{children:E})]}):[...Array(E)].map(((e,n)=>{const r=n+1,i=E-5,o=g===r;if(E<=7)return t(yd,Object.assign({onClick:()=>U(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:q,onFocus:q},{children:r}),r);const a=g+1>5&&2===r,s=g-1<=i&&r===E-1-1;return a||s?ne(a,s,r):r<=5&&g+1<=5||r<=1||r===g||r<=g+1&&r>=g-1-1||r>i&&g-1>i||r>E-1?t(yd,Object.assign({onClick:()=>U(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:q,onFocus:q},{children:r}),r):null})),t(gd,Object.assign({onClick:R,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:t(l,{"aria-hidden":!0})})),v&&t(gd,Object.assign({onClick:H,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:t(s,{"aria-hidden":!0})}))]})}),b&&!S&&t(_d,{children:t(zu,{options:_,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:B,onSelectOption:e=>{A(e);const t=e.value,n=Math.ceil(m/t);P(t);x&&x(g>=n?n:g,t)}})})]}))})),jd=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}];export{Od as Pagination};
