...
`,_s={collections:{base:{InputBoxShadow:B`
    ...
    `,ElevationBoxShadow:B`
      0px 2px 8px ${zn.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Ts=e=>t=>{var r;const n=t.theme,i=xn(_s,n[wn.designTokenScheme]);return(null===(r=n.options)||void 0===r?void 0:r.designToken)?Sn(i,e,n.options.designToken):Sn(i,e)},Hs={InputBoxShadow:Ts("InputBoxShadow"),InputErrorBoxShadow:Ts("InputErrorBoxShadow"),ElevationBoxShadow:Ts("ElevationBoxShadow"),Table:{Header:Ts("Table.Header"),Cell:{Primary:Ts("Table.Cell.Primary"),Secondary:Ts("Table.Cell.Secondary"),Selected:Ts("Table.Cell.Selected"),Hover:Ts("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Ts("Button.Danger.BackgroundColor"),Hover:Ts("Button.Danger.Hover"),Primary:Ts("Button.Danger.Primary"),Border:Ts("Button.Danger.Border")}}},Cs=O.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return B`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Hs.Button.Danger.Border:zn.Primary};

                    color: ${e.$buttonIsDanger?Hs.Button.Danger.Primary:zn.Primary};
                `;case"light":return B`
                    background-color: ${zn.Neutral[8]};
                ...
                `;case"link":return B`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Hs.Button.Danger.Hover:zn.Secondary};
                    }
                `;default:return B`
                    background-color: ${e.$buttonIsDanger?Hs.Button.Danger.BackgroundColor:zn.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?B`
                ...
                `}
`,As=O((({color:r,className:n,size:i=18})=>e(Os,Object.assign({className:n,$size:i,$color:r},{children:[t(Ds,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),t(js,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),t(ks,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),t(Es,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Hs.Button.Danger.Primary:zn.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=zn.Neutral[3](e);break;default:t=zn.Neutral[8](e)}return B`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,dl=B`
    ...
    box-shadow: ${Hs.InputErrorBoxShadow};
`,fl=O.div`
    border: 1px solid ${zn.Neutral[5]};
    border-radius: 4px;
...
`,Tl=d.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=Cn(e,["children","focusHighlight","focusOutline","type"]);return t(_l,Object.assign({ref:r,$outline:o,$highlight:i,type:a},s,{children:n}))})),Hl=e=>"small"===e?1:1.125,Cl=e=>B`
        height: ${Hl(e)}rem;
        width: ${Hl(e)}rem;
    `,Al=O.div`
...
`,Il=O(Tl)`
    ...
    ${e=>B`
        ...
        `}
`,Ll=x(((r,n)=>{var{value:i,variant:o,onClear:a}=r,s=Cn(r,["value","variant","onClear"]);return e(Al,{children:[e(Ml,{children:[t(Pl,{$variant:o,"aria-hidden":!0}),t(zl,Object.assign({ref:n,value:i,$variant:o},s))]}),i&&t(Il,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:a,$variant:o},{children:t(A,{"aria-hidden":!0})}))]})})),Rl=({listItems:n,multiSelect:i,selectedItems:o,disableItemFocus:a,itemsLoadState:s="success",itemTruncationType:l="end",itemMaxLines:c=2,labelDisplayType:u="inline",variant:d="default",listboxId:p,width:g,topScrollItem:m,onSelectItem:y,onSelectAll:b,onDismiss:$,onRetry:S,valueExtractor:x,listExtractor:F,renderListItem:O,renderCustomCallToAction:B,enableSearch:D,hideNoResultsDisplay:j,searchPlaceholder:k="Search",searchFunction:E,onSearch:_})=>{const{focusedIndex:T,setFocusedIndex:H}=w(al),[C,A]=h(""),[M,z]=h(n),P=ol(s),I=(()=>{const[e,t]=h(!1);return v((()=>{t(!0)}),[]),e})(),L=f(),R=f(),N=f([]),W=f(),Y=e=>F?F(e):e.toString(),V=il((()=>E(C))),J=il((()=>n.filter((e=>{var t;const r=Y(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),o=C.trim().toLowerCase();return n.includes(o)||i&&i.includes(o)})))),U=(e,t)=>{H(t),null==y||y(e,(e=>x?x(e):e)(e))},Z=e=>{const t=e.target.value;A(t),null==_||_()},q=()=>{var e;A(""),null===(e=W.current)||void 0===e||e.focus(),null==_||_()},X=()=>{null==S||S()};((e,t,r="window",n)=>{const i=f();v((()=>{i.current=t}),[t]),v((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const o=e=>i.current(e);return t.addEventListener(e,o,n),()=>{t.removeEventListener(e,o,n)}}),[e,r])})("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),T<M.length-1){const e=T+1;null===(t=N.current[e])||void 0===t||t.focus(),H(e)}break;case"ArrowUp":if(e.preventDefault(),T>0){const e=T-1;null===(r=N.current[e])||void 0===r||r.focus(),H(e)}else 0===T&&W.current&&(W.current.focus(),H(-1));break;case"Space":case"Enter":document.activeElement===N.current[T]&&(e.preventDefault(),M[T]&&U(M[T],T))}})),v((()=>{if(void 0===m)return;const e=setTimeout((()=>{var e;const t=n.indexOf(m),r=N.current[t];if(L.current){const t=null!==(e=null==r?void 0:r.offsetTop)&&void 0!==e?e:0;L.current.scrollTop=t-8}H(t)}),0);return()=>clearTimeout(e)}),[N,n,H,m]),v((()=>{I||a||(W.current?(H(-1),setTimeout((()=>{var e;return null===(e=W.current)||void 0===e?void 0:e.focus()}),200)):N.current[T]?setTimeout((()=>{var e;return null===(e=N.current[T])||void 0===e?void 0:e.focus()}),200):(H(0),setTimeout((()=>{var e;return null===(e=N.current[0])||void 0===e?void 0:e.focus()}),200)))}),[a,T,I,H]),v((()=>{I&&P&&(a||"success"===s&&W.current&&(H(-1),W.current.focus()))}),[I,P,s,H,a]),v((()=>{z(""===C?n:E?V():J())}),[V,J,n,E,C]);const Q=e=>i?t(e?xl:wl,{"aria-hidden":!0}):e?t($l,{"aria-hidden":!0}):t(Sl,{}),G=(e,r)=>{const n=Y(e),i="string"==typeof n?n:n.title,o="string"==typeof n?void 0:n.secondaryLabel;return t(Qn,{displayType:u,label:i,maxLines:c,selected:r,sublabel:o,truncationType:l,variant:d})},K=()=>{if(!S||S&&"success"===s)return M.map(((n,a)=>{const s=(e=>!!vs(o,(t=>$s(t,e))))(n),l=a===T;return t(bl,Object.assign({"aria-selected":s,"aria-multiselectable":i,"data-testid":"list-item",onClick:()=>U(n,a),onMouseEnter:()=>(e=>{H(e)})(a),ref:e=>N.current[a]=e,role:"option",tabIndex:l?0:-1,$active:l},{children:O?O(n,{selected:s}):e(r,{children:[Q(s),G(n,s)]})}),((e,t)=>`item_${t}__${x?x(e):e}`)(n,a))}))},ee=()=>{if((D||E)&&"success"===s)return t(Ll,{ref:W,onChange:Z,value:C,placeholder:k,"data-testid":"search-input","aria-label":"Enter text to search",onClear:q,variant:d})},te=()=>{if(i&&M.length>0&&!C&&"success"===s)return t(Fl,{children:t(Dl,Object.assign({onClick:b,type:"button",$variant:d},{children:0===o.length?"Select all":"Clear all"}))})},re=()=>{if(!j&&(C||!D)&&0===M.length&&"success"===s)return e(jl,Object.assign({"data-testid":"list-no-results"},{children:[t(El,{"data-testid":"no-result-icon",$variant:d}),t(kl,Object.assign({$variant:d},{children:"No results found."}))]}))},ne=()=>{if(S&&"loading"===s){const r="small"===d?16:18;return e(jl,Object.assign({"data-testid":"list-loading"},{children:[t(As,{$buttonStyle:"secondary",size:r}),t(kl,Object.assign({$variant:d},{children:"Loading..."}))]}))}},ie=()=>{if(S&&"fail"===s)return e(jl,Object.assign({"data-testid":"list-fail"},{children:[t(El,{"data-testid":"load-error-icon",$variant:d}),t(kl,Object.assign({$variant:d},{children:"Failed to load."}))," ",t(Bl,Object.assign({onClick:X,type:"button",$variant:d},{children:"Try again."}))]}))};return e(ml,Object.assign({"data-testid":"dropdown-container",ref:L,$width:g},{children:[e(yl,Object.assign({ref:R,"data-testid":"dropdown-list"},{children:[ee(),te(),re(),ne(),ie(),t(vl,Object.assign({role:"listbox",id:p},{children:K()}))]})),(()=>{if(B)return t("div",Object.assign({"data-testid":"custom-cta"},{children:B($,M)}))})()]}))},Nl="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Wl=O(gl)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,Vl=x((({children:r,disabled:n,expanded:i,listboxId:o,readOnly:a,variant:s},l)=>e(Wl,Object.assign({ref:l,type:"button","aria-expanded":i,"aria-haspopup":"listbox","data-testid":"selector",disabled:n,"aria-controls":o,$variant:s},{children:[r,!a&&t(Yl,Object.assign({$expanded:i,$variant:s},{children:t(z,{"aria-hidden":!0})}))]})))),Jl=e=>"small"===e?2.5:3;O.div`
    position: relative;
    width: 100%;
    ${e=>{const t=Jl(e.$variant);return B`
            min-height: ${t}rem;
...
`,Gl=O(Ql)`
    color: ${zn.Neutral[3]};
`;var Kl;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Kl||(Kl={}));const ec=O.div`
    display: flex;
    flex-direction: column;
`,tc=e=>"right"===e?"bottom-end":"bottom-start",rc=({enabled:n,isOpen:i,onOpen:o,onClose:a,onDismiss:s,renderElement:l,renderDropdown:c,customZIndex:u,clickToToggle:d=!1,offset:p=0,alignment:g="left",fitAvailableHeight:m})=>{var y;const b=f(null),$=f(null),{width:S}=Qe({targetRef:b,handleHeight:!1}),x={name:"center",fn:({x:e,rects:t})=>{const r=0===e||e+t.floating.width===window.innerWidth,n=window.innerWidth<Fs.mobileL;return{x:r&&n?(window.innerWidth-t.floating.width)/2:e}}},{refs:w,floatingStyles:F,context:O}=I({open:i,onOpenChange:(e,t,r)=>{"escape-key"===r?null==s||s():e&&!i?null==o||o():!e&&i&&(null==a||a(r))},whileElementsMounted:L,placement:tc(g),middleware:[R(p),N(),W({limiter:Y()}),V({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:m?`${e}px`:void 0,overflowY:m?"hidden":void 0})}}),x]}),B=(()=>{const[e,t]=h(void 0),r=P();return v((()=>{if(!r)return void t(void 0);const e=e=>{t(e.zIndex)};return r.events.on(Kl.Change,e),r.events.emit(Kl.Ready),()=>r.events.off(Kl.Change,e)}),[r]),e})(),{isMounted:D,styles:j}=J(O,{initial:{opacity:0},open:{opacity:1},duration:300}),k=U(O,{enabled:n,toggle:d}),E=Z(O,{enabled:n}),{getReferenceProps:_,getFloatingProps:T}=q([k,E]);return e(r,{children:[t("div",Object.assign({ref:e=>{b.current=e,w.setReference(e)}},_(),{children:l()})),D&&t(X,{children:t(Q,Object.assign({context:O,modal:!1,initialFocus:$,returnFocus:!1},{children:t("div",Object.assign({ref:w.setFloating,style:Object.assign(Object.assign({},F),{zIndex:null!==(y=null!=u?u:B)&&void 0!==y?y:50})},T(),{children:t(ec,Object.assign({ref:$,style:Object.assign({},j),inert:j.opacity<1?"":void 0},{children:c({elementWidth:S})}))}))}))})]})},nc=({selectedOption:e,placeholder:r="Select",options:n,disabled:i,error:o,className:a,"data-testid":s,id:l,enableSearch:c=!1,searchFunction:u,searchPlaceholder:d,valueExtractor:p,valueToStringFunction:g,listExtractor:m,displayValueExtractor:y,onSelectOption:b,onShowOptions:$,onHideOptions:S,onRetry:x,optionsLoadState:w="success",optionTruncationType:F="end",renderCustomSelectedOption:O,renderListItem:B,hideNoResultsDisplay:D,renderCustomCallToAction:j,onBlur:k,variant:E="default",readOnly:_,alignment:T,dropdownZIndex:H})=>{const[C,A]=h(e),[M,z]=h(!1),[P,I]=h(!1),[L]=h((()=>nl.generate())),R=f(),N=f(),W=f();v((()=>{A(e)}),[e]);const Y=(e,t)=>{N.current.focus(),A(e),z(!1),q(!1),null==b||b(e,t)},V=()=>{M&&(z(!1),q(!1))},J=()=>{P||M||I(!0)},U=e=>{!P||M||R.current.contains(e.relatedTarget)||(I(!1),null==k||k())},Z=e=>{if("middle"===F){let t=0;return W&&W.current&&(t=W.current.getBoundingClientRect().width),Yn.truncateOneLine((e=>"string"==typeof e?e:g(e)||e.toString())(e),t,120,8)}return e},q=e=>{e?null==$||$():null==S||S()};return t(sl,{children:t(rc,{enabled:!_&&!i,isOpen:M,renderElement:()=>t(fl,Object.assign({className:a,"data-testid":s,id:l,ref:R,tabIndex:-1,onFocus:J,onBlur:U,$focused:P,$disabled:i,$readOnly:_,$error:o},{children:t(Vl,Object.assign({ref:N,disabled:i,expanded:M,listboxId:L,readOnly:_,variant:E},{children:t(Xl,Object.assign({ref:W},{children:C?O?O(C):t(Ql,Object.assign({truncateType:F,$variant:E},{children:Z(y?y(C):p?p(C):C.toString())})):t(Gl,Object.assign({truncateType:F,$variant:E},{children:r}))}))}))})),renderDropdown:({elementWidth:e})=>t(Rl,{listboxId:L,listItems:n,onSelectItem:Y,onDismiss:V,valueExtractor:p,listExtractor:m,enableSearch:c,searchPlaceholder:d,searchFunction:u,selectedItems:C?[C]:[],onRetry:x,itemsLoadState:w,itemTruncationType:F,renderListItem:B,hideNoResultsDisplay:D,renderCustomCallToAction:j,variant:E,width:e}),onOpen:()=>{z(!0),q(!0),I(!0)},onClose:e=>{z(!1),q(!1),"click"!==e&&(I(!1),null==k||k())},onDismiss:()=>{N.current.focus(),z(!1),q(!1)},clickToToggle:!0,offset:8,alignment:T,fitAvailableHeight:!0,customZIndex:H})})},ic={Default:d.forwardRef(((r,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=Cn(r,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(Cs,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:o},u,c,{children:[a&&t(As,Object.assign({},u)),t("span",{children:i})]}))})),Small:d.forwardRef(((r,n)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=r,c=Cn(r,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(Cs,Object.assign({ref:n,"data-testid":c["data-testid"]||"button",disabled:o},u,c,{children:[a&&t(As,Object.assign({},u,{size:16})),t("span",{children:i})]}))}))},oc=O.input`
    ${Tn("Body","regular")}
    color: ${zn.Neutral[1]};
...
`,lc=O.div`
    display: flex;
    width: 100%;
`,cc=d.forwardRef(((n,i)=>{var{value:o,spacing:a,type:s,error:l,disabled:c,readOnly:u,onChange:d,onClear:h,allowClear:p=!1,className:g,styleType:m="bordered"}=n,y=Cn(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=f();F(i,(()=>v.current),[]);const b=function({ref:e,formatter:t}){return()=>{const r=e.current,n=r.value,i=t(n),o=n.substring(0,r.selectionEnd),a=t(o),s=o.length-a.length,l=Math.max(0,r.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{r.value=i,r.setSelectionRange(l,l)}}}}({ref:v,formatter:e=>Yn.transformWithSpaces(e,a)}),$=e=>{d&&(x()?w(e):d(e))},S=()=>{h&&h(),v&&v.current&&v.current.focus()},x=()=>"tel"===s&&a,w=e=>{const{nextValue:t,updateCaretPosition:r}=b(),n=t.replace(/\s/g,"");e.target.value=n,d(e),r()},O=o?(e=>e?x()?Yn.transformWithSpaces(e,a):e:"")(o):o,B=()=>e(r,{children:[t(oc,Object.assign({"data-testid":"input",ref:v,disabled:c,value:O,onChange:$,type:s,readOnly:u},y)),p&&!c&&!u&&!!o&&t(ac,Object.assign({onClick:S,type:"button"},{children:t(sc,{"aria-hidden":!0})}))]});return t(r,{children:"no-border"===m?t(lc,Object.assign({className:g},{children:B()})):t(hl,Object.assign({$disabled:c,$error:l,$readOnly:u,className:g},{children:B()}))})})),uc=O.nav`
    display: flex;
`,dc=O.div`
    display: flex;
    align-items: center;
...
`,xc=O.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,wc=d.forwardRef((({id:r,"data-testid":u,className:d,pageSize:f=10,totalItems:p,activePage:g,pageSizeOptions:m=Fc,showFirstAndLastNav:y,showPageSizeChanger:b=!1,onPageChange:$,onPageSizeChange:S},x)=>{const w=re.useMediaQuery({maxWidth:Ss.mobileL}),F=m,[O,B]=h(!1),[D,j]=h(!1),[k,E]=h(""),[_,T]=h(F&&F.length>=1?F[0]:null),[H,C]=h(!w&&b&&_?_.value:f),A=Math.ceil(p/H),M=1===g,z=g===A,P=g>1?()=>J(1):void 0,I=g<A?()=>J(A):void 0,L=g>1?()=>J(g-1):void 0,R=g<A?()=>J(parseInt(g.toString())+1):void 0,N=e=>e?()=>K():()=>Q(),W=e=>e?()=>ee():()=>G();v((()=>{g&&Y(g)}),[g]),v((()=>{var e;C(f),T(null!==(e=F.find((e=>e.value===f)))&&void 0!==e?e:null)}),[f]);const Y=e=>{E(e.toString())},V=()=>{B(!1),j(!1)},J=e=>{$&&($(e),Y(e))},U=()=>{const e=Math.min(A,g+5);J(e),Y(e),B(!0),j(!1)},Z=()=>{const e=Math.max(1,g-5);J(e),Y(e),B(!1),j(!0)},q=e=>{const t=e.target.value;if(void 0===t||0===t.length)E("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));Y(Math.max(1,Math.min(A,e)))}else E(t.replace(/[^0-9]/g,""))},X=e=>{e.preventDefault(),k&&$(parseInt(k))},Q=()=>{B(!0)},G=()=>{B(!1)},K=()=>{j(!0)},ee=()=>{j(!1)},te=(r,o,a)=>e(mc,{children:[t(hc,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":r?"Previous 5 pages":"Next 5 pages",onMouseOver:N(r),onMouseOut:W(r),onFocus:N(r),onBlur:W(r),onClick:r?Z:U},{children:t(r&&D?n:o&&O?i:c,{"aria-hidden":!0})})),r&&D&&t(Sc,{children:"Previous 5 pages"}),o&&O&&t(Sc,{children:"Next 5 pages"})]},a);return e(uc,Object.assign({className:d,ref:x,id:r||"pagination-wrapper","data-testid":u||"pagination","aria-label":"Pagination"},{children:[t(dc,{children:e(fc,{children:[y&&t(pc,Object.assign({onClick:P,disabled:M,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:t(a,{"aria-hidden":!0})})),t(pc,Object.assign({onClick:L,disabled:M,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:t(o,{"aria-hidden":!0})})),w?e(yc,{children:[t("form",Object.assign({onSubmit:X},{children:t($c,{value:k,onChange:q,autoComplete:"off",type:"numeric",id:(r||"pagination")+"-input","data-testid":(u||"pagination")+"-input"})})),t(bc,{children:"/"}),t(vc,{children:A})]}):[...Array(A)].map(((e,r)=>{const n=r+1,i=A-5,o=g===n;if(A<=7)return t(gc,Object.assign({onClick:()=>J(n),$selected:o,"aria-label":"Page "+n,"aria-current":!!o&&"page",onMouseOver:V,onFocus:V},{children:n}),n);const a=g+1>5&&2===n,s=g-1<=i&&n===A-1-1;return a||s?te(a,s,n):n<=5&&g+1<=5||n<=1||n===g||n<=g+1&&n>=g-1-1||n>i&&g-1>i||n>A-1?t(gc,Object.assign({onClick:()=>J(n),$selected:o,"aria-label":"Page "+n,"aria-current":!!o&&"page",onMouseOver:V,onFocus:V},{children:n}),n):null})),t(pc,Object.assign({onClick:R,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:t(l,{"aria-hidden":!0})})),y&&t(pc,Object.assign({onClick:I,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:t(s,{"aria-hidden":!0})}))]})}),b&&!w&&t(xc,{children:t(nc,{options:F,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:_,onSelectOption:e=>{T(e);const t=e.value,r=Math.ceil(p/t);C(t);S&&S(g>=r?r:g,t)}})})]}))})),Fc=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}];export{wc as Pagination};
