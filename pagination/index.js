...
`,fu=d.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=H(e,["children","focusHighlight","focusOutline","type"]);return t(hu,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),pu=x.div`
    display: flex;
    align-items: center;
    position: relative;
    border: 1px solid ${gc.Neutral[5]};
...
`,dd=x.div`
    display: flex;
    width: 100%;
`,hd=d.forwardRef(((n,a)=>{var{value:i,spacing:o,type:s,error:l,disabled:c,readOnly:u,onChange:d,onClear:h,allowClear:p=!1,className:m,styleType:g="bordered"}=n,y=H(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=f();w(a,(()=>v.current),[]);const b=function({ref:e,formatter:t}){return()=>{const r=e.current,n=r.value,a=t(n),i=n.substring(0,r.selectionEnd),o=t(i),s=i.length-o.length,l=Math.max(0,r.selectionEnd-s);return{nextValue:a,updateCaretPosition:()=>{r.value=a,r.setSelectionRange(l,l)}}}}({ref:v,formatter:e=>qc.transformWithSpaces(e,o)}),$=e=>{d&&(S()?_(e):d(e))},x=()=>{h&&h(),v&&v.current&&v.current.focus()},S=()=>"tel"===s&&o,_=e=>{const{nextValue:t,updateCaretPosition:r}=b(),n=t.replace(/\s/g,"");e.target.value=n,d(e),r()},F=i?(e=>e?S()?qc.transformWithSpaces(e,o):e:"")(i):i,O=()=>e(r,{children:[t(ld,Object.assign({"data-testid":"input",ref:v,disabled:c,value:F,onChange:$,type:s,readOnly:u},y)),p&&!c&&!u&&!!i&&t(cd,Object.assign({onClick:x,type:"button"},{children:t(ud,{"aria-hidden":!0})}))]});return t(r,{children:"no-border"===g?t(dd,Object.assign({className:m},{children:O()})):t(pu,Object.assign({$disabled:c,$error:l,$readOnly:u,className:m},{children:O()}))})})),fd=x.nav`
    display: flex;
`,pd=x.div`
    display: flex;
    align-items: center;
...
`,Fd=x.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,Od=d.forwardRef((({id:r,"data-testid":u,className:d,pageSize:f=10,totalItems:m,activePage:g,pageSizeOptions:y=Dd,showFirstAndLastNav:v,showPageSizeChanger:b=!1,onPageChange:w,onPageSizeChange:$},x)=>{const S=L.useMediaQuery({maxWidth:yc.mobileL}),_=y,[F,O]=h(!1),[D,k]=h(!1),[B,j]=h(""),[C,E]=h(_&&_.length>=1?_[0]:null),[M,A]=h(!S&&b&&C?C.value:f),P=Math.ceil(m/M),I=1===g,T=g===P,z=g>1?()=>Q(1):void 0,H=g<P?()=>Q(P):void 0,N=g>1?()=>Q(g-1):void 0,R=g<P?()=>Q(parseInt(g.toString())+1):void 0,W=e=>e?()=>ee():()=>J(),V=e=>e?()=>te():()=>K();p((()=>{g&&Y(g)}),[g]),p((()=>{var e;A(f),E(null!==(e=_.find((e=>e.value===f)))&&void 0!==e?e:null)}),[f]);const Y=e=>{j(e.toString())},q=()=>{O(!1),k(!1)},Q=e=>{w&&(w(e),Y(e))},U=()=>{const e=Math.min(P,g+5);Q(e),Y(e),O(!0),k(!1)},Z=()=>{const e=Math.max(1,g-5);Q(e),Y(e),O(!1),k(!0)},G=e=>{const t=e.target.value;if(void 0===t||0===t.length)j("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));Y(Math.max(1,Math.min(P,e)))}else j(t.replace(/[^0-9]/g,""))},X=e=>{e.preventDefault(),B&&w(parseInt(B))},J=()=>{O(!0)},K=()=>{O(!1)},ee=()=>{k(!0)},te=()=>{k(!1)},re=(r,i,o)=>e(bd,{children:[t(gd,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":r?"Previous 5 pages":"Next 5 pages",onMouseOver:W(r),onMouseOut:V(r),onFocus:W(r),onBlur:V(r),onClick:r?Z:U},{children:t(r&&D?n:i&&F?a:c,{"aria-hidden":!0})})),r&&D&&t(_d,{children:"Previous 5 pages"}),i&&F&&t(_d,{children:"Next 5 pages"})]},o);return e(fd,Object.assign({className:d,ref:x,id:r||"pagination-wrapper","data-testid":u||"pagination","aria-label":"Pagination"},{children:[t(pd,{children:e(md,{children:[v&&t(yd,Object.assign({onClick:z,disabled:I,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:t(o,{"aria-hidden":!0})})),t(yd,Object.assign({onClick:N,disabled:I,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:t(i,{"aria-hidden":!0})})),S?e(wd,{children:[t("form",Object.assign({onSubmit:X},{children:t(Sd,{value:B,onChange:G,autoComplete:"off",type:"numeric",id:(r||"pagination")+"-input","data-testid":(u||"pagination")+"-input"})})),t(xd,{children:"/"}),t($d,{children:P})]}):[...Array(P)].map(((e,r)=>{const n=r+1,a=P-5,i=g===n;if(P<=7)return t(vd,Object.assign({onClick:()=>Q(n),$selected:i,"aria-label":"Page "+n,"aria-current":!!i&&"page",onMouseOver:q,onFocus:q},{children:n}),n);const o=g+1>5&&2===n,s=g-1<=a&&n===P-1-1;return o||s?re(o,s,n):n<=5&&g+1<=5||n<=1||n===g||n<=g+1&&n>=g-1-1||n>a&&g-1>a||n>P-1?t(vd,Object.assign({onClick:()=>Q(n),$selected:i,"aria-label":"Page "+n,"aria-current":!!i&&"page",onMouseOver:q,onFocus:q},{children:n}),n):null})),t(yd,Object.assign({onClick:R,disabled:T,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:t(l,{"aria-hidden":!0})})),v&&t(yd,Object.assign({onClick:H,disabled:T,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:t(s,{"aria-hidden":!0})}))]})}),b&&!S&&t(Fd,{children:t(zu,{options:_,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:C,onSelectOption:e=>{E(e);const t=e.value,r=Math.ceil(m/t);A(t);$&&$(g>=r?r:g,t)}})})]}))})),Dd=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}];export{Od as Pagination};
