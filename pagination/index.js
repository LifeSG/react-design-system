...
`,kc={Regular:"Open Sans",Semibold:"Open Sans Semibold",Bold:"Open Sans Bold",Light:"Open Sans Light"},Dc={collections:{base:{D1:{fontFamily:kc.Bold,fontSize:3,fontWeight:700,lineHeight:4,letterSpacing:-.056},D2:{fontFamily:kc.Bold,fontSize:2.5,fontWeight:700,lineHeight:3.5,letterSpacing:-.032},D3:{fontFamily:kc.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},D4:{fontFamily:kc.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},DBody:{fontFamily:kc.Regular,fontSize:1.375,lineHeight:1.75},H1:{fontFamily:kc.Bold,fontSize:2,fontWeight:700,lineHeight:2.5},H2:{fontFamily:kc.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},H3:{fontFamily:kc.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},H4:{fontFamily:kc.Bold,fontSize:1.125,fontWeight:700,lineHeight:1.625},H5:{fontFamily:kc.Bold,fontSize:1,fontWeight:700,lineHeight:1.5,letterSpacing:.014},H6:{fontFamily:kc.Bold,fontSize:.875,fontWeight:700,lineHeight:1.6,letterSpacing:.012},Body:{fontFamily:kc.Regular,fontSize:1.125,lineHeight:1.625},BodySmall:{fontFamily:kc.Regular,fontSize:1,lineHeight:1.5,letterSpacing:.014},XSmall:{fontFamily:kc.Regular,fontSize:.75,lineHeight:1.2,letterSpacing:.012}}},defaultValue:"base"},Bc=e=>t=>{const n=t.theme,r=pc(Dc,n[mc.textStyleScheme]);return n.options&&n.options.textStyle?fc(r,e,n.options.textStyle):fc(r,e)},Mc={D1:{fontFamily:Bc("D1.fontFamily"),fontSize:Bc("D1.fontSize"),fontWeight:Bc("D1.fontWeight"),lineHeight:Bc("D1.lineHeight"),letterSpacing:Bc("D1.letterSpacing")},D2:{fontFamily:Bc("D2.fontFamily"),fontSize:Bc("D2.fontSize"),fontWeight:Bc("D2.fontWeight"),lineHeight:Bc("D2.lineHeight"),letterSpacing:Bc("D2.letterSpacing")},D3:{fontFamily:Bc("D3.fontFamily"),fontSize:Bc("D3.fontSize"),fontWeight:Bc("D3.fontWeight"),lineHeight:Bc("D3.lineHeight"),letterSpacing:Bc("D3.letterSpacing")},D4:{fontFamily:Bc("D4.fontFamily"),fontSize:Bc("D4.fontSize"),fontWeight:Bc("D4.fontWeight"),lineHeight:Bc("D4.lineHeight"),letterSpacing:Bc("D4.letterSpacing")},DBody:{fontFamily:Bc("DBody.fontFamily"),fontSize:Bc("DBody.fontSize"),fontWeight:Bc("DBody.fontWeight"),lineHeight:Bc("DBody.lineHeight"),letterSpacing:Bc("DBody.letterSpacing")},H1:{fontFamily:Bc("H1.fontFamily"),fontSize:Bc("H1.fontSize"),fontWeight:Bc("H1.fontWeight"),lineHeight:Bc("H1.lineHeight"),letterSpacing:Bc("H1.letterSpacing")},H2:{fontFamily:Bc("H2.fontFamily"),fontSize:Bc("H2.fontSize"),fontWeight:Bc("H2.fontWeight"),lineHeight:Bc("H2.lineHeight"),letterSpacing:Bc("H2.letterSpacing")},H3:{fontFamily:Bc("H3.fontFamily"),fontSize:Bc("H3.fontSize"),fontWeight:Bc("H3.fontWeight"),lineHeight:Bc("H3.lineHeight"),letterSpacing:Bc("H3.letterSpacing")},H4:{fontFamily:Bc("H4.fontFamily"),fontSize:Bc("H4.fontSize"),fontWeight:Bc("H4.fontWeight"),lineHeight:Bc("H4.lineHeight"),letterSpacing:Bc("H4.letterSpacing")},H5:{fontFamily:Bc("H5.fontFamily"),fontSize:Bc("H5.fontSize"),fontWeight:Bc("H5.fontWeight"),lineHeight:Bc("H5.lineHeight"),letterSpacing:Bc("H5.letterSpacing")},H6:{fontFamily:Bc("H6.fontFamily"),fontSize:Bc("H6.fontSize"),fontWeight:Bc("H6.fontWeight"),lineHeight:Bc("H6.lineHeight"),letterSpacing:Bc("H6.letterSpacing")},Body:{fontFamily:Bc("Body.fontFamily"),fontSize:Bc("Body.fontSize"),fontWeight:Bc("Body.fontWeight"),lineHeight:Bc("Body.lineHeight"),letterSpacing:Bc("Body.letterSpacing")},BodySmall:{fontFamily:Bc("BodySmall.fontFamily"),fontSize:Bc("BodySmall.fontSize"),fontWeight:Bc("BodySmall.fontWeight"),lineHeight:Bc("BodySmall.lineHeight"),letterSpacing:Bc("BodySmall.letterSpacing")},XSmall:{fontFamily:Bc("XSmall.fontFamily"),fontSize:Bc("XSmall.fontSize"),fontWeight:Bc("XSmall.fontWeight"),lineHeight:Bc("XSmall.lineHeight"),letterSpacing:Bc("XSmall.letterSpacing")}},Ac=e=>{switch(e){case 700:case"bold":return kc.Bold;case 600:case"semibold":return kc.Semibold;case 300:case"light":return kc.Light;case 400:case"regular":return kc.Regular;default:return""}},Ec=(e,t)=>n=>{var r;const i=Mc[e].fontFamily(n),o=Mc[e].fontWeight(n);return Object.values(kc).includes(i)?_`
        ...
        ${e=>_`
                ${Tc("D1",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D2=$.h1`
        ${e=>_`
                ${Tc("D2",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D3=$.h1`
        ${e=>_`
                ${Tc("D3",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.D4=$.h1`
        ${e=>_`
                ${Tc("D4",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.DBody=$.h1`
        ${e=>_`
                ${Tc("DBody",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H1=$.h1`
        ${e=>_`
                ${Tc("H1",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H2=$.h2`
        ${e=>_`
                ${Tc("H2",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H3=$.h3`
        ${e=>_`
                ${Tc("H3",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H4=$.h4`
        ${e=>_`
                ${Tc("H4",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H5=$.h5`
        ${e=>_`
                ${Tc("H5",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.H6=$.h6`
        ${e=>_`
                ${Tc("H6",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.Body=$.p`
        ${e=>_`
                ${Tc("Body",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.BodySmall=$.p`
        ${e=>_`
                ${Tc("BodySmall",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.XSmall=$.span`
        ${e=>_`
                ${Tc("XSmall",e.weight,e.paragraph)}
                color: ${vc.Neutral[1]};
                ${Ic(e.inline,e.paragraph,e.maxLines)}
            `}
...
`,Hc=n=>{var{external:r=!1,children:i}=n,o=I(n,["external","children"]);return e(Lc,Object.assign({},o,{children:[i,r&&t(Nc,{})]}))};var Rc;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Rc||(Rc={}));const Wc=$.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
	...
	${e=>"small"===e.$buttonSizeStyle?_`
                ...
                `}
`,Vc=$((({color:n,className:r,size:i=18})=>e($c,Object.assign({className:r,$size:i,$color:n},{children:[t(_c,{id:"inner1",$size:i-2,$borderWidth:2}),t(Oc,{id:"inner2",$size:i-2,$borderWidth:2}),t(Fc,{id:"inner3",$size:i-2,$borderWidth:2}),t(jc,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,iu=$.div`
    ...
    direction: rtl;
    text-align: right;
`,ou=$((n=>{var{className:r,checked:i,disabled:o,indeterminate:a,onChange:s,onKeyPress:l,displaySize:c="default"}=n,u=I(n,["className","checked","disabled","indeterminate","onChange","onKeyPress","displaySize"]);const d=m();h((()=>{d.current.indeterminate=a}),[a]);const f=e=>{if(!o){const t=e;if(!(" "===t.key||"change"===e.type))return;s&&s(e),l&&l(t)}};return e(Uc,Object.assign({className:r,"data-testid":"checkbox",role:"checkbox","aria-checked":a?"mixed":i,"aria-labelledby":"checkbox-input",tabIndex:o?-1:0,onKeyDown:f,$displaySize:c,$disabled:o,$unchecked:!(a||i||o)},{children:[t(Qc,Object.assign({id:"checkbox-input","data-testid":"checkbox-input","aria-hidden":"true",type:"checkbox",checked:i,ref:d,tabIndex:-1,onChange:f,disabled:o},u)),a?t(j,{"data-testid":"indeterminate"}):i?t(k,{"data-testid":"checkmark"}):o?t(D,{"data-testid":"disabled-empty-checkbox"}):t(B,{"data-testid":"empty-checkbox"})]}))}))`
    flex: 0 0 1.5rem;
    margin-right: 1rem;
`,au=$.div`
    width: 100%;
...
`,hu=d.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=I(e,["children","focusHighlight","focusOutline","type"]);return t(du,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),fu={collections:{base:{InputBoxShadow:_`
    ...
    `,ElevationBoxShadow:_`
      0px 2px 8px ${vc.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}}}},defaultValue:"base"},pu=e=>t=>{var n;const r=t.theme,i=pc(fu,r[mc.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?fc(i,e,r.options.designToken):fc(i,e)},mu=pu("InputBoxShadow"),gu=pu("InputErrorBoxShadow"),yu=(pu("ElevationBoxShadow"),pu("Table.Header"),pu("Table.Cell.Primary"),pu("Table.Cell.Secondary"),pu("Table.Cell.Selected"),pu("Table.Cell.Hover"),$.div`
    display: flex;
    align-items: center;
    position: relative;
...
`,Su=$(M)`
    ...
    width: 1.375rem;
    color: ${vc.Neutral[3]};
`,_u=g(((n,r)=>{const{onClear:i}=n,o=I(n,["onClear"]);return e(bu,{children:[t(xu,{}),t(wu,Object.assign({ref:r},o)),o.value&&t($u,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:i},{children:t(Su,{})}))]},"search")})),Ou=r=>{var{listItems:i,listExtractor:o,valueExtractor:a,onSelectItem:s,listStyleWidth:l,visible:c,enableSearch:u,searchPlaceholder:d="Search",onSearch:f,searchFunction:g,onDismiss:y,disableItemFocus:v,multiSelect:b,selectedItems:w,onSelectAll:x,onRetry:$,itemsLoadState:S="success",itemTruncationType:_="end",itemMaxLines:O=2,labelDisplayType:F="inline",renderListItem:j,onBlur:k,hideNoResultsDisplay:D,renderCustomCallToAction:B}=r,M=I(r,["listItems","listExtractor","valueExtractor","onSelectItem","listStyleWidth","visible","enableSearch","searchPlaceholder","onSearch","searchFunction","onDismiss","disableItemFocus","multiSelect","selectedItems","onSelectAll","onRetry","itemsLoadState","itemTruncationType","itemMaxLines","labelDisplayType","renderListItem","onBlur","hideNoResultsDisplay","renderCustomCallToAction"]);const[A,E]=p(0),[C,P]=p(""),[T,z]=p(i),[L,N]=p(0),H=Wl({height:L}),R=m(),W=m(),V=m([]),Y=m(),q=m(),U=m(A),Q=m(T),Z=e=>{U.current=e,E(e)},G=e=>{Q.current=e,z(e)};h((()=>(document.addEventListener("keydown",ne),()=>{document.removeEventListener("keydown",ne)})),[]),h((()=>{ee(C)}),[C]),h((()=>{if(P(""),c){if(setTimeout((()=>{N(te())})),v)return;Y&&Y.current?(Y.current.focus(),Z(-1)):V.current[A]&&V.current[A].focus()}else N(0)}),[c]),h((()=>{if(c){const e=te();N(e)}}),[T,S]),h((()=>{G(i),P(""),Z(0)}),[i]);const X=e=>o?o(e):e.toString(),J=e=>{if("inline"!==F)return!1;let t=0;W&&W.current&&(t=W.current.getBoundingClientRect().width-60);return Yc.getTextWidth(e,"1.125rem 'Open Sans'")>t*O},K=e=>!!_o(w,(t=>Fo(t,e))),ee=e=>{if(""===e)G(i);else if(g){const t=g(e);G(t)}else{const t=i.filter((t=>{var n;const r=X(t),i="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),o="string"==typeof r||null===(n=r.secondaryLabel)||void 0===n?void 0:n.toLowerCase(),a=e.trim().toLowerCase();return i.includes(a)||o&&o.includes(a)}));G(t)}},te=()=>(W&&W.current?W.current.getBoundingClientRect().height:0)+(q.current?q.current.getBoundingClientRect().height:0),ne=e=>{if(R&&R.current.contains(e.target))switch(e.code){case"ArrowDown":if(U.current<Q.current.length-1){const e=U.current+1;V.current[e].focus(),Z(e)}break;case"ArrowUp":if(U.current>0){const e=U.current-1;V.current[e].focus(),Z(U.current-1)}break;case"Escape":y&&y(!0)}},re=(e,t)=>{e.preventDefault(),s&&s(t,(e=>a?a(e):e)(t))},ie=e=>{const t=e.target.value;P(t),f&&f()},oe=()=>{P(""),Y.current.focus(),f&&f()},ae=()=>{$&&$()},se=()=>{k&&k()},le=r=>e(n,{children:[t(ru,Object.assign({$maxLines:O,"aria-hidden":!0},{children:r})),t(iu,Object.assign({$maxLines:O,"aria-hidden":!0},{children:r}))]}),ce=n=>{const r=X(n),i="string"==typeof r?r:r.title,o="string"==typeof r?void 0:r.secondaryLabel,a=J(i),s=o&&J(o),l=a||s?"next-line":F;return e(nu,Object.assign({$labelDisplayType:l},{children:[t(eu,Object.assign({$truncateType:_,$maxLines:O,"aria-label":i},{children:"middle"===_&&a?le(i):i})),o&&t(tu,Object.assign({$truncateType:_,$maxLines:O,$labelDisplayType:F,"aria-label":o},{children:"middle"===_&&s?le(o):o}))]}))},ue=()=>{if(!$||$&&"success"===S)return T.map(((n,r)=>t(Xc,Object.assign({$checked:K(n)&&!b},{children:e(Jc,Object.assign({$hasNextLineLabel:"next-line"===F&&T.length>0&&o&&"string"!=typeof o(T[0]),onClick:e=>{re(e,n)},ref:e=>V.current[r]=e,"data-testid":"list-item",type:"button",tabIndex:c?0:-1,$multiSelect:b,onBlur:se},{children:[b&&t(ou,{checked:K(n),displaySize:"small"}),j?j(n,{selected:K(n)}):ce(n)]}))}),((e,t)=>`item_${t}__${a?a(e):e}`)(n,r))))},de=()=>{if(b&&T.length>0&&!C&&"success"===S)return t(au,{children:t(su,Object.assign({onClick:x,type:"button"},{children:0===w.length?"Select all":"Clear all"}))},"selectAll")},he=()=>{if(!D&&(C||!u)&&0===T.length&&"success"===S)return e(lu,Object.assign({"data-testid":"list-no-results"},{children:[t(uu,{"data-testid":"no-result-icon"}),t(cu,{children:"No results found."})]}),"noResults")},fe=()=>{if($&&"loading"===S)return e(lu,Object.assign({"data-testid":"list-loading"},{children:[t(Vc,{$buttonStyle:"secondary",size:24}),t(cu,{children:"Loading..."})]}),"loading")},pe=()=>{if($&&"fail"===S)return e(lu,Object.assign({"data-testid":"list-fail"},{children:[t(uu,{"data-testid":"load-error-icon"}),t(cu,{children:"Failed to load."}),t(su,Object.assign({onClick:ae,type:"button"},{children:"Try again."}))]}),"noResults")};return t(n,{children:e(Zc,Object.assign({style:H,"data-testid":c?"dropdown-container":"dropdown-container-hidden",ref:R},{children:[(()=>{if(c)return e(Gc,Object.assign({ref:W,"data-testid":"dropdown-list",width:l,role:"list"},M,{children:[(u||g)&&"success"===S?t(_u,{ref:Y,onChange:ie,value:C,placeholder:d,"data-testid":"search-input","aria-label":"search-input",tabIndex:c?0:-1,onClear:oe}):null,de(),he(),fe(),pe(),ue()]}))})(),(()=>{if(c&&B)return t("div",Object.assign({ref:q,"data-testid":"custom-cta"},{children:B(y,T)}))})()]}))})},Fu="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",ju=$.div`
    position: relative;
    min-height: 3rem;
...
`,hd=$.div`
    display: flex;
    width: 100%;
`,fd=d.forwardRef(((r,i)=>{var{value:o,spacing:a,type:s,error:l,disabled:c,readOnly:u,onChange:d,onClear:h,allowClear:f=!1,className:p,styleType:g="bordered"}=r,y=I(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const v=m();w(i,(()=>v.current),[]);const b=function({ref:e,formatter:t}){return()=>{const n=e.current,r=n.value,i=t(r),o=r.substring(0,n.selectionEnd),a=t(o),s=o.length-a.length,l=Math.max(0,n.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{n.value=i,n.setSelectionRange(l,l)}}}}({ref:v,formatter:e=>Yc.transformWithSpaces(e,a)}),x=e=>{d&&(S()?_(e):d(e))},$=()=>{h&&h(),v&&v.current&&v.current.focus()},S=()=>"tel"===s&&a,_=e=>{const{nextValue:t,updateCaretPosition:n}=b(),r=t.replace(/\s/g,"");e.target.value=r,d(e),n()},O=o?(e=>e?S()?Yc.transformWithSpaces(e,a):e:"")(o):o,F=()=>e(n,{children:[t(cd,Object.assign({"data-testid":"input",ref:v,disabled:c,value:O,onChange:x,type:s,readOnly:u},y)),f&&!c&&!u&&!!o&&t(ud,Object.assign({onClick:$,type:"button"},{children:t(dd,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===g?t(hd,Object.assign({className:p},{children:F()})):t(yu,Object.assign({$disabled:c,$error:l,$readOnly:u,className:p},{children:F()}))})})),pd=$.nav`
    display: flex;
`,md=$.div`
    display: flex;
    align-items: center;
...
`,Fd=$.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,jd=d.forwardRef((({id:n,"data-testid":u,className:d,pageSize:f=10,totalItems:m,activePage:g,pageSizeOptions:y=kd,showFirstAndLastNav:v,showPageSizeChanger:b=!1,onPageChange:w,onPageSizeChange:x},$)=>{const S=T.exports.useMediaQuery({maxWidth:bc.mobileL}),_=y,[O,F]=p(!1),[j,k]=p(!1),[D,B]=p(""),[M,A]=p(_&&_.length>=1?_[0]:null),[E,C]=p(!S&&b&&M?M.value:f),P=Math.ceil(m/E),I=1===g,z=g===P,L=g>1?()=>U(1):void 0,N=g<P?()=>U(P):void 0,H=g>1?()=>U(g-1):void 0,R=g<P?()=>U(parseInt(g.toString())+1):void 0,W=e=>e?()=>ee():()=>J(),V=e=>e?()=>te():()=>K();h((()=>{g&&Y(g)}),[g]),h((()=>{var e;C(f),A(null!==(e=_.find((e=>e.value===f)))&&void 0!==e?e:null)}),[f]);const Y=e=>{B(e.toString())},q=()=>{F(!1),k(!1)},U=e=>{w&&(w(e),Y(e))},Q=()=>{const e=Math.min(P,g+5);U(e),Y(e),F(!0),k(!1)},Z=()=>{const e=Math.max(1,g-5);U(e),Y(e),F(!1),k(!0)},G=e=>{const t=e.target.value;if(void 0===t||0===t.length)B("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));Y(Math.max(1,Math.min(P,e)))}else B(t.replace(/[^0-9]/g,""))},X=e=>{e.preventDefault(),D&&w(parseInt(D))},J=()=>{F(!0)},K=()=>{F(!1)},ee=()=>{k(!0)},te=()=>{k(!1)},ne=(n,o,a)=>e(wd,{children:[t(yd,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":n?"Previous 5 pages":"Next 5 pages",onMouseOver:W(n),onMouseOut:V(n),onFocus:W(n),onBlur:V(n),onClick:n?Z:Q},{children:t(n&&j?r:o&&O?i:c,{"aria-hidden":!0})})),n&&j&&t(Od,{children:"Previous 5 pages"}),o&&O&&t(Od,{children:"Next 5 pages"})]},a);return e(pd,Object.assign({className:d,ref:$,id:n||"pagination-wrapper","data-testid":u||"pagination","aria-label":"Pagination"},{children:[t(md,{children:e(gd,{children:[v&&t(vd,Object.assign({onClick:L,disabled:I,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:t(a,{"aria-hidden":!0})})),t(vd,Object.assign({onClick:H,disabled:I,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:t(o,{"aria-hidden":!0})})),S?e(xd,{children:[t("form",Object.assign({onSubmit:X},{children:t(_d,{value:D,onChange:G,autoComplete:"off",type:"numeric",id:(n||"pagination")+"-input","data-testid":(u||"pagination")+"-input"})})),t(Sd,{children:"/"}),t($d,{children:P})]}):[...Array(P)].map(((e,n)=>{const r=n+1,i=P-5,o=g===r;if(P<=7)return t(bd,Object.assign({onClick:()=>U(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:q,onFocus:q},{children:r}),r);const a=g+1>5&&2===r,s=g-1<=i&&r===P-1-1;return a||s?ne(a,s,r):r<=5&&g+1<=5||r<=1||r===g||r<=g+1&&r>=g-1-1||r>i&&g-1>i||r>P-1?t(bd,Object.assign({onClick:()=>U(r),$selected:o,"aria-label":"Page "+r,"aria-current":!!o&&"page",onMouseOver:q,onFocus:q},{children:r}),r):null})),t(vd,Object.assign({onClick:R,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:t(l,{"aria-hidden":!0})})),v&&t(vd,Object.assign({onClick:N,disabled:z,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:t(s,{"aria-hidden":!0})}))]})}),b&&!S&&t(Fd,{children:t(Lu,{options:_,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:M,onSelectOption:e=>{A(e);const t=e.value,n=Math.ceil(m/t);C(t);x&&x(g>=n?n:g,t)}})})]}))})),kd=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}];export{jd as Pagination};
