...
`,Wl=({color:t,className:n,size:i})=>e(Tl,Object.assign({className:n,$size:i,$color:t},{children:[r(Il,{id:"inner1"}),r(Pl,{id:"inner2"}),r(Rl,{id:"inner3"}),r(Yl,{id:"inner4"})]})),Hl=C`
    outline-offset: -1px;
...
`,cd=E(Wl)`
    ...
    color: ${hi.icon};
`;function ud(e,r){var t={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&r.indexOf(n)<0&&(t[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(e);i<n.length;i++)r.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(t[n[i]]=e[n[i]])}return t}"function"==typeof SuppressedError&&SuppressedError;const hd=E.button`
    display: flex;
...
`,fd=u.forwardRef(((e,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=ud(e,["children","focusHighlight","focusOutline","type"]);return r(hd,Object.assign({ref:t,$outline:o,$highlight:i,type:a},s,{children:n}))})),bd=E.div`
...
`,vd=$(((t,n)=>{var{value:i,variant:o,onClear:a}=t,s=ud(t,["value","variant","onClear"]);return e(bd,Object.assign({$variant:o},{children:[e(gd,Object.assign({$variant:o},{children:[r(pd,{"aria-hidden":!0}),r(md,Object.assign({ref:n,value:i,$variant:o},s))]})),i&&r(yd,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:a},{children:r(B,{"aria-hidden":!0})}))]}))})),xd=({listItems:n,multiSelect:i,selectedItems:o,disableItemFocus:a,itemsLoadState:s="success",itemTruncationType:l="end",itemMaxLines:d=2,labelDisplayType:c="inline",variant:u="default",listboxId:b,width:g,topScrollItem:m,onSelectItem:p,onSelectAll:v,onDismiss:w,onRetry:$,valueExtractor:O,listExtractor:E,renderListItem:C,renderCustomCallToAction:D,enableSearch:j,hideNoResultsDisplay:_,searchPlaceholder:S="Search",searchFunction:k,onSearch:A})=>{const{focusedIndex:M,setFocusedIndex:B}=F(Bl),[z,T]=f(""),[L,I]=f(n),P=Ml(s),R=(()=>{const[e,r]=f(!1);return y((()=>{r(!0)}),[]),e})(),Y=h(),W=h(),H=h([]),N=h(),V=e=>E?E(e):e.toString(),q=x((e=>!!sl(o,(r=>dl(r,e)))),[o]),U=Al((()=>k(z))),Z=Al((()=>n.filter((e=>{var r;const t=V(e),n="object"==typeof t?t.title.toLowerCase():t.toLowerCase(),i="string"==typeof t||null===(r=t.secondaryLabel)||void 0===r?void 0:r.toLowerCase(),o=z.trim().toLowerCase();return n.includes(o)||i&&i.includes(o)})))),X=(e,r)=>{B(r),null==p||p(e,(e=>O?O(e):e)(e))},Q=e=>{const r=e.target.value;T(r),null==A||A()},J=()=>{var e;T(""),null===(e=N.current)||void 0===e||e.focus(),null==A||A()},G=()=>{null==$||$()};((e,r,t="window",n)=>{const i=h();y((()=>{i.current=r}),[r]),y((()=>{let r;switch(t){case"window":r=window;break;case"document":r=document;break;default:r=t}if(!r||!r.addEventListener)return;const o=e=>i.current(e);return r.addEventListener(e,o,n),()=>{r.removeEventListener(e,o,n)}}),[e,t])})("keydown",(e=>{var r,t;switch(e.code){case"ArrowDown":if(e.preventDefault(),M<L.length-1){const e=M+1;null===(r=H.current[e])||void 0===r||r.focus(),B(e)}break;case"ArrowUp":if(e.preventDefault(),M>0){const e=M-1;null===(t=H.current[e])||void 0===t||t.focus(),B(e)}else 0===M&&N.current&&(N.current.focus(),B(-1));break;case"Space":case"Enter":document.activeElement===H.current[M]&&(e.preventDefault(),L[M]&&X(L[M],M))}})),y((()=>{if(void 0===m)return;const e=setTimeout((()=>{var e;const r=n.indexOf(m),t=H.current[r];if(Y.current){const r=null!==(e=null==t?void 0:t.offsetTop)&&void 0!==e?e:0;Y.current.scrollTop=r-8}B(r)}),0);return()=>clearTimeout(e)}),[H,n,B,m]),y((()=>{if(R)return;if(a)return;const e=n.findIndex((e=>q(e)));N.current?(B(-1),setTimeout((()=>{var e;return null===(e=N.current)||void 0===e?void 0:e.focus()}),200)):H.current[M]?setTimeout((()=>{var e;return null===(e=H.current[M])||void 0===e?void 0:e.focus()}),200):H.current[e]?(B(e),setTimeout((()=>{var r;return null===(r=H.current[e])||void 0===r?void 0:r.focus()}),200)):(B(0),setTimeout((()=>{var e;return null===(e=H.current[0])||void 0===e?void 0:e.focus()}),200))}),[q,a,M,n,R,B]),y((()=>{R&&P&&(a||"success"===s&&N.current&&(B(-1),N.current.focus()))}),[R,P,s,B,a]),y((()=>{I(""===z?n:k?U():Z())}),[U,Z,n,k,z]);const K=e=>i?r(e?td:nd,{"aria-hidden":!0}):e?r(ed,{"aria-hidden":!0}):r(rd,{}),ee=(e,t)=>{const n=V(e),i="string"==typeof n?n:n.title,o="string"==typeof n?void 0:n.secondaryLabel;return r(ji,{displayType:c,label:i,maxLines:d,selected:t,sublabel:o,truncationType:l,variant:u})},re=()=>{if(!$||$&&"success"===s)return L.map(((n,o)=>{const a=q(n),s=o===M;return r(Kl,Object.assign({"aria-selected":a,"aria-multiselectable":i,"data-testid":"list-item",onClick:()=>X(n,o),onMouseEnter:()=>(e=>{B(e)})(o),ref:e=>H.current[o]=e,role:"option",tabIndex:s?0:-1,$active:s,$selected:a},{children:C?C(n,{selected:a}):e(t,{children:[K(a),ee(n,a)]})}),((e,r)=>`item_${r}__${O?O(e):e}`)(n,o))}))},te=()=>{if((j||k)&&"success"===s)return r(vd,{ref:N,onChange:Q,value:z,placeholder:S,"data-testid":"search-input","aria-label":"Enter text to search",onClear:J,variant:u})},ne=()=>{if(i&&L.length>0&&!z&&"success"===s)return r(id,{children:r(sd,Object.assign({onClick:v,type:"button",$variant:u},{children:0===o.length?"Select all":"Clear all"}))})},ie=()=>{if(!_&&(z||!j)&&0===L.length&&"success"===s)return e(ld,Object.assign({"data-testid":"list-no-results"},{children:[r(dd,{"data-testid":"no-result-icon"}),"No results found."]}))},oe=()=>{if($&&"loading"===s)return e(ld,Object.assign({"data-testid":"list-loading"},{children:[r(cd,{}),"Loading..."]}))},ae=()=>{if($&&"fail"===s)return e(ld,Object.assign({"data-testid":"list-fail"},{children:[r(dd,{"data-testid":"load-error-icon"}),"Failed to load. ",r(ad,Object.assign({onClick:G,type:"button",$variant:u},{children:"Try again."}))]}))};return e(Ql,Object.assign({"data-testid":"dropdown-container",ref:Y,$width:g,$variant:u},{children:[e(Jl,Object.assign({ref:W,"data-testid":"dropdown-list"},{children:[te(),ne(),ie(),oe(),ae(),r(Gl,Object.assign({role:"listbox",id:b},{children:re()}))]})),(()=>{if(D)return r("div",Object.assign({"data-testid":"custom-cta"},{children:D(w,L)}))})()]}))},wd=E(Xl)`
    display: flex;
    align-items: center;
    gap: ${mi["spacing-8"]};
    width: 100%;
...
`,Fd=$((({children:t,disabled:n,expanded:i,listboxId:o,popupRole:a,readOnly:s,variant:l},d)=>e(wd,Object.assign({ref:d,type:"button","aria-expanded":i,"aria-haspopup":a,"data-testid":"selector",disabled:n,"aria-controls":o,$variant:l},{children:[t,!s&&r($d,Object.assign({$expanded:i,$variant:l},{children:r(T,{"aria-hidden":!0})}))]}))));E.button`
...
`,E(L)`
    ...
    width: 1lh;
    color: ${hi["icon-selected"]};
`;const Od=e=>"small"===e?2.5:3;E.div`
    position: relative;
    width: 100%;
    ${e=>{const r=Od(e.$variant);return C`
            min-height: ${r}rem;
...
`,Sd=E(_d)`
    color: ${hi["text-subtler"]};
`;var kd;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(kd||(kd={}));const Ad=E.div`
    display: flex;
    flex-direction: column;
`,Md=e=>"right"===e?"bottom-end":"bottom-start",Bd=({enabled:n,isOpen:i,onOpen:o,onClose:a,onDismiss:s,renderElement:l,renderDropdown:d,customZIndex:c,clickToToggle:u=!1,offset:b=0,alignment:g="left",fitAvailableHeight:m})=>{var p;const v=D(),x=yi["sm-max"]({theme:v}),w=h(null),$=h(null),{width:F}=Ge({targetRef:w,handleHeight:!1}),O={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<x;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:E,floatingStyles:C,context:j}=P({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==s||s():e&&!i?null==o||o():!e&&i&&(null==a||a(t))},whileElementsMounted:R,placement:Md(g),middleware:[Y(b),W(),H({limiter:N()}),V({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:m?`${e}px`:void 0,overflowY:m?"hidden":void 0})}}),O]}),_=(()=>{const[e,r]=f(void 0),t=I();return y((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(kd.Change,e),t.events.emit(kd.Ready),()=>t.events.off(kd.Change,e)}),[t]),e})(),{isMounted:S,styles:k}=q(j,{initial:{opacity:0},open:{opacity:1},duration:300}),A=U(j,{enabled:n,toggle:u}),M=Z(j,{enabled:n}),{getReferenceProps:B,getFloatingProps:z}=X([A,M]);return e(t,{children:[r("div",Object.assign({ref:e=>{w.current=e,E.setReference(e)}},B(),{children:l()})),S&&r(Q,{children:r(J,Object.assign({context:j,modal:!1,initialFocus:$,returnFocus:!1},{children:r("div",Object.assign({ref:E.setFloating,style:Object.assign(Object.assign({},C),{zIndex:null!==(p=null!=c?c:_)&&void 0!==p?p:50})},z(),{children:r(Ad,Object.assign({ref:$,style:Object.assign({},k),inert:k.opacity<1?"":void 0},{children:d({elementWidth:F})}))}))}))})]})},zd=({selectedOption:e,placeholder:t="Select",options:n,disabled:i,error:o,className:a,"data-testid":s,id:l,enableSearch:d=!1,searchFunction:c,searchPlaceholder:u,valueExtractor:b,valueToStringFunction:g,listExtractor:m,displayValueExtractor:p,onSelectOption:v,onShowOptions:x,onHideOptions:w,onRetry:$,optionsLoadState:F="success",optionTruncationType:O="end",renderCustomSelectedOption:E,renderListItem:C,hideNoResultsDisplay:D,renderCustomCallToAction:j,onBlur:_,variant:S="default",readOnly:k,alignment:A,dropdownZIndex:M})=>{const[B,z]=f(e),[T,L]=f(!1),[I,P]=f(!1),[R]=f((()=>kl.generate())),Y=h(),W=h(),H=h();y((()=>{z(e)}),[e]);const N=(e,r)=>{W.current.focus(),z(e),L(!1),X(!1),null==v||v(e,r)},V=()=>{T&&(L(!1),X(!1))},q=()=>{I||T||P(!0)},U=e=>{!I||T||Y.current.contains(e.relatedTarget)||(P(!1),null==_||_())},Z=e=>{if("middle"===O){let r=0;return H&&H.current&&(r=H.current.getBoundingClientRect().width),xi.truncateOneLine((e=>"string"==typeof e?e:g(e)||e.toString())(e),r,120,8)}return e},X=e=>{e?null==x||x():null==w||w()};return r(zl,{children:r(Bd,{enabled:!k&&!i,isOpen:T,renderElement:()=>r(Ul,Object.assign({className:a,"data-testid":s,id:l,ref:Y,tabIndex:-1,onFocus:q,onBlur:U,$focused:I,$disabled:i,$readOnly:k,$error:o},{children:r(Fd,Object.assign({ref:W,disabled:i,expanded:T,listboxId:R,popupRole:"listbox",readOnly:k,variant:S},{children:r(jd,Object.assign({ref:H,$disabled:i},{children:B?E?E(B):r(_d,Object.assign({truncateType:O,$variant:S},{children:Z(p?p(B):b?b(B):B.toString())})):r(Sd,Object.assign({truncateType:O,$variant:S},{children:t}))}))}))})),renderDropdown:({elementWidth:e})=>r(xd,{listboxId:R,listItems:n,onSelectItem:N,onDismiss:V,valueExtractor:b,listExtractor:m,enableSearch:d,searchPlaceholder:u,searchFunction:c,selectedItems:B?[B]:[],onRetry:$,itemsLoadState:F,itemTruncationType:O,renderListItem:C,hideNoResultsDisplay:D,renderCustomCallToAction:j,variant:S,width:e}),onOpen:()=>{L(!0),X(!0),P(!0)},onClose:e=>{L(!1),X(!1),"click"!==e&&(P(!1),null==_||_())},onDismiss:()=>{W.current.focus(),L(!1),X(!1)},clickToToggle:!0,offset:8,alignment:A,fitAvailableHeight:!0,customZIndex:M})})},Td=E(Zl)`
    width: 100%;
    height: calc(3rem - 2px); // exclude top and bottom borders
...
`,Yd=u.forwardRef(((n,i)=>{var{value:o,spacing:a,type:s,error:l,disabled:d,readOnly:c,onChange:u,onClear:f,allowClear:b=!1,className:g,styleType:m="bordered"}=n,p=ud(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const y=h();O(i,(()=>y.current),[]);const v=function({ref:e,formatter:r}){return()=>{const t=e.current,n=t.value,i=r(n),o=n.substring(0,t.selectionEnd),a=r(o),s=o.length-a.length,l=Math.max(0,t.selectionEnd-s);return{nextValue:i,updateCaretPosition:()=>{t.value=i,t.setSelectionRange(l,l)}}}}({ref:y,formatter:e=>xi.transformWithSpaces(e,a)}),x=e=>{u&&($()?F(e):u(e))},w=()=>{f&&f(),y&&y.current&&y.current.focus()},$=()=>"tel"===s&&a,F=e=>{const{nextValue:r,updateCaretPosition:t}=v(),n=r.replace(/\s/g,"");e.target.value=n,u(e),t()},E=o?(e=>e?$()?xi.transformWithSpaces(e,a):e:"")(o):o,C=b&&!d&&!c&&!!o,D=()=>e(t,{children:[r(Td,Object.assign({"data-testid":"input",ref:y,disabled:d,value:E,onChange:x,type:s,readOnly:c,$showClear:C,$styleType:m},p)),C&&r(Ld,Object.assign({onClick:w,type:"button",$styleType:m},{children:r(Id,{"aria-hidden":!0})}))]});return r(t,{children:"no-border"===m?r(Pd,Object.assign({className:g},{children:D()})):r(Rd,Object.assign({$disabled:d,$error:l,$readOnly:c,className:g},{children:D()}))})})),Wd=(e,r,t=!1)=>{const n=`${e}-${r.toLowerCase()}`;return C`
    ...
    color: ${hi.text};
`;var Nd;!function(t){const n=(e,r,t)=>{const n=E(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${e=>Hd(r,e)}
        `;return n.displayName=`Typography.${t}`,n};t.HeaderXXL=n("h1","header-xxl","HeaderXXL"),t.HeaderXL=n("h2","header-xl","HeaderXL"),t.HeaderLG=n("h3","header-lg","HeaderLG"),t.HeaderMD=n("h4","header-md","HeaderMD"),t.HeaderSM=n("h5","header-sm","HeaderSM"),t.HeaderXS=n("h6","header-xs","HeaderXS");const i=(e,r)=>{const t=E.p.attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${r=>Hd(e,r)}
        `;return t.displayName=`Typography.${r}`,t};t.BodyBL=i("body-baseline","BodyBL"),t.BodyMD=i("body-md","BodyMD"),t.BodySM=i("body-sm","BodySM"),t.BodyXS=i("body-xs","BodyXS");const o=(t,n)=>{const i=E.a`
            ...
            `}
        `,o=t=>{var{external:n=!1,children:o}=t,a=ud(t,["external","children"]);return e(i,Object.assign({},a,{children:[o,n&&r(Vd,{})]}))};return o.displayName=`Typography.${n}`,o};t.LinkBL=o("body-baseline","LinkBL"),t.LinkMD=o("body-md","LinkMD"),t.LinkSM=o("body-sm","LinkSM"),t.LinkXS=o("body-xs","LinkXS")}(Nd||(Nd={}));const Vd=E(G)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
    vertical-align: middle;
