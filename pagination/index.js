...
`,wd=T.button`
	...
	${e=>"small"===e.$buttonSizeStyle?O`
                ...
                `}
`,$d=T((({color:n,className:r,size:o=18})=>e(gd,Object.assign({className:r,$size:o,$color:n,"data-testid":"component-loading-spinner"},{children:[t(yd,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(bd,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(xd,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(Sd,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    ${e=>{let t=e.$buttonIsDanger?dd.Button.Danger.Primary:Pr.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Pr.Neutral[3](e);break;default:t=Pr.Neutral[8](e)}return O`
