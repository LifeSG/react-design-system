...
/*!**************************************************************************************!*\
    ...
    `,e.XSmall=T.span`
        ${e=>O`
                ...
                ${Rr(e.inline,e.paragraph,e.maxLines)}
            `}
    `,e.Hyperlink={Default:e=>Yr(Object.assign(Object.assign({},e),{textStyle:"Body"})),Small:e=>Yr(Object.assign(Object.assign({},e),{textStyle:"BodySmall"}))}}(Lr||(Lr={}));const Wr=T.a`
    ${e=>O`
...
`,gd=T.div`
    ...
    animation: ${pd} 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;
`,md=T(gd)`
...
`,bd={collections:{base:{InputBoxShadow:O`
    ...
    `,ElevationBoxShadow:O`
      0px 2px 8px ${Pr.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},xd=e=>t=>{var n;const r=t.theme,o=Br(bd,r[Tr.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?Fr(o,e,r.options.designToken):Fr(o,e)},Sd={InputBoxShadow:xd("InputBoxShadow"),InputErrorBoxShadow:xd("InputErrorBoxShadow"),ElevationBoxShadow:xd("ElevationBoxShadow"),Table:{Header:xd("Table.Header"),Cell:{Primary:xd("Table.Cell.Primary"),Secondary:xd("Table.Cell.Secondary"),Selected:xd("Table.Cell.Selected"),Hover:xd("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:xd("Button.Danger.BackgroundColor"),Hover:xd("Button.Danger.Hover"),Primary:xd("Button.Danger.Primary"),Border:xd("Button.Danger.Border")}}},wd=T.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return O`
                    ...
                    border: 1px solid
                        ${e.$buttonIsDanger?Sd.Button.Danger.Border:Pr.Primary};

                    color: ${e.$buttonIsDanger?Sd.Button.Danger.Primary:Pr.Primary};
                `;case"light":return O`
                    background-color: ${Pr.Neutral[8]};
                ...
                `;case"link":return O`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Sd.Button.Danger.Hover:Pr.Secondary};
                    }
                `;default:return O`
                    background-color: ${e.$buttonIsDanger?Sd.Button.Danger.BackgroundColor:Pr.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?O`
                ...
                `}
`,$d=T((({color:n,className:r,size:o=18})=>e(hd,Object.assign({className:r,$size:o,$color:n},{children:[t(gd,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),t(md,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),t(vd,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),t(yd,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Sd.Button.Danger.Primary:Pr.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Pr.Neutral[3](e);break;default:t=Pr.Neutral[8](e)}return O`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,Kd=O`
    ...
    box-shadow: ${Sd.InputErrorBoxShadow};
`,ef=T.div`
    border: 1px solid ${Pr.Neutral[5]};
    border-radius: 4px;
...
`,Sf=d.forwardRef(((e,n)=>{var{children:r,focusHighlight:o=!0,focusOutline:i="none",type:a="button"}=e,l=_r(e,["children","focusHighlight","focusOutline","type"]);return t(xf,Object.assign({ref:n,$outline:i,$highlight:o,type:a},l,{children:r}))})),wf=e=>"small"===e?1:1.125,$f=e=>O`
        height: ${wf(e)}rem;
        width: ${wf(e)}rem;
    `,Ff=T.div`
...
`,If=T(Sf)`
    ...
    ${e=>O`
        ...
        `}
`,Df=$(((n,r)=>{var{value:o,variant:i,onClear:a}=n,l=_r(n,["value","variant","onClear"]);return e(Ff,{children:[e(Bf,{children:[t(Of,{$variant:i,"aria-hidden":!0}),t(Tf,Object.assign({ref:r,value:o,$variant:i},l))]}),o&&t(If,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:a,$variant:i},{children:t(_,{"aria-hidden":!0})}))]})})),Cf=({listItems:r,multiSelect:o,selectedItems:i,disableItemFocus:a,itemsLoadState:l="success",itemTruncationType:s="end",itemMaxLines:c=2,labelDisplayType:u="inline",variant:d="default",listboxId:p,width:g,topScrollItem:m,onSelectItem:v,onSelectAll:b,onDismiss:S,onRetry:w,valueExtractor:$,listExtractor:B,renderListItem:T,renderCustomCallToAction:O,enableSearch:I,hideNoResultsDisplay:D,searchPlaceholder:C="Search",searchFunction:k,onSearch:H})=>{const{focusedIndex:E,setFocusedIndex:j}=F(qd),[z,R]=h(""),[_,M]=h(r),A=Gd(l),P=(()=>{const[e,t]=h(!1);return y((()=>{t(!0)}),[]),e})(),L=f(),W=f(),N=f([]),Y=f(),V=f(null),U=e=>B?B(e):e.toString(),G=x((e=>!!wl(i,(t=>Fl(t,e)))),[i]),q=Ud((()=>k(z))),J=Ud((()=>r.filter((e=>{var t;const n=U(e),r="object"==typeof n?n.title.toLowerCase():n.toLowerCase(),o="string"==typeof n||null===(t=n.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),i=z.trim().toLowerCase();return r.includes(i)||o&&o.includes(i)})))),Z=(e,t)=>{j(t),null==v||v(e,(e=>$?$(e):e)(e))},X=e=>{const t=e.target.value;R(t),null==H||H()},Q=()=>{var e;R(""),null===(e=Y.current)||void 0===e||e.focus(),null==H||H()},K=()=>{null==w||w()};((e,t,n="window",r)=>{const o=f();y((()=>{o.current=t}),[t]),y((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const i=e=>o.current(e);return t.addEventListener(e,i,r),()=>{t.removeEventListener(e,i,r)}}),[e,n])})("keydown",(e=>{var t,n;switch(e.code){case"ArrowDown":if(e.preventDefault(),E<_.length-1){const e=E+1;null===(t=N.current[e])||void 0===t||t.focus(),j(e)}break;case"ArrowUp":if(e.preventDefault(),E>0){const e=E-1;null===(n=N.current[e])||void 0===n||n.focus(),j(e)}else 0===E&&Y.current&&(Y.current.focus(),j(-1));break;case"Space":case"Enter":document.activeElement===N.current[E]&&(e.preventDefault(),_[E]&&Z(_[E],E))}})),y((()=>{if(!m&&V.current)return void V.current.scrollTo({top:0});const e=setTimeout((()=>{const e=r.indexOf(m);V.current&&-1!==e&&(V.current.scrollToIndex({index:e}),j(e))}),0);return()=>clearTimeout(e)}),[N,r,j,m]),y((()=>{if(P)return;if(a)return;const e=r.findIndex((e=>G(e)));Y.current?(j(-1),setTimeout((()=>{var e;return null===(e=Y.current)||void 0===e?void 0:e.focus()}),200)):E>0?(V.current.scrollToIndex({index:E,align:"center"}),setTimeout((()=>{var e;return null===(e=N.current[E])||void 0===e?void 0:e.focus()}),200)):-1!==e?(V.current.scrollToIndex({index:e,align:"center"}),j(e),setTimeout((()=>{var t;return null===(t=N.current[e])||void 0===t?void 0:t.focus()}),200)):(V.current.scrollToIndex({index:0}),j(0),setTimeout((()=>{var e;return null===(e=N.current[0])||void 0===e?void 0:e.focus()}),200))}),[G,a,E,r,P,j]),y((()=>{P&&A&&(a||"success"===l&&Y.current&&(j(-1),Y.current.focus()))}),[P,A,l,j,a]),y((()=>{M(""===z?r:k?q():J())}),[q,J,r,k,z]);const ee=e=>o?t(e?df:ff,{"aria-hidden":!0}):e?t(cf,{"aria-hidden":!0}):t(uf,{}),te=(e,n)=>{const r=U(e),o="string"==typeof r?r:r.title,i="string"==typeof r?void 0:r.secondaryLabel;return t(to,{displayType:u,label:o,maxLines:c,selected:n,sublabel:i,truncationType:s,variant:d})},ne=(r,i)=>{if(!w||w&&"success"===l){const a=G(r),l=i===E;return t(sf,Object.assign({"aria-selected":a,"aria-multiselectable":o,"data-testid":"list-item",onClick:()=>Z(r,i),onMouseEnter:()=>(e=>{j(e)})(i),ref:e=>{N.current[i]=e},role:"option",tabIndex:l?0:-1,$active:l},{children:T?T(r,{selected:a}):e(n,{children:[ee(a),te(r,a)]})}),((e,t)=>`item_${t}__${$?$(e):e}`)(r,i))}},re=()=>{if((I||k)&&"success"===l)return t(Df,{ref:Y,onChange:X,value:z,placeholder:C,"data-testid":"search-input","aria-label":"Enter text to search",onClear:Q,variant:d})},oe=()=>{if(o&&_.length>0&&!z&&"success"===l)return t(hf,{children:t(mf,Object.assign({onClick:b,type:"button",$variant:d},{children:0===i.length?"Select all":"Clear all"}))})},ie=()=>{if(!D&&(z||!I)&&0===_.length&&"success"===l)return e(vf,Object.assign({"data-testid":"list-no-results"},{children:[t(bf,{"data-testid":"no-result-icon",$variant:d}),t(yf,Object.assign({$variant:d},{children:"No results found."}))]}))},ae=()=>{if(w&&"loading"===l){const n="small"===d?16:18;return e(vf,Object.assign({"data-testid":"list-loading"},{children:[t($d,{$buttonStyle:"secondary",size:n}),t(yf,Object.assign({$variant:d},{children:"Loading..."}))]}))}},le=()=>{if(w&&"fail"===l)return e(vf,Object.assign({"data-testid":"list-fail"},{children:[t(bf,{"data-testid":"load-error-icon",$variant:d}),t(yf,Object.assign({$variant:d},{children:"Failed to load."}))," ",t(gf,Object.assign({onClick:K,type:"button",$variant:d},{children:"Try again."}))]}))};return e(of,Object.assign({"data-testid":"dropdown-container",ref:L,$width:g},{children:[e(af,Object.assign({ref:W,"data-testid":"dropdown-list"},{children:[re(),oe(),ie(),ae(),le(),t(lf,Object.assign({role:"listbox",id:p},{children:t(Eu,{ref:V,style:{height:"100%"},data:_,customScrollParent:L.current,itemContent:(e,t)=>ne(t,e)})}))]})),(()=>{if(O)return t("div",Object.assign({"data-testid":"custom-cta"},{children:O(S,_)}))})()]}))},kf="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Hf=T(rf)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,jf=$((({children:n,disabled:r,expanded:o,listboxId:i,popupRole:a,readOnly:l,variant:s},c)=>e(Hf,Object.assign({ref:c,type:"button","aria-expanded":o,"aria-haspopup":a,"data-testid":"selector",disabled:r,"aria-controls":i,$variant:s},{children:[n,!l&&t(Ef,Object.assign({$expanded:o,$variant:s},{children:t(A,{"aria-hidden":!0})}))]}))));T.li`
...
`,T(P)`
    ...
    width: 1.625rem;
    color: ${Pr.Primary};
`;const zf=e=>"small"===e?2.5:3;T.div`
    position: relative;
    width: 100%;
    ${e=>{const t=zf(e.$variant);return O`
            min-height: ${t}rem;
...
`,Lf=T(Pf)`
    color: ${Pr.Neutral[3]};
`;var Wf;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Wf||(Wf={}));const Nf=T.div`
    display: flex;
    flex-direction: column;
`,Yf=e=>"right"===e?"bottom-end":"bottom-start",Vf=({enabled:r,isOpen:o,onOpen:i,onClose:a,onDismiss:l,renderElement:s,renderDropdown:c,customZIndex:u,clickToToggle:d=!1,offset:p=0,alignment:g="left",fitAvailableHeight:m})=>{var v;const b=f(null),x=f(null),{width:S}=et({targetRef:b,handleHeight:!1}),w={name:"center",fn:({x:e,rects:t})=>{const n=0===e||e+t.floating.width===window.innerWidth,r=window.innerWidth<fd.mobileL;return{x:n&&r?(window.innerWidth-t.floating.width)/2:e}}},{refs:$,floatingStyles:F,context:B}=W({open:o,onOpenChange:(e,t,n)=>{"escape-key"===n?null==l||l():e&&!o?null==i||i():!e&&o&&(null==a||a(n))},whileElementsMounted:N,placement:Yf(g),middleware:[Y(p),V(),U({limiter:G()}),q({apply({availableHeight:e}){x.current&&Object.assign(x.current.style,{maxHeight:m?`${e}px`:void 0,overflowY:m?"hidden":void 0})}}),w]}),T=(()=>{const[e,t]=h(void 0),n=L();return y((()=>{if(!n)return void t(void 0);const e=e=>{t(e.zIndex)};return n.events.on(Wf.Change,e),n.events.emit(Wf.Ready),()=>n.events.off(Wf.Change,e)}),[n]),e})(),{isMounted:O,styles:I}=J(B,{initial:{opacity:0},open:{opacity:1},duration:300}),D=Z(B,{enabled:r,toggle:d}),C=X(B,{enabled:r}),{getReferenceProps:k,getFloatingProps:H}=Q([D,C]);return e(n,{children:[t("div",Object.assign({ref:e=>{b.current=e,$.setReference(e)}},k(),{children:s()})),O&&t(K,{children:t(ee,Object.assign({context:B,modal:!1,initialFocus:x,returnFocus:!1},{children:t("div",Object.assign({ref:$.setFloating,style:Object.assign(Object.assign({},F),{zIndex:null!==(v=null!=u?u:T)&&void 0!==v?v:50})},H(),{children:t(Nf,Object.assign({ref:x,style:Object.assign({},I),inert:I.opacity<1?"":void 0},{children:c({elementWidth:S})}))}))}))})]})},Uf=({selectedOption:e,placeholder:n="Select",options:r,disabled:o,error:i,className:a,"data-testid":l,id:s,enableSearch:c=!1,searchFunction:u,searchPlaceholder:d,valueExtractor:p,valueToStringFunction:g,listExtractor:m,displayValueExtractor:v,onSelectOption:b,onShowOptions:x,onHideOptions:S,onRetry:w,optionsLoadState:$="success",optionTruncationType:F="end",renderCustomSelectedOption:B,renderListItem:T,hideNoResultsDisplay:O,renderCustomCallToAction:I,onBlur:D,variant:C="default",readOnly:k,alignment:H,dropdownZIndex:E})=>{const[j,z]=h(e),[R,_]=h(!1),[M,A]=h(!1),[P]=h((()=>Vd.generate())),L=f(),W=f(),N=f();y((()=>{z(e)}),[e]);const Y=(e,t)=>{W.current.focus(),z(e),_(!1),J(!1),null==b||b(e,t)},V=()=>{R&&(_(!1),J(!1))},U=()=>{M||R||A(!0)},G=e=>{!M||R||L.current.contains(e.relatedTarget)||(A(!1),null==D||D())},q=e=>{if("middle"===F){let t=0;return N&&N.current&&(t=N.current.getBoundingClientRect().width),Gr.truncateOneLine((e=>"string"==typeof e?e:g(e)||e.toString())(e),t,120,8)}return e},J=e=>{e?null==x||x():null==S||S()};return t(Jd,{children:t(Vf,{enabled:!k&&!o,isOpen:R,renderElement:()=>t(ef,Object.assign({className:a,"data-testid":l,id:s,ref:L,tabIndex:-1,onFocus:U,onBlur:G,$focused:M,$disabled:o,$readOnly:k,$error:i},{children:t(jf,Object.assign({ref:W,disabled:o,expanded:R,listboxId:P,popupRole:"listbox",readOnly:k,variant:C},{children:t(Af,Object.assign({ref:N,$disabled:o},{children:j?B?B(j):t(Pf,Object.assign({truncateType:F,$variant:C},{children:q(v?v(j):p?p(j):j.toString())})):t(Lf,Object.assign({truncateType:F,$variant:C},{children:n}))}))}))})),renderDropdown:({elementWidth:e})=>t(Cf,{listboxId:P,listItems:r,onSelectItem:Y,onDismiss:V,valueExtractor:p,listExtractor:m,enableSearch:c,searchPlaceholder:d,searchFunction:u,selectedItems:j?[j]:[],onRetry:w,itemsLoadState:$,itemTruncationType:F,renderListItem:T,hideNoResultsDisplay:O,renderCustomCallToAction:I,variant:C,width:e}),onOpen:()=>{_(!0),J(!0),A(!0)},onClose:e=>{_(!1),J(!1),"click"!==e&&(A(!1),null==D||D())},onDismiss:()=>{W.current.focus(),_(!1),J(!1)},clickToToggle:!0,offset:8,alignment:H,fitAvailableHeight:!0,customZIndex:E})})},Gf={Default:d.forwardRef(((n,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:l="default",danger:s=!1}=n,c=_r(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"default",$buttonIsDanger:s};return e(wd,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},u,c,{children:[a&&t($d,Object.assign({},u)),t("span",{children:o})]}))})),Small:d.forwardRef(((n,r)=>{const{children:o,disabled:i=!1,loading:a=!1,styleType:l="default",danger:s=!1}=n,c=_r(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:i?"disabled":l,$buttonSizeStyle:"small",$buttonIsDanger:s};return e(wd,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:i},u,c,{children:[a&&t($d,Object.assign({},u,{size:16})),t("span",{children:o})]}))}))},qf=T.input`
    ${zr("Body","regular")}
    color: ${Pr.Neutral[1]};
...
`,Xf=T.div`
    display: flex;
    width: 100%;
`,Qf=d.forwardRef(((r,o)=>{var{value:i,spacing:a,type:l,error:s,disabled:c,readOnly:u,onChange:d,onClear:h,allowClear:p=!1,className:g,styleType:m="bordered"}=r,v=_r(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const y=f();B(o,(()=>y.current),[]);const b=function({ref:e,formatter:t}){return()=>{const n=e.current,r=n.value,o=t(r),i=r.substring(0,n.selectionEnd),a=t(i),l=i.length-a.length,s=Math.max(0,n.selectionEnd-l);return{nextValue:o,updateCaretPosition:()=>{n.value=o,n.setSelectionRange(s,s)}}}}({ref:y,formatter:e=>Gr.transformWithSpaces(e,a)}),x=e=>{d&&(w()?$(e):d(e))},S=()=>{h&&h(),y&&y.current&&y.current.focus()},w=()=>"tel"===l&&a,$=e=>{const{nextValue:t,updateCaretPosition:n}=b(),r=t.replace(/\s/g,"");e.target.value=r,d(e),n()},F=i?(e=>e?w()?Gr.transformWithSpaces(e,a):e:"")(i):i,T=()=>e(n,{children:[t(qf,Object.assign({"data-testid":"input",ref:y,disabled:c,value:F,onChange:x,type:l,readOnly:u},v)),p&&!c&&!u&&!!i&&t(Jf,Object.assign({onClick:S,type:"button"},{children:t(Zf,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===m?t(Xf,Object.assign({className:g},{children:T()})):t(tf,Object.assign({$disabled:c,$error:s,$readOnly:u,className:g},{children:T()}))})})),Kf=T.nav`
    display: flex;
`,eh=T.div`
    display: flex;
    align-items: center;
...
`,dh=T.div`
    width: 9.2rem;
    margin-left: 0.5rem;
`,fh=d.forwardRef((({id:n,"data-testid":u,className:d,pageSize:f=10,totalItems:p,activePage:g,pageSizeOptions:m=hh,showFirstAndLastNav:v,showPageSizeChanger:b=!1,onPageChange:x,onPageSizeChange:S},w)=>{const $=ie.useMediaQuery({maxWidth:cd.mobileL}),F=m,[B,T]=h(!1),[O,I]=h(!1),[D,C]=h(""),[k,H]=h(F&&F.length>=1?F[0]:null),[E,j]=h(!$&&b&&k?k.value:f),z=Math.ceil(p/E),R=1===g,_=g===z,M=g>1?()=>U(1):void 0,A=g<z?()=>U(z):void 0,P=g>1?()=>U(g-1):void 0,L=g<z?()=>U(parseInt(g.toString())+1):void 0,W=e=>e?()=>K():()=>X(),N=e=>e?()=>ee():()=>Q();y((()=>{g&&Y(g)}),[g]),y((()=>{var e;j(f),H(null!==(e=F.find((e=>e.value===f)))&&void 0!==e?e:null)}),[f]);const Y=e=>{C(e.toString())},V=()=>{T(!1),I(!1)},U=e=>{x&&(x(e),Y(e))},G=()=>{const e=Math.min(z,g+5);U(e),Y(e),T(!0),I(!1)},q=()=>{const e=Math.max(1,g-5);U(e),Y(e),T(!1),I(!0)},J=e=>{const t=e.target.value;if(void 0===t||0===t.length)C("");else if(/^[0-9]+$/.test(t)){const e=parseInt(t.replace(/[^0-9]/g,""));Y(Math.max(1,Math.min(z,e)))}else C(t.replace(/[^0-9]/g,""))},Z=e=>{e.preventDefault(),D&&x(parseInt(D))},X=()=>{T(!0)},Q=()=>{T(!1)},K=()=>{I(!0)},ee=()=>{I(!1)},te=(n,i,a)=>e(ih,{children:[t(nh,Object.assign({focusHighlight:!1,focusOutline:"browser","aria-label":n?"Previous 5 pages":"Next 5 pages",onMouseOver:W(n),onMouseOut:N(n),onFocus:W(n),onBlur:N(n),onClick:n?q:G},{children:t(n&&O?r:i&&B?o:c,{"aria-hidden":!0})})),n&&O&&t(uh,{children:"Previous 5 pages"}),i&&B&&t(uh,{children:"Next 5 pages"})]},a);return e(Kf,Object.assign({className:d,ref:w,id:n||"pagination-wrapper","data-testid":u||"pagination","aria-label":"Pagination"},{children:[t(eh,{children:e(th,{children:[v&&t(rh,Object.assign({onClick:M,disabled:R,focusHighlight:!1,$position:"left","aria-label":"First page",focusOutline:"browser"},{children:t(a,{"aria-hidden":!0})})),t(rh,Object.assign({onClick:P,disabled:R,focusHighlight:!1,$position:"left","aria-label":"Previous page",focusOutline:"browser"},{children:t(i,{"aria-hidden":!0})})),$?e(ah,{children:[t("form",Object.assign({onSubmit:Z},{children:t(ch,{value:D,onChange:J,autoComplete:"off",type:"numeric",id:(n||"pagination")+"-input","data-testid":(u||"pagination")+"-input"})})),t(sh,{children:"/"}),t(lh,{children:z})]}):[...Array(z)].map(((e,n)=>{const r=n+1,o=z-5,i=g===r;if(z<=7)return t(oh,Object.assign({onClick:()=>U(r),$selected:i,"aria-label":"Page "+r,"aria-current":!!i&&"page",onMouseOver:V,onFocus:V},{children:r}),r);const a=g+1>5&&2===r,l=g-1<=o&&r===z-1-1;return a||l?te(a,l,r):r<=5&&g+1<=5||r<=1||r===g||r<=g+1&&r>=g-1-1||r>o&&g-1>o||r>z-1?t(oh,Object.assign({onClick:()=>U(r),$selected:i,"aria-label":"Page "+r,"aria-current":!!i&&"page",onMouseOver:V,onFocus:V},{children:r}),r):null})),t(rh,Object.assign({onClick:L,disabled:_,focusHighlight:!1,$position:"right","aria-label":"Next page",focusOutline:"browser"},{children:t(s,{"aria-hidden":!0})})),v&&t(rh,Object.assign({onClick:A,disabled:_,focusHighlight:!1,$position:"right","aria-label":"Last page",focusOutline:"browser"},{children:t(l,{"aria-hidden":!0})}))]})}),b&&!$&&t(dh,{children:t(Uf,{options:F,valueExtractor:e=>e.value,listExtractor:e=>e.label,displayValueExtractor:e=>e.label,selectedOption:k,onSelectOption:e=>{H(e);const t=e.value,n=Math.ceil(p/t);j(t);S&&S(g>=n?n:g,t)}})})]}))})),hh=[{value:10,label:"10 / page"},{value:20,label:"20 / page"},{value:30,label:"30 / page"}];export{fh as Pagination};
