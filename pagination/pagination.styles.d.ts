...
export declare const Label: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
export declare const LabelDivider: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
