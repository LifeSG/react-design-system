...
`;p.button`
	...
	${e=>"small"===e.$buttonSizeStyle?g`
                ...
                `}
`;const yc=p((({color:r,className:n,size:a=18})=>e(dc,Object.assign({className:n,$size:a,$color:r},{children:[t(fc,{id:"inner1",$size:a-2,$borderWidth:2,$color:r}),t(pc,{id:"inner2",$size:a-2,$borderWidth:2,$color:r}),t(gc,{id:"inner3",$size:a-2,$borderWidth:2,$color:r}),t(mc,{id:"inner4",$size:a-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
...
`,Hc=a.forwardRef(((e,r)=>{var{children:n,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=O(e,["children","focusHighlight","focusOutline","type"]);return t(Ic,Object.assign({ref:r,$outline:i,$highlight:a,type:o},s,{children:n}))})),Tc=e=>"small"===e?1:1.375,Nc=e=>g`
        height: ${Tc(e)}rem;
        width: ${Tc(e)}rem;
    `,Lc=p.li`
...
`;p(ed)`
    color: ${Kt.Neutral[3]};
`;const td=({children:e,show:r,error:n,disabled:a,testId:s,onBlur:l,readOnly:u,className:c,variant:d})=>{const h=i();return((e,t,r="window",n)=>{const a=i();o((()=>{a.current=t}),[t]),o((()=>{let t;switch(r){case"window":t=window;break;case"document":t=document;break;default:t=r}if(!t||!t.addEventListener)return;const i=e=>a.current(e);return t.addEventListener(e,i,n),()=>{t.removeEventListener(e,i,n)}}),[e,r])})("mousedown",(function(e){if(!a){if(h&&h.current.contains(e.target))return;r&&l()}}),"document"),t(Jc,Object.assign({className:c,$variant:d},{children:t(Kc,Object.assign({ref:h,error:n&&!r,disabled:a,$readOnly:u,expanded:r,"data-testid":s},{children:e}))}))};var rd;!function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(rd||(rd={})),p.div`
    display: flex;
    flex-direction: column;
`;const nd=p.div`
    position: relative;
