...
`;g.button`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const Vc=g((({color:e,className:n,size:a=18})=>t(Ic,{className:n,$size:a,$color:e,children:[r(Dc,{id:"inner1",$size:a-2,$borderWidth:2}),r(Mc,{id:"inner2",$size:a-2,$borderWidth:2}),r(Tc,{id:"inner3",$size:a-2,$borderWidth:2}),r(Hc,{id:"inner4",$size:a-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
