...
`;g.button`
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`;const Cc=g((({color:e,className:n,size:a=18})=>t(vc,{className:n,$size:a,$color:e,children:[r(xc,{id:"inner1",$size:a-2,$borderWidth:2}),r($c,{id:"inner2",$size:a-2,$borderWidth:2}),r(_c,{id:"inner3",$size:a-2,$borderWidth:2}),r(Sc,{id:"inner4",$size:a-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
