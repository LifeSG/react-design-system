...
`,Ct=n=>{var{external:r=!1,children:a}=n,o=i(n,["external","children"]);return e(zt,Object.assign({},o,{children:[a,r&&t(Ot,{})]}))};var Tt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Tt||(Tt={}));const Vt=n.div`
    border-radius: 1rem;
...
`,Nt=n.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,Wt=n=>{var{type:r,colorType:a="black",children:o,icon:l}=n,c=i(n,["type","colorType","children","icon"]);return e(Vt,Object.assign({$type:r,$color:a},c,{children:[l,t(Nt,{children:o})]}))};export{Wt as Pill};
