...
`,Vt=n=>{var{external:r=!1,children:a}=n,o=i(n,["external","children"]);return e(At,Object.assign({},o,{children:[a,r&&t(Ot,{})]}))};var Tt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Tt||(Tt={}));const Wt=n.div`
    border-radius: 1rem;
...
`,Ct=n.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,Nt=n=>{var{type:r,colorType:a="black",children:o,icon:l}=n,c=i(n,["type","colorType","children","icon"]);return e(Wt,Object.assign({$type:r,$color:a},c,{children:[l,t(Ct,{children:o})]}))};export{Nt as Pill};
