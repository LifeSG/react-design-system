...
`,cr=x.div`
    ...
    color: ${An[1]};
    ${ir({textSize:"BodySmall"})}
`,ur=r=>{var{children:o,visible:i,onMobileClose:a}=r,s=E(r,["children","visible","onMobileClose"]);const l=s["data-testid"]||"popover",c=M.useMediaQuery({maxWidth:fe.mobileL}),u=()=>{a&&a()},d=()=>"string"==typeof o?e(Qn.BodySmall,{children:o}):o;return t(n,{children:[i&&e(ar,Object.assign({"data-testid":l},s,{children:e(sr,{children:d()})})),c&&e(ye,Object.assign({show:i,onOverlayClick:u},{children:e(lr,Object.assign({onClose:u},{children:e(cr,{children:d()})}))}))]})},dr=x.div`
    display: inline;
    width: fit-content;
    cursor: pointer;
    position: relative;
`,fr=r=>{var l,c,{children:u,popoverContent:$,trigger:x="click",position:w="top",zIndex:O,rootNode:B,customOffset:H,delay:k,onPopoverAppear:_,onPopoverDismiss:j}=r,C=E(r,["children","popoverContent","trigger","position","zIndex","rootNode","customOffset","delay","onPopoverAppear","onPopoverDismiss"]);const[A,z]=o(!1),T=a(),P=a(),L=M.useMediaQuery({maxWidth:me.mobileL}),{refs:I,floatingStyles:W,context:R}=d({open:A,placement:w,whileElementsMounted:f,middleware:[h(null!=H?H:16),p(),m({limiter:g()})],onOpenChange:e=>{z(e),A!==e&&X(e)}}),Y=(()=>{const[e,t]=o(void 0),n=s();return i((()=>{if(!n)return void t(void 0);const e=e=>{t(e.zIndex)};return n.events.on(ie.Change,e),n.events.emit(ie.Ready),()=>n.events.off(ie.Change,e)}),[n]),e})(),V=L?"click":x,N=y(R,{ignoreMouse:"hover"===V}),J=v(R),Z=b(R,{enabled:"hover"===V,delay:{open:null!==(l=null==k?void 0:k.open)&&void 0!==l?l:0,close:null!==(c=null==k?void 0:k.close)&&void 0!==c?c:500}}),{getReferenceProps:q,getFloatingProps:Q}=S([N,J,Z]),U=()=>{z(!1),X(!1)},X=e=>{e&&_&&_(),!e&&j&&j()};return t(n,{children:[e(dr,Object.assign({ref:e=>{T.current=e,I.setReference(e)}},q({onClick:e=>{e.stopPropagation(),e.preventDefault()}}),C,{children:u})),A&&e(F,Object.assign({root:B},{children:e(D,Object.assign({context:R},{children:e("div",Object.assign({ref:e=>{P.current=e,I.setFloating(e)},style:Object.assign(Object.assign({},W),{outline:"none",zIndex:null!=O?O:Y})},Q(),{children:"function"==typeof $?$():e(ur,Object.assign({visible:!0,onMobileClose:U},{children:$}))}))}))}))]})},hr=e=>{switch(e){case"underline":return"text-decoration: underline 1px;";case"underline-dashed":return"text-decoration: underline dashed 1px;"}},pr=x.span`
    color: ${jn};
    font-weight: 600;
