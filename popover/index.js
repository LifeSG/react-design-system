...
`,Yn=c.div`
    ...
    ${e=>{let t="";return e.$show?t+=u`
            ...
            `,e.$disableTransition&&(t+=u`
                transition: none;
            `),t}}
`,Rn=({show:e=!1,rootId:n,onOverlayClick:s,children:c,backgroundOpacity:u,backgroundBlur:d=!0,disableTransition:f=!1,enableOverlayClick:h=!1,zIndex:p,id:m})=>{const[g,y]=i(null),[v,b]=i(),[F]=i((()=>In.generate())),S=o(),D=o(null),w=c&&r.cloneElement(c,{ref:D}),x=m?`lifesg-ds-overlay-root-${m}`:"lifesg-ds-overlay-root";a((()=>(E(),y(B()),()=>{M(),j().length<1&&_("remove")})),[]),a((()=>{if(e){const e=O();$(e),k();const t=setTimeout((()=>{_("add")}),200);return()=>clearTimeout(t)}{M();const e=setTimeout((()=>{j().length<1&&_("remove")}),200);return()=>clearTimeout(e)}}),[e]);const $=e=>{S.current=e,b(e)},B=()=>document&&n?document.getElementById(n):document?document.body:null,O=()=>j().length>0,E=()=>{if(!document.getElementById(Vn)){const e=document.createElement("style");e.id=Vn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${Nn} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Nn}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},_=e=>{const t=document.body.classList.contains(Nn);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(Nn):document.body.classList.add(Nn)},j=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},k=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=[...e,F].join(",")},M=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==F)).join(",")},H=e=>{var t;const n=null===(t=D.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||s&&h&&(e.preventDefault(),s())};return g?l.createPortal(t(Pn,Object.assign({id:x,"data-testid":x,$show:e,zIndex:p,$stacked:v},{children:c&&t(Yn,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:u||(v?.5:.8),$backgroundBlur:d,$disableTransition:f,$enableOverlayClick:h,onClick:H},{children:w}))})),g):null},Vn="lifesg-ds-overlay-stylesheet",Nn="lifesg-ds-overlay-open",Zn=e=>Object.keys(v).reduce(((t,n)=>{const r=v[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),Xn=Zn("max-width"),qn=(Zn("min-width"),c.div`
    position: relative;
    display: flex;
...
`,er="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",tr=c.div`
    max-width: 30rem;
    pointer-events: auto;
    position: absolute;
...
`,nr=c((n=>{var{id:r="modal-box",children:i,onClose:o,showCloseButton:a=!0}=n,s=f(n,["id","children","onClose","showCloseButton"]);return e(Jn,Object.assign({"data-testid":r},s,{onClick:e=>{e.stopPropagation()}},{children:[a&&t(Kn,Object.assign({onClick:o,"data-testid":"close-button",focusHighlight:!1},{children:t(d,{})})),i]}))}))`
...
`,ar=r=>{var{children:s,visible:c,onMobileClose:u}=r,l=f(r,["children","visible","onMobileClose"]);const d=l["data-testid"]||"popover",[h,p]=i("none"),m=o(null),g=y.useMediaQuery({maxWidth:v.mobileL}),b=o(h);a((()=>(D(),window.addEventListener("resize",ne(F,300)),()=>{window.removeEventListener("resize",ne(F,300))})),[]);const F=()=>{D()},S=()=>{u&&u()},D=()=>{const e=w();var t;e&&(t=e,b.current=t,p(t))},w=()=>{if(m.current){const e=m.current.getBoundingClientRect(),t=24,n=e.y<t,r=window.innerWidth-t;return e.x<t?n?"top-left":"left":e.x+e.width>r?n?"top-right":"right":("top-left"===b.current||"left"===b.current)&&e.x-e.width/2>t||("top-right"===b.current||"right"===b.current)&&e.x+2*e.width<r?n?"top-center":"none":n?"top-center":void 0}},x=()=>"string"==typeof s?t(fn.BodySmall,{children:s}):s;return e(n,{children:[t(tr,Object.assign({ref:m,"data-testid":d,$visible:c,$offset:h},l,{children:t(yn,{children:x()})})),g&&t(Qn,Object.assign({show:c,onOverlayClick:S},{children:t(nr,Object.assign({onClose:S},{children:t(or,{children:x()})}))}))]})},sr=(n,r)=>s=>{const{onPopoverAppear:c,onPopoverDismiss:u}=s,l=f(s,["onPopoverAppear","onPopoverDismiss"]),d=r.trigger||"click",h=l,[p,m]=i(!1),g=o(),b=y.useMediaQuery({maxWidth:v.mobileL});a((()=>{if(!b)return document.addEventListener("mousedown",F),()=>{document.removeEventListener("mousedown",F)}}),[p]);const F=e=>{g&&!g.current.contains(e.target)&&(p&&m(!1),u&&u())};return e(rr,Object.assign({id:"popover-hoc-wrapper",ref:g},{children:[t(ir,Object.assign({id:`popover-hoc-trigger${r["data-testid"]&&`-${r["data-testid"]}`}`,type:"button",onClick:e=>{e.preventDefault(),("click"===d||b)&&(m(!p),!p&&c&&c(),p&&u&&u())},onMouseEnter:()=>{"hover"!==d||b||m(!0)},onMouseLeave:()=>{"hover"===d&&p&&!b&&m(!1)},"aria-label":"popover-button"},{children:t(n,Object.assign({},h))})),t(ar,Object.assign({visible:p,id:r.id,"data-testid":r["data-testid"],onMobileClose:()=>{m(!1)}},{children:r.content}))]}))};export{ar as Popover,sr as withPopover};
