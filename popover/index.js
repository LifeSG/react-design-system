...
`,vn=c.div`
    ...
    ${e=>{let t="";return e.$show?t+=s`
            ...
            `,e.$disableTransition&&(t+=s`
                transition: none;
            `),t}}
`,bn=({show:e=!1,rootId:t,onOverlayClick:r,children:c,backgroundOpacity:s,backgroundBlur:d=!0,disableTransition:f=!1,enableOverlayClick:p=!1,zIndex:h,id:y})=>{const[m,g]=i(null),[v,b]=i(),w=a(),F=a(null),S=c&&o.cloneElement(c,{ref:F}),x=y?`lifesg-ds-overlay-root-${y}`:"lifesg-ds-overlay-root";l((()=>{if(e){const e=B();if($(e),!e){const e=setTimeout((()=>{O("add")}),200);return()=>clearTimeout(e)}}else if(!w.current){const e=setTimeout((()=>{O("remove")}),200);return()=>clearTimeout(e)}}),[e]),l((()=>{g(_());const e=B();return $(e),e||C(),()=>{O("remove")}}),[]);const $=e=>{w.current=e,b(e)},_=()=>document&&t?document.getElementById(t):document?document.body:null,B=()=>document.body.classList.contains(Fn),C=()=>{if(!document.getElementById(wn)){const e=document.createElement("style");e.id=wn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${Fn} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Fn}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},O=e=>{const t=document.body.classList.contains(Fn);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(Fn):document.body.classList.add(Fn)},j=e=>{const t=F.current?.firstChild;t&&t.contains(e.target)||r&&p&&(e.preventDefault(),r())};return m?u.createPortal(n(gn,{id:x,"data-testid":x,$show:e,zIndex:h,$stacked:v,children:c&&n(vn,{"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:s||(v?.5:.8),$backgroundBlur:d,$disableTransition:f,$enableOverlayClick:p,onClick:j,children:S})}),m):null},wn="lifesg-ds-overlay-stylesheet",Fn="lifesg-ds-overlay-open",Sn=e=>Object.keys(h).reduce(((t,n)=>{const r=h[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),xn=Sn("max-width"),$n=(Sn("min-width"),c.div`
    position: relative;
    display: flex;
...
`,Dn=o.forwardRef((({children:e,focusHighlight:t=!0,focusOutline:r="none",type:o="button",...i},a)=>n(En,{ref:a,$outline:r,$highlight:t,type:o,...i,children:e}))),Hn=c.div`
    position: relative;
    display: flex;
...
`,Tn=c(Bn)`
    ...
    width: 1.5rem;
    color: ${en[4]};
`,zn="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",An=c.div`
    max-width: 30rem;
    pointer-events: auto;
    position: absolute;
...
`,Pn=c((({id:e="modal-box",children:r,onClose:o,showCloseButton:i=!0,...a})=>t(Hn,{"data-testid":e,...a,onClick:e=>{e.stopPropagation()},children:[i&&n(kn,{onClick:o,"data-testid":"close-button",focusHighlight:!1,children:n(Tn,{})}),r]})))`
