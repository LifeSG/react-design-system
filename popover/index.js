...
`,yn=c.div`
    ...
    ${e=>{let t="";return e.$show?t+=s`
            ...
            `,e.$disableTransition&&(t+=s`
                transition: none;
            `),t}}
`,mn=({show:e=!1,rootId:n,onOverlayClick:l,children:c,backgroundOpacity:s,backgroundBlur:d=!0,disableTransition:f=!1,enableOverlayClick:p=!1,zIndex:h,id:y})=>{const[m,g]=o(null),[v,b]=o(),w=i(),F=i(!1),S=i(null),x=c&&r.cloneElement(c,{ref:S}),$=y?`lifesg-ds-overlay-root-${y}`:"lifesg-ds-overlay-root";a((()=>{const t=!0===F.current;if(t||(F.current=!0),e){const e=O();if(_(e),!e){const e=setTimeout((()=>{E("add")}),200);return()=>clearTimeout(e)}}else{if(!t)return;if(!w.current){const e=setTimeout((()=>{E("remove")}),200);return()=>clearTimeout(e)}}}),[e]),a((()=>{g(B());const e=O();return _(e),e||j(),()=>{E("remove")}}),[]);const _=e=>{w.current=e,b(e)},B=()=>document&&n?document.getElementById(n):document?document.body:null,O=()=>document.body.classList.contains(vn),j=()=>{if(!document.getElementById(gn)){const e=document.createElement("style");e.id=gn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${vn} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${vn}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},E=e=>{const t=document.body.classList.contains(vn);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(vn):document.body.classList.add(vn)},D=e=>{const t=S.current?.firstChild;t&&t.contains(e.target)||l&&p&&(e.preventDefault(),l())};return m?u.createPortal(t(hn,{id:$,"data-testid":$,$show:e,zIndex:h,$stacked:v,children:c&&t(yn,{"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:s||(v?.5:.8),$backgroundBlur:d,$disableTransition:f,$enableOverlayClick:p,onClick:D,children:x})}),m):null},gn="lifesg-ds-overlay-stylesheet",vn="lifesg-ds-overlay-open",bn=e=>Object.keys(y).reduce(((t,n)=>{const r=y[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),wn=bn("max-width"),Fn=(bn("min-width"),c.div`
    position: relative;
    display: flex;
