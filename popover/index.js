...
`,Yn=c.div`
    ...
    ${e=>{let t="";return e.$show?t+=u`
            ...
            `,e.$disableTransition&&(t+=u`
                transition: none;
            `),t}}
`,Rn=({show:e=!1,rootId:n,onOverlayClick:s,children:c,backgroundOpacity:u,backgroundBlur:d=!0,disableTransition:f=!1,enableOverlayClick:h=!1,zIndex:p,id:m})=>{const[g,y]=i(null),[v,b]=i(),[F]=i((()=>In.generate())),S=o(),w=o(null),$=c&&r.cloneElement(c,{ref:w}),x=m?`lifesg-ds-overlay-root-${m}`:"lifesg-ds-overlay-root";a((()=>(E(),y(O()),()=>{C(),j().length<1&&_("remove")})),[]),a((()=>{if(e){const e=B();D(e),M();const t=setTimeout((()=>{_("add")}),200);return()=>clearTimeout(t)}{C();const e=setTimeout((()=>{j().length<1&&_("remove")}),200);return()=>clearTimeout(e)}}),[e]);const D=e=>{S.current=e,b(e)},O=()=>document&&n?document.getElementById(n):document?document.body:null,B=()=>j().length>0,E=()=>{if(!document.getElementById(Vn)){const e=document.createElement("style");e.id=Vn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${Nn} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Nn}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},_=e=>{const t=document.body.classList.contains(Nn);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(Nn):document.body.classList.add(Nn)},j=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},M=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=[...e,F].join(",")},C=()=>{const e=j();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==F)).join(",")},k=e=>{var t;const n=null===(t=w.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||s&&h&&(e.preventDefault(),s())};return g?l.createPortal(t(Pn,Object.assign({id:x,"data-testid":x,$show:e,zIndex:p,$stacked:v},{children:c&&t(Yn,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:u||(v?.5:.8),$backgroundBlur:d,$disableTransition:f,$enableOverlayClick:h,onClick:k},{children:$}))})),g):null},Vn="lifesg-ds-overlay-stylesheet",Nn="lifesg-ds-overlay-open",Zn=e=>Object.keys(v).reduce(((t,n)=>{const r=v[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),qn=Zn("max-width"),Xn=(Zn("min-width"),c.div`
    position: relative;
    display: flex;
