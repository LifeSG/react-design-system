...
`,Pn=c.div`
    ...
    ${e=>{let t="";return e.$show?t+=u`
            ...
            `,e.$disableTransition&&(t+=u`
                transition: none;
            `),t}}
`,Rn=({show:e=!1,rootId:n,onOverlayClick:s,children:c,backgroundOpacity:u,backgroundBlur:d=!0,disableTransition:f=!1,enableOverlayClick:h=!1,zIndex:p,id:m})=>{const[y,g]=i(null),[v,b]=i(),[S]=i((()=>Wn.generate())),w=o(),$=o(null),x=c&&r.cloneElement(c,{ref:$}),F=m?`lifesg-ds-overlay-root-${m}`:"lifesg-ds-overlay-root";a((()=>(_(),g(O()),()=>{H(),E().length<1&&j("remove")})),[]),a((()=>{if(e){const e=B();D(e),M();const t=setTimeout((()=>{j("add")}),200);return()=>clearTimeout(t)}{H();const e=setTimeout((()=>{E().length<1&&j("remove")}),200);return()=>clearTimeout(e)}}),[e]);const D=e=>{w.current=e,b(e)},O=()=>document&&n?document.getElementById(n):document?document.body:null,B=()=>E().length>0,_=()=>{if(!document.getElementById(Vn)){const e=document.createElement("style");e.id=Vn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${Nn} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Nn}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},j=e=>{const t=document.body.classList.contains(Nn);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(Nn):document.body.classList.add(Nn)},E=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},M=()=>{const e=E();document.body.dataset.lifesgDsOverlayOrder=[...e,S].join(",")},H=()=>{const e=E();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==S)).join(",")},k=e=>{var t;const n=null===(t=$.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||s&&h&&(e.preventDefault(),s())};return y?l.createPortal(t(Yn,Object.assign({id:F,"data-testid":F,$show:e,zIndex:p,$stacked:v},{children:c&&t(Pn,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:u||(v?.5:.8),$backgroundBlur:d,$disableTransition:f,$enableOverlayClick:h,onClick:k},{children:x}))})),y):null},Vn="lifesg-ds-overlay-stylesheet",Nn="lifesg-ds-overlay-open",Zn=e=>Object.keys(v).reduce(((t,n)=>{const r=v[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),qn=Zn("max-width"),Xn=(Zn("min-width"),c.div`
    position: relative;
    display: flex;
...
`,sr=r=>{var{children:s,visible:c,onMobileClose:u}=r,l=f(r,["children","visible","onMobileClose"]);const d=l["data-testid"]||"popover",[h,p]=i("none"),m=o(null),y=g.useMediaQuery({maxWidth:v.mobileL}),b=o(h);a((()=>($(),window.addEventListener("resize",ne(S,300)),()=>{window.removeEventListener("resize",ne(S,300))})),[]);const S=()=>{$()},w=()=>{u&&u()},$=()=>{const e=x();var t;e&&(t=e,b.current=t,p(t))},x=()=>{if(m.current){const e=m.current.getBoundingClientRect(),t=24,n=e.y<t,r=window.innerWidth-t;return e.x<t?n?"top-left":"left":e.x+e.width>r?n?"top-right":"right":("top-left"===b.current||"left"===b.current)&&e.x-e.width/2>t||("top-right"===b.current||"right"===b.current)&&e.x+2*e.width<r?n?"top-center":"none":n?"top-center":void 0}},F=()=>"string"==typeof s?t(fn.BodySmall,{children:s}):s;return e(n,{children:[t(nr,Object.assign({ref:m,"data-testid":d,$visible:c,$offset:h},l,{children:t(gn,{children:F()})})),y&&t(Qn,Object.assign({show:c,onOverlayClick:w},{children:t(rr,Object.assign({onClose:w},{children:t(ar,{children:F()})}))}))]})},cr=(n,r)=>s=>{const{onPopoverAppear:c,onPopoverDismiss:u}=s,l=f(s,["onPopoverAppear","onPopoverDismiss"]),d=r.trigger||"click",h=l,[p,m]=i(!1),y=o(),b=g.useMediaQuery({maxWidth:v.mobileL});a((()=>{if(!b)return document.addEventListener("mousedown",S),()=>{document.removeEventListener("mousedown",S)}}),[p]);const S=e=>{y&&!y.current.contains(e.target)&&(p&&m(!1),u&&u())};return e(ir,Object.assign({id:"popover-hoc-wrapper",ref:y},{children:[t(or,Object.assign({id:`popover-hoc-trigger${r["data-testid"]&&`-${r["data-testid"]}`}`,type:"button",onClick:e=>{e.preventDefault(),("click"===d||b)&&(m(!p),!p&&c&&c(),p&&u&&u())},onMouseEnter:()=>{"hover"!==d||b||m(!0)},onMouseLeave:()=>{"hover"===d&&p&&!b&&m(!1)},"aria-label":"popover-button"},{children:t(n,Object.assign({},h))})),t(sr,Object.assign({visible:p,id:r.id,"data-testid":r["data-testid"],onMobileClose:()=>{m(!1)}},{children:r.content}))]}))};export{sr as Popover,cr as withPopover};
