...
`;p(Gc)`
    color: ${fn.Neutral[3]};
`;const Xc=({children:e,show:n,error:r,disabled:i,testId:a,onBlur:l,readOnly:u})=>{const c=o();return((e,t,n="window",r)=>{const i=o();s((()=>{i.current=t}),[t]),s((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const o=e=>i.current(e);return t.addEventListener(e,o,r),()=>{t.removeEventListener(e,o,r)}}),[e,n])})("mousedown",(function(e){if(!i){if(c&&c.current.contains(e.target))return;n&&l()}}),"document"),t(Vc,{children:t(Qc,{ref:c,error:r&&!n,disabled:i,$readOnly:u,expanded:n,"data-testid":a,children:e})})},Jc=({className:r,"data-testid":i,selectedOption:a,minimumCharacters:l=3,fetchOptions:c,placeholder:h="Enter here...",readOnly:f=!1,disabled:p=!1,error:g,valueExtractor:m,listExtractor:y,displayValueExtractor:v=(e=>e.toString()),onSelectOption:b})=>{const w=a&&v(a),[$,S]=u(w||""),[x,_]=u(w||""),[F,k]=u([]),[D,B]=u(!0),[O,M]=u(!1),[A,E]=u(!!a),[j,C]=u(a),z=o(c),T=async e=>{M(!1),B(!0);try{const t=await z.current(e);_(e),k(t),B(!1)}catch{M(!0)}},I=d(de((e=>T(e)),500,{leading:!1,trailing:!0}),[]);s((()=>{z.current=c}),[c]),s((()=>{$&&$.length>=l&&$!==x?I($):I.cancel(),""===$&&j&&(b&&b(void 0,void 0),N(),C(void 0)),a&&$!==v(a)&&E(!1)}),[$,a]),s((()=>{S(a?v(a):""),N(a),C(a)}),[a]);const P=e=>{S(e.target.value)},H=(e,t)=>{b&&b(e,t)},N=e=>{_(e?v(e):""),E(!!e),k([]),B(!0)},L=()=>{S(""),b&&b(void 0,void 0),N()},R=()=>{A||j?(N(j),S(v(j)),b&&b(j,W(j)),C(j)):L()},V=()=>$&&$.length>=l&&!A,W=e=>m?m(e):e,Y=()=>t(ar,{type:"text",value:$,onChange:P,placeholder:h,readOnly:f,disabled:p,allowClear:!0,onClear:L,styleType:"no-border",onBlur:$.length<l?R:void 0});return e(Xc,{className:r,show:V(),error:g&&!V(),disabled:p,readOnly:f,testId:i,onBlur:R,children:[t(f?n:qc,{children:Y()}),!f&&V()&&t(Zc,{}),t(Lc,{listItems:F,onSelectItem:H,valueExtractor:m,listExtractor:y,itemsLoadState:O?"fail":D?"loading":"success",visible:V(),disableItemFocus:!0,onRetry:()=>T($),itemTruncationType:"end",itemMaxLines:1,labelDisplayType:"next-line"})]})};export{Jc as PredictiveTextInput};
