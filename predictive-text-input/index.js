...
`;p.button`
	...
	${e=>"small"===e.$buttonSizeStyle?g`
                ...
                `}
`;const xc=p((({color:n,className:r,size:a=18})=>e(vc,Object.assign({className:r,$size:a,$color:n,"data-testid":"component-loading-spinner"},{children:[t($c,{id:"inner1",$size:a-2,$borderWidth:2,$color:n}),t(Sc,{id:"inner2",$size:a-2,$borderWidth:2,$color:n}),t(wc,{id:"inner3",$size:a-2,$borderWidth:2,$color:n}),t(Fc,{id:"inner4",$size:a-2,$borderWidth:2,$color:n})]}))))`
...
`,Yc=a.forwardRef(((e,n)=>{var{children:r,focusHighlight:a=!0,focusOutline:i="none",type:o="button"}=e,s=k(e,["children","focusHighlight","focusOutline","type"]);return t(Wc,Object.assign({ref:n,$outline:i,$highlight:a,type:o},s,{children:r}))})),qc=e=>"small"===e?1:1.375,Uc=e=>g`
        height: ${qc(e)}rem;
        width: ${qc(e)}rem;
    `,Jc=p.li`
