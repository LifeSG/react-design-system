...
`;p(rd)`
    color: ${vn.Neutral[3]};
`;const id=({children:e,show:n,error:r,disabled:i,testId:a,onBlur:l,readOnly:c,className:u})=>{const d=o();return((e,t,n="window",r)=>{const i=o();s((()=>{i.current=t}),[t]),s((()=>{let t;switch(n){case"window":t=window;break;case"document":t=document;break;default:t=n}if(!t||!t.addEventListener)return;const o=e=>i.current(e);return t.addEventListener(e,o,r),()=>{t.removeEventListener(e,o,r)}}),[e,n])})("mousedown",(function(e){if(!i){if(d&&d.current.contains(e.target))return;n&&l()}}),"document"),t(Gu,Object.assign({className:u},{children:t(td,Object.assign({ref:d,error:r&&!n,disabled:i,$readOnly:c,expanded:n,"data-testid":a},{children:e}))}))},od=({className:r,"data-testid":i,selectedOption:a,minimumCharacters:l=3,fetchOptions:u,placeholder:h="Enter here...",readOnly:f=!1,disabled:p=!1,error:g,valueExtractor:m,listExtractor:y,displayValueExtractor:v=(e=>e.toString()),onSelectOption:b})=>{const w=a&&v(a),[$,x]=c(w||""),[S,_]=c(w||""),[F,D]=c([]),[k,B]=c(!0),[M,A]=c(!1),[j,E]=c(!!a),[C,I]=c(a),T=o(u),z=e=>O(void 0,void 0,void 0,(function*(){A(!1),B(!0);try{const t=yield T.current(e);_(e),D(t),B(!1)}catch(e){A(!0)}})),P=d(me((e=>z(e)),500,{leading:!1,trailing:!0}),[]);s((()=>{T.current=u}),[u]),s((()=>{$&&$.length>=l&&$!==S?P($):P.cancel(),""===$&&C&&(b&&b(void 0,void 0),N(),I(void 0)),a&&$!==v(a)&&E(!1)}),[$,a]),s((()=>{x(a?v(a):""),N(a),I(a)}),[a]);const H=e=>{x(e.target.value)},L=(e,t)=>{b&&b(e,t)},N=e=>{_(e?v(e):""),E(!!e),D([]),B(!0)},R=()=>{x(""),b&&b(void 0,void 0),N()},V=()=>{j||C?(N(C),x(v(C)),b&&b(C,Y(C)),I(C)):R()},W=()=>$&&$.length>=l&&!j,Y=e=>m?m(e):e,q=()=>t(fr,{type:"text",value:$,onChange:H,placeholder:h,readOnly:f,disabled:p,allowClear:!0,onClear:R,styleType:"no-border",onBlur:$.length<l?V:void 0});return e(id,Object.assign({className:r,show:W(),error:g&&!W(),disabled:p,readOnly:f,testId:i,onBlur:V},{children:[t(f?n:Ku,{children:q()}),!f&&W()&&t(nd,{}),t(Qu,{listItems:F,onSelectItem:L,valueExtractor:m,listExtractor:y,itemsLoadState:M?"fail":k?"loading":"success",visible:W(),disableItemFocus:!0,onRetry:()=>z($),itemTruncationType:"end",itemMaxLines:1,labelDisplayType:"next-line"})]}))};export{od as PredictiveTextInput};
