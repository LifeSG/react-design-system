...
`;const rn=c.div`
    ...
    ${e=>{const{highlighted:t}=e;return`\n            background-color: ${(t?Et.Accent.Light[1]:Et.Neutral[6])(e)};\n        `}};
...
`,on=c(Yt.BodySmall)`
    ...
    ${e=>{const{highlighted:t}=e;return`color: ${(t?Et.Primary:Et.Neutral[4])(e)};`}};
`,an=c.div`
    display: flex;
    flex-direction: column;
    flex: 1;
