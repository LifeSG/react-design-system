...
export declare const IndicatorTitleDesktop: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../text").TextProps & IndicatorProps, never>;
export declare const IndicatorTitleMobile: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../text").TextProps, never>;
