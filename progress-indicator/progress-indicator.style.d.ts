...
export declare const IndicatorTitleDesktop: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("..").TypographyProps & IndicatorProps, never>;
export declare const IndicatorTitleTablet: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("..").TypographyProps, never>;
