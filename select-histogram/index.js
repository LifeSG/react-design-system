...
`;var Ds;p(Es)`
    color: ${Qt["text-subtler"]};
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Ds||(Ds={}));const Cs=p.div`
    display: flex;
    flex-direction: column;
`,Bs=e=>"right"===e?"bottom-end":"bottom-start",Ms=({enabled:n,isOpen:i,onOpen:a,onClose:d,onDismiss:c,renderElement:u,renderDropdown:h,customZIndex:g,clickToToggle:b=!1,offset:m=0,alignment:p="left",fitAvailableHeight:f})=>{var y;const x=v(),w=sn["sm-max"]({theme:x}),$=l(null),F=l(null),{width:E}=function(e){void 0===e&&(e={});var r=e.skipOnMount,t=void 0!==r&&r,n=e.refreshMode,i=e.refreshRate,s=void 0===i?1e3:i,a=e.refreshOptions,d=e.handleWidth,c=void 0===d||d,u=e.handleHeight,h=void 0===u||u,g=e.targetRef,b=e.observerOptions,m=e.onResize,p=l(t),f=l(null),y=null!=g?g:f,v=l(),x=o({width:void 0,height:void 0}),w=x[0],$=x[1];return Oi((function(){if(!Di()){var e=Bi(m,$,c,h);v.current=Fi((function(r){(c||h)&&r.forEach((function(r){var t=r&&r.contentRect||{},n=t.width,i=t.height;!p.current&&!Di()&&e({width:n,height:i}),p.current=!1}))}),n,s,a);var r=new window.ResizeObserver(v.current);return y.current&&r.observe(y.current,b),function(){r.disconnect();var e=v.current;e&&e.cancel&&e.cancel()}}}),[n,s,a,c,h,m,b,y.current]),Ln({ref:y},w)}({targetRef:$,handleHeight:!1}),D={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<w;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:C,floatingStyles:B,context:H}=O({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==c||c():e&&!i?null==a||a():!e&&i&&(null==d||d(t))},whileElementsMounted:z,placement:Bs(p),middleware:[k(m),A(),S({limiter:_()}),T({apply({availableHeight:e}){F.current&&Object.assign(F.current.style,{maxHeight:f?`${e}px`:void 0,overflowY:f?"hidden":void 0})}}),D]}),W=(()=>{const[e,r]=o(void 0),t=M();return s((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(Ds.Change,e),t.events.emit(Ds.Ready),()=>t.events.off(Ds.Change,e)}),[t]),e})(),{isMounted:N,styles:V}=L(H,{initial:{opacity:0},open:{opacity:1},duration:300}),K=j(H,{enabled:n,toggle:b}),U=Y(H,{enabled:n}),{getReferenceProps:Z,getFloatingProps:X}=P([K,U]);return e(t,{children:[r("div",Object.assign({ref:e=>{$.current=e,C.setReference(e)}},Z(),{children:u()})),N&&r(R,{children:r(I,Object.assign({context:H,modal:!1,initialFocus:F,returnFocus:!1},{children:r("div",Object.assign({ref:C.setFloating,style:Object.assign(Object.assign({},B),{zIndex:null!==(y=null!=g?g:W)&&void 0!==y?y:50})},X(),{children:r(Cs,Object.assign({ref:F,style:Object.assign({},V),inert:V.opacity<1?"":void 0},{children:h({elementWidth:E})}))}))}))})]})},Os=p.div`
    overflow: hidden;
    border: ${tn["width-010"]} ${tn.solid} ${Qt.border};
    border-radius: ${on.sm};
    background: ${Qt.bg};
...
`,Ss=p(As)`
    color: ${Qt["text-subtler"]};
`,_s=t=>{var{alignment:n="left",className:i,disabled:a,dropdownZIndex:d,error:c,histogramSlider:u,id:h,onBlur:g,onChange:b,onChangeEnd:m,optionTruncationType:p="end",placeholder:f="Select",rangeLabelPrefix:y,rangeLabelSuffix:v,readOnly:x,renderRangeLabel:w,value:$}=t,F=W(t,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value"]);const{interval:E,bins:D=[],renderEmptyView:C,ariaLabels:B}=u,[M,O]=o(K()),[z,k]=o(!1),[A,S]=o(!1),[_]=o((()=>Vo.generate())),T=D.map((e=>e.minValue)),L=Math.min(...T),j=l(),Y=l(),P=l(),R=F["data-testid"]||"select-histogram";s((()=>{$!==M&&O(K())}),[$]);const I=e=>{O(e),null==b||b(e)},H=e=>{O(e),null==m||m(e)},N=()=>{A||z||S(!0)},V=e=>{!A||z||j.current.contains(e.relatedTarget)||(S(!1),null==g||g())};function K(){return null!=$?$:[L,L+E]}const U=r=>w?w(r):e(cn.BodyBL,{children:[y,r,v]});return r(Uo,{children:r(Ms,{enabled:!x&&!a,isOpen:z,renderElement:()=>r(os,Object.assign({className:i,"data-testid":R,id:h,ref:j,tabIndex:-1,onFocus:N,onBlur:V,$focused:A,$disabled:a,$readOnly:x,$error:c},{children:r(ys,Object.assign({ref:Y,disabled:a,expanded:z,listboxId:_,popupRole:"dialog",readOnly:x,variant:"default"},{children:r(Fs,Object.assign({ref:P,$disabled:a},{children:T&&0!==T.length?e(zs,{children:[U(M[0]),r(ks,{children:"-"}),U(M[1])]}):r(Ss,Object.assign({truncateType:p,$variant:"default"},{children:f}))}))}))})),renderDropdown:({elementWidth:e})=>r(Os,Object.assign({style:{width:e}},{children:r(_n,{interval:E,value:M,bins:D,onChange:I,onChangeEnd:H,showRangeLabels:!1,renderEmptyView:C,ariaLabels:B})})),onOpen:()=>{k(!0)},onClose:()=>{k(!1)},onDismiss:()=>{Y.current.focus(),k(!1)},clickToToggle:!0,offset:8,alignment:n,fitAvailableHeight:!0,customZIndex:d})})};export{_s as SelectHistogram};
