...
`,Vn=(e,r,t=!1)=>v`
    ...
    `,Kn=e=>{if(e)return v`
            ${Wn(e)}
        `},Un=(e,r)=>v`
    ${Vn(e,r.weight||"regular",r.paragraph)}
    ${((e=!1,r=!1,t)=>r?v`
            display: block;
            ${Kn(t)}
        `:e?v`
    ...
    color: ${Cn.text};
`;var Zn;!function(t){const n=(e,r,t)=>{const n=y(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${e=>Un(r,e)}
        `;return n.displayName=`Typography.${t}`,n};t.HeadingXXL=n("h1","heading-xxl","HeadingXXL"),t.HeadingXL=n("h2","heading-xl","HeadingXL"),t.HeadingLG=n("h3","heading-lg","HeadingLG"),t.HeadingMD=n("h4","heading-md","HeadingMD"),t.HeadingSM=n("h5","heading-sm","HeadingSM"),t.HeadingXS=n("h6","heading-xs","HeadingXS");const i=(e,r)=>{const t=y.p.attrs((({inline:e})=>({as:e?"span":void 0})))`
            ${r=>Un(e,r)}
        `;return t.displayName=`Typography.${r}`,t};t.BodyBL=i("body-baseline","BodyBL"),t.BodyMD=i("body-md","BodyMD"),t.BodySM=i("body-sm","BodySM"),t.BodyXS=i("body-xs","BodyXS");const o=(t,n)=>{const i=y.a`
            ${e=>v`
                ${Vn(t,e.weight||"regular")}
                color: ${Cn.hyperlink};
...
`,pi=y.div`
    ...
    ${e=>{let r=Cn["bg-strongest"];return e.$disabled&&e.$selected?r=Cn["bg-selected-stronger-disabled"]:e.$disabled?r=Cn["bg-disabled"]:e.$selected&&(r=Cn["bg-selected-stronger"]),v`
            background-color: ${r};
        `}}
`,fi=y((t=>{var{value:n,min:i=0,max:a=100,step:l=1,minRange:d,numOfThumbs:c=2,colors:u,disabled:g,readOnly:h,ariaLabels:b,showSliderLabels:m,sliderLabelPrefix:p,sliderLabelSuffix:f,showIndicatorLabel:y,indicatorLabelPrefix:v,indicatorLabelSuffix:x,renderSliderLabel:w,onChange:F,onChangeEnd:$}=t,E=K(t,["value","min","max","step","minRange","numOfThumbs","colors","disabled","readOnly","ariaLabels","showSliderLabels","sliderLabelPrefix","sliderLabelSuffix","showIndicatorLabel","indicatorLabelPrefix","indicatorLabelSuffix","renderSliderLabel","onChange","onChangeEnd"]);const[D,C]=o(S()),B=function(){const e=function(){const e=g||h?Cn["border-disabled"]:Cn["border-strong"],r=g||h?Cn["border-selected-disabled"]:Cn["border-selected"];if(1===c)return[r,e];const t=[];t.push(e);for(let e=0;e<c-1;e++)t.push(r);return t.push(e),t}();return new Array(c+1).fill(0).map(((r,t)=>(null==u?void 0:u[t])||e[t]))}();s((()=>{n!==D&&C(S())}),[n]);function S(){if(n&&n.length===c)return n;const e=[];for(let r=0;r<c;r++)e.push(i+l*r);return e}const k=r=>w?w(r):e(li,{children:[p,r,f]});return e(oi,Object.assign({},E,{children:[y&&r(ai,{children:(()=>{let r="";if(1===D.length)r=`${D[0]}`;else if(2===D.length)r=`${D[0]} - ${D[1]}`;else if(D.length>2){r=`${Math.min(...D)} - ${Math.max(...D)}`}return e(li,{children:[v,r,x]})})()}),r(di,{step:l,min:i,max:a,value:D,disabled:g||h,onChange:(e,r)=>{if("number"==typeof e){const r=[e];C(r),null==F||F(r)}else{if(r>-1&&D[r]===e[r])return;const t=[...e];C(t),null==F||F(t)}},onAfterChange:e=>{if("number"==typeof e){const r=[e];C(r),null==$||$(r)}else{const r=[...e];C(r),null==$||$(r)}},minDistance:d,ariaLabel:b,renderThumb:(e,t)=>r(ui,Object.assign({"data-testid":`slider-thumb-${t.index}`},e,{tabIndex:g?void 0:e.tabIndex,children:r(ci,{$disabled:g,$readOnly:h})})),renderTrack:(e,t)=>r(gi,Object.assign({"data-testid":`slider-track-${t.index}`},e,{$color:B[t.index]}))}),m&&e(si,{children:[r("div",{children:k(i)}),r("div",{children:k(a)})]})]}))}))`
    margin-top: -0.3125rem;
`,yi=n=>{var{bins:i=[],interval:l,disabled:d,readOnly:c,value:u,showRangeLabels:g,rangeLabelPrefix:h,rangeLabelSuffix:b,ariaLabels:m,onChange:p,onChangeEnd:f,renderEmptyView:y,renderRangeLabel:v}=n,x=K(n,["bins","interval","disabled","readOnly","value","showRangeLabels","rangeLabelPrefix","rangeLabelSuffix","ariaLabels","onChange","onChangeEnd","renderEmptyView","renderRangeLabel"]);const w=i.map((e=>e.count)),F=Math.max(...w),$=i.map((e=>e.minValue)),E=Math.max(...$),D=Math.min(...$),[C,B]=o(z()),S=a((()=>{const e=[...i].sort(((e,r)=>e.minValue-r.minValue)),r=(E-D)/l+1,t=[];for(let n=0;n<r;n++){const r=e.find((e=>e.minValue===D+l*n));r?t.push(r):t.push({count:0,minValue:D+l*n})}return t}),[i,l]);s((()=>{u!==C&&B(z())}),[u]);const k=e=>{const[r,t]=e,n=[r,t];B(n),null==p||p(n)},A=e=>{const[r,t]=e,n=[r,t];B(n),null==f||f(n)};function z(){return null!=u?u:[D,D+l]}const M=r=>v?v(r):e(Zn.BodyBL,{children:[h,r,b]});return e("div",Object.assign({},x,{children:[g&&e(hi,{children:[M(C[0]),r(bi,{children:"-"}),M(C[1])]}),S.every((e=>0===e.count))&&y?y():e(t,{children:[r(mi,{children:S.map(((e,t)=>{const n=e.count/F;return r(pi,{style:{height:n?`calc(calc(100% - 0.25rem) * ${n} + 0.25rem)`:0},$selected:e.minValue>=C[0]&&e.minValue<C[1],$disabled:d||c},t)}))}),r(fi,{min:D,max:E+l,step:l,minRange:l,numOfThumbs:2,value:C,disabled:d,readOnly:c,ariaLabels:m,onChange:k,onChangeEnd:A})]})]}))};var vi=function(e,r){return vi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t])},vi(e,r)};var xi=function(){return xi=Object.assign||function(e){for(var r,t=1,n=arguments.length;t<n;t++)for(var i in r=arguments[t])Object.prototype.hasOwnProperty.call(r,i)&&(e[i]=r[i]);return e},xi.apply(this,arguments)};var wi="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};var Fi=function(e){var r=typeof e;return null!=e&&("object"==r||"function"==r)},$i="object"==typeof wi&&wi&&wi.Object===Object&&wi,Ei="object"==typeof self&&self&&self.Object===Object&&self,Di=$i||Ei||Function("return this")(),Ci=Di,Bi=function(){return Ci.Date.now()},Si=/\s/;var ki=function(e){for(var r=e.length;r--&&Si.test(e.charAt(r)););return r},Ai=/^\s+/;var zi=function(e){return e?e.slice(0,ki(e)+1).replace(Ai,""):e},Mi=Di.Symbol,Oi=Mi,_i=Object.prototype,Ti=_i.hasOwnProperty,Li=_i.toString,ji=Oi?Oi.toStringTag:void 0;var Ri=function(e){var r=Ti.call(e,ji),t=e[ji];try{e[ji]=void 0;var n=!0}catch(e){}var i=Li.call(e);return n&&(r?e[ji]=t:delete e[ji]),i},Yi=Object.prototype.toString;var Pi=Ri,Ii=function(e){return Yi.call(e)},Hi=Mi?Mi.toStringTag:void 0;var Ni=function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":Hi&&Hi in Object(e)?Pi(e):Ii(e)},Wi=function(e){return null!=e&&"object"==typeof e};var Vi=zi,Ki=Fi,Ui=function(e){return"symbol"==typeof e||Wi(e)&&"[object Symbol]"==Ni(e)},Zi=/^[-+]0x[0-9a-f]+$/i,Xi=/^0b[01]+$/i,qi=/^0o[0-7]+$/i,Ji=parseInt;var Gi=Fi,Qi=Bi,eo=function(e){if("number"==typeof e)return e;if(Ui(e))return NaN;if(Ki(e)){var r="function"==typeof e.valueOf?e.valueOf():e;e=Ki(r)?r+"":r}if("string"!=typeof e)return 0===e?e:+e;e=Vi(e);var t=Xi.test(e);return t||qi.test(e)?Ji(e.slice(2),t?2:8):Zi.test(e)?NaN:+e},ro=Math.max,to=Math.min;var no=function(e,r,t){var n,i,o,s,a,l,d=0,c=!1,u=!1,g=!0;if("function"!=typeof e)throw new TypeError("Expected a function");function h(r){var t=n,o=i;return n=i=void 0,d=r,s=e.apply(o,t)}function b(e){var t=e-l;return void 0===l||t>=r||t<0||u&&e-d>=o}function m(){var e=Qi();if(b(e))return p(e);a=setTimeout(m,function(e){var t=r-(e-l);return u?to(t,o-(e-d)):t}(e))}function p(e){return a=void 0,g&&n?h(e):(n=i=void 0,s)}function f(){var e=Qi(),t=b(e);if(n=arguments,i=this,l=e,t){if(void 0===a)return function(e){return d=e,a=setTimeout(m,r),c?h(e):s}(l);if(u)return clearTimeout(a),a=setTimeout(m,r),h(l)}return void 0===a&&(a=setTimeout(m,r)),s}return r=eo(r)||0,Gi(t)&&(c=!!t.leading,o=(u="maxWait"in t)?ro(eo(t.maxWait)||0,r):o,g="trailing"in t?!!t.trailing:g),f.cancel=function(){void 0!==a&&clearTimeout(a),d=0,n=l=i=a=void 0},f.flush=function(){return void 0===a?s:p(Qi())},f},io=no,oo=Fi;var so=function(e,r,t){var n=!0,i=!0;if("function"!=typeof e)throw new TypeError("Expected a function");return oo(t)&&(n="leading"in t?!!t.leading:n,i="trailing"in t?!!t.trailing:i),io(e,r,{leading:n,maxWait:r,trailing:i})},ao=function(e,r,t,n){switch(r){case"debounce":return no(e,t,n);case"throttle":return so(e,t,n);default:return e}},lo=function(e){return"function"==typeof e},co=function(){return"undefined"==typeof window},uo=function(e){return e instanceof Element||e instanceof HTMLDocument},go=function(e,r,t,n){return function(i){var o=i.width,s=i.height;r((function(r){return r.width===o&&r.height===s||r.width===o&&!n||r.height===s&&!t?r:(e&&lo(e)&&e(o,s),{width:o,height:s})}))}};!function(e){function r(r){var t=e.call(this,r)||this;t.cancelHandler=function(){t.resizeHandler&&t.resizeHandler.cancel&&(t.resizeHandler.cancel(),t.resizeHandler=null)},t.attachObserver=function(){var e=t.props,r=e.targetRef,n=e.observerOptions;if(!co()){r&&r.current&&(t.targetRef.current=r.current);var i=t.getElement();i&&(t.observableElement&&t.observableElement===i||(t.observableElement=i,t.resizeObserver.observe(i,n)))}},t.getElement=function(){var e=t.props,r=e.querySelector,n=e.targetDomEl;if(co())return null;if(r)return document.querySelector(r);if(n&&uo(n))return n;if(t.targetRef&&uo(t.targetRef.current))return t.targetRef.current;var i=V(t);if(!i)return null;switch(t.getRenderType()){case"renderProp":case"childFunction":case"child":case"childArray":return i;default:return i.parentElement}},t.createResizeHandler=function(e){var r=t.props,n=r.handleWidth,i=void 0===n||n,o=r.handleHeight,s=void 0===o||o,a=r.onResize;if(i||s){var l=go(a,t.setState.bind(t),i,s);e.forEach((function(e){var r=e&&e.contentRect||{},n=r.width,i=r.height;!t.skipOnMount&&!co()&&l({width:n,height:i}),t.skipOnMount=!1}))}},t.getRenderType=function(){var e=t.props,r=e.render,n=e.children;return lo(r)?"renderProp":lo(n)?"childFunction":d(n)?"child":Array.isArray(n)?"childArray":"parent"};var n=r.skipOnMount,i=r.refreshMode,o=r.refreshRate,s=void 0===o?1e3:o,a=r.refreshOptions;return t.state={width:void 0,height:void 0},t.skipOnMount=n,t.targetRef=c(),t.observableElement=null,co()||(t.resizeHandler=ao(t.createResizeHandler,i,s,a),t.resizeObserver=new window.ResizeObserver(t.resizeHandler)),t}(function(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");function t(){this.constructor=e}vi(e,r),e.prototype=null===r?Object.create(r):(t.prototype=r.prototype,new t)})(r,e),r.prototype.componentDidMount=function(){this.attachObserver()},r.prototype.componentDidUpdate=function(){this.attachObserver()},r.prototype.componentWillUnmount=function(){co()||(this.observableElement=null,this.resizeObserver.disconnect(),this.cancelHandler())},r.prototype.render=function(){var e,r=this.props,t=r.render,i=r.children,o=r.nodeType,s=void 0===o?"div":o,a=this.state,l={width:a.width,height:a.height,targetRef:this.targetRef};switch(this.getRenderType()){case"renderProp":return t&&t(l);case"childFunction":return(e=i)(l);case"child":if((e=i).type&&"string"==typeof e.type){var d=function(e,r){var t={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&r.indexOf(n)<0&&(t[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(e);i<n.length;i++)r.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(t[n[i]]=e[n[i]])}return t}(l,["targetRef"]);return u(e,d)}return u(e,l);case"childArray":return(e=i).map((function(e){return!!e&&u(e,l)}));default:return n.createElement(s,null)}}}(g);var ho,bo=co()?s:h;!function(e){e.transformWithSpaces=(e,r)=>{const t="(.{"+r+"})";return e.replace(/[^\dA-Z]/gi,"").replace(new RegExp(t,"g"),"$1 ").trim()},e.padValue=(e,r)=>{if("0"===e)return r?e:e.padStart(2,"0");if(""===e)return e;return parseInt(e).toString().padStart(2,"0")},e.shouldTruncateToTwoLines=(e,r)=>{const t=Math.floor(r/9);return e.length>=2*t||1===e.split(" ").length&&e.length>t},e.truncateOneLine=(e,r,t,n,i=8)=>{let o=0;r>t&&(o=Math.floor((r-t)/i));const s=n+o;if(s<e.length){const r=Math.floor(s/2);return e.substring(0,r)+" ... "+e.substring(e.length-r,e.length)}return e},e.truncateTwoLines=(e,r,t,n=1.2)=>{const i=Math.floor(2*r/(.6*t))*(2/n);if(e.length<=i)return e;const o=Math.floor(.6*i),s=Math.floor(.2*i);return`${e.substring(0,o)}...${e.substring(e.length-s)}`},e.getTextWidth=(r,t)=>{if("undefined"==typeof document)return 0;const n=(e.getTextWidth.canvas||(e.getTextWidth.canvas=document.createElement("canvas"))).getContext("2d");n.font=t;return n.measureText(r).width},e.maskValue=(e,t)=>{if(!e)return e;const{maskRange:n,unmaskRange:i,maskChar:o="•",maskRegex:s,maskTransformer:a}=t;if(a)return a(e);if(s)return e.replace(s,o);if(n){const{startIndex:t,endIndex:i}=r(n[0],n[1]);return e.substring(0,t)+o.repeat(e.substring(t,i+1).length)+e.substring(i+1)}if(i){const{startIndex:t,endIndex:n}=r(i[0],i[1]);return o.repeat(e.substring(0,t).length)+e.substring(t,n+1)+o.repeat(e.substring(n+1).length)}return e};const r=(e,r)=>e<r?{startIndex:e,endIndex:r}:{startIndex:r,endIndex:e},t=new Intl.PluralRules("en",{type:"ordinal"}),n=new Map([["one","st"],["two","nd"],["few","rd"],["other","th"]]);e.formatOrdinal=e=>{const r=t.select(e);return`${e}${n.get(r)}`}}(ho||(ho={}));const mo=y.div`
    ...
    ${e=>"end"===e.$truncateType&&Wn(e.$maxLines||2)}
...
`,Ys=({color:t,className:n,size:i})=>e(Os,{className:n,$size:i,$color:t,"data-testid":"component-loading-spinner",children:[r(Ts,{id:"inner1"}),r(Ls,{id:"inner2"}),r(js,{id:"inner3"}),r(Rs,{id:"inner4"})]}),Ps=v`
    outline-offset: -1px;
...
`;y.div`
    ...
    ${_n.MaxWidth.sm} {
        min-width: unset;
        width: calc(100vw - ${On["sm-margin"]} * 2);
        max-height: 15rem;
    }

    ${_n.MaxWidth.xs} {
        width: calc(100vw - ${On["xs-margin"]} * 2);
    }

    ${_n.MaxWidth.xxs} {
        width: calc(100vw - ${On["xxs-margin"]} * 2);
    }
...
`,Xs=i.forwardRef(((e,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:s="button"}=e,a=K(e,["children","focusHighlight","focusOutline","type"]);return r(Zs,Object.assign({ref:t,$outline:o,$highlight:i,type:s},a,{children:n}))})),qs=y.div`
...
`;b(((t,n)=>{var{value:i,variant:o,onClear:s}=t,a=K(t,["value","variant","onClear"]);return e(qs,{$variant:o,children:[e(Js,{$variant:o,children:[r(Qs,{"aria-hidden":!0}),r(Gs,Object.assign({ref:n,value:i,$variant:o},a))]}),i&&r(ea,{"aria-label":"Clear search",focusOutline:"browser",onClick:s,children:r(B,{"aria-hidden":!0})})]})}));const ra=y(Ks)`
    display: flex;
    align-items: center;
    gap: ${An["spacing-8"]};
    width: 100%;
...
`,na=b((({children:t,disabled:n,expanded:i,listboxId:o,popupRole:s,readOnly:a,variant:l},d)=>e(ra,{ref:d,type:"button","aria-expanded":i,"aria-haspopup":s,"data-testid":"selector",disabled:n,"aria-controls":o,$variant:l,children:[t,!a&&r(ta,{$expanded:i,$variant:l,children:r(k,{"aria-hidden":!0})})]}))),ia={Button:{"button-radius":fn.md,"button-default-colour-bg":Kt["bg-primary"],"button-default-colour-bg-hover":Kt["bg-primary-hover"],"button-default-colour-text":Kt["text-inverse"],"button-secondary-colour-border":Kt["border-primary"],"button-secondary-colour-text":Kt["text-primary"],"button-light-colour-text":Kt["text-primary"],"button-link-colour-text":Kt["text-primary"]}},oa={collections:{default:{Button:{"button-radius":fn.sm,"button-default-colour-bg":Kt["bg-primary"],"button-default-colour-bg-hover":Kt["bg-primary-hover"],"button-default-colour-text":Kt["text-inverse"],"button-secondary-colour-border":Kt["border-primary"],"button-secondary-colour-text":Kt["text-primary"],"button-light-colour-text":Kt["text-primary"],"button-link-colour-text":Kt["text-primary"]}},pa:{Button:{"button-radius":fn.full,"button-default-colour-bg":Kt["bg-primary"],"button-default-colour-bg-hover":Kt["bg-primary-hover"],"button-default-colour-text":Kt["text-inverse"],"button-secondary-colour-border":Kt["border-primary"],"button-secondary-colour-text":Kt["text-primary"],"button-light-colour-text":Kt["text-primary"],"button-link-colour-text":Kt["text-primary"]}},a11yplayground:ia},defaultValue:"default"},sa=(e,r)=>t=>{var n,i;const o=t.theme,s=xt(oa,null==o?void 0:o.componentScheme);return aa((null===(i=null===(n=null==o?void 0:o.componentOverrides)||void 0===n?void 0:n[e])||void 0===i?void 0:i[r])||s[e][r],t)},aa=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},la=sa("Button","button-radius"),da=sa("Button","button-default-colour-bg"),ca=sa("Button","button-default-colour-bg-hover"),ua=sa("Button","button-default-colour-text"),ga=sa("Button","button-secondary-colour-border"),ha=sa("Button","button-secondary-colour-text"),ba=sa("Button","button-light-colour-text"),ma=sa("Button","button-link-colour-text");y.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return v`
                    background-color: ${Cn.bg};
                    border-color: ${e.$buttonIsDanger?Cn["border-error-strong"]:ga};

                    color: ${e.$buttonIsDanger?Cn["text-error"]:ha};
                ...
                `;case"light":return v`
                    ...
                    color: ${e.$buttonIsDanger?Cn["text-error"]:ba};
                ...
                `;case"link":return v`
                    ...
                    color: ${e.$buttonIsDanger?Cn["text-error"]:ma};
                    &:hover,
                    &:active {
                        background-color: ${Cn["bg-hover-neutral"]};
                    }
                `;case"disabled":return v`
                    ...
                    color: ${Cn["text-disabled"]};
                `;default:return v`
                    background-color: ${e.$buttonIsDanger?Cn["bg-error-strong"]:da};
                    ...
                    &:hover,
                    &:active {
                        background-color: ${e.$buttonIsDanger?Cn["bg-error-strong-hover"]:ca};
                    }
                `}}}
...
`,y(A)`
    ...
    width: 1lh;
    color: ${Cn["icon-selected"]};
`;const pa=e=>"small"===e?2.5:3;y.div`
    position: relative;
    width: 100%;
    ${e=>{const r=pa(e.$variant);return v`
            min-height: ${r}rem;
...
`;const fa=v`
    ...
    height: calc(${e=>pa(e.$variant)}rem - 2px);
    width: 100%;
    border-radius: ${zn.sm};
    border: none;
    background: transparent;
...
`;var Fa;y(wa)`
    color: ${Cn["text-subtler"]};
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Fa||(Fa={}));y.div`
    clip-path: inset(50%);
    height: 1px;
    width: 1px;
    overflow: hidden;
    position: absolute;
    white-space: nowrap;
`;const $a=e=>{const r=m.split(".");return parseInt(r[0],10)>=19?e:e?"true":void 0},Ea=y.div`
    display: flex;
    flex-direction: column;
`,Da=e=>"right"===e?"bottom-end":"bottom-start",Ca=({enabled:n,isOpen:i,onOpen:a,onClose:d,onDismiss:c,renderElement:u,renderDropdown:g,customZIndex:h,clickToToggle:b=!1,offset:m=0,alignment:f="left",fitAvailableHeight:y,rootNode:v})=>{var x;const F=p(w),$=On["sm-max"]({theme:F}),E=l(null),D=l(null),{width:C=0}=function(e){void 0===e&&(e={});var r=e.skipOnMount,t=void 0!==r&&r,n=e.refreshMode,i=e.refreshRate,s=void 0===i?1e3:i,a=e.refreshOptions,d=e.handleWidth,c=void 0===d||d,u=e.handleHeight,g=void 0===u||u,h=e.targetRef,b=e.observerOptions,m=e.onResize,p=l(t),f=l(null),y=null!=h?h:f,v=l(),x=o({width:void 0,height:void 0}),w=x[0],F=x[1];return bo((function(){if(!co()){var e=go(m,F,c,g);v.current=ao((function(r){(c||g)&&r.forEach((function(r){var t=r&&r.contentRect||{},n=t.width,i=t.height;!p.current&&!co()&&e({width:n,height:i}),p.current=!1}))}),n,s,a);var r=new window.ResizeObserver(v.current);return y.current&&r.observe(y.current,b),function(){r.disconnect();var e=v.current;e&&e.cancel&&e.cancel()}}}),[n,s,a,c,g,m,b,y.current]),xi({ref:y},w)}({targetRef:E,handleHeight:!1}),B={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<$;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:S,floatingStyles:k,context:A}=M({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==c||c():e&&!i?null==a||a():!e&&i&&(null==d||d(t))},whileElementsMounted:O,placement:Da(f),middleware:[_(m),T(),L({limiter:j()}),R({apply({availableHeight:e}){D.current&&Object.assign(D.current.style,{maxHeight:y?`${e}px`:void 0,overflowY:y?"hidden":void 0})}}),B]}),V=(()=>{const[e,r]=o(void 0),t=z();return s((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(Fa.Change,e),t.events.emit(Fa.Ready),()=>t.events.off(Fa.Change,e)}),[t]),e})(),{isMounted:K,styles:U}=Y(A,{initial:{opacity:0},open:{opacity:1},duration:300}),Z=P(A,{enabled:n,toggle:b}),X=I(A,{enabled:n}),{getReferenceProps:q,getFloatingProps:J}=H([Z,X]);return e(t,{children:[r("div",Object.assign({ref:e=>{E.current=e,S.setReference(e)}},q(),{children:u()})),K&&r(N,{root:v,children:r(W,{context:A,modal:!1,initialFocus:D,returnFocus:!1,children:r("div",Object.assign({ref:S.setFloating,style:Object.assign(Object.assign({},k),{zIndex:null!==(x=null!=h?h:V)&&void 0!==x?x:50})},J(),{children:r(Ea,{ref:D,style:Object.assign({},U),inert:$a(U.opacity<1),children:g({elementWidth:C})})}))})})]})},Ba=y.div`
    overflow: hidden;
    border: ${kn["width-010"]} ${kn.solid} ${Cn.border};
    border-radius: ${zn.sm};
    background: ${Cn.bg};
...
`,za=y(Aa)`
    color: ${Cn["text-subtler"]};
`,Ma=t=>{var{alignment:n="left",className:i,disabled:a,dropdownZIndex:d,error:c,histogramSlider:u,id:g,onBlur:h,onChange:b,onChangeEnd:m,optionTruncationType:p="end",placeholder:f="Select",rangeLabelPrefix:y,rangeLabelSuffix:v,readOnly:x,renderRangeLabel:w,value:F,dropdownRootNode:$}=t,E=K(t,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value","dropdownRootNode"]);const{interval:D,bins:C=[],renderEmptyView:B,ariaLabels:S}=u,k=C.map((e=>e.minValue)),A=Math.min(...k),[z,M]=o(U()),[O,_]=o(!1),[T,L]=o(!1),[j]=o((()=>As.generate())),R=l(null),Y=l(null),P=l(null),I=E["data-testid"]||"select-histogram";s((()=>{F!==z&&M(U())}),[F]);const H=e=>{M(e),null==b||b(e)},N=e=>{M(e),null==m||m(e)},W=()=>{T||O||L(!0)},V=e=>{T&&!O&&R.current&&!R.current.contains(e.relatedTarget)&&(L(!1),null==h||h())};function U(){return null!=F?F:[A,A+D]}const Z=r=>w?w(r):e(Zn.BodyBL,{children:[y,r,v]});return r(Ms,{children:r(Ca,{enabled:!x&&!a,isOpen:O,renderElement:()=>r(Ws,{className:i,"data-testid":I,id:g,ref:R,tabIndex:-1,onFocus:W,onBlur:V,$focused:T,$disabled:a,$readOnly:x,$error:c,children:r(na,{ref:Y,disabled:a,expanded:O,listboxId:j,popupRole:"dialog",readOnly:x,variant:"default",children:r(xa,{ref:P,$disabled:a,children:k&&0!==k.length?e(Sa,{children:[Z(z[0]),r(ka,{children:"-"}),Z(z[1])]}):r(za,{truncateType:p,$variant:"default",children:f})})})}),renderDropdown:({elementWidth:e})=>r(Ba,{style:{width:e},children:r(yi,{interval:D,value:z,bins:C,onChange:H,onChangeEnd:N,showRangeLabels:!1,renderEmptyView:B,ariaLabels:S})}),onOpen:()=>{_(!0)},onClose:()=>{_(!1)},onDismiss:()=>{var e;null===(e=Y.current)||void 0===e||e.focus(),_(!1)},clickToToggle:!0,offset:8,alignment:n,fitAvailableHeight:!0,customZIndex:d,rootNode:$})})};export{Ma as SelectHistogram};
