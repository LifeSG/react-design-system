...
`,zo=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=W(e,["children","focusHighlight","focusOutline","type"]);return t(Ho,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),To=e=>"small"===e?1:1.125,Co=e=>m`
        height: ${To(e)}rem;
        width: ${To(e)}rem;
    `,Ao=g.div`
...
`,Ro=g(zo)`
    ...
    ${e=>m`
        ...
        `}
`;p(((n,r)=>{var{value:i,variant:o,onClear:a}=n,s=W(n,["value","variant","onClear"]);return e(Ao,{children:[e(_o,{children:[t(Lo,{$variant:o,"aria-hidden":!0}),t(Po,Object.assign({ref:r,value:i,$variant:o},s))]}),i&&t(Ro,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:a,$variant:o},{children:t(F,{"aria-hidden":!0})}))]})}));const No="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",jo=g(Eo)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,Io=p((({children:n,disabled:r,expanded:i,listboxId:o,popupRole:a,readOnly:s,variant:l},c)=>e(jo,Object.assign({ref:c,type:"button","aria-expanded":i,"aria-haspopup":a,"data-testid":"selector",disabled:r,"aria-controls":o,$variant:l},{children:[n,!s&&t(Wo,Object.assign({$expanded:i,$variant:l},{children:t(B,{"aria-hidden":!0})}))]}))));g.li`
...
`,g(D)`
    ...
    width: 1.625rem;
    color: ${wn.Primary};
`;const Yo=e=>"small"===e?2.5:3;g.div`
    position: relative;
    width: 100%;
    ${e=>{const t=Yo(e.$variant);return m`
            min-height: ${t}rem;
...
`;const Vo=m`
    ...
    height: calc(${e=>Yo(e.$variant)}rem - 2px);
    width: 100%;
    border-radius: ${"4px"};
    border: none;
    background: transparent;
