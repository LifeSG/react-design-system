...
`,fs=i.forwardRef(((e,n)=>{var{children:t,focusHighlight:i=!0,focusOutline:o="none",type:s="button"}=e,a=W(e,["children","focusHighlight","focusOutline","type"]);return r(ps,Object.assign({ref:n,$outline:o,$highlight:i,type:s},a,{children:t}))})),ys=p.div`
...
`;b(((n,t)=>{var{value:i,variant:o,onClear:s}=n,a=W(n,["value","variant","onClear"]);return e(ys,{$variant:o,children:[e(vs,{$variant:o,children:[r(ws,{"aria-hidden":!0}),r(xs,Object.assign({ref:t,value:i,$variant:o},a))]}),i&&r(Fs,{"aria-label":"Clear search",focusOutline:"browser",onClick:s,children:r(D,{"aria-hidden":!0})})]})}));const $s=p(bs)`
    display: flex;
    align-items: center;
    gap: ${lt["spacing-8"]};
    width: 100%;
...
`;var Ns;p(Hs)`
    color: ${it["text-subtler"]};
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Ns||(Ns={}));const Ws=p.div`
    display: flex;
    flex-direction: column;
`,Vs=e=>"right"===e?"bottom-end":"bottom-start",Ks=({enabled:t,isOpen:i,onOpen:a,onClose:d,onDismiss:c,renderElement:u,renderDropdown:h,customZIndex:g,clickToToggle:b=!1,offset:m=0,alignment:p="left",fitAvailableHeight:f,rootNode:y})=>{var x;const w=v(),F=ct["sm-max"]({theme:w}),$=l(null),E=l(null),{width:D=0}=function(e){void 0===e&&(e={});var r=e.skipOnMount,n=void 0!==r&&r,t=e.refreshMode,i=e.refreshRate,s=void 0===i?1e3:i,a=e.refreshOptions,d=e.handleWidth,c=void 0===d||d,u=e.handleHeight,h=void 0===u||u,g=e.targetRef,b=e.observerOptions,m=e.onResize,p=l(n),f=l(null),y=null!=g?g:f,v=l(),x=o({width:void 0,height:void 0}),w=x[0],F=x[1];return Ti((function(){if(!ki()){var e=Si(m,F,c,h);v.current=Mi((function(r){(c||h)&&r.forEach((function(r){var n=r&&r.contentRect||{},t=n.width,i=n.height;!p.current&&!ki()&&e({width:t,height:i}),p.current=!1}))}),t,s,a);var r=new window.ResizeObserver(v.current);return y.current&&r.observe(y.current,b),function(){r.disconnect();var e=v.current;e&&e.cancel&&e.cancel()}}}),[t,s,a,c,h,m,b,y.current]),Ht({ref:y},w)}({targetRef:$,handleHeight:!1}),C={name:"center",fn:({x:e,rects:r})=>{const n=0===e||e+r.floating.width===window.innerWidth,t=window.innerWidth<F;return{x:n&&t?(window.innerWidth-r.floating.width)/2:e}}},{refs:B,floatingStyles:A,context:N}=z({open:i,onOpenChange:(e,r,n)=>{"escape-key"===n?null==c||c():e&&!i?null==a||a():!e&&i&&(null==d||d(n))},whileElementsMounted:k,placement:Vs(p),middleware:[O(m),S(),_({limiter:T()}),L({apply({availableHeight:e}){E.current&&Object.assign(E.current.style,{maxHeight:f?`${e}px`:void 0,overflowY:f?"hidden":void 0})}}),C]}),W=(()=>{const[e,r]=o(void 0),n=M();return s((()=>{if(!n)return void r(void 0);const e=e=>{r(e.zIndex)};return n.events.on(Ns.Change,e),n.events.emit(Ns.Ready),()=>n.events.off(Ns.Change,e)}),[n]),e})(),{isMounted:V,styles:K}=j(N,{initial:{opacity:0},open:{opacity:1},duration:300}),U=R(N,{enabled:t,toggle:b}),Z=Y(N,{enabled:t}),{getReferenceProps:X,getFloatingProps:q}=P([U,Z]);return e(n,{children:[r("div",Object.assign({ref:e=>{$.current=e,B.setReference(e)}},X(),{children:u()})),V&&r(I,{root:y,children:r(H,{context:N,modal:!1,initialFocus:E,returnFocus:!1,children:r("div",Object.assign({ref:B.setFloating,style:Object.assign(Object.assign({},A),{zIndex:null!==(x=null!=g?g:W)&&void 0!==x?x:50})},q(),{children:r(Ws,{ref:E,style:Object.assign({},K),inert:K.opacity<1?"":void 0,children:h({elementWidth:D})})}))})})]})},Us=p.div`
    overflow: hidden;
    border: ${at["width-010"]} ${at.solid} ${it.border};
    border-radius: ${dt.sm};
    background: ${it.bg};
...
`,Js=p(qs)`
    color: ${it["text-subtler"]};
`,Gs=n=>{var{alignment:t="left",className:i,disabled:a,dropdownZIndex:d,error:c,histogramSlider:u,id:h,onBlur:g,onChange:b,onChangeEnd:m,optionTruncationType:p="end",placeholder:f="Select",rangeLabelPrefix:y,rangeLabelSuffix:v,readOnly:x,renderRangeLabel:w,value:F,dropdownRootNode:$}=n,E=W(n,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value","dropdownRootNode"]);const{interval:D,bins:C=[],renderEmptyView:B,ariaLabels:A}=u,[M,z]=o(U()),[k,O]=o(!1),[S,_]=o(!1),[T]=o((()=>Go.generate())),L=C.map((e=>e.minValue)),j=Math.min(...L),R=l(null),Y=l(null),P=l(null),I=E["data-testid"]||"select-histogram";s((()=>{F!==M&&z(U())}),[F]);const H=e=>{z(e),null==b||b(e)},N=e=>{z(e),null==m||m(e)},V=()=>{S||k||_(!0)},K=e=>{S&&!k&&R.current&&!R.current.contains(e.relatedTarget)&&(_(!1),null==g||g())};function U(){return null!=F?F:[j,j+D]}const Z=r=>w?w(r):e(pt.BodyBL,{children:[y,r,v]});return r(es,{children:r(Ks,{enabled:!x&&!a,isOpen:k,renderElement:()=>r(hs,{className:i,"data-testid":I,id:h,ref:R,tabIndex:-1,onFocus:V,onBlur:K,$focused:S,$disabled:a,$readOnly:x,$error:c,children:r(Ds,{ref:Y,disabled:a,expanded:k,listboxId:T,popupRole:"dialog",readOnly:x,variant:"default",children:r(Is,{ref:P,$disabled:a,children:L&&0!==L.length?e(Zs,{children:[Z(M[0]),r(Xs,{children:"-"}),Z(M[1])]}):r(Js,{truncateType:p,$variant:"default",children:f})})})}),renderDropdown:({elementWidth:e})=>r(Us,{style:{width:e},children:r(Pt,{interval:D,value:M,bins:C,onChange:H,onChangeEnd:N,showRangeLabels:!1,renderEmptyView:B,ariaLabels:A})}),onOpen:()=>{O(!0)},onClose:()=>{O(!1)},onDismiss:()=>{var e;null===(e=Y.current)||void 0===e||e.focus(),O(!1)},clickToToggle:!0,offset:8,alignment:t,fitAvailableHeight:!0,customZIndex:d,rootNode:$})})};export{Gs as SelectHistogram};
