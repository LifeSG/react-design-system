...
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Ha||(Ha={}));const Na=e=>"right"===e?"bottom-end":"bottom-start",Wa=b({elementWidth:0,styles:{},setFloatingRef:()=>{},getFloatingProps:()=>({})}),Va=({enabled:n,isOpen:i,onOpen:s,onClose:d,onDismiss:c,renderElement:u,renderDropdown:g,customZIndex:h,clickToToggle:b=!1,offset:p=0,alignment:f="left",fitAvailableHeight:y,rootNode:v,positionRef:x})=>{var w;const j=m(F),R=Tn["sm-max"]({theme:j}),P=l(null),{width:Y=0}=function(e){void 0===e&&(e={});var r=e.skipOnMount,t=void 0!==r&&r,n=e.refreshMode,i=e.refreshRate,a=void 0===i?1e3:i,s=e.refreshOptions,d=e.handleWidth,c=void 0===d||d,u=e.handleHeight,g=void 0===u||u,h=e.targetRef,b=e.observerOptions,m=e.onResize,p=l(t),f=l(null),y=null!=h?h:f,v=l(),x=o({width:void 0,height:void 0}),F=x[0],w=x[1];return xo((function(){if(!po()){var e=yo(m,w,c,g);v.current=bo((function(r){(c||g)&&r.forEach((function(r){var t=r&&r.contentRect||{},n=t.width,i=t.height;!p.current&&!po()&&e({width:n,height:i}),p.current=!1}))}),n,a,s);var r=new window.ResizeObserver(v.current);return y.current&&r.observe(y.current,b),function(){r.disconnect();var e=v.current;e&&e.cancel&&e.cancel()}}}),[n,a,s,c,g,m,b,y.current]),Ci({ref:y},F)}({targetRef:null!=x?x:P,handleHeight:!1}),I={name:"center",fn:({x:e,rects:r})=>{const t=0===e||e+r.floating.width===window.innerWidth,n=window.innerWidth<R;return{x:t&&n?(window.innerWidth-r.floating.width)/2:e}}},{refs:H,floatingStyles:N,context:W}=E({open:i,onOpenChange:(e,r,t)=>{"escape-key"===t?null==c||c():e&&!i?null==s||s():!e&&i&&(null==d||d(t))},whileElementsMounted:D,placement:Na(f),middleware:[C(p),B(),S({limiter:k()}),A({apply({availableHeight:e,elements:r}){!y||e>=r.floating.scrollHeight?r.floating.style.setProperty("--available-height",""):r.floating.style.setProperty("--available-height",`${Math.max(0,e)}px`)}}),I]}),V=(()=>{const[e,r]=o(void 0),t=$();return a((()=>{if(!t)return void r(void 0);const e=e=>{r(e.zIndex)};return t.events.on(Ha.Change,e),t.events.emit(Ha.Ready),()=>t.events.off(Ha.Change,e)}),[t]),e})(),{isMounted:K,styles:U}=z(W,{initial:{opacity:0},open:{opacity:1},duration:300}),Z=O(W,{enabled:n,toggle:b}),X=M(W,{enabled:n}),{getReferenceProps:q,getFloatingProps:J}=_([Z,X]),G={elementWidth:Y,styles:Object.assign(Object.assign(Object.assign({},U),N),{zIndex:null!==(w=null!=h?h:V)&&void 0!==w?w:50}),setFloatingRef:H.setFloating,getFloatingProps:J};return r(t,{children:[e("div",Object.assign({ref:e=>{P.current=e,H.setReference(e)}},q(),{children:u()})),K&&e(T,{root:v,children:e(L,{context:W,modal:!1,initialFocus:-1,returnFocus:!1,children:e(Wa.Provider,{value:G,children:g(G)})})})]})},Ka=i.createContext({focusedIndex:-1,setFocusedIndex:()=>{}}),Ua=({children:r})=>{const[t,n]=o(-1);return e(Ka.Provider,{value:{focusedIndex:t,setFocusedIndex:n},children:r})},Za=y.div`
    display: inline-block;
    position: relative;
...
`,es=({color:t,className:n,size:i})=>r(Za,{className:n,$size:i,$color:t,"data-testid":"component-loading-spinner",children:[e(qa,{id:"inner1"}),e(Ja,{id:"inner2"}),e(Ga,{id:"inner3"}),e(Qa,{id:"inner4"})]}),rs=v`
    outline-offset: -1px;
...
`;y.div`
    ...
    ${Ln.MaxWidth.sm} {
        --x-spacing: ${Tn["sm-margin"]}px;
        max-height: 15rem;
    }

    ${Ln.MaxWidth.xs} {
        --x-spacing: ${Tn["xs-margin"]}px;
    }

    ${Ln.MaxWidth.xxs} {
        --x-spacing: ${Tn["xxs-margin"]}px;
    }
...
`,cs=i.forwardRef(((r,t)=>{var{children:n,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=r,s=K(r,["children","focusHighlight","focusOutline","type"]);return e(ds,Object.assign({ref:t,$outline:o,$highlight:i,type:a},s,{children:n}))})),us=y.div`
...
`;p(((t,n)=>{var{value:i,variant:o,onClear:a}=t,s=K(t,["value","variant","onClear"]);return r(us,{$variant:o,children:[r(gs,{$variant:o,children:[e(bs,{"aria-hidden":!0}),e(hs,Object.assign({ref:n,value:i,$variant:o},s))]}),i&&e(ms,{"aria-label":"Clear search",focusOutline:"browser",onClick:a,children:e(N,{"aria-hidden":!0})})]})}));const ps=y(ss)`
    display: flex;
    align-items: center;
    gap: ${On["spacing-8"]};
    width: 100%;
...
`,ys=p(((t,n)=>{var{children:i,disabled:o,expanded:a,listboxId:s,popupRole:l,readOnly:d,variant:c}=t,u=K(t,["children","disabled","expanded","listboxId","popupRole","readOnly","variant"]);return r(ps,Object.assign({ref:n,type:"button",role:"combobox","aria-expanded":a,"aria-haspopup":l,"aria-controls":a?s:void 0,"data-testid":"selector","aria-disabled":o,"aria-readonly":d,$variant:c,$readOnly:d},u,{children:[i,!d&&e(fs,{$expanded:a,$variant:c,children:e(w,{"aria-hidden":!0})})]}))})),vs={Button:{"button-radius":vn.md,"button-default-colour-bg":Zt["bg-primary"],"button-default-colour-bg-hover":Zt["bg-primary-hover"],"button-default-colour-text":Zt["text-inverse"],"button-secondary-colour-border":Zt["border-primary"],"button-secondary-colour-text":Zt["text-primary"],"button-light-colour-text":Zt["text-primary"],"button-link-colour-text":Zt["text-primary"]},Animation:{"loading-dots-spinner-colour":Zt["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Zt.bg,"navbar-colour-icon":Zt.icon,"navbar-link-colour-text":Zt.text,"navbar-link-colour-text-hover":Zt["text-hover"],"navbar-link-colour-text-selected-hover":Zt["text-selected-hover"]},Footer:{"footer-colour-bg":Zt["bg-strong"],"footer-colour-text":Zt.text,"footer-link-colour-text":Zt.text,"footer-link-colour-text-hover":Zt["text-hover"],"footer-disclaimer-link-colour-text":Zt.text,"footer-disclaimer-link-colour-text-hover":Zt["text-subtler"]}},xs={Button:{"button-radius":vn.sm,"button-default-colour-bg":Zt["bg-primary"],"button-default-colour-bg-hover":Zt["bg-primary-hover"],"button-default-colour-text":Zt["text-inverse"],"button-secondary-colour-border":Zt["border-primary"],"button-secondary-colour-text":Zt["text-primary"],"button-light-colour-text":Zt["text-primary"],"button-link-colour-text":Zt["text-primary"]},Animation:{"loading-dots-spinner-colour":Zt["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Zt.bg,"navbar-colour-icon":Zt.icon,"navbar-link-colour-text":Zt.text,"navbar-link-colour-text-hover":Zt["text-hover"],"navbar-link-colour-text-selected-hover":Zt["text-selected-hover"]},Footer:{"footer-colour-bg":Zt["bg-strong"],"footer-colour-text":Zt.text,"footer-link-colour-text":Zt.text,"footer-link-colour-text-hover":Zt["text-hover"],"footer-disclaimer-link-colour-text":Zt.text,"footer-disclaimer-link-colour-text-hover":Zt["text-subtler"]}},Fs={Button:{"button-radius":vn.sm,"button-default-colour-bg":Zt["bg-primary"],"button-default-colour-bg-hover":Zt["bg-primary-hover"],"button-default-colour-text":Zt["text-inverse"],"button-secondary-colour-border":Zt["border-primary"],"button-secondary-colour-text":Zt["text-primary"],"button-light-colour-text":Zt["text-primary"],"button-link-colour-text":Zt["text-primary"]},Animation:{"loading-dots-spinner-colour":Sn.Primitive["brand-50"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Zt.bg,"navbar-colour-icon":Zt.icon,"navbar-link-colour-text":Zt.text,"navbar-link-colour-text-hover":Zt["text-hover"],"navbar-link-colour-text-selected-hover":Zt["text-selected-hover"]},Footer:{"footer-colour-bg":Zt["bg-strong"],"footer-colour-text":Zt.text,"footer-link-colour-text":Zt.text,"footer-link-colour-text-hover":Zt["text-hover"],"footer-disclaimer-link-colour-text":Zt.text,"footer-disclaimer-link-colour-text-hover":Zt["text-subtler"]}},ws={collections:{default:xs,pa:{Button:{"button-radius":vn.full,"button-default-colour-bg":Zt["bg-primary"],"button-default-colour-bg-hover":Zt["bg-primary-hover"],"button-default-colour-text":Zt["text-inverse"],"button-secondary-colour-border":Zt["border-primary"],"button-secondary-colour-text":Zt["text-primary"],"button-light-colour-text":Zt["text-primary"],"button-link-colour-text":Zt["text-primary"]},Animation:{"loading-dots-spinner-colour":Zt["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"2rem","navbar-compressed-height":"4rem","navbar-compressed-logo-height":"1.5rem","navbar-mobile-height":"3.5rem","navbar-mobile-logo-height":"1.5rem","navbar-colour-bg":Zt.bg,"navbar-colour-icon":Zt.icon,"navbar-link-colour-text":Zt.text,"navbar-link-colour-text-hover":Zt["text-hover"],"navbar-link-colour-text-selected-hover":Zt["text-selected-hover"]},Footer:{"footer-colour-bg":Zt["bg-strong"],"footer-colour-text":Zt.text,"footer-link-colour-text":Zt.text,"footer-link-colour-text-hover":Zt["text-hover"],"footer-disclaimer-link-colour-text":Zt.text,"footer-disclaimer-link-colour-text-hover":Zt["text-subtler"]}},a11yplayground:vs,lifesg:Fs,spf:{Button:{"button-radius":vn.md,"button-default-colour-bg":Zt["bg-primary"],"button-default-colour-bg-hover":Zt["bg-primary-hover"],"button-default-colour-text":Zt["text-inverse"],"button-secondary-colour-border":Zt["border-primary"],"button-secondary-colour-text":Zt["text-primary"],"button-light-colour-text":Zt["text-primary"],"button-link-colour-text":Zt["text-primary"]},Animation:{"loading-dots-spinner-colour":Zt["icon-primary"]},Navbar:{"navbar-full-height":"6rem","navbar-full-logo-height":"3rem","navbar-compressed-height":"5rem","navbar-compressed-logo-height":"2rem","navbar-mobile-height":"4rem","navbar-mobile-logo-height":"2rem","navbar-colour-bg":Zt.bg,"navbar-colour-icon":Zt.icon,"navbar-link-colour-text":Zt["text-primary-strongest"],"navbar-link-colour-text-hover":Zt["text-subtler"],"navbar-link-colour-text-selected-hover":Zt["text-subtler"]},Footer:{"footer-colour-bg":Zt["bg-inverse"],"footer-colour-text":Zt["text-inverse"],"footer-link-colour-text":Zt["text-inverse"],"footer-link-colour-text-hover":Zt["text-inverse"],"footer-disclaimer-link-colour-text":Zt["text-inverse"],"footer-disclaimer-link-colour-text-hover":Zt["text-inverse"]}}},defaultValue:"default"},$s=(e,r)=>t=>{var n,i;const o=t.theme,a=xt(ws,null==o?void 0:o.componentScheme);return Es((null===(i=null===(n=null==o?void 0:o.componentOverrides)||void 0===n?void 0:n[e])||void 0===i?void 0:i[r])||a[e][r],t)},Es=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},Ds=$s("Button","button-radius"),Cs=$s("Button","button-default-colour-bg"),Bs=$s("Button","button-default-colour-bg-hover"),Ss=$s("Button","button-default-colour-text"),ks=$s("Button","button-secondary-colour-border"),As=$s("Button","button-secondary-colour-text"),zs=$s("Button","button-light-colour-text"),Os=$s("Button","button-link-colour-text");y.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return v`
                    background-color: ${Sn.bg};
                    border-color: ${e.$buttonIsDanger?Sn["border-error-strong"]:ks};

                    color: ${e.$buttonIsDanger?Sn["text-error"]:As};
                ...
                `;case"light":return v`
                    ...
                    color: ${e.$buttonIsDanger?Sn["text-error"]:zs};
                ...
                `;case"link":return v`
                    ...
                    color: ${e.$buttonIsDanger?Sn["text-error"]:Os};
                    &:hover,
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${Sn["bg-hover-neutral"]};
                ...
                `;case"disabled":return v`
                    ...
                    color: ${Sn["text-disabled"]};
                `;default:return v`
                    background-color: ${e.$buttonIsDanger?Sn["bg-error-strong"]:Cs};
                    ...
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${e.$buttonIsDanger?Sn["bg-error-strong-hover"]:Bs};
                        }
                    }
                `}}}
...
`;const Ms=y.div`
    ...
    ${Ln.MaxWidth.sm} {
        min-width: unset;
        width: calc(100vw - ${Tn["sm-margin"]}px * 2);
    }

    ${Ln.MaxWidth.xs} {
        width: calc(100vw - ${Tn["xs-margin"]}px * 2);
    }

    ${Ln.MaxWidth.xxs} {
        width: calc(100vw - ${Tn["xxs-margin"]}px * 2);
    }
`,_s=y.div`
    display: flex;
    align-items: baseline;
...
`)`
    color: ${Sn["text-subtler"]};
`,js=t=>{var{alignment:n="left",className:i,disabled:s,dropdownZIndex:d,error:c,histogramSlider:u,id:g,"aria-labelledby":h,"aria-describedby":b,"aria-invalid":m,onBlur:p,onChange:f,onChangeEnd:y,optionTruncationType:v="end",placeholder:x="Select",rangeLabelPrefix:F,rangeLabelSuffix:w,readOnly:$,renderRangeLabel:E,value:D,dropdownRootNode:C}=t,B=K(t,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","aria-labelledby","aria-describedby","aria-invalid","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value","dropdownRootNode"]);const{interval:S,bins:k=[],renderEmptyView:A,ariaLabels:z}=u,O=k.map((e=>e.minValue)),M=Math.min(...O),[_,T]=o(q()),[L,j]=o(!1),[R,P]=o(!1),[Y]=o((()=>La.generate())),I=l(null),H=l(null),N=l(null),W=B["data-testid"]||"select-histogram";a((()=>{D!==_&&T(q())}),[D]);const V=e=>{T(e),null==f||f(e)},U=e=>{T(e),null==y||y(e)},Z=()=>{R||L||P(!0)},X=e=>{R&&!L&&I.current&&!I.current.contains(e.relatedTarget)&&(P(!1),null==p||p())};function q(){return null!=D?D:[M,M+S]}const J=e=>E?E(e):r(ri.BodyBL,{children:[F,e,w]});return e(Ua,{children:e(Va,{enabled:!$&&!s,isOpen:L,renderElement:()=>e(os,{className:i,"data-testid":W,id:g,ref:I,tabIndex:-1,onFocus:Z,onBlur:X,$focused:R,$disabled:s,$readOnly:$,$error:c,children:e(ys,{ref:H,disabled:s,expanded:L,listboxId:Y,popupRole:"dialog",readOnly:$,variant:"default","aria-labelledby":h,"aria-describedby":b,"aria-invalid":m,children:e(Ia,{ref:N,$disabled:s,children:O&&0!==O.length?r(_s,{children:[J(_[0]),e(Ts,{children:"-"}),J(_[1])]}):e(Ls,{$truncateType:v,$variant:"default",children:x})})})}),renderDropdown:({elementWidth:r,styles:t,setFloatingRef:n,getFloatingProps:i})=>e(Ms,Object.assign({style:Object.assign(Object.assign({},t),{width:r}),ref:n},i(),{children:e(Ei,{interval:S,value:_,bins:k,onChange:V,onChangeEnd:U,showRangeLabels:!1,renderEmptyView:A,ariaLabels:z})})),onOpen:()=>{j(!0)},onClose:()=>{j(!1)},onDismiss:()=>{var e;null===(e=H.current)||void 0===e||e.focus(),j(!1)},clickToToggle:!0,offset:8,alignment:n,fitAvailableHeight:!0,customZIndex:d,rootNode:C})})};export{js as SelectHistogram};
