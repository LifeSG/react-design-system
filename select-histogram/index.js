...
`,pa=p((({children:n,disabled:t,expanded:i,listboxId:o,popupRole:s,readOnly:a,variant:l},d)=>r(ba,{ref:d,type:"button","aria-expanded":i,"aria-haspopup":s,"data-testid":"selector",disabled:t,"aria-controls":o,$variant:l,$readOnly:a,children:[n,!a&&e(ma,{$expanded:i,$variant:l,children:e(w,{"aria-hidden":!0})})]}))),fa={Button:{"button-radius":yt.md,"button-default-colour-bg":Zn["bg-primary"],"button-default-colour-bg-hover":Zn["bg-primary-hover"],"button-default-colour-text":Zn["text-inverse"],"button-secondary-colour-border":Zn["border-primary"],"button-secondary-colour-text":Zn["text-primary"],"button-light-colour-text":Zn["text-primary"],"button-link-colour-text":Zn["text-primary"]}},ya={collections:{default:{Button:{"button-radius":yt.sm,"button-default-colour-bg":Zn["bg-primary"],"button-default-colour-bg-hover":Zn["bg-primary-hover"],"button-default-colour-text":Zn["text-inverse"],"button-secondary-colour-border":Zn["border-primary"],"button-secondary-colour-text":Zn["text-primary"],"button-light-colour-text":Zn["text-primary"],"button-link-colour-text":Zn["text-primary"]}},pa:{Button:{"button-radius":yt.full,"button-default-colour-bg":Zn["bg-primary"],"button-default-colour-bg-hover":Zn["bg-primary-hover"],"button-default-colour-text":Zn["text-inverse"],"button-secondary-colour-border":Zn["border-primary"],"button-secondary-colour-text":Zn["text-primary"],"button-light-colour-text":Zn["text-primary"],"button-link-colour-text":Zn["text-primary"]}},a11yplayground:fa},defaultValue:"default"},va=(e,r)=>n=>{var t,i;const o=n.theme,s=Fn(ya,null==o?void 0:o.componentScheme);return xa((null===(i=null===(t=null==o?void 0:o.componentOverrides)||void 0===t?void 0:t[e])||void 0===i?void 0:i[r])||s[e][r],n)},xa=(e,r)=>{switch(typeof e){case"function":return e(r);case"number":return e+"px";case"string":return e}},Fa=va("Button","button-radius"),wa=va("Button","button-default-colour-bg"),$a=va("Button","button-default-colour-bg-hover"),Ea=va("Button","button-default-colour-text"),Da=va("Button","button-secondary-colour-border"),Ca=va("Button","button-secondary-colour-text"),Ba=va("Button","button-light-colour-text"),Sa=va("Button","button-link-colour-text");y.button`
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return v`
                    background-color: ${Bt.bg};
                    border-color: ${e.$buttonIsDanger?Bt["border-error-strong"]:Da};

                    color: ${e.$buttonIsDanger?Bt["text-error"]:Ca};
                ...
                `;case"light":return v`
                    ...
                    color: ${e.$buttonIsDanger?Bt["text-error"]:Ba};
                ...
                `;case"disabled":return v`
                    ...
                    color: ${Bt["text-disabled"]};
                `;default:return v`
                    background-color: ${e.$buttonIsDanger?Bt["bg-error-strong"]:wa};
                    ...
                    &:active {
                        @media (pointer: fine) {
                            background-color: ${e.$buttonIsDanger?Bt["bg-error-strong-hover"]:$a};
                        }
                    }
                `}}}
