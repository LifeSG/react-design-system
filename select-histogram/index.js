...
`)`
    color: ${Sn["text-subtler"]};
`,ja=t=>{var{alignment:n="left",className:i,disabled:a,dropdownZIndex:d,error:c,histogramSlider:u,id:g,onBlur:h,onChange:b,onChangeEnd:m,optionTruncationType:p="end",placeholder:f="Select",rangeLabelPrefix:y,rangeLabelSuffix:v,readOnly:x,renderRangeLabel:F,value:w,dropdownRootNode:$}=t,E=K(t,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value","dropdownRootNode"]);const{interval:D,bins:C=[],renderEmptyView:B,ariaLabels:S}=u,k=C.map((e=>e.minValue)),A=Math.min(...k),[z,O]=o(U()),[M,_]=o(!1),[T,L]=o(!1),[j]=o((()=>Ls.generate())),R=l(null),P=l(null),Y=l(null),I=E["data-testid"]||"select-histogram";s((()=>{w!==z&&O(U())}),[w]);const H=e=>{O(e),null==b||b(e)},N=e=>{O(e),null==m||m(e)},W=()=>{T||M||L(!0)},V=e=>{T&&!M&&R.current&&!R.current.contains(e.relatedTarget)&&(L(!1),null==h||h())};function U(){return null!=w?w:[A,A+D]}const Z=e=>F?F(e):r(ri.BodyBL,{children:[y,e,v]});return e(Us,{children:e(Vs,{enabled:!x&&!a,isOpen:M,renderElement:()=>e(oa,{className:i,"data-testid":I,id:g,ref:R,tabIndex:-1,onFocus:W,onBlur:V,$focused:T,$disabled:a,$readOnly:x,$error:c,children:e(ya,{ref:P,disabled:a,expanded:M,listboxId:j,popupRole:"dialog",readOnly:x,variant:"default",children:e(Is,{ref:Y,$disabled:a,children:k&&0!==k.length?r(_a,{children:[Z(z[0]),e(Ta,{children:"-"}),Z(z[1])]}):e(La,{$truncateType:p,$variant:"default",children:f})})})}),renderDropdown:({elementWidth:r,styles:t,setFloatingRef:n,getFloatingProps:i})=>e(Ma,Object.assign({style:Object.assign(Object.assign({},t),{width:r}),ref:n},i(),{children:e(Ei,{interval:D,value:z,bins:C,onChange:H,onChangeEnd:N,showRangeLabels:!1,renderEmptyView:B,ariaLabels:S})})),onOpen:()=>{_(!0)},onClose:()=>{_(!1)},onDismiss:()=>{var e;null===(e=P.current)||void 0===e||e.focus(),_(!1)},clickToToggle:!0,offset:8,alignment:n,fitAvailableHeight:!0,customZIndex:d,rootNode:$})})};export{ja as SelectHistogram};
