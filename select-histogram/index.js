...
`,Zi={collections:{base:{InputBoxShadow:m`
    ...
    `,ElevationBoxShadow:m`
      0px 2px 8px ${wn.Shadow.Elevation}
    `,Table:{Header:"#F5F5F5",Cell:{Primary:"#FBFBFB",Secondary:"#FFFFFF",Selected:"#F0F6FF",Hover:"#DDE6FD"}},Button:{Danger:{BackgroundColor:"#CB2213",Border:"#CB2213",Hover:"#8F0E0E",Primary:"#CB2213"}}}},defaultValue:"base"},Xi=e=>t=>{var n;const r=t.theme,i=dn(Zi,r[un.designTokenScheme]);return(null===(n=r.options)||void 0===n?void 0:n.designToken)?cn(i,e,r.options.designToken):cn(i,e)},Gi={InputBoxShadow:Xi("InputBoxShadow"),InputErrorBoxShadow:Xi("InputErrorBoxShadow"),ElevationBoxShadow:Xi("ElevationBoxShadow"),Table:{Header:Xi("Table.Header"),Cell:{Primary:Xi("Table.Cell.Primary"),Secondary:Xi("Table.Cell.Secondary"),Selected:Xi("Table.Cell.Selected"),Hover:Xi("Table.Cell.Hover")}},Button:{Danger:{BackgroundColor:Xi("Button.Danger.BackgroundColor"),Hover:Xi("Button.Danger.Hover"),Primary:Xi("Button.Danger.Primary"),Border:Xi("Button.Danger.Border")}}};g.button`
    padding: 0.5rem 1rem;
    min-width: 4rem;
    border-radius: 4px;
    ...
    ${e=>{switch(e.$buttonStyle){case"secondary":return m`
                    background-color: ${wn.Neutral[8]};
                    border: 1px solid
                        ${e.$buttonIsDanger?Gi.Button.Danger.Border:wn.Primary};

                    color: ${e.$buttonIsDanger?Gi.Button.Danger.Primary:wn.Primary};
                `;case"light":return m`
                    background-color: ${wn.Neutral[8]};
                ...
                `;case"link":return m`
                    ...
                    :active,
                    :focus {
                        color: ${e.$buttonIsDanger?Gi.Button.Danger.Hover:wn.Secondary};
                    }
                `;default:return m`
                    background-color: ${e.$buttonIsDanger?Gi.Button.Danger.BackgroundColor:wn.Primary};
                    border: 1px solid transparent;
	...
	${e=>"small"===e.$buttonSizeStyle?m`
                ...
                `}
`,g((({color:n,className:r,size:i=18})=>e(Ii,Object.assign({className:r,$size:i,$color:n},{children:[t(Vi,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(Ki,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(Ui,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(Ji,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?Gi.Button.Danger.Primary:wn.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=wn.Neutral[3](e);break;default:t=wn.Neutral[8](e)}return m`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,wo=m`
    ...
    box-shadow: ${Gi.InputErrorBoxShadow};
`,Bo=g.div`
    border: 1px solid ${wn.Neutral[5]};
    border-radius: 4px;
...
`,Mo=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=e,s=W(e,["children","focusHighlight","focusOutline","type"]);return t(Eo,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Ho=e=>"small"===e?1:1.125,zo=e=>m`
        height: ${Ho(e)}rem;
        width: ${Ho(e)}rem;
    `,To=g.div`
...
`,Po=g(Mo)`
    ...
    ${e=>m`
        ...
        `}
`;p(((n,r)=>{var{value:i,variant:o,onClear:a}=n,s=W(n,["value","variant","onClear"]);return e(To,{children:[e(Co,{children:[t(_o,{$variant:o,"aria-hidden":!0}),t(Ao,Object.assign({ref:r,value:i,$variant:o},s))]}),i&&t(Po,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:a,$variant:o},{children:t(F,{"aria-hidden":!0})}))]})}));const Lo="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Ro=g(ko)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
...
`,jo=p((({children:n,disabled:r,expanded:i,listboxId:o,popupRole:a,readOnly:s,variant:l},c)=>e(Ro,Object.assign({ref:c,type:"button","aria-expanded":i,"aria-haspopup":a,"data-testid":"selector",disabled:r,"aria-controls":o,$variant:l},{children:[n,!s&&t(No,Object.assign({$expanded:i,$variant:l},{children:t(B,{"aria-hidden":!0})}))]}))));g.li`
...
`,g(D)`
    ...
    width: 1.625rem;
    color: ${wn.Primary};
`;const Wo=e=>"small"===e?2.5:3;g.div`
    position: relative;
    width: 100%;
...
`,na=g(ta)`
    color: ${wn.Neutral[3]};
`,ra=n=>{var{alignment:r="left",className:i,disabled:s,dropdownZIndex:c,error:d,histogramSlider:u,id:h,onBlur:f,onChange:p,onChangeEnd:g,optionTruncationType:m="end",placeholder:v="Select",rangeLabelPrefix:y,rangeLabelSuffix:b,readOnly:$,renderRangeLabel:S,value:x}=n,F=W(n,["alignment","className","disabled","dropdownZIndex","error","histogramSlider","id","onBlur","onChange","onChangeEnd","optionTruncationType","placeholder","rangeLabelPrefix","rangeLabelSuffix","readOnly","renderRangeLabel","value"]);const{interval:w,bins:B=[],renderEmptyView:D,ariaLabels:k}=u,[O,E]=o(K()),[M,H]=o(!1),[z,T]=o(!1),[C]=o((()=>yo.generate())),A=B.map((e=>e.minValue)),_=Math.min(...A),P=l(),L=l(),R=l(),N=F["data-testid"]||"select-histogram";a((()=>{x!==O&&E(K())}),[x]);const j=e=>{E(e),null==p||p(e)},I=e=>{E(e),null==g||g(e)},Y=()=>{z||M||T(!0)},V=e=>{!z||M||P.current.contains(e.relatedTarget)||(T(!1),null==f||f())};function K(){return null!=x?x:[_,_+w]}const U=t=>S?S(t):e(Bn.Body,{children:[y,t,b]});return t($o,{children:t(Go,{enabled:!$&&!s,isOpen:M,renderElement:()=>t(Bo,Object.assign({className:i,"data-testid":N,id:h,ref:P,tabIndex:-1,onFocus:Y,onBlur:V,$focused:z,$disabled:s,$readOnly:$,$error:d},{children:t(jo,Object.assign({ref:L,disabled:s,expanded:M,listboxId:C,popupRole:"dialog",readOnly:$,variant:"default"},{children:t(Ko,Object.assign({ref:R,$disabled:s},{children:A&&0!==A.length?e(Qo,{children:[U(O[0]),t(ea,{children:"-"}),U(O[1])]}):t(na,Object.assign({truncateType:m,$variant:"default"},{children:v}))}))}))})),renderDropdown:({elementWidth:e})=>t(qo,Object.assign({style:{width:e}},{children:t(qn,{interval:w,value:O,bins:B,onChange:j,onChangeEnd:I,showRangeLabels:!1,renderEmptyView:D,ariaLabels:k})})),onOpen:()=>{H(!0)},onClose:()=>{H(!1)},onDismiss:()=>{L.current.focus(),H(!1)},clickToToggle:!0,offset:8,alignment:r,fitAvailableHeight:!0,customZIndex:c})})};export{ra as SelectHistogram};
