...
export declare const Component: ({ children, disabled, expanded, listboxId, readOnly, variant, }: ExpandableElementProps, ref: Ref<HTMLButtonElement>) => import("react/jsx-runtime").JSX.Element;
