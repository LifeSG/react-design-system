import type { NestedDropdownListItemProps, NestedDropdownListLocalItem } from "./types";
/**
...
export declare const findItemFromStart: <T>(arr: T[], predicate: (e: T) => boolean, start: number) => T | undefined;
export declare const findItemFromEnd: <T>(arr: T[], predicate: (e: T) => boolean, end: number) => T | undefined;
export declare const findItemByKeyPath: <T>(nestedList: NestedDropdownListItemProps<T>[] | undefined, keyPath: string[]) => NestedDropdownListItemProps<T> | undefined;
export declare const buildKeyPath: (keyPath: string[]) => string;
export declare const buildKeyPathToSet: (keyPathArr: string[][]) => Set<string>;
