import type { DropdownVariantType, IconProps, LabelDisplayType, TruncateType } from "./types";
...
export declare const ListCheckbox: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("../..").CheckboxProps, never>> & string & Omit<({ className, checked, disabled, indeterminate, displaySize, id, ...otherProps }: import("../..").CheckboxProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;
