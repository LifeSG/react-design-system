...
export declare const ListCheckbox: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("../..").CheckboxProps, never>> & string & Omit<({ className, checked, disabled, focusableWhenDisabled, indeterminate, displaySize, id, tabIndex, onChange, ...otherProps }: import("../..").CheckboxProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;
