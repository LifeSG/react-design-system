...
export declare const Component: ({ children, className, disabled, expanded, listboxId, popupRole, readOnly, variant, ...otherProps }: ExpandableElementProps, ref: Ref<HTMLButtonElement>) => import("react/jsx-runtime").JSX.Element;
