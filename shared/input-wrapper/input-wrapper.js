import o,{css as r}from"styled-components";import{Border as e,Colour as n,Radius as t,Spacing as i,Font as d}from"../../theme/index.js";const a=r`
    outline-offset: -1px;
    outline: ${e["width-020"]} ${e.solid} ${n["border-focus"]};
`,s=r`
...
`,c=r`
    outline: none;
`,u=o.div`
    border: ${e["width-010"]} ${e.solid} ${n.border};
    border-radius: ${t.sm};
    background: ${n.bg};
