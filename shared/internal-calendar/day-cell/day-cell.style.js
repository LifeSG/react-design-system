import e,{css as t}from"styled-components";import{Motion as r,Border as o,Radius as i,Font as n,Colour as l}from"../../../theme/index.js";const s=e=>{let t=l.bg,r="transparent";switch(e.$type){case"hover-subtle":t=l["bg-hover"],r=l["bg-hover"];break;case"hover":t=l["bg-hover-strong"],r=l["bg-hover-strong"];break;case"hover-outline":t=l["bg-hover-subtle"],r=l["border-hover"];break;case"selected-outline":t=l["bg-selected"],r=l["border-selected"];break;case"selected-outline-subtle":t=l["bg-selected"],r=l["border-selected-subtle"];break;case"selected-hover":t=l["bg-selected-hover"];break;case"selected-hover-outline":t=l["bg-selected-hover"],r=l["border-selected-hover"]}return{color:t,borderColor:r}},d=e.div`
    display: flex;
    align-items: center;
