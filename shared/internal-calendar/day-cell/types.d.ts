...
export type CellType = "hover-subtle" | "hover" | "hover-outline" | "selected-outline" | "selected-outline-subtle" | "selected-hover" | "selected-hover-outline";
export type LabelType = "available" | "unavailable" | "current" | "hover" | "selected" | "selected-hover" | "hidden";
