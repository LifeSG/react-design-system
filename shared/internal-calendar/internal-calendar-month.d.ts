...
export declare const InternalCalendarMonth: ({ calendarDate, currentFocus, selectedStartDate, selectedEndDate, viewCalendarDate, isNewSelection, minDate, maxDate, allowDisabledSelection, onMonthSelect, }: Props) => import("react/jsx-runtime").JSX.Element;
export {};
