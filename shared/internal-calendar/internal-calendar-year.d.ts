...
export declare const InternalCalendarYear: ({ calendarDate, currentFocus, selectedStartDate, selectedEndDate, viewCalendarDate, type, isNewSelection, minDate, maxDate, allowDisabledSelection, onYearSelect, }: Props) => import("react/jsx-runtime").JSX.Element;
export {};
