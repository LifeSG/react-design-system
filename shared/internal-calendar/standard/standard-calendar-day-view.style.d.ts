...
export declare const DayLabel: import("styled-components").StyledComponent<"h5", import("styled-components").DefaultTheme, import("../../../v2_text").V2_TextProps & DayLabelStyleProps, never>;
