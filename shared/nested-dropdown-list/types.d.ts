...
export interface NestedDropdownListProps<V1, V2, V3> extends React.HTMLAttributes<HTMLUListElement>, DropdownEventHandlerProps<V1, V2, V3>, DropdownSearchProps, DropdownStyleProps {
    ...
    onSelectAll?: ((keyPaths: string[][], items: SelectedItem<V1, V2, V3>[]) => void) | undefined;
...
export type CombinedFormattedOptionProps<V1, V2, V3> = FormattedOption<V1, V2, V3> | FL2<V2, V3> | FL3<V3>;
export {};
