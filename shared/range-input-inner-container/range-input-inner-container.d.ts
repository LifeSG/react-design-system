 ...
 */
export declare const RangeInputInnerContainer: ({ children, currentActive, error, className, wrap, }: RangeInputInnerContainerProps) => import("react/jsx-runtime").JSX.Element;
