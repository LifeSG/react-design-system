import{ArrowRightIcon as e}from"@lifesg/react-icons";import i,{css as n}from"styled-components";import{Font as a,Spacing as t,Colour as r,Motion as o}from"../../theme/index.js";const s=i.div`
    position: relative;
    height: 100%;
    display: flex;
    flex: 1;
...
`,p=i.div`
    ...
    width: calc(
        50% - ${t["spacing-8"]} - (${a.Spec["body-size-baseline"]} / 2)
    );
