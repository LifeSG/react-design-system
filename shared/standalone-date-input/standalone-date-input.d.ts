...
export declare const Component: ({ disabled, readOnly, names, value, focused, hoverValue, placeholder, label, onChange, onFocus, onBlur, hideInputKeyboard, inputLabels, }: Props, ref: React.ForwardedRef<StandaloneDateInputRef>) => import("react/jsx-runtime").JSX.Element;
export declare const StandaloneDateInput: (props: Props & React.RefAttributes<StandaloneDateInputRef>) => React.ReactElement | null;
export {};
