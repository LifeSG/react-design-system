...
export declare const Component: ({ disabled, readOnly, names, value, focused, hoverValue, placeholder, label, onChange, onFocus, onBlur, hideInputKeyboard, }: Props, ref: React.ForwardedRef<StandaloneDateInputRef>) => import("react/jsx-runtime").JSX.Element;
