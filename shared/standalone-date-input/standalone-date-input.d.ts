...
export declare const Component: ({ disabled, readOnly, names, value, focused, hoverValue, placeholder, label, onChange, onFocus, onBlur, }: Props, ref: React.ForwardedRef<StandaloneDateInputRef>) => JSX.Element;
