...
export declare const Divider: import("styled-components").StyledComponent<"p", import("styled-components").DefaultTheme, import("../..").TextProps & DividerStyleProps, never>;
