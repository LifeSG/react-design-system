...
`,Eo={Regular:"Open Sans",Semibold:"Open Sans Semibold",Bold:"Open Sans Bold",Light:"Open Sans Light"},Io={collections:{base:{D1:{fontFamily:Eo.Bold,fontSize:3,fontWeight:700,lineHeight:4,letterSpacing:-.056},D2:{fontFamily:Eo.Bold,fontSize:2.5,fontWeight:700,lineHeight:3.5,letterSpacing:-.032},D3:{fontFamily:Eo.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},D4:{fontFamily:Eo.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},DBody:{fontFamily:Eo.Regular,fontSize:1.375,lineHeight:1.75},H1:{fontFamily:Eo.Bold,fontSize:2,fontWeight:700,lineHeight:2.5},H2:{fontFamily:Eo.Bold,fontSize:1.625,fontWeight:700,lineHeight:2.25},H3:{fontFamily:Eo.Bold,fontSize:1.375,fontWeight:700,lineHeight:1.75},H4:{fontFamily:Eo.Bold,fontSize:1.125,fontWeight:700,lineHeight:1.625},H5:{fontFamily:Eo.Bold,fontSize:1,fontWeight:700,lineHeight:1.5,letterSpacing:.014},H6:{fontFamily:Eo.Bold,fontSize:.875,fontWeight:700,lineHeight:1.6,letterSpacing:.012},Body:{fontFamily:Eo.Regular,fontSize:1.125,lineHeight:1.625},BodySmall:{fontFamily:Eo.Regular,fontSize:1,lineHeight:1.5,letterSpacing:.014},XSmall:{fontFamily:Eo.Regular,fontSize:.75,lineHeight:1.2,letterSpacing:.012}}},defaultValue:"base"},Ao=e=>t=>{const n=t.theme,r=jt(Io,n[zt.textStyleScheme]);return n.options&&n.options.textStyle?Ht(r,e,n.options.textStyle):Ht(r,e)},Po={D1:{fontFamily:Ao("D1.fontFamily"),fontSize:Ao("D1.fontSize"),fontWeight:Ao("D1.fontWeight"),lineHeight:Ao("D1.lineHeight"),letterSpacing:Ao("D1.letterSpacing")},D2:{fontFamily:Ao("D2.fontFamily"),fontSize:Ao("D2.fontSize"),fontWeight:Ao("D2.fontWeight"),lineHeight:Ao("D2.lineHeight"),letterSpacing:Ao("D2.letterSpacing")},D3:{fontFamily:Ao("D3.fontFamily"),fontSize:Ao("D3.fontSize"),fontWeight:Ao("D3.fontWeight"),lineHeight:Ao("D3.lineHeight"),letterSpacing:Ao("D3.letterSpacing")},D4:{fontFamily:Ao("D4.fontFamily"),fontSize:Ao("D4.fontSize"),fontWeight:Ao("D4.fontWeight"),lineHeight:Ao("D4.lineHeight"),letterSpacing:Ao("D4.letterSpacing")},DBody:{fontFamily:Ao("DBody.fontFamily"),fontSize:Ao("DBody.fontSize"),fontWeight:Ao("DBody.fontWeight"),lineHeight:Ao("DBody.lineHeight"),letterSpacing:Ao("DBody.letterSpacing")},H1:{fontFamily:Ao("H1.fontFamily"),fontSize:Ao("H1.fontSize"),fontWeight:Ao("H1.fontWeight"),lineHeight:Ao("H1.lineHeight"),letterSpacing:Ao("H1.letterSpacing")},H2:{fontFamily:Ao("H2.fontFamily"),fontSize:Ao("H2.fontSize"),fontWeight:Ao("H2.fontWeight"),lineHeight:Ao("H2.lineHeight"),letterSpacing:Ao("H2.letterSpacing")},H3:{fontFamily:Ao("H3.fontFamily"),fontSize:Ao("H3.fontSize"),fontWeight:Ao("H3.fontWeight"),lineHeight:Ao("H3.lineHeight"),letterSpacing:Ao("H3.letterSpacing")},H4:{fontFamily:Ao("H4.fontFamily"),fontSize:Ao("H4.fontSize"),fontWeight:Ao("H4.fontWeight"),lineHeight:Ao("H4.lineHeight"),letterSpacing:Ao("H4.letterSpacing")},H5:{fontFamily:Ao("H5.fontFamily"),fontSize:Ao("H5.fontSize"),fontWeight:Ao("H5.fontWeight"),lineHeight:Ao("H5.lineHeight"),letterSpacing:Ao("H5.letterSpacing")},H6:{fontFamily:Ao("H6.fontFamily"),fontSize:Ao("H6.fontSize"),fontWeight:Ao("H6.fontWeight"),lineHeight:Ao("H6.lineHeight"),letterSpacing:Ao("H6.letterSpacing")},Body:{fontFamily:Ao("Body.fontFamily"),fontSize:Ao("Body.fontSize"),fontWeight:Ao("Body.fontWeight"),lineHeight:Ao("Body.lineHeight"),letterSpacing:Ao("Body.letterSpacing")},BodySmall:{fontFamily:Ao("BodySmall.fontFamily"),fontSize:Ao("BodySmall.fontSize"),fontWeight:Ao("BodySmall.fontWeight"),lineHeight:Ao("BodySmall.lineHeight"),letterSpacing:Ao("BodySmall.letterSpacing")},XSmall:{fontFamily:Ao("XSmall.fontFamily"),fontSize:Ao("XSmall.fontSize"),fontWeight:Ao("XSmall.fontWeight"),lineHeight:Ao("XSmall.lineHeight"),letterSpacing:Ao("XSmall.letterSpacing")}},Co=e=>{switch(e){case 700:case"bold":return Eo.Bold;case 600:case"semibold":return Eo.Semibold;case 300:case"light":return Eo.Light;case 400:case"regular":return Eo.Regular;default:return""}},Ho=(e,t)=>n=>{var r;const i=Po[e].fontFamily(n),o=Po[e].fontWeight(n);return Object.values(Eo).includes(i)?v`
        ...
        `},jo=e=>{switch(e){case 300:case"light":return 300;case 400:case"regular":return 400;case 600:case"semibold":return 600;case 700:case"bold":return 700;case 900:case"black":return 900;default:return""}},zo=e=>{if(e>0)return v`
            ...
            line-clamp: ${e};
            overflow: hidden;
        `},To=Ho,Mo=(e,t,n=!1)=>r=>{const i=Po[e],o=i.fontSize(r);return v`
            ${Ho(e,t)}
...
`,Wo=n=>{var{external:r=!1,children:i}=n,o=B(n,["external","children"]);return e(No,Object.assign({},o,{children:[i,r&&t(Lo,{})]}))};var qo;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(qo||(qo={}));const Qo=y.div`
...
`,Jo={collections:{base:{InputBoxShadow:v`
	...
	${e=>"small"===e.$buttonSizeStyle?v`
                ...
                `}
`,na=y((({color:n,className:r,size:i=18})=>e(Qo,Object.assign({className:r,$size:i,$color:n},{children:[t(Go,{id:"inner1",$size:i-2,$borderWidth:2}),t(Xo,{id:"inner2",$size:i-2,$borderWidth:2}),t(Zo,{id:"inner3",$size:i-2,$borderWidth:2}),t(Yo,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?ea.Button.Danger.Primary:Rt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Rt.Neutral[3](e);break;default:t=Rt.Neutral[8](e)}return v`
        ...
        `}}
`,ra={Default:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=n,c=B(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(ta,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:o},u,c,{children:[a&&t(na,Object.assign({},u)),t("span",{children:i})]}))})),Small:r.forwardRef(((n,r)=>{const{children:i,disabled:o=!1,loading:a=!1,styleType:s="default",danger:l=!1}=n,c=B(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:o?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(ta,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:o},u,c,{children:[a&&t(na,Object.assign({},u,{size:16})),t("span",{children:i})]}))}))},ia=y.li`
    width: 100%;
`,oa=y(ra.Default)`
    width: 100%;
    height: unset;
...
`,us=y.div`
    ...
    -webkit-box-orient: vertical;
    text-align: initial;
`,ds=y(Bo.ul)``,hs=y.li``,ps=y(ra.Default)`
    width: 100%;
    height: unset;
    justify-content: flex-start;
    border-radius: 0.5rem;
