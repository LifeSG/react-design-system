...
`,ps=y.div`
    ...
    -webkit-box-orient: vertical;
    text-align: initial;
`,fs=y(Io.ul)``,gs=y.li``,ms=y(aa.Default)`
    width: 100%;
    height: unset;
    justify-content: flex-start;
    border-radius: 0.5rem;
