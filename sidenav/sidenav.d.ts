...
export declare const Sidenav: (({ fixed, children, "aria-label": ariaLabel, ...otherProps }: SidenavProps) => import("react/jsx-runtime").JSX.Element) & {
    Group: ({ separator, children, ...otherProps }: import("./types").SidenavGroupProps) => import("react/jsx-runtime").JSX.Element;
    Item: ({ children, icon, title, onClick, selected, ...otherProps }: import("./types").SidenavItemProps) => import("react/jsx-runtime").JSX.Element;
