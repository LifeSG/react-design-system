...
export declare const DesktopDrawer: import("styled-components").StyledComponent<import("@react-spring/web").AnimatedComponent<"ul">, import("styled-components").DefaultTheme, DrawerStyleProps, never>;
export {};
