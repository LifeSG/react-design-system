...
`,Er=a(f)`
    ${Lr}
`,Nr="https://assets.life.gov.sg/react-design-system/img/app-icon/app-icon.png",jr="smart-app-banner";const Ar=i.forwardRef((function(e,i){const{className:a,show:o,href:l,content:c,offset:d=0,icon:s=Nr,animated:h=!1,onDismiss:g,onClick:f}=e,{title:u,message:p,buttonLabel:m,buttonAriaLabel:y,numberOfStars:S}=c,$=e=>{e.stopPropagation(),window.open(l,"_blank","noreferrer"),f?.()};return r(n,{children:o&&t(Sr,{ref:i,$isAnimated:h,$offset:d,className:a,children:[r($r,{onClick:g,id:`${jr}-dismiss`,"data-testid":`${jr}-dismiss-container`,children:r(vr,{"aria-label":"Dismiss",children:r(br,{})})}),t(Fr,{onClick:$,id:`${jr}-proceed`,"data-testid":`${jr}-proceed-container`,children:[r(Br,{src:s,alt:"lifesg-app-icon"}),t(Cr,{children:[r(Dr,{children:u}),r(xr,{children:p}),(()=>{if(isNaN(S)||S<0)return;const e=[],t=S-Math.floor(S)>=.4;for(let t=0;t<Math.floor(S);t++)e.push(r(zr,{},`star${t}`));if(t&&e.push(r(kr,{},"halfstar")),e.length<5){const t=5-e.length;for(let n=0;n<t;n++)e.push(r(Er,{},`emptystar${n}`))}return r(_r,{children:e.slice(0,5)})})()]}),r(Hr,{children:r(wr,{onClick:$,"aria-label":y,children:m})})]})]})})}));export{Ar as SmartAppBanner};
