...
`,sr=({external:e=!1,children:n,...i})=>t(cr,{...i,children:[n,e&&r(dr,{})]});var hr;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(hr||(hr={}));const gr=a.button`
	...
	${e=>"small"===e.$buttonSizeStyle?l`
                ...
                `}
`,ur=a((({color:e,className:n,size:i=18})=>t(Pt,{className:n,$size:i,$color:e,children:[r(Mt,{id:"inner1",$size:i-2,$borderWidth:2}),r(Xt,{id:"inner2",$size:i-2,$borderWidth:2}),r(Zt,{id:"inner3",$size:i-2,$borderWidth:2}),r(Gt,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Ot.Primary(e);break;case"disabled":t=Ot.Neutral[3](e);break;default:t=Ot.Neutral[8](e)}return l`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
        ...
        `}}
`,fr={Default:i.forwardRef(((e,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:l="default",...c}=e,d={$buttonStyle:a?"disabled":l,$buttonSizeStyle:"default"};return t(gr,{ref:n,"data-testid":c["data-testid"]||"button",disabled:a,...d,...c,children:[o&&r(ur,{...d}),r("span",{children:i})]})})),Small:i.forwardRef(((e,n)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:l="default",...c}=e,d={$buttonStyle:a?"disabled":l,$buttonSizeStyle:"small"};return t(gr,{ref:n,"data-testid":c["data-testid"]||"button",disabled:a,...d,...c,children:[o&&r(ur,{...d,size:16}),r("span",{children:i})]})}))},pr=a.button`
    display: flex;
    justify-content: center;
    align-items: center;
    padding: 1.5rem;
...
`,mr=i.forwardRef((({children:e,focusHighlight:t=!0,focusOutline:n="none",type:i="button",...a},o)=>r(pr,{ref:o,$outline:n,$highlight:t,type:i,...a,children:e}))),yr=o`
	from {
		opacity: 0;
...
`,Er=a(u)`
    ${Lr}
`,Nr="https://assets.life.gov.sg/react-design-system/img/app-icon/app-icon.png",jr="smart-app-banner";const Wr=i.forwardRef((function(e,i){const{className:a,show:o,href:l,content:c,offset:d=0,icon:s=Nr,animated:h=!1,onDismiss:g,onClick:u}=e,{title:f,message:p,buttonLabel:m,buttonAriaLabel:y,numberOfStars:S}=c,$=e=>{e.stopPropagation(),window.open(l,"_blank","noreferrer"),u?.()};return r(n,{children:o&&t(Sr,{ref:i,$isAnimated:h,$offset:d,className:a,children:[r($r,{onClick:g,id:`${jr}-dismiss`,"data-testid":`${jr}-dismiss-container`,children:r(vr,{"aria-label":"Dismiss",children:r(br,{})})}),t(Fr,{onClick:$,id:`${jr}-proceed`,"data-testid":`${jr}-proceed-container`,children:[r(Br,{src:s,alt:"lifesg-app-icon"}),t(Cr,{children:[r(xr,{children:f}),r(Dr,{children:p}),(()=>{if(isNaN(S)||S<0)return;const e=[],t=S-Math.floor(S)>=.4;for(let t=0;t<Math.floor(S);t++)e.push(r(zr,{},`star${t}`));if(t&&e.push(r(kr,{},"halfstar")),e.length<5){const t=5-e.length;for(let n=0;n<t;n++)e.push(r(Er,{},`emptystar${n}`))}return r(_r,{children:e.slice(0,5)})})()]}),r(Hr,{children:r(wr,{type:"button",onClick:$,"aria-label":y,children:m})})]})]})})}));export{Wr as SmartAppBanner};
