import { BaseColorSet, BookingSGColorSet } from "../spec/color";
import { IColorSet } from "../spec/types";
import { getValue } from "./theme-helper";
import { ColorScheme, ThemeContextKeys } from "./types";

// =============================================================================
// HELPER FUNCTIONS
// =============================================================================
const getThemeColors = (attributePath: string) => {
    return getValue(
        ColorMap,
        ThemeContextKeys.colorScheme,
        "base",
        attributePath
    );
};
