...
export const Backdrop = styled.div`
    ...
    left: 0;
    bottom: 0;
    background-color: ${V2_Color.Neutral[1]}D9;
    z-index: -1;
`;

export const LabelText = styled(V2_Text.BodySmall)<NavItemStyleProps>`
    margin: 0;
    ${(props) =>
        props.$isSelected &&
        css`
...
export const NavLabel = styled.div<NavLabelStyleProps>`
    ...
    padding: 12px 16px;
    box-shadow: 0px 0px 1px 1px ${V2_Color.Neutral[5]};
    overflow: hidden;
    border-radius: ${(props) =>
...
export const NavItem = styled.li<NavItemStyleProps>`
    ...
    background: ${(props) =>
        props.$isSelected ? V2_Color.Accent.Light[5] : V2_Color.Neutral[8]};
