...
export const PAColourSet: SemanticColourSet = {
    ...
    "text-primary": getPrimitiveColour("primary-10"),

    "text-hover": getPrimitiveColour("primary-70"),
    "text-selected": getPrimitiveColour("primary-20"),
    "text-selected-hover": getPrimitiveColour("primary-40"), // to be updated
    ...
    "text-error": getPrimitiveColour("brand-40"),
    ...
    "icon-strongest": getPrimitiveColour("neutral-10"), // to be updated
    ...
    "icon-selected-hover": getPrimitiveColour("primary-40"), // to be updated
    ...
    "icon-error-strong": getPrimitiveColour("error-40"), // to be updated
    ...
    "border-stronger": getPrimitiveColour("neutral-50"), // to be updated
    ...
    "border-selected-subtlest": getPrimitiveColour("neutral-60"),
    "border-selected-hover": getPrimitiveColour("primary-40"), // to be updated
    ...
    "border-error-focus": getPrimitiveColour("brand-30"),
    "border-error-focus-strong": getPrimitiveColour("error-40"), // to be updated
    "border-error-strong": getPrimitiveColour("error-40"), // to be updated
    "border-info": getPrimitiveColour("neutral-40"),

    // background
    bg: getPrimitiveColour("neutral-100"),
    "bg-strong": getPrimitiveColour("neutral-100"), // to be updated
    "bg-stronger": getPrimitiveColour("neutral-95"), // to be updated
    "bg-strongest": getPrimitiveColour("neutral-90"), // to be updated
    ...
    "bg-hover-neutral-strong": getPrimitiveColour("brand-90"), // to be updated
    ...
    "bg-selected-strongest": getPrimitiveColour("primary-50"), // to be updated
    "bg-selected-strongest-hover": getPrimitiveColour("primary-40"), // to be updated

    "bg-disabled": getPrimitiveColour("neutral-90"),
    "bg-selected-disabled": getPrimitiveColour("neutral-80"),
    "bg-selected-stronger-disabled": getPrimitiveColour("neutral-70"), // to be updated

    "bg-success": getPrimitiveColour("success-100"),
    "bg-success-hover": getPrimitiveColour("success-95"), // to be updated
    "bg-success-strong": getPrimitiveColour("success-50"), // to be updated
    "bg-success-strong-hover": getPrimitiveColour("success-40"), // to be updated
    "bg-warning": getPrimitiveColour("warning-100"),
    "bg-warning-hover": getPrimitiveColour("warning-95"), // to be updated
    "bg-warning-strong": getPrimitiveColour("warning-50"), // to be updated
    "bg-warning-strong-hover": getPrimitiveColour("warning-40"), // to be updated
    "bg-info": getPrimitiveColour("neutral-95"),
    "bg-info-hover": getPrimitiveColour("info-95"), // to be updated
    "bg-info-strong": getPrimitiveColour("info-50"), // to be updated
    "bg-info-strong-hover": getPrimitiveColour("info-40"), // to be updated
    "bg-error": getPrimitiveColour("brand-100"),
    "bg-error-hover": getPrimitiveColour("error-95"), // to be updated
    "bg-error-strong": getPrimitiveColour("error-50"), // to be updated
    "bg-error-strong-hover": getPrimitiveColour("error-40"), // to be updated

    "bg-inverse": getPrimitiveColour("neutral-40"),
    "bg-inverse-subtle": getPrimitiveColour("neutral-30"), // to be updated
    "bg-inverse-subtler": getPrimitiveColour("neutral-50"), // to be updated
    "bg-inverse-subtlest": getPrimitiveColour("neutral-60"), // to be updated
    "bg-inverse-hover": getPrimitiveColour("neutral-40"), // to be updated

    "bg-primary": getPrimitiveColour("brand-20"),
    "bg-primary-subtle": getPrimitiveColour("brand-60"),
    "bg-primary-subtler": getPrimitiveColour("primary-95"), // to be updated
    "bg-primary-subtlest": getPrimitiveColour("brand-100"),
    "bg-available": "#6DD0A1", // to be updated
    ...
    "hyperlink-hover": getPrimitiveColour("primary-40"), // to be updated
    "hyperlink-visited": getPrimitiveColour("primary-40"), // to be updated
