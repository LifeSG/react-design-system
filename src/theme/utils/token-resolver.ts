 ...
 */
export const toCssValue = (value: string | number) => {
 ...
 */
export const isTokenFromSet = <TToken extends string>(
    value: unknown,
    tokenSet: Set<string>
): value is TToken => {
    return typeof value === "string" && tokenSet.has(value);
};
 ...
 */
export const isTokenWithPrefix = <TToken extends string>(
    value: unknown,
    prefix: string
): value is TToken => {
 ...
 */
export const getTokenOrDefault = <TToken extends string>(
    value: unknown,
 ...
 */
export const getEffectiveTokenOrCustom = <TToken extends string, TCustom>({
    value,
    resolvedValue,
    guard,
    normalizeCustom,
    ...
    return guard(value)
        ? getResolvedValue(resolvedValue, value)
        : normalizeCustom(value);
};
