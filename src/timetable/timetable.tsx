...
export const TimeTable = forwardRef<TimeTableRef, TimeTableProps>(
    (
        {
            date,
            emptyContentMessage,
        ...
        const allRecordsLoaded =
            isEmptyContent || rowData.length === totalRecords;
        ...
        const getColorFromSequence = (() => {
            ...
            return () => {
                ...
                const alternateColor =
                    ROW_BAR_COLOR_ALTERNATE_COLOR[colorIndex];
