...
import { HeaderItemDocs, PropsTable, RowDocs } from "./props-table";
...
<PropTableTabs
    tabs={[
        {
            label: "DataTable",
            content: <Controls of={DataTableStories.Default} />,
        },
        {
            label: "HeaderItem",
            content: <ArgTypes of={HeaderItemDocs} />,
        },
        {
            label: "Row",
            content: <ArgTypes of={RowDocs} />,
        },
    ]}
/>
