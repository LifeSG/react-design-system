...
<Preview>
    <Story name="Insufficient Credit">
        <ErrorDisplay type="insufficient-credit" />
    </Story>
</Preview>
...
This is used to display when user’s payment transaction is unsuccessful.
