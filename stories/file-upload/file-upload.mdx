...
The component displays error states for individual files that fail to upload. Error messages are shown with an error icon and files can be removed. This example shows errors for both PDF and image files.

<Canvas of={FileUploadStories.WithFileErrors} />
