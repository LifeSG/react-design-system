...
import { PropsTable, FilterItemDocs, FilterPageDocs } from "./props-table";
...
<PropTableTabs
    tabs={[
        {
            label: "Filter",
            content: <Controls of={FilterStories.Default} />,
        },
        {
            label: "Filter.Item",
            content: <ArgsTable of={FilterItemDocs} />,
        },
        {
            label: "Filter.Page",
            content: <ArgsTable of={FilterPageDocs} />,
        },
    ]}
/>
