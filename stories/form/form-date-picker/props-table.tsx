...
const DATA: ApiTableSectionProps[] = [
    {
        name: "DatePicker specific props",
        attributes: [
            {
                name: "value",
                description: (
            ...
            },
            {
                ...
                description: (
                    <>
                        The value of the end date in string based format.&nbsp;
                        <code>YYYY-MM-DD</code>
                    </>
                ),
                propTypes: ["string"],
            ...
            {
                name: "type",
                description: "Single or range input variant",
                propTypes: ["string"],
            },
            {
                name: "hasButton",
                description: "Cancel/done button in calendar",
                propTypes: ["string"],
            },
            {
                name: "disabledDate",
