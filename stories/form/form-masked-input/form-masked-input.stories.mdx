...
<Meta title="Form/MaskedInput" component={Form.MaskedInput} />
    ...
    <Story name="Field">
        <StoryContainer>
            <Container>
                ...
                />
                <Form.MaskedInput
                    label="This is the mask field with uppercase input"
                    maskRange={[2, 5]}
                    transformInput={"uppercase"}
                />
                <Form.MaskedInput
                    label="This is the mask field with lowercase input"
                    maskRange={[2, 5]}
