...
<Canvas of={ImageButtonStories.Playground} />
<div className="controls-only">
    <Controls of={ImageButtonStories.Playground} />
</div>

## Variants

<Canvas of={ImageButtonStories.Variants} />
...
<AutoArgTypesTabs of={ImageButtonStories} />
