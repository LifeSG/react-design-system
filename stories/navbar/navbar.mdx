...
## Sub menu with grid layout

A sub menu can display links in a multi-column grid by setting `subMenuGridLayout` on the nav item.

<Canvas of={NavbarStories.SubMenuGrid} />
...
<AutoArgTypesTabs of={NavbarStories} />
