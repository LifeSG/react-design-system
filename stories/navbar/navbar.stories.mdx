                    ...
                    items={{
                                ...
                                subMenu: [
                                    {
                                        id: "guides1",
                                        children:
                                            "Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1",
                                        href: "https://www.life.gov.sg",
                                        onClick: () => {
                                            setSelected("guides1");
                                        },
                        ...
                        mobile: [
                            ...
                            },
                            {
                                ...
                                children: "Blog",
                                onClick: () => {
                                    setSelected("blog-mobile");
                                },
                                subMenu: [
                                    {
                                        id: "blogsg-mobile1",
                                        children:
                                            "Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1 Sub Blog 1",
                                        href: "https://www.life.gov.sg",
                                    },
                                    {
                                        id: "blogsg-mobile2",
