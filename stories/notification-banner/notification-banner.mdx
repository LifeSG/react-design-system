...
You can restrict the height of the `NotificationBanner` by setting the `maxCollapsedHeight` to a
desired value in px.
...
You can choose to render a custom component of your choice as an action button.

<Canvas of={NotificationBannerStories.ActionButton} />
