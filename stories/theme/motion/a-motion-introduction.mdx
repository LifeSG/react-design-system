...
[Default](/docs/foundations-motion-default--docs)
...
useApplyStyle(themeElementRef, {
    [Motion["duration-150"]]: "1s", // specify a custom time-based value
    [Motion["ease-default"]]: "steps(10, jump-both)", // specify a custom easing
});
```
