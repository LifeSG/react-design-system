import { AutoArgTypesTabs, Tabs } from "../storybook-common";
    ...
    tabs={[
        {
            ...
            component: (
                <div>
                    <Canvas of={TypographyStories.PlaygroundText} />
                    <div className="controls-only">
                        <Controls of={TypographyStories.PlaygroundText} />
                    </div>
                </div>
            ),
        },
        {
            ...
            component: (
                <div>
                    <Canvas of={TypographyStories.PlaygroundLink} />
                    <div className="controls-only">
                        <Controls of={TypographyStories.PlaygroundLink} />
                    </div>
                </div>
            ),
        },
...
Links use the underline text decoration style by default to ensure they are
visually identifiable. If you need to change the text decoration style, use the
`underlineStyle` prop on the link component.

## Component API

<AutoArgTypesTabs of={TypographyStories} />
