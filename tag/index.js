...
`,Pt=n=>{var{external:a=!1,children:r}=n,o=i(n,["external","children"]);return e(Wt,Object.assign({},o,{children:[r,a&&t(Tt,{})]}))};var Nt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Nt||(Nt={}));const Rt={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},jt=e=>Object.keys(Rt).reduce(((t,n)=>{const a=Rt[n];return t[n]=`@media screen and (${e}: ${a}px)`,t}),{}),It=jt("max-width"),Lt=(jt("min-width"),n.div`
    border-radius: 4px;
...
`),Jt=n.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,Gt=n=>{var{type:a,colorType:r="black",children:o,interactive:l=!1,icon:c,iconPosition:g="left"}=n,f=i(n,["type","colorType","children","interactive","icon","iconPosition"]);return e(Lt,Object.assign({as:l?"button":"div",$type:a,$color:r,$interactive:l},f,{children:["left"===g&&c,t(Jt,{children:o}),"right"===g&&c]}))};export{Gt as Tag};
