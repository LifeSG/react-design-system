...
`),Jt=n.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,Gt=n=>{var{type:a,colorType:r="black",children:o,interactive:l=!1,icon:c,iconPosition:g="left"}=n,d=i(n,["type","colorType","children","interactive","icon","iconPosition"]);return e(Lt,Object.assign({as:l?"button":"div",$type:a,$color:r,$interactive:l},d,{children:["left"===g&&c,t(Jt,{children:o}),"right"===g&&c]}))};export{Gt as Tag};
