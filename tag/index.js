...
`,Tt=n=>{var{external:r=!1,children:a}=n,o=i(n,["external","children"]);return e(wt,Object.assign({},o,{children:[a,r&&t(Ot,{})]}))};var Wt;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Wt||(Wt={}));const Vt={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},Nt=e=>Object.keys(Vt).reduce(((t,n)=>{const r=Vt[n];return t[n]=`@media screen and (${e}: ${r}px)`,t}),{}),jt=Nt("max-width"),Rt=(Nt("min-width"),n.div`
    border-radius: 4px;
...
`),It=n.div`
    ...
    -webkit-line-clamp: 2;
    text-align: left;
`,Lt=n=>{var{type:r,colorType:a="black",children:o,interactive:l=!1,icon:c}=n,d=i(n,["type","colorType","children","interactive","icon"]);return e(Rt,Object.assign({as:l?"button":"div",$type:r,$color:a,$interactive:l},d,{children:[c,t(It,{children:o})]}))};export{Lt as Tag};
