...
// UNIT TESTS
// =============================================================================
describe("DateRangeInput (fixed-range variant)", () => {
    beforeEach(() => {
        jest.resetAllMocks();
        jest.useFakeTimers({
    ...
    it("should render the field with calendar not shown by default", async () => {
        render(<DateRangeInput data-testid="e2e" variant="fixed-range" />);
    ...
    describe("with buttons", () => {
        it("should handle date selection by click", async () => {
            ...
            expect(screen.getByLabelText("End Date")).toHaveValue("21");
        ...
        it("should handle date selection by manual input", async () => {
            ...
            expect(screen.getByLabelText("End Date")).toHaveValue("07");
            expect(screen.getByLabelText("End Month")).toHaveValue("01");
            expect(screen.getByLabelText("End Year")).toHaveValue("2023");
            expect(mockOnChange).toHaveBeenCalledWith(
                "2023-01-01",
                "2023-01-07"
            );
