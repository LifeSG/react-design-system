import{css as o}from"styled-components";import{BorderValues as r}from"../border/theme-helper.js";import{ColourSemantic as t}from"../colour-semantic/theme-helper.js";const e=e=>n=>{var i,s,d;const{thickness:l,radius:u,colour:c}=e||{},a=null!==(i="function"==typeof l?l(n):l+"px")&&void 0!==i?i:r["width-010"](n),f=null!==(s="function"==typeof u?u(n):u+"px")&&void 0!==s?s:0,h=null!==(d="function"==typeof c?c(n):c)&&void 0!==d?d:t.border(n),p=r.solid;return o`
            border: ${a} ${p} ${h};
            border-radius: ${f};
