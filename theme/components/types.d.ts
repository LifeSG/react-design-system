...
export type NavbarTokens = {
    "navbar-full-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-full-logo-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-compressed-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-compressed-logo-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-mobile-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-mobile-logo-height": number | string | ((props: StyledComponentProps) => string);
    "navbar-colour-bg": string | ((props: StyledComponentProps) => string);
    "navbar-colour-icon": string | ((props: StyledComponentProps) => string);
    "navbar-link-colour-text": string | ((props: StyledComponentProps) => string);
    "navbar-link-colour-text-hover": string | ((props: StyledComponentProps) => string);
    "navbar-link-colour-text-selected-hover": string | ((props: StyledComponentProps) => string);
};
export type FooterTokens = {
    ...
    "footer-link-colour-text": string | ((props: StyledComponentProps) => string);
    "footer-link-colour-text-hover": string | ((props: StyledComponentProps) => string);
    "footer-disclaimer-link-colour-text": string | ((props: StyledComponentProps) => string);
    "footer-disclaimer-link-colour-text-hover": string | ((props: StyledComponentProps) => string);
};
