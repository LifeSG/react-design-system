...
export declare const THEME_TYPES: readonly ["a11y-playground", "bookingsg", "careercompass", "ccube", "imda", "lifesg", "mylegacy", "oneservice", "pa", "rbs", "sgw-digital-lobby", "smgs", "spf", "supportgowhere", "tote-board", "vica", "websg", "wise", "wogaa"];
...
export type FontSize = "heading-xxl" | "heading-xl" | "heading-lg" | "heading-md" | "heading-sm" | "heading-xs" | "body-baseline" | "body-md" | "body-sm" | "body-xs" | "form-label" | "form-description";
...
export type ComponentTokenCSSVariableString = ValueOf<typeof ComponentToken.Animation> | ValueOf<typeof ComponentToken.Button> | ValueOf<typeof ComponentToken.Footer> | ValueOf<typeof ComponentToken.Navbar>;
...
export type ColourCSSVariableString = PrimitiveColourCSSVariableString | SemanticColourCSSVariableString;
...
export type CSSVariableString = BreakpointCSSVariableString | BorderCSSVariableString | ColourCSSVariableString | ComponentTokenCSSVariableString | FontSpecCSSVariableString | MotionCSSVariableString | RadiusCSSVariableString | ShadowCSSVariableString | SpacingCSSVariableString;
