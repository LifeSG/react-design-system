...
`,ss=b((({color:e,className:r,size:i=18})=>t(Ea,{className:r,$size:i,$color:e,children:[n(Ta,{id:"inner1",$size:i-2,$borderWidth:2}),n(Na,{id:"inner2",$size:i-2,$borderWidth:2}),n(za,{id:"inner3",$size:i-2,$borderWidth:2}),n(Va,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
    ${e=>{let t;switch(e.$buttonStyle){case"secondary":case"light":case"link":t=Ba.Primary(e);break;case"disabled":t=Ba.Neutral[3](e);break;default:t=Ba.Neutral[8](e)}return $`
            #inner1,
            #inner2,
            #inner3,
            #inner4 {
...
`,cs=i.forwardRef((({children:e,focusHighlight:t=!0,focusOutline:r="none",...i},o)=>n(us,{ref:o,$outline:r,$highlight:t,...i,children:e}))),ds=b.div`
    position: relative;
    display: inline-flex;
    min-width: 10.375rem;
    border-radius: 4px;
    ...
    ${e=>"no-border"===e.$styleType?e.$error?$`
                        border-color: ${Ba.Validation.Red.Icon};
                        background: ${Ba.Neutral[8]};

                        :hover {
                            box-shadow: 0 0 4px 1px ${Ba.Shadow.Red};
                        }
                    `:e.$disabled?$`
                    ...
                    `:$`
                        ...
                        :hover {
                            background: ${Ba.Accent.Light[6]};
                        }
                    `:e.$disabled&&!e.$selected?$`
                        background: ${Ba.Neutral[6]};
                        border-color: ${Ba.Neutral[5]};
                    `:e.$disabled&&e.$selected?$`
                        background: ${Ba.Neutral[6]};
                        border-color: ${Ba.Neutral[4]};
                    `:e.$error?$`
                        background: ${Ba.Neutral[8]};
                        border-color: ${Ba.Validation.Red.Border};
                    ...
                    `:e.$selected?$`
                        ...
                        border-color: ${Ba.Primary};

                        :hover {
                            box-shadow: 0 0 4px 1px ${Ba.Shadow.Accent};
                        }
                    `:$`
                        background: ${Ba.Neutral[8]};
                        border-color: ${Ba.Neutral[5]};
                        ...
                        :hover {
                            box-shadow: 0 0 4px 1px ${Ba.Shadow.Accent};
                            border-color: ${Ba.Accent.Light[1]};
                        }
                    `}
`,hs=b.input`
    position: absolute;
...
`),$l=b.div`
    ...
    ${e=>e.$readOnly?$`
            ...
            `:e.$disabled?$`
                background: ${Ba.Neutral[6](e)} !important;
                :hover {
                    cursor: not-allowed;
                }
                :focus-within {
...
`,kl=b.input`
    ...
    :disabled {
        background: ${Ba.Neutral[6]} !important;
        :hover {
            cursor: not-allowed;
        }
    }
