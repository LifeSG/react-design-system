...
`,is=n=>{var{external:r=!1,children:i}=n,a=E(n,["external","children"]);return e(ns,Object.assign({},a,{children:[i,r&&t(rs,{})]}))};var as;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(as||(as={}));const os={collections:{base:{InputBoxShadow:v`
	...
	${e=>"small"===e.$buttonSizeStyle?v`
                ...
                `}
`,cs=y((({color:n,className:r,size:i=18})=>e(zo,Object.assign({className:r,$size:i,$color:n},{children:[t(No,{id:"inner1",$size:i-2,$borderWidth:2}),t(Ro,{id:"inner2",$size:i-2,$borderWidth:2}),t(Vo,{id:"inner3",$size:i-2,$borderWidth:2}),t(Lo,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,cl=y(Ys)`
    ...
    width: 100%;
    flex: 1;
`,dl=n=>{var{id:r,disabled:o=!1,error:s,value:l,format:u="24hr",readOnly:d,onChange:h,onFocus:f,onBlur:p}=n,g=E(n,["id","disabled","error","value","format","readOnly","onChange","onFocus","onBlur"]);const[m,y]=a(!1),[v,b]=a(!1),[w,$]=a(""),[S,x]=a(""),F=i();c((()=>{l&&($(l.start),x(l.end))}),[]),Rs("mousedown",(function(e){o||k(e)}),"document"),Rs("keyup",(function(e){if("Tab"===e.code)k(e)}),"document");const D=()=>{B()},_=()=>{m||v||f&&f()},B=()=>{y(!1),b(!1),p&&p()},k=e=>{F&&!F.current.contains(e.target)&&(v||m)&&B()};return t(ll,Object.assign({ref:F,id:r},g,{children:e(ul,Object.assign({$disabled:o,$error:s,$readOnly:d},{children:[e(Kt,Object.assign({error:s,currentActive:m?"start":v?"end":"none"},{children:[t(cl,{onFocus:()=>{o||d||m||(b(!1),y(!0),_())},readOnly:!0,placeholder:"From",value:Oo.formatDisplayValue(w,u),disabled:o,"data-testid":g["data-testid"]?`${g["data-testid"]}-timepicker-selector`:"timepicker-selector"}),t(cl,{onFocus:()=>{o||d||v||(y(!1),b(!0),_())},readOnly:!0,placeholder:"To",value:Oo.formatDisplayValue(S,u),disabled:o,"data-testid":g["data-testid"]?`${g["data-testid"]}-timepicker-selector`:"timepicker-selector"})]})),t(sl,{id:r,show:m,value:w,format:u,onCancel:D,onChange:e=>{y(!1),b(!0),$(e);h&&h({start:e,end:S})}}),t(sl,{id:r,show:v,value:S,format:u,onCancel:D,onChange:e=>{b(!1),x(e);h&&h({start:w,end:e}),""==w?y(!0):p&&p()}})]}))}))};export{dl as TimeRangePicker};
