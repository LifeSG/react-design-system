...
`,Bc=w(bc)`
    color: ${e=>e.$disabled?Pn["text-disabled"]:Pn["text-error"]};
`,Ac=w((({type:e,active:r=!1,disabled:n,className:o})=>{let i;switch(e){case"checkbox":i=t(r?L:j,{});break;case"radio":i=t(r?R:_,{});break;case"tick":i=t(P,{});break;case"cross":i=t(H,{});break;default:i=null}return t(uc,{className:o,$active:r,$disabled:n,"aria-hidden":!0,children:i})}))`
    ${e=>e.$disabled?e.$selected?$`
                    color: ${Pn["icon-selected-disabled"]};
                `:$`
                    color: ${Pn["icon-disabled-subtle"]};
...
`,Uc=w((n=>{var{type:o="checkbox",indicator:l,checked:d,styleType:c="default",children:u,childrenMaxLines:h,subLabel:g,disabled:m,error:p,name:b,id:y,className:v,compositeSection:x,removable:w,onRemove:$,"data-testid":F,onChange:C,useContentWidth:k,"aria-describedby":D}=n,I=ie(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","onRemove","data-testid","onChange","useContentWidth","aria-describedby"]);const{collapsible:T=!0,errors:B,children:A,initialExpanded:z}=x||{},[O,M]=a(d),[_,R]=a(!!z),H=f((()=>{const e=Array.isArray(B)&&(null==B?void 0:B.length)>0,t=!Array.isArray(B)&&!!B;return e||t}),[B]),[j]=a(Gd.generate()),L=y?`${y}`:`tg-${j}`,P=i(null);s((()=>{M(d)}),[d]),s((()=>{O&&R(null==z||z)}),[O]);const W=e=>{if(!m){if(C)return void C(e);switch(o){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":O||M(!0)}}},N=()=>{m||R(!_)},V=()=>{m||!$||$()},Y=()=>{let e;switch(o){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=o}return t(Ac,{type:e,active:O,disabled:m,$selected:O,$disabled:m})},U=()=>{if(!g)return null;let e;return e="function"==typeof g?g():g,t($c,{"data-id":"toggle-sublabel",id:`${L}-sublabel`,"aria-hidden":!0,children:e})},q=n=>e(r,{children:[t(Tc,{weight:"semibold",$disabled:m,children:"Error"}),t(Bc,{$disabled:m,children:null==n?void 0:n.map(((e,r)=>t("li",{id:`${L}-error-list-item-${r}`,children:t(Tc,{weight:"semibold",$disabled:m,children:e})},r)))})]});return e(yc,{$selected:O,$disabled:m,className:v,$styleType:c,$error:p,$indicator:l,$useContentWidth:k,id:y,"data-testid":F,children:[(()=>{const r=["string"==typeof g?`${L}-sublabel`:null,D].filter(Boolean).join(" ")||void 0;return e(Fc,{id:`${L}-header-container`,$disabled:m,$error:p,$selected:O,$indicator:l,$styleType:c,children:[e(Cc,{$addPadding:w,children:[t(vc,Object.assign({ref:P,name:b,id:`${L}-input`,type:"checkbox"===o?"checkbox":"radio","data-testid":"toggle-input",disabled:m,onChange:W,checked:O,"aria-describedby":r},I)),l&&Y(),e(xc,{$selected:O,$disabled:m,children:[t(wc,{htmlFor:`${L}-input`,"data-testid":`${L}-toggle-label`,$maxLines:h,children:u}),g&&U()]})]}),w&&t(Ec,{type:"button",$disabled:m,onClick:V,id:`${L}-remove-button`,children:"Remove"})]})})(),A&&e("div",{children:[(!T||_)&&t(Ic,{"data-id":"toggle-composite-children",$isFinalItem:!T,$disabled:m,children:A}),T&&!_&&H&&t(kc,{$disabled:m,onClick:N,id:`${L}-error-alert`,children:t(Dc,{type:m?"description":"error",className:v,showIcon:!0,children:Array.isArray(B)?q(B):B})}),T&&e(Sc,{$paddingTopRequired:!_&&!H,disabled:m,onClick:N,"data-testid":_?"collapse-button":"expand-button",children:[_?"Show less":"Show more",t(_?S:E,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,qc=w(Dd.Small)`
    width: 7rem;
