...
`,zc=$(yc)`
    color: ${e=>e.$disabled?Wn["text-disabled"]:Wn["text-error"]};
`,Mc=$((({type:e,active:r=!1,disabled:n,className:o})=>{let i;switch(e){case"checkbox":i=t(r?P:L,{});break;case"radio":i=t(r?H:R,{});break;case"tick":i=t(W,{});break;case"cross":i=t(j,{});break;default:i=null}return t(hc,{className:o,$active:r,$disabled:n,"aria-hidden":!0,children:i})}))`
    ${e=>e.$disabled?e.$selected?F`
                    color: ${Wn["icon-selected-disabled"]};
                `:F`
                    color: ${Wn["icon-disabled-subtle"]};
...
`,_c=o.forwardRef(((e,r)=>{var{children:n,focusHighlight:o=!0,focusOutline:i="none",type:s="button"}=e,a=se(e,["children","focusHighlight","focusOutline","type"]);return t(Oc,Object.assign({ref:r,$outline:i,$highlight:o,type:s},a,{children:n}))})),Rc=td($.div`
    position: absolute;
...
`,Gc=$((n=>{var{type:o="checkbox",indicator:l,checked:d,styleType:c="default",children:u,childrenMaxLines:h,subLabel:g,disabled:m,error:f,name:b,id:y,className:v,compositeSection:x,removable:w,onRemove:$,"data-testid":F,onChange:C,useContentWidth:E,"aria-describedby":D}=n,I=se(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","onRemove","data-testid","onChange","useContentWidth","aria-describedby"]);const{collapsible:T=!0,errors:B,children:A,initialExpanded:z}=x||{},[M,O]=a(d),[_,R]=a(!!z),H=p((()=>{const e=Array.isArray(B)&&(null==B?void 0:B.length)>0,t=!Array.isArray(B)&&!!B;return e||t}),[B]),[j]=a(qd.generate()),L=y?`${y}`:`tg-${j}`,P=i(null);s((()=>{O(d)}),[d]),s((()=>{M&&R(null==z||z)}),[M]);const W=e=>{if(!m){if(C)return void C(e);switch(o){case"checkbox":O((e=>!e));break;case"radio":case"yes":case"no":M||O(!0)}}},N=()=>{m||R(!_)},V=()=>{m||!$||$()},Y=()=>{var e;null===(e=null==P?void 0:P.current)||void 0===e||e.click()},U=e=>{e.stopPropagation()},q=()=>{let e;switch(o){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=o}return t(Mc,{type:e,active:M,disabled:m,$selected:M,$disabled:m})},G=()=>{if(!g)return null;let e;return e="function"==typeof g?g():g,t(Cc,{"data-id":"toggle-sublabel",id:`${L}-sublabel`,"aria-hidden":!0,children:e})},Z=n=>e(r,{children:[t(Ac,{weight:"semibold",$disabled:m,children:"Error"}),t(zc,{$disabled:m,children:null==n?void 0:n.map(((e,r)=>t("li",{id:`${L}-error-list-item-${r}`,children:t(Ac,{weight:"semibold",$disabled:m,children:e})},r)))})]});return e(vc,{$selected:M,$disabled:m,className:v,$styleType:c,$error:f,$indicator:l,$useContentWidth:E,id:y,"data-testid":F,children:[(()=>{const r=["string"==typeof g?`${L}-sublabel`:null,D].filter(Boolean).join(" ")||void 0;return e(Ec,{id:`${L}-header-container`,$disabled:m,$error:f,$selected:M,$indicator:l,$styleType:c,children:[t(Sc,{$addPadding:w,children:e(wc,{id:`${L}-input-container`,onClick:Y,children:[t(xc,Object.assign({ref:P,name:b,id:`${L}-input`,type:"checkbox"===o?"checkbox":"radio","data-testid":"toggle-input",disabled:m,onChange:W,onClick:U,checked:M,"aria-describedby":r},I)),l&&q(),e($c,{$selected:M,$disabled:m,children:[t(Fc,{htmlFor:`${L}-input`,"data-testid":"toggle-label",id:`${L}-label`,$maxLines:h,children:u}),g&&G()]})]})}),w&&t(kc,{type:"button",$disabled:m,onClick:V,id:`${L}-remove-button`,children:"Remove"})]})})(),A&&e("div",{children:[(!T||_)&&t(Bc,{"data-id":"toggle-composite-children",$isFinalItem:!T,$disabled:m,children:A}),T&&!_&&H&&t(Ic,{$disabled:m,onClick:N,id:`${L}-error-alert`,children:t(Tc,{type:m?"description":"error",className:v,showIcon:!0,children:Array.isArray(B)?Z(B):B})}),T&&e(Dc,{$paddingTopRequired:!_&&!H,disabled:m,onClick:N,"data-testid":_?"collapse-button":"expand-button",children:[_?"Show less":"Show more",t(_?k:S,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,Zc=$(Sd.Small)`
    width: 7rem;
