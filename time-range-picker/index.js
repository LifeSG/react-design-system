...
`,On=x.div`
    ...
    width: calc(
        50% - ${Dn["spacing-8"]} - (${En.Spec["body-size-baseline"]} / 2)
    );
    ...
    ${e=>{if(e.$wrap)return w`
                display: none;
            `}}
`,Rn=({children:r,currentActive:n,error:o,className:i,wrap:s})=>{const[a,l]=r;return e(An,{className:i,$wrap:s,children:[t(Mn,{"data-id":"range-container-elem1-container",children:a}),t(_n,{}),s&&t(zn,{}),t(Mn,{"data-id":"range-container-elem2-container",children:l}),t(On,{"data-id":"range-container-indicator",$position:n,$error:o,$wrap:s})]})},Hn=w`
    outline-offset: -1px;
...
`,Hl=({color:r,className:n,size:o})=>e(Al,{className:n,$size:o,$color:r,"data-testid":"component-loading-spinner",children:[t(Ml,{id:"inner1"}),t(_l,{id:"inner2"}),t(Ol,{id:"inner3"}),t(Rl,{id:"inner4"})]}),Ll={collections:{default:{Button:{"button-radius":xn.sm,"button-default-colour-bg":Zr["bg-primary"],"button-default-colour-bg-hover":Zr["bg-primary-hover"],"button-default-colour-text":Zr["text-inverse"],"button-secondary-colour-border":Zr["border-primary"],"button-secondary-colour-text":Zr["text-primary"],"button-light-colour-text":Zr["text-primary"],"button-link-colour-text":Zr["text-primary"]}},pa:{Button:{"button-radius":xn.full,"button-default-colour-bg":Zr["bg-primary"],"button-default-colour-bg-hover":Zr["bg-primary-hover"],"button-default-colour-text":Zr["text-inverse"],"button-secondary-colour-border":Zr["border-primary"],"button-secondary-colour-text":Zr["text-primary"],"button-light-colour-text":Zr["text-primary"],"button-link-colour-text":Zr["text-primary"]}}},defaultValue:"default"},jl=(e,t)=>r=>{var n,o;const i=r.theme,s=Hr(Ll,null==i?void 0:i.componentScheme);return Pl((null===(o=null===(n=null==i?void 0:i.componentOverrides)||void 0===n?void 0:n[e])||void 0===o?void 0:o[t])||s[e][t],r)},Pl=(e,t)=>{switch(typeof e){case"function":return e(t);case"number":return e+"px";case"string":return e}},Wl=jl("Button","button-radius"),Nl=jl("Button","button-default-colour-bg"),Vl=jl("Button","button-default-colour-bg-hover"),Yl=jl("Button","button-default-colour-text"),Ul=jl("Button","button-secondary-colour-border"),ql=jl("Button","button-secondary-colour-text"),Gl=jl("Button","button-light-colour-text"),Zl=jl("Button","button-link-colour-text"),Ql=x.button`
...
`;var Id;!function(r){const n=(e,t,r)=>{const n=x(e).attrs((({inline:e})=>({as:e?"span":void 0})))`
        ...
        `;return r.displayName=`Typography.${t}`,r};r.BodyBL=o("body-baseline","BodyBL"),r.BodyMD=o("body-md","BodyMD"),r.BodySM=o("body-sm","BodySM"),r.BodyXS=o("body-xs","BodyXS");const i=(r,n)=>{const o=x.a`
            ...
            `}
        `,i=r=>{var{external:n=!1,children:i}=r,s=oe(r,["external","children"]);return e(o,Object.assign({},s,{children:[i,n&&t(Td,{})]}))};return i.displayName=`Typography.${n}`,i};r.LinkBL=i("body-baseline","LinkBL"),r.LinkMD=i("body-md","LinkMD"),r.LinkSM=i("body-sm","LinkSM"),r.LinkXS=i("body-xs","LinkXS")}(Id||(Id={}));const Td=x(M)`
    height: 1lh;
    width: 1em;
    margin-left: 0.4em;
    vertical-align: middle;
...
`,oc=x(Vd)`
    color: ${e=>e.$disabled?Cn["text-disabled"]:Cn["text-error"]};
`,ic=x((({type:e,active:r=!1,disabled:n,className:o})=>{let i;switch(e){case"checkbox":i=t(r?L:H,{});break;case"radio":i=t(r?O:_,{});break;case"tick":i=t(j,{});break;case"cross":i=t(R,{});break;default:i=null}return t(Hd,{className:o,$active:r,$disabled:n,children:i})}))`
    ${e=>e.$disabled?e.$selected?w`
                    color: ${Cn["icon-selected-disabled"]};
                `:w`
                    color: ${Cn["icon-disabled-subtle"]};
...
`,dc=x.div`
    position: relative;
    width: 100%;
    padding: ${Dn["spacing-8"]} ${Dn["spacing-20"]}
        ${Dn["spacing-24"]} ${Dn["spacing-20"]};
    display: flex;
    flex-direction: column;
    background: ${Cn.bg};
    border: ${kn["width-010"]} ${kn.solid} ${Cn.border};
...
`,uc=x.div`
    display: flex;
    justify-content: flex-end;
    margin-top: ${Dn["spacing-16"]};
    gap: ${Dn["spacing-8"]} ${Dn["spacing-16"]};

    ${Bn.MaxWidth.xxs} {
        flex-direction: column-reverse; // FIXME: this breaks tab focus
        margin-top: ${Dn["spacing-32"]};
    }
`,hc=x.div`
    display: flex;
    align-items: center;
    margin-right: ${Dn["spacing-32"]};
...
`,yc=x((({type:n="checkbox",indicator:o,checked:l,styleType:d="default",children:c,childrenMaxLines:u,subLabel:h,disabled:g,error:m,name:f,id:b,className:v,compositeSection:y,removable:x,onRemove:w,"data-testid":$,onChange:F,useContentWidth:S})=>{const{collapsible:k=!0,errors:D,children:I,initialExpanded:T}=y||{},[B,A]=a(l),[z,M]=a(!!T),_=p((()=>{const e=Array.isArray(D)&&(null==D?void 0:D.length)>0,t=!Array.isArray(D)&&!!D;return e||t}),[D]),[O]=a(wd.generate()),R=b?`${b}`:`tg-${O}`,H=i(null);s((()=>{A(l)}),[l]),s((()=>{B&&M(null==T||T)}),[B]);const L=()=>{g||M(!z)},j=()=>{g||!w||w()},P=()=>{let e;switch(n){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=n}return t(ic,{type:e,active:B,disabled:g,$selected:B,$disabled:g})},W=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,t(Zd,{"data-id":"toggle-sublabel",children:e})},N=n=>e(r,{children:[t(nc,{weight:"semibold",$disabled:g,children:"Error"}),t(oc,{$disabled:g,children:null==n?void 0:n.map(((e,r)=>t("li",{id:`${R}-error-list-item-${r}`,children:t(nc,{weight:"semibold",$disabled:g,children:e})},r)))})]});return e(Yd,{$selected:B,$disabled:g,className:v,$styleType:d,$error:m,$indicator:o,$useContentWidth:S,id:b,"data-testid":$,children:[e(Qd,{id:`${R}-header-container`,$disabled:g,$error:m,$selected:B,$indicator:o,$styleType:d,children:[e(Xd,{$addPadding:x,children:[t(Ud,{ref:H,name:f,id:`${R}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:g,onChange:e=>{if(!g){if(F)return void F(e);switch(n){case"checkbox":A((e=>!e));break;case"radio":case"yes":case"no":B||A(!0)}}},checked:B}),o&&P(),e(qd,{$selected:B,$disabled:g,children:[t(Gd,{htmlFor:`${R}-input`,"data-testid":`${R}-toggle-label`,$maxLines:u,children:c}),h&&W()]})]}),x&&t(Kd,{type:"button",$disabled:g,onClick:j,id:`${R}-remove-button`,children:"Remove"})]}),I&&e("div",{children:[(!k||z)&&t(rc,{"data-id":"toggle-composite-children",$isFinalItem:!k,$disabled:g,children:I}),k&&!z&&_&&t(ec,{$disabled:g,onClick:L,id:`${R}-error-alert`,children:t(tc,{type:g?"description":"error",className:v,showIcon:!0,children:Array.isArray(D)?N(D):D})}),k&&e(Jd,{$paddingTopRequired:!z&&!_,disabled:g,onClick:L,"data-testid":z?"collapse-button":"expand-button",children:[z?"Show less":"Show more",t(z?E:C,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,xc=x(td.Small)`
    width: 7rem;
...
`,x(Vn)`
    ...
    ${e=>"no-border"!==e.$styleType&&w`
            padding-left: ${Dn["spacing-16"]};
            padding-right: ${e.$showClear?0:Dn["spacing-16"]};
        `}
`;const kc=x(Yn)`
    height: auto;
...
`;const Mc=x(kc)`
    position: absolute;
    right: 0;
    padding-left: ${Dn["spacing-8"]};
    margin-right: 0;
`;x(Bc)`
    // space for clear icon
    padding-right: calc(1.25rem + ${Dn["spacing-16"]});
`;const _c=x.div`
...
`,lv=x.li`
    ...
    align-items: flex-start;
    gap: ${Dn["spacing-8"]};
    padding: ${Dn["spacing-12"]} ${Dn["spacing-8"]};
    cursor: pointer;
...
`,bv=x(fv)`
    ${En["body-md-semibold"]}
    padding: ${Dn["spacing-8"]} ${Dn["spacing-8"]};
`,vv=x.div`
    width: 100%;
    display: flex;
    padding: ${Dn["spacing-12"]} ${Dn["spacing-16"]};
...
`,wv=x.div`
    ${Cd()}
    color: ${Cn["text-subtle"]};
    padding: 0 ${Dn["spacing-16"]} ${Dn["spacing-12"]}
        ${Dn["spacing-16"]};
`,$v=x.div`
...
`,Fv=x.label`
    ...
    padding: ${e=>"small"===e.$variant?w`
                  ${Dn["spacing-8"]} ${Dn["spacing-16"]}
              `:w`10px ${Dn["spacing-16"]}`};
`,Cv=x(Vn)`
    flex: 1;
`,Ev=x(W)`
    color: ${Cn.icon};
...
`,kv=g(((r,n)=>{var{value:o,variant:i,onClear:s}=r,a=oe(r,["value","variant","onClear"]);return e($v,{$variant:i,children:[e(Fv,{$variant:i,children:[t(Ev,{"aria-hidden":!0}),t(Cv,Object.assign({ref:n,value:o,$variant:i},a))]}),o&&t(Sv,{"aria-label":"Clear search",focusOutline:"browser",onClick:s,children:t(R,{"aria-hidden":!0})})]})})),Dv=({listItems:n,multiSelect:o,maxSelectable:l,selectedItems:d,disableItemFocus:c,itemsLoadState:u="success",itemTruncationType:h="end",itemMaxLines:g=2,labelDisplayType:p="inline",variant:b="default",listboxId:v,width:y,topScrollItem:x,onSelectItem:w,onSelectAll:$,onDismiss:F,onRetry:C,valueExtractor:E,listExtractor:S,renderListItem:k,renderCustomCallToAction:D,enableSearch:I,hideNoResultsDisplay:T,noResultsDescription:B,searchPlaceholder:A="Search",searchFunction:z,onSearch:M})=>{const{focusedIndex:_,setFocusedIndex:O}=f(nv),[R,H]=a(""),[L,j]=a(null!=n?n:[]),P=Fd(u),W=(()=>{const[e,t]=a(!1);return s((()=>{t(!0)}),[]),e})(),N=i(null),V=i(null),Y=i([]),U=i(null),q=i(null),G=!!l&&!!d&&(null==d?void 0:d.length)===l,Z=e=>{const t=S?S(e):null==e?void 0:e.toString();return"object"==typeof t?{title:t.title,secondaryLabel:t.secondaryLabel}:{title:null!=t?t:""}},Q=m((e=>!!ym(d,(t=>wm(t,e)))),[d]),X=$d((()=>null==z?void 0:z(R))),K=$d((()=>null==n?void 0:n.filter((e=>{const{title:t,secondaryLabel:r}=Z(e),n=R.trim().toLowerCase();return t.toLowerCase().includes(n)||r&&r.toLowerCase().includes(n)})))),J=(e,t)=>{G&&!Q(e)||(O(t),null==w||w(e,(e=>E?E(e):e)(e)))},ee=e=>{const t=e.target.value;H(t),null==M||M()},te=()=>{var e;H(""),null===(e=U.current)||void 0===e||e.focus(),null==M||M()},re=()=>{null==C||C()};ie("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),_<L.length-1){const e=_+1;null===(t=Y.current[e])||void 0===t||t.focus(),O(e)}break;case"ArrowUp":if(e.preventDefault(),_>0){const e=_-1;null===(r=Y.current[e])||void 0===r||r.focus(),O(e)}else 0===_&&U.current&&(U.current.focus(),O(-1));break;case"Space":case"Enter":document.activeElement===Y.current[_]&&(e.preventDefault(),L[_]&&J(L[_],_))}})),s((()=>{var e;if(!x)return void(null===(e=q.current)||void 0===e||e.scrollTo({top:0}));const t=setTimeout((()=>{if(!n)return;const e=n.indexOf(x);q.current&&-1!==e&&(q.current.scrollToIndex({index:e}),O(e))}),0);return()=>clearTimeout(t)}),[Y,n,O,x]),s((()=>{var e,t,r;if(W)return;if(c||!n)return;const o=n.findIndex((e=>Q(e)));U.current?(O(-1),setTimeout((()=>{var e;return null===(e=U.current)||void 0===e?void 0:e.focus()}),200)):_>0?(null===(e=q.current)||void 0===e||e.scrollToIndex({index:_,align:"center"}),setTimeout((()=>{var e;return null===(e=Y.current[_])||void 0===e?void 0:e.focus()}),200)):-1!==o?(null===(t=q.current)||void 0===t||t.scrollToIndex({index:o,align:"center"}),O(o),setTimeout((()=>{var e;return null===(e=Y.current[o])||void 0===e?void 0:e.focus()}),200)):(null===(r=q.current)||void 0===r||r.scrollToIndex({index:0}),O(0),setTimeout((()=>{var e;return null===(e=Y.current[0])||void 0===e?void 0:e.focus()}),200))}),[Q,c,_,n,W,O]),s((()=>{W&&P&&(c||"success"===u&&U.current&&(O(-1),U.current.focus()))}),[W,P,u,O,c]),s((()=>{var e;j(null!==(e=""===R?n:z?X():K())&&void 0!==e?e:[])}),[X,K,n,z,R]);const ne=e=>o?t(G&&!e?gv:e?uv:hv,{"aria-hidden":!0}):e?t(dv,{"aria-hidden":!0}):t(cv,{}),oe=(e,r)=>{const{title:n,secondaryLabel:o}=Z(e);return t(Pc,{displayType:p,label:n,maxLines:g,selected:r,disabled:!r&&G,sublabel:o,truncationType:h,variant:b})},se=(n,i)=>{if(!C||"success"===u){const s=Q(n),a=i===_;return t(lv,{"aria-selected":s,"aria-multiselectable":o,"aria-disabled":!s&&G,"data-testid":"list-item",onClick:()=>J(n,i),onMouseEnter:()=>(e=>{O(e)})(i),ref:e=>{Y.current[i]=e},role:"option",tabIndex:a?0:-1,$active:a,$selected:s,$disabled:!s&&G,children:k?k(n,{selected:s}):e(r,{children:[ne(s),oe(n,s)]})},((e,t)=>`item_${t}__${E?E(e):e}`)(n,i))}},ae=()=>{if(d&&o&&L.length>0&&!R&&"success"===u)return t(mv,{children:t(bv,{onClick:$,type:"button",$variant:b,children:l||0!==d.length?"Clear all":"Select all"})})},le=()=>{if(!T&&(R||!I)&&0===L.length&&"success"===u)return e(r,{children:[e(vv,{"data-testid":"list-no-results",children:[t(yv,{"data-testid":"no-result-icon"}),"No results found."]}),B&&t(wv,{"data-testid":"no-result-desc",children:B})]})},de=()=>{if(C&&"loading"===u)return e(vv,{"data-testid":"list-loading",children:[t(xv,{}),"Loading..."]})},ce=()=>{if(C&&"fail"===u)return e(vv,{"data-testid":"list-fail",children:[t(yv,{"data-testid":"load-error-icon"}),"Failed to load. ",t(pv,{onClick:re,type:"button",$variant:b,children:"Try again."})]})},ue=()=>{var e;const r="test"===process.env.NODE_ENV;return t(av,{role:"listbox",id:v,children:t(kb,Object.assign({ref:q,style:{height:"100%"},data:L,customScrollParent:null!==(e=N.current)&&void 0!==e?e:void 0,itemContent:(e,t)=>se(t,e)},r?{initialItemCount:L.length}:{}),r?L.length:void 0)})};return e(iv,{"data-testid":"dropdown-container",ref:N,$width:y,$variant:b,children:[e(sv,{ref:V,"data-testid":"dropdown-list",children:[(()=>{if((I||z)&&"success"===u)return t(kv,{ref:U,onChange:ee,value:R,placeholder:A,"data-testid":"search-input","aria-label":"Enter text to search",onClear:te,variant:b})})(),ae(),le(),de(),ce(),ue()]}),(()=>{if(D)return t("div",{"data-testid":"custom-cta",children:D(F,L)})})()]})},Iv=x(Yn)`
    display: flex;
    align-items: center;
    gap: ${Dn["spacing-8"]};
    width: 100%;
    height: calc(3rem - 2px); // exclude top and bottom borders
    padding: ${Dn["spacing-16"]};
...
`;var Bv;g((({children:r,disabled:n,expanded:o,listboxId:i,popupRole:s,readOnly:a,variant:l},d)=>e(Iv,{ref:d,type:"button","aria-expanded":o,"aria-haspopup":s,"data-testid":"selector",disabled:n,"aria-controls":i,$variant:l,children:[r,!a&&t(Tv,{$expanded:o,$variant:l,children:t(C,{"aria-hidden":!0})})]}))),x.li`
...
`,x.div`
    height: 1px;
    width: calc((1lh + ${Dn["spacing-8"]}) * ${e=>e.$level});
`,x.div`
    width: 1lh;
    height: 1lh;
    color: ${Cn["icon-primary"]};
...
`,x.div`
    flex-shrink: 0;
    height: 1lh;
    width: ${e=>e.$hasNestedSiblings?"1lh":Dn["spacing-16"]};
...
`,x(N)`
    ...
    width: 1lh;
    color: ${Cn["icon-selected"]};
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}(Bv||(Bv={}));const Av=x.div`
    display: flex;
    flex-direction: column;
`,zv=e=>"right"===e?"bottom-end":"bottom-start",Mv=({enabled:n,isOpen:o,onOpen:l,onClose:d,onDismiss:c,renderElement:u,renderDropdown:h,customZIndex:g,clickToToggle:m=!1,offset:f=0,alignment:p="left",fitAvailableHeight:b,rootNode:v})=>{var y;const x=F(),w=Tn["sm-max"]({theme:x}),$=i(null),C=i(null),{width:E=0}=Jo({targetRef:$,handleHeight:!1}),S={name:"center",fn:({x:e,rects:t})=>{const r=0===e||e+t.floating.width===window.innerWidth,n=window.innerWidth<w;return{x:r&&n?(window.innerWidth-t.floating.width)/2:e}}},{refs:k,floatingStyles:D,context:I}=Y({open:o,onOpenChange:(e,t,r)=>{"escape-key"===r?null==c||c():e&&!o?null==l||l():!e&&o&&(null==d||d(r))},whileElementsMounted:U,placement:zv(p),middleware:[q(f),G(),Z({limiter:Q()}),X({apply({availableHeight:e}){C.current&&Object.assign(C.current.style,{maxHeight:b?`${e}px`:void 0,overflowY:b?"hidden":void 0})}}),S]}),T=(()=>{const[e,t]=a(void 0),r=V();return s((()=>{if(!r)return void t(void 0);const e=e=>{t(e.zIndex)};return r.events.on(Bv.Change,e),r.events.emit(Bv.Ready),()=>r.events.off(Bv.Change,e)}),[r]),e})(),{isMounted:B,styles:A}=K(I,{initial:{opacity:0},open:{opacity:1},duration:300}),z=J(I,{enabled:n,toggle:m}),M=ee(I,{enabled:n}),{getReferenceProps:_,getFloatingProps:O}=te([z,M]);return e(r,{children:[t("div",Object.assign({ref:e=>{$.current=e,k.setReference(e)}},_(),{children:u()})),B&&t(re,{root:v,children:t(ne,{context:I,modal:!1,initialFocus:C,returnFocus:!1,children:t("div",Object.assign({ref:k.setFloating,style:Object.assign(Object.assign({},D),{zIndex:null!==(y=null!=g?g:T)&&void 0!==y?y:50})},O(),{children:t(Av,{ref:C,style:Object.assign({},A),inert:A.opacity<1?"":void 0,children:h({elementWidth:E})})}))})})]})},_v=x(Nn)`
    height: 3rem;
    gap: ${Dn["spacing-8"]};
    // space for clear icon
    padding-right: calc(1.25rem + ${Dn["spacing-20"]});
`,Ov=r=>{var{id:n,disabled:o=!1,error:l,value:d,format:c="12hr",readOnly:u,onChange:h,onFocus:g,onBlur:f,alignment:b="left",dropdownZIndex:v,startLimit:y,endLimit:x,interval:w=15}=r,$=oe(r,["id","disabled","error","value","format","readOnly","onChange","onFocus","onBlur","alignment","dropdownZIndex","startLimit","endLimit","interval"]);const[F]=a((()=>wd.generate())),[C,E]=a(null),[S,k]=a(!1),[D,I]=a(""),[T,B]=a(""),[A,z]=a(""),[M,_]=a(""),[O,R]=a(""),H=i(null),L=i(null),j=i(null),P=p((()=>Kn.generateTimings(w,c,y,x)),[w,c,y,x]),W=p((()=>{if(""===M)return P;const e=Kn.findClosestFlooredTime(M,P);return e?P.slice(P.indexOf(e)):[]}),[P,M]),N=m((e=>Kn.parseInput(e,c)),[c]);s((()=>{var e,t;if(d){const r=null!==(e=N(d.start))&&void 0!==e?e:"",n=null!==(t=N(d.end))&&void 0!==t?t:"";B(r),z(n),_(r),R(n)}}),[d,N]),s((()=>{if(l)return void k(!1);const e=N(T),t=N(A);if(void 0===e)I("Invalid start time");else if(void 0===t)I("Invalid end time");else{if(!(""!==e&&""!==t&&Kn.to24Hour(t)<Kn.to24Hour(e)))return I(""),void(document.activeElement!==L.current&&document.activeElement!==j.current||k(!0));I("End time must be after start time")}k(!1)}),[T,A,N,l]);const V=e=>{o||u||(C||S||null==g||g(),E(e),k(!0))},Y=e=>{var t;o||u||(E(e),k(!0),null===(t=("start"===e?L:j).current)||void 0===t||t.select())};function U(e){var t;switch(e.code){case"Enter":"start"===C?q(T):"end"===C&&(S&&G(A),null===(t=j.current)||void 0===t||t.blur());break;case"Tab":Z(T,A,{})}}const q=e=>{Z(e,A,{goToNextInput:!0})},G=e=>{Z(T,e,{triggerOnBlur:!0})},Z=(e,t,{goToNextInput:r,triggerOnBlur:n})=>{var o,i,s;const a=null!==(o=N(e))&&void 0!==o?o:M,l=null!==(i=N(t))&&void 0!==i?i:O;B(a),z(l);a===M&&l===O||null==h||h({start:a,end:l}),r&&void 0!==N(e)&&(E("end"),null===(s=j.current)||void 0===s||s.select()),n&&(E(null),k(!1),null==f||f()),_(a),R(l)},Q=e=>{e.stopPropagation(),B(""),z(""),_(""),R("");null==h||h({start:"",end:""}),E(null),k(!1)},X=e=>{H.current&&!H.current.contains(e.relatedTarget)&&C&&!S&&Z(T,A,{triggerOnBlur:!0})},K=()=>{if(!u&&!o&&((null==T?void 0:T.length)>0||(null==A?void 0:A.length)>0))return t(Mc,{onClick:Q,type:"button","aria-label":"Clear",children:t(Dc,{"aria-hidden":!0})})};return e(Un,Object.assign({id:n},$,{children:[t(ov,{children:t(Mv,{enabled:!u&&!o,isOpen:S,renderElement:()=>e(_v,{ref:H,$disabled:o,$error:l||!!D,$readOnly:u,onBlur:X,children:[e(Rn,{error:l||!!D,currentActive:null===C?"none":C,children:[t(Gn,{ref:L,onFocus:()=>V("start"),placeholder:"start"===C?"hh:mm":"From",onChange:e=>B(e.target.value),value:T,disabled:o,readOnly:u,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("start"),onKeyDown:U,autoComplete:"off","aria-label":"Start time input",type:"text",role:"combobox","aria-expanded":S,"aria-controls":F,"aria-autocomplete":"list"}),t(Gn,{ref:j,onFocus:()=>V("end"),placeholder:"end"===C?"hh:mm":"To",onChange:e=>z(e.target.value),value:A,disabled:o,readOnly:u,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("end"),onKeyDown:U,autoComplete:"off","aria-label":"End time input",type:"text",role:"combobox","aria-expanded":S,"aria-controls":F,"aria-autocomplete":"list"})]}),K()]}),renderDropdown:()=>{if(S)return t(Dv,"start"===C?{listItems:P,onSelectItem:q,selectedItems:[T],disableItemFocus:!0,topScrollItem:Kn.findClosestFlooredTime(N(T),P),listboxId:F}:{listItems:W,onSelectItem:G,selectedItems:[A],disableItemFocus:!0,topScrollItem:Kn.findClosestFlooredTime(N(A),W),listboxId:F})},onClose:e=>{"outside-press"===e?(E(null),k(!1),null==f||f()):Z(T,A,{triggerOnBlur:!0})},onDismiss:()=>{var e;null===(e=("start"===C?L:j).current)||void 0===e||e.focus(),k(!1)},offset:8,alignment:b,fitAvailableHeight:!0,customZIndex:v})}),!l&&D&&t(Sc,{id:n?`${n}-error-message`:"error-message",tabIndex:0,"data-testid":n?`${n}-error-message`:"error-message",children:D})]}))},Rv=e=>{var{variant:r="dial"}=e,n=oe(e,["variant"]);return t("combobox"===r?Ov:Ec,Object.assign({},n))};export{Rv as TimeRangePicker};
