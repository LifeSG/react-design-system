...
`,_n=x.div`
    ...
    ${e=>{if(e.$wrap)return w`
                display: none;
            `}}
`,On=({children:r,currentActive:n,error:o,className:i,wrap:s})=>{const[a,l]=r;return e(zn,{className:i,$wrap:s,children:[t(Bn,{"data-id":"range-container-elem1-container",children:a}),t(An,{}),s&&t(Mn,{}),t(Bn,{"data-id":"range-container-elem2-container",children:l}),t(_n,{"data-id":"range-container-indicator",$position:n,$error:o,$wrap:s})]})},Hn=w`
    outline-offset: -1px;
...
`,Rl=({color:r,className:n,size:o})=>e(Ml,{className:n,$size:o,$color:r,"data-testid":"component-loading-spinner",children:[t(Al,{id:"inner1"}),t(_l,{id:"inner2"}),t(Ol,{id:"inner3"}),t(Hl,{id:"inner4"})]}),jl=x.button`
...
`,qd=x(Bd)`
    color: ${e=>e.$disabled?Fn["text-disabled"]:Fn["text-error"]};
`,Gd=x((({type:e,active:r=!1,disabled:n,className:o})=>{let i;switch(e){case"checkbox":i=t(r?j:R,{});break;case"radio":i=t(r?O:_,{});break;case"tick":i=t(L,{});break;case"cross":i=t(H,{});break;default:i=null}return t(kd,{className:o,$active:r,$disabled:n,children:i})}))`
    ${e=>e.$disabled?e.$selected?w`
                    color: ${Fn["icon-selected-disabled"]};
                `:w`
                    color: ${Fn["icon-disabled-subtle"]};
...
`,lc=x((({type:n="checkbox",indicator:o,checked:l,styleType:d="default",children:c,childrenMaxLines:u,subLabel:h,disabled:g,error:m,name:f,id:b,className:v,compositeSection:y,removable:x,onRemove:w,"data-testid":$,onChange:F,useContentWidth:S})=>{const{collapsible:k=!0,errors:I,children:T,initialExpanded:D}=y||{},[z,M]=a(l),[B,A]=a(!!D),_=p((()=>{const e=Array.isArray(I)&&(null==I?void 0:I.length)>0,t=!Array.isArray(I)&&!!I;return e||t}),[I]),[O]=a(cd.generate()),H=b?`${b}`:`tg-${O}`,R=i(null);s((()=>{M(l)}),[l]),s((()=>{z&&A(null==D||D)}),[z]);const j=()=>{g||A(!B)},L=()=>{g||!w||w()},P=()=>{let e;switch(n){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=n}return t(Gd,{type:e,active:z,disabled:g,$selected:z,$disabled:g})},W=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,t(Rd,{"data-id":"toggle-sublabel",children:e})},V=n=>e(r,{children:[t(Ud,{weight:"semibold",$disabled:g,children:"Error"}),t(qd,{$disabled:g,children:null==n?void 0:n.map(((e,r)=>t("li",{id:`${H}-error-list-item-${r}`,children:t(Ud,{weight:"semibold",$disabled:g,children:e})},r)))})]});return e(Ad,{$selected:z,$disabled:g,className:v,$styleType:d,$error:m,$indicator:o,$useContentWidth:S,id:b,"data-testid":$,children:[e(jd,{id:`${H}-header-container`,$disabled:g,$error:m,$selected:z,$indicator:o,$styleType:d,children:[e(Ld,{$addPadding:x,children:[t(_d,{ref:R,name:f,id:`${H}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:g,onChange:e=>{if(!g){if(F)return void F(e);switch(n){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":z||M(!0)}}},checked:z}),o&&P(),e(Od,{$selected:z,$disabled:g,children:[t(Hd,{htmlFor:`${H}-input`,"data-testid":`${H}-toggle-label`,$maxLines:u,children:c}),h&&W()]})]}),x&&t(Pd,{type:"button",$disabled:g,onClick:L,id:`${H}-remove-button`,children:"Remove"})]}),T&&e("div",{children:[(!k||B)&&t(Yd,{"data-id":"toggle-composite-children",$isFinalItem:!k,$disabled:g,children:T}),k&&!B&&_&&t(Vd,{$disabled:g,onClick:j,id:`${H}-error-alert`,children:t(Nd,{type:g?"description":"error",className:v,showIcon:!0,children:Array.isArray(I)?V(I):I})}),k&&e(Wd,{$paddingTopRequired:!B&&!_,disabled:g,onClick:j,"data-testid":B?"collapse-button":"expand-button",children:[B?"Show less":"Show more",t(B?E:C,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,dc=x(Nl.Small)`
    width: 7rem;
...
`,vv=g(((r,n)=>{var{value:o,variant:i,onClear:s}=r,a=ne(r,["value","variant","onClear"]);return e(gv,{$variant:i,children:[e(mv,{$variant:i,children:[t(pv,{"aria-hidden":!0}),t(fv,Object.assign({ref:n,value:o,$variant:i},a))]}),o&&t(bv,{"aria-label":"Clear search",focusOutline:"browser",onClick:s,children:t(H,{"aria-hidden":!0})})]})})),yv=({listItems:n,multiSelect:o,selectedItems:l,disableItemFocus:d,itemsLoadState:c="success",itemTruncationType:u="end",itemMaxLines:h=2,labelDisplayType:g="inline",variant:p="default",listboxId:b,width:v,topScrollItem:y,onSelectItem:x,onSelectAll:w,onDismiss:$,onRetry:F,valueExtractor:C,listExtractor:E,renderListItem:S,renderCustomCallToAction:k,enableSearch:I,hideNoResultsDisplay:T,searchPlaceholder:D="Search",searchFunction:z,onSearch:M})=>{const{focusedIndex:B,setFocusedIndex:A}=f(Qb),[_,O]=a(""),[H,R]=a(null!=n?n:[]),j=hd(c),L=(()=>{const[e,t]=a(!1);return s((()=>{t(!0)}),[]),e})(),P=i(null),W=i(null),V=i([]),N=i(null),Y=i(null),U=e=>{const t=E?E(e):null==e?void 0:e.toString();return"object"==typeof t?{title:t.title,secondaryLabel:t.secondaryLabel}:{title:null!=t?t:""}},q=m((e=>!!lm(l,(t=>cm(t,e)))),[l]),G=ud((()=>null==z?void 0:z(_))),Z=ud((()=>null==n?void 0:n.filter((e=>{const{title:t,secondaryLabel:r}=U(e),n=_.trim().toLowerCase();return t.includes(n)||r&&r.includes(n)})))),Q=(e,t)=>{A(t),null==x||x(e,(e=>C?C(e):e)(e))},X=e=>{const t=e.target.value;O(t),null==M||M()},K=()=>{var e;O(""),null===(e=N.current)||void 0===e||e.focus(),null==M||M()},J=()=>{null==F||F()};oe("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),B<H.length-1){const e=B+1;null===(t=V.current[e])||void 0===t||t.focus(),A(e)}break;case"ArrowUp":if(e.preventDefault(),B>0){const e=B-1;null===(r=V.current[e])||void 0===r||r.focus(),A(e)}else 0===B&&N.current&&(N.current.focus(),A(-1));break;case"Space":case"Enter":document.activeElement===V.current[B]&&(e.preventDefault(),H[B]&&Q(H[B],B))}})),s((()=>{var e;if(!y)return void(null===(e=Y.current)||void 0===e||e.scrollTo({top:0}));const t=setTimeout((()=>{if(!n)return;const e=n.indexOf(y);Y.current&&-1!==e&&(Y.current.scrollToIndex({index:e}),A(e))}),0);return()=>clearTimeout(t)}),[V,n,A,y]),s((()=>{var e,t,r;if(L)return;if(d||!n)return;const o=n.findIndex((e=>q(e)));N.current?(A(-1),setTimeout((()=>{var e;return null===(e=N.current)||void 0===e?void 0:e.focus()}),200)):B>0?(null===(e=Y.current)||void 0===e||e.scrollToIndex({index:B,align:"center"}),setTimeout((()=>{var e;return null===(e=V.current[B])||void 0===e?void 0:e.focus()}),200)):-1!==o?(null===(t=Y.current)||void 0===t||t.scrollToIndex({index:o,align:"center"}),A(o),setTimeout((()=>{var e;return null===(e=V.current[o])||void 0===e?void 0:e.focus()}),200)):(null===(r=Y.current)||void 0===r||r.scrollToIndex({index:0}),A(0),setTimeout((()=>{var e;return null===(e=V.current[0])||void 0===e?void 0:e.focus()}),200))}),[q,d,B,n,L,A]),s((()=>{L&&j&&(d||"success"===c&&N.current&&(A(-1),N.current.focus()))}),[L,j,c,A,d]),s((()=>{var e;R(null!==(e=""===_?n:z?G():Z())&&void 0!==e?e:[])}),[G,Z,n,z,_]);const ee=e=>o?t(e?ov:iv,{"aria-hidden":!0}):e?t(rv,{"aria-hidden":!0}):t(nv,{}),te=(e,r)=>{const{title:n,secondaryLabel:o}=U(e);return t(Dc,{displayType:g,label:n,maxLines:h,selected:r,sublabel:o,truncationType:u,variant:p})},re=(n,i)=>{if(!F||"success"===c){const s=q(n),a=i===B;return t(tv,{"aria-selected":s,"aria-multiselectable":o,"data-testid":"list-item",onClick:()=>Q(n,i),onMouseEnter:()=>(e=>{A(e)})(i),ref:e=>{V.current[i]=e},role:"option",tabIndex:a?0:-1,$active:a,$selected:s,children:S?S(n,{selected:s}):e(r,{children:[ee(s),te(n,s)]})},((e,t)=>`item_${t}__${C?C(e):e}`)(n,i))}},ne=()=>{if(l&&o&&H.length>0&&!_&&"success"===c)return t(sv,{children:t(dv,{onClick:w,type:"button",$variant:p,children:0===l.length?"Select all":"Clear all"})})},ie=()=>{if(!T&&(_||!I)&&0===H.length&&"success"===c)return e(cv,{"data-testid":"list-no-results",children:[t(uv,{"data-testid":"no-result-icon"}),"No results found."]})},se=()=>{if(F&&"loading"===c)return e(cv,{"data-testid":"list-loading",children:[t(hv,{}),"Loading..."]})},ae=()=>{if(F&&"fail"===c)return e(cv,{"data-testid":"list-fail",children:[t(uv,{"data-testid":"load-error-icon"}),"Failed to load. ",t(lv,{onClick:J,type:"button",$variant:p,children:"Try again."})]})};return e(Kb,{"data-testid":"dropdown-container",ref:P,$width:v,$variant:p,children:[e(Jb,{ref:W,"data-testid":"dropdown-list",children:[(()=>{if((I||z)&&"success"===c)return t(vv,{ref:N,onChange:X,value:_,placeholder:D,"data-testid":"search-input","aria-label":"Enter text to search",onClear:K,variant:p})})(),ne(),ie(),se(),ae(),t(ev,{role:"listbox",id:b,children:t(xb,Object.assign({ref:Y,style:{height:"100%"},data:H,customScrollParent:null!==(le=P.current)&&void 0!==le?le:void 0,itemContent:(e,t)=>re(t,e)},"test"===process.env.NODE_ENV?{initialItemCount:H.length,key:H.length}:{}))})]}),(()=>{if(k)return t("div",{"data-testid":"custom-cta",children:k($,H)})})()]});var le},xv=x(Nn)`
    display: flex;
    align-items: center;
    gap: ${kn["spacing-8"]};
    width: 100%;
...
`,function(e){e.Ready="overlay-context-ready",e.Change="overlay-context-change"}($v||($v={}));const Fv=x.div`
    display: flex;
    flex-direction: column;
`,Cv=e=>"right"===e?"bottom-end":"bottom-start",Ev=({enabled:n,isOpen:o,onOpen:l,onClose:d,onDismiss:c,renderElement:u,renderDropdown:h,customZIndex:g,clickToToggle:m=!1,offset:f=0,alignment:p="left",fitAvailableHeight:b})=>{var v;const y=F(),x=Tn["sm-max"]({theme:y}),w=i(null),$=i(null),{width:C=0}=Ko({targetRef:w,handleHeight:!1}),E={name:"center",fn:({x:e,rects:t})=>{const r=0===e||e+t.floating.width===window.innerWidth,n=window.innerWidth<x;return{x:r&&n?(window.innerWidth-t.floating.width)/2:e}}},{refs:S,floatingStyles:k,context:I}=N({open:o,onOpenChange:(e,t,r)=>{"escape-key"===r?null==c||c():e&&!o?null==l||l():!e&&o&&(null==d||d(r))},whileElementsMounted:Y,placement:Cv(p),middleware:[U(f),q(),G({limiter:Z()}),Q({apply({availableHeight:e}){$.current&&Object.assign($.current.style,{maxHeight:b?`${e}px`:void 0,overflowY:b?"hidden":void 0})}}),E]}),T=(()=>{const[e,t]=a(void 0),r=V();return s((()=>{if(!r)return void t(void 0);const e=e=>{t(e.zIndex)};return r.events.on($v.Change,e),r.events.emit($v.Ready),()=>r.events.off($v.Change,e)}),[r]),e})(),{isMounted:D,styles:z}=X(I,{initial:{opacity:0},open:{opacity:1},duration:300}),M=K(I,{enabled:n,toggle:m}),B=J(I,{enabled:n}),{getReferenceProps:A,getFloatingProps:_}=ee([M,B]);return e(r,{children:[t("div",Object.assign({ref:e=>{w.current=e,S.setReference(e)}},A(),{children:u()})),D&&t(te,{children:t(re,{context:I,modal:!1,initialFocus:$,returnFocus:!1,children:t("div",Object.assign({ref:S.setFloating,style:Object.assign(Object.assign({},k),{zIndex:null!==(v=null!=g?g:T)&&void 0!==v?v:50})},_(),{children:t(Fv,{ref:$,style:Object.assign({},z),inert:z.opacity<1?"":void 0,children:h({elementWidth:C})})}))})})]})},Sv=x(Wn)`
    height: 3rem;
    gap: ${kn["spacing-8"]};
    // space for clear icon
    padding-right: calc(1.25rem + ${kn["spacing-20"]});
`,kv=r=>{var{id:n,disabled:o=!1,error:l,value:d,format:c="12hr",readOnly:u,onChange:h,onFocus:g,onBlur:f,alignment:b="left",dropdownZIndex:v,startLimit:y,endLimit:x,interval:w=15}=r,$=ne(r,["id","disabled","error","value","format","readOnly","onChange","onFocus","onBlur","alignment","dropdownZIndex","startLimit","endLimit","interval"]);const[F]=a((()=>cd.generate())),[C,E]=a(null),[S,k]=a(!1),[I,T]=a(""),[D,z]=a(""),[M,B]=a(""),[A,_]=a(""),[O,H]=a(""),R=i(null),j=i(null),L=i(null),P=p((()=>Xn.generateTimings(w,c,y,x)),[w,c,y,x]),W=p((()=>{if(""===A)return P;const e=Xn.findClosestFlooredTime(A,P);return e?P.slice(P.indexOf(e)):[]}),[P,A]),V=m((e=>Xn.parseInput(e,c)),[c]);s((()=>{var e,t;if(d){const r=null!==(e=V(d.start))&&void 0!==e?e:"",n=null!==(t=V(d.end))&&void 0!==t?t:"";z(r),B(n),_(r),H(n)}}),[d,V]),s((()=>{if(l)return void k(!1);const e=V(D),t=V(M);if(void 0===e)T("Invalid start time");else if(void 0===t)T("Invalid end time");else{if(!(""!==e&&""!==t&&Xn.to24Hour(t)<Xn.to24Hour(e)))return T(""),void(document.activeElement!==j.current&&document.activeElement!==L.current||k(!0));T("End time must be after start time")}k(!1)}),[D,M,V,l]);const N=e=>{o||u||(C||S||null==g||g(),E(e),k(!0))},Y=e=>{var t;o||u||(E(e),k(!0),null===(t=("start"===e?j:L).current)||void 0===t||t.select())};function U(e){var t;switch(e.code){case"Enter":"start"===C?q(D):"end"===C&&(S&&G(M),null===(t=L.current)||void 0===t||t.blur());break;case"Tab":Z(D,M,{})}}const q=e=>{Z(e,M,{goToNextInput:!0})},G=e=>{Z(D,e,{triggerOnBlur:!0})},Z=(e,t,{goToNextInput:r,triggerOnBlur:n})=>{var o,i,s;const a=null!==(o=V(e))&&void 0!==o?o:A,l=null!==(i=V(t))&&void 0!==i?i:O;z(a),B(l);a===A&&l===O||null==h||h({start:a,end:l}),r&&void 0!==V(e)&&(E("end"),null===(s=L.current)||void 0===s||s.select()),n&&(E(null),k(!1),null==f||f()),_(a),H(l)},Q=e=>{e.stopPropagation(),z(""),B(""),_(""),H("");null==h||h({start:"",end:""}),E(null),k(!1)},X=e=>{R.current&&!R.current.contains(e.relatedTarget)&&C&&!S&&Z(D,M,{triggerOnBlur:!0})},K=()=>{if(!u&&!o&&((null==D?void 0:D.length)>0||(null==M?void 0:M.length)>0))return t(Fc,{onClick:Q,type:"button","aria-label":"Clear",children:t(bc,{"aria-hidden":!0})})};return e(Yn,Object.assign({id:n},$,{children:[t(Xb,{children:t(Ev,{enabled:!u&&!o,isOpen:S,renderElement:()=>e(Sv,{ref:R,$disabled:o,$error:l||!!I,$readOnly:u,onBlur:X,children:[e(On,{error:l||!!I,currentActive:null===C?"none":C,children:[t(qn,{ref:j,onFocus:()=>N("start"),placeholder:"start"===C?"hh:mm":"From",onChange:e=>z(e.target.value),value:D,disabled:o,readOnly:u,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("start"),onKeyDown:U,autoComplete:"off","aria-label":"Start time input",type:"text",role:"combobox","aria-expanded":S,"aria-controls":F,"aria-autocomplete":"list"}),t(qn,{ref:L,onFocus:()=>N("end"),placeholder:"end"===C?"hh:mm":"To",onChange:e=>B(e.target.value),value:M,disabled:o,readOnly:u,"data-testid":$["data-testid"]?`${$["data-testid"]}-timepicker-selector`:"timepicker-selector",onClick:()=>Y("end"),onKeyDown:U,autoComplete:"off","aria-label":"End time input",type:"text",role:"combobox","aria-expanded":S,"aria-controls":F,"aria-autocomplete":"list"})]}),K()]}),renderDropdown:()=>{if(S)return t(yv,"start"===C?{listItems:P,onSelectItem:q,selectedItems:[D],disableItemFocus:!0,topScrollItem:Xn.findClosestFlooredTime(V(D),P),listboxId:F}:{listItems:W,onSelectItem:G,selectedItems:[M],disableItemFocus:!0,topScrollItem:Xn.findClosestFlooredTime(V(M),W),listboxId:F})},onClose:e=>{"outside-press"===e?(E(null),k(!1),null==f||f()):Z(D,M,{triggerOnBlur:!0})},onDismiss:()=>{var e;null===(e=("start"===C?j:L).current)||void 0===e||e.focus(),k(!1)},offset:8,alignment:b,fitAvailableHeight:!0,customZIndex:v})}),!l&&I&&t(fc,{id:n?`${n}-error-message`:"error-message",tabIndex:0,"data-testid":n?`${n}-error-message`:"error-message",children:I})]}))},Iv=e=>{var{variant:r="dial"}=e,n=ne(e,["variant"]);return t("combobox"===r?kv:mc,Object.assign({},n))};export{Iv as TimeRangePicker};
