...
`,Il=v((({type:n="checkbox",indicator:i,checked:s,styleType:l="default",children:c,childrenMaxLines:d,subLabel:h,disabled:f,error:p,name:g,id:y,className:b,compositeSection:v,removable:$,onRemove:w,"data-testid":x,onChange:B,useContentWidth:D})=>{const{collapsible:k=!0,errors:O,children:_,initialExpanded:M}=v||{},[E,A]=o(s),[H,C]=o(M),I=m((()=>{const e=Array.isArray(O)&&(null==O?void 0:O.length)>0,t=!Array.isArray(O)&&!!O;return e||t}),[O]),[T]=o(Ls.generate()),P=y?`${y}`:`tg-${T}`,z=a();u((()=>{A(s)}),[s]),u((()=>{E&&C(null==M||M)}),[E]);const j=e=>{if(!f){if(B)return void B(e);switch(n){case"checkbox":A((e=>!e));break;case"radio":case"yes":case"no":E||A(!0)}}},N=()=>{f||C(!H)},R=()=>{f||!w||w()},V=()=>{let e;switch(n){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=n}return t(ws,{type:e,active:E,disabled:f})},L=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,t(ol,Object.assign({"data-id":"toggle-sublabel",$disabled:f,$selected:E},{children:e}))},W=()=>{const r=!H&&!I;return k&&e(dl,Object.assign({$paddingTopRequired:r,disabled:f,onClick:N,"data-testid":H?"collapse-button":"expand-button"},{children:[H?"Show less":"Show more",t(H?S:F,{"aria-hidden":!0})]}))},Y=n=>e(r,{children:[t(pl,Object.assign({weight:"semibold",$disabled:f},{children:"Error"})),t(gl,Object.assign({$disabled:f},{children:null==n?void 0:n.map(((e,r)=>t("li",Object.assign({id:`${P}-error-list-item-${r}`},{children:t(pl,Object.assign({weight:"semibold",$disabled:f},{children:e}))}),r)))}))]});return e(rl,Object.assign({$selected:E,$disabled:f,className:b,$styleType:l,$error:p,$indicator:i,$useContentWidth:D,id:y,"data-testid":x},{children:[e(sl,Object.assign({id:`${P}-header-container`,$disabled:f,$error:p,$selected:E,$indicator:i,$styleType:l},{children:[e(ll,Object.assign({$addPadding:$},{children:[t(nl,{ref:z,name:g,id:`${P}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:f,onChange:j,checked:E}),i&&V(),e(il,{children:[t(al,Object.assign({htmlFor:`${P}-input`,$selected:E,$indicator:i,$disabled:f,"data-testid":`${P}-toggle-label`,$maxLines:d},{children:c})),h&&L()]})]})),$&&t(cl,Object.assign({type:"button",$disabled:f,onClick:R,id:`${P}-remove-button`},{children:"Remove"}))]})),_&&e("div",{children:[(!k||H)&&t(fl,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!k,$disabled:f},{children:_})),k&&!H&&I&&t(ul,Object.assign({$disabled:f,onClick:N,id:`${P}-error-alert`},{children:t(hl,Object.assign({type:f?"description":"error",className:b,showIcon:!0},{children:Array.isArray(O)?Y(O):O}))})),W()]})]}))}))`
    min-width: 5rem;
    flex: 1;
`,Tl=v(vs.Small)`
    width: 7rem;
