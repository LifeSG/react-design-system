...
`,Cf=y(sc)`
    ...
    ${e=>$`
        ...
        `}
`,If=f(((r,n)=>{var{value:i,variant:a,onClear:o}=r,s=ee(r,["value","variant","onClear"]);return e(jf,{children:[e(Af,{children:[t(Hf,{$variant:a,"aria-hidden":!0}),t(Ef,Object.assign({ref:n,value:i,$variant:a},s))]}),i&&t(Cf,Object.assign({"aria-label":"Clear search",focusOutline:"browser",onClick:o,$variant:a},{children:t(M,{"aria-hidden":!0})}))]})})),Tf=({listItems:n,multiSelect:i,selectedItems:l,disableItemFocus:c,itemsLoadState:d="success",itemTruncationType:u="end",itemMaxLines:h=2,labelDisplayType:f="inline",variant:p="default",listboxId:g,width:b,topScrollItem:v,onSelectItem:y,onSelectAll:$,onDismiss:w,onRetry:S,valueExtractor:x,listExtractor:F,renderListItem:k,renderCustomCallToAction:O,enableSearch:B,hideNoResultsDisplay:D,searchPlaceholder:_="Search",searchFunction:M,onSearch:j})=>{const{focusedIndex:A,setFocusedIndex:E}=m(hf),[H,C]=s(""),[I,T]=s(n),P=Hl(d),z=(()=>{const[e,t]=s(!1);return o((()=>{t(!0)}),[]),e})(),N=a(),R=a(),L=a([]),V=a(),W=e=>F?F(e):e.toString(),Y=El((()=>M(H))),U=El((()=>n.filter((e=>{var t;const r=W(e),n="object"==typeof r?r.title.toLowerCase():r.toLowerCase(),i="string"==typeof r||null===(t=r.secondaryLabel)||void 0===t?void 0:t.toLowerCase(),a=H.trim().toLowerCase();return n.includes(a)||i&&i.includes(a)})))),q=(e,t)=>{E(t),null==y||y(e,(e=>x?x(e):e)(e))},Z=e=>{const t=e.target.value;C(t),null==j||j()},J=()=>{var e;C(""),null===(e=V.current)||void 0===e||e.focus(),null==j||j()},Q=()=>{null==S||S()};te("keydown",(e=>{var t,r;switch(e.code){case"ArrowDown":if(e.preventDefault(),A<I.length-1){const e=A+1;null===(t=L.current[e])||void 0===t||t.focus(),E(e)}break;case"ArrowUp":if(e.preventDefault(),A>0){const e=A-1;null===(r=L.current[e])||void 0===r||r.focus(),E(e)}else 0===A&&V.current&&(V.current.focus(),E(-1));break;case"Space":case"Enter":document.activeElement===L.current[A]&&(e.preventDefault(),I[A]&&q(I[A],A))}})),o((()=>{if(void 0===v)return;const e=setTimeout((()=>{var e;const t=n.indexOf(v),r=L.current[t];if(N.current){const t=null!==(e=null==r?void 0:r.offsetTop)&&void 0!==e?e:0;N.current.scrollTop=t-8}E(t)}),0);return()=>clearTimeout(e)}),[L,n,E,v]),o((()=>{z||c||(V.current?(E(-1),setTimeout((()=>{var e;return null===(e=V.current)||void 0===e?void 0:e.focus()}),200)):L.current[A]?setTimeout((()=>{var e;return null===(e=L.current[A])||void 0===e?void 0:e.focus()}),200):(E(0),setTimeout((()=>{var e;return null===(e=L.current[0])||void 0===e?void 0:e.focus()}),200)))}),[c,A,z,E]),o((()=>{z&&P&&(c||"success"===d&&V.current&&(E(-1),V.current.focus()))}),[z,P,d,E,c]),o((()=>{T(""===H?n:M?Y():U())}),[Y,U,n,M,H]);const G=e=>i?t(e?$f:wf,{"aria-hidden":!0}):e?t(vf,{"aria-hidden":!0}):t(yf,{}),X=(e,r)=>{const n=W(e),i="string"==typeof n?n:n.title,a="string"==typeof n?void 0:n.secondaryLabel;return t(Lc,{displayType:f,label:i,maxLines:h,selected:r,sublabel:a,truncationType:u,variant:p})},K=()=>{if(!S||S&&"success"===d)return I.map(((n,a)=>{const o=(e=>!!cf(l,(t=>uf(t,e))))(n),s=a===A;return t(bf,Object.assign({"aria-selected":o,"aria-multiselectable":i,"data-testid":"list-item",onClick:()=>q(n,a),onMouseEnter:()=>(e=>{E(e)})(a),ref:e=>L.current[a]=e,role:"option",tabIndex:s?0:-1,$active:s},{children:k?k(n,{selected:o}):e(r,{children:[G(o),X(n,o)]})}),((e,t)=>`item_${t}__${x?x(e):e}`)(n,a))}))},ee=()=>{if((B||M)&&"success"===d)return t(If,{ref:V,onChange:Z,value:H,placeholder:_,"data-testid":"search-input","aria-label":"Enter text to search",onClear:J,variant:p})},re=()=>{if(i&&I.length>0&&!H&&"success"===d)return t(Sf,{children:t(kf,Object.assign({onClick:$,type:"button",$variant:p},{children:0===l.length?"Select all":"Clear all"}))})},ne=()=>{if(!D&&(H||!B)&&0===I.length&&"success"===d)return e(Of,Object.assign({"data-testid":"list-no-results"},{children:[t(Df,{"data-testid":"no-result-icon",$variant:p}),t(Bf,Object.assign({$variant:p},{children:"No results found."}))]}))},ie=()=>{if(S&&"loading"===d){const r="small"===p?16:18;return e(Of,Object.assign({"data-testid":"list-loading"},{children:[t(cl,{$buttonStyle:"secondary",size:r}),t(Bf,Object.assign({$variant:p},{children:"Loading..."}))]}))}},ae=()=>{if(S&&"fail"===d)return e(Of,Object.assign({"data-testid":"list-fail"},{children:[t(Df,{"data-testid":"load-error-icon",$variant:p}),t(Bf,Object.assign({$variant:p},{children:"Failed to load."}))," ",t(Ff,Object.assign({onClick:Q,type:"button",$variant:p},{children:"Try again."}))]}))};return e(pf,Object.assign({"data-testid":"dropdown-container",ref:N,$width:b},{children:[e(mf,Object.assign({ref:R,"data-testid":"dropdown-list"},{children:[ee(),re(),ne(),ie(),ae(),t(gf,Object.assign({role:"listbox",id:g},{children:K()}))]})),(()=>{if(O)return t("div",Object.assign({"data-testid":"custom-cta"},{children:O(w,I)}))})()]}))},Pf=y(dn)`
    display: flex;
    align-items: center;
    gap: 0.5rem;
    width: 100%;
