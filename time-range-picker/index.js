...
`,Rs=F((n=>{var{type:o="checkbox",indicator:i,checked:l,styleType:d="default",children:c,childrenMaxLines:u,subLabel:h,disabled:m,error:f,name:p,id:y,className:v,compositeSection:x,removable:w,onRemove:$,"data-testid":F,onChange:C,useContentWidth:E,"aria-describedby":S}=n,B=ae(n,["type","indicator","checked","styleType","children","childrenMaxLines","subLabel","disabled","error","name","id","className","compositeSection","removable","onRemove","data-testid","onChange","useContentWidth","aria-describedby"]);const{collapsible:T=!0,errors:z,children:I,initialExpanded:A}=x||{},[O,M]=s(l),[H,R]=s(!!A),L=b((()=>{const e=Array.isArray(z)&&(null==z?void 0:z.length)>0,r=!Array.isArray(z)&&!!z;return e||r}),[z]),[j]=s(Fi.generate()),_=y?`${y}`:`tg-${j}`,W=a(null);g((()=>{M(l)}),[l]),g((()=>{O&&R(null==A||A)}),[O]);const N=e=>{if(!m){if(C)return void C(e);switch(o){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":O||M(!0)}}},P=()=>{m||R(!H)},Y=()=>{m||!$||$()},V=()=>{var e;null===(e=null==W?void 0:W.current)||void 0===e||e.click()},U=e=>{e.stopPropagation()},Z=()=>{let e;switch(o){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=o}return r(Fs,{type:e,active:O,disabled:m,$selected:O,$disabled:m})},G=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,r(hs,{"data-id":"toggle-sublabel",id:`${_}-sublabel`,"aria-hidden":!0,children:e})},q=n=>e(t,{children:[r(ws,{weight:"semibold",$disabled:m,children:"Error"}),r($s,{$disabled:m,children:null==n?void 0:n.map(((e,t)=>r("li",{id:`${_}-error-list-item-${t}`,children:r(ws,{weight:"semibold",$disabled:m,children:e})},t)))})]});return e(ls,{$selected:O,$disabled:m,className:v,$styleType:d,$error:f,$indicator:i,$useContentWidth:E,id:y,"data-testid":F,children:[(()=>{const t=["string"==typeof h?`${_}-sublabel`:null,S].filter(Boolean).join(" ")||void 0;return e(ms,{id:`${_}-header-container`,$disabled:m,$error:f,$selected:O,$indicator:i,$styleType:d,children:[r(bs,{$addPadding:w,children:e(cs,{id:`${_}-input-container`,onClick:V,children:[r(ds,Object.assign({ref:W,name:p,id:`${_}-input`,type:"checkbox"===o?"checkbox":"radio","data-testid":"toggle-input",disabled:m,onChange:N,onClick:U,checked:O,"aria-describedby":t},B)),i&&Z(),e(us,{$selected:O,$disabled:m,children:[r(gs,{htmlFor:`${_}-input`,"data-testid":"toggle-label",id:`${_}-label`,$maxLines:u,$selected:O,children:c}),h&&G()]})]})}),w&&r(fs,{type:"button",$disabled:m,onClick:Y,id:`${_}-remove-button`,children:"Remove"})]})})(),I&&e("div",{children:[(!T||H)&&r(xs,{"data-id":"toggle-composite-children",$isFinalItem:!T,$disabled:m,children:I}),T&&!H&&L&&r(ys,{$disabled:m,onClick:P,id:`${_}-error-alert`,children:r(vs,{type:m?"description":"error",className:v,showIcon:!0,children:Array.isArray(z)?q(z):z})}),T&&e(ps,{$paddingTopRequired:!H&&!L,disabled:m,onClick:P,"data-testid":H?"collapse-button":"expand-button",children:[H?"Show less":"Show more",r(H?k:D,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,Ls=F(Ra.Small)`
    width: 7rem;
