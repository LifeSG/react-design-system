...
`,Ln=r=>{var{external:n=!1,children:i}=r,a=B(r,["external","children"]);return e(In,Object.assign({},a,{children:[i,n&&t(Rn,{})]}))};var Nn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Nn||(Nn={}));const Yn={collections:{base:{InputBoxShadow:S`
	...
	${e=>"small"===e.$buttonSizeStyle?S`
                ...
                `}
`,Un=w((({color:r,className:n,size:i=18})=>e(wn,Object.assign({className:n,$size:i,$color:r},{children:[t(Sn,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),t(xn,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),t(Fn,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),t(_n,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
    margin-right: 0.5rem;
...
`,Gn=i.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=B(e,["children","focusHighlight","focusOutline","type"]);return t(Zn,Object.assign({ref:r,$outline:a,$highlight:i,type:o},s,{children:n}))})),Xn=S`
    color: ${yn.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,Jn=w(b)`
