...
export declare const TimeSlotBarWeekDays: ({ calendarDate, disabledDates, selectedDate, onSelect, minDate, maxDate, startTime, endTime, maxVisibleCellHeight, slots: daySlots, interval, variant, enableSelection, onSlotClick, }: TimeSlotWeekDaysProps) => JSX.Element;
export {};
