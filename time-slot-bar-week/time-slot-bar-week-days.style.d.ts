...
export declare const CellWeekText: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../text").TextProps & CellWeekTextStyleProps, never>;
