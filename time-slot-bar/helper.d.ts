...
export declare class TimeSlotBarHelper {
    /**
     * Format HH:mm to am/pm display
     * @param timeString input timeString string
     */
    static formatHourlyDisplay(timeString: string): string;
    /**
     ...
     */
    static calculateWidth(start: string, end: string, cellWidth: number): number;
    /**
     ...
     */
    static adjustTimeForMarker(time: string, type: "start" | "end"): string;
    /**
