...
`,Er=({"data-testid":r,className:i,startTime:o,endTime:s,slots:c,onSlotClick:u,onClick:h,styleAttributes:d})=>{const g=a(null),[p,m]=l(0),[y,v]=l(0);f((()=>{const t=g.current;return t&&t.addEventListener("scroll",$),()=>{t&&t.removeEventListener("scroll",$)}}),[]);const $=()=>{g.current&&m(g.current.scrollLeft)},F=t=>{g.current&&g.current.scrollBy({left:"left"===t?-110:110,behavior:"smooth"})};!function(t){void 0===t&&(t={});var e=t.skipOnMount,n=void 0!==e&&e,r=t.refreshMode,i=t.refreshRate,o=void 0===i?1e3:i,s=t.refreshOptions,c=t.handleWidth,u=void 0===c||c,f=t.handleHeight,h=void 0===f||f,d=t.targetRef,g=t.observerOptions,p=t.onResize,m=a(n),y=a(null),v=null!=d?d:y,$=a(),F=l({width:void 0,height:void 0}),D=F[0],S=F[1];pt((function(){if(!ht()){var t=gt(p,S,u,h);$.current=ut((function(e){(u||h)&&e.forEach((function(e){var n=e&&e.contentRect||{},r=n.width,i=n.height;!m.current&&!ht()&&t({width:r,height:i}),m.current=!1}))}),r,o,s);var e=new window.ResizeObserver($.current);return v.current&&e.observe(v.current,g),function(){e.disconnect();var t=$.current;t&&t.cancel&&t.cancel()}}}),[r,o,s,u,h,p,g,v.current]),b({ref:v},D)}({onResize:()=>{g.current&&v(g.current.clientWidth)},targetRef:g,refreshMode:"debounce",refreshRate:50});const S=t=>t<=22,B=t=>{if(r)return`${r}-${t}`};return e(vr,Object.assign({className:i},{children:[e(Sr,Object.assign({"data-testid":r,ref:g},{children:[t(br,Object.assign({"data-testid":B("time-marker-wrapper"),"data-id":"marker-wrapper"},{children:(()=>{const e=[],n=D(o,"HH:mm"),r=D(s,"HH:mm");for(let i=n;i.isBefore(r);i=i.add(30,"minute")){const n=0===i.minute();e.push(t(wr,Object.assign({isHour:n},{children:n&&t(xr,Object.assign({weight:"semibold"},{children:Wt.formatHourlyDisplay(i.format("HH:mm"))}))}),i.format("HH:mm")))}return e})()})),e(Br,Object.assign({"data-testid":B("time-slot-wrapper"),"data-id":"slot-wrapper"},{children:[d&&(()=>{const{backgroundColor:r,backgroundColor2:i,styleType:a="default"}=d,l=Wt.calculateWidth(o,s,yr);return e(n,{children:[t(Hr,{}),t(Or,{"data-testid":B("default-timeslot"),$width:l,$left:0,$styleType:a,$bgColor:r,$bgColor2:i,$clickable:!!h,onClick:h},"default-timeslot"),t(Hr,{style:{left:`${l}px`}})]})})(),c.map((r=>{const{id:i,startTime:a,endTime:l,label:s,clickable:c=!0,styleAttributes:f}=r,{color:h,styleType:d="default",backgroundColor:g,backgroundColor2:p}=f,m=Wt.calculateWidth(a,l,yr),y=Wt.calculateWidth(o,a,yr);return e(n,{children:[t(Hr,{style:{left:`${y}px`}}),t(Or,Object.assign({"data-testid":B(`${i}-timeslot`),$width:m,$left:y,$styleType:d,$bgColor:g,$bgColor2:p,$clickable:c,onClick:()=>c&&u(r)},{children:s&&t(Mr,Object.assign({$slotWidth:m,$color:h,weight:"semibold"},{children:S(m)?"...":s}))}),i),t(Hr,{style:{left:`${y+m}px`}})]})}))]}))]})),t(n,{children:p>0&&t($r,Object.assign({"data-testid":B("arrow-left"),$direction:"left",focusHighlight:!1,focusOutline:"none",onClick:()=>{F("left")}},{children:t(Dr,{})}))}),p+y<Wt.calculateWidth(o,s,yr)?t($r,Object.assign({"data-testid":B("arrow-right"),$direction:"right",focusHighlight:!1,focusOutline:"none",onClick:()=>{F("right")}},{children:t(Fr,{})})):t(n,{})]}))};export{Er as TimeSlotBar};
