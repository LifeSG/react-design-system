...
export declare const TimeLabel: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const CellText: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps & CellTextStyleProps, never>;
export {};
