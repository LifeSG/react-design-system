    ...
    ${e=>{if(e.$disabledDisplay)return g`
            ...
            `;switch(e.$variant){case"current-month":return g`
                ...
                `;case"selected-month":return g`
                    ...
                    color: ${er.Primary(e)};
                `}}}
`,Jr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const f=i((()=>A.generateMonths(b(e))),[e]),g=e=>{const t="start"===r&&a&&e.isAfter(a,"month")&&l,i="end"===r&&n&&e.isBefore(n,"month")&&l;return t||i},p=e=>{const t=e.format("MMMM"),r=(n=e,!A.isWithinRange(n,c?b(c):void 0,d?b(d):void 0,"month"));var n;const i=o.isSame(e,"month")?"selected-month":b().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||g(e),interactive:!r||u,month:t,variant:i}};return f.length?t(Xr,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,month:a}=p(e);return t(Ur,Object.assign({$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Gr,Object.assign({weight:"regular",$variant:i,$disabledDisplay:r},{children:a}))}),a)}))})):null},qr=h.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Kr=h(Dr.H5)`
    ${e=>{if(e.$disabledDisplay)return g`
            ...
            `;switch(e.$variant){case"current-year":return g`
                ...
                `}}}
`,en=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onYearSelect:h})=>{const f=i((()=>A.generateDecadeOfYears(b(e))),[e]),g=e=>{const t="start"===r&&a&&e.isAfter(a,"year")&&l,i="end"===r&&n&&e.isBefore(n,"year")&&l;return t||i},p=e=>{const t=[0,11].includes(f.indexOf(e)),r=e.year(),n=(i=e,!A.isWithinRange(i,c?b(c):void 0,d?b(d):void 0,"year"));var i;const a=t?"other-decade":o.isSame(e,"year")?"selected-year":b().isSame(e,"year")?"current-year":"default";return{disabledDisplay:n||g(e),interactive:!n||u,year:r,variant:a}};return f.length?t(qr,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,year:a}=p(e);return t(Qr,Object.assign({$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Kr,Object.assign({weight:"regular",$variant:i,$disabledDisplay:r,$interactive:n},{children:a}))}),a)}))})):null},tn=n.forwardRef(((n,i)=>{var{children:c,initialCalendarDate:d,type:u,minDate:h,maxDate:f,currentFocus:g,selectedStartDate:p,selectedEndDate:y,selectWithinRange:$,dynamicHeight:v=!1,allowDisabledSelection:D,onCalendarDateChange:S,withButton:x,doneButtonDisabled:w,onDismiss:F,showNavigationHeader:B=!0,getLeftArrowDate:H,getRightArrowDate:k,isLeftArrowDisabled:O,isRightArrowDisabled:M,getMonthHeaderLabel:C,getYearHeaderLabel:L}=n,Y=m(n,["children","initialCalendarDate","type","minDate","maxDate","currentFocus","selectedStartDate","selectedEndDate","selectWithinRange","dynamicHeight","allowDisabledSelection","onCalendarDateChange","withButton","doneButtonDisabled","onDismiss","showNavigationHeader","getLeftArrowDate","getRightArrowDate","isLeftArrowDisabled","isRightArrowDisabled","getMonthHeaderLabel","getYearHeaderLabel"]);const[z,E]=a(_.toDayjs(d)),[W,j]=a(_.toDayjs(d)),[N,T]=a("default"),R=o(null),P=o(null),I=o();s(i,(()=>({defaultView(){T("default")},resetView(){const e=_.toDayjs(d);E(e),j(e),T("default")},setCalendarDate(e){const t=_.toDayjs(e);E(t),j(t)}}))),l((()=>{const e=_.toDayjs(d);E(e),j(e)}),[d]),l((()=>{q(W)}),[W]);const V=()=>{"month-options"!==N?(T("month-options"),I.current.focus()):(T("default"),E(W))},Z=()=>{"default"!==N?(T("default"),E(W)):T("year-options")},X=()=>{I.current.focus();const e=H?H(z):z.subtract(1,"month");switch(N){case"default":j(e),E(e);break;case"month-options":E((e=>e.subtract(1,"year")));break;case"year-options":E((e=>e.subtract(10,"year")))}},U=()=>{I.current.focus();const e=k?k(z):z.add(1,"month");switch(N){case"default":j(e),E(e);break;case"month-options":E((e=>e.add(1,"year")));break;case"year-options":E((e=>e.add(10,"year")))}},G=e=>{E(e),j(e),x||T("default")},J=()=>{const e=_.toDayjs(d);E(e),j(e),"default"===N?Q("reset"):T("default")},q=e=>{S&&S(e)},Q=e=>{F&&F(e)},K=()=>{if(!h||D)return!1;const e=b(h);return"month-options"===N?!A.isPreviousYearWithinRange(z,e):"year-options"===N?!A.isPreviousDecadeWithinRange(z,e):O?O(z):!A.isPreviousMonthWithinRange(z,e)},ee=()=>{if(!f||D)return!1;const e=b(f);return"month-options"===N?!A.isNextYearWithinRange(z,e):"year-options"===N?!A.isNextDecadeWithinRange(z,e):M?M(z):!A.isNextMonthWithinRange(z,e)},te=()=>{if("year-options"===N){const{beginDecade:e,endDecade:t}=A.getStartEndDecade(z);return`${e} to ${t}`}return L?L(z):z.format("YYYY")},re=()=>{const n=C?C(z):z.format("MMM");return e(r,{children:[e(Tr,Object.assign({type:"button",tabIndex:-1,$expanded:"month-options"===N,$visible:"default"===N,id:"month-dropdown",onClick:V},{children:[t(Rr,{children:n}),t(Yr,{})]})),e(Tr,Object.assign({type:"button",tabIndex:-1,$expanded:"default"!==N,id:"year-dropdown",onClick:Z},{children:[t(Rr,{children:te()}),t(Yr,{})]}))]})},ne=()=>{switch(N){case"month-options":return t(Jr,{type:u,calendarDate:z,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:y,viewCalendarDate:W,isNewSelection:$,onMonthSelect:G,allowDisabledSelection:D});case"year-options":return t(en,{type:u,calendarDate:z,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:y,viewCalendarDate:W,isNewSelection:$,onYearSelect:G,allowDisabledSelection:D});default:return null}};return e(zr,Object.assign({ref:I,tabIndex:-1,"data-id":"calendar-container","data-testid":"calendar-container"},Y,{children:[B&&e(jr,Object.assign({"data-id":"calendar-header","data-testid":"calendar-header"},{children:[t(Nr,{children:re()}),e(Pr,{children:[t(Ir,Object.assign({"data-testid":"left-arrow-btn",disabled:K(),focusHighlight:!1,tabIndex:-1,onClick:X},{children:t(Cr,{})})),t(Ir,Object.assign({"data-testid":"right-arrow-btn",disabled:ee(),focusHighlight:!1,tabIndex:-1,onClick:U},{children:t(Lr,{})}))]})]})),t(Er,{children:(()=>{const n="function"==typeof c?c({calendarDate:W,currentView:N}):c;return e(r,v?{children:["default"===N&&n,ne()]}:{children:[t(_r,{children:n}),t(Wr,Object.assign({$visible:"default"!==N},{children:ne()}))]})})()}),(()=>{if(!x)return;const r=!!("default"===N)&&w;return e(Vr,{children:[t(Zr,Object.assign({ref:P,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:J},{children:"Cancel"})),t(Zr,Object.assign({"data-testid":"done-button",ref:R,type:"button",onClick:()=>{r||(E(W),"default"===N?Q("confirmed"):T("default"))},disabled:r},{children:"Done"}))]})})()]}))}));h.div`
    width: 100%;
    display: grid;
...
`,pn=h.div`
    ...
    flex: 1;
    margin: 1px;
`;b.extend(H);const mn={id:"1",startTime:"",endTime:"",clickable:!1,styleAttributes:{styleType:"stripes",backgroundColor:"#ECEFEF",backgroundColor2:"#E0E4E5"}},yn=({calendarDate:r,disabledDates:n,selectedDate:a,onSelect:o,minDate:s,maxDate:l,slots:c,enableSelection:d=!0,onSlotClick:u})=>{const h=i((()=>A.generateDaysForCurrentWeek(r)),[r]),f="YYYY-MM-DD",g=e=>{const t=e.format(f),r=(e=>{const t=A.isWithinRange(e,s?b(s):void 0,l?b(l):void 0),r=n&&n.includes(e.format(f));return!t||r})(e),i={},o={};return r&&(i.$disabledDisplay=!0,o.$disabledDisplay=!0),i.$interactive=d&&!r,[a].includes(t)&&(i.$selected=!0,o.$selected=!0),{styleCircleProps:i,styleLabelProps:o}};return e(hn,{children:[t(rn,{children:h.map(((e,r)=>{const n="default",{styleCircleProps:i,styleLabelProps:a}=g(e);return t(nn,{children:t(ln,Object.assign({$variant:n,onClick:()=>((e,t)=>{!t&&d&&o(e)})(e,!i.$interactive)},i,{children:t(dn,Object.assign({weight:a.$selected?"semibold":"regular",$variant:n},a,{children:e.format("D")}))}))},`day-${r}`)}))}),h.map(((e,r)=>t(un,{children:t(Dr.XSmall,Object.assign({weight:"semibold"},{children:b(e).format("ddd")}))},`week-day-${r}`))),t(fn,{children:h.map(((r,n)=>{const i=r.format(f),a=c&&(c[i]?c[i]:[mn]);return t(pn,{children:a&&a.map((r=>{const{id:n,startTime:a,endTime:o,clickable:s=!0,styleAttributes:l}=r,{color:c,styleType:d="default",backgroundColor:h,backgroundColor2:f}=l;return t(cn,Object.assign({$type:"vertical",$styleType:d,$bgColor:h,$bgColor2:f,$clickable:s,onClick:()=>s&&((e,t)=>{u(e,t)})(i,r)},{children:e(gn,Object.assign({style:{color:c}},{children:[t("span",{children:A.convertTo12HourFormat(a)}),o&&a&&t("span",{children:"-"}),t("span",{children:A.convertTo12HourFormat(o)})]}))}),n)}))},`wrapper-${n}`)}))},`week-cell-${r.format(f)}`)]})},$n=h.div`
    min-width: 18.5rem;
...
`,bn="YYYY-MM-DD",vn=e=>{var{disabledDates:r,onWeekDisplayChange:n,onChange:i,value:s,minDate:c,maxDate:d,slots:u,showNavigationHeader:h=!0,enableSelection:f,onSlotClick:g,currentCalendarDate:p}=e,y=m(e,["disabledDates","onWeekDisplayChange","onChange","value","minDate","maxDate","slots","showNavigationHeader","enableSelection","onSlotClick","currentCalendarDate"]);const[$,v]=a(s),D=o(),S=o(void 0);l((()=>{v(s)}),[s]);const x=e=>{const t=e.format(bn);v(t),i&&i(t)},w=(e,t)=>{g&&g(e,t)},F=e=>{if(n){const t={week:{firstDayOfWeek:e.startOf("week").format(bn),lastDayOfWeek:e.endOf("week").format(bn)},month:e.month()+1,year:e.year()};n(t)}};return t($n,Object.assign({},y,{children:t(tn,Object.assign({ref:D,type:"standalone",dynamicHeight:!0,initialCalendarDate:_.toDayjs($||p).endOf("week").format(bn),selectedStartDate:$,getLeftArrowDate:e=>e.subtract(1,"week"),getRightArrowDate:e=>e.add(1,"week"),isLeftArrowDisabled:e=>c&&b(e).subtract(1,"week").isBefore(c,"week"),isRightArrowDisabled:e=>d&&b(e).add(1,"week").isAfter(d,"week"),onCalendarDateChange:e=>{S.current&&S.current.isSame(e,"week")||F(e),S.current=e},showNavigationHeader:h,minDate:c,maxDate:d,getMonthHeaderLabel:e=>b(e).endOf("week").format("MMM"),getYearHeaderLabel:e=>b(e).endOf("week").format("YYYY")},{children:({calendarDate:e})=>t(yn,{calendarDate:e,disabledDates:r,selectedDate:$,minDate:c,maxDate:d,onSelect:x,slots:u,enableSelection:f,onSlotClick:w})}))}))};export{vn as TimeSlotWeekView};
