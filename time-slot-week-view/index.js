    ...
    ${e=>{const{$disabled:t,$type:n}=e;if(t)return"selected"===n?f`
            ...
            `;switch(n){case"selected":return f`
                ...
                `;default:return f`
                    color: ${tn.Neutral[1]};
                `}}}
`,D.extend(x);const Dr=1.25,Sr=e=>"minified"===e?12:40;h.div`
    position: relative;
    display: flex;
    align-items: center;
`,h(Yn)`
