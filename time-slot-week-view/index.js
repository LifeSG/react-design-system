...
`,xn="YYYY-MM-DD",wn=e=>{var{disabledDates:r,onWeekDisplayChange:n,onChange:i,value:s,minDate:c,maxDate:d,slots:u,showNavigationHeader:h=!0,enableSelection:f,onSlotClick:g,currentCalendarDate:p}=e,y=m(e,["disabledDates","onWeekDisplayChange","onChange","value","minDate","maxDate","slots","showNavigationHeader","enableSelection","onSlotClick","currentCalendarDate"]);const[$,v]=a(s),D=o(),S=o(void 0);l((()=>{v(s)}),[s]);const x=e=>{const t=e.format(xn);v(t),i&&i(t)},w=(e,t)=>{g&&g(e,t)},F=e=>{if(n){const t={week:{firstDayOfWeek:e.startOf("week").format(xn),lastDayOfWeek:e.endOf("week").format(xn)},month:e.month()+1,year:e.year()};n(t)}};return t(Sn,Object.assign({},y,{children:t(tn,Object.assign({ref:D,type:"standalone",dynamicHeight:!0,initialCalendarDate:N.toDayjs($||p).endOf("week").format(xn),selectedStartDate:$,getLeftArrowDate:e=>e.subtract(1,"week"),getRightArrowDate:e=>e.add(1,"week"),isLeftArrowDisabled:e=>c&&b(e).subtract(1,"week").isBefore(c,"week"),isRightArrowDisabled:e=>d&&b(e).add(1,"week").isAfter(d,"week"),onCalendarDateChange:e=>{S.current&&S.current.isSame(e,"week")||F(e),S.current=e},showNavigationHeader:h,minDate:c,maxDate:d,getMonthHeaderLabel:e=>b(e).endOf("week").format("MMM"),getYearHeaderLabel:e=>b(e).endOf("week").format("YYYY")},{children:({calendarDate:e})=>t(Dn,{calendarDate:e,disabledDates:r,selectedDate:$,minDate:c,maxDate:d,onSelect:x,slots:u,enableSelection:f,onSlotClick:w})}))}))};export{wn as TimeSlotWeekView};
