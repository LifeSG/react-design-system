    ...
    ${e=>{const{$disabled:t,$type:r}=e;if(t)return"selected"===r?g`
            ...
            `;switch(r){case"selected":return g`
                ...
                `;default:return g`
                    color: ${tr.Neutral[1]};
                `}}}
`,D.extend(H);const Dn=1.25,Sn=e=>"minified"===e?12:40;h.div`
    position: relative;
    display: flex;
    align-items: center;
`,h(Wr)`
