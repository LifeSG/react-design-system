...
`,wr=r=>{var{external:n=!1,children:i}=r,a=m(r,["external","children"]);return e(Sr,Object.assign({},a,{children:[i,n&&t(xr,{})]}))};var Fr;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Fr||(Fr={}));const Br=h.button`
	...
	${e=>"small"===e.$buttonSizeStyle?g`
                ...
                `}
`,kr=h((({color:r,className:n,size:i=18})=>e(ir,Object.assign({className:n,$size:i,$color:r},{children:[t(or,{id:"inner1",$size:i-2,$borderWidth:2}),t(sr,{id:"inner2",$size:i-2,$borderWidth:2}),t(lr,{id:"inner3",$size:i-2,$borderWidth:2}),t(cr,{id:"inner4",$size:i-2,$borderWidth:2})]}))))`
    margin-right: 0.5rem;
...
`,Or=n.forwardRef(((e,r)=>{var{children:n,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=m(e,["children","focusHighlight","focusOutline","type"]);return t(Ar,Object.assign({ref:r,$outline:a,$highlight:i,type:o},s,{children:n}))})),Mr=g`
    color: ${er.Neutral[3]};
    height: 1rem;
    width: 1rem;
`,Er=h(d)`
    ...
    ${e=>{if(e.$disabledDisplay)return g`
            ...
            `;switch(e.$variant){case"current-month":return g`
                ...
                `;case"selected-month":return g`
                    ...
                    color: ${er.Primary(e)};
                `}}}
`,Jr=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onMonthSelect:h})=>{const f=i((()=>M.generateMonths(b(e))),[e]),g=e=>{const t="start"===r&&a&&e.isAfter(a,"month")&&l,i="end"===r&&n&&e.isBefore(n,"month")&&l;return t||i},p=e=>{const t=e.format("MMMM"),r=(n=e,!M.isWithinRange(n,c?b(c):void 0,d?b(d):void 0,"month"));var n;const i=o.isSame(e,"month")?"selected-month":b().isSame(e,"month")?"current-month":"default";return{disabledDisplay:r||g(e),interactive:!r||u,month:t,variant:i}};return f.length?t(Xr,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,month:a}=p(e);return t(Ur,Object.assign({$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Gr,Object.assign({weight:"regular",$variant:i,$disabledDisplay:r},{children:a}))}),a)}))})):null},qr=h.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
...
`,Kr=h(Dr.H5)`
    ${e=>{if(e.$disabledDisplay)return g`
            ...
            `;switch(e.$variant){case"current-year":return g`
                ...
                `}}}
`,en=({calendarDate:e,currentFocus:r,selectedStartDate:n,selectedEndDate:a,viewCalendarDate:o,type:s,isNewSelection:l,minDate:c,maxDate:d,allowDisabledSelection:u,onYearSelect:h})=>{const f=i((()=>M.generateDecadeOfYears(b(e))),[e]),g=e=>{const t="start"===r&&a&&e.isAfter(a,"year")&&l,i="end"===r&&n&&e.isBefore(n,"year")&&l;return t||i},p=e=>{const t=[0,11].includes(f.indexOf(e)),r=e.year(),n=(i=e,!M.isWithinRange(i,c?b(c):void 0,d?b(d):void 0,"year"));var i;const a=t?"other-decade":o.isSame(e,"year")?"selected-year":b().isSame(e,"year")?"current-year":"default";return{disabledDisplay:n||g(e),interactive:!n||u,year:r,variant:a}};return f.length?t(qr,Object.assign({$type:s},{children:f.map((e=>{const{disabledDisplay:r,interactive:n,variant:i,year:a}=p(e);return t(Qr,Object.assign({$variant:i,$disabledDisplay:r,$interactive:n,onClick:()=>((e,t)=>{t||h(e)})(e,!n)},{children:t(Kr,Object.assign({weight:"regular",$variant:i,$disabledDisplay:r,$interactive:n},{children:a}))}),a)}))})):null},tn=n.forwardRef(((n,i)=>{var{children:c,initialCalendarDate:d,type:u,minDate:h,maxDate:f,currentFocus:g,selectedStartDate:p,selectedEndDate:$,selectWithinRange:y,dynamicHeight:v=!1,allowDisabledSelection:D,onCalendarDateChange:S,withButton:x,doneButtonDisabled:w,onDismiss:F,showNavigationHeader:B=!0,getLeftArrowDate:k,getRightArrowDate:H,isLeftArrowDisabled:A,isRightArrowDisabled:O,getMonthHeaderLabel:E,getYearHeaderLabel:L}=n,C=m(n,["children","initialCalendarDate","type","minDate","maxDate","currentFocus","selectedStartDate","selectedEndDate","selectWithinRange","dynamicHeight","allowDisabledSelection","onCalendarDateChange","withButton","doneButtonDisabled","onDismiss","showNavigationHeader","getLeftArrowDate","getRightArrowDate","isLeftArrowDisabled","isRightArrowDisabled","getMonthHeaderLabel","getYearHeaderLabel"]);const[Y,z]=a(N.toDayjs(d)),[_,j]=a(N.toDayjs(d)),[W,T]=a("default"),R=o(null),P=o(null),I=o();s(i,(()=>({defaultView(){T("default")},resetView(){const e=N.toDayjs(d);z(e),j(e),T("default")},setCalendarDate(e){const t=N.toDayjs(e);z(t),j(t)}}))),l((()=>{const e=N.toDayjs(d);z(e),j(e)}),[d]),l((()=>{q(_)}),[_]);const V=()=>{"month-options"!==W?(T("month-options"),I.current.focus()):(T("default"),z(_))},Z=()=>{"default"!==W?(T("default"),z(_)):T("year-options")},X=()=>{I.current.focus();const e=k?k(Y):Y.subtract(1,"month");switch(W){case"default":j(e),z(e);break;case"month-options":z((e=>e.subtract(1,"year")));break;case"year-options":z((e=>e.subtract(10,"year")))}},U=()=>{I.current.focus();const e=H?H(Y):Y.add(1,"month");switch(W){case"default":j(e),z(e);break;case"month-options":z((e=>e.add(1,"year")));break;case"year-options":z((e=>e.add(10,"year")))}},G=e=>{z(e),j(e),x||T("default")},J=()=>{const e=N.toDayjs(d);z(e),j(e),"default"===W?Q("reset"):T("default")},q=e=>{S&&S(e)},Q=e=>{F&&F(e)},K=()=>{if(!h||D)return!1;const e=b(h);return"month-options"===W?!M.isPreviousYearWithinRange(Y,e):"year-options"===W?!M.isPreviousDecadeWithinRange(Y,e):A?A(Y):!M.isPreviousMonthWithinRange(Y,e)},ee=()=>{if(!f||D)return!1;const e=b(f);return"month-options"===W?!M.isNextYearWithinRange(Y,e):"year-options"===W?!M.isNextDecadeWithinRange(Y,e):O?O(Y):!M.isNextMonthWithinRange(Y,e)},te=()=>{if("year-options"===W){const{beginDecade:e,endDecade:t}=M.getStartEndDecade(Y);return`${e} to ${t}`}return L?L(Y):Y.format("YYYY")},re=()=>{const n=E?E(Y):Y.format("MMM");return e(r,{children:[e(Tr,Object.assign({type:"button",tabIndex:-1,$expanded:"month-options"===W,$visible:"default"===W,id:"month-dropdown",onClick:V},{children:[t(Rr,{children:n}),t(Cr,{})]})),e(Tr,Object.assign({type:"button",tabIndex:-1,$expanded:"default"!==W,id:"year-dropdown",onClick:Z},{children:[t(Rr,{children:te()}),t(Cr,{})]}))]})},ne=()=>{switch(W){case"month-options":return t(Jr,{type:u,calendarDate:Y,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:$,viewCalendarDate:_,isNewSelection:y,onMonthSelect:G,allowDisabledSelection:D});case"year-options":return t(en,{type:u,calendarDate:Y,currentFocus:g,minDate:h,maxDate:f,selectedStartDate:p,selectedEndDate:$,viewCalendarDate:_,isNewSelection:y,onYearSelect:G,allowDisabledSelection:D});default:return null}};return e(Yr,Object.assign({ref:I,tabIndex:-1,"data-id":"calendar-container","data-testid":"calendar-container"},C,{children:[B&&e(jr,Object.assign({"data-id":"calendar-header","data-testid":"calendar-header"},{children:[t(Wr,{children:re()}),e(Pr,{children:[t(Ir,Object.assign({"data-testid":"left-arrow-btn",disabled:K(),focusHighlight:!1,tabIndex:-1,onClick:X},{children:t(Er,{})})),t(Ir,Object.assign({"data-testid":"right-arrow-btn",disabled:ee(),focusHighlight:!1,tabIndex:-1,onClick:U},{children:t(Lr,{})}))]})]})),t(zr,{children:(()=>{const n="function"==typeof c?c({calendarDate:_,currentView:W}):c;return e(r,v?{children:["default"===W&&n,ne()]}:{children:[t(Nr,{children:n}),t(_r,Object.assign({$visible:"default"!==W},{children:ne()}))]})})()}),(()=>{if(!x)return;const r=!!("default"===W)&&w;return e(Vr,{children:[t(Zr,Object.assign({ref:P,"data-testid":"cancel-button",styleType:"light",type:"button",onClick:J},{children:"Cancel"})),t(Zr,Object.assign({"data-testid":"done-button",ref:R,type:"button",onClick:()=>{r||(z(_),"default"===W?Q("confirmed"):T("default"))},disabled:r},{children:"Done"}))]})})()]}))}));h.div`
    width: 100%;
    display: grid;
...
`;const ln=h(on)`
    ...
    ${e=>{const{$disabledDisplay:t,$overlap:r,$variant:n}=e;return r?g`
            ...
            `:"today"===n?g`
                    background: ${er.Accent.Light[5]};
                `:void 0}}
`,cn=e=>{let t=er.Neutral[8],r="1px solid transparent";switch(e.$type){case"current":t=er.Accent.Light[5];break;case"hover-dash":t=er.Accent.Light[6],r=`1px dashed ${er.Accent.Light[4](e)}`;break;case"hover-current":t=er.Neutral[8],r=`1px solid ${er.Primary(e)}`;break;case"selected":t=er.Accent.Light[5],r=`1px solid ${er.Accent.Light[4](e)}`;break;case"selected-outline":t=er.Accent.Light[5],r=`1px solid ${er.Primary(e)}`;break;case"overlap":t=er.Accent.Light[4],r=`1px solid ${er.Accent.Light[4](e)}`;break;case"overlap-outline":t=er.Accent.Light[4],r=`1px solid ${er.Primary(e)}`}return{color:t,border:r}};h.div`
    display: flex;
    align-items: center;
    justify-content: center;
    position: relative;
...
`;const dn=h.div`
    ...
    ${e=>{if(!e.$type)return;const{color:t,border:r}=cn(e);return g`
            background-color: ${t};
...
`;const hn=h.div`
    ...
    ${e=>{if(e.$type){const{color:t,border:r}=cn(e);return g`
                background-color: ${t};
                background-clip: content-box;
                border: ${r};
            `}}}
    ...
    ${e=>{const{$disabled:t,$type:r}=e;if(t)return"selected"===r?g`
            ...
            `;switch(r){case"selected":return g`
                ...
                `;default:return g`
                    color: ${er.Neutral[1]};
                `}}}
`,b.extend(k);const fn=1.25,gn=e=>"minified"===e?12:40;h.div`
    position: relative;
    display: flex;
    align-items: center;
`,h(Or)`
...
`,h.div`
    ...
    ${e=>{let t=0;switch(e.$variant){case"default":t=e.$isLongMarker?fn:.625;break;case"minified":t=e.$isLongMarker?fn:0;break;default:t=0}return g`
            height: ${t}rem;
        `}}
`,h(Dr.XSmall)`
    color: ${er.Neutral[2]};
...
`,Dn=h.div`
    ...
    flex: 1;
    margin: 1px;
`;b.extend(k);const Sn={id:"1",startTime:"",endTime:"",clickable:!1,styleAttributes:{styleType:"stripes",backgroundColor:"#ECEFEF",backgroundColor2:"#E0E4E5"}},xn=({calendarDate:r,disabledDates:n,selectedDate:a,onSelect:o,minDate:s,maxDate:l,slots:c,enableSelection:d=!0,onSlotClick:u})=>{const h=i((()=>M.generateDaysForCurrentWeek(r)),[r]),f="YYYY-MM-DD",g=e=>{const t=e.format(f),r=(e=>{const t=M.isWithinRange(e,s?b(s):void 0,l?b(l):void 0),r=n&&n.includes(e.format(f));return!t||r})(e),i={},o={};return r&&(i.$disabledDisplay=!0,o.$disabledDisplay=!0),i.$interactive=d&&!r,[a].includes(t)&&(i.$selected=!0,o.$selected=!0),{styleCircleProps:i,styleLabelProps:o}};return e(yn,{children:[t(rn,{children:h.map(((e,r)=>{const n="default",{styleCircleProps:i,styleLabelProps:a}=g(e);return t(nn,{children:t(ln,Object.assign({$variant:n,onClick:()=>((e,t)=>{!t&&d&&o(e)})(e,!i.$interactive)},i,{children:t(mn,Object.assign({weight:a.$selected?"semibold":"regular",$variant:n},a,{children:e.format("D")}))}))},`day-${r}`)}))}),h.map(((e,r)=>t($n,{children:t(Dr.XSmall,Object.assign({weight:"semibold"},{children:b(e).format("ddd")}))},`week-day-${r}`))),t(bn,{children:h.map(((r,n)=>{const i=r.format(f),a=c&&(c[i]?c[i]:[Sn]);return t(Dn,{children:a&&a.map((r=>{const{id:n,startTime:a,endTime:o,clickable:s=!0,styleAttributes:l}=r,{color:c,styleType:d="default",backgroundColor:h,backgroundColor2:f}=l;return t(pn,Object.assign({$type:"vertical",$variant:"default",$styleType:d,$bgColor:h,$bgColor2:f,$clickable:s,onClick:()=>s&&((e,t)=>{u(e,t)})(i,r)},{children:e(vn,Object.assign({style:{color:c}},{children:[t("span",{children:M.convertTo12HourFormat(a)}),o&&a&&t("span",{children:"-"}),t("span",{children:M.convertTo12HourFormat(o)})]}))}),n)}))},`wrapper-${n}`)}))},`week-cell-${r.format(f)}`)]})},wn=h.div`
    min-width: 18.5rem;
...
`,Fn="YYYY-MM-DD",Bn=e=>{var{disabledDates:r,onWeekDisplayChange:n,onChange:i,value:s,minDate:c,maxDate:d,slots:u,showNavigationHeader:h=!0,enableSelection:f,onSlotClick:g,currentCalendarDate:p}=e,$=m(e,["disabledDates","onWeekDisplayChange","onChange","value","minDate","maxDate","slots","showNavigationHeader","enableSelection","onSlotClick","currentCalendarDate"]);const[y,v]=a(s),D=o(),S=o(void 0);l((()=>{v(s)}),[s]);const x=e=>{const t=e.format(Fn);v(t),i&&i(t)},w=(e,t)=>{g&&g(e,t)},F=e=>{if(n){const t={week:{firstDayOfWeek:e.startOf("week").format(Fn),lastDayOfWeek:e.endOf("week").format(Fn)},month:e.month()+1,year:e.year()};n(t)}};return t(wn,Object.assign({},$,{children:t(tn,Object.assign({ref:D,type:"standalone",dynamicHeight:!0,initialCalendarDate:N.toDayjs(y||p).endOf("week").format(Fn),selectedStartDate:y,getLeftArrowDate:e=>e.subtract(1,"week"),getRightArrowDate:e=>e.add(1,"week"),isLeftArrowDisabled:e=>c&&b(e).subtract(1,"week").isBefore(c,"week"),isRightArrowDisabled:e=>d&&b(e).add(1,"week").isAfter(d,"week"),onCalendarDateChange:e=>{S.current&&S.current.isSame(e,"week")||F(e),S.current=e},showNavigationHeader:h,minDate:c,maxDate:d,getMonthHeaderLabel:e=>b(e).endOf("week").format("MMM"),getYearHeaderLabel:e=>b(e).endOf("week").format("YYYY")},{children:({calendarDate:e})=>t(xn,{calendarDate:e,disabledDates:r,selectedDate:y,minDate:c,maxDate:d,onSelect:x,slots:u,enableSelection:f,onSlotClick:w})}))}))};export{Bn as TimeSlotWeekView};
