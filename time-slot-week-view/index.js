...
`,kn=h.div`
    ...
    ${({$variant:e,$interactive:r})=>{if(r)return"selected-month"===e?g`
        ...
        `}}
`,zn=({calendarDate:e,currentFocus:t,selectedStartDate:n,selectedEndDate:i,viewCalendarDate:o,isNewSelection:s,minDate:l,maxDate:d,allowDisabledSelection:c,onMonthSelect:u})=>{const h=a((()=>k.generateMonths(x(e))),[e]),b=e=>{const r="start"===t&&i&&e.isAfter(i,"month")&&s,a="end"===t&&n&&e.isBefore(n,"month")&&s;return r||a},g=e=>{const r=e.format("MMMM"),t=(n=e,!k.isWithinRange(n,l?x(l):void 0,d?x(d):void 0,"month"));var n;const a=o.isSame(e,"month")?"selected-month":x().isSame(e,"month")?"current-month":"default";return{disabledDisplay:t||b(e),interactive:!t||c,month:r,variant:a}};return h.length?r(Sn,{children:h.map((e=>{const{disabledDisplay:t,interactive:n,variant:a,month:i}=g(e);return r(kn,Object.assign({$variant:a,$disabledDisplay:t,$interactive:n,onClick:()=>((e,r)=>{r||u(e)})(e,!n)},{children:i}),i)}))}):null},Mn=h.div`
    width: 100%;
    height: 100%;
    display: grid;
    align-content: center;
