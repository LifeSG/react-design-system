...
export declare const TimeSlotWeekDays: ({ calendarDate, disabledDates, selectedDate, onSelect, minDate, maxDate, slots: daySlots, enableSelection, onSlotClick, }: TimeSlotWeekDaysProps) => import("react/jsx-runtime").JSX.Element;
export {};
