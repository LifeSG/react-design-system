export declare const DayLabelWeek: import("styled-components").StyledComponent<"h5", import("styled-components").DefaultTheme, import("../text").TextProps & import("../shared/internal-calendar/standard").DayLabelStyleProps, never>;
...
export declare const TimeSlotText: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, {}, never>;
