...
export declare const TimelineTitle: import("styled-components").StyledComponent<"h3", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
export declare const TimelineItemTitle: import("styled-components").StyledComponent<"h4", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
...
export declare const TimelinePills: import("styled-components").StyledComponent<"h3", import("styled-components").DefaultTheme, import("../v2_text").V2_TextProps, never>;
