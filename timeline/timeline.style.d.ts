...
export declare const TimelinePill: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("..").PillProps, never>> & string & Omit<({ type, colorType, children, icon, ...otherProps }: import("..").PillProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;
export {};
