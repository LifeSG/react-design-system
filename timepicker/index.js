...
`,wl=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=T(e,["children","focusHighlight","focusOutline","type"]);return t($l,Object.assign({ref:n,$outline:a,$highlight:i,type:o},s,{children:r}))})),Sl=y(is.div)`
    position: absolute;
    top: 3.5rem;
    left: 0;
...
`,El=y((({type:r="checkbox",indicator:i,checked:s,styleType:l="default",children:c,childrenMaxLines:u,subLabel:h,disabled:f,error:p,name:m,id:y,className:b,compositeSection:v,removable:$,onRemove:F,"data-testid":x,onChange:B,useContentWidth:k})=>{const{collapsible:D=!0,errors:O,children:_,initialExpanded:M}=v||{},[H,E]=o(s),[A,C]=o(M),I=g((()=>{const e=Array.isArray(O)&&(null==O?void 0:O.length)>0,t=!Array.isArray(O)&&!!O;return e||t}),[O]),[P]=o(Us.generate()),T=y?`${y}`:`tg-${P}`,z=a();d((()=>{E(s)}),[s]),d((()=>{H&&C(null==M||M)}),[H]);const V=e=>{if(!f){if(B)return void B(e);switch(r){case"checkbox":E((e=>!e));break;case"radio":case"yes":case"no":H||E(!0)}}},N=()=>{f||C(!A)},j=()=>{f||!F||F()},R=()=>{var e;null===(e=null==z?void 0:z.current)||void 0===e||e.click()},L=e=>{e.stopPropagation()},W=()=>{let e;switch(r){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=r}return t(ks,{type:e,active:H,disabled:f})},Y=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,t(ul,Object.assign({"data-id":"toggle-sublabel",$disabled:f,$selected:H},{children:e}))},U=()=>{const n=!A&&!I;return D&&e(pl,Object.assign({$paddingTopRequired:n,disabled:f,onClick:N,"data-testid":A?"collapse-button":"expand-button"},{children:[A?"Show less":"Show more",t(A?S:w,{"aria-hidden":!0})]}))},q=r=>e(n,{children:[t(bl,Object.assign({weight:"semibold",$disabled:f},{children:"Error"})),t(vl,Object.assign({$disabled:f},{children:null==r?void 0:r.map(((e,n)=>t("li",Object.assign({id:`${T}-error-list-item-${n}`},{children:t(bl,Object.assign({weight:"semibold",$disabled:f},{children:e}))}),n)))}))]});return e(al,Object.assign({$selected:H,$disabled:f,className:b,$styleType:l,$error:p,$indicator:i,$useContentWidth:k,id:y,"data-testid":x},{children:[e(dl,Object.assign({id:`${T}-header-container`,$disabled:f,$error:p,$selected:H,$indicator:i,$styleType:l},{children:[t(hl,Object.assign({$addPadding:$},{children:e(sl,Object.assign({id:`${T}-input-container`,onClick:R},{children:[t(ol,{ref:z,name:m,id:`${T}-input`,type:"checkbox"===r?"checkbox":"radio","data-testid":"toggle-input",disabled:f,onChange:V,onClick:L,checked:H}),i&&W(),e(ll,{children:[t(cl,Object.assign({htmlFor:`${T}-input`,$selected:H,$indicator:i,$disabled:f,"data-testid":`${T}-toggle-label`,$maxLines:u},{children:c})),h&&Y()]})]}))})),$&&t(fl,Object.assign({type:"button",$disabled:f,onClick:j,id:`${T}-remove-button`},{children:"Remove"}))]})),_&&e("div",{children:[(!D||A)&&t(yl,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!D,$disabled:f},{children:_})),D&&!A&&I&&t(ml,Object.assign({$disabled:f,onClick:N,id:`${T}-error-alert`},{children:t(gl,Object.assign({type:f?"description":"error",className:b,showIcon:!0},{children:Array.isArray(O)?q(O):O}))})),U()]})]}))}))`
    min-width: 5rem;
    flex: 1;
`,Al=y(xs.Small)`
    width: 7rem;
