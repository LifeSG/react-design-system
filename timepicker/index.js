...
`,is=m.button`
	...
	${e=>"small"===e.$buttonSizeStyle?y`
                ...
                `}
`,as=m((({color:n,className:r,size:i=18})=>e(Jo,Object.assign({className:r,$size:i,$color:n},{children:[t(es,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(ts,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(ns,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t(rs,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
