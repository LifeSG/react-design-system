...
`,rs=({external:e=!1,children:r,...i})=>t(ts,{...i,children:[r,e&&n(ns,{})]});var is;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(is||(is={}));const os=b.button`
	...
	${e=>"small"===e.$buttonSizeStyle?$`
                ...
                `}
`,as=b((({color:e,className:r,size:i=18})=>t(Aa,{className:r,$size:i,$color:e,children:[n(ja,{id:"inner1",$size:i-2,$borderWidth:2}),n(Ta,{id:"inner2",$size:i-2,$borderWidth:2}),n(Na,{id:"inner3",$size:i-2,$borderWidth:2}),n(za,{id:"inner4",$size:i-2,$borderWidth:2})]})))`
    margin-right: 0.5rem;
