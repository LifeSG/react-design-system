...
`,yd=f((({type:n="checkbox",indicator:i,checked:a,styleType:l="default",children:d,childrenMaxLines:c,subLabel:h,disabled:g,error:m,name:b,id:f,className:y,compositeSection:v,removable:$,onRemove:F,"data-testid":E,onChange:C,useContentWidth:D})=>{const{collapsible:k=!0,errors:M,children:A,initialExpanded:_}=v||{},[B,S]=o(a),[O,z]=o(!!_),T=p((()=>{const e=Array.isArray(M)&&(null==M?void 0:M.length)>0,r=!Array.isArray(M)&&!!M;return e||r}),[M]),[I]=o($l.generate()),P=f?`${f}`:`tg-${I}`,j=s(null);u((()=>{S(a)}),[a]),u((()=>{B&&z(null==_||_)}),[B]);const L=()=>{g||z(!O)},R=()=>{g||!F||F()},H=()=>{let e;switch(n){case"yes":e="tick";break;case"no":e="cross";break;case"checkbox":case"radio":e=n}return r(id,{type:e,active:B,disabled:g,$selected:B,$disabled:g})},V=()=>{if(!h)return null;let e;return e="function"==typeof h?h():h,r(Ql,{"data-id":"toggle-sublabel",children:e})},Y=n=>e(t,{children:[r(td,{weight:"semibold",$disabled:g,children:"Error"}),r(nd,{$disabled:g,children:null==n?void 0:n.map(((e,t)=>r("li",{id:`${P}-error-list-item-${t}`,children:r(td,{weight:"semibold",$disabled:g,children:e})},t)))})]});return e(Nl,{$selected:B,$disabled:g,className:y,$styleType:l,$error:m,$indicator:i,$useContentWidth:D,id:f,"data-testid":E,children:[e(Zl,{id:`${P}-header-container`,$disabled:g,$error:m,$selected:B,$indicator:i,$styleType:l,children:[e(Xl,{$addPadding:$,children:[r(Wl,{ref:j,name:b,id:`${P}-input`,type:"checkbox"===n?"checkbox":"radio","data-testid":"toggle-input",disabled:g,onChange:e=>{if(!g){if(C)return void C(e);switch(n){case"checkbox":S((e=>!e));break;case"radio":case"yes":case"no":B||S(!0)}}},checked:B}),i&&H(),e(Ul,{$selected:B,$disabled:g,children:[r(ql,{htmlFor:`${P}-input`,"data-testid":`${P}-toggle-label`,$maxLines:c,children:d}),h&&V()]})]}),$&&r(Gl,{type:"button",$disabled:g,onClick:R,id:`${P}-remove-button`,children:"Remove"})]}),A&&e("div",{children:[(!k||O)&&r(rd,{"data-id":"toggle-composite-children",$isFinalItem:!k,$disabled:g,children:A}),k&&!O&&T&&r(Kl,{$disabled:g,onClick:L,id:`${P}-error-alert`,children:r(ed,{type:g?"description":"error",className:y,showIcon:!0,children:Array.isArray(M)?Y(M):M})}),k&&e(Jl,{$paddingTopRequired:!O&&!T,disabled:g,onClick:L,"data-testid":O?"collapse-button":"expand-button",children:[O?"Show less":"Show more",r(O?w:x,{"aria-hidden":!0})]})]})]})}))`
    min-width: 5rem;
    flex: 1;
`,vd=f(tl.Small)`
    width: 7rem;
