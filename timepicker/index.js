...
`,ws=y.button`
	...
	${e=>"small"===e.$buttonSizeStyle?b`
                ...
                `}
`,Ss=y((({color:n,className:r,size:i=18})=>e(gs,Object.assign({className:r,$size:i,$color:n},{children:[t(ys,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),t(bs,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),t(vs,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),t($s,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    ${e=>{let t=e.$buttonIsDanger?nn.Button.Danger.Primary:Kt.Primary(e);switch(e.$buttonStyle){case"secondary":case"light":case"link":break;case"disabled":t=Kt.Neutral[3](e);break;default:t=Kt.Neutral[8](e)}return b`
        ...
        `}}
`,Fs={Default:i.forwardRef(((n,r)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:s="default",danger:l=!1}=n,c=T(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:a?"disabled":s,$buttonSizeStyle:"default",$buttonIsDanger:l};return e(ws,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:a},u,c,{children:[o&&t(Ss,Object.assign({},u)),t("span",{children:i})]}))})),Small:i.forwardRef(((n,r)=>{const{children:i,disabled:a=!1,loading:o=!1,styleType:s="default",danger:l=!1}=n,c=T(n,["children","disabled","loading","styleType","danger"]),u={$buttonStyle:a?"disabled":s,$buttonSizeStyle:"small",$buttonIsDanger:l};return e(ws,Object.assign({ref:r,"data-testid":c["data-testid"]||"button",disabled:a},u,c,{children:[o&&t(Ss,Object.assign({},u,{size:16})),t("span",{children:i})]}))}))},xs=y.div`
    height: 1.625rem;
    width: 1.625rem;
    margin-right: 0.5rem;
    flex-shrink: 0;
...
`,wl=i.forwardRef(((e,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:a="none",type:o="button"}=e,s=T(e,["children","focusHighlight","focusOutline","type"]);return t($l,Object.assign({ref:n,$outline:a,$highlight:i,type:o},s,{children:r}))})),Sl=y(ss.div)`
    position: absolute;
    top: 3.5rem;
    left: 0;
