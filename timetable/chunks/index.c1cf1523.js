...
`,Mi=x.button`
	...
	${e=>"small"===e.$buttonSizeStyle?$`
                ...
                `}
`,Ri=x((({color:r,className:n,size:i=18})=>t(Bi,Object.assign({className:n,$size:i,$color:r,"data-testid":"component-loading-spinner"},{children:[e(Ei,{id:"inner1",$size:i-2,$borderWidth:2,$color:r}),e(Ai,{id:"inner2",$size:i-2,$borderWidth:2,$color:r}),e(Hi,{id:"inner3",$size:i-2,$borderWidth:2,$color:r}),e(Ti,{id:"inner4",$size:i-2,$borderWidth:2,$color:r})]}))))`
...
//# sourceMappingURL=index.c1cf1523.js.map
