...
export declare const BlockTitle: import("styled-components").StyledComponent<"h6", import("styled-components").DefaultTheme, import("../../text").TextProps, never>;
export declare const BlockDescription: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../../text").TextProps, never>;
export {};
