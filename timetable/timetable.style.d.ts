...
export declare const ColumnHeaderTitle: import("styled-components").StyledComponent<"h6", import("styled-components").DefaultTheme, import("../text").TextProps, never>;
...
export declare const ClickableRowHeaderTitle: import("styled-components").StyledComponent<"h5", import("styled-components").DefaultTheme, import("../text").TextProps & {
    $isClickable: boolean;
}, never>;
export declare const RowHeaderSubtitle: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, import("../text").TextProps & {
    $show: boolean;
}, never>;
