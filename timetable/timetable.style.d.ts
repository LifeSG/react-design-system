...
export declare const NoResultsFound: import("styled-components").StyledComponent<({ type, img, title, description, actionButton, additionalProps, imageOnly, illustrationScheme, ...otherProps }: import("../error-display").ErrorDisplayProps) => import("react/jsx-runtime").JSX.Element | null, import("styled-components").DefaultTheme, {}, never>;
