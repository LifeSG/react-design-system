...
export interface TimeTableCellStyleAttributes {
    ...
    backgroundColor?: string | ((props: V3_ThemeStyleProps) => string) | undefined;
    /** Alternate background color (used for striped patterns in blocked/pending status) */
    altBackgroundColor?: string | ((props: V3_ThemeStyleProps) => string) | undefined;
    /** Hover background color for the cell */
    hoverBackgroundColor?: string | ((props: V3_ThemeStyleProps) => string) | undefined;
    /** Alternate hover background color for the cell */
    altHoverBackgroundColor?: string | ((props: V3_ThemeStyleProps) => string) | undefined;
