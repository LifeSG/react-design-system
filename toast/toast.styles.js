import{animated as e}from"@react-spring/web";import r,{css as o}from"styled-components";import{Button as i}from"../button/button.js";import{ClickableIcon as t}from"../shared/clickable-icon/clickable-icon.js";import{Radius as n,MediaQuery as a,Font as d,Colour as c}from"../theme/index.js";import{Typography as s}from"../typography/typography.js";const l=e=>{const r={success:{Background:"bg-success",Border:"border-success",Text:"text-success",Icon:"icon-success"},warning:{Background:"bg-warning",Border:"border-warning",Text:"text-warning",Icon:"icon-warning"},error:{Background:"bg-error",Border:"border-error",Text:"text-error",Icon:"icon-error"},info:{Background:"bg-info",Border:"border-info",Text:"text-info",Icon:"icon-info"}}[e.$type];return{Background:c[r.Background],Border:c[r.Border],Text:c[r.Text],Icon:c[r.Icon]}},g=e(r.div`
    display: flex;
    flex-direction: row;
