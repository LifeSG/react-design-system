...
`,zr=n=>{var{external:r=!1,children:i}=n,a=hr(n,["external","children"]);return t(Hr,Object.assign({},a,{children:[i,r&&e(Er,{})]}))};var Mr;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Mr||(Mr={}));const Ar=e=>{const{textSize:t}=e||{};return S`
        // Text styling
        ${t&&xr(t,"regular")}
    ...
    color: ${Jt.Neutral[1]};
    ${e=>"small"===e.$sizeType?Ar({textSize:"H6"}):Ar({textSize:"BodySmall"})}
`,Cr=F.div`
    display: flex;
    margin-right: 0.5rem;
...
`,si=({type:a="checkbox",indicator:s,checked:c,styleType:d="default",children:u,childrenMaxLines:h,subLabel:m,disabled:p,error:y,name:$,id:v,className:b,compositeSection:F,removable:S,onRemove:D,"data-testid":B,onChange:w,useContentWidth:x})=>{const{collapsible:O=!0,errors:k,children:H,initialExpanded:E}=F||{},[z,M]=l(c),[A,T]=l(E),C=g((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[_]=l(yn.generate()),W=v?`${v}`:`tg-${_}`,V=o();f((()=>{M(c)}),[c]),f((()=>{z&&T(null==E||E)}),[z]);const j=e=>{if(!p){if(w)return void w(e);switch(a){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":z||M(!0)}}},R=()=>{p||T(!A)},L=()=>{p||!D||D()},Y=()=>{var e;null===(e=null==V?void 0:V.current)||void 0===e||e.click()},N=e=>{e.stopPropagation()},P=()=>{let t;switch(a){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=a}return e(Gt,{type:t,active:z,disabled:p})},I=()=>{if(!m)return null;let t;return t="function"==typeof m?m():m,e(Qr,Object.assign({"data-id":"toggle-sublabel",$disabled:p,$selected:z},{children:t}))},J=()=>{const n=!A&&!C;return O&&t(ni,Object.assign({$paddingTopRequired:n,disabled:p,onClick:R,"data-testid":A?"collapse-button":"expand-button"},{children:[A?"Show less":"Show more",e(A?i:r,{"aria-hidden":!0})]}))},Z=r=>t(n,{children:[e(oi,Object.assign({weight:"semibold",$disabled:p},{children:"Error"})),e(li,Object.assign({$disabled:p},{children:null==r?void 0:r.map(((t,n)=>e("li",Object.assign({id:`${W}-error-list-item-${n}`},{children:e(oi,Object.assign({weight:"semibold",$disabled:p},{children:t}))}),n)))}))]});return t(Zr,Object.assign({$selected:z,$disabled:p,className:b,$styleType:d,$error:y,$indicator:s,$useContentWidth:x,id:v,"data-testid":B},{children:[t(Kr,Object.assign({id:`${W}-header-container`,$disabled:p,$error:y,$selected:z,$indicator:s,$styleType:d},{children:[e(ei,Object.assign({$addPadding:S},{children:t(Ur,Object.assign({id:`${W}-input-container`,onClick:Y},{children:[e(Gr,{ref:V,name:$,id:`${W}-input`,type:"checkbox"===a?"checkbox":"radio","data-testid":"toggle-input",disabled:p,onChange:j,onClick:N,checked:z}),s&&P(),t(Xr,{children:[e(qr,Object.assign({htmlFor:`${W}-input`,$selected:z,$indicator:s,$disabled:p,"data-testid":`${W}-toggle-label`,$maxLines:h},{children:u})),m&&I()]})]}))})),S&&e(ti,Object.assign({type:"button",$disabled:p,onClick:L,id:`${W}-remove-button`},{children:"Remove"}))]})),H&&t("div",{children:[(!O||A)&&e(ai,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:p},{children:H})),O&&!A&&C&&e(ri,Object.assign({$disabled:p,onClick:R,id:`${W}-error-alert`},{children:e(ii,Object.assign({type:p?"description":"error",className:b,showIcon:!0},{children:Array.isArray(k)?Z(k):k}))})),J()]})]}))};export{si as Toggle};
