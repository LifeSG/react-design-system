...
`,li=({type:a="checkbox",indicator:s,checked:c,styleType:d="default",children:u,childrenMaxLines:h,subLabel:m,disabled:p,error:y,name:$,id:v,className:b,compositeSection:F,removable:S,onRemove:D,"data-testid":B,onChange:w,useContentWidth:x})=>{const{collapsible:O=!0,errors:k,children:H,initialExpanded:E}=F||{},[z,A]=l(c),[M,T]=l(E),C=g((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[_]=l(yn.generate()),W=v?`${v}`:`tg-${_}`,V=o();f((()=>{A(c)}),[c]),f((()=>{z&&T(null==E||E)}),[z]);const j=e=>{if(!p){if(w)return void w(e);switch(a){case"checkbox":A((e=>!e));break;case"radio":case"yes":case"no":z||A(!0)}}},R=()=>{p||T(!M)},L=()=>{p||!D||D()},N=()=>{let t;switch(a){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=a}return e(Gt,{type:t,active:z,disabled:p})},Y=()=>{if(!m)return null;let t;return t="function"==typeof m?m():m,e(qr,Object.assign({"data-id":"toggle-sublabel",$disabled:p,$selected:z},{children:t}))},P=()=>{const n=!M&&!C;return O&&t(ti,Object.assign({$paddingTopRequired:n,disabled:p,onClick:R,"data-testid":M?"collapse-button":"expand-button"},{children:[M?"Show less":"Show more",e(M?i:r,{"aria-hidden":!0})]}))},I=r=>t(n,{children:[e(ai,Object.assign({weight:"semibold",$disabled:p},{children:"Error"})),e(oi,Object.assign({$disabled:p},{children:null==r?void 0:r.map(((t,n)=>e("li",Object.assign({id:`${W}-error-list-item-${n}`},{children:e(ai,Object.assign({weight:"semibold",$disabled:p},{children:t}))}),n)))}))]});return t(Zr,Object.assign({$selected:z,$disabled:p,className:b,$styleType:d,$error:y,$indicator:s,$useContentWidth:x,id:v,"data-testid":B},{children:[t(Qr,Object.assign({id:`${W}-header-container`,$disabled:p,$error:y,$selected:z,$indicator:s,$styleType:d},{children:[t(Kr,Object.assign({$addPadding:S},{children:[e(Gr,{ref:V,name:$,id:`${W}-input`,type:"checkbox"===a?"checkbox":"radio","data-testid":"toggle-input",disabled:p,onChange:j,checked:z}),s&&N(),t(Ur,{children:[e(Xr,Object.assign({htmlFor:`${W}-input`,$selected:z,$indicator:s,$disabled:p,"data-testid":`${W}-toggle-label`,$maxLines:h},{children:u})),m&&Y()]})]})),S&&e(ei,Object.assign({type:"button",$disabled:p,onClick:L,id:`${W}-remove-button`},{children:"Remove"}))]})),H&&t("div",{children:[(!O||M)&&e(ii,Object.assign({"data-id":"toggle-composite-children",$isFinalItem:!O,$disabled:p},{children:H})),O&&!M&&C&&e(ni,Object.assign({$disabled:p,onClick:R,id:`${W}-error-alert`},{children:e(ri,Object.assign({type:p?"description":"error",className:b,showIcon:!0},{children:Array.isArray(k)?I(k):k}))})),P()]})]}))};export{li as Toggle};
