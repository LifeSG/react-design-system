...
`,On=r=>{var{external:n=!1,children:i}=r,o=hn(r,["external","children"]);return t(xn,Object.assign({},o,{children:[i,n&&e(kn,{})]}))};var Hn;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Hn||(Hn={}));const En=e=>{const{textSize:t}=e||{};return S`
        // Text styling
        ${t&&Dn(t,"regular")}
...
`,oi=({type:o="checkbox",indicator:l,checked:c,styleType:d="default",children:u,childrenMaxLines:h,subLabel:p,disabled:m,error:y,name:$,id:v,className:b,compositeSection:F,removable:S,onRemove:D,"data-testid":B,onChange:w})=>{const{collapsible:x=!0,errors:k,children:O,initialExpanded:H}=F||{},[E,M]=s(c),[A,z]=s(H),T=g((()=>{const e=Array.isArray(k)&&(null==k?void 0:k.length)>0,t=!Array.isArray(k)&&!!k;return e||t}),[k]),[_]=s(mr.generate()),j=v?`${v}`:`tg-${_}`,C=a();f((()=>{M(c)}),[c]),f((()=>{E&&z(null==H||H)}),[E]);const L=e=>{if(!m){if(w)return void w(e);switch(o){case"checkbox":M((e=>!e));break;case"radio":case"yes":case"no":E||M(!0)}}},Y=()=>{m||z(!A)},R=()=>{m||!D||D()},N=()=>{let t;switch(o){case"yes":t="tick";break;case"no":t="cross";break;case"checkbox":case"radio":t=o}return e(Ut,{type:t,active:E,disabled:m})},W=()=>{if(!p)return null;let t;return t="function"==typeof p?p():p,e(Un,Object.assign({"data-id":"toggle-sublabel",$disabled:m,$selected:E},{children:t}))},I=()=>{const r=!A&&!T;return x&&t(Qn,Object.assign({$paddingTopRequired:r,disabled:m,onClick:Y,"data-testid":A?"collapse-button":"expand-button"},{children:[A?"Show less":"Show more",e(A?i:n,{"aria-hidden":!0})]}))},P=n=>t(r,{children:[e(ni,Object.assign({weight:"semibold",$disabled:m},{children:"Error"})),e(ii,Object.assign({$disabled:m},{children:null==n?void 0:n.map(((t,r)=>e("li",Object.assign({id:`${j}-error-list-item-${r}`},{children:e(ni,Object.assign({weight:"semibold",$disabled:m},{children:t}))}),r)))}))]});return t(Pn,Object.assign({$selected:E,$disabled:m,className:b,$styleType:d,$error:y,$indicator:l,id:v,"data-testid":B},{children:[t(Xn,Object.assign({id:`${j}-header-container`,$disabled:m,$error:y,$selected:E,$indicator:l,$styleType:d},{children:[t(qn,Object.assign({$addPadding:S},{children:[e(Vn,{ref:C,name:$,id:`${j}-input`,type:"checkbox"===o?"checkbox":"radio","data-testid":"toggle-input",disabled:m,onChange:L,checked:E}),l&&N(),t(Zn,{children:[e(Gn,Object.assign({htmlFor:`${j}-input`,$selected:E,$indicator:l,$disabled:m,"data-testid":`${j}-toggle-label`,$maxLines:h},{children:u})),p&&W()]})]})),S&&e(Jn,Object.assign({type:"button",$disabled:m,onClick:R,id:`${j}-remove-button`},{children:"Remove"}))]})),O&&t(ti,{children:[(!x||A)&&e(ri,Object.assign({$isFinalItem:!x,$disabled:m},{children:O})),x&&!A&&T&&e(Kn,Object.assign({$disabled:m,onClick:Y,id:`${j}-error-alert`},{children:e(ei,Object.assign({type:m?"description":"error",className:b,showIcon:!0},{children:Array.isArray(k)?P(k):k}))})),I()]})]}))};export{oi as Toggle};
