...
`,ln={mobileS:320,mobileM:375,mobileL:480,tablet:1199,desktopM:1399,desktopL:1999,desktop4k:3840},cn=t=>Object.keys(ln).reduce(((e,n)=>{const r=ln[n];return e[n]=`@media screen and (${t}: ${r}px)`,e}),{}),sn=cn("max-width"),hn=(cn("min-width"),"all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)"),pn=a.div`
    ...
    ${t=>t.visible?l`
        ...
        `:l`
            ...
            z-index: -1;
        `}
`,fn=a((t=>{var{children:n}=t,r=c(t,["children"]);const i=r["data-testid"]||"card";return e(an,Object.assign({},r,{"data-testid":i},{children:"string"==typeof n?e(en.Body,{children:n}):n}))}))`
    border-radius: 4px;
...
`,gn=a.div`
    position: relative;
`,un=o=>{var{visible:a,position:l="top",children:s}=o,h=c(o,["visible","position","children"]);const p=h["data-testid"]||"tooltip",[f,d]=n(l),g=r(null);i((()=>(m(),window.addEventListener("resize",M(u,300)),()=>{window.removeEventListener("resize",M(u,300))})),[]);const u=()=>{m()},m=()=>{if(g.current){const t=g.current.getBoundingClientRect();if(t.x<0)switch(l){case"left":case"top":case"bottom":d("right");break;case"right":d("top")}else if(t.x+t.width>window.outerWidth)switch(l){case"right":case"top":case"bottom":d("left");break;case"left":d("top")}else d(l)}};return t(pn,Object.assign({position:f,"data-testid":p,visible:a,ref:g},h,{children:[e(fn,{children:"string"==typeof s?e(en.BodySmall,{children:s}):s}),e(dn,{position:f})]}))},mn=(n,r)=>i=>{const{tooltipVisible:o,position:a}=i,l=c(i,["tooltipVisible","position"]);return t(gn,{children:[e(n,Object.assign({},l)),e(un,Object.assign({visible:o,position:a},{children:r.content}))]})};export{un as Tooltip,mn as withTooltip};
