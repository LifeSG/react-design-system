...
export declare const Bubble: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components").FastOmit<import("../card/types").CardProps, never> & Partial<Pick<import("../card/types").CardProps, never>>> & string & Omit<({ children, ...otherProps }: import("../card/types").CardProps) => JSX.Element, keyof import("react").Component<any, {}, any>>;
