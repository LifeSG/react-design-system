...
export declare const UneditableSection: (({ items, title, description, topSection, bottomSection, children, background, onMask, onUnmask, onTryAgain, ...otherProps }: import("./types").UneditableSectionProps) => JSX.Element) & {
    ...
    Item: ({ label, value, displayWidth, maskState, maskLoadingState, maskChar, maskRange, unmaskRange, maskRegex, disableMaskUnmask, maskTransformer, onMask, onUnmask, onTryAgain, }: import("./section-item").UneditableSectionItemComponentProps) => JSX.Element;
};
