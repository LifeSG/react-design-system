...
`;var ra;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(ra||(ra={}));const oa=e=>{const{textSize:t}=e||{};return x`
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,aa=w((t=>{var{children:n}=t,r=C(t,["children"]);const o=r["data-testid"]||"card";return e(Ji,Object.assign({},r,{"data-testid":o},{children:"string"==typeof n?e(Zi.Body,{children:n}):n}))}))`
    color: ${_i.Neutral[1]};
...
`,sa=w((n=>{var{id:r="modal-box",children:o,onClose:i,showCloseButton:a=!0}=n,s=C(n,["id","children","onClose","showCloseButton"]);return t(ta,Object.assign({"data-testid":r},s,{onClick:e=>{e.stopPropagation()}},{children:[a&&e(na,Object.assign({onClick:i,"data-testid":"close-button",focusHighlight:!1},{children:e(O,{})})),o]}))}))`
...
`,ya=n=>{var{children:r,addon:o,subtitle:i,"data-testid":a}=n,s=C(n,["children","addon","subtitle","data-testid"]);return t(ma,Object.assign({},s,{children:[r,o&&o.type&&("popover"===o.type?e(ha,{addon:o}):null),"string"==typeof i?e(ga,Object.assign({as:"span","data-testid":a?`${a}-subtitle`:"subtitle"},s,{children:i})):i]}))},va=w.div`
    display: inline-block;
    position: relative;
    width: ${e=>e.$size}px;
    height: ${e=>e.$size}px;
...
`,Ma=w.span`
    color: ${_i.Neutral[3]};
`,Aa=w((({color:n,className:r,size:o=18})=>t(va,Object.assign({className:r,$size:o,$color:n},{children:[e(wa,{id:"inner1",$size:o-2,$borderWidth:2,$color:n}),e(xa,{id:"inner2",$size:o-2,$borderWidth:2,$color:n}),e($a,{id:"inner3",$size:o-2,$borderWidth:2,$color:n}),e(Sa,{id:"inner4",$size:o-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    #inner1,
    #inner2,
    #inner3,
...
`,La=w.span`
    ...
    margin-left: 0.5rem;
`,za=w((n=>{var{type:r,className:o,children:i,actionLink:a,actionLinkIcon:s,sizeType:d="default",showIcon:f=!1,customIcon:p,maxCollapsedHeight:h}=n,g=C(n,["type","className","children","actionLink","actionLinkIcon","sizeType","showIcon","customIcon","maxCollapsedHeight"]);const[y,v]=u(!1),[b,w]=u(!1),{height:x,ref:$}=function(e){void 0===e&&(e={});var t=e.skipOnMount,n=void 0!==t&&t,r=e.refreshMode,o=e.refreshRate,i=void 0===o?1e3:o,a=e.refreshOptions,s=e.handleWidth,l=void 0===s||s,d=e.handleHeight,f=void 0===d||d,p=e.targetRef,h=e.observerOptions,m=e.onResize,g=c(n),y=c(null),v=null!=p?p:y,b=c(),w=u({width:void 0,height:void 0}),x=w[0],$=w[1];return cr((function(){if(!ar()){var e=lr(m,$,l,f);b.current=or((function(t){(l||f)&&t.forEach((function(t){var n=t&&t.contentRect||{},r=n.width,o=n.height;!g.current&&!ar()&&e({width:r,height:o}),g.current=!1}))}),r,i,a);var t=new window.ResizeObserver(b.current);return v.current&&t.observe(v.current,h),function(){t.disconnect();var e=b.current;e&&e.cancel&&e.cancel()}}}),[r,i,a,l,f,m,h,v.current]),gn({ref:v},x)}();l((()=>{S()}),[h,x]);const S=()=>{v(!h),w(O())},O=()=>!!h&&x>h;return t(Oa,Object.assign({className:o,$type:r,$sizeType:d,"data-testid":g["data-testid"]},{children:[f&&e(Fa,Object.assign({$sizeType:d,$type:r},{children:(()=>{if(r&&p)return p;switch(r){case"success":return e(B,{});case"warning":return e(k,{});case"error":return e(E,{});case"info":case"description":return e(m,{});default:return null}})()})),t(Ea,{children:[t(ka,Object.assign({$maxCollapsedHeight:O()?h:void 0,$showMore:y,$hasActionLink:!!a},{children:[e("div",Object.assign({ref:$},{children:i})),a&&t(Da,Object.assign({"data-testid":"action-link",$type:r,$sizeType:d},a,{children:[a.children,s||e(D,{})]}))]})),b&&t(Ba,Object.assign({$sizeType:d,$type:r,type:"button",onClick:()=>v(!y)},{children:["Show ",y?"less":"more",e(ja,{$expanded:y})]}))]})]}))}))`
    margin-top: 0.5rem;
`,Ia=({label:i,value:a,displayWidth:s="full",maskState:c,maskLoadingState:d,maskChar:f="•",maskRange:p,unmaskRange:h,maskRegex:m,disableMaskUnmask:g,alert:y,maskTransformer:v,onMask:b,onUnmask:w,onTryAgain:x})=>{const[$,S]=u(c);l((()=>{S(c)}),[c]);const O=()=>{switch("fail"===d&&x&&x(),$){case"masked":w&&w(),S("unmasked");break;case"unmasked":b&&b(),S("masked")}},F=()=>"masked"===$?hn.maskValue(a,{maskChar:f,maskRange:p,unmaskRange:h,maskRegex:m,maskTransformer:v}):a,D=()=>{switch(d){case"fail":return t(n,{children:[e(_a,{}),e(Ha,{children:"Error"}),e(La,{children:"Try again?"})]});case"loading":return t(n,{children:[e(Aa,{}),e(Ma,{children:"Retrieving..."})]});default:return t(n,{children:[F(),e(Ra,{children:"masked"===$?e(r,{"data-testid":"masked-icon"}):e(o,{"data-testid":"unmasked-icon"})})]})}};return t(Ca,Object.assign({$widthStyle:s},{children:[e(ya,{children:i}),$?g?e(Zi.Body,{children:F()}):e(Ta,Object.assign({"data-testid":"clickable-label",onClick:O,"aria-busy":"loading"===d,"aria-live":"polite",type:"button"},{children:D()})):e(Zi.Body,{children:a}),y&&e(za,Object.assign({sizeType:"small"},y))]}))},Pa=w.div`
    position: relative;
    ${e=>{const{$desktopStart:t,$desktopSpan:n,$tabletStart:r,$tabletSpan:o,$mobileStart:i,$mobileSpan:a}=e;return x`
        ...
        `}}
`,Na=a.forwardRef(((t,n)=>{const{mobileCols:r,tabletCols:o,desktopCols:i}=t,a=C(t,["mobileCols","tabletCols","desktopCols"]);return e(Pa,Object.assign({ref:n},(()=>{const e=o||r,t=r,n=Wa(i||o||r),a=Wa(e),s=Wa(t);return{$desktopSpan:n.span,$desktopStart:n.start,$mobileSpan:s.span,$mobileStart:s.start,$tabletSpan:a.span,$tabletStart:a.start}})(),a))})),Wa=e=>{if(Array.isArray(e)&&e.length>1){const[t,n]=e,r=t<=n?t:n,o=t<=n?n:t;let i;return i=o===r?1:o-r,{start:r,span:i}}return"number"==typeof e?{start:void 0,span:e}:{start:void 0,span:void 0}},Ya=a.forwardRef(((t,n)=>{const{children:r,"data-testid":o="container",type:i="flex",stretch:a=!1}=t,s=C(t,["children","data-testid","type","stretch"]);return e(Va,Object.assign({ref:n,"data-testid":o,$type:i,$stretch:a},s,{children:r}))})),Va=w.div`
    flex-grow: 1;
    margin: 0 auto;
    position: relative;
    width: auto;
    ...
    ${e=>{switch(e.$type){case"grid":return x`
                ...
                `;default:return x`
                    display: flex;
                `}}}
`,Ua=a.forwardRef(((t,n)=>{const{children:r,"data-testid":o="section",stretch:i=!1}=t,a=C(t,["children","data-testid","stretch"]);return e(qa,Object.assign({ref:n,"data-testid":o,$stretch:i},a,{children:r}))})),qa=w.section`
    display: block;
    position: relative;
    ${e=>e.$stretch?x`
                ${Wt.tablet} {
