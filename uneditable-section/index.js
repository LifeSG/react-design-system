...
`,Mr=Object.assign((r=>{var{items:i,title:o,description:a,topSection:s,bottomSection:c,children:l}=r,u=p(r,["items","title","description","topSection","bottomSection","children"]);const d=()=>{if(i&&i.length>0){const e=i.map(((e,n)=>t(mr,Object.assign({},e),n)));return t(Er,{children:e})}return null};return t(Dr,Object.assign({},u,{children:t(Or,Object.assign({type:"grid"},{children:l||e(n,{children:[o&&t(Br,{children:o}),a&&t(_r,{children:a}),s&&t(jr,Object.assign({"data-id":"top-section"},{children:s})),d(),c&&t(jr,Object.assign({"data-id":"bottom-section"},{children:c}))]})}))}))}),{ItemSection:Er,Item:mr});export{Mr as UneditableSection};
