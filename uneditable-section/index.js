...
`,Oi=i.forwardRef(((t,n)=>{var{children:r,focusHighlight:i=!0,focusOutline:o="none",type:a="button"}=t,s=N(t,["children","focusHighlight","focusOutline","type"]);return e(xi,Object.assign({ref:n,$outline:o,$highlight:i,type:a},s,{children:r}))})),Di=h.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,ki=e=>{const{textSize:t}=e||{};return p`
    ...
    padding: 0 1rem;
    pointer-events: auto;
`,Hi=h((t=>{var{children:n}=t,r=N(t,["children"]);const i=r["data-testid"]||"card";return e(Fi,Object.assign({},r,{"data-testid":i},{children:"string"==typeof n?e(Tn.Body,{children:n}):n}))}))`
    color: ${Sn.Neutral[1]};
...
`,Ei=h((n=>{var{id:r="modal-box",children:i,onClose:o,showCloseButton:a=!0}=n,s=N(n,["id","children","onClose","showCloseButton"]);return t(Di,Object.assign({"data-testid":r},s,{onClick:e=>{e.stopPropagation()}},{children:[a&&e(Bi,Object.assign({onClick:o,"data-testid":"close-button",focusHighlight:!1},{children:e(P,{})})),i]}))}))`
...
`;h(Tn.H6)`
    ...
    margin-bottom: 0;
    outline: none;
`;const Vi=h(Tn.BodySmall)`
    && {
        color: ${Sn.Neutral[3]};
        ${Cn("BodySmall","regular")}
    }
`,Yi=n=>{var{children:r,addon:i,subtitle:o,"data-testid":a}=n,s=N(n,["children","addon","subtitle","data-testid"]);return t(Wi,Object.assign({},s,{children:[r,i&&i.type&&("popover"===i.type?e(Li,{addon:i}):null),"string"==typeof o?e(Vi,Object.assign({as:"span","data-testid":a?`${a}-subtitle`:"subtitle"},s,{children:o})):o]}))},Ni=h.div`
    display: inline-block;
    position: relative;
    width: ${e=>e.$size}px;
    height: ${e=>e.$size}px;
...
`,so=h.span`
    color: ${Sn.Neutral[3]};
`,lo=h((({color:n,className:r,size:i=18})=>t(Ni,Object.assign({className:r,$size:i,$color:n,"data-testid":"component-loading-spinner"},{children:[e(Ui,{id:"inner1",$size:i-2,$borderWidth:2,$color:n}),e(qi,{id:"inner2",$size:i-2,$borderWidth:2,$color:n}),e(Zi,{id:"inner3",$size:i-2,$borderWidth:2,$color:n}),e(Qi,{id:"inner4",$size:i-2,$borderWidth:2,$color:n})]}))))`
    margin-right: 0.5rem;
    #inner1,
    #inner2,
    #inner3,
