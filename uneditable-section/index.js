...
`,Fo=t=>{var{ariaLabel:n,content:i,icon:o,underlineStyle:a="default",underlineHoverStyle:s="default"}=t,l=U(t,["ariaLabel","content","icon","underlineStyle","underlineHoverStyle"]);const d=!!i;return e(yo,Object.assign({},l,{children:r(xo,{role:"button","aria-haspopup":"dialog",tabIndex:0,$defaultStyle:a,$hoverStyle:s,"aria-label":null!=n?n:d?void 0:"More info",children:[i,o&&e(wo,{$standalone:!d,children:o})]})}))},$o=m.div`
    ...
    display: inline;
`,Eo=({addon:r,rootNode:t})=>{const{content:n,type:i,icon:o,id:a,zIndex:s,"data-testid":l}=r;return e($o,{children:e(Fo,{trigger:"click",id:a,"data-testid":l,popoverContent:n,rootNode:t,zIndex:s,icon:null!=o?o:e(x,{"data-testid":`${i}-icon`}),ariaLabel:"More info"})})},Co=m.label`
...
`;const Do=m.span`
    ...
    display: block;
`,Oo=t=>{var{children:n,addon:i,subtitle:o,"data-testid":a}=t,s=U(t,["children","addon","subtitle","data-testid"]);return r(Co,Object.assign({},s,{children:[n,i&&i.type&&("popover"===(null==i?void 0:i.type)?e(Eo,{addon:i}):null),"string"==typeof o?e(Do,Object.assign({"data-testid":a?`${a}-subtitle`:"subtitle"},s,{children:o})):o]}))},So=m.div`
