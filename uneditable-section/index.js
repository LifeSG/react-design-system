...
`,Vo=a.div`
    ...
    ${e=>{let t="";return e.$show?t+=l`
            ...
            `,e.$disableTransition&&(t+=l`
                transition: none;
            `),t}}
`,Uo=({show:e=!1,rootId:n,onOverlayClick:r,children:o,backgroundOpacity:i,backgroundBlur:a=!0,disableTransition:s=!1,enableOverlayClick:l=!1,zIndex:c,id:u})=>{const[d,p]=m(null),[y,b]=m(),[x]=m((()=>No.generate())),w=g(),S=g(null),$=o&&f.cloneElement(o,{ref:S}),F=u?`lifesg-ds-overlay-root-${u}`:"lifesg-ds-overlay-root";h((()=>(B(),p(O()),()=>{M(),C().length<1&&k("remove")})),[]),h((()=>{if(e){const e=E();D(e),A();const t=setTimeout((()=>{k("add")}),200);return()=>clearTimeout(t)}{M();const e=setTimeout((()=>{C().length<1&&k("remove")}),200);return()=>clearTimeout(e)}}),[e]);const D=e=>{w.current=e,b(e)},O=()=>document&&n?document.getElementById(n):document?document.body:null,E=()=>C().length>0,B=()=>{if(!document.getElementById(qo)){const e=document.createElement("style");e.id=qo;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${Zo} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${Zo}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},k=e=>{const t=document.body.classList.contains(Zo);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(Zo):document.body.classList.add(Zo)},C=()=>{const e=document.body.dataset.lifesgDsOverlayOrder;return e?e.split(","):[]},A=()=>{const e=C();document.body.dataset.lifesgDsOverlayOrder=[...e,x].join(",")},M=()=>{const e=C();document.body.dataset.lifesgDsOverlayOrder=e.filter((e=>e!==x)).join(",")},j=e=>{var t;const n=null===(t=S.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||r&&l&&(e.preventDefault(),r())};return d?v.createPortal(t(Yo,Object.assign({id:F,"data-testid":F,$show:e,zIndex:c,$stacked:y},{children:o&&t(Vo,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:i||(y?.5:.8),$backgroundBlur:a,$disableTransition:s,$enableOverlayClick:l,onClick:j},{children:$}))})),d):null},qo="lifesg-ds-overlay-stylesheet",Zo="lifesg-ds-overlay-open",Qo=a.div`
    position: relative;
    display: flex;
    justify-content: center;
    align-items: center;
...
`,li=r=>{var{children:o,visible:i,onMobileClose:a}=r,s=w(r,["children","visible","onMobileClose"]);const l=s["data-testid"]||"popover",c=xo.useMediaQuery({maxWidth:Wt.mobileL}),u=()=>{a&&a()},d=()=>"string"==typeof o?t(un.BodySmall,{children:o}):o;return e(n,{children:[i&&t(oi,Object.assign({"data-testid":l},s,{children:t(ii,{children:d()})})),c&&t(Xo,Object.assign({show:i,onOverlayClick:u},{children:t(ai,Object.assign({onClose:u},{children:t(si,{children:d()})}))}))]})},ci=a.div`
    ...
    cursor: pointer;
    position: relative;
`,ui=r=>{var{children:o,popoverContent:i,trigger:a="click",position:s="top",rootNode:l,onPopoverAppear:c,onPopoverDismiss:u}=r,d=w(r,["children","popoverContent","trigger","position","rootNode","onPopoverAppear","onPopoverDismiss"]);const[f,p]=m(!1),y=g(),v=xo.useMediaQuery({maxWidth:Ut.mobileL}),{refs:b,floatingStyles:x}=yo({open:f,placement:s,whileElementsMounted:xr,middleware:[ar(16),Sr(),wr({limiter:$r()})]});h((()=>{if(!v&&f)return document.addEventListener("mousedown",S),()=>{document.removeEventListener("mousedown",S)}}),[f]);const S=e=>{y&&!y.current.contains(e.target)&&(p(!1),u&&u())},$=()=>{p(!1)};return e(n,{children:[f&&t(ho,Object.assign({root:l},{children:t("div",Object.assign({ref:b.setFloating,style:Object.assign({},x)},{children:"function"==typeof i?i():t(li,Object.assign({visible:!0,onMobileClose:$},{children:i}))}))})),t(ci,Object.assign({ref:e=>{y.current=e,b.setReference(e)},onClick:e=>{e.preventDefault(),("click"===a||v)&&(p(!f),!f&&c&&c(),f&&u&&u())},onMouseEnter:()=>{"hover"!==a||v||p(!0)},onMouseLeave:()=>{"hover"===a&&f&&!v&&p(!1)}},d,{children:o}))]})},di=a.button`
...
`,fi=a.div`
    ...
    position: relative;
    width: fit-content;
`,pi=({addon:e,rootNode:n})=>{const{content:r,type:o,icon:i,id:a,"data-testid":s}=e;return t(ui,Object.assign({trigger:"click",id:a,"data-testid":s,popoverContent:r,rootNode:n},{children:t(fi,{children:t(di,{children:i||t(u,{id:`${o}-icon`})})})}))},hi=a.label`
    ${ln("H5","semibold")}
    color: ${Nt.Neutral[3]};
