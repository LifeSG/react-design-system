...
`,vn=n=>{var{external:r=!1,children:o}=n,i=p(n,["external","children"]);return e(gn,Object.assign({},i,{children:[o,r&&t(yn,{})]}))},bn=r.div`
    border-radius: 0.5rem;
    background: ${nn[8]};
    padding: 1rem 2rem;
    box-shadow: 0 0.125rem 0.5rem rgba(104, 104, 104, 0.25);
`,wn=e=>{var{children:n}=e,r=p(e,["children"]);const o=r["data-testid"]||"card";return t(bn,Object.assign({},r,{"data-testid":o},{children:"string"==typeof n?t(mn.Body,{children:n}):n}))},xn=r.div`
    position: fixed;
    left: 0;
    top: 0;
    height: 0;
...
`,Sn=r.div`
    ...
    ${e=>{let t="";return e.$show?t+=o`
            ...
            `,e.$disableTransition&&(t+=o`
                transition: none;
            `),t}}
`,$n=({show:e=!1,rootId:n,onOverlayClick:r,children:o,backgroundOpacity:i,backgroundBlur:u=!0,disableTransition:f=!1,enableOverlayClick:p=!1,zIndex:h,id:m})=>{const[g,y]=l(null),[v,b]=l(),w=c(),x=c(!1),S=c(null),$=o&&a.cloneElement(o,{ref:S}),F=m?`lifesg-ds-overlay-root-${m}`:"lifesg-ds-overlay-root";s((()=>{const t=!0===x.current;if(t||(x.current=!0),e){const e=B();if(O(e),!e){const e=setTimeout((()=>{E("add")}),200);return()=>clearTimeout(e)}}else{if(!t)return;if(!w.current){const e=setTimeout((()=>{E("remove")}),200);return()=>clearTimeout(e)}}}),[e]),s((()=>{y(j());const e=B();return O(e),e||_(),()=>{E("remove")}}),[]);const O=e=>{w.current=e,b(e)},j=()=>document&&n?document.getElementById(n):document?document.body:null,B=()=>document.body.classList.contains(On),_=()=>{if(!document.getElementById(Fn)){const e=document.createElement("style");e.id=Fn;const t=document.documentElement.clientWidth,n=window.innerWidth-t;e.innerHTML=`\n\t\t\t\t.${On} {\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t\tpadding-right: ${n}px !important;\n\t\t\t\t\t-ms-overflow-style: none;\n\t\t\t\t\tscrollbar-width: none;\n\t\t\t\t}\n\n\t\t\t\t.${On}::-webkit-scrollbar {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t`,document.body.appendChild(e)}},E=e=>{const t=document.body.classList.contains(On);"add"!==e||t?"remove"===e&&t&&document.body.classList.remove(On):document.body.classList.add(On)},k=e=>{var t;const n=null===(t=S.current)||void 0===t?void 0:t.firstChild;n&&n.contains(e.target)||r&&p&&(e.preventDefault(),r())};return g?d.createPortal(t(xn,Object.assign({id:F,"data-testid":F,$show:e,zIndex:h,$stacked:v},{children:o&&t(Sn,Object.assign({"data-testid":"overlay-wrapper",$show:e,$backgroundOpacity:i||(v?.5:.8),$backgroundBlur:u,$disableTransition:f,$enableOverlayClick:p,onClick:k},{children:$}))})),g):null},Fn="lifesg-ds-overlay-stylesheet",On="lifesg-ds-overlay-open",jn=r.div`
    position: relative;
    display: flex;
...
`,En=a.forwardRef(((e,n)=>{var{children:r,focusHighlight:o=!0,focusOutline:i="none",type:a="button"}=e,l=p(e,["children","focusHighlight","focusOutline","type"]);return t(_n,Object.assign({ref:n,$outline:i,$highlight:o,type:a},l,{children:r}))})),kn=r.div`
    position: relative;
    display: flex;
    flex-direction: column;
    width: 40rem;
...
`,Cn=r(f)`
    ...
    width: 1.5rem;
    color: ${nn[3]};
`,Hn="all 300ms cubic-bezier(0.21, 0.79, 0.53, 1)",Tn=r.div`
    max-width: 30rem;
    pointer-events: auto;
    position: absolute;
...
`,zn=r((n=>{var{id:r="modal-box",children:o,onClose:i,showCloseButton:a=!0}=n,l=p(n,["id","children","onClose","showCloseButton"]);return e(kn,Object.assign({"data-testid":r},l,{onClick:e=>{e.stopPropagation()}},{children:[a&&t(Dn,Object.assign({onClick:i,"data-testid":"close-button",focusHighlight:!1},{children:t(Cn,{})})),o]}))}))`
...
`,In=r=>{var{children:o,visible:i,onMobileClose:a}=r,u=p(r,["children","visible","onMobileClose"]);const d=u["data-testid"]||"popover",[f,m]=l("none"),g=c(null),y=w.exports.useMediaQuery({maxWidth:h.mobileL}),v=c(f);s((()=>(S(),window.addEventListener("resize",oe(b,300)),()=>{window.removeEventListener("resize",oe(b,300))})),[]);const b=()=>{S()},x=()=>{a&&a()},S=()=>{const e=$();var t;e&&(t=e,v.current=t,m(t))},$=()=>{if(g.current){const e=g.current.getBoundingClientRect(),t=24,n=e.y<t,r=window.innerWidth-t;return e.x<t?n?"top-left":"left":e.x+e.width>r?n?"top-right":"right":("top-left"===v.current||"left"===v.current)&&e.x-e.width/2>t||("top-right"===v.current||"right"===v.current)&&e.x+2*e.width<r?n?"top-center":"none":n?"top-center":void 0}},F=()=>"string"==typeof o?t(mn.BodySmall,{children:o}):o;return e(n,{children:[t(Tn,Object.assign({ref:g,"data-testid":d,$visible:i,$offset:f},u,{children:t(wn,{children:F()})})),y&&t(Bn,Object.assign({show:i,onOverlayClick:x},{children:t(zn,Object.assign({onClose:x},{children:t(An,{children:F()})}))}))]})},Ln=r.button`
...
`;r(mn.H6)`
    ...
    margin-bottom: 0;
    outline: none;
`;const Nn=r(mn.BodySmall)`
    color: ${nn[3]};
`,qn=n=>{var{children:r,addon:o,subtitle:i,"data-testid":a}=n,l=p(n,["children","addon","subtitle","data-testid"]);return e(Vn,Object.assign({},l,{children:[r,o&&o.type&&("popover"===o.type?o&&t(Rn,{addon:o}):null),"string"==typeof i?t(Nn,Object.assign({as:"span","data-testid":a?`${a}-subtitle`:"subtitle"},l,{children:i})):i]}))},Qn=({label:n,value:r,displayWidth:o="full"})=>e(y,Object.assign({$widthStyle:o},{children:[t(qn,{children:n}),t(mn.Body,{children:r})]})),Xn=r.div`
    position: relative;
    ${e=>{const{$desktopStart:t,$desktopSpan:n,$tabletStart:r,$tabletSpan:i,$mobileStart:a,$mobileSpan:l}=e;return o`
        ...
        `}}
`,Gn=a.forwardRef(((e,n)=>{const{mobileCols:r,tabletCols:o,desktopCols:i}=e,a=p(e,["mobileCols","tabletCols","desktopCols"]);return t(Xn,Object.assign({ref:n},(()=>{const e=o||r,t=r,n=Un(i||o||r),a=Un(e),l=Un(t);return{$desktopSpan:n.span,$desktopStart:n.start,$mobileSpan:l.span,$mobileStart:l.start,$tabletSpan:a.span,$tabletStart:a.start}})(),a))})),Un=e=>{if(Array.isArray(e)&&e.length>1){const[t,n]=e,r=t<=n?t:n,o=t<=n?n:t;let i;return i=o===r?1:o-r,{start:r,span:i}}return"number"==typeof e?{start:void 0,span:e}:{start:void 0,span:void 0}},Yn=a.forwardRef(((e,n)=>{const{children:r,"data-testid":o="container",type:i="flex",stretch:a=!1}=e,l=p(e,["children","data-testid","type","stretch"]);return t(Jn,Object.assign({ref:n,"data-testid":o,$type:i,$stretch:a},l,{children:r}))})),Jn=r.div`
    flex-grow: 1;
    margin: 0 auto;
    position: relative;
    width: auto;
    ...
    ${e=>{switch(e.$type){case"grid":return o`
                ...
                `;default:return o`
                    display: flex;
                `}}}
`,Kn=a.forwardRef(((e,n)=>{const{children:r,"data-testid":o="section",stretch:i=!1}=e,a=p(e,["children","data-testid","stretch"]);return t(Zn,Object.assign({ref:n,"data-testid":o,$stretch:i},a,{children:r}))})),Zn=r.section`
    display: block;
    position: relative;
    ${e=>e.$stretch?o`
                ${g.tablet} {
...
`,cr=Object.assign((r=>{var{items:o,title:i,description:a,topSection:l,bottomSection:c,children:s}=r,u=p(r,["items","title","description","topSection","bottomSection","children"]);const d=()=>{if(o&&o.length>0){const e=o.map(((e,n)=>t(Qn,Object.assign({},e),n)));return t(lr,{children:e})}return null};return t(nr,Object.assign({},u,{children:t(rr,Object.assign({type:"grid"},{children:s||e(n,{children:[i&&t(or,{children:i}),a&&t(ir,{children:a}),l&&t(ar,Object.assign({"data-id":"top-section"},{children:l})),d(),c&&t(ar,Object.assign({"data-id":"bottom-section"},{children:c}))]})}))}))}),{ItemSection:lr,Item:Qn});export{cr as UneditableSection};
