...
`,Zt=r=>{var{external:n=!1,children:a}=r,o=h(r,["external","children"]);return e(Vt,Object.assign({},o,{children:[a,n&&t(Pt,{})]}))};var Ut;!function(e){e[e.Subpage=0]="Subpage",e[e.Domain=1]="Domain"}(Ut||(Ut={}));const Gt=c`
...
`,wr=l.div`
    display: flex;
    width: 100%;
`,Er=n.forwardRef(((n,i)=>{var{value:s,spacing:l,type:c,error:u,disabled:d,readOnly:f,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:F="bordered"}=n,v=h(n,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const $=a();o(i,(()=>$.current),[]);const D=Br({ref:$,formatter:e=>Dr.transformWithSpaces(e,l)}),B=e=>{g&&(b()?x(e):g(e))},S=()=>{p&&p(),$&&$.current&&$.current.focus()},b=()=>"tel"===c&&l,x=e=>{const{nextValue:t,updateCaretPosition:r}=D(),n=t.replace(/\s/g,"");e.target.value=n,g(e),r()},w=s?(e=>e?b()?Dr.transformWithSpaces(e,l):e:"")(s):s,E=()=>e(r,{children:[t(Sr,Object.assign({"data-testid":"input",ref:$,disabled:d,value:w,onChange:B,type:c,readOnly:f},v)),m&&!d&&!f&&!!s&&t(br,Object.assign({onClick:S,type:"button"},{children:t(xr,{"aria-hidden":!0})}))]});return t(r,{children:"no-border"===F?t(wr,Object.assign({className:y},{children:E()})):t(Kt,Object.assign({$disabled:d,$error:u,$readOnly:f,className:y},{children:E()}))})}));l.div`
    display: flex;
    position: relative;
    border: 1px solid ${Ht.Neutral[5]};
    border-radius: 4px;
...
`,_r=l(jt.Body)`
    ${e=>{if(e.$inactive)return c`
                color: ${Ht.Neutral[3]};
            `}}
`,Tr=n=>{var{disabled:o,error:l,value:c,onChange:u,onBlur:d,onChangeRaw:f,onBlurRaw:g,readOnly:p,placeholder:m="00-8888"}=n,y=h(n,["disabled","error","value","onChange","onBlur","onChangeRaw","onBlurRaw","readOnly","placeholder"]);const[F,v]=i(""),[$,D]=i(""),[B,S]=i("none"),b=a(null),x=a(null),w=a(null),E=a(F),H=a($),O=a(B),k=e=>e.toLocaleUpperCase().replace(/[^0-9A-Za-z]/g,""),C=Br({ref:x,formatter:k}),M=Br({ref:w,formatter:k}),A=e=>{E.current=e,v(e)},_=e=>{H.current=e,D(e)},T=e=>{O.current=e,S(e)};s((()=>{"floor"===B&&3===F.length&&w.current&&w.current.focus()}),[F]),s((()=>{I(c)}),[c]);const z=e=>{T(e.target.name),e.target.select()},Y=e=>{const t=e.target.name,r=e.target.value,n=N(r);"floor"===t?(A(n),n!==F&&R(n,t)):(_(n),n!==$&&R(n,t))},L=e=>{const t=e.target.name;if("floor"===t){const{nextValue:e,updateCaretPosition:r}=C();r(),A(e),R(e,t)}else{const{nextValue:e,updateCaretPosition:r}=M();r(),_(e),R(e,t)}},W=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||"unit"===B&&0===$.length&&x.current.focus()},N=e=>/^[0-9]$/.test(e)?Dr.padValue(e,!0):e.toLocaleUpperCase(),I=e=>{if(e!==zr)if(void 0===e||0===e.length)A(""),_("");else{const t=e.split("-");if(2===t.length){const e=t[0],r=t[1];A("floor"===B?e:N(e)),_("unit"===B?r:N(r))}}},R=(e,t)=>{if(!u&&!f)return;const r={floor:E.current,unit:H.current};if(r[t]=e,u){const e=V(r);u(e)}f&&f([r.floor,r.unit])},j=()=>{if(!d&&!g)return;const e={floor:N(E.current),unit:N(H.current)};if(d){const t=V(e);d(t)}g&&g([e.floor,e.unit])},V=e=>{const t=[e.floor,e.unit];return e.floor.length>0&&e.unit.length>0?t.join("-"):t.every((e=>""===e))?"":zr},P=e=>e.split("-");return e(Kt,Object.assign({},y,{ref:b,onClick:()=>{"none"===B&&x.current&&x.current.focus()},$disabled:o,$error:l,$readOnly:p,tabIndex:-1,onBlur:e=>{b.current&&b.current.contains(e.relatedTarget)||"none"!==O.current&&(T("none"),j())}},{children:[t(Or,Object.assign({"data-testid":"addon",disabled:o,$readOnly:p},{children:"#"})),p&&c?(()=>{const r=c.split("-");return e(Ar,{children:[t(_r,{children:r[0]}),t(Mr,{children:"-"}),t(_r,{children:r[1]})]})})():e(r,{children:[t(kr,{name:"floor",maxLength:3,value:F,ref:x,onFocus:z,onBlur:Y,onChange:L,disabled:o,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,3}","data-testid":"floor-input","aria-label":"floor-input",placeholder:"floor"!==B||p?P(m)[0]:""}),t(Mr,Object.assign({$inactive:0===F.length},{children:"-"})),t(Cr,{name:"unit",maxLength:5,value:$,ref:w,onFocus:z,onBlur:Y,onChange:L,onKeyDown:W,disabled:o,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,5}","data-testid":"unit-input","aria-label":"unit-input",placeholder:"unit"!==B||p?P(m)[1]:""})]})]}))},zr="Invalid unit number";export{Tr as UnitNumberInput};
