...
`,Sn=s.div`
    display: flex;
    width: 100%;
`,Fn=r.forwardRef(((r,a)=>{var{value:l,spacing:s,type:c,error:u,disabled:d,readOnly:f,onChange:g,onClear:p,allowClear:m=!1,className:y,styleType:v="bordered"}=r,$=h(r,["value","spacing","type","error","disabled","readOnly","onChange","onClear","allowClear","className","styleType"]);const S=i();o(a,(()=>S.current),[]);const F=mn({ref:S,formatter:e=>pn.transformWithSpaces(e,s)}),b=e=>{g&&(B()?w(e):g(e))},D=()=>{p&&p(),S&&S.current&&S.current.focus()},B=()=>"tel"===c&&s,w=e=>{const{nextValue:t,updateCaretPosition:n}=F(),r=t.replace(/\s/g,"");e.target.value=r,g(e),n()},x=l?(e=>e?B()?pn.transformWithSpaces(e,s):e:"")(l):l,H=()=>e(n,{children:[t(yn,Object.assign({"data-testid":"input",ref:S,disabled:d,value:x,onChange:b,type:c,readOnly:f},$)),m&&!d&&!f&&!!l&&t(vn,Object.assign({onClick:D,type:"button"},{children:t($n,{"aria-hidden":!0})}))]});return t(n,{children:"no-border"===v?t(Sn,Object.assign({className:y},{children:H()})):t(Zt,Object.assign({$disabled:d,$error:u,$readOnly:f,className:y},{children:H()}))})}));s.div`
    display: flex;
    position: relative;
    border: 1px solid ${Ht.Neutral[5]};
    border-radius: 4px;
...
`,On=s(It.Body)`
    ${e=>{if(e.$inactive)return c`
                color: ${Ht.Neutral[3]};
            `}}
`,Mn=r=>{var{disabled:o,error:s,value:c,onChange:u,onBlur:d,onChangeRaw:f,onBlurRaw:g,readOnly:p,placeholder:m="00-8888"}=r,y=h(r,["disabled","error","value","onChange","onBlur","onChangeRaw","onBlurRaw","readOnly","placeholder"]);const[v,$]=a(""),[S,F]=a(""),[b,D]=a("none"),B=i(null),w=i(null),x=i(null),H=i(v),O=i(S),M=i(b),E=e=>e.toLocaleUpperCase().replace(/[^0-9A-Za-z]/g,""),_=mn({ref:w,formatter:E}),k=mn({ref:x,formatter:E}),A=e=>{H.current=e,$(e)},C=e=>{O.current=e,F(e)},z=e=>{M.current=e,D(e)};l((()=>{"floor"===b&&3===v.length&&x.current&&x.current.focus()}),[v]),l((()=>{I(c)}),[c]);const T=e=>{z(e.target.name),e.target.select()},W=e=>{const t=e.target.name,n=e.target.value,r=L(n);"floor"===t?(A(r),r!==v&&j(r,t)):(C(r),r!==S&&j(r,t))},N=e=>{const t=e.target.name;if("floor"===t){const{nextValue:e,updateCaretPosition:n}=_();n(),A(e),j(e,t)}else{const{nextValue:e,updateCaretPosition:n}=k();n(),C(e),j(e,t)}},Y=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||"unit"===b&&0===S.length&&w.current.focus()},L=e=>/^[0-9]$/.test(e)?pn.padValue(e,!0):e.toLocaleUpperCase(),I=e=>{if(e!==En)if(void 0===e||0===e.length)A(""),C("");else{const t=e.split("-");if(2===t.length){const e=t[0],n=t[1];A("floor"===b?e:L(e)),C("unit"===b?n:L(n))}}},j=(e,t)=>{if(!u&&!f)return;const n={floor:H.current,unit:O.current};if(n[t]=e,u){const e=V(n);u(e)}f&&f([n.floor,n.unit])},R=()=>{if(!d&&!g)return;const e={floor:L(H.current),unit:L(O.current)};if(d){const t=V(e);d(t)}g&&g([e.floor,e.unit])},V=e=>{const t=[e.floor,e.unit];return e.floor.length>0&&e.unit.length>0?t.join("-"):t.every((e=>""===e))?"":En},P=e=>e.split("-");return e(Zt,Object.assign({ref:B,onClick:()=>{"none"===b&&w.current&&w.current.focus()},$disabled:o,$error:s,$readOnly:p,"data-testid":y["data-testid"],tabIndex:-1,onBlur:e=>{B.current&&B.current.contains(e.relatedTarget)||"none"!==M.current&&(z("none"),R())}},{children:[t(Dn,Object.assign({"data-testid":"addon",disabled:o,$readOnly:p},{children:"#"})),p&&c?(()=>{const n=c.split("-");return e(Hn,{children:[t(On,{children:n[0]}),t(xn,{children:"-"}),t(On,{children:n[1]})]})})():e(n,{children:[t(Bn,{name:"floor",maxLength:3,value:v,ref:w,onFocus:T,onBlur:W,onChange:N,disabled:o,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,3}","data-testid":"floor-input","aria-label":"floor-input",placeholder:"floor"!==b||p?P(m)[0]:""}),t(xn,Object.assign({$inactive:0===v.length},{children:"-"})),t(wn,{name:"unit",maxLength:5,value:S,ref:x,onFocus:T,onBlur:W,onChange:N,onKeyDown:Y,disabled:o,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,5}","data-testid":"unit-input","aria-label":"unit-input",placeholder:"unit"!==b||p?P(m)[1]:""})]})]}))},En="Invalid unit number";export{Mn as UnitNumberInput};
