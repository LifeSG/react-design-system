...
`,hn=d(Yt.Body)`
    ${e=>{if(e.$inactive)return u`
                color: ${Ht.Neutral[3]};
            `}}
`,gn=({disabled:e,error:o,value:i,onChange:d,onBlur:u,onChangeRaw:h,onBlurRaw:g,readOnly:s,placeholder:p="00-8888",...f})=>{const[y,m]=l(""),[v,S]=l(""),[F,b]=l("none"),B=a(null),$=a(null),w=a(null),H=a(y),x=a(v),D=a(F),C=e=>{H.current=e,m(e)},_=e=>{x.current=e,S(e)},k=e=>{D.current=e,b(e)};c((()=>(document.addEventListener("mousedown",E),B.current&&B.current.addEventListener("keydown",z),()=>{document.removeEventListener("mousedown",E),B.current&&B.current.removeEventListener("keydown",z)})),[F]),c((()=>{"floor"===F&&3===y.length&&w.current&&w.current.focus()}),[y]),c((()=>{j(i)}),[i]);const E=t=>{e||s||B&&B.current.contains(t.target)||"none"!==D.current&&(k("none"),T())},z=e=>{"unit"===e.target.name&&"Tab"===e.code&&(k("none"),T())},O=e=>{k(e.target.name),e.target.select()},A=e=>{const t=e.target.name,n=e.target.value;"floor"===t?C(V(n)):_(V(n))},N=e=>{const t=e.target.name,n=e.target.value.toLocaleUpperCase().replace(/[^0-9A-Za-z]/,"");"floor"===t?(C(n),L(n,t)):(_(n),L(n,t))},W=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||"unit"===F&&0===v.length&&$.current.focus()},V=e=>/^[0-9]$/.test(e)?Et.padValue(e,!0):e.toLocaleUpperCase(),j=e=>{if(e!==sn)if(void 0===e||0===e.length)C(""),_("");else{const t=e.split("-");if(2===t.length){const e=t[0],n=t[1];C("floor"===F?e:V(e)),_("unit"===F?n:V(n))}}},L=(e,t)=>{if(!d&&!h)return;const n={floor:H.current,unit:x.current};if(n[t]=e,d){const e=I(n);d(e)}h&&h([n.floor,n.unit])},T=()=>{if(!u&&!g)return;const e={floor:V(H.current),unit:V(x.current)};if(u){const t=I(e);u(t)}g&&g([e.floor,e.unit])},I=e=>{const t=[e.floor,e.unit];return e.floor.length>0&&e.unit.length>0?t.join("-"):t.every((e=>""===e))?"":sn},R=e=>e.split("-");return t(kt,{ref:B,onClick:()=>{"none"===F&&$.current&&$.current.focus()},disabled:e,$error:o,$readOnly:s,"data-testid":f["data-testid"],children:[n(an,{"data-testid":"addon",disabled:e,$readOnly:s,children:"#"}),s&&i?(()=>{const e=i.split("-");return t(un,{children:[n(hn,{children:e[0]}),n(dn,{children:"-"}),n(hn,{children:e[1]})]})})():t(r,{children:[n(ln,{name:"floor",maxLength:3,value:y,ref:$,onFocus:O,onBlur:A,onChange:N,disabled:e,readOnly:s,type:"text",pattern:"[0-9A-Z]{2,3}","data-testid":"floor-input","aria-label":"floor-input",placeholder:"floor"!==F||s?R(p)[0]:""}),n(dn,{$inactive:0===y.length,children:"-"}),n(cn,{name:"unit",maxLength:5,value:v,ref:w,onFocus:O,onBlur:A,onChange:N,onKeyDown:W,disabled:e,readOnly:s,type:"text",pattern:"[0-9A-Z]{2,5}","data-testid":"unit-input","aria-label":"unit-input",placeholder:"unit"!==F||s?R(p)[1]:""})]})]})},sn="Invalid unit number";export{gn as UnitNumberInput};
