...
`,Ln=s(Jt.Body)`
    ${e=>{if(e.$inactive)return u`
                color: ${Ot.Neutral[3]};
            `}}
`,In=r=>{var{disabled:i,error:s,value:u,onChange:c,onBlur:d,onChangeRaw:f,onBlurRaw:g,readOnly:p,placeholder:m="00-8888",autoComplete:F}=r,y=h(r,["disabled","error","value","onChange","onBlur","onChangeRaw","onBlurRaw","readOnly","placeholder","autoComplete"]);const[S,B]=o(""),[v,D]=o(""),[$,b]=o("none"),x=a(null),w=a(null),H=a(null),O=a(S),E=a(v),k=a($),C=e=>e.toLocaleUpperCase().replace(/[^0-9A-Za-z]/g,""),A=Hn({ref:w,formatter:C}),M=Hn({ref:H,formatter:C}),z=e=>{O.current=e,B(e)},_=e=>{E.current=e,D(e)},W=e=>{k.current=e,b(e)};l((()=>{"floor"===$&&3===S.length&&H.current&&H.current.focus()}),[S]),l((()=>{P(u)}),[u]);const T=e=>{W(e.target.name),e.target.select()},Y=e=>{const t=e.target.name,n=e.target.value,r=R(n);"floor"===t?(z(r),r!==S&&N(r,t)):(_(r),r!==v&&N(r,t))},L=e=>{const t=e.target.name;if("floor"===t){const{nextValue:e,updateCaretPosition:n}=A();n(),z(e),N(e,t)}else{const{nextValue:e,updateCaretPosition:n}=M();n(),_(e),N(e,t)}},I=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||"unit"===$&&0===v.length&&w.current.focus()},R=e=>/^[0-9]$/.test(e)?wn.padValue(e,!0):e.toLocaleUpperCase(),P=e=>{if(e!==Rn)if(void 0===e||0===e.length)z(""),_("");else{const t=e.split("-");if(2===t.length){const e=t[0],n=t[1];z("floor"===$?e:R(e)),_("unit"===$?n:R(n))}}},N=(e,t)=>{if(!c&&!f)return;const n={floor:O.current,unit:E.current};if(n[t]=e,c){const e=V(n);c(e)}f&&f([n.floor,n.unit])},j=()=>{if(!d&&!g)return;const e={floor:R(O.current),unit:R(E.current)};if(d){const t=V(e);d(t)}g&&g([e.floor,e.unit])},V=e=>{const t=[e.floor,e.unit];return e.floor.length>0&&e.unit.length>0?t.join("-"):t.every((e=>""===e))?"":Rn},J=e=>e.split("-");return e(nn,Object.assign({},y,{ref:x,onClick:()=>{"none"===$&&w.current&&w.current.focus()},$disabled:i,$error:s,$readOnly:p,tabIndex:-1,onBlur:e=>{x.current&&x.current.contains(e.relatedTarget)||"none"!==k.current&&(W("none"),j())}},{children:[t(zn,Object.assign({"data-testid":"addon",disabled:i,$readOnly:p},{children:"#"})),p&&u?(()=>{const n=u.split("-");return e(Yn,{children:[t(Ln,{children:n[0]}),t(Tn,{children:"-"}),t(Ln,{children:n[1]})]})})():e(n,{children:[t(_n,{name:"floor",maxLength:3,value:S,ref:w,onFocus:T,onBlur:Y,onChange:L,disabled:i,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,3}","data-testid":"floor-input","aria-label":"floor-input",placeholder:"floor"!==$||p?J(m)[0]:"",autoComplete:F}),t(Tn,Object.assign({$inactive:0===S.length},{children:"-"})),t(Wn,{name:"unit",maxLength:5,value:v,ref:H,onFocus:T,onBlur:Y,onChange:L,onKeyDown:I,disabled:i,readOnly:p,type:"text",pattern:"[0-9A-Z]{2,5}","data-testid":"unit-input","aria-label":"unit-input",placeholder:"unit"!==$||p?J(m)[1]:"",autoComplete:F})]})]}))},Rn="Invalid unit number";export{In as UnitNumberInput};
