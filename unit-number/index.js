...
`,Hn=s(Lt.Body)`
    ${e=>{if(e.$inactive)return c`
                color: ${xt.Neutral[3]};
            `}}
`,Mn=({disabled:r,error:o,value:s,onChange:c,onBlur:u,onChangeRaw:d,onBlurRaw:h,readOnly:f,placeholder:g="00-8888",...p})=>{const[m,y]=a(""),[v,$]=a(""),[F,S]=a("none"),D=i(null),b=i(null),B=i(null),w=i(m),x=i(v),H=i(F),M=e=>e.toLocaleUpperCase().replace(/[^0-9A-Za-z]/g,""),E=pn({ref:b,formatter:M}),O=pn({ref:B,formatter:M}),_=e=>{w.current=e,y(e)},k=e=>{x.current=e,$(e)},A=e=>{H.current=e,S(e)};l((()=>(document.addEventListener("mousedown",z),D.current&&D.current.addEventListener("keydown",C),()=>{document.removeEventListener("mousedown",z),D.current&&D.current.removeEventListener("keydown",C)})),[F]),l((()=>{"floor"===F&&3===m.length&&B.current&&B.current.focus()}),[m]),l((()=>{I(s)}),[s]);const z=e=>{r||f||D&&D.current.contains(e.target)||"none"!==H.current&&(A("none"),V())},C=e=>{"unit"===e.target.name&&"Tab"===e.code&&(A("none"),V())},T=e=>{A(e.target.name),e.target.select()},W=e=>{const t=e.target.name,n=e.target.value;"floor"===t?_(L(n)):k(L(n))},Y=e=>{const t=e.target.name;if("floor"===t){const{nextValue:e,updateCaretPosition:n}=E();n(),_(e),R(e,t)}else{const{nextValue:e,updateCaretPosition:n}=O();n(),k(e),R(e,t)}},N=e=>{"Backspace"!==e.code&&"Backspace"!==e.key||"unit"===F&&0===v.length&&b.current.focus()},L=e=>/^[0-9]$/.test(e)?gn.padValue(e,!0):e.toLocaleUpperCase(),I=e=>{if(e!==En)if(void 0===e||0===e.length)_(""),k("");else{const t=e.split("-");if(2===t.length){const e=t[0],n=t[1];_("floor"===F?e:L(e)),k("unit"===F?n:L(n))}}},R=(e,t)=>{if(!c&&!d)return;const n={floor:w.current,unit:x.current};if(n[t]=e,c){const e=P(n);c(e)}d&&d([n.floor,n.unit])},V=()=>{if(!u&&!h)return;const e={floor:L(w.current),unit:L(x.current)};if(u){const t=P(e);u(t)}h&&h([e.floor,e.unit])},P=e=>{const t=[e.floor,e.unit];return e.floor.length>0&&e.unit.length>0?t.join("-"):t.every((e=>""===e))?"":En},j=e=>e.split("-");return e(jt,{ref:D,onClick:()=>{"none"===F&&b.current&&b.current.focus()},$disabled:r,$error:o,$readOnly:f,"data-testid":p["data-testid"],children:[t(Dn,{"data-testid":"addon",disabled:r,$readOnly:f,children:"#"}),f&&s?(()=>{const n=s.split("-");return e(xn,{children:[t(Hn,{children:n[0]}),t(wn,{children:"-"}),t(Hn,{children:n[1]})]})})():e(n,{children:[t(bn,{name:"floor",maxLength:3,value:m,ref:b,onFocus:T,onBlur:W,onChange:Y,disabled:r,readOnly:f,type:"text",pattern:"[0-9A-Z]{2,3}","data-testid":"floor-input","aria-label":"floor-input",placeholder:"floor"!==F||f?j(g)[0]:""}),t(wn,{$inactive:0===m.length,children:"-"}),t(Bn,{name:"unit",maxLength:5,value:v,ref:B,onFocus:T,onBlur:W,onChange:Y,onKeyDown:N,disabled:r,readOnly:f,type:"text",pattern:"[0-9A-Z]{2,5}","data-testid":"unit-input","aria-label":"unit-input",placeholder:"unit"!==F||f?j(g)[1]:""})]})]})},En="Invalid unit number";export{Mn as UnitNumberInput};
