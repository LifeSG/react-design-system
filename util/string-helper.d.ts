...
export declare namespace StringHelper {
    ...
    const getMaskedDescription: (value: string, displayMaskState: "masked" | "unmasked", maskRange?: number[]) => string;
    const joinNonEmptyStrings: (strings: (string | undefined | null)[], delimiter?: string) => string;
}
export {};
