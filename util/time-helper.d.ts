...
export declare class TimeHelper {
     ...
     */
    static roundToNearestInterval(time: string, interval: number, toNextInterval?: boolean): string;
    static generateHourlyIntervals(startTime: string, endTime: string, generatedFormat?: string): string[];
    static getTimeValues(format: TimeFormat, value: string | undefined): TimeValues;
    static updateMinutes(valueString: string, direction: "add" | "minus"): string;
    static updateHours(valueString: string, direction: "add" | "minus"): string;
    static convertTo24HourFormat(values: TimeValues): string;
    static convertHourTo12HourFormat(hourValue: string): string;
    /**
    ...
    static isSameTime(a: string, b: string): boolean;
    static formatDisplayValue(value: string | undefined, format: TimeFormat): string;
    static toMinutesSeconds(_seconds: number): {
        minutes: number;
        seconds: number;
    };
    static to24Hour(time: string): string;
    static generateTimings(interval: number, // In minutes
    format?: TimeFormat, startTime?: string | undefined, endTime?: string | undefined): string[];
    static parseInput(input: string | undefined, format?: TimeFormat): string | undefined;
    static findClosestFlooredTime(inputTime: string | undefined, timeArray: string[]): string | undefined;
     ...
     */
    static calculateScrollPosition(props: CalculateScrollPositionProps): number | null;
}
