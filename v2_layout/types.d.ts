...
/** @deprecated */
export interface V2_CommonLayoutProps extends React.HTMLAttributes<HTMLDivElement> {
...
/** @deprecated */
export interface V2_ColDivProps extends React.HTMLAttributes<HTMLDivElement>, V2_ColProps {
    "data-testid"?: string | undefined;
}
export {};
