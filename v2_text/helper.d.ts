...
export declare const V2_TextStyleHelper: {
    ...
    getTextStyle: (type: V2_TextSizeType | V2_TextLinkSizeType, weight: V2_TextWeight, paragraph?: boolean) => (props: any) => import("styled-components").FlattenInterpolation<import("styled-components").ThemeProps<import("styled-components").DefaultTheme>>;
