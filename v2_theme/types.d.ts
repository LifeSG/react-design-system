...
import type { V2_DesignTokenSet, V2_DesignTokenSetOptions } from "../v2_design-token/types";
import type { V2_TextStyleSetOptionsType, V2_TextStyleSetType } from "../v2_text/types";
export type V2_ThemeLayout = "normal";
export type V2_ColorScheme = "base" | "bookingsg" | "rbs" | "mylegacy" | "ccube" | "oneservice";
...
export type V2_ResourceScheme = "base" | "bookingsg" | "rbs" | "ccube" | "mylegacy";
export declare enum V2_ThemeContextKeys {
